...
Signed file: `ETN.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $439.98 (2026-09-25, ~15-min delayed) |
| Market cap | $170.89B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +19.53%; price +14.22% vs SMA200. |
| Fresh setup quality | Moderate / wait | -4.34% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 12.75%, revenue growth 21.40%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 27.30, EV/Sales 6.38. |
...
| Eaton to Buy COL Group in $923 Million Deal to Expand European Footprint | MT Newswires | 2026-09-25 |
| Eaton Adds European Power Capacity as Data Center Demand Keeps Rising | Benzinga | 2026-09-25 |
| Zacks Industry Outlook Highlights Eaton, Emerson Electric, A. O. Smith and EnerSys | Zacks | 2026-09-25 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $439.98; 52w high $459.96 (-4.34%); 52w low $313.20 (+40.48%) |
| Trend | +14.22% vs SMA200, +5.06% vs SMA50, +6.27% vs SMA20 |
| Momentum | RSI(14) 59.2 (neutral) |
| Volatility | ATR(14) 14.21 (~3.2% of price); beta 1.17 |
| Setup perspective | -4.34% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 44.85, forward P/E 27.30, P/S 5.69, P/B 8.44 | EV/Sales 6.38, EV/EBITDA 28.86 |
...
- **Valuation risk:** Forward P/E 27.30, EV/Sales 6.38. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $439.98 | EV/Sales | 6.38 |
| Market cap | $170.89B | EV/EBITDA | 28.86 |
| Beta | 1.17 | Gross margin | 36.02% |
| RSI(14) | 59.2 | Operating margin | 16.56% |
| ATR(14) | 14.21 | Profit margin | 12.75% |
| SMA20 dist | +6.27% | ROA | 7.05% |
| SMA50 dist | +5.06% | ROE | 19.68% |
| SMA200 dist | +14.22% | Revenue (ttm) | $30.03B |
| 52W high | $459.96 | Revenue growth y/y | 21.40% |
| 52W low | $313.20 | Inst. ownership | 87.90% |
| P/E (ttm) | 44.85 | Insider ownership | 0.07% |
| Forward P/E | 27.30 | Short float | 2.00% |
| PEG (trailing) | 2.67 | Avg volume | 2,188,101 |

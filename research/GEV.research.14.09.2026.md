...
Signed file: `GEV.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $874.76 (2026-09-14, ~15-min delayed) |
| Market cap | $232.98B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $874.76; 52w high $1,174.86 (-25.54%); 52w low $546.95 (+59.94%) |
| Trend | -2.24% vs SMA200, -12.31% vs SMA50, -7.74% vs SMA20 |
| Momentum | RSI(14) 37.7 (neutral) |
| Volatility | ATR(14) 43.71 (~5.0% of price); beta 0.97 |
| Setup perspective | -25.54% from 52w high — base needs to rebuild. |
...
| SMA20 dist | -7.74% | ROA | 2.54% |
| SMA50 dist | -12.31% | ROE | 82.58% |
| SMA200 dist | -2.24% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.66% |
| P/E (ttm) | 25.11 | Insider ownership | 0.13% |
| Forward P/E | 34.56 | Short float | 3.29% |
| PEG (trailing) | 1.87 | Avg volume | 2,575,035 |
| P/S | 5.63 | Employees | 78,000 |
| P/B | 19.48 | Analyst rec (1=buy..5=sell) | 1.5 |

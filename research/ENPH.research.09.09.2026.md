...
Signed file: `ENPH.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $36.72 (2026-09-09, ~15-min delayed) |
| Market cap | $4.84B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-10.10%) with negative half-year (-15.76%). |
| Fresh setup quality | Poor / broken | -49.23% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 16.15, EV/Sales 3.62. |
| Risk level | High | Beta 1.64, ATR 5.6% of price, short float 19.63%. |
...
| Enphase Energy, Inc. (ENPH) Is a Trending Stock: Facts to Know Before Betting on It | Zacks | 2026-09-08 |
| Which Solar Stock Has Dominated in 2026: SolarEdge, Enphase Energy, or First Solar? | 24/7 Wall St. | 2026-09-07 |
| 1 Profitable Stock to Consider Right Now and 2 We Turn Down | StockStory | 2026-09-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.72; 52w high $72.33 (-49.23%); 52w low $26.12 (+40.58%) |
| Trend | -10.10% vs SMA200, -8.09% vs SMA50, -3.34% vs SMA20 |
| Momentum | RSI(14) 44.5 (neutral) |
| Volatility | ATR(14) 2.07 (~5.6% of price); beta 1.64 |
| Setup perspective | -49.23% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 36.36, forward P/E 16.15, P/S 3.64, P/B 4.11 | EV/Sales 3.62, EV/EBITDA 25.06 |
...
- **Volatility risk:** Beta 1.64, ATR 5.6% of price, short float 19.63%. Size positions accordingly.
...
|---|---|---|---|
| Price | $36.72 | EV/Sales | 3.62 |
| Market cap | $4.84B | EV/EBITDA | 25.06 |
| Beta | 1.64 | Gross margin | 30.04% |
| RSI(14) | 44.5 | Operating margin | 17.98% |
| ATR(14) | 2.07 | Profit margin | 10.09% |
| SMA20 dist | -3.34% | ROA | 2.38% |
| SMA50 dist | -8.09% | ROE | 13.00% |
| SMA200 dist | -10.10% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 96.91% |
| P/E (ttm) | 36.36 | Insider ownership | 3.03% |
| Forward P/E | 16.15 | Short float | 19.63% |
| PEG (trailing) | 0.84 | Avg volume | 5,128,956 |
| P/S | 3.64 | Employees | 2,872 |

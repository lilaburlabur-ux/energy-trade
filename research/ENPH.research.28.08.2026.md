...
Signed file: `ENPH.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $39.25 (2026-08-28, ~15-min delayed) |
| Market cap | $5.17B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-3.21%) with negative half-year (-14.25%). |
| Fresh setup quality | Poor / broken | -45.73% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 17.04, EV/Sales 3.66. |
| Risk level | High | Beta 1.65, ATR 5.5% of price, short float 19.63%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $39.25; 52w high $72.33 (-45.73%); 52w low $26.12 (+50.27%) |
| Trend | -3.21% vs SMA200, -6.34% vs SMA50, -0.53% vs SMA20 |
| Momentum | RSI(14) 48.0 (neutral) |
| Volatility | ATR(14) 2.15 (~5.5% of price); beta 1.65 |
| Setup perspective | -45.73% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 38.86, forward P/E 17.04, P/S 3.89, P/B 4.39 | EV/Sales 3.66, EV/EBITDA 25.35 |
...
- **Volatility risk:** Beta 1.65, ATR 5.5% of price, short float 19.63%. Size positions accordingly.
...
|---|---|---|---|
| Price | $39.25 | EV/Sales | 3.66 |
| Market cap | $5.17B | EV/EBITDA | 25.35 |
| Beta | 1.65 | Gross margin | 30.04% |
| RSI(14) | 48.0 | Operating margin | 17.98% |
| ATR(14) | 2.15 | Profit margin | 10.09% |
| SMA20 dist | -0.53% | ROA | 2.38% |
| SMA50 dist | -6.34% | ROE | 13.00% |
| SMA200 dist | -3.21% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 96.77% |
| P/E (ttm) | 38.86 | Insider ownership | 3.03% |
| Forward P/E | 17.04 | Short float | 19.63% |
| PEG (trailing) | 1.11 | Avg volume | 5,578,022 |
| P/S | 3.89 | Employees | 2,872 |
| P/B | 4.39 | Analyst rec (1=buy..5=sell) | 2.5 |

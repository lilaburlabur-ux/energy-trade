...
Signed file: `NEE.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $86.22 (2026-08-17, ~15-min delayed) |
| Market cap | $179.82B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-0.91%) with negative half-year (-6.78%). |
...
| Trend | -0.91% vs SMA200, -1.04% vs SMA50, -1.00% vs SMA20 |
| Momentum | RSI(14) 45.4 (neutral) |
| Volatility | ATR(14) 1.53 (~1.8% of price); beta 0.65 |
...
| ATR(14) | 1.53 | Profit margin | 32.40% |
| SMA20 dist | -1.00% | ROA | 2.44% |
| SMA50 dist | -1.04% | ROE | 11.68% |
| SMA200 dist | -0.91% | Revenue (ttm) | $28.70B |
...
| PEG (trailing) | 1.88 | Avg volume | 12,147,806 |

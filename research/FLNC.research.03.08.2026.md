...
Signed file: `FLNC.research.03.08.2026`

| Field | Value |
|---|---|
| Current price | $14.56 (2026-08-03, ~15-min delayed) |
| Market cap | $2.68B |
...
|---|---|---|
| Technical momentum | High | 1Y +79.31%; price -22.97% vs SMA200. |
| Fresh setup quality | Poor / broken | -54.82% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-1.62%). |
| Value attractiveness | Low (expensive) | Forward P/E 74.53, EV/Sales 0.76. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $14.56; 52w high $32.23 (-54.82%); 52w low $6.75 (+115.70%) |
| Trend | -22.97% vs SMA200, -23.85% vs SMA50, +0.02% vs SMA20 |
| Momentum | RSI(14) 44.9 (neutral) |
| Volatility | ATR(14) 1.64 (~11.3% of price); beta 2.78 |
| Setup perspective | -54.82% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 74.53, P/S 1.04, P/B 5.25 | EV/Sales 0.76, EV/EBITDA -105.94 |
...
- **Valuation risk:** Forward P/E 74.53, EV/Sales 0.76. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $14.56 | EV/Sales | 0.76 |
| Market cap | $2.68B | EV/EBITDA | -105.94 |
| Beta | 2.78 | Gross margin | 11.71% |
| RSI(14) | 44.9 | Operating margin | -8.43% |
| ATR(14) | 1.64 | Profit margin | -1.62% |
| SMA20 dist | +0.02% | ROA | -1.32% |
| SMA50 dist | -23.85% | ROE | -12.72% |
| SMA200 dist | -22.97% | Revenue (ttm) | $2.58B |
| 52W high | $32.23 | Revenue growth y/y | 7.70% |
| 52W low | $6.75 | Inst. ownership | 85.85% |
| P/E (ttm) | — | Insider ownership | 14.45% |
| Forward P/E | 74.53 | Short float | 40.44% |
| PEG (trailing) | — | Avg volume | 12,003,035 |
| P/S | 1.04 | Employees | 1,670 |
| P/B | 5.25 | Analyst rec (1=buy..5=sell) | 2.7 |

...
Signed file: `SO.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $83.47 (2026-09-23, ~15-min delayed) |
| Market cap | $96.02B |
...
| Trend | -8.28% vs SMA200, -8.15% vs SMA50, -4.66% vs SMA20 |
| Momentum | RSI(14) 23.8 (oversold) |
...
| SMA20 dist | -4.66% | ROA | 3.27% |
| SMA50 dist | -8.15% | ROE | 11.48% |
...
| Forward P/E | 16.95 | Short float | 3.06% |
| PEG (trailing) | 2.01 | Avg volume | 5,609,746 |
| P/S | 3.18 | Employees | 29,502 |
| P/B | 2.43 | Analyst rec (1=buy..5=sell) | 2.7 |

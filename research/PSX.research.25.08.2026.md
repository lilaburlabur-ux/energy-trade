...
Signed file: `PSX.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $236.90 (2026-08-25, ~15-min delayed) |
| Market cap | $94.53B |
...
|---|---|---|
| Technical momentum | High | 1Y +87.71%; price +42.73% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 11.45, EV/Sales 0.75. |
...
| $27 Billion in Buybacks: 3 Stocks Betting Their Strong Runs Aren’t Over | MarketBeat | 2026-08-23 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $236.90; 52w high $243.49 (-2.71%); 52w low $123.11 (+92.42%) |
| Trend | +42.73% vs SMA200, +18.02% vs SMA50, +6.31% vs SMA20 |
| Momentum | RSI(14) 68.0 (neutral) |
| Volatility | ATR(14) 6.65 (~2.8% of price); beta 0.69 |
...
| Valuation | P/E 13.52, forward P/E 11.45, P/S 0.62, P/B 3.00 | EV/Sales 0.75, EV/EBITDA 11.51 |
...
|---|---|---|---|
| Price | $236.90 | EV/Sales | 0.75 |
| Market cap | $94.53B | EV/EBITDA | 11.51 |
| Beta | 0.69 | Gross margin | 13.10% |
| RSI(14) | 68.0 | Operating margin | 8.53% |
| ATR(14) | 6.65 | Profit margin | 4.66% |
| SMA20 dist | +6.31% | ROA | 6.04% |
| SMA50 dist | +18.02% | ROE | 23.45% |
| SMA200 dist | +42.73% | Revenue (ttm) | $152.17B |
| 52W high | $243.49 | Revenue growth y/y | 53.10% |
| 52W low | $123.11 | Inst. ownership | 80.57% |
| P/E (ttm) | 13.52 | Insider ownership | 0.21% |
| Forward P/E | 11.45 | Short float | 2.13% |
| PEG (trailing) | 1.16 | Avg volume | 2,657,250 |
| P/S | 0.62 | Employees | 12,600 |
| P/B | 3.00 | Analyst rec (1=buy..5=sell) | 2.1 |

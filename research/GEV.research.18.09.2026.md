...
Signed file: `GEV.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $940.33 (2026-09-18, ~15-min delayed) |
| Market cap | $250.44B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +53.30%; price +4.31% vs SMA200. |
| Fresh setup quality | Moderate / wait | -19.96% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 23.04%, revenue growth 21.90%. |
| Value attractiveness | Low (expensive) | Forward P/E 37.15, EV/Sales 5.76. |
| Risk level | Elevated | Beta 0.97, ATR 4.5% of price, short float 3.29%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $940.33; 52w high $1,174.86 (-19.96%); 52w low $546.95 (+71.92%) |
| Trend | +4.31% vs SMA200, -4.39% vs SMA50, +1.12% vs SMA20 |
| Momentum | RSI(14) 48.7 (neutral) |
| Volatility | ATR(14) 41.90 (~4.5% of price); beta 0.97 |
| Setup perspective | -19.96% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.97, forward P/E 37.15, P/S 6.05, P/B 20.95 | EV/Sales 5.76, EV/EBITDA 60.73 |
...
- **Valuation risk:** Forward P/E 37.15, EV/Sales 5.76. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.97, ATR 4.5% of price, short float 3.29%. Size positions accordingly.
...
|---|---|---|---|
| Price | $940.33 | EV/Sales | 5.76 |
| Market cap | $250.44B | EV/EBITDA | 60.73 |
| Beta | 0.97 | Gross margin | 20.57% |
| RSI(14) | 48.7 | Operating margin | 7.47% |
| ATR(14) | 41.90 | Profit margin | 23.04% |
| SMA20 dist | +1.12% | ROA | 2.54% |
| SMA50 dist | -4.39% | ROE | 82.58% |
| SMA200 dist | +4.31% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.65% |
| P/E (ttm) | 26.97 | Insider ownership | 0.13% |
| Forward P/E | 37.15 | Short float | 3.29% |
| PEG (trailing) | 1.80 | Avg volume | 2,536,596 |
| P/S | 6.05 | Employees | 78,000 |
| P/B | 20.95 | Analyst rec (1=buy..5=sell) | 1.5 |

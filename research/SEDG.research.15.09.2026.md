...
Signed file: `SEDG.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $35.26 (2026-09-15, ~15-min delayed) |
| Market cap | $2.17B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-16.22%) with negative half-year (-13.39%). |
| Fresh setup quality | Poor / broken | -55.09% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-20.29%). |
| Value attractiveness | Low (expensive) | Forward P/E 40.19, EV/Sales 1.53. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $35.26; 52w high $78.51 (-55.09%); 52w low $28.47 (+23.85%) |
| Trend | -16.22% vs SMA200, -10.53% vs SMA50, +6.45% vs SMA20 |
| Momentum | RSI(14) 49.5 (neutral) |
| Volatility | ATR(14) 2.90 (~8.2% of price); beta 1.44 |
| Setup perspective | -55.09% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 40.19, P/S 1.63, P/B 5.26 | EV/Sales 1.53, EV/EBITDA -16.80 |
...
- **Valuation risk:** Forward P/E 40.19, EV/Sales 1.53. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $35.26 | EV/Sales | 1.53 |
| Market cap | $2.17B | EV/EBITDA | -16.80 |
| Beta | 1.44 | Gross margin | 21.25% |
| RSI(14) | 49.5 | Operating margin | -6.51% |
| ATR(14) | 2.90 | Profit margin | -20.29% |
| SMA20 dist | +6.45% | ROA | -3.84% |
| SMA50 dist | -10.53% | ROE | -58.42% |
| SMA200 dist | -16.22% | Revenue (ttm) | $1.33B |
| 52W high | $78.51 | Revenue growth y/y | 19.60% |
| 52W low | $28.47 | Inst. ownership | 101.66% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 40.19 | Short float | 25.50% |
| PEG (trailing) | — | Avg volume | 3,113,625 |
| P/S | 1.63 | Employees | 3,576 |
| P/B | 5.26 | Analyst rec (1=buy..5=sell) | 3.0 |

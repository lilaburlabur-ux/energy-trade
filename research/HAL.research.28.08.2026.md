...
Signed file: `HAL.research.28.08.2026`
...
|---|---|---|
| Technical momentum | High | 1Y +65.97%; price +3.36% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 12.23, EV/Sales 1.60. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $35.49; 52w high $42.80 (-17.08%); 52w low $21.26 (+66.94%) |
| Trend | +3.36% vs SMA200, +4.83% vs SMA50, +5.23% vs SMA20 |
| Momentum | RSI(14) 58.2 (neutral) |
| Volatility | ATR(14) 1.06 (~3.0% of price); beta 0.75 |
...
| SMA20 dist | +5.23% | ROA | 7.26% |
| SMA50 dist | +4.83% | ROE | 14.92% |

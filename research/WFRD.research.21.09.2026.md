...
Signed file: `WFRD.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $82.20 (2026-09-21, ~15-min delayed) |
| Market cap | $5.88B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-11.21%) with negative half-year (-4.03%). |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $82.20; 52w high $111.07 (-25.99%); 52w low $60.73 (+35.36%) |
| Trend | -11.21% vs SMA200, -6.86% vs SMA50, -8.51% vs SMA20 |
| Momentum | RSI(14) 35.3 (neutral) |
| Volatility | ATR(14) 3.56 (~4.3% of price); beta 0.90 |
| Setup perspective | -25.99% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 16.21, forward P/E 11.65, P/S 1.23, P/B 3.30 | EV/Sales 1.34, EV/EBITDA 6.89 |
...
|---|---|---|---|
| Price | $82.20 | EV/Sales | 1.34 |
| Market cap | $5.88B | EV/EBITDA | 6.89 |
| Beta | 0.90 | Gross margin | 30.51% |
| RSI(14) | 35.3 | Operating margin | 10.50% |
| ATR(14) | 3.56 | Profit margin | 7.66% |
| SMA20 dist | -8.51% | ROA | 7.90% |
| SMA50 dist | -6.86% | ROE | 22.79% |
| SMA200 dist | -11.21% | Revenue (ttm) | $4.78B |

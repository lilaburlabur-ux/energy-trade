...
Signed file: `NEE.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $81.28 (2026-09-17, ~15-min delayed) |
| Market cap | $169.52B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-6.04%) with negative half-year (-9.31%). |
| Fresh setup quality | Moderate / wait | -15.72% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 32.40%, revenue growth 12.40%. |
| Value attractiveness | Reasonable | Forward P/E 18.49, EV/Sales 10.03. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $81.28; 52w high $96.44 (-15.72%); 52w low $68.35 (+18.92%) |
| Trend | -6.04% vs SMA200, -4.53% vs SMA50, -1.73% vs SMA20 |
| Momentum | RSI(14) 37.1 (neutral) |
| Volatility | ATR(14) 1.32 (~1.6% of price); beta 0.64 |
| Setup perspective | -15.72% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.27, forward P/E 18.49, P/S 5.91, P/B 2.97 | EV/Sales 10.03, EV/EBITDA 19.73 |
...
|---|---|---|---|
| Price | $81.28 | EV/Sales | 10.03 |
| Market cap | $169.52B | EV/EBITDA | 19.73 |
| Beta | 0.64 | Gross margin | 61.02% |
| RSI(14) | 37.1 | Operating margin | 31.52% |
| ATR(14) | 1.32 | Profit margin | 32.40% |
| SMA20 dist | -1.73% | ROA | 2.44% |
| SMA50 dist | -4.53% | ROE | 11.68% |
| SMA200 dist | -6.04% | Revenue (ttm) | $28.70B |
| 52W high | $96.44 | Revenue growth y/y | 12.40% |
| 52W low | $68.35 | Inst. ownership | 87.01% |
| P/E (ttm) | 18.27 | Insider ownership | 0.12% |
| Forward P/E | 18.49 | Short float | 0.00% |
| PEG (trailing) | 1.62 | Avg volume | 11,087,341 |
| P/S | 5.91 | Employees | 17,400 |
| P/B | 2.97 | Analyst rec (1=buy..5=sell) | 2.0 |

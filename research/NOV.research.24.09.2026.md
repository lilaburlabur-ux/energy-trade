...
Signed file: `NOV.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $19.90 (2026-09-24, ~15-min delayed) |
| Market cap | $7.09B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $19.90; 52w high $21.62 (-7.95%); 52w low $12.04 (+65.33%) |
| Trend | +4.35% vs SMA200, -2.26% vs SMA50, -4.45% vs SMA20 |
| Momentum | RSI(14) 41.0 (neutral) |
| Volatility | ATR(14) 0.64 (~3.2% of price); beta 0.94 |
| Setup perspective | -7.95% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | -4.45% | ROA | 3.45% |
| SMA50 dist | -2.26% | ROE | 1.54% |
| SMA200 dist | +4.35% | Revenue (ttm) | $8.64B |

...
Signed file: `ARRY.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $4.24 (2026-09-17, ~15-min delayed) |
| Market cap | $652.22M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-45.11%) with negative half-year (-38.19%). |
| Fresh setup quality | Poor / broken | -64.55% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 4.73, EV/Sales 1.34. |
| Risk level | High | Beta 1.77, ATR 6.1% of price, short float 29.27%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.24; 52w high $11.96 (-64.55%); 52w low $4.20 (+0.95%) |
| Trend | -45.11% vs SMA200, -17.80% vs SMA50, -6.36% vs SMA20 |
| Momentum | RSI(14) 35.2 (neutral) |
| Volatility | ATR(14) 0.26 (~6.1% of price); beta 1.77 |
| Setup perspective | -64.55% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 4.73, P/S 0.55, P/B -3.23 | EV/Sales 1.34, EV/EBITDA 13.33 |
...
- **Volatility risk:** Beta 1.77, ATR 6.1% of price, short float 29.27%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.24 | EV/Sales | 1.34 |
| Market cap | $652.22M | EV/EBITDA | 13.33 |
| Beta | 1.77 | Gross margin | 26.76% |
| RSI(14) | 35.2 | Operating margin | 10.88% |
| ATR(14) | 0.26 | Profit margin | -7.25% |
| SMA20 dist | -6.36% | ROA | 3.33% |
| SMA50 dist | -17.80% | ROE | -25.98% |
| SMA200 dist | -45.11% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.20 | Inst. ownership | 147.85% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 4.73 | Short float | 29.27% |
| PEG (trailing) | 0.44 | Avg volume | 6,527,109 |

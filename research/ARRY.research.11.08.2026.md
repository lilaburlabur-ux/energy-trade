...
Signed file: `ARRY.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $5.35 (2026-08-11, ~15-min delayed) |
| Market cap | $823.94M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-34.57%) with negative half-year (-55.12%). |
| Fresh setup quality | Poor / broken | -55.27% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.97, EV/Sales 1.49. |
| Risk level | High | Beta 1.79, ATR 8.3% of price, short float 25.46%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $5.35; 52w high $11.96 (-55.27%); 52w low $4.81 (+11.23%) |
| Trend | -34.57% vs SMA200, -20.81% vs SMA50, -4.47% vs SMA20 |
| Momentum | RSI(14) 41.6 (neutral) |
| Volatility | ATR(14) 0.44 (~8.3% of price); beta 1.79 |
| Setup perspective | -55.27% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 5.97, P/S 0.70, P/B -4.08 | EV/Sales 1.49, EV/EBITDA 14.77 |
| Growth expectations | Earnings growth -73.20%, EPS q/q -43.70% | Analyst mean target $9.36 (20 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 152.22% |
...
- **Volatility risk:** Beta 1.79, ATR 8.3% of price, short float 25.46%. Size positions accordingly.
...
|---|---|---|---|
| Price | $5.35 | EV/Sales | 1.49 |
| Market cap | $823.94M | EV/EBITDA | 14.77 |
| Beta | 1.79 | Gross margin | 26.76% |
| RSI(14) | 41.6 | Operating margin | 10.88% |
| ATR(14) | 0.44 | Profit margin | -7.25% |
| SMA20 dist | -4.47% | ROA | 3.33% |
| SMA50 dist | -20.81% | ROE | -25.98% |
| SMA200 dist | -34.57% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.81 | Inst. ownership | 152.22% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.97 | Short float | 25.46% |
| PEG (trailing) | 0.63 | Avg volume | 6,574,829 |
| P/S | 0.70 | Employees | 1,200 |
| P/B | -4.08 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `WFRD.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $82.03 (2026-09-18, ~15-min delayed) |
| Market cap | $5.87B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-11.35%) with negative half-year (-5.73%). |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $82.03; 52w high $111.07 (-26.15%); 52w low $60.73 (+35.08%) |
| Trend | -11.35% vs SMA200, -7.09% vs SMA50, -9.12% vs SMA20 |
| Momentum | RSI(14) 34.9 (neutral) |
| Volatility | ATR(14) 3.55 (~4.3% of price); beta 0.90 |
...
| Valuation | P/E 16.18, forward P/E 11.62, P/S 1.23, P/B 3.29 | EV/Sales 1.34, EV/EBITDA 6.89 |
...
|---|---|---|---|
| Price | $82.03 | EV/Sales | 1.34 |
| Market cap | $5.87B | EV/EBITDA | 6.89 |
| Beta | 0.90 | Gross margin | 30.51% |
| RSI(14) | 34.9 | Operating margin | 10.50% |
| ATR(14) | 3.55 | Profit margin | 7.66% |
| SMA20 dist | -9.12% | ROA | 7.90% |
| SMA50 dist | -7.09% | ROE | 22.79% |
| SMA200 dist | -11.35% | Revenue (ttm) | $4.78B |
...
| PEG (trailing) | 1.25 | Avg volume | 1,188,245 |

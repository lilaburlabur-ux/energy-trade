...
Signed file: `FLNC.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $13.11 (2026-08-11, ~15-min delayed) |
| Market cap | $2.98B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-30.14%) with negative half-year (-32.42%). |
| Fresh setup quality | Poor / broken | -59.32% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 56.22, EV/Sales 0.74. |
| Risk level | High | Beta 2.78, ATR 11.5% of price, short float 40.44%. |
...
| Fluence Energy Q3 Earnings Call Highlights | MarketBeat | 2026-08-06 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $13.11; 52w high $32.23 (-59.32%); 52w low $6.75 (+94.22%) |
| Trend | -30.14% vs SMA200, -28.25% vs SMA50, -5.68% vs SMA20 |
| Momentum | RSI(14) 41.3 (neutral) |
| Volatility | ATR(14) 1.50 (~11.5% of price); beta 2.78 |
| Setup perspective | -59.32% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 56.22, P/S 1.13, P/B 5.03 | EV/Sales 0.74, EV/EBITDA -24.92 |
...
- **Valuation risk:** Forward P/E 56.22, EV/Sales 0.74. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.78, ATR 11.5% of price, short float 40.44%. Size positions accordingly.
...
|---|---|---|---|
| Price | $13.11 | EV/Sales | 0.74 |
| Market cap | $2.98B | EV/EBITDA | -24.92 |
| Beta | 2.78 | Gross margin | 9.36% |
| RSI(14) | 41.3 | Operating margin | -8.85% |
| ATR(14) | 1.50 | Profit margin | -3.07% |
| SMA20 dist | -5.68% | ROA | -2.95% |
| SMA50 dist | -28.25% | ROE | -23.54% |
| SMA200 dist | -30.14% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.75 | Inst. ownership | 89.94% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 56.22 | Short float | 40.44% |
| PEG (trailing) | — | Avg volume | 11,057,054 |
| P/S | 1.13 | Employees | 1,670 |
| P/B | 5.03 | Analyst rec (1=buy..5=sell) | 2.7 |

...
Signed file: `NXT.research.27.08.2026`

| Field | Value |
|---|---|
| Current price | $87.23 (2026-08-27, ~15-min delayed) |
| Market cap | $13.40B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-19.93%) with negative half-year (-25.13%). |
| Fresh setup quality | Poor / broken | -44.23% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 16.36%, revenue growth 8.20%. |
| Value attractiveness | Reasonable | Forward P/E 15.10, EV/Sales 3.32. |
| Risk level | High | Beta 1.95, ATR 6.2% of price, short float 8.04%. |
...
|---|---|---|
| Nextpower (NXT) Approved Governance Changes, Is The Stock Cheap After The Earnings Miss? | Simply Wall St. | 2026-08-26 |
| Core Scientific (CORZ) Just Spent $444 Million on More Power. Here’s Why It Keeps Buying | Insider Monkey | 2026-08-26 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $87.23; 52w high $156.40 (-44.23%); 52w low $64.33 (+35.60%) |
| Trend | -19.93% vs SMA200, -16.39% vs SMA50, -8.56% vs SMA20 |
| Momentum | RSI(14) 37.3 (neutral) |
| Volatility | ATR(14) 5.42 (~6.2% of price); beta 1.95 |
| Setup perspective | -44.23% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 22.54, forward P/E 15.10, P/S 3.69, P/B 5.17 | EV/Sales 3.32, EV/EBITDA 16.10 |
...
- **Volatility risk:** Beta 1.95, ATR 6.2% of price, short float 8.04%. Size positions accordingly.
...
|---|---|---|---|
| Price | $87.23 | EV/Sales | 3.32 |
| Market cap | $13.40B | EV/EBITDA | 16.10 |
| Beta | 1.95 | Gross margin | 22.98% |
| RSI(14) | 37.3 | Operating margin | 20.86% |
| ATR(14) | 5.42 | Profit margin | 16.36% |
| SMA20 dist | -8.56% | ROA | 11.68% |
| SMA50 dist | -16.39% | ROE | 27.22% |
| SMA200 dist | -19.93% | Revenue (ttm) | $3.63B |
| 52W high | $156.40 | Revenue growth y/y | 8.20% |
| 52W low | $64.33 | Inst. ownership | 109.56% |
| P/E (ttm) | 22.54 | Insider ownership | 0.63% |
| Forward P/E | 15.10 | Short float | 8.04% |
| PEG (trailing) | 3.15 | Avg volume | 3,051,160 |
| P/S | 3.69 | Employees | 1,993 |
| P/B | 5.17 | Analyst rec (1=buy..5=sell) | 1.5 |

...
Signed file: `VST.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $151.10 (2026-09-09, ~15-min delayed) |
| Market cap | $50.71B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-3.90%) with negative half-year (-7.84%). |
| Fresh setup quality | Poor / broken | -30.37% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 11.55%, revenue growth -5.50%. |
| Value attractiveness | Reasonable | Forward P/E 14.58, EV/Sales 3.83. |
| Risk level | Elevated | Beta 1.41, ATR 3.5% of price, short float 3.32%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $151.10; 52w high $217.02 (-30.37%); 52w low $134.52 (+12.32%) |
| Trend | -3.90% vs SMA200, +1.29% vs SMA50, +5.94% vs SMA20 |
| Momentum | RSI(14) 59.2 (neutral) |
| Volatility | ATR(14) 5.27 (~3.5% of price); beta 1.41 |
| Setup perspective | -30.37% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 25.48, forward P/E 14.58, P/S 2.64, P/B 16.89 | EV/Sales 3.83, EV/EBITDA 11.06 |
...
- **Volatility risk:** Beta 1.41, ATR 3.5% of price, short float 3.32%. Size positions accordingly.
...
|---|---|---|---|
| Price | $151.10 | EV/Sales | 3.83 |
| Market cap | $50.71B | EV/EBITDA | 11.06 |
| Beta | 1.41 | Gross margin | 38.31% |
| RSI(14) | 59.2 | Operating margin | 13.77% |
| ATR(14) | 5.27 | Profit margin | 11.55% |
| SMA20 dist | +5.94% | ROA | 5.89% |
| SMA50 dist | +1.29% | ROE | 42.96% |
| SMA200 dist | -3.90% | Revenue (ttm) | $19.21B |
| 52W high | $217.02 | Revenue growth y/y | -5.50% |
| 52W low | $134.52 | Inst. ownership | 92.10% |
| P/E (ttm) | 25.48 | Insider ownership | 0.79% |
| Forward P/E | 14.58 | Short float | 3.32% |
| PEG (trailing) | 0.38 | Avg volume | 4,464,359 |
| P/S | 2.64 | Employees | 6,390 |
| P/B | 16.89 | Analyst rec (1=buy..5=sell) | 1.4 |

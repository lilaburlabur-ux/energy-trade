...
Signed file: `FSLR.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $209.03 (2026-09-11, ~15-min delayed) |
| Market cap | $22.46B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +2.57%; price -9.02% vs SMA200. |
| Fresh setup quality | Poor / broken | -34.32% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 32.46%, revenue growth -3.70%. |
| Value attractiveness | Reasonable | Forward P/E 9.02, EV/Sales 3.85. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $209.03; 52w high $318.25 (-34.32%); 52w low $184.70 (+13.17%) |
| Trend | -9.02% vs SMA200, -3.63% vs SMA50, -0.42% vs SMA20 |
| Momentum | RSI(14) 47.1 (neutral) |
| Volatility | ATR(14) 9.72 (~4.6% of price); beta 1.73 |
| Setup perspective | -34.32% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 12.63, forward P/E 9.02, P/S 4.18, P/B 2.18 | EV/Sales 3.85, EV/EBITDA 8.69 |
| Growth expectations | Earnings growth 23.30%, EPS q/q 23.60% | Analyst mean target $274.81 (31 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 96.42% |
...
- **Volatility risk:** Beta 1.73, ATR 4.6% of price, short float 11.47%. Size positions accordingly.
...
|---|---|---|---|
| Price | $209.03 | EV/Sales | 3.85 |
| Market cap | $22.46B | EV/EBITDA | 8.69 |
| Beta | 1.73 | Gross margin | 44.02% |
| RSI(14) | 47.1 | Operating margin | 42.64% |
| ATR(14) | 9.72 | Profit margin | 32.46% |
| SMA20 dist | -0.42% | ROA | 8.62% |
| SMA50 dist | -3.63% | ROE | 18.51% |
| SMA200 dist | -9.02% | Revenue (ttm) | $5.38B |
| 52W high | $318.25 | Revenue growth y/y | -3.70% |
| 52W low | $184.70 | Inst. ownership | 96.42% |
| P/E (ttm) | 12.63 | Insider ownership | 5.36% |
| Forward P/E | 9.02 | Short float | 11.47% |
| PEG (trailing) | 0.39 | Avg volume | 2,134,995 |
| P/S | 4.18 | Employees | 7,900 |
| P/B | 2.18 | Analyst rec (1=buy..5=sell) | 1.9 |

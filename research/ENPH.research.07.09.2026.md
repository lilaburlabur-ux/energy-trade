...
Signed file: `ENPH.research.07.09.2026`

| Field | Value |
|---|---|
| Current price | $36.37 (2026-09-07, ~15-min delayed) |
| Market cap | $4.81B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-10.73%) with negative half-year (-9.59%). |
| Fresh setup quality | Poor / broken | -49.72% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 15.99, EV/Sales 3.37. |
| Risk level | High | Beta 1.64, ATR 5.3% of price, short float 19.63%. |
...
| Enphase Energy (ENPH) Outperforms Broader Market: What You Need to Know | Zacks | 2026-09-03 |
| SunPower Soars 60% on $26.2M Raise: Is This a Short Squeeze in Progress? | 24/7 Wall St. | 2026-09-03 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.37; 52w high $72.33 (-49.72%); 52w low $26.12 (+39.24%) |
| Trend | -10.73% vs SMA200, -9.89% vs SMA50, -5.22% vs SMA20 |
| Momentum | RSI(14) 41.8 (neutral) |
| Volatility | ATR(14) 1.91 (~5.3% of price); beta 1.64 |
| Setup perspective | -49.72% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 36.01, forward P/E 15.99, P/S 3.62, P/B 4.07 | EV/Sales 3.37, EV/EBITDA 23.37 |
...
- **Volatility risk:** Beta 1.64, ATR 5.3% of price, short float 19.63%. Size positions accordingly.
...
|---|---|---|---|
| Price | $36.37 | EV/Sales | 3.37 |
| Market cap | $4.81B | EV/EBITDA | 23.37 |
| Beta | 1.64 | Gross margin | 30.04% |
| RSI(14) | 41.8 | Operating margin | 17.98% |
| ATR(14) | 1.91 | Profit margin | 10.09% |
| SMA20 dist | -5.22% | ROA | 2.38% |
| SMA50 dist | -9.89% | ROE | 13.00% |
| SMA200 dist | -10.73% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 96.91% |
| P/E (ttm) | 36.01 | Insider ownership | 3.03% |
| Forward P/E | 15.99 | Short float | 19.63% |
| PEG (trailing) | 0.78 | Avg volume | 5,232,585 |

...
Signed file: `BWXT.research.07.08.2026`

| Field | Value |
|---|---|
| Current price | $169.90 (2026-08-07, ~15-min delayed) |
| Market cap | $15.57B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-13.42%) with negative half-year (-9.10%). |
| Fresh setup quality | Poor / broken | -28.64% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.11%, revenue growth 18.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 32.39, EV/Sales 4.75. |
| Risk level | Elevated | Beta 0.76, ATR 4.4% of price, short float 4.13%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $169.90; 52w high $238.10 (-28.64%); 52w low $157.44 (+7.91%) |
| Trend | -13.42% vs SMA200, -8.17% vs SMA50, -1.13% vs SMA20 |
| Momentum | RSI(14) 43.8 (neutral) |
| Volatility | ATR(14) 7.42 (~4.4% of price); beta 0.76 |
| Setup perspective | -28.64% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 43.90, forward P/E 32.39, P/S 4.43, P/B 16.42 | EV/Sales 4.75, EV/EBITDA 35.02 |
| Growth expectations | Earnings growth 14.10%, EPS q/q 13.60% | Analyst mean target $235.16 (14 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 95.06% |
...
- **Valuation risk:** Forward P/E 32.39, EV/Sales 4.75. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.76, ATR 4.4% of price, short float 4.13%. Size positions accordingly.
...
|---|---|---|---|
| Price | $169.90 | EV/Sales | 4.75 |
| Market cap | $15.57B | EV/EBITDA | 35.02 |
| Beta | 0.76 | Gross margin | 22.08% |
| RSI(14) | 43.8 | Operating margin | 10.39% |
| ATR(14) | 7.42 | Profit margin | 10.11% |
| SMA20 dist | -1.13% | ROA | 5.53% |
| SMA50 dist | -8.17% | ROE | 28.29% |
| SMA200 dist | -13.42% | Revenue (ttm) | $3.51B |
| 52W high | $238.10 | Revenue growth y/y | 18.00% |
| 52W low | $157.44 | Inst. ownership | 95.06% |
| P/E (ttm) | 43.90 | Insider ownership | 0.36% |
| Forward P/E | 32.39 | Short float | 4.13% |
| PEG (trailing) | — | Avg volume | 979,467 |
| P/S | 4.43 | Employees | 11,000 |
| P/B | 16.42 | Analyst rec (1=buy..5=sell) | 1.8 |

...
Signed file: `EPD.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $38.09 (2026-09-16, ~15-min delayed) |
| Market cap | $82.25B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +27.74%; price +6.60% vs SMA200. |
| Fresh setup quality | Watch | -3.23% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.02, EV/Sales 2.03. |
| Risk level | Moderate | Beta 0.48, ATR 1.5% of price, short float 3.09%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.09; 52w high $39.36 (-3.23%); 52w low $28.35 (+34.34%) |
| Trend | +6.60% vs SMA200, -0.36% vs SMA50, -1.82% vs SMA20 |
| Momentum | RSI(14) 43.1 (neutral) |
| Volatility | ATR(14) 0.58 (~1.5% of price); beta 0.48 |
| Setup perspective | -3.23% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.18, forward P/E 12.02, P/S 1.41, P/B 2.72 | EV/Sales 2.03, EV/EBITDA 11.51 |
| Growth expectations | Earnings growth 28.50%, EPS q/q 28.20% | Analyst mean target $41.37 (19 analysts) |
...
|---|---|---|---|
| Price | $38.09 | EV/Sales | 2.03 |
| Market cap | $82.25B | EV/EBITDA | 11.51 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 43.1 | Operating margin | 11.76% |
| ATR(14) | 0.58 | Profit margin | 10.79% |
| SMA20 dist | -1.82% | ROA | 5.92% |
| SMA50 dist | -0.36% | ROE | 20.85% |
| SMA200 dist | +6.60% | Revenue (ttm) | $58.47B |
| 52W high | $39.36 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.64% |
| P/E (ttm) | 13.18 | Insider ownership | 33.04% |
| Forward P/E | 12.02 | Short float | 3.09% |
| PEG (trailing) | 1.38 | Avg volume | 2,911,575 |
| P/S | 1.41 | Employees | 0 |
| P/B | 2.72 | Analyst rec (1=buy..5=sell) | 2.3 |

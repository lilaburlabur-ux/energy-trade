...
Signed file: `EOSE.research.14.08.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-56.67%) with negative half-year (-62.74%). |
| Fresh setup quality | Poor / broken | -79.05% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-246.76%). |
| Value attractiveness | Reasonable | Forward P/E -26.88, EV/Sales 11.96. |
| Risk level | High | Beta 2.80, ATR 10.6% of price, short float 32.31%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.02; 52w high $19.19 (-79.05%); 52w low $3.14 (+28.03%) |
| Trend | -56.67% vs SMA200, -19.99% vs SMA50, +4.01% vs SMA20 |
| Momentum | RSI(14) 45.6 (neutral) |
| Volatility | ATR(14) 0.43 (~10.6% of price); beta 2.80 |
| Setup perspective | -79.05% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 2.80, ATR 10.6% of price, short float 32.31%. Size positions accordingly.
...
| SMA20 dist | +4.01% | ROA | -30.03% |
| SMA50 dist | -19.99% | ROE | — |
| SMA200 dist | -56.67% | Revenue (ttm) | $214.25M |
| 52W high | $19.19 | Revenue growth y/y | 351.40% |
| 52W low | $3.14 | Inst. ownership | 59.96% |

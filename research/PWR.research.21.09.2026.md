...
Signed file: `PWR.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $642.61 (2026-09-21, ~15-min delayed) |
| Market cap | $96.61B |
...
|---|---|---|
| Technical momentum | High | 1Y +64.64%; price +7.67% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 32.59, EV/Sales 3.10. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $642.61; 52w high $785.12 (-18.15%); 52w low $388.25 (+65.51%) |
| Trend | +7.67% vs SMA200, +0.13% vs SMA50, +3.47% vs SMA20 |
| Momentum | RSI(14) 52.5 (neutral) |
| Volatility | ATR(14) 24.09 (~3.7% of price); beta 1.20 |
...
| Valuation | P/E 73.69, forward P/E 32.59, P/S 2.94, P/B 10.02 | EV/Sales 3.10, EV/EBITDA 33.47 |
...
- **Valuation risk:** Forward P/E 32.59, EV/Sales 3.10. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $642.61 | EV/Sales | 3.10 |
| Market cap | $96.61B | EV/EBITDA | 33.47 |
| Beta | 1.20 | Gross margin | 15.46% |
| RSI(14) | 52.5 | Operating margin | 7.22% |
| ATR(14) | 24.09 | Profit margin | 4.03% |
| SMA20 dist | +3.47% | ROA | 5.23% |
| SMA50 dist | +0.13% | ROE | 15.34% |
| SMA200 dist | +7.67% | Revenue (ttm) | $32.91B |

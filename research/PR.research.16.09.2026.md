...
Signed file: `PR.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $22.95 (2026-09-16, ~15-min delayed) |
| Market cap | $19.22B |
...
|---|---|---|
| Technical momentum | High | 1Y +80.24%; price +22.15% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.29% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 21.52%, revenue growth 55.10%. |
| Value attractiveness | Reasonable | Forward P/E 10.32, EV/Sales 4.10. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $22.95; 52w high $24.49 (-6.29%); 52w low $11.76 (+95.14%) |
| Trend | +22.15% vs SMA200, +5.49% vs SMA50, -2.38% vs SMA20 |
| Momentum | RSI(14) 50.2 (neutral) |
| Volatility | ATR(14) 0.75 (~3.3% of price); beta 0.48 |
| Setup perspective | -6.29% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 14.81, forward P/E 10.32, P/S 3.35, P/B 1.60 | EV/Sales 4.10, EV/EBITDA 5.53 |
...
|---|---|---|---|
| Price | $22.95 | EV/Sales | 4.10 |
| Market cap | $19.22B | EV/EBITDA | 5.53 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 50.2 | Operating margin | 57.44% |
| ATR(14) | 0.75 | Profit margin | 21.52% |
| SMA20 dist | -2.38% | ROA | 7.54% |
| SMA50 dist | +5.49% | ROE | 11.40% |
| SMA200 dist | +22.15% | Revenue (ttm) | $5.74B |
| 52W high | $24.49 | Revenue growth y/y | 55.10% |
| 52W low | $11.76 | Inst. ownership | 92.72% |
| P/E (ttm) | 14.81 | Insider ownership | 4.61% |
| Forward P/E | 10.32 | Short float | 2.47% |
| PEG (trailing) | 1.41 | Avg volume | 9,774,767 |
| P/S | 3.35 | Employees | 515 |
| P/B | 1.60 | Analyst rec (1=buy..5=sell) | 1.3 |

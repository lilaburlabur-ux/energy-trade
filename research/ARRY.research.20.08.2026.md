...
Signed file: `ARRY.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $4.71 (2026-08-20, ~15-min delayed) |
| Market cap | $725.38M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-41.43%) with negative half-year (-56.91%). |
...
| Value attractiveness | Reasonable | Forward P/E 5.26, EV/Sales 1.44. |
| Risk level | High | Beta 1.79, ATR 7.9% of price, short float 26.42%. |
...
| 3 Unprofitable Stocks That Concern Us | StockStory | 2026-08-12 |
| 3 Small-Cap Stocks We’re Skeptical Of | StockStory | 2026-08-10 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.71; 52w high $11.96 (-60.62%); 52w low $4.71 (+0.00%) |
| Trend | -41.43% vs SMA200, -24.86% vs SMA50, -9.99% vs SMA20 |
| Momentum | RSI(14) 34.8 (neutral) |
| Volatility | ATR(14) 0.37 (~7.9% of price); beta 1.79 |
...
| Valuation | P/E —, forward P/E 5.26, P/S 0.61, P/B -3.59 | EV/Sales 1.44, EV/EBITDA 14.26 |
...
- **Volatility risk:** Beta 1.79, ATR 7.9% of price, short float 26.42%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.71 | EV/Sales | 1.44 |
| Market cap | $725.38M | EV/EBITDA | 14.26 |
| Beta | 1.79 | Gross margin | 26.76% |
| RSI(14) | 34.8 | Operating margin | 10.88% |
| ATR(14) | 0.37 | Profit margin | -7.25% |
| SMA20 dist | -9.99% | ROA | 3.33% |
| SMA50 dist | -24.86% | ROE | -25.98% |
| SMA200 dist | -41.43% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.71 | Inst. ownership | 148.14% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.26 | Short float | 26.42% |
| PEG (trailing) | 0.59 | Avg volume | 6,652,469 |

...
Signed file: `FSLR.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $177.71 (2026-09-25, ~15-min delayed) |
| Market cap | $19.10B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-21.50%) with negative half-year (-4.37%). |
| Fresh setup quality | Poor / broken | -44.16% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 32.46%, revenue growth -3.70%. |
| Value attractiveness | Reasonable | Forward P/E 7.64, EV/Sales 3.15. |
| Risk level | High | Beta 1.73, ATR 5.8% of price, short float 12.80%. |
...
|---|---|---|
| FSLR Stock Heads For Its Worst Week In Over A Month — Roth Says US Polysilicon Crackdown Could Provide A Tailwind | Stocktwits | 2026-09-25 |
| Solar Stocks Tumble After 30-Year Treasury Yield Hits 2004 High | GuruFocus.com | 2026-09-25 |
| US Stock Market Today: S&P 500 Futures Slip As Hot Growth Keeps Rate Fears High | Simply Wall St. | 2026-09-25 |
| First Solar, Enphase, SolarEdge, Alight, and Goodyear Shares Are Falling, What You Need To Know | StockStory | 2026-09-24 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $177.71; 52w high $318.25 (-44.16%); 52w low $172.16 (+3.22%) |
| Trend | -21.50% vs SMA200, -15.71% vs SMA50, -10.99% vs SMA20 |
| Momentum | RSI(14) 35.1 (neutral) |
| Volatility | ATR(14) 10.29 (~5.8% of price); beta 1.73 |
| Setup perspective | -44.16% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 10.96, forward P/E 7.64, P/S 3.55, P/B 1.85 | EV/Sales 3.15, EV/EBITDA 7.11 |
| Growth expectations | Earnings growth 23.30%, EPS q/q 23.60% | Analyst mean target $272.10 (31 analysts) |
...
- **Volatility risk:** Beta 1.73, ATR 5.8% of price, short float 12.80%. Size positions accordingly.
...
|---|---|---|---|
| Price | $177.71 | EV/Sales | 3.15 |
| Market cap | $19.10B | EV/EBITDA | 7.11 |
| Beta | 1.73 | Gross margin | 44.02% |
| RSI(14) | 35.1 | Operating margin | 42.64% |
| ATR(14) | 10.29 | Profit margin | 32.46% |
| SMA20 dist | -10.99% | ROA | 8.62% |
| SMA50 dist | -15.71% | ROE | 18.51% |
| SMA200 dist | -21.50% | Revenue (ttm) | $5.38B |
| 52W high | $318.25 | Revenue growth y/y | -3.70% |
| 52W low | $172.16 | Inst. ownership | 96.44% |
| P/E (ttm) | 10.96 | Insider ownership | 5.36% |
| Forward P/E | 7.64 | Short float | 12.80% |
| PEG (trailing) | 0.36 | Avg volume | 2,227,433 |

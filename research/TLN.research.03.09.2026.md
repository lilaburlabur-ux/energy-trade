...
Signed file: `TLN.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $305.52 (2026-09-03, ~15-min delayed) |
| Market cap | $14.64B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-14.73%) with negative half-year (-8.76%). |
...
| Value attractiveness | Reasonable | Forward P/E 9.93, EV/Sales 6.37. |
| Risk level | High | Beta 1.67, ATR 5.0% of price, short float 5.05%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $305.52; 52w high $445.84 (-31.47%); 52w low $293.73 (+4.01%) |
| Trend | -14.73% vs SMA200, -12.60% vs SMA50, -5.71% vs SMA20 |
| Momentum | RSI(14) 39.4 (neutral) |
| Volatility | ATR(14) 15.42 (~5.0% of price); beta 1.67 |
| Setup perspective | -31.47% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 9.93, P/S 3.91, P/B 9.06 | EV/Sales 6.37, EV/EBITDA 40.96 |
...
- **Volatility risk:** Beta 1.67, ATR 5.0% of price, short float 5.05%. Size positions accordingly.
...
|---|---|---|---|
| Price | $305.52 | EV/Sales | 6.37 |
| Market cap | $14.64B | EV/EBITDA | 40.96 |
| Beta | 1.67 | Gross margin | 42.10% |
| RSI(14) | 39.4 | Operating margin | -4.80% |
| ATR(14) | 15.42 | Profit margin | -4.95% |
| SMA20 dist | -5.71% | ROA | 0.92% |
| SMA50 dist | -12.60% | ROE | -12.83% |
| SMA200 dist | -14.73% | Revenue (ttm) | $3.74B |
| 52W high | $445.84 | Revenue growth y/y | 111.20% |
| 52W low | $293.73 | Inst. ownership | 102.16% |
| P/E (ttm) | — | Insider ownership | 1.36% |
| Forward P/E | 9.93 | Short float | 5.05% |
| PEG (trailing) | — | Avg volume | 853,966 |

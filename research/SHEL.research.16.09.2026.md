...
Signed file: `SHEL.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $95.70 (2026-09-16, ~15-min delayed) |
| Market cap | $273.53B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $95.70; 52w high $98.95 (-3.28%); 52w low $68.25 (+40.22%) |
| Trend | +15.79% vs SMA200, +6.61% vs SMA50, +2.05% vs SMA20 |
| Momentum | RSI(14) 59.5 (neutral) |
| Volatility | ATR(14) 1.70 (~1.8% of price); beta -0.22 |
...
| SMA20 dist | +2.05% | ROA | 6.40% |
| SMA50 dist | +6.61% | ROE | 14.34% |
| SMA200 dist | +15.79% | Revenue (ttm) | $296.60B |
| 52W high | $98.95 | Revenue growth y/y | 44.70% |
| 52W low | $68.25 | Inst. ownership | 13.35% |
| P/E (ttm) | 10.59 | Insider ownership | 0.01% |
| Forward P/E | 9.26 | Short float | 1.54% |
| PEG (trailing) | 1.67 | Avg volume | 6,418,883 |

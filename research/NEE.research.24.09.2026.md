...
Signed file: `NEE.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $75.62 (2026-09-24, ~15-min delayed) |
| Market cap | $157.74B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-12.50%) with negative half-year (-16.23%). |
| Fresh setup quality | Moderate / wait | -21.59% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 32.40%, revenue growth 12.40%. |
| Value attractiveness | Reasonable | Forward P/E 17.21, EV/Sales 9.72. |
| Risk level | Moderate | Beta 0.64, ATR 1.9% of price, short float 0.00%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $75.62; 52w high $96.44 (-21.59%); 52w low $70.30 (+7.57%) |
| Trend | -12.50% vs SMA200, -10.39% vs SMA50, -7.35% vs SMA20 |
| Momentum | RSI(14) 20.0 (oversold) |
| Volatility | ATR(14) 1.41 (~1.9% of price); beta 0.64 |
| Setup perspective | -21.59% from 52w high; no clean fresh pivot by default. |
...
|---|---|---|---|
| Price | $75.62 | EV/Sales | 9.72 |
| Market cap | $157.74B | EV/EBITDA | 19.12 |
| Beta | 0.64 | Gross margin | 61.02% |
| RSI(14) | 20.0 | Operating margin | 31.52% |
| ATR(14) | 1.41 | Profit margin | 32.40% |
| SMA20 dist | -7.35% | ROA | 2.44% |
| SMA50 dist | -10.39% | ROE | 11.68% |
| SMA200 dist | -12.50% | Revenue (ttm) | $28.70B |

...
Signed file: `MPC.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $312.61 (2026-08-04, ~15-min delayed) |
| Market cap | $91.26B |
...
|---|---|---|
| Technical momentum | High | 1Y +92.55%; price +40.82% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 11.26, EV/Sales 0.94. |
| Risk level | Elevated | Beta 0.51, ATR 3.0% of price, short float 2.54%. |
...
|---|---|---|
| Marathon Petroleum Beats Second-Quarter Estimates as Refining Margins Surge | InvestorsHub | 2026-08-04 |
| Marathon Petroleum Q2 2026 earnings beat on refining margin surge | Quartz | 2026-08-04 |
| How Valero's Q2 Refining & Renewable Diesel Surge Reshapes its 2026 | Zacks | 2026-08-04 |
| Marathon Petroleum (MPC) Beats Q2 Earnings and Revenue Estimates | Zacks | 2026-08-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $312.61; 52w high $319.76 (-2.24%); 52w low $155.55 (+100.98%) |
| Trend | +40.82% vs SMA200, +13.14% vs SMA50, +2.24% vs SMA20 |
| Momentum | RSI(14) 62.5 (neutral) |
| Volatility | ATR(14) 9.41 (~3.0% of price); beta 0.51 |
...
| Valuation | P/E 20.57, forward P/E 11.26, P/S 0.67, P/B 5.47 | EV/Sales 0.94, EV/EBITDA 12.53 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $303.89 (18 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 78.41% |
...
|---|---|---|---|
| Blackrock Inc. | 24,394,842 | 8.36% | 2026-03-31 |
| Vanguard Capital Management LLC | 19,170,094 | 6.57% | 2026-03-31 |
| State Street Corporation | 19,025,020 | 6.52% | 2026-03-31 |
| Vanguard Portfolio Management LLC | 15,672,113 | 5.37% | 2026-03-31 |
...
- **Volatility risk:** Beta 0.51, ATR 3.0% of price, short float 2.54%. Size positions accordingly.
...
|---|---|---|---|
| Price | $312.61 | EV/Sales | 0.94 |
| Market cap | $91.26B | EV/EBITDA | 12.53 |
| Beta | 0.51 | Gross margin | 10.74% |
| RSI(14) | 62.5 | Operating margin | 3.56% |
| ATR(14) | 9.41 | Profit margin | 3.41% |
| SMA20 dist | +2.24% | ROA | 5.15% |
| SMA50 dist | +13.14% | ROE | 27.46% |
| SMA200 dist | +40.82% | Revenue (ttm) | $135.95B |
| 52W high | $319.76 | Revenue growth y/y | 8.80% |
| 52W low | $155.55 | Inst. ownership | 78.41% |
| P/E (ttm) | 20.57 | Insider ownership | 0.32% |
| Forward P/E | 11.26 | Short float | 2.54% |
| PEG (trailing) | 1.57 | Avg volume | 2,334,729 |
| P/S | 0.67 | Employees | 18,500 |
| P/B | 5.47 | Analyst rec (1=buy..5=sell) | 2.3 |
...
| 2026-07-13 | main | Evercore ISI Group | In-Line → In-Line |
| 2026-07-13 | main | Raymond James | Outperform → Outperform |
| 2026-07-13 | main | Barclays | Overweight → Overweight |
| 2026-06-29 | main | TD Cowen | Buy → Buy |
| 2026-06-12 | main | Morgan Stanley | Overweight → Overweight |
...
| Source | URL | Used for |
|---|---|---|
| Yahoo Finance quote/profile/statistics for MPC | https://finance.yahoo.com/quote/MPC | Snapshot metrics, ownership, analyst data |
| Yahoo Finance price history (via yfinance) | https://finance.yahoo.com/quote/MPC/history | SMA/RSI/ATR/performance calculations |
| Yahoo Finance news feed | https://finance.yahoo.com/quote/MPC/news | Catalyst headlines |

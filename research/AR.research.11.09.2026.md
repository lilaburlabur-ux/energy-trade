...
Signed file: `AR.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $38.43 (2026-09-11, ~15-min delayed) |
| Market cap | $11.81B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +16.99%; price +5.66% vs SMA200. |
| Fresh setup quality | Moderate / wait | -14.88% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 18.75%, revenue growth 12.60%. |
| Value attractiveness | Reasonable | Forward P/E 8.98, EV/Sales —. |
| Risk level | Moderate | Beta 0.35, ATR 2.7% of price, short float 4.81%. |
...
|---|---|---|
| Antero Resources (AR) Stock Looks Like A Bargain On Earnings | Simply Wall St. | 2026-09-06 |
| Why Is W&T (WTI) Up 16.5% Since Last Earnings Report? | Zacks | 2026-09-04 |
| 1 Growth Stock Set to Flourishand 2 That Underwhelm | StockStory | 2026-09-03 |
| 1 Value Stock to Own for Decades and 2 Facing Challenges | StockStory | 2026-09-02 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.43; 52w high $45.15 (-14.88%); 52w low $30.03 (+27.97%) |
| Trend | +5.66% vs SMA200, +5.79% vs SMA50, +0.13% vs SMA20 |
| Momentum | RSI(14) 54.5 (neutral) |
| Volatility | ATR(14) 1.03 (~2.7% of price); beta 0.35 |
| Setup perspective | -14.88% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 11.01, forward P/E 8.98, P/S 2.04, P/B 1.43 | EV/Sales —, EV/EBITDA — |
| Growth expectations | Earnings growth 79.90%, EPS q/q 78.00% | Analyst mean target $49.57 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 91.47% |
...
|---|---|---|---|
| Price | $38.43 | EV/Sales | — |
| Market cap | $11.81B | EV/EBITDA | — |
| Beta | 0.35 | Gross margin | 67.15% |
| RSI(14) | 54.5 | Operating margin | 26.02% |
| ATR(14) | 1.03 | Profit margin | 18.75% |
| SMA20 dist | +0.13% | ROA | 6.61% |
| SMA50 dist | +5.79% | ROE | 14.22% |
| SMA200 dist | +5.66% | Revenue (ttm) | $5.78B |
| 52W high | $45.15 | Revenue growth y/y | 12.60% |
| 52W low | $30.03 | Inst. ownership | 91.47% |
| P/E (ttm) | 11.01 | Insider ownership | 4.41% |
| Forward P/E | 8.98 | Short float | 4.81% |
| PEG (trailing) | 0.45 | Avg volume | 4,316,164 |
| P/S | 2.04 | Employees | 632 |
| P/B | 1.43 | Analyst rec (1=buy..5=sell) | 1.8 |

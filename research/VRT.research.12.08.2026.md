...
Signed file: `VRT.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $288.36 (2026-08-12, ~15-min delayed) |
| Market cap | $111.02B |
...
|---|---|---|
| Technical momentum | High | 1Y +106.45%; price +15.26% vs SMA200. |
| Fresh setup quality | Moderate / wait | -23.34% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 15.09%, revenue growth 24.10%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 31.70, EV/Sales 9.47. |
| Risk level | High | Beta 2.08, ATR 6.6% of price, short float 3.21%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $288.36; 52w high $376.15 (-23.34%); 52w low $121.69 (+136.97%) |
| Trend | +15.26% vs SMA200, -3.38% vs SMA50, +4.41% vs SMA20 |
| Momentum | RSI(14) 52.1 (neutral) |
| Volatility | ATR(14) 19.08 (~6.6% of price); beta 2.08 |
| Setup perspective | -23.34% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 65.24, forward P/E 31.70, P/S 9.67, P/B 26.08 | EV/Sales 9.47, EV/EBITDA 40.59 |
...
- **Valuation risk:** Forward P/E 31.70, EV/Sales 9.47. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.08, ATR 6.6% of price, short float 3.21%. Size positions accordingly.
...
|---|---|---|---|
| Price | $288.36 | EV/Sales | 9.47 |
| Market cap | $111.02B | EV/EBITDA | 40.59 |
| Beta | 2.08 | Gross margin | 38.04% |
| RSI(14) | 52.1 | Operating margin | 20.36% |
| ATR(14) | 19.08 | Profit margin | 15.09% |
| SMA20 dist | +4.41% | ROA | 10.89% |
| SMA50 dist | -3.38% | ROE | 43.94% |
| SMA200 dist | +15.26% | Revenue (ttm) | $11.48B |
| 52W high | $376.15 | Revenue growth y/y | 24.10% |
| 52W low | $121.69 | Inst. ownership | 86.12% |
| P/E (ttm) | 65.24 | Insider ownership | 0.27% |
| Forward P/E | 31.70 | Short float | 3.21% |
| PEG (trailing) | 1.27 | Avg volume | 6,347,287 |
| P/S | 9.67 | Employees | 34,000 |
| P/B | 26.08 | Analyst rec (1=buy..5=sell) | 1.4 |

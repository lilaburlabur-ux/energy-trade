...
Signed file: `PWR.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $662.47 (2026-08-20, ~15-min delayed) |
| Market cap | $99.60B |
...
|---|---|---|
| Technical momentum | High | 1Y +74.82%; price +14.58% vs SMA200. |
| Fresh setup quality | Moderate / wait | -15.62% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 4.03%, revenue growth 41.10%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 33.73, EV/Sales 3.28. |
...
| Argan's Power Margin Hits 23.6%: Is the Earnings Upside Sustainable? | Zacks | 2026-08-20 |
| TTEK Wins $49M Geospatial and Engineering Services Contract From NOAA | Zacks | 2026-08-20 |
| Toll Brothers Beats Q3 Earnings & Revenue Estimates on Higher Pricing | Zacks | 2026-08-19 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $662.47; 52w high $785.12 (-15.62%); 52w low $372.18 (+78.00%) |
| Trend | +14.58% vs SMA200, -1.41% vs SMA50, +0.05% vs SMA20 |
| Momentum | RSI(14) 48.2 (neutral) |
| Volatility | ATR(14) 29.96 (~4.5% of price); beta 1.22 |
| Setup perspective | -15.62% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 75.80, forward P/E 33.73, P/S 3.03, P/B 10.33 | EV/Sales 3.28, EV/EBITDA 35.48 |
...
- **Valuation risk:** Forward P/E 33.73, EV/Sales 3.28. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $662.47 | EV/Sales | 3.28 |
| Market cap | $99.60B | EV/EBITDA | 35.48 |
| Beta | 1.22 | Gross margin | 15.46% |
| RSI(14) | 48.2 | Operating margin | 7.22% |
| ATR(14) | 29.96 | Profit margin | 4.03% |
| SMA20 dist | +0.05% | ROA | 5.23% |
| SMA50 dist | -1.41% | ROE | 15.34% |
| SMA200 dist | +14.58% | Revenue (ttm) | $32.91B |

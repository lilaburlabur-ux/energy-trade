...
Signed file: `GEV.research.22.09.2026`

| Field | Value |
|---|---|
| Current price | $950.28 (2026-09-22, ~15-min delayed) |
| Market cap | $253.09B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +52.59%; price +5.01% vs SMA200. |
| Fresh setup quality | Moderate / wait | -19.12% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 23.04%, revenue growth 21.90%. |
| Value attractiveness | Low (expensive) | Forward P/E 37.55, EV/Sales 5.93. |
| Risk level | Elevated | Beta 0.97, ATR 4.2% of price, short float 3.29%. |
...
| After $176 billion backlog, GE Vernova sends investors wakeup call | TheStreet | 2026-09-22 |
| Should You Forget Nvidia and Buy These 3 Millionaire-Maker AI Infrastructure Stocks Instead? | Motley Fool | 2026-09-21 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $950.28; 52w high $1,174.86 (-19.12%); 52w low $546.95 (+73.74%) |
| Trend | +5.01% vs SMA200, -2.91% vs SMA50, +2.20% vs SMA20 |
| Momentum | RSI(14) 50.4 (neutral) |
| Volatility | ATR(14) 39.54 (~4.2% of price); beta 0.97 |
| Setup perspective | -19.12% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 27.21, forward P/E 37.55, P/S 6.12, P/B 21.17 | EV/Sales 5.93, EV/EBITDA 62.45 |
...
- **Valuation risk:** Forward P/E 37.55, EV/Sales 5.93. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.97, ATR 4.2% of price, short float 3.29%. Size positions accordingly.
...
|---|---|---|---|
| Price | $950.28 | EV/Sales | 5.93 |
| Market cap | $253.09B | EV/EBITDA | 62.45 |
| Beta | 0.97 | Gross margin | 20.57% |
| RSI(14) | 50.4 | Operating margin | 7.47% |
| ATR(14) | 39.54 | Profit margin | 23.04% |
| SMA20 dist | +2.20% | ROA | 2.54% |
| SMA50 dist | -2.91% | ROE | 82.58% |
| SMA200 dist | +5.01% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.66% |
| P/E (ttm) | 27.21 | Insider ownership | 0.13% |
| Forward P/E | 37.55 | Short float | 3.29% |
| PEG (trailing) | 1.85 | Avg volume | 2,540,501 |
| P/S | 6.12 | Employees | 78,000 |
| P/B | 21.17 | Analyst rec (1=buy..5=sell) | 1.5 |

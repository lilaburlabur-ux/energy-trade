...
Signed file: `WFRD.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $91.97 (2026-08-28, ~15-min delayed) |
| Market cap | $6.59B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +51.18%; price +0.87% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 13.03, EV/Sales 1.49. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $91.97; 52w high $111.07 (-17.20%); 52w low $60.68 (+51.57%) |
| Trend | +0.87% vs SMA200, +6.17% vs SMA50, +1.58% vs SMA20 |
| Momentum | RSI(14) 55.5 (neutral) |
| Volatility | ATR(14) 3.44 (~3.7% of price); beta 0.89 |
...
| Valuation | P/E 18.14, forward P/E 13.03, P/S 1.38, P/B 3.69 | EV/Sales 1.49, EV/EBITDA 7.66 |
...
|---|---|---|---|
| Price | $91.97 | EV/Sales | 1.49 |
| Market cap | $6.59B | EV/EBITDA | 7.66 |
| Beta | 0.89 | Gross margin | 30.51% |
| RSI(14) | 55.5 | Operating margin | 10.50% |
| ATR(14) | 3.44 | Profit margin | 7.66% |
| SMA20 dist | +1.58% | ROA | 7.90% |
| SMA50 dist | +6.17% | ROE | 22.79% |
| SMA200 dist | +0.87% | Revenue (ttm) | $4.78B |
| 52W high | $111.07 | Revenue growth y/y | -8.20% |
| 52W low | $60.68 | Inst. ownership | 108.23% |
| P/E (ttm) | 18.14 | Insider ownership | 2.15% |
| Forward P/E | 13.03 | Short float | 6.33% |
| PEG (trailing) | 1.74 | Avg volume | 1,227,571 |
| P/S | 1.38 | Employees | 16,700 |
| P/B | 3.69 | Analyst rec (1=buy..5=sell) | 1.7 |

...
Signed file: `FSLR.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $191.97 (2026-09-23, ~15-min delayed) |
| Market cap | $20.63B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y -9.66%; price -15.61% vs SMA200. |
| Fresh setup quality | Poor / broken | -39.68% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 32.46%, revenue growth -3.70%. |
| Value attractiveness | Reasonable | Forward P/E 8.26, EV/Sales 3.73. |
| Risk level | High | Beta 1.73, ATR 5.2% of price, short float 11.47%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $191.97; 52w high $318.25 (-39.68%); 52w low $184.70 (+3.94%) |
| Trend | -15.61% vs SMA200, -9.85% vs SMA50, -5.56% vs SMA20 |
| Momentum | RSI(14) 39.7 (neutral) |
| Volatility | ATR(14) 9.98 (~5.2% of price); beta 1.73 |
| Setup perspective | -39.68% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 11.84, forward P/E 8.26, P/S 3.84, P/B 2.00 | EV/Sales 3.73, EV/EBITDA 8.40 |
...
- **Volatility risk:** Beta 1.73, ATR 5.2% of price, short float 11.47%. Size positions accordingly.
...
|---|---|---|---|
| Price | $191.97 | EV/Sales | 3.73 |
| Market cap | $20.63B | EV/EBITDA | 8.40 |
| Beta | 1.73 | Gross margin | 44.02% |
| RSI(14) | 39.7 | Operating margin | 42.64% |
| ATR(14) | 9.98 | Profit margin | 32.46% |
| SMA20 dist | -5.56% | ROA | 8.62% |
| SMA50 dist | -9.85% | ROE | 18.51% |
| SMA200 dist | -15.61% | Revenue (ttm) | $5.38B |
| 52W high | $318.25 | Revenue growth y/y | -3.70% |
| 52W low | $184.70 | Inst. ownership | 96.45% |
| P/E (ttm) | 11.84 | Insider ownership | 5.36% |
| Forward P/E | 8.26 | Short float | 11.47% |
| PEG (trailing) | 0.37 | Avg volume | 2,135,974 |
| P/S | 3.84 | Employees | 7,900 |
| P/B | 2.00 | Analyst rec (1=buy..5=sell) | 1.9 |

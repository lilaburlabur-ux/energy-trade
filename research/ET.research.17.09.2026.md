...
Signed file: `ET.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $21.05 (2026-09-17, ~15-min delayed) |
| Market cap | $72.48B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +28.71%; price +13.24% vs SMA200. |
| Fresh setup quality | Watch | -3.13% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 4.92%, revenue growth 78.40%. |
| Value attractiveness | Reasonable | Forward P/E 12.03, EV/Sales 1.50. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $21.05; 52w high $21.73 (-3.13%); 52w low $15.15 (+38.90%) |
| Trend | +13.24% vs SMA200, +1.92% vs SMA50, -1.52% vs SMA20 |
| Momentum | RSI(14) 47.4 (neutral) |
| Volatility | ATR(14) 0.32 (~1.5% of price); beta 0.57 |
| Setup perspective | -3.13% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 14.42, forward P/E 12.03, P/S 0.68, P/B 2.27 | EV/Sales 1.50, EV/EBITDA 9.37 |
...
|---|---|---|---|
| Price | $21.05 | EV/Sales | 1.50 |
| Market cap | $72.48B | EV/EBITDA | 9.37 |
| Beta | 0.57 | Gross margin | 17.51% |
| RSI(14) | 47.4 | Operating margin | 10.41% |
| ATR(14) | 0.32 | Profit margin | 4.92% |
| SMA20 dist | -1.52% | ROA | 5.06% |
| SMA50 dist | +1.92% | ROE | 14.56% |
| SMA200 dist | +13.24% | Revenue (ttm) | $107.38B |
| 52W high | $21.73 | Revenue growth y/y | 78.40% |
| 52W low | $15.15 | Inst. ownership | 32.51% |
| P/E (ttm) | 14.42 | Insider ownership | 10.29% |
| Forward P/E | 12.03 | Short float | 0.86% |
| PEG (trailing) | 0.64 | Avg volume | 8,549,809 |

...
Signed file: `BEP.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $29.83 (2026-09-18, ~15-min delayed) |
| Market cap | $14.54B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-4.52%) with negative half-year (-4.22%). |
...
| Value attractiveness | Reasonable | Forward P/E -15.96, EV/Sales 12.88. |
| Risk level | Moderate | Beta 0.98, ATR 3.0% of price, short float 0.61%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $29.83; 52w high $36.63 (-18.57%); 52w low $24.08 (+23.89%) |
| Trend | -4.52% vs SMA200, -6.44% vs SMA50, -3.73% vs SMA20 |
| Momentum | RSI(14) 39.5 (neutral) |
| Volatility | ATR(14) 0.89 (~3.0% of price); beta 0.98 |
...
| Valuation | P/E —, forward P/E -15.96, P/S 2.29, P/B 2.39 | EV/Sales 12.88, EV/EBITDA 27.31 |
...
|---|---|---|---|
| Price | $29.83 | EV/Sales | 12.88 |
| Market cap | $14.54B | EV/EBITDA | 27.31 |
| Beta | 0.98 | Gross margin | 51.39% |
| RSI(14) | 39.5 | Operating margin | 17.08% |
| ATR(14) | 0.89 | Profit margin | -1.26% |
| SMA20 dist | -3.73% | ROA | 0.42% |
| SMA50 dist | -6.44% | ROE | 0.40% |
| SMA200 dist | -4.52% | Revenue (ttm) | $6.36B |
| 52W high | $36.63 | Revenue growth y/y | 1.10% |
| 52W low | $24.08 | Inst. ownership | 65.46% |
| P/E (ttm) | — | Insider ownership | 0.02% |
| Forward P/E | -15.96 | Short float | 0.61% |
| PEG (trailing) | — | Avg volume | 923,577 |
| P/S | 2.29 | Employees | 5,870 |

...
Signed file: `CVX.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $205.77 (2026-08-20, ~15-min delayed) |
| Market cap | $403.64B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +40.71%; price +17.51% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.80% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.83%, revenue growth 53.50%. |
| Value attractiveness | Reasonable | Forward P/E 15.56, EV/Sales 2.09. |
| Risk level | Moderate | Beta 0.49, ATR 2.0% of price, short float 1.04%. |
...
|---|---|---|
| Chevron Jumps as Brent Crude Approaches $94 | GuruFocus.com | 2026-08-20 |
| Chevron (CVX) Could Be 5% Undervalued Following Its Angola Discovery | Simply Wall St. | 2026-08-20 |
| Crude Hits $95 and Threatens the Inflation Cooldown: 3 Energy Stocks Turning the Oil Spike Into Bigger Shareholder Payouts | 24/7 Wall St. | 2026-08-20 |
| Chevron vs. Exxon Mobil: The Better Energy Stock for the Next 5 Years | 24/7 Wall St. | 2026-08-20 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $205.77; 52w high $207.42 (-0.80%); 52w low $142.76 (+44.13%) |
| Trend | +17.51% vs SMA200, +11.94% vs SMA50, +6.21% vs SMA20 |
| Momentum | RSI(14) 71.3 (overbought) |
| Volatility | ATR(14) 4.16 (~2.0% of price); beta 0.49 |
| Setup perspective | -0.80% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 19.80, forward P/E 15.56, P/S 1.93, P/B 2.13 | EV/Sales 2.09, EV/EBITDA 8.64 |
| Growth expectations | Earnings growth 321.90%, EPS q/q 384.80% | Analyst mean target $217.88 (24 analysts) |
...
|---|---|---|---|
| Price | $205.77 | EV/Sales | 2.09 |
| Market cap | $403.64B | EV/EBITDA | 8.64 |
| Beta | 0.49 | Gross margin | 44.27% |
| RSI(14) | 71.3 | Operating margin | 21.87% |
| ATR(14) | 4.16 | Profit margin | 9.83% |
| SMA20 dist | +6.21% | ROA | 5.86% |
| SMA50 dist | +11.94% | ROE | 12.23% |
| SMA200 dist | +17.51% | Revenue (ttm) | $209.38B |
| 52W high | $207.42 | Revenue growth y/y | 53.50% |
| 52W low | $142.76 | Inst. ownership | 71.11% |
| P/E (ttm) | 19.80 | Insider ownership | 4.77% |
| Forward P/E | 15.56 | Short float | 1.04% |
| PEG (trailing) | 0.79 | Avg volume | 8,707,024 |

...
Signed file: `NXE.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $9.38 (2026-09-16, ~15-min delayed) |
| Market cap | $6.21B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-13.83%) with negative half-year (-21.44%). |
| Fresh setup quality | Poor / broken | -32.61% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -58.21, EV/Sales —. |
| Risk level | Elevated | Beta 1.67, ATR 4.8% of price, short float —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.38; 52w high $13.92 (-32.61%); 52w low $7.56 (+24.07%) |
| Trend | -13.83% vs SMA200, -5.59% vs SMA50, -9.88% vs SMA20 |
| Momentum | RSI(14) 37.5 (neutral) |
| Volatility | ATR(14) 0.45 (~4.8% of price); beta 1.67 |
| Setup perspective | -32.61% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -58.21, P/S —, P/B 4.70 | EV/Sales —, EV/EBITDA -55.23 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $19.22 (1 analysts) |
...
- **Volatility risk:** Beta 1.67, ATR 4.8% of price, short float —. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.38 | EV/Sales | — |
| Market cap | $6.21B | EV/EBITDA | -55.23 |
| Beta | 1.67 | Gross margin | 0.00% |
| RSI(14) | 37.5 | Operating margin | 0.00% |
| ATR(14) | 0.45 | Profit margin | 0.00% |
| SMA20 dist | -9.88% | ROA | -3.39% |
| SMA50 dist | -5.59% | ROE | -17.67% |
| SMA200 dist | -13.83% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.56 | Inst. ownership | 55.23% |
| P/E (ttm) | — | Insider ownership | 6.40% |
| Forward P/E | -58.21 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,035,035 |
| P/S | — | Employees | 142 |
| P/B | 4.70 | Analyst rec (1=buy..5=sell) | 1.5 |

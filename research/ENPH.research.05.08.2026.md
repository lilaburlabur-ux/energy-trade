...
Signed file: `ENPH.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $38.95 (2026-08-05, ~15-min delayed) |
| Market cap | $5.15B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +22.91%; price -2.81% vs SMA200. |
| Fresh setup quality | Poor / broken | -46.15% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 16.92, EV/Sales 3.67. |
| Risk level | High | Beta 1.65, ATR 7.8% of price, short float 20.87%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.95; 52w high $72.33 (-46.15%); 52w low $26.12 (+49.12%) |
| Trend | -2.81% vs SMA200, -20.23% vs SMA50, -3.04% vs SMA20 |
| Momentum | RSI(14) 44.0 (neutral) |
| Volatility | ATR(14) 3.03 (~7.8% of price); beta 1.65 |
| Setup perspective | -46.15% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 38.56, forward P/E 16.92, P/S 3.87, P/B 4.35 | EV/Sales 3.67, EV/EBITDA 25.42 |
| Growth expectations | Earnings growth -3.50%, EPS q/q -2.60% | Analyst mean target $47.01 (27 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 103.38% |
...
- **Volatility risk:** Beta 1.65, ATR 7.8% of price, short float 20.87%. Size positions accordingly.
...
|---|---|---|---|
| Price | $38.95 | EV/Sales | 3.67 |
| Market cap | $5.15B | EV/EBITDA | 25.42 |
| Beta | 1.65 | Gross margin | 30.04% |
| RSI(14) | 44.0 | Operating margin | 17.98% |
| ATR(14) | 3.03 | Profit margin | 10.09% |
| SMA20 dist | -3.04% | ROA | 2.38% |
| SMA50 dist | -20.23% | ROE | 13.00% |
| SMA200 dist | -2.81% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 103.38% |
| P/E (ttm) | 38.56 | Insider ownership | 3.03% |
| Forward P/E | 16.92 | Short float | 20.87% |
| PEG (trailing) | 1.08 | Avg volume | 7,284,972 |
| P/S | 3.87 | Employees | 2,872 |
| P/B | 4.35 | Analyst rec (1=buy..5=sell) | 2.5 |

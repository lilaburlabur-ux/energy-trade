...
Signed file: `ARRY.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $4.92 (2026-08-19, ~15-min delayed) |
| Market cap | $757.72M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-38.97%) with negative half-year (-57.95%). |
| Fresh setup quality | Poor / broken | -58.86% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.49, EV/Sales 1.42. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.92; 52w high $11.96 (-58.86%); 52w low $4.80 (+2.50%) |
| Trend | -38.97% vs SMA200, -22.18% vs SMA50, -6.79% vs SMA20 |
| Momentum | RSI(14) 37.5 (neutral) |
| Volatility | ATR(14) 0.37 (~7.6% of price); beta 1.79 |
| Setup perspective | -58.86% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 5.49, P/S 0.64, P/B -3.75 | EV/Sales 1.42, EV/EBITDA 14.10 |
...
|---|---|---|---|
| Price | $4.92 | EV/Sales | 1.42 |
| Market cap | $757.72M | EV/EBITDA | 14.10 |
| Beta | 1.79 | Gross margin | 26.76% |
| RSI(14) | 37.5 | Operating margin | 10.88% |
| ATR(14) | 0.37 | Profit margin | -7.25% |
| SMA20 dist | -6.79% | ROA | 3.33% |
| SMA50 dist | -22.18% | ROE | -25.98% |
| SMA200 dist | -38.97% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.80 | Inst. ownership | 148.14% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.49 | Short float | 26.42% |
| PEG (trailing) | 0.57 | Avg volume | 6,646,191 |
| P/S | 0.64 | Employees | 1,200 |
| P/B | -3.75 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `FSLR.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $214.28 (2026-08-21, ~15-min delayed) |
| Market cap | $23.03B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-8.26%) with negative half-year (-11.41%). |
...
| Value attractiveness | Reasonable | Forward P/E 9.28, EV/Sales 3.99. |
| Risk level | High | Beta 1.75, ATR 5.6% of price, short float 12.45%. |
...
|---|---|---|
| Sustainable Development ETF (SDG) Touches New 52-Week High | Zacks | 2026-08-21 |
| One company stands to gain as bankruptcy wave hits solar sector | TheStreet | 2026-08-20 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $214.28; 52w high $318.25 (-32.67%); 52w low $184.70 (+16.02%) |
| Trend | -8.26% vs SMA200, -6.83% vs SMA50, -4.27% vs SMA20 |
| Momentum | RSI(14) 42.9 (neutral) |
| Volatility | ATR(14) 11.98 (~5.6% of price); beta 1.75 |
...
| Valuation | P/E 13.20, forward P/E 9.28, P/S 4.28, P/B 2.23 | EV/Sales 3.99, EV/EBITDA 9.00 |
...
- **Volatility risk:** Beta 1.75, ATR 5.6% of price, short float 12.45%. Size positions accordingly.
...
|---|---|---|---|
| Price | $214.28 | EV/Sales | 3.99 |
| Market cap | $23.03B | EV/EBITDA | 9.00 |
| Beta | 1.75 | Gross margin | 44.02% |
| RSI(14) | 42.9 | Operating margin | 42.64% |
| ATR(14) | 11.98 | Profit margin | 32.46% |
| SMA20 dist | -4.27% | ROA | 8.62% |
| SMA50 dist | -6.83% | ROE | 18.51% |
| SMA200 dist | -8.26% | Revenue (ttm) | $5.38B |
| 52W high | $318.25 | Revenue growth y/y | -3.70% |
| 52W low | $184.70 | Inst. ownership | 97.02% |
| P/E (ttm) | 13.20 | Insider ownership | 5.36% |
| Forward P/E | 9.28 | Short float | 12.45% |
| PEG (trailing) | 0.58 | Avg volume | 2,438,220 |
| P/S | 4.28 | Employees | 7,900 |

...
Signed file: `WMB.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $70.58 (2026-09-24, ~15-min delayed) |
| Market cap | $86.33B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $70.58; 52w high $78.25 (-9.80%); 52w low $54.84 (+28.70%) |
| Trend | +0.98% vs SMA200, -2.46% vs SMA50, -3.21% vs SMA20 |
| Momentum | RSI(14) 41.7 (neutral) |
| Volatility | ATR(14) 1.83 (~2.6% of price); beta 0.62 |
| Setup perspective | -9.80% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | -3.21% | ROA | 5.03% |
| SMA50 dist | -2.46% | ROE | 21.50% |
| SMA200 dist | +0.98% | Revenue (ttm) | $12.32B |

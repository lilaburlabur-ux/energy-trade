...
Signed file: `DINO.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $105.79 (2026-09-24, ~15-min delayed) |
| Market cap | $18.81B |
...
|---|---|---|
| Technical momentum | High | 1Y +108.44%; price +54.68% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 8.95, EV/Sales 0.64. |
| Risk level | Elevated | Beta 0.69, ATR 4.5% of price, short float 6.41%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $105.79; 52w high $116.62 (-9.29%); 52w low $44.83 (+135.98%) |
| Trend | +54.68% vs SMA200, +9.72% vs SMA50, -0.91% vs SMA20 |
| Momentum | RSI(14) 53.6 (neutral) |
| Volatility | ATR(14) 4.77 (~4.5% of price); beta 0.69 |
...
| Valuation | P/E 10.08, forward P/E 8.95, P/S 0.60, P/B 1.83 | EV/Sales 0.64, EV/EBITDA 6.24 |
...
- **Volatility risk:** Beta 0.69, ATR 4.5% of price, short float 6.41%. Size positions accordingly.
...
|---|---|---|---|
| Price | $105.79 | EV/Sales | 0.64 |
| Market cap | $18.81B | EV/EBITDA | 6.24 |
| Beta | 0.69 | Gross margin | 12.89% |
| RSI(14) | 53.6 | Operating margin | 11.69% |
| ATR(14) | 4.77 | Profit margin | 6.13% |
| SMA20 dist | -0.91% | ROA | 9.16% |
| SMA50 dist | +9.72% | ROE | 19.50% |
| SMA200 dist | +54.68% | Revenue (ttm) | $31.23B |
| 52W high | $116.62 | Revenue growth y/y | 53.20% |
| 52W low | $44.83 | Inst. ownership | 89.61% |
| P/E (ttm) | 10.08 | Insider ownership | 5.49% |
| Forward P/E | 8.95 | Short float | 6.41% |
| PEG (trailing) | 1.14 | Avg volume | 2,792,019 |

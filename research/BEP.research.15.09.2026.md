...
Signed file: `BEP.research.15.09.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-7.69%) with negative half-year (-3.82%). |
...
| Value attractiveness | Reasonable | Forward P/E -15.41, EV/Sales 12.86. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $28.81; 52w high $36.63 (-21.35%); 52w low $24.08 (+19.65%) |
| Trend | -7.69% vs SMA200, -10.17% vs SMA50, -8.42% vs SMA20 |
...
| SMA20 dist | -8.42% | ROA | 0.42% |
| SMA50 dist | -10.17% | ROE | 0.40% |
| SMA200 dist | -7.69% | Revenue (ttm) | $6.36B |

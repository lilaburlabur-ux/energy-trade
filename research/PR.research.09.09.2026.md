...
Signed file: `PR.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $23.62 (2026-09-09, ~15-min delayed) |
| Market cap | $19.78B |
...
|---|---|---|
| Technical momentum | High | 1Y +78.10%; price +27.42% vs SMA200. |
| Fresh setup quality | Watch | -1.05% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Strong | Profit margin 21.52%, revenue growth 55.10%. |
| Value attractiveness | Reasonable | Forward P/E 10.58, EV/Sales 3.98. |
| Risk level | Moderate | Beta 0.48, ATR 2.6% of price, short float 2.27%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $23.62; 52w high $23.87 (-1.05%); 52w low $11.76 (+100.84%) |
| Trend | +27.42% vs SMA200, +11.31% vs SMA50, +2.67% vs SMA20 |
| Momentum | RSI(14) 61.5 (neutral) |
| Volatility | ATR(14) 0.62 (~2.6% of price); beta 0.48 |
| Setup perspective | -1.05% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 15.24, forward P/E 10.58, P/S 3.45, P/B 1.65 | EV/Sales 3.98, EV/EBITDA 5.37 |
...
|---|---|---|---|
| Price | $23.62 | EV/Sales | 3.98 |
| Market cap | $19.78B | EV/EBITDA | 5.37 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 61.5 | Operating margin | 57.44% |
| ATR(14) | 0.62 | Profit margin | 21.52% |
| SMA20 dist | +2.67% | ROA | 7.54% |
| SMA50 dist | +11.31% | ROE | 11.40% |
| SMA200 dist | +27.42% | Revenue (ttm) | $5.74B |
| 52W high | $23.87 | Revenue growth y/y | 55.10% |
| 52W low | $11.76 | Inst. ownership | 92.77% |
| P/E (ttm) | 15.24 | Insider ownership | 4.61% |
| Forward P/E | 10.58 | Short float | 2.27% |
| PEG (trailing) | 1.26 | Avg volume | 10,023,172 |

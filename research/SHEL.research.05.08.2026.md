...
Signed file: `SHEL.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $87.76 (2026-08-05, ~15-min delayed) |
| Market cap | $242.68B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +26.84%; price +9.16% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.94% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 8.76%, revenue growth 44.70%. |
| Value attractiveness | Reasonable | Forward P/E 9.93, EV/Sales 1.00. |
...
| Here’s Why Emerald Wealth Partners Cut Its Shell (SHEL) Stake | Insider Monkey | 2026-08-05 |
| Shell to invest in Surat Gas Project Central in Queensland | Offshore Technology | 2026-08-05 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $87.76; 52w high $93.30 (-5.94%); 52w low $68.73 (+27.69%) |
| Trend | +9.16% vs SMA200, +4.42% vs SMA50, +0.95% vs SMA20 |
| Momentum | RSI(14) 54.6 (neutral) |
| Volatility | ATR(14) 1.73 (~2.0% of price); beta -0.22 |
| Setup perspective | -5.94% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 9.71, forward P/E 9.93, P/S 0.82, P/B 1.35 | EV/Sales 1.00, EV/EBITDA 5.14 |
...
| Mawer Investment Management Ltd. | 7,120,336 | 0.26% | 2026-03-31 |
...
|---|---|---|---|
| Price | $87.76 | EV/Sales | 1.00 |
| Market cap | $242.68B | EV/EBITDA | 5.14 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 54.6 | Operating margin | 16.69% |
| ATR(14) | 1.73 | Profit margin | 8.76% |
| SMA20 dist | +0.95% | ROA | 6.40% |
| SMA50 dist | +4.42% | ROE | 14.34% |
| SMA200 dist | +9.16% | Revenue (ttm) | $296.60B |
| 52W high | $93.30 | Revenue growth y/y | 44.70% |
| 52W low | $68.73 | Inst. ownership | 13.79% |
| P/E (ttm) | 9.71 | Insider ownership | 0.00% |
| Forward P/E | 9.93 | Short float | 1.82% |
| PEG (trailing) | 1.34 | Avg volume | 6,938,050 |
| P/S | 0.82 | Employees | 84,000 |
| P/B | 1.35 | Analyst rec (1=buy..5=sell) | 2.2 |

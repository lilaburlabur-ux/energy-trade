...
Signed file: `OKLO.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $38.04 (2026-09-25, ~15-min delayed) |
| Market cap | $7.08B |
...
| Value attractiveness | Reasonable | Forward P/E -36.78, EV/Sales 3,814.13. |
...
| FCEL vs. OKLO: Comparing Two Data Center-Linked Power Plays | Zacks | 2026-09-25 |
| The Math Doesn't Lie: What Oklo's Stock Sales Actually Cost Investors | Motley Fool | 2026-09-25 |
| NuScale Power Stock Is Just One Of 3 Top Nuclear Stocks | Simply Wall St. | 2026-09-24 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.04; 52w high $174.14 (-78.16%); 52w low $35.62 (+6.79%) |
| Trend | -37.56% vs SMA200, -7.78% vs SMA50, -2.85% vs SMA20 |
| Momentum | RSI(14) 44.9 (neutral) |
| Volatility | ATR(14) 2.54 (~6.7% of price); beta 1.20 |
| Setup perspective | -78.16% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -36.78, P/S 5,848.03, P/B 2.15 | EV/Sales 3,814.13, EV/EBITDA -21.29 |
...
- **Volatility risk:** Beta 1.20, ATR 6.7% of price, short float 20.52%. Size positions accordingly.
...
| SMA20 dist | -2.85% | ROA | -6.65% |
| SMA50 dist | -7.78% | ROE | -7.70% |
| SMA200 dist | -37.56% | Revenue (ttm) | $1.21M |
...
|---|---|---|---|
| 2026-09-25 | main | UBS | Neutral → Neutral |

...
Signed file: `WFRD.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $84.66 (2026-09-23, ~15-min delayed) |
| Market cap | $6.05B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-8.59%) with negative half-year (-7.00%). |
| Fresh setup quality | Moderate / wait | -23.78% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 7.66%, revenue growth -8.20%. |
| Value attractiveness | Reasonable | Forward P/E 11.99, EV/Sales 1.38. |
| Risk level | Elevated | Beta 0.90, ATR 4.2% of price, short float 6.87%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $84.66; 52w high $111.07 (-23.78%); 52w low $60.73 (+39.41%) |
| Trend | -8.59% vs SMA200, -4.15% vs SMA50, -5.56% vs SMA20 |
| Momentum | RSI(14) 41.9 (neutral) |
| Volatility | ATR(14) 3.54 (~4.2% of price); beta 0.90 |
| Setup perspective | -23.78% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 16.70, forward P/E 11.99, P/S 1.27, P/B 3.40 | EV/Sales 1.38, EV/EBITDA 7.10 |
...
- **Volatility risk:** Beta 0.90, ATR 4.2% of price, short float 6.87%. Size positions accordingly.
...
|---|---|---|---|
| Price | $84.66 | EV/Sales | 1.38 |
| Market cap | $6.05B | EV/EBITDA | 7.10 |
| Beta | 0.90 | Gross margin | 30.51% |
| RSI(14) | 41.9 | Operating margin | 10.50% |
| ATR(14) | 3.54 | Profit margin | 7.66% |
| SMA20 dist | -5.56% | ROA | 7.90% |
| SMA50 dist | -4.15% | ROE | 22.79% |
| SMA200 dist | -8.59% | Revenue (ttm) | $4.78B |
| 52W high | $111.07 | Revenue growth y/y | -8.20% |
| 52W low | $60.73 | Inst. ownership | 106.72% |
| P/E (ttm) | 16.70 | Insider ownership | 2.12% |
| Forward P/E | 11.99 | Short float | 6.87% |
| PEG (trailing) | 1.28 | Avg volume | 1,212,953 |
| P/S | 1.27 | Employees | 16,700 |
| P/B | 3.40 | Analyst rec (1=buy..5=sell) | 1.7 |

## 8. Analyst Actions
| Date | Action | Firm | Rating change |
|---|---|---|---|
| 2026-09-23 | main | UBS | Buy → Buy |

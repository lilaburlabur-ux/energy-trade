...
Signed file: `WFRD.research.04.09.2026`

| Field | Value |
|---|---|
| Current price | $95.88 (2026-09-04, ~15-min delayed) |
| Market cap | $6.86B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +54.82%; price +4.35% vs SMA200. |
| Fresh setup quality | Moderate / wait | -13.68% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 7.66%, revenue growth -8.20%. |
| Value attractiveness | Reasonable | Forward P/E 13.58, EV/Sales 1.56. |
| Risk level | Elevated | Beta 0.90, ATR 3.7% of price, short float 6.33%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $95.88; 52w high $111.07 (-13.68%); 52w low $60.68 (+58.02%) |
| Trend | +4.35% vs SMA200, +9.63% vs SMA50, +3.15% vs SMA20 |
| Momentum | RSI(14) 58.1 (neutral) |
| Volatility | ATR(14) 3.59 (~3.7% of price); beta 0.90 |
| Setup perspective | -13.68% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.91, forward P/E 13.58, P/S 1.44, P/B 3.85 | EV/Sales 1.56, EV/EBITDA 8.00 |
| Growth expectations | Earnings growth -71.00%, EPS q/q -71.30% | Analyst mean target $116.92 (12 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 106.83% |
...
- **Volatility risk:** Beta 0.90, ATR 3.7% of price, short float 6.33%. Size positions accordingly.
...
|---|---|---|---|
| Price | $95.88 | EV/Sales | 1.56 |
| Market cap | $6.86B | EV/EBITDA | 8.00 |
| Beta | 0.90 | Gross margin | 30.51% |
| RSI(14) | 58.1 | Operating margin | 10.50% |
| ATR(14) | 3.59 | Profit margin | 7.66% |
| SMA20 dist | +3.15% | ROA | 7.90% |
| SMA50 dist | +9.63% | ROE | 22.79% |
| SMA200 dist | +4.35% | Revenue (ttm) | $4.78B |
| 52W high | $111.07 | Revenue growth y/y | -8.20% |
| 52W low | $60.68 | Inst. ownership | 106.83% |
| P/E (ttm) | 18.91 | Insider ownership | 2.12% |
| Forward P/E | 13.58 | Short float | 6.33% |
| PEG (trailing) | 1.44 | Avg volume | 1,247,617 |
| P/S | 1.44 | Employees | 16,700 |

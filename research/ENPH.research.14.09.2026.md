...
Signed file: `ENPH.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $36.66 (2026-09-14, ~15-min delayed) |
| Market cap | $4.84B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-10.58%) with negative half-year (-16.81%). |
| Fresh setup quality | Poor / broken | -49.32% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 16.12, EV/Sales 3.37. |
| Risk level | High | Beta 1.64, ATR 5.8% of price, short float 21.29%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.66; 52w high $72.33 (-49.32%); 52w low $26.12 (+40.35%) |
| Trend | -10.58% vs SMA200, -6.88% vs SMA50, -1.93% vs SMA20 |
| Momentum | RSI(14) 44.7 (neutral) |
| Volatility | ATR(14) 2.14 (~5.8% of price); beta 1.64 |
| Setup perspective | -49.32% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 36.30, forward P/E 16.12, P/S 3.65, P/B 4.10 | EV/Sales 3.37, EV/EBITDA 23.35 |
| Growth expectations | Earnings growth -3.50%, EPS q/q -2.60% | Analyst mean target $53.23 (27 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 96.66% |
...
- **Volatility risk:** Beta 1.64, ATR 5.8% of price, short float 21.29%. Size positions accordingly.
...
|---|---|---|---|
| Price | $36.66 | EV/Sales | 3.37 |
| Market cap | $4.84B | EV/EBITDA | 23.35 |
| Beta | 1.64 | Gross margin | 30.04% |
| RSI(14) | 44.7 | Operating margin | 17.98% |
| ATR(14) | 2.14 | Profit margin | 10.09% |
| SMA20 dist | -1.93% | ROA | 2.38% |
| SMA50 dist | -6.88% | ROE | 13.00% |
| SMA200 dist | -10.58% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 96.66% |
| P/E (ttm) | 36.30 | Insider ownership | 3.03% |
| Forward P/E | 16.12 | Short float | 21.29% |
| PEG (trailing) | 0.78 | Avg volume | 5,079,569 |
| P/S | 3.65 | Employees | 2,872 |
| P/B | 4.10 | Analyst rec (1=buy..5=sell) | 2.4 |

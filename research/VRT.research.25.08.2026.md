...
Signed file: `VRT.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $255.75 (2026-08-25, ~15-min delayed) |
| Market cap | $98.46B |
...
|---|---|---|
| Technical momentum | High | 1Y +103.25%; price +0.77% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 28.11, EV/Sales 8.57. |
| Risk level | High | Beta 2.08, ATR 6.3% of price, short float 3.21%. |
...
|---|---|---|
| Autodesk to Report Q2 Earnings: What's in the Cards for the Stock? | Zacks | 2026-08-25 |
| 4 Stocks With Solid Interest Coverage Ratios to Buy Amid Volatility | Zacks | 2026-08-25 |
| Boeing and 9 More Stocks for Manufacturing’s Revival, From Our Roundtable Pros | Barrons.com | 2026-08-24 |
| SentinelOne to Report Q2 Earnings: What's in Store for the Stock? | Zacks | 2026-08-24 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $255.75; 52w high $376.15 (-32.01%); 52w low $121.69 (+110.17%) |
| Trend | +0.77% vs SMA200, -12.44% vs SMA50, -4.12% vs SMA20 |
| Momentum | RSI(14) 40.1 (neutral) |
| Volatility | ATR(14) 16.10 (~6.3% of price); beta 2.08 |
...
| Valuation | P/E 57.99, forward P/E 28.11, P/S 8.58, P/B 20.69 | EV/Sales 8.57, EV/EBITDA 36.73 |
| Growth expectations | Earnings growth 53.00%, EPS q/q 53.50% | Analyst mean target $338.15 (26 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 84.41% |
...
- **Valuation risk:** Forward P/E 28.11, EV/Sales 8.57. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.08, ATR 6.3% of price, short float 3.21%. Size positions accordingly.
...
|---|---|---|---|
| Price | $255.75 | EV/Sales | 8.57 |
| Market cap | $98.46B | EV/EBITDA | 36.73 |
| Beta | 2.08 | Gross margin | 38.04% |
| RSI(14) | 40.1 | Operating margin | 20.36% |
| ATR(14) | 16.10 | Profit margin | 15.09% |
| SMA20 dist | -4.12% | ROA | 10.89% |
| SMA50 dist | -12.44% | ROE | 43.94% |
| SMA200 dist | +0.77% | Revenue (ttm) | $11.48B |
| 52W high | $376.15 | Revenue growth y/y | 24.10% |
| 52W low | $121.69 | Inst. ownership | 84.41% |
| P/E (ttm) | 57.99 | Insider ownership | 0.27% |
| Forward P/E | 28.11 | Short float | 3.21% |
| PEG (trailing) | 1.20 | Avg volume | 6,119,255 |
| P/S | 8.58 | Employees | 34,000 |
| P/B | 20.69 | Analyst rec (1=buy..5=sell) | 1.4 |

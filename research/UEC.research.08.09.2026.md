...
Signed file: `UEC.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $11.89 (2026-09-08, ~15-min delayed) |
| Market cap | $5.88B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-10.39%) with negative half-year (-12.32%). |
| Fresh setup quality | Poor / broken | -40.96% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -132.11, EV/Sales 258.65. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.89; 52w high $20.14 (-40.96%); 52w low $9.04 (+31.53%) |
| Trend | -10.39% vs SMA200, +9.76% vs SMA50, -0.17% vs SMA20 |
| Momentum | RSI(14) 52.8 (neutral) |
| Volatility | ATR(14) 0.67 (~5.6% of price); beta 1.24 |
| Setup perspective | -40.96% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -132.11, P/S 291.29, P/B 4.13 | EV/Sales 258.65, EV/EBITDA -43.26 |
...
|---|---|---|---|
| Price | $11.89 | EV/Sales | 258.65 |
| Market cap | $5.88B | EV/EBITDA | -43.26 |
| Beta | 1.24 | Gross margin | 0.00% |
| RSI(14) | 52.8 | Operating margin | -629.66% |
| ATR(14) | 0.67 | Profit margin | 0.00% |
| SMA20 dist | -0.17% | ROA | -6.25% |
| SMA50 dist | +9.76% | ROE | -8.96% |
| SMA200 dist | -10.39% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 88.54% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -132.11 | Short float | 14.55% |
| PEG (trailing) | — | Avg volume | 9,496,417 |
| P/S | 291.29 | Employees | 171 |
| P/B | 4.13 | Analyst rec (1=buy..5=sell) | 1.4 |

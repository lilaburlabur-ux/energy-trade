...
Signed file: `HAL.research.13.08.2026`

| Field | Value |
|---|---|
| Current price | $32.84 (2026-08-13, ~15-min delayed) |
| Market cap | $27.36B |
...
|---|---|---|
| Technical momentum | High | 1Y +60.24%; price -3.21% vs SMA200. |
| Fresh setup quality | Moderate / wait | -23.27% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 7.16%, revenue growth 3.70%. |
| Value attractiveness | Reasonable | Forward P/E 11.30, EV/Sales 1.52. |
| Risk level | Moderate | Beta 0.75, ATR 3.0% of price, short float 5.76%. |
...
| Centuri hires Halliburton alum for CFO | CFO Dive | 2026-08-13 |
| Halliburton (HAL) Stock May Be Undervalued Even After A 94% Run | Simply Wall St. | 2026-08-13 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $32.84; 52w high $42.80 (-23.27%); 52w low $20.62 (+59.25%) |
| Trend | -3.21% vs SMA200, -5.66% vs SMA50, +0.26% vs SMA20 |
| Momentum | RSI(14) 46.5 (neutral) |
| Volatility | ATR(14) 0.98 (~3.0% of price); beta 0.75 |
| Setup perspective | -23.27% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 17.19, forward P/E 11.30, P/S 1.22, P/B 2.49 | EV/Sales 1.52, EV/EBITDA 8.20 |
...
|---|---|---|---|
| Price | $32.84 | EV/Sales | 1.52 |
| Market cap | $27.36B | EV/EBITDA | 8.20 |
| Beta | 0.75 | Gross margin | 15.08% |
| RSI(14) | 46.5 | Operating margin | 12.79% |
| ATR(14) | 0.98 | Profit margin | 7.16% |
| SMA20 dist | +0.26% | ROA | 7.26% |
| SMA50 dist | -5.66% | ROE | 14.92% |
| SMA200 dist | -3.21% | Revenue (ttm) | $22.37B |
| 52W high | $42.80 | Revenue growth y/y | 3.70% |
| 52W low | $20.62 | Inst. ownership | 86.58% |
| P/E (ttm) | 17.19 | Insider ownership | 0.43% |
| Forward P/E | 11.30 | Short float | 5.76% |
| PEG (trailing) | 0.82 | Avg volume | 11,965,535 |
| P/S | 1.22 | Employees | 46,000 |
| P/B | 2.49 | Analyst rec (1=buy..5=sell) | 1.8 |

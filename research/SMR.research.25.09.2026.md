...
Signed file: `SMR.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $8.42 (2026-09-25, ~15-min delayed) |
| Market cap | $3.46B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-31.23%) with negative half-year (-23.38%). |
| Fresh setup quality | Poor / broken | -84.24% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -12.76, EV/Sales 221.04. |
...
|---|---|---|
| 3 Nuclear Stocks Powering the Grid Long Before AI Made Them Trendy | Motley Fool | 2026-09-25 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $8.42; 52w high $53.43 (-84.24%); 52w low $7.59 (+10.94%) |
| Trend | -31.23% vs SMA200, -7.12% vs SMA50, -8.17% vs SMA20 |
| Momentum | RSI(14) 43.9 (neutral) |
| Volatility | ATR(14) 0.65 (~7.8% of price); beta 2.31 |
| Setup perspective | -84.24% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -12.76, P/S 323.24, P/B 1.68 | EV/Sales 221.04, EV/EBITDA -10.54 |
...
- **Volatility risk:** Beta 2.31, ATR 7.8% of price, short float 20.64%. Size positions accordingly.
...
|---|---|---|---|
| Price | $8.42 | EV/Sales | 221.04 |
| Market cap | $3.46B | EV/EBITDA | -10.54 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 43.9 | Operating margin | -85337.33% |
| ATR(14) | 0.65 | Profit margin | 0.00% |
| SMA20 dist | -8.17% | ROA | -10.60% |
| SMA50 dist | -7.12% | ROE | -55.18% |
| SMA200 dist | -31.23% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.47% |
| P/E (ttm) | — | Insider ownership | 1.70% |
| Forward P/E | -12.76 | Short float | 20.64% |
| PEG (trailing) | — | Avg volume | 33,269,550 |
| P/S | 323.24 | Employees | 428 |
| P/B | 1.68 | Analyst rec (1=buy..5=sell) | 2.7 |

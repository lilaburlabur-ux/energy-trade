...
Signed file: `RUN.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $9.26 (2026-08-18, ~15-min delayed) |
| Market cap | $2.23B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-38.95%) with negative half-year (-52.12%). |
| Fresh setup quality | Poor / broken | -56.75% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 11.59%, revenue growth 52.80%. |
| Value attractiveness | Reasonable | Forward P/E 9.39, EV/Sales 5.35. |
| Risk level | High | Beta 2.39, ATR 7.7% of price, short float 32.19%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.26; 52w high $21.41 (-56.75%); 52w low $9.26 (+0.00%) |
| Trend | -38.95% vs SMA200, -20.47% vs SMA50, -7.44% vs SMA20 |
| Momentum | RSI(14) 37.1 (neutral) |
| Volatility | ATR(14) 0.72 (~7.7% of price); beta 2.39 |
| Setup perspective | -56.75% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 6.30, forward P/E 9.39, P/S 0.64, P/B 0.65 | EV/Sales 5.35, EV/EBITDA 22.12 |
| Growth expectations | Earnings growth -60.70%, EPS q/q -58.80% | Analyst mean target $16.39 (19 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 116.83% |
...
- **Volatility risk:** Beta 2.39, ATR 7.7% of price, short float 32.19%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.26 | EV/Sales | 5.35 |
| Market cap | $2.23B | EV/EBITDA | 22.12 |
| Beta | 2.39 | Gross margin | 35.29% |
| RSI(14) | 37.1 | Operating margin | 4.00% |
| ATR(14) | 0.72 | Profit margin | 11.59% |
| SMA20 dist | -7.44% | ROA | 0.26% |
| SMA50 dist | -20.47% | ROE | -19.86% |
| SMA200 dist | -38.95% | Revenue (ttm) | $3.48B |
| 52W high | $21.41 | Revenue growth y/y | 52.80% |
| 52W low | $9.26 | Inst. ownership | 116.83% |
| P/E (ttm) | 6.30 | Insider ownership | 2.82% |
| Forward P/E | 9.39 | Short float | 32.19% |
| PEG (trailing) | 3.07 | Avg volume | 10,123,783 |

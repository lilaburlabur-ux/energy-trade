...
Signed file: `RUN.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $10.49 (2026-08-05, ~15-min delayed) |
| Market cap | $2.50B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-32.89%) with negative half-year (-43.21%). |
| Fresh setup quality | Poor / broken | -51.00% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 17.88%, revenue growth 43.20%. |
| Value attractiveness | Reasonable | Forward P/E 10.41, EV/Sales 5.76. |
| Risk level | High | Beta 2.39, ATR 7.0% of price, short float 33.17%. |
...
|---|---|---|
| Sunrun’s (NASDAQ:RUN) Q2 CY2026: Strong Sales But Stock Drops 12% | StockStory | 2026-08-05 |
...
| Tesla's Build-Out Now Costs More Cash Than The Business Generates | Trefis | 2026-08-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.49; 52w high $21.41 (-51.00%); 52w low $9.07 (+15.66%) |
| Trend | -32.89% vs SMA200, -16.75% vs SMA50, -5.24% vs SMA20 |
| Momentum | RSI(14) 41.8 (neutral) |
| Volatility | ATR(14) 0.74 (~7.0% of price); beta 2.39 |
| Setup perspective | -51.00% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 4.92, forward P/E 10.41, P/S 0.79, P/B 0.74 | EV/Sales 5.76, EV/EBITDA 26.50 |
| Growth expectations | Earnings growth 214.40%, EPS q/q 235.20% | Analyst mean target $18.84 (19 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 112.81% |
...
- **Volatility risk:** Beta 2.39, ATR 7.0% of price, short float 33.17%. Size positions accordingly.
...
|---|---|---|---|
| Price | $10.49 | EV/Sales | 5.76 |
| Market cap | $2.50B | EV/EBITDA | 26.50 |
| Beta | 2.39 | Gross margin | 32.07% |
| RSI(14) | 41.8 | Operating margin | -6.02% |
| ATR(14) | 0.74 | Profit margin | 17.88% |
| SMA20 dist | -5.24% | ROA | -0.16% |
| SMA50 dist | -16.75% | ROE | -22.74% |
| SMA200 dist | -32.89% | Revenue (ttm) | $3.17B |
| 52W high | $21.41 | Revenue growth y/y | 43.20% |
| 52W low | $9.07 | Inst. ownership | 112.81% |
| P/E (ttm) | 4.92 | Insider ownership | 2.87% |
| Forward P/E | 10.41 | Short float | 33.17% |
| PEG (trailing) | 3.07 | Avg volume | 10,056,426 |
| P/S | 0.79 | Employees | 9,059 |

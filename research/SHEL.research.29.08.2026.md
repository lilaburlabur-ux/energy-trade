...
Signed file: `SHEL.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $90.91 (2026-08-29, ~15-min delayed) |
| Market cap | $250.23B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +27.92%; price +11.81% vs SMA200. |
| Fresh setup quality | Watch | -2.93% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 8.76%, revenue growth 44.70%. |
| Value attractiveness | Reasonable | Forward P/E 10.31, EV/Sales 1.00. |
| Risk level | Moderate | Beta -0.22, ATR 1.5% of price, short float 1.57%. |
...
|---|---|---|
| Can TotalEnergies (TTE)’s Shell (SHELL) Deal Unlock More Growth? | Insider Monkey | 2026-08-28 |
| Potential Bidders Are Looking at Shell’s Chemical Assets. How Investors Should View a Potential Sale. | Barchart | 2026-08-27 |
| Sector Update: Energy Stocks Mixed Late Afternoon | MT Newswires | 2026-08-27 |
| Shell's CEO Warned Oil Prices Would Keep Rising. Hormuz Talks Are Testing That Call. Here's What It Means for SHEL Stock. | Motley Fool | 2026-08-27 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $90.91; 52w high $93.65 (-2.93%); 52w low $68.25 (+33.20%) |
| Trend | +11.81% vs SMA200, +6.17% vs SMA50, +0.34% vs SMA20 |
| Momentum | RSI(14) 55.8 (neutral) |
| Volatility | ATR(14) 1.37 (~1.5% of price); beta -0.22 |
| Setup perspective | -2.93% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 10.06, forward P/E 10.31, P/S 0.84, P/B 1.40 | EV/Sales 1.00, EV/EBITDA 5.13 |
| Growth expectations | Earnings growth 220.00%, EPS q/q 200.50% | Analyst mean target $97.77 (15 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 13.96% |
...
|---|---|---|---|
| Price | $90.91 | EV/Sales | 1.00 |
| Market cap | $250.23B | EV/EBITDA | 5.13 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 55.8 | Operating margin | 16.69% |
| ATR(14) | 1.37 | Profit margin | 8.76% |
| SMA20 dist | +0.34% | ROA | 6.40% |
| SMA50 dist | +6.17% | ROE | 14.34% |
| SMA200 dist | +11.81% | Revenue (ttm) | $296.60B |
| 52W high | $93.65 | Revenue growth y/y | 44.70% |
| 52W low | $68.25 | Inst. ownership | 13.96% |
| P/E (ttm) | 10.06 | Insider ownership | 0.01% |
| Forward P/E | 10.31 | Short float | 1.57% |
| PEG (trailing) | 1.35 | Avg volume | 6,336,054 |
| P/S | 0.84 | Employees | 84,000 |
| P/B | 1.40 | Analyst rec (1=buy..5=sell) | 2.2 |
...
| 2026-03-12 | main | Piper Sandler | Overweight → Overweight |

...
Signed file: `ETR.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $107.84 (2026-08-14, ~15-min delayed) |
| Market cap | $50.32B |
...
- **Valuation risk:** Forward P/E 21.15, EV/Sales 6.01. Multiple compression is the main downside if growth disappoints.
...
| Forward P/E | 21.15 | Short float | 4.91% |
| PEG (trailing) | 1.88 | Avg volume | 3,167,106 |

...
Signed file: `SEDG.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $35.61 (2026-09-21, ~15-min delayed) |
| Market cap | $2.19B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-15.42%) with negative half-year (-31.16%). |
...
| Value attractiveness | Low (expensive) | Forward P/E 41.40, EV/Sales 1.50. |
| Risk level | High | Beta 1.44, ATR 7.8% of price, short float 25.50%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $35.61; 52w high $78.51 (-54.64%); 52w low $28.47 (+25.08%) |
| Trend | -15.42% vs SMA200, -6.10% vs SMA50, +4.85% vs SMA20 |
| Momentum | RSI(14) 50.7 (neutral) |
| Volatility | ATR(14) 2.79 (~7.8% of price); beta 1.44 |
| Setup perspective | -54.64% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 41.40, P/S 1.64, P/B 5.32 | EV/Sales 1.50, EV/EBITDA -16.47 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $39.55 (20 analysts) |
...
- **Valuation risk:** Forward P/E 41.40, EV/Sales 1.50. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.44, ATR 7.8% of price, short float 25.50%. Size positions accordingly.
...
|---|---|---|---|
| Price | $35.61 | EV/Sales | 1.50 |
| Market cap | $2.19B | EV/EBITDA | -16.47 |
| Beta | 1.44 | Gross margin | 21.25% |
| RSI(14) | 50.7 | Operating margin | -6.51% |
| ATR(14) | 2.79 | Profit margin | -20.29% |
| SMA20 dist | +4.85% | ROA | -3.84% |
| SMA50 dist | -6.10% | ROE | -58.42% |
| SMA200 dist | -15.42% | Revenue (ttm) | $1.33B |
| 52W high | $78.51 | Revenue growth y/y | 19.60% |
| 52W low | $28.47 | Inst. ownership | 101.66% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 41.40 | Short float | 25.50% |
| PEG (trailing) | — | Avg volume | 3,109,625 |
| P/S | 1.64 | Employees | 3,576 |
| P/B | 5.32 | Analyst rec (1=buy..5=sell) | 3.0 |

## 8. Analyst Actions
| Date | Action | Firm | Rating change |
|---|---|---|---|
| 2026-09-21 | main | Citigroup | Sell → Sell |

...
Signed file: `NXE.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $10.55 (2026-08-12, ~15-min delayed) |
| Market cap | $6.98B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-1.07%) with negative half-year (-9.91%). |
...
| Value attractiveness | Reasonable | Forward P/E -64.47, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.55; 52w high $13.92 (-24.21%); 52w low $6.46 (+63.31%) |
| Trend | -1.07% vs SMA200, +7.44% vs SMA50, +10.56% vs SMA20 |
| Momentum | RSI(14) 62.8 (neutral) |
| Volatility | ATR(14) 0.45 (~4.2% of price); beta 1.65 |
...
| Valuation | P/E —, forward P/E -64.47, P/S —, P/B 5.78 | EV/Sales —, EV/EBITDA -62.02 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $19.29 (1 analysts) |
...
|---|---|---|---|
| Price | $10.55 | EV/Sales | — |
| Market cap | $6.98B | EV/EBITDA | -62.02 |
| Beta | 1.65 | Gross margin | 0.00% |
| RSI(14) | 62.8 | Operating margin | 0.00% |
| ATR(14) | 0.45 | Profit margin | 0.00% |
| SMA20 dist | +10.56% | ROA | -3.39% |
| SMA50 dist | +7.44% | ROE | -17.67% |
| SMA200 dist | -1.07% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $6.46 | Inst. ownership | 54.62% |
| P/E (ttm) | — | Insider ownership | 6.39% |
| Forward P/E | -64.47 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,484,240 |
| P/S | — | Employees | 142 |
| P/B | 5.78 | Analyst rec (1=buy..5=sell) | 1.5 |

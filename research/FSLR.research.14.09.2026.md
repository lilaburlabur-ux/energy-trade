...
Signed file: `FSLR.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $207.04 (2026-09-14, ~15-min delayed) |
| Market cap | $22.25B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $207.04; 52w high $318.25 (-34.94%); 52w low $184.70 (+12.10%) |
| Trend | -9.79% vs SMA200, -4.39% vs SMA50, -0.93% vs SMA20 |
| Momentum | RSI(14) 45.6 (neutral) |
| Volatility | ATR(14) 9.59 (~4.6% of price); beta 1.73 |
| Setup perspective | -34.94% from 52w high — base needs to rebuild. |
...
| SMA20 dist | -0.93% | ROA | 8.62% |
| SMA50 dist | -4.39% | ROE | 18.51% |
| SMA200 dist | -9.79% | Revenue (ttm) | $5.38B |
| 52W high | $318.25 | Revenue growth y/y | -3.70% |
| 52W low | $184.70 | Inst. ownership | 96.44% |
| P/E (ttm) | 12.76 | Insider ownership | 5.36% |
| Forward P/E | 8.94 | Short float | 11.47% |
| PEG (trailing) | 0.39 | Avg volume | 2,139,427 |

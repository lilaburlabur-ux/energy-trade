...
Signed file: `BEP.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $30.39 (2026-09-11, ~15-min delayed) |
| Market cap | $14.81B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $30.39; 52w high $36.63 (-17.04%); 52w low $24.08 (+26.21%) |
| Trend | -2.57% vs SMA200, -5.75% vs SMA50, -4.92% vs SMA20 |
| Momentum | RSI(14) 37.5 (neutral) |
| Volatility | ATR(14) 0.89 (~2.9% of price); beta 0.98 |
| Setup perspective | -17.04% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E -16.26, P/S 2.33, P/B 2.44 | EV/Sales 12.97, EV/EBITDA 27.50 |

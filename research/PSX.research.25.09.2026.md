...
Signed file: `PSX.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $255.75 (2026-09-25, ~15-min delayed) |
| Market cap | $102.05B |
...
|---|---|---|
| Technical momentum | High | 1Y +92.78%; price +42.52% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.73% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 4.66%, revenue growth 53.10%. |
| Value attractiveness | Reasonable | Forward P/E 10.27, EV/Sales 0.79. |
| Risk level | Elevated | Beta 0.70, ATR 3.4% of price, short float 1.96%. |
...
|---|---|---|
| Phillips 66 (PSX) Stock May Be Below Fair Value On Cash Flow | Simply Wall St. | 2026-09-25 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $255.75; 52w high $274.21 (-6.73%); 52w low $123.11 (+107.73%) |
| Trend | +42.52% vs SMA200, +8.70% vs SMA50, -1.01% vs SMA20 |
| Momentum | RSI(14) 55.2 (neutral) |
| Volatility | ATR(14) 8.62 (~3.4% of price); beta 0.70 |
| Setup perspective | -6.73% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 14.59, forward P/E 10.27, P/S 0.67, P/B 3.24 | EV/Sales 0.79, EV/EBITDA 12.07 |
...
- **Volatility risk:** Beta 0.70, ATR 3.4% of price, short float 1.96%. Size positions accordingly.
...
|---|---|---|---|
| Price | $255.75 | EV/Sales | 0.79 |
| Market cap | $102.05B | EV/EBITDA | 12.07 |
| Beta | 0.70 | Gross margin | 13.10% |
| RSI(14) | 55.2 | Operating margin | 8.53% |
| ATR(14) | 8.62 | Profit margin | 4.66% |
| SMA20 dist | -1.01% | ROA | 6.04% |
| SMA50 dist | +8.70% | ROE | 23.45% |
| SMA200 dist | +42.52% | Revenue (ttm) | $152.17B |
| 52W high | $274.21 | Revenue growth y/y | 53.10% |
| 52W low | $123.11 | Inst. ownership | 80.53% |
| P/E (ttm) | 14.59 | Insider ownership | 0.21% |
| Forward P/E | 10.27 | Short float | 1.96% |
| PEG (trailing) | 0.82 | Avg volume | 2,895,649 |

...
Signed file: `PWR.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $639.34 (2026-08-21, ~15-min delayed) |
| Market cap | $96.12B |
...
|---|---|---|
| Technical momentum | High | 1Y +70.24%; price +10.40% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 32.55, EV/Sales 3.21. |
| Risk level | Elevated | Beta 1.22, ATR 4.7% of price, short float 2.36%. |
...
|---|---|---|
| MasTec vs. Quanta: Which Infrastructure Stock Is a Better Buy? | Zacks | 2026-08-21 |
| Is Quanta's Capital Strategy Creating More Than Earnings Growth? | Zacks | 2026-08-21 |
| Are Wall Street Analysts Bullish on Quanta Services Stock? | Barchart | 2026-08-21 |
| How Superior Strengthens MasTec's Data Center Opportunity | Zacks | 2026-08-20 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $639.34; 52w high $785.12 (-18.57%); 52w low $372.18 (+71.78%) |
| Trend | +10.40% vs SMA200, -4.82% vs SMA50, -3.54% vs SMA20 |
| Momentum | RSI(14) 43.7 (neutral) |
| Volatility | ATR(14) 30.07 (~4.7% of price); beta 1.22 |
...
| Valuation | P/E 73.15, forward P/E 32.55, P/S 2.92, P/B 9.97 | EV/Sales 3.21, EV/EBITDA 34.74 |
...
- **Valuation risk:** Forward P/E 32.55, EV/Sales 3.21. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.22, ATR 4.7% of price, short float 2.36%. Size positions accordingly.
...
|---|---|---|---|
| Price | $639.34 | EV/Sales | 3.21 |
| Market cap | $96.12B | EV/EBITDA | 34.74 |
| Beta | 1.22 | Gross margin | 15.46% |
| RSI(14) | 43.7 | Operating margin | 7.22% |
| ATR(14) | 30.07 | Profit margin | 4.03% |
| SMA20 dist | -3.54% | ROA | 5.23% |
| SMA50 dist | -4.82% | ROE | 15.34% |
| SMA200 dist | +10.40% | Revenue (ttm) | $32.91B |
| 52W high | $785.12 | Revenue growth y/y | 41.10% |
| 52W low | $372.18 | Inst. ownership | 94.86% |
| P/E (ttm) | 73.15 | Insider ownership | 0.67% |
| Forward P/E | 32.55 | Short float | 2.36% |
| PEG (trailing) | 1.82 | Avg volume | 1,224,975 |
| P/S | 2.92 | Employees | 69,500 |
| P/B | 9.97 | Analyst rec (1=buy..5=sell) | 1.5 |

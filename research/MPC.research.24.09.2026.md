...
Signed file: `MPC.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $390.95 (2026-09-24, ~15-min delayed) |
| Market cap | $114.13B |
...
|---|---|---|
| Technical momentum | High | 1Y +112.27%; price +54.48% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 8.29, EV/Sales 0.92. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $390.95; 52w high $424.89 (-7.99%); 52w low $160.76 (+143.18%) |
| Trend | +54.48% vs SMA200, +10.88% vs SMA50, -0.39% vs SMA20 |
| Momentum | RSI(14) 55.0 (neutral) |
| Volatility | ATR(14) 14.64 (~3.7% of price); beta 0.53 |
...
| Valuation | P/E 13.55, forward P/E 8.29, P/S 0.74, P/B 5.80 | EV/Sales 0.92, EV/EBITDA 9.24 |
...
|---|---|---|---|
| Price | $390.95 | EV/Sales | 0.92 |
| Market cap | $114.13B | EV/EBITDA | 9.24 |
| Beta | 0.53 | Gross margin | 12.82% |
| RSI(14) | 55.0 | Operating margin | 13.56% |
| ATR(14) | 14.64 | Profit margin | 5.55% |
| SMA20 dist | -0.39% | ROA | 8.74% |
| SMA50 dist | +10.88% | ROE | 42.10% |
| SMA200 dist | +54.48% | Revenue (ttm) | $154.15B |
| 52W high | $424.89 | Revenue growth y/y | 53.70% |
| 52W low | $160.76 | Inst. ownership | 79.49% |
| P/E (ttm) | 13.55 | Insider ownership | 0.33% |
| Forward P/E | 8.29 | Short float | 3.14% |
| PEG (trailing) | 0.90 | Avg volume | 2,602,201 |
| P/S | 0.74 | Employees | 18,500 |
| P/B | 5.80 | Analyst rec (1=buy..5=sell) | 2.3 |

...
Signed file: `SLB.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $50.81 (2026-08-04, ~15-min delayed) |
| Market cap | $75.41B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +57.94%; price +9.04% vs SMA200. |
| Fresh setup quality | Moderate / wait | -12.41% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 8.53%, revenue growth 5.00%. |
| Value attractiveness | Reasonable | Forward P/E 15.59, EV/Sales 2.28. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $50.81; 52w high $58.01 (-12.41%); 52w low $31.12 (+63.25%) |
| Trend | +9.04% vs SMA200, +0.57% vs SMA50, +4.94% vs SMA20 |
| Momentum | RSI(14) 57.3 (neutral) |
| Volatility | ATR(14) 1.67 (~3.3% of price); beta 0.75 |
| Setup perspective | -12.41% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 24.79, forward P/E 15.59, P/S 2.07, P/B 2.77 | EV/Sales 2.28, EV/EBITDA 11.25 |
...
|---|---|---|---|
| Blackrock Inc. | 132,223,012 | 8.91% | 2026-03-31 |
| Vanguard Capital Management LLC | 97,191,687 | 6.55% | 2026-03-31 |
| State Street Corporation | 90,500,581 | 6.10% | 2026-03-31 |
...
|---|---|---|---|
| Price | $50.81 | EV/Sales | 2.28 |
| Market cap | $75.41B | EV/EBITDA | 11.25 |
| Beta | 0.75 | Gross margin | 16.99% |
| RSI(14) | 57.3 | Operating margin | 12.71% |
| ATR(14) | 1.67 | Profit margin | 8.53% |
| SMA20 dist | +4.94% | ROA | 6.17% |
| SMA50 dist | +0.57% | ROE | 12.91% |
| SMA200 dist | +9.04% | Revenue (ttm) | $36.37B |
| 52W high | $58.01 | Revenue growth y/y | 5.00% |
| 52W low | $31.12 | Inst. ownership | 94.05% |
| P/E (ttm) | 24.79 | Insider ownership | 0.22% |
| Forward P/E | 15.59 | Short float | 4.88% |
| PEG (trailing) | 1.67 | Avg volume | 14,274,070 |
| P/S | 2.07 | Employees | 109,000 |

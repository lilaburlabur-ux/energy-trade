...
Signed file: `EPD.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $38.90 (2026-08-14, ~15-min delayed) |
| Market cap | $84.00B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.90; 52w high $39.22 (-0.80%); 52w low $28.35 (+37.19%) |
| Trend | +11.87% vs SMA200, +4.61% vs SMA50, +2.31% vs SMA20 |
| Momentum | RSI(14) 63.0 (neutral) |
| Volatility | ATR(14) 0.65 (~1.7% of price); beta 0.48 |
| Setup perspective | -0.80% from 52w high and near SMA20 — check for a tight base. |
...
|---|---|---|---|
| Price | $38.90 | EV/Sales | 2.00 |
| Market cap | $84.00B | EV/EBITDA | 11.33 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 63.0 | Operating margin | 11.76% |
| ATR(14) | 0.65 | Profit margin | 10.79% |
| SMA20 dist | +2.31% | ROA | 5.92% |
| SMA50 dist | +4.61% | ROE | 20.85% |
| SMA200 dist | +11.87% | Revenue (ttm) | $58.47B |

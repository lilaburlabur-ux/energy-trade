...
Signed file: `PR.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $23.20 (2026-09-17, ~15-min delayed) |
| Market cap | $19.43B |
...
|---|---|---|
| Technical momentum | High | 1Y +79.29%; price +23.98% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.44, EV/Sales 3.88. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $23.20; 52w high $24.33 (-4.64%); 52w low $11.68 (+98.57%) |
| Trend | +23.98% vs SMA200, +6.93% vs SMA50, -0.77% vs SMA20 |
| Momentum | RSI(14) 53.8 (neutral) |
| Volatility | ATR(14) 0.73 (~3.1% of price); beta 0.48 |
...
| Valuation | P/E 14.97, forward P/E 10.44, P/S 3.39, P/B 1.62 | EV/Sales 3.88, EV/EBITDA 5.23 |
...
|---|---|---|---|
| Price | $23.20 | EV/Sales | 3.88 |
| Market cap | $19.43B | EV/EBITDA | 5.23 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 53.8 | Operating margin | 57.44% |
| ATR(14) | 0.73 | Profit margin | 21.52% |
| SMA20 dist | -0.77% | ROA | 7.54% |
| SMA50 dist | +6.93% | ROE | 11.40% |
| SMA200 dist | +23.98% | Revenue (ttm) | $5.74B |
| 52W high | $24.33 | Revenue growth y/y | 55.10% |
| 52W low | $11.68 | Inst. ownership | 92.72% |
| P/E (ttm) | 14.97 | Insider ownership | 4.61% |
| Forward P/E | 10.44 | Short float | 2.47% |
| PEG (trailing) | 1.32 | Avg volume | 9,843,372 |
| P/S | 3.39 | Employees | 515 |

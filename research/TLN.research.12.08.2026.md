...
Signed file: `TLN.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $365.07 (2026-08-12, ~15-min delayed) |
| Market cap | $17.49B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y -2.56%; price +0.22% vs SMA200. |
| Fresh setup quality | Moderate / wait | -18.12% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-4.95%). |
| Value attractiveness | Reasonable | Forward P/E 12.53, EV/Sales 7.09. |
| Risk level | High | Beta 1.67, ATR 5.5% of price, short float 5.32%. |
...
| Talen Energy (TLN) Raised Guidance In August, So Why The Loss? | Insider Monkey | 2026-08-11 |
| TLN Q2 Earnings Call Emphasizes Cash Flow and Data Center Strategy | Zacks | 2026-08-07 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $365.07; 52w high $445.84 (-18.12%); 52w low $302.97 (+20.50%) |
| Trend | +0.22% vs SMA200, -1.86% vs SMA50, +3.59% vs SMA20 |
| Momentum | RSI(14) 53.1 (neutral) |
| Volatility | ATR(14) 20.22 (~5.5% of price); beta 1.67 |
| Setup perspective | -18.12% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E 12.53, P/S 4.68, P/B 10.82 | EV/Sales 7.09, EV/EBITDA 45.55 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $467.69 (16 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 104.75% |
...
- **Volatility risk:** Beta 1.67, ATR 5.5% of price, short float 5.32%. Size positions accordingly.
...
|---|---|---|---|
| Price | $365.07 | EV/Sales | 7.09 |
| Market cap | $17.49B | EV/EBITDA | 45.55 |
| Beta | 1.67 | Gross margin | 42.10% |
| RSI(14) | 53.1 | Operating margin | -4.80% |
| ATR(14) | 20.22 | Profit margin | -4.95% |
| SMA20 dist | +3.59% | ROA | 0.92% |
| SMA50 dist | -1.86% | ROE | -12.83% |
| SMA200 dist | +0.22% | Revenue (ttm) | $3.74B |
| 52W high | $445.84 | Revenue growth y/y | 111.20% |
| 52W low | $302.97 | Inst. ownership | 104.75% |
| P/E (ttm) | — | Insider ownership | 1.36% |
| Forward P/E | 12.53 | Short float | 5.32% |
| PEG (trailing) | — | Avg volume | 837,030 |
| P/S | 4.68 | Employees | 1,880 |
| P/B | 10.82 | Analyst rec (1=buy..5=sell) | 1.6 |
...
## 9. Conclusion
TLN: Moderate momentum / weak fundamentals / reasonable value / high risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

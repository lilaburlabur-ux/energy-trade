...
Signed file: `PWR.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $639.05 (2026-09-08, ~15-min delayed) |
| Market cap | $96.08B |
...
|---|---|---|
| Technical momentum | High | 1Y +71.70%; price +8.55% vs SMA200. |
| Fresh setup quality | Moderate / wait | -18.60% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 4.03%, revenue growth 41.10%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 32.54, EV/Sales 3.04. |
| Risk level | Elevated | Beta 1.20, ATR 3.8% of price, short float 2.10%. |
...
|---|---|---|
| Quanta Services (PWR) Rises As Market Takes a Dip: Key Facts | Zacks | 2026-09-08 |
| Argan's Q2 Beat Shows Power Strength as Industrial Margins Stay Soft | Zacks | 2026-09-08 |
| Is Argan Worth Buying as Growth Surges but Valuation Stays Elevated? | Zacks | 2026-09-08 |
| AGX Falls 28.1% in a Month as Backlog and Margin Risks Come Into Focus | Zacks | 2026-09-08 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $639.05; 52w high $785.12 (-18.60%); 52w low $373.15 (+71.26%) |
| Trend | +8.55% vs SMA200, -1.87% vs SMA50, -0.76% vs SMA20 |
| Momentum | RSI(14) 49.8 (neutral) |
| Volatility | ATR(14) 24.37 (~3.8% of price); beta 1.20 |
| Setup perspective | -18.60% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 73.12, forward P/E 32.54, P/S 2.92, P/B 9.96 | EV/Sales 3.04, EV/EBITDA 32.87 |
...
- **Valuation risk:** Forward P/E 32.54, EV/Sales 3.04. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.20, ATR 3.8% of price, short float 2.10%. Size positions accordingly.
...
|---|---|---|---|
| Price | $639.05 | EV/Sales | 3.04 |
| Market cap | $96.08B | EV/EBITDA | 32.87 |
| Beta | 1.20 | Gross margin | 15.46% |
| RSI(14) | 49.8 | Operating margin | 7.22% |
| ATR(14) | 24.37 | Profit margin | 4.03% |
| SMA20 dist | -0.76% | ROA | 5.23% |
| SMA50 dist | -1.87% | ROE | 15.34% |
| SMA200 dist | +8.55% | Revenue (ttm) | $32.91B |
| 52W high | $785.12 | Revenue growth y/y | 41.10% |
| 52W low | $373.15 | Inst. ownership | 94.26% |
| P/E (ttm) | 73.12 | Insider ownership | 0.67% |
| Forward P/E | 32.54 | Short float | 2.10% |
| PEG (trailing) | 1.41 | Avg volume | 1,231,493 |
| P/S | 2.92 | Employees | 69,500 |
| P/B | 9.96 | Analyst rec (1=buy..5=sell) | 1.5 |

...
Signed file: `BE.research.02.09.2026`

| Field | Value |
|---|---|
| Current price | $217.28 (2026-09-02, ~15-min delayed) |
| Market cap | $63.99B |
...
|---|---|---|
| Technical momentum | High | 1Y +323.14%; price +14.41% vs SMA200. |
| Fresh setup quality | Poor / broken | -37.18% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 7.87%, revenue growth 165.50%. |
| Value attractiveness | Low (expensive) | Forward P/E 44.16, EV/Sales 20.25. |
| Risk level | High | Beta 3.83, ATR 8.7% of price, short float 7.06%. |
...
| Is Bloom Energy (BE) Stock Outpacing Its Oils-Energy Peers This Year? | Zacks | 2026-09-02 |
| FuelCell Sinks 13% as Wider Loss Overshadows First Data Center Reservation Deal, Bloom Energy Slips, Plug Power Barely Budges | 24/7 Wall St. | 2026-09-02 |
| GEV Stock Rises 37.5% YTD: Time to Lock in Gains or Ride the Wave? | Zacks | 2026-09-02 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $217.28; 52w high $345.85 (-37.18%); 52w low $52.45 (+314.26%) |
| Trend | +14.41% vs SMA200, -5.29% vs SMA50, +0.34% vs SMA20 |
| Momentum | RSI(14) 49.8 (neutral) |
| Volatility | ATR(14) 18.85 (~8.7% of price); beta 3.83 |
| Setup perspective | -37.18% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 282.18, forward P/E 44.16, P/S 20.56, P/B 39.54 | EV/Sales 20.25, EV/EBITDA 150.66 |
...
- **Valuation risk:** Forward P/E 44.16, EV/Sales 20.25. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.83, ATR 8.7% of price, short float 7.06%. Size positions accordingly.
...
|---|---|---|---|
| Price | $217.28 | EV/Sales | 20.25 |
| Market cap | $63.99B | EV/EBITDA | 150.66 |
| Beta | 3.83 | Gross margin | 31.65% |
| RSI(14) | 49.8 | Operating margin | 17.11% |
| ATR(14) | 18.85 | Profit margin | 7.87% |
| SMA20 dist | +0.34% | ROA | 5.60% |
| SMA50 dist | -5.29% | ROE | 22.21% |
| SMA200 dist | +14.41% | Revenue (ttm) | $3.11B |
| 52W high | $345.85 | Revenue growth y/y | 165.50% |
| 52W low | $52.45 | Inst. ownership | 86.08% |
| P/E (ttm) | 282.18 | Insider ownership | 5.64% |
| Forward P/E | 44.16 | Short float | 7.06% |
| PEG (trailing) | 0.48 | Avg volume | 14,606,165 |
| P/S | 20.56 | Employees | 2,214 |
| P/B | 39.54 | Analyst rec (1=buy..5=sell) | 2.2 |

...
Signed file: `DVN.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $47.05 (2026-09-25, ~15-min delayed) |
| Market cap | $51.75B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $47.05; 52w high $51.37 (-8.41%); 52w low $30.95 (+52.01%) |
| Trend | +7.36% vs SMA200, +1.32% vs SMA50, -3.02% vs SMA20 |
| Momentum | RSI(14) 46.7 (neutral) |
| Volatility | ATR(14) 1.47 (~3.1% of price); beta 0.43 |
...
| SMA20 dist | -3.02% | ROA | 5.91% |
| SMA50 dist | +1.32% | ROE | 11.52% |
| SMA200 dist | +7.36% | Revenue (ttm) | $18.78B |
| 52W high | $51.37 | Revenue growth y/y | 64.20% |
| 52W low | $30.95 | Inst. ownership | 94.76% |
| P/E (ttm) | 10.23 | Insider ownership | 0.80% |
| Forward P/E | 8.74 | Short float | 3.02% |
| PEG (trailing) | 2.92 | Avg volume | 11,760,117 |

...
Signed file: `OVV.research.27.08.2026`

| Field | Value |
|---|---|
| Current price | $64.52 (2026-08-27, ~15-min delayed) |
| Market cap | $17.85B |
...
|---|---|---|
| Technical momentum | High | 1Y +60.47%; price +25.44% vs SMA200. |
| Fresh setup quality | Watch | -3.44% from 52w high and near SMA20 — check for a tight base. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $64.52; 52w high $66.82 (-3.44%); 52w low $35.32 (+82.66%) |
| Trend | +25.44% vs SMA200, +9.63% vs SMA50, +2.23% vs SMA20 |
| Momentum | RSI(14) 58.0 (neutral) |
| Volatility | ATR(14) 1.83 (~2.8% of price); beta 0.54 |
| Setup perspective | -3.44% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 18.02, forward P/E 8.83, P/S 1.87, P/B 1.55 | EV/Sales 2.32, EV/EBITDA 4.53 |
...
|---|---|---|---|
| Price | $64.52 | EV/Sales | 2.32 |
| Market cap | $17.85B | EV/EBITDA | 4.53 |
| Beta | 0.54 | Gross margin | 53.86% |
| RSI(14) | 58.0 | Operating margin | 36.18% |
| ATR(14) | 1.83 | Profit margin | 9.66% |
| SMA20 dist | +2.23% | ROA | 8.64% |
| SMA50 dist | +9.63% | ROE | 8.41% |
| SMA200 dist | +25.44% | Revenue (ttm) | $9.52B |
| 52W high | $66.82 | Revenue growth y/y | 29.70% |
| 52W low | $35.32 | Inst. ownership | 96.32% |
| P/E (ttm) | 18.02 | Insider ownership | 0.46% |
| Forward P/E | 8.83 | Short float | 4.84% |
| PEG (trailing) | — | Avg volume | 3,341,031 |
| P/S | 1.87 | Employees | 1,465 |
| P/B | 1.55 | Analyst rec (1=buy..5=sell) | 1.5 |

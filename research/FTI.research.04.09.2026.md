...
Signed file: `FTI.research.04.09.2026`

| Field | Value |
|---|---|
| Current price | $79.84 (2026-09-04, ~15-min delayed) |
| Market cap | $31.31B |
...
|---|---|---|
| Technical momentum | High | 1Y +102.02%; price +24.13% vs SMA200. |
| Fresh setup quality | Watch | -0.30% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 11.28%, revenue growth 9.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 22.18, EV/Sales 3.04. |
| Risk level | Moderate | Beta 0.74, ATR 2.8% of price, short float 3.35%. |
...
| Zacks Industry Outlook Highlights TechnipFMC, Oceaneering International, Inc. and Core Laboratories | Zacks | 2026-09-02 |
| TechnipFMC’s (FTI) Deepwater Deal Streak Meets A Flattening Backlog | Insider Monkey | 2026-09-02 |
| TechnipFMC (FTI) Stock Could Be 29% Undervalued Following Subsea 2.0 Delivery | Simply Wall St. | 2026-09-02 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $79.84; 52w high $80.08 (-0.30%); 52w low $35.45 (+125.19%) |
| Trend | +24.13% vs SMA200, +8.91% vs SMA50, +3.36% vs SMA20 |
| Momentum | RSI(14) 64.2 (neutral) |
| Volatility | ATR(14) 2.27 (~2.8% of price); beta 0.74 |
| Setup perspective | -0.30% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 27.92, forward P/E 22.18, P/S 3.00, P/B 9.59 | EV/Sales 3.04, EV/EBITDA 15.96 |
| Growth expectations | Earnings growth 40.60%, EPS q/q 34.60% | Analyst mean target $75.81 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 101.16% |
...
| Price (T.Rowe) Associates Inc | 25,720,395 | 6.56% | 2026-06-30 |
| Vanguard Portfolio Management LLC | 18,806,161 | 4.80% | 2026-06-30 |
| Vanguard Capital Management LLC | 18,033,920 | 4.60% | 2026-06-30 |
| State Street Corporation | 15,631,272 | 3.99% | 2026-06-30 |
| AQR Capital Management, LLC | 14,685,742 | 3.74% | 2026-06-30 |
| Capital World Investors | 14,378,091 | 3.67% | 2026-06-30 |
| FMR, LLC | 12,575,617 | 3.21% | 2026-06-30 |
| Invesco Ltd. | 11,995,326 | 3.06% | 2026-06-30 |
| T. Rowe Price Investment Management, Inc. | 9,275,901 | 2.37% | 2026-06-30 |

## 6. Risk Review and Setup Plan
- **Valuation risk:** Forward P/E 22.18, EV/Sales 3.04. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $79.84 | EV/Sales | 3.04 |
| Market cap | $31.31B | EV/EBITDA | 15.96 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 64.2 | Operating margin | 17.69% |
| ATR(14) | 2.27 | Profit margin | 11.28% |
| SMA20 dist | +3.36% | ROA | 9.53% |
| SMA50 dist | +8.91% | ROE | 35.81% |
| SMA200 dist | +24.13% | Revenue (ttm) | $10.42B |
| 52W high | $80.08 | Revenue growth y/y | 9.00% |
| 52W low | $35.45 | Inst. ownership | 101.16% |
| P/E (ttm) | 27.92 | Insider ownership | 1.49% |
| Forward P/E | 22.18 | Short float | 3.35% |
| PEG (trailing) | — | Avg volume | 3,658,498 |
| P/S | 3.00 | Employees | 22,000 |
| P/B | 9.59 | Analyst rec (1=buy..5=sell) | 2.0 |
...
## 9. Conclusion
FTI: High momentum / mixed fundamentals / fair-to-demanding value / moderate risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

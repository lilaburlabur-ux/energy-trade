...
Signed file: `AR.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $38.83 (2026-09-15, ~15-min delayed) |
| Market cap | $11.94B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +17.42%; price +6.64% vs SMA200. |
| Fresh setup quality | Moderate / wait | -14.00% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 18.75%, revenue growth 12.60%. |
| Value attractiveness | Reasonable | Forward P/E 9.07, EV/Sales —. |
...
| Natural Gas Ends Week Lower, but LNG Demand Offers Support | Zacks | 2026-09-14 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.83; 52w high $45.15 (-14.00%); 52w low $30.03 (+29.30%) |
| Trend | +6.64% vs SMA200, +6.49% vs SMA50, +0.76% vs SMA20 |
| Momentum | RSI(14) 57.2 (neutral) |
| Volatility | ATR(14) 1.07 (~2.7% of price); beta 0.35 |
| Setup perspective | -14.00% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 11.13, forward P/E 9.07, P/S 2.06, P/B 1.44 | EV/Sales —, EV/EBITDA — |
| Growth expectations | Earnings growth 79.90%, EPS q/q 78.00% | Analyst mean target $49.86 (21 analysts) |
...
| Market cap | $11.94B | EV/EBITDA | — |
| Beta | 0.35 | Gross margin | 67.15% |
| RSI(14) | 57.2 | Operating margin | 26.02% |
| ATR(14) | 1.07 | Profit margin | 18.75% |
| SMA20 dist | +0.76% | ROA | 6.61% |
| SMA50 dist | +6.49% | ROE | 14.22% |
| SMA200 dist | +6.64% | Revenue (ttm) | $5.78B |
| 52W high | $45.15 | Revenue growth y/y | 12.60% |
| 52W low | $30.03 | Inst. ownership | 91.48% |
| P/E (ttm) | 11.13 | Insider ownership | 4.41% |
| Forward P/E | 9.07 | Short float | 4.81% |
| PEG (trailing) | 0.48 | Avg volume | 4,278,733 |
| P/S | 2.06 | Employees | 632 |
| P/B | 1.44 | Analyst rec (1=buy..5=sell) | 1.8 |

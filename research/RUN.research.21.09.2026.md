...
Signed file: `RUN.research.21.09.2026`
...
| Trend | -37.19% vs SMA200, -9.99% vs SMA50, +0.43% vs SMA20 |
| Momentum | RSI(14) 45.9 (neutral) |
| Volatility | ATR(14) 0.49 (~5.5% of price); beta 2.36 |
...
- **Volatility risk:** Beta 2.36, ATR 5.5% of price, short float 34.08%. Size positions accordingly.
...
| SMA20 dist | +0.43% | ROA | 0.26% |
| SMA50 dist | -9.99% | ROE | -19.86% |
| SMA200 dist | -37.19% | Revenue (ttm) | $3.48B |

...
Signed file: `TLN.research.22.09.2026`

| Field | Value |
|---|---|
| Current price | $294.54 (2026-09-22, ~15-min delayed) |
| Market cap | $14.11B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-16.75%) with negative half-year (-5.30%). |
| Fresh setup quality | Poor / broken | -33.94% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-4.95%). |
| Value attractiveness | Reasonable | Forward P/E 9.58, EV/Sales 6.34. |
| Risk level | Elevated | Beta 1.63, ATR 4.7% of price, short float 5.69%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $294.54; 52w high $445.84 (-33.94%); 52w low $282.15 (+4.39%) |
| Trend | -16.75% vs SMA200, -10.71% vs SMA50, -2.39% vs SMA20 |
| Momentum | RSI(14) 41.7 (neutral) |
| Volatility | ATR(14) 13.82 (~4.7% of price); beta 1.63 |
| Setup perspective | -33.94% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 9.58, P/S 3.77, P/B 8.73 | EV/Sales 6.34, EV/EBITDA 40.79 |
...
- **Volatility risk:** Beta 1.63, ATR 4.7% of price, short float 5.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $294.54 | EV/Sales | 6.34 |
| Market cap | $14.11B | EV/EBITDA | 40.79 |
| Beta | 1.63 | Gross margin | 42.10% |
| RSI(14) | 41.7 | Operating margin | -4.80% |
| ATR(14) | 13.82 | Profit margin | -4.95% |
| SMA20 dist | -2.39% | ROA | 0.92% |
| SMA50 dist | -10.71% | ROE | -12.83% |
| SMA200 dist | -16.75% | Revenue (ttm) | $3.74B |
| 52W high | $445.84 | Revenue growth y/y | 111.20% |
| 52W low | $282.15 | Inst. ownership | 102.12% |
| P/E (ttm) | — | Insider ownership | 1.36% |
| Forward P/E | 9.58 | Short float | 5.69% |
| PEG (trailing) | — | Avg volume | 823,460 |
| P/S | 3.77 | Employees | 1,880 |

...
Signed file: `SLB.research.04.09.2026`

| Field | Value |
|---|---|
| Current price | $57.51 (2026-09-04, ~15-min delayed) |
| Market cap | $85.35B |
...
|---|---|---|
| Technical momentum | High | 1Y +63.61%; price +18.44% vs SMA200. |
| Fresh setup quality | Moderate / wait | -3.81% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 8.53%, revenue growth 5.00%. |
| Value attractiveness | Reasonable | Forward P/E 17.79, EV/Sales 2.61. |
| Risk level | Elevated | Beta 0.77, ATR 3.3% of price, short float 4.28%. |
...
|---|---|---|
| How Could SLB (SLB) Change After Its Upstream Software Deal? | Simply Wall St. | 2026-09-04 |
| AppLovin (APP) Down 6.6% Since Last Earnings Report: Can It Rebound? | Zacks | 2026-09-04 |
| 1 Profitable Stock with Solid Fundamentals and 2 That Underwhelm | StockStory | 2026-09-04 |
| Why Is APTIV PLC (APTV) Down 4.2% Since Last Earnings Report? | Zacks | 2026-09-03 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $57.51; 52w high $59.79 (-3.81%); 52w low $30.96 (+85.74%) |
| Trend | +18.44% vs SMA200, +13.78% vs SMA50, +5.32% vs SMA20 |
| Momentum | RSI(14) 62.8 (neutral) |
| Volatility | ATR(14) 1.88 (~3.3% of price); beta 0.77 |
| Setup perspective | -3.81% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 28.05, forward P/E 17.79, P/S 2.35, P/B 3.27 | EV/Sales 2.61, EV/EBITDA 12.88 |
...
- **Volatility risk:** Beta 0.77, ATR 3.3% of price, short float 4.28%. Size positions accordingly.
...
|---|---|---|---|
| Price | $57.51 | EV/Sales | 2.61 |
| Market cap | $85.35B | EV/EBITDA | 12.88 |
| Beta | 0.77 | Gross margin | 16.99% |
| RSI(14) | 62.8 | Operating margin | 12.71% |
| ATR(14) | 1.88 | Profit margin | 8.53% |
| SMA20 dist | +5.32% | ROA | 6.17% |
| SMA50 dist | +13.78% | ROE | 12.91% |
| SMA200 dist | +18.44% | Revenue (ttm) | $36.37B |
| 52W high | $59.79 | Revenue growth y/y | 5.00% |
| 52W low | $30.96 | Inst. ownership | 92.65% |
| P/E (ttm) | 28.05 | Insider ownership | 0.22% |
| Forward P/E | 17.79 | Short float | 4.28% |
| PEG (trailing) | 1.88 | Avg volume | 13,758,998 |
| P/S | 2.35 | Employees | 109,000 |
| P/B | 3.27 | Analyst rec (1=buy..5=sell) | 1.6 |

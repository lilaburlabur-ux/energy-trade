...
Signed file: `SO.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $86.76 (2026-09-17, ~15-min delayed) |
| Market cap | $99.81B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-4.69%) with negative half-year (-8.64%). |
| Fresh setup quality | Moderate / wait | -11.01% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 15.43%, revenue growth 0.10%. |
| Value attractiveness | Reasonable | Forward P/E 17.62, EV/Sales 5.83. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $86.76; 52w high $97.49 (-11.01%); 52w low $82.06 (+5.72%) |
| Trend | -4.69% vs SMA200, -5.16% vs SMA50, -1.80% vs SMA20 |
| Momentum | RSI(14) 35.1 (neutral) |
| Volatility | ATR(14) 1.34 (~1.5% of price); beta 0.32 |
| Setup perspective | -11.01% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.91, forward P/E 17.62, P/S 3.31, P/B 2.52 | EV/Sales 5.83, EV/EBITDA 12.35 |
...
|---|---|---|---|
| Price | $86.76 | EV/Sales | 5.83 |
| Market cap | $99.81B | EV/EBITDA | 12.35 |
| Beta | 0.32 | Gross margin | 48.29% |
| RSI(14) | 35.1 | Operating margin | 29.61% |
| ATR(14) | 1.34 | Profit margin | 15.43% |
| SMA20 dist | -1.80% | ROA | 3.27% |
| SMA50 dist | -5.16% | ROE | 11.48% |
| SMA200 dist | -4.69% | Revenue (ttm) | $30.18B |
| 52W high | $97.49 | Revenue growth y/y | 0.10% |
| 52W low | $82.06 | Inst. ownership | 74.23% |
| P/E (ttm) | 20.91 | Insider ownership | 0.10% |
| Forward P/E | 17.62 | Short float | 3.06% |
| PEG (trailing) | 2.04 | Avg volume | 5,741,417 |
| P/S | 3.31 | Employees | 29,502 |
| P/B | 2.52 | Analyst rec (1=buy..5=sell) | 2.7 |

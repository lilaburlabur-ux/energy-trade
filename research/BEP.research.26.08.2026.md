...
Signed file: `BEP.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $32.49 (2026-08-26, ~15-min delayed) |
| Market cap | $15.84B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +32.47%; price +3.43% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E -17.38, EV/Sales 13.22. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $32.49; 52w high $37.09 (-12.40%); 52w low $24.11 (+34.78%) |
| Trend | +3.43% vs SMA200, -2.65% vs SMA50, -2.47% vs SMA20 |
| Momentum | RSI(14) 44.8 (neutral) |
| Volatility | ATR(14) 0.98 (~3.0% of price); beta 0.99 |
...
| Valuation | P/E —, forward P/E -17.38, P/S 2.49, P/B 2.61 | EV/Sales 13.22, EV/EBITDA 28.02 |
...
|---|---|---|---|
| Price | $32.49 | EV/Sales | 13.22 |
| Market cap | $15.84B | EV/EBITDA | 28.02 |
| Beta | 0.99 | Gross margin | 51.39% |
| RSI(14) | 44.8 | Operating margin | 17.08% |
| ATR(14) | 0.98 | Profit margin | -1.26% |
| SMA20 dist | -2.47% | ROA | 0.42% |
| SMA50 dist | -2.65% | ROE | 0.40% |
| SMA200 dist | +3.43% | Revenue (ttm) | $6.36B |
...
| PEG (trailing) | — | Avg volume | 882,965 |

...
Signed file: `GEV.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $971.31 (2026-09-08, ~15-min delayed) |
| Market cap | $258.69B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $971.31; 52w high $1,174.86 (-17.33%); 52w low $546.95 (+77.59%) |
| Trend | +9.42% vs SMA200, -4.20% vs SMA50, +0.03% vs SMA20 |
| Momentum | RSI(14) 50.4 (neutral) |
| Volatility | ATR(14) 41.46 (~4.3% of price); beta 0.97 |
| Setup perspective | -17.33% from 52w high; no clean fresh pivot by default. |
...
| SMA50 dist | -4.20% | ROE | 82.58% |
| SMA200 dist | +9.42% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.75% |
| P/E (ttm) | 27.87 | Insider ownership | 0.13% |
| Forward P/E | 38.43 | Short float | 2.98% |
| PEG (trailing) | 1.84 | Avg volume | 2,742,504 |
| P/S | 6.25 | Employees | 78,000 |

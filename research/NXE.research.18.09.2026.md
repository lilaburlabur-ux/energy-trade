...
Signed file: `NXE.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $9.35 (2026-09-18, ~15-min delayed) |
| Market cap | $6.19B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-14.14%) with negative half-year (-17.91%). |
| Fresh setup quality | Poor / broken | -32.83% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -58.39, EV/Sales —. |
| Risk level | Elevated | Beta 1.67, ATR 4.6% of price, short float —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.35; 52w high $13.92 (-32.83%); 52w low $7.56 (+23.68%) |
| Trend | -14.14% vs SMA200, -5.91% vs SMA50, -9.30% vs SMA20 |
| Momentum | RSI(14) 37.6 (neutral) |
| Volatility | ATR(14) 0.43 (~4.6% of price); beta 1.67 |
| Setup perspective | -32.83% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -58.39, P/S —, P/B 4.68 | EV/Sales —, EV/EBITDA -55.16 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $19.23 (1 analysts) |
...
- **Volatility risk:** Beta 1.67, ATR 4.6% of price, short float —. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.35 | EV/Sales | — |
| Market cap | $6.19B | EV/EBITDA | -55.16 |
| Beta | 1.67 | Gross margin | 0.00% |
| RSI(14) | 37.6 | Operating margin | 0.00% |
| ATR(14) | 0.43 | Profit margin | 0.00% |
| SMA20 dist | -9.30% | ROA | -3.39% |
| SMA50 dist | -5.91% | ROE | -17.67% |
| SMA200 dist | -14.14% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.56 | Inst. ownership | 55.22% |
| P/E (ttm) | — | Insider ownership | 6.40% |
| Forward P/E | -58.39 | Short float | — |
| PEG (trailing) | — | Avg volume | 4,686,432 |
| P/S | — | Employees | 142 |
| P/B | 4.68 | Analyst rec (1=buy..5=sell) | 1.5 |

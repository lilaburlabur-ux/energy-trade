...
Signed file: `SEDG.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $34.68 (2026-09-18, ~15-min delayed) |
| Market cap | $2.13B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-17.60%) with negative half-year (-24.05%). |
...
| Value attractiveness | Low (expensive) | Forward P/E 39.29, EV/Sales 1.56. |
| Risk level | High | Beta 1.44, ATR 8.1% of price, short float 25.50%. |
...
| Trend | -17.60% vs SMA200, -9.49% vs SMA50, +2.83% vs SMA20 |
| Momentum | RSI(14) 48.0 (neutral) |
| Volatility | ATR(14) 2.80 (~8.1% of price); beta 1.44 |
...
| Valuation | P/E —, forward P/E 39.29, P/S 1.60, P/B 5.18 | EV/Sales 1.56, EV/EBITDA -17.14 |
...
- **Valuation risk:** Forward P/E 39.29, EV/Sales 1.56. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.44, ATR 8.1% of price, short float 25.50%. Size positions accordingly.
...
|---|---|---|---|
| Price | $34.68 | EV/Sales | 1.56 |
| Market cap | $2.13B | EV/EBITDA | -17.14 |
| Beta | 1.44 | Gross margin | 21.25% |
| RSI(14) | 48.0 | Operating margin | -6.51% |
| ATR(14) | 2.80 | Profit margin | -20.29% |
| SMA20 dist | +2.83% | ROA | -3.84% |
| SMA50 dist | -9.49% | ROE | -58.42% |
| SMA200 dist | -17.60% | Revenue (ttm) | $1.33B |
| 52W high | $78.51 | Revenue growth y/y | 19.60% |
| 52W low | $28.47 | Inst. ownership | 101.66% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 39.29 | Short float | 25.50% |
| PEG (trailing) | — | Avg volume | 3,108,183 |

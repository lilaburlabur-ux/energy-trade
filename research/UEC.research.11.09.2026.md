...
Signed file: `UEC.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $10.45 (2026-09-11, ~15-min delayed) |
| Market cap | $5.17B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-21.21%) with negative half-year (-25.83%). |
| Fresh setup quality | Poor / broken | -48.11% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -116.11, EV/Sales 245.91. |
| Risk level | High | Beta 1.24, ATR 6.4% of price, short float 14.73%. |
...
|---|---|---|
| Is Uranium Energy (UEC) a Buy as Wall Street Analysts Look Optimistic? | Zacks | 2026-09-10 |
| BWX Technologies Already Builds Reactors for the Navy. Why Is It Still the Cheapest Nuclear Stock? | Motley Fool | 2026-09-06 |
| Uranium Energy Rose as Jefferies Started Coverage | GuruFocus.com | 2026-09-03 |
| NuScale Advances Key Safety Component Toward SMR Commercialization | Zacks | 2026-09-02 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.45; 52w high $20.14 (-48.11%); 52w low $9.04 (+15.60%) |
| Trend | -21.21% vs SMA200, -3.72% vs SMA50, -11.91% vs SMA20 |
| Momentum | RSI(14) 39.7 (neutral) |
| Volatility | ATR(14) 0.67 (~6.4% of price); beta 1.24 |
| Setup perspective | -48.11% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -116.11, P/S 256.01, P/B 3.63 | EV/Sales 245.91, EV/EBITDA -41.13 |
...
- **Volatility risk:** Beta 1.24, ATR 6.4% of price, short float 14.73%. Size positions accordingly.
- **Short interest risk:** short float 14.73% can fuel squeezes both ways around news.
...
|---|---|---|---|
| Price | $10.45 | EV/Sales | 245.91 |
| Market cap | $5.17B | EV/EBITDA | -41.13 |
| Beta | 1.24 | Gross margin | 0.00% |
| RSI(14) | 39.7 | Operating margin | -629.66% |
| ATR(14) | 0.67 | Profit margin | 0.00% |
| SMA20 dist | -11.91% | ROA | -6.25% |
| SMA50 dist | -3.72% | ROE | -8.96% |
| SMA200 dist | -21.21% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 88.49% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -116.11 | Short float | 14.73% |
| PEG (trailing) | — | Avg volume | 8,755,854 |
| P/S | 256.01 | Employees | 171 |
| P/B | 3.63 | Analyst rec (1=buy..5=sell) | 1.6 |

...
Signed file: `DUK.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $121.40 (2026-09-03, ~15-min delayed) |
| Market cap | $94.66B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-0.77%) with negative half-year (-6.14%). |
| Fresh setup quality | Moderate / wait | -7.44% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 16.00%, revenue growth 1.10%. |
| Value attractiveness | Reasonable | Forward P/E 16.93, EV/Sales 5.77. |
...
|---|---|---|
| Why Is Duke Energy (DUK) Down 2.3% Since Last Earnings Report? | Zacks | 2026-09-03 |
| Is Duke Energy Stock Underperforming the Nasdaq? | Barchart | 2026-09-03 |
| Two Utility Dividend Plays Are Quietly Beating XOM, CVX On Yield Amid Iran-Driven Oil Rally — Does Retail Know? | Stocktwits | 2026-09-03 |
| Lowe's Foundation launches skilled trades coalition with 75 companies | Quartz | 2026-09-01 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $121.40; 52w high $131.16 (-7.44%); 52w low $111.09 (+9.28%) |
| Trend | -0.77% vs SMA200, -2.18% vs SMA50, -0.42% vs SMA20 |
| Momentum | RSI(14) 46.0 (neutral) |
| Volatility | ATR(14) 1.93 (~1.6% of price); beta 0.36 |
| Setup perspective | -7.44% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.28, forward P/E 16.93, P/S 2.89, P/B 1.76 | EV/Sales 5.77, EV/EBITDA 11.39 |
...
|---|---|---|---|
| Price | $121.40 | EV/Sales | 5.77 |
| Market cap | $94.66B | EV/EBITDA | 11.39 |
| Beta | 0.36 | Gross margin | 51.97% |
| RSI(14) | 46.0 | Operating margin | 27.50% |
| ATR(14) | 1.93 | Profit margin | 16.00% |
| SMA20 dist | -0.42% | ROA | 2.84% |
| SMA50 dist | -2.18% | ROE | 9.86% |
| SMA200 dist | -0.77% | Revenue (ttm) | $32.80B |
| 52W high | $131.16 | Revenue growth y/y | 1.10% |
| 52W low | $111.09 | Inst. ownership | 71.17% |
| P/E (ttm) | 18.28 | Insider ownership | 0.13% |
| Forward P/E | 16.93 | Short float | 2.55% |
| PEG (trailing) | 2.24 | Avg volume | 4,013,714 |
| P/S | 2.89 | Employees | 26,441 |
| P/B | 1.76 | Analyst rec (1=buy..5=sell) | 2.1 |

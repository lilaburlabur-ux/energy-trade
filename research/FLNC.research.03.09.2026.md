...
Signed file: `FLNC.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $10.20 (2026-09-03, ~15-min delayed) |
| Market cap | $1.90B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-43.62%) with negative half-year (-35.28%). |
| Fresh setup quality | Poor / broken | -68.35% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 74.12, EV/Sales 0.62. |
| Risk level | High | Beta 2.78, ATR 8.5% of price, short float 33.35%. |
...
| Why Is Fluence Energy (FLNC) Refreshing Its Board With A New Representative? | Simply Wall St. | 2026-09-03 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.20; 52w high $32.23 (-68.35%); 52w low $6.75 (+51.11%) |
| Trend | -43.62% vs SMA200, -27.17% vs SMA50, -13.26% vs SMA20 |
| Momentum | RSI(14) 32.5 (neutral) |
| Volatility | ATR(14) 0.87 (~8.5% of price); beta 2.78 |
| Setup perspective | -68.35% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 74.12, P/S 0.72, P/B 3.91 | EV/Sales 0.62, EV/EBITDA -21.08 |
...
- **Valuation risk:** Forward P/E 74.12, EV/Sales 0.62. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.78, ATR 8.5% of price, short float 33.35%. Size positions accordingly.
...
|---|---|---|---|
| Price | $10.20 | EV/Sales | 0.62 |
| Market cap | $1.90B | EV/EBITDA | -21.08 |
| Beta | 2.78 | Gross margin | 9.36% |
| RSI(14) | 32.5 | Operating margin | -8.85% |
| ATR(14) | 0.87 | Profit margin | -3.07% |
| SMA20 dist | -13.26% | ROA | -2.95% |
| SMA50 dist | -27.17% | ROE | -23.54% |
| SMA200 dist | -43.62% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.75 | Inst. ownership | 84.98% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 74.12 | Short float | 33.35% |
| PEG (trailing) | — | Avg volume | 8,593,607 |
| P/S | 0.72 | Employees | 1,670 |
| P/B | 3.91 | Analyst rec (1=buy..5=sell) | 2.6 |

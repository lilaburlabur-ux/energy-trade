...
Signed file: `EOG.research.20.08.2026`
...
|---|---|---|
| Technical momentum | Moderate | 1Y +34.23%; price +21.80% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.44, EV/Sales 3.06. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $152.19; 52w high $152.19 (+0.00%); 52w low $99.31 (+53.25%) |
| Trend | +21.80% vs SMA200, +10.09% vs SMA50, +6.05% vs SMA20 |
| Momentum | RSI(14) 64.8 (neutral) |
| Volatility | ATR(14) 3.84 (~2.5% of price); beta 0.28 |
...
| SMA20 dist | +6.05% | ROA | 11.02% |
| SMA50 dist | +10.09% | ROE | 22.51% |
| SMA200 dist | +21.80% | Revenue (ttm) | $26.72B |
| 52W high | $152.19 | Revenue growth y/y | 58.70% |

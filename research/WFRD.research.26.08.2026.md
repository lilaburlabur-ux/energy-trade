...
Signed file: `WFRD.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $88.00 (2026-08-26, ~15-min delayed) |
| Market cap | $6.31B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-3.39%) with negative half-year (-15.68%). |
...
| Value attractiveness | Reasonable | Forward P/E 12.47, EV/Sales 1.43. |
| Risk level | Elevated | Beta 0.89, ATR 3.7% of price, short float 6.33%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $88.00; 52w high $111.07 (-20.77%); 52w low $60.68 (+45.03%) |
| Trend | -3.39% vs SMA200, +1.46% vs SMA50, -2.40% vs SMA20 |
| Momentum | RSI(14) 46.7 (neutral) |
| Volatility | ATR(14) 3.22 (~3.7% of price); beta 0.89 |
...
| Valuation | P/E 17.36, forward P/E 12.47, P/S 1.32, P/B 3.53 | EV/Sales 1.43, EV/EBITDA 7.37 |
...
- **Volatility risk:** Beta 0.89, ATR 3.7% of price, short float 6.33%. Size positions accordingly.
...
|---|---|---|---|
| Price | $88.00 | EV/Sales | 1.43 |
| Market cap | $6.31B | EV/EBITDA | 7.37 |
| Beta | 0.89 | Gross margin | 30.51% |
| RSI(14) | 46.7 | Operating margin | 10.50% |
| ATR(14) | 3.22 | Profit margin | 7.66% |
| SMA20 dist | -2.40% | ROA | 7.90% |
| SMA50 dist | +1.46% | ROE | 22.79% |
| SMA200 dist | -3.39% | Revenue (ttm) | $4.78B |
| 52W high | $111.07 | Revenue growth y/y | -8.20% |
| 52W low | $60.68 | Inst. ownership | 108.23% |
| P/E (ttm) | 17.36 | Insider ownership | 2.15% |
| Forward P/E | 12.47 | Short float | 6.33% |
| PEG (trailing) | 1.74 | Avg volume | 1,229,931 |
| P/S | 1.32 | Employees | 16,700 |
| P/B | 3.53 | Analyst rec (1=buy..5=sell) | 1.7 |

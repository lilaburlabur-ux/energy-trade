...
Signed file: `TTE.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $89.89 (2026-08-21, ~15-min delayed) |
| Market cap | $199.30B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +48.59%; price +14.24% vs SMA200. |
| Fresh setup quality | Watch | -3.96% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 9.08%, revenue growth 27.80%. |
| Value attractiveness | Reasonable | Forward P/E 9.32, EV/Sales 1.20. |
| Risk level | Moderate | Beta 0.06, ATR 1.8% of price, short float 0.20%. |
...
| Sector Update: Energy Stocks Mixed Friday Afternoon | MT Newswires | 2026-08-21 |
| Sector Update: Energy Stocks Lean Lower Pre-Bell Friday | MT Newswires | 2026-08-21 |
| Update: US Equity Futures Fall Pre-Bell as US Threatens Iran's Trade Partners | MT Newswires | 2026-08-20 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $89.89; 52w high $93.60 (-3.96%); 52w low $55.92 (+60.74%) |
| Trend | +14.24% vs SMA200, +7.78% vs SMA50, +2.91% vs SMA20 |
| Momentum | RSI(14) 62.8 (neutral) |
| Volatility | ATR(14) 1.64 (~1.8% of price); beta 0.06 |
| Setup perspective | -3.96% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 11.25, forward P/E 9.32, P/S 1.01, P/B 1.56 | EV/Sales 1.20, EV/EBITDA 5.95 |
| Growth expectations | Earnings growth 106.00%, EPS q/q 102.40% | Analyst mean target $95.00 (10 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 54.67% |
...
|---|---|---|---|
| Price | $89.89 | EV/Sales | 1.20 |
| Market cap | $199.30B | EV/EBITDA | 5.95 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 62.8 | Operating margin | 12.79% |
| ATR(14) | 1.64 | Profit margin | 9.08% |
| SMA20 dist | +2.91% | ROA | 5.51% |
| SMA50 dist | +7.78% | ROE | 14.48% |
| SMA200 dist | +14.24% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 54.67% |
| P/E (ttm) | 11.25 | Insider ownership | 8.86% |
| Forward P/E | 9.32 | Short float | 0.20% |
| PEG (trailing) | 0.74 | Avg volume | 1,578,985 |
| P/S | 1.01 | Employees | 94,847 |
| P/B | 1.56 | Analyst rec (1=buy..5=sell) | — |

...
Signed file: `PEG.research.28.08.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-7.64%) with negative half-year (-13.15%). |
...
| Trend | -7.64% vs SMA200, -6.18% vs SMA50, -2.32% vs SMA20 |
| Momentum | RSI(14) 35.4 (neutral) |
| Volatility | ATR(14) 1.27 (~1.7% of price); beta 0.53 |

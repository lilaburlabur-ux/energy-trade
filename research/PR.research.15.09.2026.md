...
Signed file: `PR.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $24.49 (2026-09-15, ~15-min delayed) |
| Market cap | $20.51B |
...
|---|---|---|
| Technical momentum | High | 1Y +85.87%; price +30.66% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 11.02, EV/Sales 4.00. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $24.49; 52w high $24.49 (+0.00%); 52w low $11.76 (+108.24%) |
| Trend | +30.66% vs SMA200, +12.97% vs SMA50, +4.30% vs SMA20 |
| Momentum | RSI(14) 68.6 (neutral) |
| Volatility | ATR(14) 0.66 (~2.7% of price); beta 0.48 |
...
| Valuation | P/E 15.80, forward P/E 11.02, P/S 3.58, P/B 1.71 | EV/Sales 4.00, EV/EBITDA 5.39 |
...
|---|---|---|---|
| Price | $24.49 | EV/Sales | 4.00 |
| Market cap | $20.51B | EV/EBITDA | 5.39 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 68.6 | Operating margin | 57.44% |
| ATR(14) | 0.66 | Profit margin | 21.52% |
| SMA20 dist | +4.30% | ROA | 7.54% |
| SMA50 dist | +12.97% | ROE | 11.40% |
| SMA200 dist | +30.66% | Revenue (ttm) | $5.74B |
| 52W high | $24.49 | Revenue growth y/y | 55.10% |
| 52W low | $11.76 | Inst. ownership | 92.72% |
| P/E (ttm) | 15.80 | Insider ownership | 4.61% |
| Forward P/E | 11.02 | Short float | 2.47% |
| PEG (trailing) | 1.37 | Avg volume | 9,831,783 |
| P/S | 3.58 | Employees | 515 |
| P/B | 1.71 | Analyst rec (1=buy..5=sell) | 1.3 |

...
Signed file: `FTI.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $76.34 (2026-09-11, ~15-min delayed) |
| Market cap | $29.94B |
...
|---|---|---|
| Technical momentum | High | 1Y +87.31%; price +17.47% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 21.21, EV/Sales 2.87. |
| Risk level | Elevated | Beta 0.74, ATR 3.1% of price, short float 3.28%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $76.34; 52w high $80.08 (-4.67%); 52w low $35.45 (+115.32%) |
| Trend | +17.47% vs SMA200, +2.82% vs SMA50, -1.60% vs SMA20 |
| Momentum | RSI(14) 50.1 (neutral) |
| Volatility | ATR(14) 2.40 (~3.1% of price); beta 0.74 |
...
| Valuation | P/E 26.69, forward P/E 21.21, P/S 2.87, P/B 9.17 | EV/Sales 2.87, EV/EBITDA 15.07 |
...
- **Valuation risk:** Forward P/E 21.21, EV/Sales 2.87. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.74, ATR 3.1% of price, short float 3.28%. Size positions accordingly.
...
|---|---|---|---|
| Price | $76.34 | EV/Sales | 2.87 |
| Market cap | $29.94B | EV/EBITDA | 15.07 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 50.1 | Operating margin | 17.69% |
| ATR(14) | 2.40 | Profit margin | 11.28% |
| SMA20 dist | -1.60% | ROA | 9.53% |
| SMA50 dist | +2.82% | ROE | 35.81% |
| SMA200 dist | +17.47% | Revenue (ttm) | $10.42B |
| 52W high | $80.08 | Revenue growth y/y | 9.00% |
| 52W low | $35.45 | Inst. ownership | 101.12% |
| P/E (ttm) | 26.69 | Insider ownership | 1.49% |
| Forward P/E | 21.21 | Short float | 3.28% |
| PEG (trailing) | — | Avg volume | 3,653,030 |
| P/S | 2.87 | Employees | 22,000 |
| P/B | 9.17 | Analyst rec (1=buy..5=sell) | 2.0 |

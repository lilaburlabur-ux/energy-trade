...
Signed file: `SHEL.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $91.62 (2026-08-17, ~15-min delayed) |
| Market cap | $252.98B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +32.12%; price +13.94% vs SMA200. |
| Fresh setup quality | Watch | -0.94% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 8.76%, revenue growth 44.70%. |
| Value attractiveness | Reasonable | Forward P/E 10.39, EV/Sales 0.99. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $91.62; 52w high $92.49 (-0.94%); 52w low $68.25 (+34.24%) |
| Trend | +13.94% vs SMA200, +8.94% vs SMA50, +3.52% vs SMA20 |
| Momentum | RSI(14) 65.0 (neutral) |
| Volatility | ATR(14) 1.58 (~1.7% of price); beta -0.22 |
| Setup perspective | -0.94% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 10.13, forward P/E 10.39, P/S 0.85, P/B 1.49 | EV/Sales 0.99, EV/EBITDA 5.12 |
...
|---|---|---|---|
| Price | $91.62 | EV/Sales | 0.99 |
| Market cap | $252.98B | EV/EBITDA | 5.12 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 65.0 | Operating margin | 16.69% |
| ATR(14) | 1.58 | Profit margin | 8.76% |
| SMA20 dist | +3.52% | ROA | 6.40% |
| SMA50 dist | +8.94% | ROE | 14.34% |
| SMA200 dist | +13.94% | Revenue (ttm) | $296.60B |
| 52W high | $92.49 | Revenue growth y/y | 44.70% |
| 52W low | $68.25 | Inst. ownership | 13.90% |
| P/E (ttm) | 10.13 | Insider ownership | 0.01% |
| Forward P/E | 10.39 | Short float | 1.77% |
| PEG (trailing) | 1.35 | Avg volume | 6,625,329 |

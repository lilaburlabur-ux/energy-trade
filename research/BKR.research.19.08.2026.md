...
Signed file: `BKR.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $64.48 (2026-08-19, ~15-min delayed) |
| Market cap | $64.01B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +52.76%; price +12.70% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 20.40, EV/Sales 2.29. |
| Risk level | Moderate | Beta 0.96, ATR 2.6% of price, short float 2.83%. |
...
| 1 Profitable Stock Worth Your Attention and 2 We Turn Down | StockStory | 2026-08-17 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $64.48; 52w high $69.18 (-6.80%); 52w low $42.19 (+52.83%) |
| Trend | +12.70% vs SMA200, +8.86% vs SMA50, +4.60% vs SMA20 |
| Momentum | RSI(14) 63.8 (neutral) |
| Volatility | ATR(14) 1.65 (~2.6% of price); beta 0.96 |
...
| Valuation | P/E 20.73, forward P/E 20.40, P/S 2.31, P/B 3.21 | EV/Sales 2.29, EV/EBITDA 13.10 |
...
- **Valuation risk:** Forward P/E 20.40, EV/Sales 2.29. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $64.48 | EV/Sales | 2.29 |
| Market cap | $64.01B | EV/EBITDA | 13.10 |
| Beta | 0.96 | Gross margin | 23.66% |
| RSI(14) | 63.8 | Operating margin | 12.83% |
| ATR(14) | 1.65 | Profit margin | 11.17% |
| SMA20 dist | +4.60% | ROA | 4.85% |
| SMA50 dist | +8.86% | ROE | 16.46% |
| SMA200 dist | +12.70% | Revenue (ttm) | $27.73B |
| 52W high | $69.18 | Revenue growth y/y | -2.40% |
| 52W low | $42.19 | Inst. ownership | 101.00% |
| P/E (ttm) | 20.73 | Insider ownership | 0.15% |
| Forward P/E | 20.40 | Short float | 2.83% |
| PEG (trailing) | 2.22 | Avg volume | 8,617,598 |
| P/S | 2.31 | Employees | 54,000 |

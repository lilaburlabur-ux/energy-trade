...
Signed file: `PR.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $23.76 (2026-09-14, ~15-min delayed) |
| Market cap | $19.90B |
...
|---|---|---|
| Technical momentum | High | 1Y +77.10%; price +27.13% vs SMA200. |
| Fresh setup quality | Watch | -0.46% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Strong | Profit margin 21.52%, revenue growth 55.10%. |
| Value attractiveness | Reasonable | Forward P/E 10.77, EV/Sales 4.00. |
| Risk level | Moderate | Beta 0.48, ATR 2.7% of price, short float 2.47%. |
...
| 1 Profitable Stock with Impressive Fundamentals and 2 We Find Risky | StockStory | 2026-09-03 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $23.76; 52w high $23.87 (-0.46%); 52w low $11.76 (+102.03%) |
| Trend | +27.13% vs SMA200, +10.24% vs SMA50, +1.69% vs SMA20 |
| Momentum | RSI(14) 62.6 (neutral) |
| Volatility | ATR(14) 0.64 (~2.7% of price); beta 0.48 |
| Setup perspective | -0.46% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 15.33, forward P/E 10.77, P/S 3.47, P/B 1.66 | EV/Sales 4.00, EV/EBITDA 5.39 |
| Growth expectations | Earnings growth 232.90%, EPS q/q 282.60% | Analyst mean target $26.62 (21 analysts) |
...
|---|---|---|---|
| Price | $23.76 | EV/Sales | 4.00 |
| Market cap | $19.90B | EV/EBITDA | 5.39 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 62.6 | Operating margin | 57.44% |
| ATR(14) | 0.64 | Profit margin | 21.52% |
| SMA20 dist | +1.69% | ROA | 7.54% |
| SMA50 dist | +10.24% | ROE | 11.40% |
| SMA200 dist | +27.13% | Revenue (ttm) | $5.74B |
| 52W high | $23.87 | Revenue growth y/y | 55.10% |
| 52W low | $11.76 | Inst. ownership | 92.74% |
| P/E (ttm) | 15.33 | Insider ownership | 4.61% |
| Forward P/E | 10.77 | Short float | 2.47% |
| PEG (trailing) | 1.27 | Avg volume | 9,926,448 |

...
Signed file: `EPD.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $36.75 (2026-09-25, ~15-min delayed) |
| Market cap | $79.36B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +23.44%; price +2.16% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.63% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 11.55, EV/Sales 1.95. |
| Risk level | Moderate | Beta 0.48, ATR 1.7% of price, short float 2.40%. |
...
| This Stock Pays a 6% Yield — and Has Raised Its Dividend for 28 Straight Years | Barchart | 2026-09-24 |
| Why ONEOK’s Dividend Raise Matters More Than Its Eye-Catching Yield | 24/7 Wall St. | 2026-09-24 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.75; 52w high $39.36 (-6.63%); 52w low $28.35 (+29.61%) |
| Trend | +2.16% vs SMA200, -4.13% vs SMA50, -4.79% vs SMA20 |
| Momentum | RSI(14) 32.9 (neutral) |
| Volatility | ATR(14) 0.62 (~1.7% of price); beta 0.48 |
| Setup perspective | -6.63% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 12.72, forward P/E 11.55, P/S 1.36, P/B 2.62 | EV/Sales 1.95, EV/EBITDA 11.08 |
...
|---|---|---|---|
| Price | $36.75 | EV/Sales | 1.95 |
| Market cap | $79.36B | EV/EBITDA | 11.08 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 32.9 | Operating margin | 11.76% |
| ATR(14) | 0.62 | Profit margin | 10.79% |
| SMA20 dist | -4.79% | ROA | 5.92% |
| SMA50 dist | -4.13% | ROE | 20.85% |
| SMA200 dist | +2.16% | Revenue (ttm) | $58.47B |
| 52W high | $39.36 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.64% |
| P/E (ttm) | 12.72 | Insider ownership | 33.04% |
| Forward P/E | 11.55 | Short float | 2.40% |
| PEG (trailing) | 1.33 | Avg volume | 2,884,100 |

...
Signed file: `GEV.research.04.09.2026`

| Field | Value |
|---|---|
| Current price | $941.95 (2026-09-04, ~15-min delayed) |
| Market cap | $250.87B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +57.66%; price +6.37% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 37.27, EV/Sales 5.87. |
| Risk level | Elevated | Beta 0.97, ATR 4.5% of price, short float 2.98%. |
...
|---|---|---|
| Exchange-Traded Funds Higher, Equity Futures Mixed Pre-Bell Friday After August Jobs Report Tops Estimates | MT Newswires | 2026-09-04 |
| GE Vernova signs agreement to supply turbines for ESB wind farm in Scotland | Energy Global | 2026-09-04 |
| Market Chatter: GE Vernova Deal Aims to Stabilize Venezuela Power Grid Within Six to 12 Months | MT Newswires | 2026-09-04 |
| GE Vernova (GEV) Laps the Stock Market: Here's Why | Zacks | 2026-09-03 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $941.95; 52w high $1,174.86 (-19.82%); 52w low $546.95 (+72.22%) |
| Trend | +6.37% vs SMA200, -7.23% vs SMA50, -3.09% vs SMA20 |
| Momentum | RSI(14) 44.6 (neutral) |
| Volatility | ATR(14) 42.16 (~4.5% of price); beta 0.97 |
...
| Valuation | P/E 27.03, forward P/E 37.27, P/S 6.06, P/B 20.98 | EV/Sales 5.87, EV/EBITDA 61.88 |
...
- **Valuation risk:** Forward P/E 37.27, EV/Sales 5.87. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.97, ATR 4.5% of price, short float 2.98%. Size positions accordingly.
...
|---|---|---|---|
| Price | $941.95 | EV/Sales | 5.87 |
| Market cap | $250.87B | EV/EBITDA | 61.88 |
| Beta | 0.97 | Gross margin | 20.57% |
| RSI(14) | 44.6 | Operating margin | 7.47% |
| ATR(14) | 42.16 | Profit margin | 23.04% |
| SMA20 dist | -3.09% | ROA | 2.54% |
| SMA50 dist | -7.23% | ROE | 82.58% |
| SMA200 dist | +6.37% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.75% |
| P/E (ttm) | 27.03 | Insider ownership | 0.13% |
| Forward P/E | 37.27 | Short float | 2.98% |
| PEG (trailing) | 1.75 | Avg volume | 2,757,055 |
| P/S | 6.06 | Employees | 78,000 |

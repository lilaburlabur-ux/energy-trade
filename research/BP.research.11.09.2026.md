...
Signed file: `BP.research.11.09.2026`
...
|---|---|---|
| Technical momentum | Moderate | 1Y +39.46%; price +14.89% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.90% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 2.55%, revenue growth 48.20%. |
| Value attractiveness | Reasonable | Forward P/E 9.39, EV/Sales 2.46. |
| Risk level | Moderate | Beta -0.22, ATR 2.1% of price, short float 0.29%. |
...
|---|---|---|
| Energy & Utilities Roundup: Market Talk | The Wall Street Journal | 2026-09-11 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $46.10; 52w high $46.52 (-0.90%); 52w low $31.17 (+47.88%) |
| Trend | +14.89% vs SMA200, +8.97% vs SMA50, +5.08% vs SMA20 |
| Momentum | RSI(14) 65.6 (neutral) |
| Volatility | ATR(14) 0.99 (~2.1% of price); beta -0.22 |
| Setup perspective | -0.90% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 22.06, forward P/E 9.39, P/S 0.55, P/B 8.17 | EV/Sales 2.46, EV/EBITDA 13.53 |
...
| SMA20 dist | +5.08% | ROA | 5.04% |
| SMA50 dist | +8.97% | ROE | 8.87% |
| SMA200 dist | +14.89% | Revenue (ttm) | $215.47B |
| 52W high | $46.52 | Revenue growth y/y | 48.20% |
| 52W low | $31.17 | Inst. ownership | 14.09% |
| P/E (ttm) | 22.06 | Insider ownership | 0.00% |
| Forward P/E | 9.39 | Short float | 0.29% |
| PEG (trailing) | 0.06 | Avg volume | 9,205,508 |
| P/S | 0.55 | Employees | 93,700 |
| P/B | 8.17 | Analyst rec (1=buy..5=sell) | 2.4 |

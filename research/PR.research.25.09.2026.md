...
Signed file: `PR.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $21.36 (2026-09-25, ~15-min delayed) |
| Market cap | $17.89B |
...
|---|---|---|
| Technical momentum | High | 1Y +61.69%; price +12.77% vs SMA200. |
| Fresh setup quality | Moderate / wait | -12.21% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 21.52%, revenue growth 55.10%. |
| Value attractiveness | Reasonable | Forward P/E 9.61, EV/Sales 3.64. |
| Risk level | Elevated | Beta 0.48, ATR 3.3% of price, short float 2.54%. |
...
|---|---|---|
| Permian Resources (PR) Stock Still Looks Cheap As Its 371% Run Continues | Simply Wall St. | 2026-09-17 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $21.36; 52w high $24.33 (-12.21%); 52w low $11.68 (+82.82%) |
| Trend | +12.77% vs SMA200, -2.89% vs SMA50, -6.91% vs SMA20 |
| Momentum | RSI(14) 40.1 (neutral) |
| Volatility | ATR(14) 0.70 (~3.3% of price); beta 0.48 |
| Setup perspective | -12.21% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 13.78, forward P/E 9.61, P/S 3.12, P/B 1.49 | EV/Sales 3.64, EV/EBITDA 4.91 |
...
- **Volatility risk:** Beta 0.48, ATR 3.3% of price, short float 2.54%. Size positions accordingly.
...
|---|---|---|---|
| Price | $21.36 | EV/Sales | 3.64 |
| Market cap | $17.89B | EV/EBITDA | 4.91 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 40.1 | Operating margin | 57.44% |
| ATR(14) | 0.70 | Profit margin | 21.52% |
| SMA20 dist | -6.91% | ROA | 7.54% |
| SMA50 dist | -2.89% | ROE | 11.40% |
| SMA200 dist | +12.77% | Revenue (ttm) | $5.74B |
| 52W high | $24.33 | Revenue growth y/y | 55.10% |
| 52W low | $11.68 | Inst. ownership | 92.73% |
| P/E (ttm) | 13.78 | Insider ownership | 4.61% |
| Forward P/E | 9.61 | Short float | 2.54% |
| PEG (trailing) | 1.25 | Avg volume | 9,789,668 |
| P/S | 3.12 | Employees | 515 |
| P/B | 1.49 | Analyst rec (1=buy..5=sell) | 1.3 |

## 8. Analyst Actions
| Date | Action | Firm | Rating change |
|---|---|---|---|
| 2026-09-24 | reit | RBC Capital | Outperform → Outperform |
| 2026-09-15 | main | Keybanc | Overweight → Overweight |

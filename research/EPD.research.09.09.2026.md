...
Signed file: `EPD.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $39.32 (2026-09-09, ~15-min delayed) |
| Market cap | $84.91B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +33.04%; price +10.65% vs SMA200. |
| Fresh setup quality | Watch | -0.10% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.42, EV/Sales 2.03. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $39.32; 52w high $39.36 (-0.10%); 52w low $28.35 (+38.68%) |
| Trend | +10.65% vs SMA200, +3.53% vs SMA50, +1.57% vs SMA20 |
| Momentum | RSI(14) 59.9 (neutral) |
| Volatility | ATR(14) 0.56 (~1.4% of price); beta 0.48 |
| Setup perspective | -0.10% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.61, forward P/E 12.42, P/S 1.45, P/B 2.81 | EV/Sales 2.03, EV/EBITDA 11.51 |
...
|---|---|---|---|
| Price | $39.32 | EV/Sales | 2.03 |
| Market cap | $84.91B | EV/EBITDA | 11.51 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 59.9 | Operating margin | 11.76% |
| ATR(14) | 0.56 | Profit margin | 10.79% |
| SMA20 dist | +1.57% | ROA | 5.92% |
| SMA50 dist | +3.53% | ROE | 20.85% |
| SMA200 dist | +10.65% | Revenue (ttm) | $58.47B |
...
| PEG (trailing) | 1.37 | Avg volume | 2,962,680 |

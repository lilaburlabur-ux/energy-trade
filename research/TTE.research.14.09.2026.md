...
Signed file: `TTE.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $91.14 (2026-09-14, ~15-min delayed) |
| Market cap | $201.40B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +54.83%; price +12.88% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 8.80, EV/Sales 1.20. |
| Risk level | Moderate | Beta 0.06, ATR 1.7% of price, short float 0.22%. |
...
| TotalEnergies (TTE) Sees Long-Term Potential in Angola’s Offshore Oil | Insider Monkey | 2026-09-14 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $91.14; 52w high $93.60 (-2.63%); 52w low $55.92 (+62.98%) |
| Trend | +12.88% vs SMA200, +5.92% vs SMA50, +1.86% vs SMA20 |
| Momentum | RSI(14) 59.6 (neutral) |
| Volatility | ATR(14) 1.59 (~1.7% of price); beta 0.06 |
...
| Valuation | P/E 11.41, forward P/E 8.80, P/S 1.03, P/B 1.58 | EV/Sales 1.20, EV/EBITDA 5.96 |
...
|---|---|---|---|
| Price | $91.14 | EV/Sales | 1.20 |
| Market cap | $201.40B | EV/EBITDA | 5.96 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 59.6 | Operating margin | 12.79% |
| ATR(14) | 1.59 | Profit margin | 9.08% |
| SMA20 dist | +1.86% | ROA | 5.51% |
| SMA50 dist | +5.92% | ROE | 14.48% |
| SMA200 dist | +12.88% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 54.15% |
| P/E (ttm) | 11.41 | Insider ownership | 8.86% |
| Forward P/E | 8.80 | Short float | 0.22% |
| PEG (trailing) | 0.83 | Avg volume | 1,672,229 |
| P/S | 1.03 | Employees | 94,847 |
| P/B | 1.58 | Analyst rec (1=buy..5=sell) | 2.0 |

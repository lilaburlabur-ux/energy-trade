...
Signed file: `FLNC.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $9.30 (2026-09-15, ~15-min delayed) |
| Market cap | $1.73B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-47.95%) with negative half-year (-44.58%). |
| Fresh setup quality | Poor / broken | -71.14% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 72.68, EV/Sales 0.56. |
| Risk level | High | Beta 2.74, ATR 8.1% of price, short float 34.01%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.30; 52w high $32.23 (-71.14%); 52w low $7.39 (+25.85%) |
| Trend | -47.95% vs SMA200, -27.26% vs SMA50, -13.03% vs SMA20 |
| Momentum | RSI(14) 32.5 (neutral) |
| Volatility | ATR(14) 0.75 (~8.1% of price); beta 2.74 |
| Setup perspective | -71.14% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 72.68, P/S 0.66, P/B 3.57 | EV/Sales 0.56, EV/EBITDA -18.77 |
...
- **Valuation risk:** Forward P/E 72.68, EV/Sales 0.56. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.74, ATR 8.1% of price, short float 34.01%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.30 | EV/Sales | 0.56 |
| Market cap | $1.73B | EV/EBITDA | -18.77 |
| Beta | 2.74 | Gross margin | 9.36% |
| RSI(14) | 32.5 | Operating margin | -8.85% |
| ATR(14) | 0.75 | Profit margin | -3.07% |
| SMA20 dist | -13.03% | ROA | -2.95% |
| SMA50 dist | -27.26% | ROE | -23.54% |
| SMA200 dist | -47.95% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $7.39 | Inst. ownership | 84.59% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 72.68 | Short float | 34.01% |
| PEG (trailing) | — | Avg volume | 7,756,317 |
| P/S | 0.66 | Employees | 1,670 |
| P/B | 3.57 | Analyst rec (1=buy..5=sell) | 2.7 |

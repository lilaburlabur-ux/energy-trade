...
Signed file: `MPLX.research.10.09.2026`
...
|---|---|---|
| Technical momentum | Moderate | 1Y +28.84%; price +8.85% vs SMA200. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $59.63; 52w high $60.23 (-1.00%); 52w low $44.22 (+34.85%) |
| Trend | +8.85% vs SMA200, +3.03% vs SMA50, +0.79% vs SMA20 |
| Momentum | RSI(14) 57.2 (neutral) |
| Volatility | ATR(14) 0.91 (~1.5% of price); beta 0.46 |
...
| SMA20 dist | +0.79% | ROA | 7.25% |
| SMA50 dist | +3.03% | ROE | 33.69% |
| SMA200 dist | +8.85% | Revenue (ttm) | $12.03B |

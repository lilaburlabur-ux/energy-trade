...
Signed file: `FTI.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $72.78 (2026-09-16, ~15-min delayed) |
| Market cap | $28.54B |
...
|---|---|---|
| Technical momentum | High | 1Y +87.13%; price +11.26% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 20.23, EV/Sales 2.85. |
| Risk level | Elevated | Beta 0.74, ATR 3.5% of price, short float 3.28%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $72.78; 52w high $80.08 (-9.12%); 52w low $35.45 (+105.28%) |
| Trend | +11.26% vs SMA200, -2.47% vs SMA50, -5.21% vs SMA20 |
| Momentum | RSI(14) 41.6 (neutral) |
| Volatility | ATR(14) 2.56 (~3.5% of price); beta 0.74 |
| Setup perspective | -9.12% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 25.45, forward P/E 20.23, P/S 2.74, P/B 8.74 | EV/Sales 2.85, EV/EBITDA 14.95 |
...
- **Valuation risk:** Forward P/E 20.23, EV/Sales 2.85. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.74, ATR 3.5% of price, short float 3.28%. Size positions accordingly.
...
|---|---|---|---|
| Price | $72.78 | EV/Sales | 2.85 |
| Market cap | $28.54B | EV/EBITDA | 14.95 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 41.6 | Operating margin | 17.69% |
| ATR(14) | 2.56 | Profit margin | 11.28% |
| SMA20 dist | -5.21% | ROA | 9.53% |
| SMA50 dist | -2.47% | ROE | 35.81% |
| SMA200 dist | +11.26% | Revenue (ttm) | $10.42B |
| 52W high | $80.08 | Revenue growth y/y | 9.00% |
| 52W low | $35.45 | Inst. ownership | 101.17% |
| P/E (ttm) | 25.45 | Insider ownership | 1.49% |
| Forward P/E | 20.23 | Short float | 3.28% |
| PEG (trailing) | — | Avg volume | 3,630,977 |
| P/S | 2.74 | Employees | 22,000 |
| P/B | 8.74 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `AR.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $39.17 (2026-09-10, ~15-min delayed) |
| Market cap | $12.04B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +21.72%; price +7.77% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 9.15, EV/Sales —. |
| Risk level | Moderate | Beta 0.35, ATR 2.7% of price, short float 4.44%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $39.17; 52w high $45.15 (-13.24%); 52w low $30.03 (+30.44%) |
| Trend | +7.77% vs SMA200, +8.04% vs SMA50, +2.27% vs SMA20 |
| Momentum | RSI(14) 62.5 (neutral) |
| Volatility | ATR(14) 1.04 (~2.7% of price); beta 0.35 |
...
| Valuation | P/E 11.22, forward P/E 9.15, P/S 2.08, P/B 1.45 | EV/Sales —, EV/EBITDA — |
...
|---|---|---|---|
| Price | $39.17 | EV/Sales | — |
| Market cap | $12.04B | EV/EBITDA | — |
| Beta | 0.35 | Gross margin | 67.15% |
| RSI(14) | 62.5 | Operating margin | 26.02% |
| ATR(14) | 1.04 | Profit margin | 18.75% |
| SMA20 dist | +2.27% | ROA | 6.61% |
| SMA50 dist | +8.04% | ROE | 14.22% |
| SMA200 dist | +7.77% | Revenue (ttm) | $5.78B |
| 52W high | $45.15 | Revenue growth y/y | 12.60% |
| 52W low | $30.03 | Inst. ownership | 91.55% |
| P/E (ttm) | 11.22 | Insider ownership | 4.41% |
| Forward P/E | 9.15 | Short float | 4.44% |
| PEG (trailing) | 0.45 | Avg volume | 4,366,311 |

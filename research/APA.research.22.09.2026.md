...
Signed file: `APA.research.22.09.2026`

| Field | Value |
|---|---|
| Current price | $42.30 (2026-09-22, ~15-min delayed) |
| Market cap | $14.82B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $42.30; 52w high $47.41 (-10.78%); 52w low $21.16 (+99.86%) |
| Trend | +23.11% vs SMA200, +4.92% vs SMA50, -3.63% vs SMA20 |
| Momentum | RSI(14) 47.1 (neutral) |
| Volatility | ATR(14) 1.55 (~3.7% of price); beta 0.37 |
| Setup perspective | -10.78% from 52w high; no clean fresh pivot by default. |
...
|---|---|---|---|
| Price | $42.30 | EV/Sales | 2.30 |
| Market cap | $14.82B | EV/EBITDA | 3.45 |
| Beta | 0.37 | Gross margin | 78.25% |
| RSI(14) | 47.1 | Operating margin | 56.33% |
| ATR(14) | 1.55 | Profit margin | 19.56% |
| SMA20 dist | -3.63% | ROA | 11.60% |
| SMA50 dist | +4.92% | ROE | 26.66% |
| SMA200 dist | +23.11% | Revenue (ttm) | $8.57B |

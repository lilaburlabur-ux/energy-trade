...
Signed file: `SO.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $87.17 (2026-09-11, ~15-min delayed) |
| Market cap | $100.28B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-4.27%) with negative half-year (-9.43%). |
| Fresh setup quality | Moderate / wait | -10.59% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 15.43%, revenue growth 0.10%. |
| Value attractiveness | Reasonable | Forward P/E 17.70, EV/Sales 5.89. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $87.17; 52w high $97.49 (-10.59%); 52w low $82.06 (+6.22%) |
| Trend | -4.27% vs SMA200, -5.51% vs SMA50, -2.58% vs SMA20 |
| Momentum | RSI(14) 32.8 (neutral) |
| Volatility | ATR(14) 1.43 (~1.6% of price); beta 0.32 |
| Setup perspective | -10.59% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.00, forward P/E 17.70, P/S 3.32, P/B 2.53 | EV/Sales 5.89, EV/EBITDA 12.47 |
...
|---|---|---|---|
| Price | $87.17 | EV/Sales | 5.89 |
| Market cap | $100.28B | EV/EBITDA | 12.47 |
| Beta | 0.32 | Gross margin | 48.29% |
| RSI(14) | 32.8 | Operating margin | 29.61% |
| ATR(14) | 1.43 | Profit margin | 15.43% |
| SMA20 dist | -2.58% | ROA | 3.27% |
| SMA50 dist | -5.51% | ROE | 11.48% |
| SMA200 dist | -4.27% | Revenue (ttm) | $30.18B |
| 52W high | $97.49 | Revenue growth y/y | 0.10% |
| 52W low | $82.06 | Inst. ownership | 74.23% |
| P/E (ttm) | 21.00 | Insider ownership | 0.10% |
| Forward P/E | 17.70 | Short float | 3.06% |
| PEG (trailing) | 2.07 | Avg volume | 5,854,008 |
| P/S | 3.32 | Employees | 29,502 |
| P/B | 2.53 | Analyst rec (1=buy..5=sell) | 2.7 |

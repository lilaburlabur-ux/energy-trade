...
Signed file: `FLNC.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $14.23 (2026-08-05, ~15-min delayed) |
| Market cap | $2.62B |
...
|---|---|---|
| Technical momentum | High | 1Y +67.81%; price -24.50% vs SMA200. |
| Fresh setup quality | Poor / broken | -55.85% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-1.62%). |
| Value attractiveness | Low (expensive) | Forward P/E 72.84, EV/Sales 0.79. |
| Risk level | High | Beta 2.78, ATR 11.3% of price, short float 40.44%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $14.23; 52w high $32.23 (-55.85%); 52w low $6.75 (+110.81%) |
| Trend | -24.50% vs SMA200, -24.65% vs SMA50, -1.69% vs SMA20 |
| Momentum | RSI(14) 44.3 (neutral) |
| Volatility | ATR(14) 1.60 (~11.3% of price); beta 2.78 |
| Setup perspective | -55.85% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 72.84, P/S 1.01, P/B 5.13 | EV/Sales 0.79, EV/EBITDA -110.47 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $18.67 (18 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 86.35% |
...
- **Valuation risk:** Forward P/E 72.84, EV/Sales 0.79. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.78, ATR 11.3% of price, short float 40.44%. Size positions accordingly.
...
|---|---|---|---|
| Price | $14.23 | EV/Sales | 0.79 |
| Market cap | $2.62B | EV/EBITDA | -110.47 |
| Beta | 2.78 | Gross margin | 11.71% |
| RSI(14) | 44.3 | Operating margin | -8.43% |
| ATR(14) | 1.60 | Profit margin | -1.62% |
| SMA20 dist | -1.69% | ROA | -1.32% |
| SMA50 dist | -24.65% | ROE | -12.72% |
| SMA200 dist | -24.50% | Revenue (ttm) | $2.58B |
| 52W high | $32.23 | Revenue growth y/y | 7.70% |
| 52W low | $6.75 | Inst. ownership | 86.35% |
| P/E (ttm) | — | Insider ownership | 14.45% |
| Forward P/E | 72.84 | Short float | 40.44% |
| PEG (trailing) | — | Avg volume | 12,161,352 |
| P/S | 1.01 | Employees | 1,670 |
| P/B | 5.13 | Analyst rec (1=buy..5=sell) | 2.7 |

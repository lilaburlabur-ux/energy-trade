...
Signed file: `FTI.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $72.02 (2026-09-18, ~15-min delayed) |
| Market cap | $28.24B |
...
|---|---|---|
| Technical momentum | High | 1Y +84.23%; price +9.64% vs SMA200. |
| Fresh setup quality | Moderate / wait | -10.06% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 11.28%, revenue growth 9.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.02, EV/Sales 2.76. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $72.02; 52w high $80.08 (-10.06%); 52w low $35.45 (+103.14%) |
| Trend | +9.64% vs SMA200, -3.59% vs SMA50, -5.59% vs SMA20 |
| Momentum | RSI(14) 39.8 (neutral) |
| Volatility | ATR(14) 2.47 (~3.4% of price); beta 0.74 |
| Setup perspective | -10.06% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 25.18, forward P/E 20.02, P/S 2.71, P/B 8.65 | EV/Sales 2.76, EV/EBITDA 14.51 |
...
- **Valuation risk:** Forward P/E 20.02, EV/Sales 2.76. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $72.02 | EV/Sales | 2.76 |
| Market cap | $28.24B | EV/EBITDA | 14.51 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 39.8 | Operating margin | 17.69% |
| ATR(14) | 2.47 | Profit margin | 11.28% |
| SMA20 dist | -5.59% | ROA | 9.53% |
| SMA50 dist | -3.59% | ROE | 35.81% |
| SMA200 dist | +9.64% | Revenue (ttm) | $10.42B |
| 52W high | $80.08 | Revenue growth y/y | 9.00% |
| 52W low | $35.45 | Inst. ownership | 101.17% |
| P/E (ttm) | 25.18 | Insider ownership | 1.49% |
| Forward P/E | 20.02 | Short float | 3.28% |
| PEG (trailing) | — | Avg volume | 3,520,280 |
| P/S | 2.71 | Employees | 22,000 |
| P/B | 8.65 | Analyst rec (1=buy..5=sell) | 2.0 |

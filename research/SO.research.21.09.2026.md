...
Signed file: `SO.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $85.46 (2026-09-21, ~15-min delayed) |
| Market cap | $98.31B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $85.46; 52w high $97.49 (-12.34%); 52w low $82.06 (+4.14%) |
| Trend | -6.11% vs SMA200, -6.21% vs SMA50, -2.75% vs SMA20 |
| Momentum | RSI(14) 30.0 (oversold) |
| Volatility | ATR(14) 1.31 (~1.5% of price); beta 0.32 |
| Setup perspective | -12.34% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | -2.75% | ROA | 3.27% |
| SMA50 dist | -6.21% | ROE | 11.48% |

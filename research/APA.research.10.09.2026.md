...
Signed file: `APA.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $44.53 (2026-09-10, ~15-min delayed) |
| Market cap | $15.60B |
...
|---|---|---|
| Technical momentum | High | 1Y +112.76%; price +32.75% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.23, EV/Sales 2.34. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $44.53; 52w high $44.84 (-0.69%); 52w low $21.16 (+110.40%) |
| Trend | +32.75% vs SMA200, +15.80% vs SMA50, +3.79% vs SMA20 |
| Momentum | RSI(14) 62.9 (neutral) |
| Volatility | ATR(14) 1.49 (~3.3% of price); beta 0.37 |
...
| Valuation | P/E 9.39, forward P/E 10.23, P/S 1.82, P/B 2.22 | EV/Sales 2.34, EV/EBITDA 3.51 |
...
|---|---|---|---|
| Price | $44.53 | EV/Sales | 2.34 |
| Market cap | $15.60B | EV/EBITDA | 3.51 |
| Beta | 0.37 | Gross margin | 78.25% |
| RSI(14) | 62.9 | Operating margin | 56.33% |
| ATR(14) | 1.49 | Profit margin | 19.56% |
| SMA20 dist | +3.79% | ROA | 11.60% |
| SMA50 dist | +15.80% | ROE | 26.66% |
| SMA200 dist | +32.75% | Revenue (ttm) | $8.57B |
| 52W high | $44.84 | Revenue growth y/y | 9.20% |
| 52W low | $21.16 | Inst. ownership | 109.93% |
| P/E (ttm) | 9.39 | Insider ownership | 0.44% |
| Forward P/E | 10.23 | Short float | 9.82% |
| PEG (trailing) | 1.20 | Avg volume | 5,548,285 |
| P/S | 1.82 | Employees | 1,791 |

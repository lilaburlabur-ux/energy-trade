...
Signed file: `DVN.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $48.72 (2026-09-17, ~15-min delayed) |
| Market cap | $53.59B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $48.72; 52w high $51.37 (-5.16%); 52w low $30.95 (+57.41%) |
| Trend | +12.03% vs SMA200, +6.36% vs SMA50, +0.58% vs SMA20 |
| Momentum | RSI(14) 54.4 (neutral) |
| Volatility | ATR(14) 1.42 (~2.9% of price); beta 0.43 |
...
| SMA20 dist | +0.58% | ROA | 5.91% |
| SMA50 dist | +6.36% | ROE | 11.52% |
| SMA200 dist | +12.03% | Revenue (ttm) | $18.78B |
| 52W high | $51.37 | Revenue growth y/y | 64.20% |
| 52W low | $30.95 | Inst. ownership | 94.74% |
| P/E (ttm) | 10.59 | Insider ownership | 0.80% |
| Forward P/E | 9.09 | Short float | 2.62% |
| PEG (trailing) | 2.92 | Avg volume | 11,673,240 |

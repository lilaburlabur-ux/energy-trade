...
Signed file: `NEE.research.28.08.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-4.26%) with negative half-year (-7.97%). |
...
| Value attractiveness | Reasonable | Forward P/E 19.02, EV/Sales 10.19. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $83.47; 52w high $97.17 (-14.10%); 52w low $68.33 (+22.16%) |
| Trend | -4.26% vs SMA200, -4.06% vs SMA50, -2.22% vs SMA20 |
...
| SMA20 dist | -2.22% | ROA | 2.44% |
| SMA50 dist | -4.06% | ROE | 11.68% |

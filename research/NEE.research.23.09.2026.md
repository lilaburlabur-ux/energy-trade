...
Signed file: `NEE.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $77.02 (2026-09-23, ~15-min delayed) |
| Market cap | $160.66B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-10.91%) with negative half-year (-13.37%). |
...
| Value attractiveness | Reasonable | Forward P/E 17.52, EV/Sales 9.72. |
| Risk level | Moderate | Beta 0.64, ATR 1.8% of price, short float 0.00%. |
...
|---|---|---|
| NextEra Energy, Inc. (NEE) is Attracting Investor Attention: Here is What You Should Know | Zacks | 2026-09-23 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $77.02; 52w high $96.44 (-20.14%); 52w low $70.30 (+9.56%) |
| Trend | -10.91% vs SMA200, -9.01% vs SMA50, -6.10% vs SMA20 |
| Momentum | RSI(14) 22.9 (oversold) |
| Volatility | ATR(14) 1.37 (~1.8% of price); beta 0.64 |
...
| Valuation | P/E 17.31, forward P/E 17.52, P/S 5.60, P/B 2.81 | EV/Sales 9.72, EV/EBITDA 19.12 |
...
|---|---|---|---|
| Price | $77.02 | EV/Sales | 9.72 |
| Market cap | $160.66B | EV/EBITDA | 19.12 |
| Beta | 0.64 | Gross margin | 61.02% |
| RSI(14) | 22.9 | Operating margin | 31.52% |
| ATR(14) | 1.37 | Profit margin | 32.40% |
| SMA20 dist | -6.10% | ROA | 2.44% |
| SMA50 dist | -9.01% | ROE | 11.68% |
| SMA200 dist | -10.91% | Revenue (ttm) | $28.70B |
| 52W high | $96.44 | Revenue growth y/y | 12.40% |
| 52W low | $70.30 | Inst. ownership | 87.02% |
| P/E (ttm) | 17.31 | Insider ownership | 0.12% |
| Forward P/E | 17.52 | Short float | 0.00% |
| PEG (trailing) | 1.60 | Avg volume | 10,998,934 |
| P/S | 5.60 | Employees | 17,400 |
| P/B | 2.81 | Analyst rec (1=buy..5=sell) | 2.0 |

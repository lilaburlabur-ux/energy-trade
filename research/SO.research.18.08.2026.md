...
Signed file: `SO.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $92.07 (2026-08-18, ~15-min delayed) |
| Market cap | $105.91B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +1.91%; price +1.15% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.56% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 15.43%, revenue growth 0.10%. |
| Value attractiveness | Reasonable | Forward P/E 18.70, EV/Sales 6.07. |
| Risk level | Moderate | Beta 0.33, ATR 1.8% of price, short float 3.16%. |
...
| Southern Co's Dividend Analysis | GuruFocus.com | 2026-08-17 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $92.07; 52w high $97.49 (-5.56%); 52w low $82.06 (+12.20%) |
| Trend | +1.15% vs SMA200, -1.85% vs SMA50, -1.24% vs SMA20 |
| Momentum | RSI(14) 44.2 (neutral) |
| Volatility | ATR(14) 1.65 (~1.8% of price); beta 0.33 |
| Setup perspective | -5.56% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 22.19, forward P/E 18.70, P/S 3.51, P/B 2.68 | EV/Sales 6.07, EV/EBITDA 12.84 |
| Growth expectations | Earnings growth 30.40%, EPS q/q 33.40% | Analyst mean target $100.61 (19 analysts) |
...
|---|---|---|---|
| Price | $92.07 | EV/Sales | 6.07 |
| Market cap | $105.91B | EV/EBITDA | 12.84 |
| Beta | 0.33 | Gross margin | 48.29% |
| RSI(14) | 44.2 | Operating margin | 29.61% |
| ATR(14) | 1.65 | Profit margin | 15.43% |
| SMA20 dist | -1.24% | ROA | 3.27% |
| SMA50 dist | -1.85% | ROE | 11.48% |
| SMA200 dist | +1.15% | Revenue (ttm) | $30.18B |
| 52W high | $97.49 | Revenue growth y/y | 0.10% |
| 52W low | $82.06 | Inst. ownership | 74.16% |
| P/E (ttm) | 22.19 | Insider ownership | 0.10% |
| Forward P/E | 18.70 | Short float | 3.16% |
| PEG (trailing) | 2.34 | Avg volume | 5,796,851 |
| P/S | 3.51 | Employees | 29,502 |
| P/B | 2.68 | Analyst rec (1=buy..5=sell) | 2.7 |

...
Signed file: `OKLO.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $43.33 (2026-08-04, ~15-min delayed) |
| Market cap | $7.54B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-41.75%) with negative half-year (-41.14%). |
| Fresh setup quality | Poor / broken | -75.12% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -51.36, EV/Sales —. |
| Risk level | High | Beta 1.20, ATR 8.4% of price, short float 18.39%. |
...
|---|---|---|
| Oklo Reports Earnings on Aug. 7. Here's What Investors Should Be Watching. | Motley Fool | 2026-08-04 |
| Is Oklo Stock a No-Brainer Buy at Less Than $50? | Motley Fool | 2026-08-04 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $43.33; 52w high $174.14 (-75.12%); 52w low $36.84 (+17.62%) |
| Trend | -41.75% vs SMA200, -17.71% vs SMA50, +0.41% vs SMA20 |
| Momentum | RSI(14) 46.0 (neutral) |
| Volatility | ATR(14) 3.62 (~8.4% of price); beta 1.20 |
| Setup perspective | -75.12% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -51.36, P/S —, P/B 2.86 | EV/Sales —, EV/EBITDA -28.85 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $84.20 (20 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 55.36% |
| Insider ownership | 16.04% |
| Short float | 18.39% |
...
|---|---|---|---|
| Blackrock Inc. | 15,907,512 | 9.14% | 2026-03-31 |
| Mirae Asset Global ETFs Holdings Ltd. | 8,856,496 | 5.09% | 2026-03-31 |
| Vanguard Portfolio Management LLC | 6,237,918 | 3.59% | 2026-03-31 |
| Van Eck Associates Corporation | 6,081,517 | 3.50% | 2026-03-31 |
| Vanguard Capital Management LLC | 5,830,933 | 3.35% | 2026-03-31 |
| Defiance Etfs, LLC | 3,643,044 | 2.09% | 2026-03-31 |
| State Street Corporation | 3,326,142 | 1.91% | 2026-03-31 |
| Geode Capital Management, LLC | 3,054,149 | 1.76% | 2026-03-31 |
| Morgan Stanley | 2,681,738 | 1.54% | 2026-03-31 |
| Alyeska Investment Group, L.p. | 1,709,692 | 0.98% | 2026-03-31 |

## 6. Risk Review and Setup Plan
- **Volatility risk:** Beta 1.20, ATR 8.4% of price, short float 18.39%. Size positions accordingly.
...
|---|---|---|---|
| Price | $43.33 | EV/Sales | — |
| Market cap | $7.54B | EV/EBITDA | -28.85 |
| Beta | 1.20 | Gross margin | 0.00% |
| RSI(14) | 46.0 | Operating margin | 0.00% |
| ATR(14) | 3.62 | Profit margin | 0.00% |
| SMA20 dist | +0.41% | ROA | -7.18% |
| SMA50 dist | -17.71% | ROE | -8.87% |
| SMA200 dist | -41.75% | Revenue (ttm) | — |
| 52W high | $174.14 | Revenue growth y/y | — |
| 52W low | $36.84 | Inst. ownership | 55.36% |
| P/E (ttm) | — | Insider ownership | 16.04% |
| Forward P/E | -51.36 | Short float | 18.39% |
| PEG (trailing) | — | Avg volume | 11,793,478 |
| P/S | — | Employees | 215 |
| P/B | 2.86 | Analyst rec (1=buy..5=sell) | 2.0 |
...
| 2026-05-27 | reit | Wedbush | Outperform → Outperform |
| 2026-05-19 | init | Wolfe Research | — → Peer Perform |
| 2026-05-14 | main | Citigroup | Neutral → Neutral |
| 2026-05-13 | reit | Wedbush | Outperform → Outperform |
...
| Source | URL | Used for |
|---|---|---|
| Yahoo Finance quote/profile/statistics for OKLO | https://finance.yahoo.com/quote/OKLO | Snapshot metrics, ownership, analyst data |
| Yahoo Finance price history (via yfinance) | https://finance.yahoo.com/quote/OKLO/history | SMA/RSI/ATR/performance calculations |
| Yahoo Finance news feed | https://finance.yahoo.com/quote/OKLO/news | Catalyst headlines |

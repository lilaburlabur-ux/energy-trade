...
Signed file: `OKLO.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $47.01 (2026-08-11, ~15-min delayed) |
| Market cap | $8.74B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-34.52%) with negative half-year (-37.36%). |
| Fresh setup quality | Poor / broken | -73.00% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -47.74, EV/Sales 4,805.56. |
| Risk level | High | Beta 1.20, ATR 7.9% of price, short float 18.39%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $47.01; 52w high $174.14 (-73.00%); 52w low $36.84 (+27.61%) |
| Trend | -34.52% vs SMA200, -6.74% vs SMA50, +10.52% vs SMA20 |
| Momentum | RSI(14) 52.7 (neutral) |
| Volatility | ATR(14) 3.69 (~7.9% of price); beta 1.20 |
| Setup perspective | -73.00% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -47.74, P/S 7,227.02, P/B 2.66 | EV/Sales 4,805.56, EV/EBITDA -26.82 |
...
- **Volatility risk:** Beta 1.20, ATR 7.9% of price, short float 18.39%. Size positions accordingly.
...
|---|---|---|---|
| Price | $47.01 | EV/Sales | 4,805.56 |
| Market cap | $8.74B | EV/EBITDA | -26.82 |
| Beta | 1.20 | Gross margin | 40.41% |
| RSI(14) | 52.7 | Operating margin | -6048.76% |
| ATR(14) | 3.69 | Profit margin | 0.00% |
| SMA20 dist | +10.52% | ROA | -6.65% |
| SMA50 dist | -6.74% | ROE | -7.70% |
| SMA200 dist | -34.52% | Revenue (ttm) | $1.21M |
| 52W high | $174.14 | Revenue growth y/y | — |
| 52W low | $36.84 | Inst. ownership | 46.74% |
| P/E (ttm) | — | Insider ownership | 15.42% |
| Forward P/E | -47.74 | Short float | 18.39% |
| PEG (trailing) | — | Avg volume | 11,543,982 |
| P/S | 7,227.02 | Employees | 215 |
| P/B | 2.66 | Analyst rec (1=buy..5=sell) | 2.0 |

...
| Field | Value |
|---|---|
| Current price | $93.51 (2026-09-01, ~15-min delayed) |
| Market cap | $257.28B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +31.28%; price +14.75% vs SMA200. |
| Fresh setup quality | Watch | -0.15% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 8.76%, revenue growth 44.70%. |
| Value attractiveness | Reasonable | Forward P/E 10.60, EV/Sales 1.00. |
...
| Shell Rallies as Oil Jumps, Weighs $8 Billion Chemicals Sale | GuruFocus.com | 2026-09-01 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $93.51; 52w high $93.65 (-0.15%); 52w low $68.25 (+37.01%) |
| Trend | +14.75% vs SMA200, +8.50% vs SMA50, +2.89% vs SMA20 |
| Momentum | RSI(14) 64.8 (neutral) |
| Volatility | ATR(14) 1.46 (~1.6% of price); beta -0.22 |
| Setup perspective | -0.15% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 10.34, forward P/E 10.60, P/S 0.87, P/B 1.44 | EV/Sales 1.00, EV/EBITDA 5.14 |
...
|---|---|---|---|
| Price | $93.51 | EV/Sales | 1.00 |
| Market cap | $257.28B | EV/EBITDA | 5.14 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 64.8 | Operating margin | 16.69% |
| ATR(14) | 1.46 | Profit margin | 8.76% |
| SMA20 dist | +2.89% | ROA | 6.40% |
| SMA50 dist | +8.50% | ROE | 14.34% |
| SMA200 dist | +14.75% | Revenue (ttm) | $296.60B |
| 52W high | $93.65 | Revenue growth y/y | 44.70% |
| 52W low | $68.25 | Inst. ownership | 13.85% |
| P/E (ttm) | 10.34 | Insider ownership | 0.01% |
| Forward P/E | 10.60 | Short float | 1.57% |
| PEG (trailing) | 1.36 | Avg volume | 6,321,500 |

...
Signed file: `SHEL.research.01.09.2026`

| Field | Value |
|---|---|
| Current price | $91.45 (2026-09-01, ~15-min delayed) |
| Market cap | $251.71B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +28.30%; price +12.36% vs SMA200. |
| Fresh setup quality | Watch | -2.35% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 8.76%, revenue growth 44.70%. |
| Value attractiveness | Reasonable | Forward P/E 10.37, EV/Sales 1.00. |
...
| The Strait of Hormuz Conflict Just Escalated Again. Here's What It Means for Shell. | Motley Fool | 2026-08-31 |
| Update: Market Chatter: Trump to Host Oil Company Executives on Tuesday | MT Newswires | 2026-08-31 |
| What XOM's Q2 Earnings Say About Production Growth and Market Risk | Zacks | 2026-08-31 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $91.45; 52w high $93.65 (-2.35%); 52w low $68.25 (+33.99%) |
| Trend | +12.36% vs SMA200, +6.47% vs SMA50, +0.87% vs SMA20 |
| Momentum | RSI(14) 57.9 (neutral) |
| Volatility | ATR(14) 1.39 (~1.5% of price); beta -0.22 |
| Setup perspective | -2.35% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 10.12, forward P/E 10.37, P/S 0.85, P/B 1.41 | EV/Sales 1.00, EV/EBITDA 5.16 |
...
|---|---|---|---|
| Price | $91.45 | EV/Sales | 1.00 |
| Market cap | $251.71B | EV/EBITDA | 5.16 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 57.9 | Operating margin | 16.69% |
| ATR(14) | 1.39 | Profit margin | 8.76% |
| SMA20 dist | +0.87% | ROA | 6.40% |
| SMA50 dist | +6.47% | ROE | 14.34% |
| SMA200 dist | +12.36% | Revenue (ttm) | $296.60B |
| 52W high | $93.65 | Revenue growth y/y | 44.70% |
| 52W low | $68.25 | Inst. ownership | 13.85% |
| P/E (ttm) | 10.12 | Insider ownership | 0.01% |
| Forward P/E | 10.37 | Short float | 1.57% |
| PEG (trailing) | 1.35 | Avg volume | 6,354,807 |
| P/S | 0.85 | Employees | 84,000 |
| P/B | 1.41 | Analyst rec (1=buy..5=sell) | 2.2 |

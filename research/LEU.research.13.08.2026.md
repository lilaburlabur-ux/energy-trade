...
Signed file: `LEU.research.13.08.2026`

| Field | Value |
|---|---|
| Current price | $191.82 (2026-08-13, ~15-min delayed) |
| Market cap | $3.83B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-13.33%) with negative half-year (-8.73%). |
| Fresh setup quality | Poor / broken | -56.00% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.23%, revenue growth 14.00%. |
| Value attractiveness | Low (expensive) | Forward P/E 51.21, EV/Sales 6.33. |
| Risk level | High | Beta 1.35, ATR 6.3% of price, short float 26.68%. |
...
|---|---|---|
| X-Energy Q2 Earnings Call Highlights | MarketBeat | 2026-08-13 |
| Centrus Energy (LEU) Q2 2026 Earnings Call Transcript | Motley Fool | 2026-08-13 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $191.82; 52w high $436.00 (-56.00%); 52w low $146.61 (+30.84%) |
| Trend | -13.33% vs SMA200, +12.12% vs SMA50, +8.43% vs SMA20 |
| Momentum | RSI(14) 58.3 (neutral) |
| Volatility | ATR(14) 12.14 (~6.3% of price); beta 1.35 |
| Setup perspective | -56.00% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 51.21, P/S 8.08, P/B 4.53 | EV/Sales 6.33, EV/EBITDA 297.18 |
...
- **Valuation risk:** Forward P/E 51.21, EV/Sales 6.33. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.35, ATR 6.3% of price, short float 26.68%. Size positions accordingly.
- **Short interest risk:** short float 26.68% can fuel squeezes both ways around news.
...
|---|---|---|---|
| Price | $191.82 | EV/Sales | 6.33 |
| Market cap | $3.83B | EV/EBITDA | 297.18 |
| Beta | 1.35 | Gross margin | 23.66% |
| RSI(14) | 58.3 | Operating margin | 5.34% |
| ATR(14) | 12.14 | Profit margin | 10.23% |
| SMA20 dist | +8.43% | ROA | 0.02% |
...
| P/S | 8.08 | Employees | 467 |
| P/B | 4.53 | Analyst rec (1=buy..5=sell) | 1.7 |

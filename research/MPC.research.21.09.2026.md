...
Signed file: `MPC.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $402.38 (2026-09-21, ~15-min delayed) |
| Market cap | $113.00B |
...
|---|---|---|
| Technical momentum | High | 1Y +121.10%; price +60.27% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.30% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 5.55%, revenue growth 53.70%. |
| Value attractiveness | Reasonable | Forward P/E 9.25, EV/Sales 0.99. |
| Risk level | Elevated | Beta 0.53, ATR 3.5% of price, short float 3.14%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $402.38; 52w high $424.89 (-5.30%); 52w low $160.76 (+150.29%) |
| Trend | +60.27% vs SMA200, +15.31% vs SMA50, +3.33% vs SMA20 |
| Momentum | RSI(14) 62.7 (neutral) |
| Volatility | ATR(14) 14.06 (~3.5% of price); beta 0.53 |
| Setup perspective | -5.30% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 13.95, forward P/E 9.25, P/S 0.73, P/B 5.97 | EV/Sales 0.99, EV/EBITDA 9.90 |
...
- **Volatility risk:** Beta 0.53, ATR 3.5% of price, short float 3.14%. Size positions accordingly.
...
|---|---|---|---|
| Price | $402.38 | EV/Sales | 0.99 |
| Market cap | $113.00B | EV/EBITDA | 9.90 |
| Beta | 0.53 | Gross margin | 12.82% |
| RSI(14) | 62.7 | Operating margin | 13.56% |
| ATR(14) | 14.06 | Profit margin | 5.55% |
| SMA20 dist | +3.33% | ROA | 8.74% |
| SMA50 dist | +15.31% | ROE | 42.10% |
| SMA200 dist | +60.27% | Revenue (ttm) | $154.15B |

...
Signed file: `GEV.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $942.10 (2026-08-24, ~15-min delayed) |
| Market cap | $250.91B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +55.82%; price +8.36% vs SMA200. |
| Fresh setup quality | Moderate / wait | -19.81% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 23.04%, revenue growth 21.90%. |
| Value attractiveness | Low (expensive) | Forward P/E 37.48, EV/Sales 5.97. |
...
|---|---|---|
| Why Is GE Vernova (GEV) A Key Pick For Queensland's Supernode Battery Project? | Simply Wall St. | 2026-08-24 |
| GE Vernova Launches Medium-Voltage Power System for AI Data Centers | InvestorsHub | 2026-08-24 |
| GE Vernova to supply technology for stage three of Supernode BESS project | Power Technology | 2026-08-24 |
| Is GE Vernova Under $1,000 a Bargain or a Trap? Here's the Honest Answer. | Motley Fool | 2026-08-23 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $942.10; 52w high $1,174.86 (-19.81%); 52w low $546.95 (+72.25%) |
| Trend | +8.36% vs SMA200, -9.04% vs SMA50, -5.51% vs SMA20 |
| Momentum | RSI(14) 39.2 (neutral) |
| Volatility | ATR(14) 48.62 (~5.2% of price); beta 1.03 |
| Setup perspective | -19.81% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.97, forward P/E 37.48, P/S 6.07, P/B 20.98 | EV/Sales 5.97, EV/EBITDA 62.90 |
...
- **Valuation risk:** Forward P/E 37.48, EV/Sales 5.97. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $942.10 | EV/Sales | 5.97 |
| Market cap | $250.91B | EV/EBITDA | 62.90 |
| Beta | 1.03 | Gross margin | 20.57% |
| RSI(14) | 39.2 | Operating margin | 7.47% |
| ATR(14) | 48.62 | Profit margin | 23.04% |
| SMA20 dist | -5.51% | ROA | 2.54% |
| SMA50 dist | -9.04% | ROE | 82.58% |
| SMA200 dist | +8.36% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.68% |
| P/E (ttm) | 26.97 | Insider ownership | 0.13% |
| Forward P/E | 37.48 | Short float | 3.20% |
| PEG (trailing) | 1.63 | Avg volume | 2,827,991 |
| P/S | 6.07 | Employees | 78,000 |

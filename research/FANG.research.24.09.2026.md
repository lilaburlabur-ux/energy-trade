...
Signed file: `FANG.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $189.01 (2026-09-24, ~15-min delayed) |
| Market cap | $53.17B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +39.42%; price +3.84% vs SMA200. |
| Fresh setup quality | Moderate / wait | -10.65% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.03%, revenue growth 52.50%. |
| Value attractiveness | Reasonable | Forward P/E 10.12, EV/Sales 4.32. |
| Risk level | Elevated | Beta 0.41, ATR 3.4% of price, short float 4.23%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $189.01; 52w high $211.53 (-10.65%); 52w low $134.06 (+40.99%) |
| Trend | +3.84% vs SMA200, -4.96% vs SMA50, -5.14% vs SMA20 |
| Momentum | RSI(14) 40.2 (neutral) |
| Volatility | ATR(14) 6.42 (~3.4% of price); beta 0.41 |
| Setup perspective | -10.65% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 36.00, forward P/E 10.12, P/S 3.27, P/B 1.40 | EV/Sales 4.32, EV/EBITDA 5.96 |
...
- **Volatility risk:** Beta 0.41, ATR 3.4% of price, short float 4.23%. Size positions accordingly.
...
|---|---|---|---|
| Price | $189.01 | EV/Sales | 4.32 |
| Market cap | $53.17B | EV/EBITDA | 5.96 |
| Beta | 0.41 | Gross margin | 72.35% |
| RSI(14) | 40.2 | Operating margin | 48.47% |
| ATR(14) | 6.42 | Profit margin | 9.03% |
| SMA20 dist | -5.14% | ROA | 1.31% |
| SMA50 dist | -4.96% | ROE | 3.49% |
| SMA200 dist | +3.84% | Revenue (ttm) | $16.25B |
| 52W high | $211.53 | Revenue growth y/y | 52.50% |
| 52W low | $134.06 | Inst. ownership | 73.37% |
| P/E (ttm) | 36.00 | Insider ownership | 23.88% |
| Forward P/E | 10.12 | Short float | 4.23% |
| PEG (trailing) | 22.29 | Avg volume | 2,395,525 |
| P/S | 3.27 | Employees | 1,762 |

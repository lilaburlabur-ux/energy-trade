...
Signed file: `FANG.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $211.02 (2026-08-20, ~15-min delayed) |
| Market cap | $59.36B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +55.51%; price +20.11% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.16% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.03%, revenue growth 52.50%. |
| Value attractiveness | Reasonable | Forward P/E 11.67, EV/Sales 4.72. |
| Risk level | Moderate | Beta 0.42, ATR 2.9% of price, short float 4.26%. |
...
|---|---|---|
| How Diamondback’s Permian‑to‑Katy Gas Pipeline Bet At Diamondback Energy (FANG) Has Changed Its Investment Story | Simply Wall St. | 2026-08-18 |
| WhiteWater and partners approve FID for Solitude Pipeline System | Offshore Technology | 2026-08-18 |
| Is Diamondback Energy (FANG) Undervalued As It Joins The Solitude Pipeline Venture? | Simply Wall St. | 2026-08-18 |
| This New Pipeline Could Unlock Years of Growth for 4 Energy Stocks. Here's Why That's a Win for All of Them. | Motley Fool | 2026-08-17 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $211.02; 52w high $211.36 (-0.16%); 52w low $131.37 (+60.64%) |
| Trend | +20.11% vs SMA200, +10.39% vs SMA50, +6.27% vs SMA20 |
| Momentum | RSI(14) 64.5 (neutral) |
| Volatility | ATR(14) 6.03 (~2.9% of price); beta 0.42 |
| Setup perspective | -0.16% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 40.12, forward P/E 11.67, P/S 3.65, P/B 1.56 | EV/Sales 4.72, EV/EBITDA 6.51 |
| Growth expectations | Earnings growth 179.50%, EPS q/q 169.20% | Analyst mean target $232.18 (28 analysts) |
...
|---|---|---|---|
| Price | $211.02 | EV/Sales | 4.72 |
| Market cap | $59.36B | EV/EBITDA | 6.51 |
| Beta | 0.42 | Gross margin | 72.35% |
| RSI(14) | 64.5 | Operating margin | 48.47% |
| ATR(14) | 6.03 | Profit margin | 9.03% |
| SMA20 dist | +6.27% | ROA | 1.31% |
| SMA50 dist | +10.39% | ROE | 3.49% |
| SMA200 dist | +20.11% | Revenue (ttm) | $16.25B |
| 52W high | $211.36 | Revenue growth y/y | 52.50% |
| 52W low | $131.37 | Inst. ownership | 73.36% |
| P/E (ttm) | 40.12 | Insider ownership | 27.12% |
| Forward P/E | 11.67 | Short float | 4.26% |
| PEG (trailing) | 22.07 | Avg volume | 2,224,341 |
| P/S | 3.65 | Employees | 1,762 |
| P/B | 1.56 | Analyst rec (1=buy..5=sell) | 1.5 |

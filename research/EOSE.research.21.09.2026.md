...
Signed file: `EOSE.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $4.07 (2026-09-21, ~15-min delayed) |
| Market cap | $1.47B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-48.49%) with negative half-year (-21.58%). |
...
| Value attractiveness | Reasonable | Forward P/E -23.45, EV/Sales 11.62. |
| Risk level | High | Beta 2.78, ATR 8.0% of price, short float 30.87%. |
...
| Trend | -48.49% vs SMA200, +6.26% vs SMA50, +9.27% vs SMA20 |
| Momentum | RSI(14) 53.9 (neutral) |
| Volatility | ATR(14) 0.32 (~8.0% of price); beta 2.78 |
...
| Valuation | P/E —, forward P/E -23.45, P/S 6.87, P/B -1.35 | EV/Sales 11.62, EV/EBITDA -8.76 |
...
- **Volatility risk:** Beta 2.78, ATR 8.0% of price, short float 30.87%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.07 | EV/Sales | 11.62 |
| Market cap | $1.47B | EV/EBITDA | -8.76 |
| Beta | 2.78 | Gross margin | -84.75% |
| RSI(14) | 53.9 | Operating margin | -121.86% |
| ATR(14) | 0.32 | Profit margin | -246.76% |
| SMA20 dist | +9.27% | ROA | -30.03% |
| SMA50 dist | +6.26% | ROE | — |
| SMA200 dist | -48.49% | Revenue (ttm) | $214.25M |
...
| PEG (trailing) | — | Avg volume | 25,919,963 |

...
Signed file: `CEG.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $263.27 (2026-09-25, ~15-min delayed) |
| Market cap | $93.28B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-9.09%) with negative half-year (-10.54%). |
...
| Value attractiveness | Reasonable | Forward P/E 19.76, EV/Sales 3.74. |
| Risk level | Elevated | Beta 1.12, ATR 3.5% of price, short float 3.70%. |
...
|---|---|---|
| US tech giants could spark a European nuclear revival | Proactive | 2026-09-25 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $263.27; 52w high $401.70 (-34.46%); 52w low $236.14 (+11.49%) |
| Trend | -9.09% vs SMA200, -3.12% vs SMA50, -4.01% vs SMA20 |
| Momentum | RSI(14) 43.9 (neutral) |
| Volatility | ATR(14) 9.18 (~3.5% of price); beta 1.12 |
...
| Valuation | P/E 25.74, forward P/E 19.76, P/S 2.98, P/B 2.93 | EV/Sales 3.74, EV/EBITDA 14.72 |
...
- **Volatility risk:** Beta 1.12, ATR 3.5% of price, short float 3.70%. Size positions accordingly.
...
|---|---|---|---|
| Price | $263.27 | EV/Sales | 3.74 |
| Market cap | $93.28B | EV/EBITDA | 14.72 |
| Beta | 1.12 | Gross margin | 22.11% |
| RSI(14) | 43.9 | Operating margin | 8.66% |
| ATR(14) | 9.18 | Profit margin | 11.08% |
| SMA20 dist | -4.01% | ROA | 3.89% |
| SMA50 dist | -3.12% | ROE | 15.06% |
| SMA200 dist | -9.09% | Revenue (ttm) | $31.27B |
| 52W high | $401.70 | Revenue growth y/y | 23.00% |
| 52W low | $236.14 | Inst. ownership | 82.97% |
| P/E (ttm) | 25.74 | Insider ownership | 0.34% |
| Forward P/E | 19.76 | Short float | 3.70% |
| PEG (trailing) | — | Avg volume | 2,952,071 |
| P/S | 2.98 | Employees | 15,291 |

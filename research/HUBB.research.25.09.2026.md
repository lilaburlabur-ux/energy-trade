...
Signed file: `HUBB.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $466.62 (2026-09-25, ~15-min delayed) |
| Market cap | $24.65B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-3.75%) with negative half-year (-2.53%). |
| Fresh setup quality | Moderate / wait | -15.84% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 14.49%, revenue growth 15.30%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.36, EV/Sales 4.79. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $466.62; 52w high $554.46 (-15.84%); 52w low $402.45 (+15.94%) |
| Trend | -3.75% vs SMA200, -1.46% vs SMA50, +2.77% vs SMA20 |
| Momentum | RSI(14) 53.3 (neutral) |
| Volatility | ATR(14) 12.30 (~2.6% of price); beta 0.89 |
| Setup perspective | -15.84% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 27.59, forward P/E 20.36, P/S 3.96, P/B 6.30 | EV/Sales 4.79, EV/EBITDA 19.66 |
...
- **Valuation risk:** Forward P/E 20.36, EV/Sales 4.79. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $466.62 | EV/Sales | 4.79 |
| Market cap | $24.65B | EV/EBITDA | 19.66 |
| Beta | 0.89 | Gross margin | 35.34% |
| RSI(14) | 53.3 | Operating margin | 21.67% |
| ATR(14) | 12.30 | Profit margin | 14.49% |
| SMA20 dist | +2.77% | ROA | 8.43% |
| SMA50 dist | -1.46% | ROE | 24.44% |
| SMA200 dist | -3.75% | Revenue (ttm) | $6.22B |
| 52W high | $554.46 | Revenue growth y/y | 15.30% |
| 52W low | $402.45 | Inst. ownership | 99.12% |
| P/E (ttm) | 27.59 | Insider ownership | 0.35% |
| Forward P/E | 20.36 | Short float | 6.21% |
| PEG (trailing) | 1.95 | Avg volume | 532,361 |
...
|---|---|---|---|
| 2026-09-25 | init | Wells Fargo | — → Equal-Weight |

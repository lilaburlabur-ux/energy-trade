...
Signed file: `LNG.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $268.54 (2026-09-25, ~15-min delayed) |
| Market cap | $55.46B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +14.61%; price +9.99% vs SMA200. |
| Fresh setup quality | Moderate / wait | -9.23% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 13.94%, revenue growth 22.70%. |
| Value attractiveness | Reasonable | Forward P/E 12.75, EV/Sales 4.26. |
| Risk level | Moderate | Beta -0.00, ATR 2.9% of price, short float 1.89%. |
...
| APA vs. LNG: Which Stock Should Value Investors Buy Now? | Zacks | 2026-09-24 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $268.54; 52w high $295.86 (-9.23%); 52w low $187.49 (+43.23%) |
| Trend | +9.99% vs SMA200, -1.10% vs SMA50, -3.62% vs SMA20 |
| Momentum | RSI(14) 44.0 (neutral) |
| Volatility | ATR(14) 7.88 (~2.9% of price); beta -0.00 |
| Setup perspective | -9.23% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.33, forward P/E 12.75, P/S 2.65, P/B 9.02 | EV/Sales 4.26, EV/EBITDA 11.40 |
...
|---|---|---|---|
| Price | $268.54 | EV/Sales | 4.26 |
| Market cap | $55.46B | EV/EBITDA | 11.40 |
| Beta | -0.00 | Gross margin | 36.85% |
| RSI(14) | 44.0 | Operating margin | 75.00% |
| ATR(14) | 7.88 | Profit margin | 13.94% |
| SMA20 dist | -3.62% | ROA | 8.63% |
| SMA50 dist | -1.10% | ROE | 39.12% |
| SMA200 dist | +9.99% | Revenue (ttm) | $20.92B |
| 52W high | $295.86 | Revenue growth y/y | 22.70% |
| 52W low | $187.49 | Inst. ownership | 91.52% |
| P/E (ttm) | 20.33 | Insider ownership | 0.66% |
| Forward P/E | 12.75 | Short float | 1.89% |
| PEG (trailing) | — | Avg volume | 1,965,885 |
| P/S | 2.65 | Employees | 1,717 |
| P/B | 9.02 | Analyst rec (1=buy..5=sell) | 1.4 |

...
Signed file: `SHEL.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $92.01 (2026-08-18, ~15-min delayed) |
| Market cap | $253.95B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +32.82%; price +14.29% vs SMA200. |
| Fresh setup quality | Watch | -0.52% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 8.76%, revenue growth 44.70%. |
| Value attractiveness | Reasonable | Forward P/E 10.43, EV/Sales 1.00. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $92.01; 52w high $92.49 (-0.52%); 52w low $68.25 (+34.81%) |
| Trend | +14.29% vs SMA200, +9.21% vs SMA50, +3.63% vs SMA20 |
| Momentum | RSI(14) 66.0 (neutral) |
| Volatility | ATR(14) 1.54 (~1.7% of price); beta -0.22 |
| Setup perspective | -0.52% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 10.18, forward P/E 10.43, P/S 0.86, P/B 1.49 | EV/Sales 1.00, EV/EBITDA 5.17 |
...
|---|---|---|---|
| Price | $92.01 | EV/Sales | 1.00 |
| Market cap | $253.95B | EV/EBITDA | 5.17 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 66.0 | Operating margin | 16.69% |
| ATR(14) | 1.54 | Profit margin | 8.76% |
| SMA20 dist | +3.63% | ROA | 6.40% |
| SMA50 dist | +9.21% | ROE | 14.34% |
| SMA200 dist | +14.29% | Revenue (ttm) | $296.60B |
| 52W high | $92.49 | Revenue growth y/y | 44.70% |
| 52W low | $68.25 | Inst. ownership | 13.92% |
| P/E (ttm) | 10.18 | Insider ownership | 0.01% |
| Forward P/E | 10.43 | Short float | 1.77% |
| PEG (trailing) | 1.37 | Avg volume | 6,608,046 |

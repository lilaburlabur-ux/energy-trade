...
Signed file: `KMI.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $31.12 (2026-08-05, ~15-min delayed) |
| Market cap | $69.30B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +14.47%; price +3.92% vs SMA200. |
| Fresh setup quality | Moderate / wait | -8.45% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 19.30%, revenue growth 10.80%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.22, EV/Sales 5.76. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $31.12; 52w high $33.99 (-8.45%); 52w low $24.86 (+25.18%) |
| Trend | +3.92% vs SMA200, -1.85% vs SMA50, -2.34% vs SMA20 |
| Momentum | RSI(14) 41.9 (neutral) |
| Volatility | ATR(14) 0.72 (~2.3% of price); beta 0.55 |
| Setup perspective | -8.45% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.08, forward P/E 20.22, P/S 3.86, P/B 2.19 | EV/Sales 5.76, EV/EBITDA 13.56 |
...
- **Valuation risk:** Forward P/E 20.22, EV/Sales 5.76. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $31.12 | EV/Sales | 5.76 |
| Market cap | $69.30B | EV/EBITDA | 13.56 |
| Beta | 0.55 | Gross margin | 49.41% |
| RSI(14) | 41.9 | Operating margin | 30.06% |
| ATR(14) | 0.72 | Profit margin | 19.30% |
| SMA20 dist | -2.34% | ROA | 4.45% |
| SMA50 dist | -1.85% | ROE | 10.99% |
| SMA200 dist | +3.92% | Revenue (ttm) | $17.96B |
| 52W high | $33.99 | Revenue growth y/y | 10.80% |
| 52W low | $24.86 | Inst. ownership | 70.85% |
| P/E (ttm) | 20.08 | Insider ownership | 12.67% |
| Forward P/E | 20.22 | Short float | 2.33% |
| PEG (trailing) | 3.50 | Avg volume | 10,060,470 |
| P/S | 3.86 | Employees | 11,028 |

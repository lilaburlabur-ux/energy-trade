...
Signed file: `FTI.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $72.74 (2026-09-17, ~15-min delayed) |
| Market cap | $28.53B |
...
|---|---|---|
| Technical momentum | High | 1Y +87.07%; price +10.96% vs SMA200. |
| Fresh setup quality | Moderate / wait | -9.17% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 11.28%, revenue growth 9.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.22, EV/Sales 2.76. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $72.74; 52w high $80.08 (-9.17%); 52w low $35.45 (+105.17%) |
| Trend | +10.96% vs SMA200, -2.58% vs SMA50, -4.99% vs SMA20 |
| Momentum | RSI(14) 41.5 (neutral) |
| Volatility | ATR(14) 2.47 (~3.4% of price); beta 0.74 |
| Setup perspective | -9.17% from 52w high; no clean fresh pivot by default. |
...
- **Valuation risk:** Forward P/E 20.22, EV/Sales 2.76. Multiple compression is the main downside if growth disappoints.
...
| SMA20 dist | -4.99% | ROA | 9.53% |
| SMA50 dist | -2.58% | ROE | 35.81% |
| SMA200 dist | +10.96% | Revenue (ttm) | $10.42B |
| 52W high | $80.08 | Revenue growth y/y | 9.00% |
| 52W low | $35.45 | Inst. ownership | 101.17% |
| P/E (ttm) | 25.43 | Insider ownership | 1.49% |
| Forward P/E | 20.22 | Short float | 3.28% |
| PEG (trailing) | — | Avg volume | 3,601,462 |
| P/S | 2.74 | Employees | 22,000 |
| P/B | 8.73 | Analyst rec (1=buy..5=sell) | 2.0 |

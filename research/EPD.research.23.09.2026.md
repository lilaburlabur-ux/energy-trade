...
Signed file: `EPD.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $37.57 (2026-09-23, ~15-min delayed) |
| Market cap | $81.13B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $37.57; 52w high $39.36 (-4.55%); 52w low $28.35 (+32.50%) |
| Trend | +4.71% vs SMA200, -1.97% vs SMA50, -3.22% vs SMA20 |
...
| SMA20 dist | -3.22% | ROA | 5.92% |
| SMA50 dist | -1.97% | ROE | 20.85% |
| SMA200 dist | +4.71% | Revenue (ttm) | $58.47B |
| 52W high | $39.36 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.64% |
| P/E (ttm) | 13.00 | Insider ownership | 33.04% |
| Forward P/E | 11.81 | Short float | 3.09% |
| PEG (trailing) | 1.35 | Avg volume | 2,882,073 |
| P/S | 1.39 | Employees | 0 |

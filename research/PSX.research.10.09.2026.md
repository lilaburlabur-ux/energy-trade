...
Signed file: `PSX.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $258.51 (2026-09-10, ~15-min delayed) |
| Market cap | $103.15B |
...
|---|---|---|
| Technical momentum | High | 1Y +101.20%; price +49.92% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.87% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 4.66%, revenue growth 53.10%. |
| Value attractiveness | Reasonable | Forward P/E 11.86, EV/Sales 0.80. |
| Risk level | Moderate | Beta 0.70, ATR 2.6% of price, short float 1.43%. |
...
| Phillips 66 (PSX) is a Great Momentum Stock: Should You Buy? | Zacks | 2026-09-10 |
| Wall Street Bulls Look Optimistic About Phillips 66 (PSX): Should You Buy? | Zacks | 2026-09-10 |
| Bull of the Day: Phillips 66 (PSX) | Zacks | 2026-09-10 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $258.51; 52w high $260.78 (-0.87%); 52w low $123.11 (+109.98%) |
| Trend | +49.92% vs SMA200, +18.11% vs SMA50, +5.10% vs SMA20 |
| Momentum | RSI(14) 74.0 (overbought) |
| Volatility | ATR(14) 6.82 (~2.6% of price); beta 0.70 |
| Setup perspective | -0.87% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 14.76, forward P/E 11.86, P/S 0.68, P/B 3.27 | EV/Sales 0.80, EV/EBITDA 12.26 |
| Growth expectations | Earnings growth 344.90%, EPS q/q 338.70% | Analyst mean target $235.58 (19 analysts) |
...
|---|---|---|---|
| Price | $258.51 | EV/Sales | 0.80 |
| Market cap | $103.15B | EV/EBITDA | 12.26 |
| Beta | 0.70 | Gross margin | 13.10% |
| RSI(14) | 74.0 | Operating margin | 8.53% |
| ATR(14) | 6.82 | Profit margin | 4.66% |
| SMA20 dist | +5.10% | ROA | 6.04% |
| SMA50 dist | +18.11% | ROE | 23.45% |
| SMA200 dist | +49.92% | Revenue (ttm) | $152.17B |
| 52W high | $260.78 | Revenue growth y/y | 53.10% |
| 52W low | $123.11 | Inst. ownership | 80.60% |
| P/E (ttm) | 14.76 | Insider ownership | 0.21% |
| Forward P/E | 11.86 | Short float | 1.43% |
| PEG (trailing) | 1.25 | Avg volume | 2,777,224 |
| P/S | 0.68 | Employees | 12,600 |
| P/B | 3.27 | Analyst rec (1=buy..5=sell) | 2.1 |

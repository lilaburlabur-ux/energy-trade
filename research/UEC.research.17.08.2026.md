...
Signed file: `UEC.research.17.08.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-16.20%) with negative half-year (-28.03%). |
| Fresh setup quality | Poor / broken | -44.54% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -124.11, EV/Sales 250.56. |
| Risk level | High | Beta 1.21, ATR 5.0% of price, short float 14.38%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.17; 52w high $20.14 (-44.54%); 52w low $9.04 (+23.56%) |
| Trend | -16.20% vs SMA200, +5.62% vs SMA50, +7.75% vs SMA20 |
| Momentum | RSI(14) 57.6 (neutral) |
| Volatility | ATR(14) 0.55 (~5.0% of price); beta 1.21 |
| Setup perspective | -44.54% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 1.21, ATR 5.0% of price, short float 14.38%. Size positions accordingly.

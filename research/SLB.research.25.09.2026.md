...
Signed file: `SLB.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $51.54 (2026-09-25, ~15-min delayed) |
| Market cap | $76.49B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $51.54; 52w high $59.79 (-13.80%); 52w low $30.96 (+66.46%) |
| Trend | +3.51% vs SMA200, -1.80% vs SMA50, -5.84% vs SMA20 |
| Momentum | RSI(14) 41.7 (neutral) |
| Volatility | ATR(14) 1.74 (~3.4% of price); beta 0.77 |
| Setup perspective | -13.80% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 25.39, forward P/E 15.92, P/S 2.10, P/B 2.93 | EV/Sales 2.37, EV/EBITDA 11.68 |
...
- **Volatility risk:** Beta 0.77, ATR 3.4% of price, short float 4.67%. Size positions accordingly.

...
Signed file: `NXE.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $9.80 (2026-09-21, ~15-min delayed) |
| Market cap | $6.57B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-10.04%) with negative half-year (-12.97%). |
| Fresh setup quality | Poor / broken | -29.60% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -61.25, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.80; 52w high $13.92 (-29.60%); 52w low $7.56 (+29.63%) |
| Trend | -10.04% vs SMA200, -1.41% vs SMA50, -4.45% vs SMA20 |
| Momentum | RSI(14) 46.0 (neutral) |
| Volatility | ATR(14) 0.44 (~4.5% of price); beta 1.67 |
| Setup perspective | -29.60% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -61.25, P/S —, P/B 4.91 | EV/Sales —, EV/EBITDA -54.55 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $16.56 (2 analysts) |

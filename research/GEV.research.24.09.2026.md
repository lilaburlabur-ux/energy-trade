...
Signed file: `GEV.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $955.04 (2026-09-24, ~15-min delayed) |
| Market cap | $254.36B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +48.55%; price +5.35% vs SMA200. |
| Fresh setup quality | Moderate / wait | -18.71% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 23.04%, revenue growth 21.90%. |
| Value attractiveness | Low (expensive) | Forward P/E 38.01, EV/Sales 5.94. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $955.04; 52w high $1,174.86 (-18.71%); 52w low $546.95 (+74.61%) |
| Trend | +5.35% vs SMA200, -2.21% vs SMA50, +2.55% vs SMA20 |
| Momentum | RSI(14) 51.2 (neutral) |
| Volatility | ATR(14) 39.01 (~4.1% of price); beta 0.97 |
| Setup perspective | -18.71% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 27.41, forward P/E 38.01, P/S 6.15, P/B 21.27 | EV/Sales 5.94, EV/EBITDA 62.56 |
...
- **Valuation risk:** Forward P/E 38.01, EV/Sales 5.94. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $955.04 | EV/Sales | 5.94 |
| Market cap | $254.36B | EV/EBITDA | 62.56 |
| Beta | 0.97 | Gross margin | 20.57% |
| RSI(14) | 51.2 | Operating margin | 7.47% |
| ATR(14) | 39.01 | Profit margin | 23.04% |
| SMA20 dist | +2.55% | ROA | 2.54% |
| SMA50 dist | -2.21% | ROE | 82.58% |
| SMA200 dist | +5.35% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.65% |
| P/E (ttm) | 27.41 | Insider ownership | 0.13% |
| Forward P/E | 38.01 | Short float | 3.29% |
| PEG (trailing) | 1.86 | Avg volume | 2,491,996 |
| P/S | 6.15 | Employees | 78,000 |
| P/B | 21.27 | Analyst rec (1=buy..5=sell) | 1.5 |

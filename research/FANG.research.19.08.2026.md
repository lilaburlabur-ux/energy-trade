...
Signed file: `FANG.research.19.08.2026`
...
|---|---|---|
| Technical momentum | Moderate | 1Y +53.08%; price +18.94% vs SMA200. |
| Fresh setup quality | Moderate / wait | -1.33% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.03%, revenue growth 52.50%. |
| Value attractiveness | Reasonable | Forward P/E 11.53, EV/Sales 4.74. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $208.55; 52w high $211.36 (-1.33%); 52w low $131.37 (+58.76%) |
| Trend | +18.94% vs SMA200, +9.31% vs SMA50, +5.20% vs SMA20 |
| Momentum | RSI(14) 62.6 (neutral) |
| Volatility | ATR(14) 5.85 (~2.8% of price); beta 0.42 |
| Setup perspective | -1.33% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | +5.20% | ROA | 1.31% |
| SMA50 dist | +9.31% | ROE | 3.49% |
| SMA200 dist | +18.94% | Revenue (ttm) | $16.25B |

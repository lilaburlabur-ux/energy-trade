...
Signed file: `UEC.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $9.41 (2026-09-25, ~15-min delayed) |
| Market cap | $4.66B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-28.32%) with negative half-year (-27.89%). |
...
| Value attractiveness | Reasonable | Forward P/E -104.56, EV/Sales 206.47. |
| Risk level | High | Beta 1.24, ATR 6.2% of price, short float 14.60%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.41; 52w high $20.14 (-53.28%); 52w low $9.04 (+4.09%) |
| Trend | -28.32% vs SMA200, -12.97% vs SMA50, -12.69% vs SMA20 |
| Momentum | RSI(14) 34.2 (neutral) |
| Volatility | ATR(14) 0.59 (~6.2% of price); beta 1.24 |
...
| Valuation | P/E —, forward P/E -104.56, P/S 230.53, P/B 3.27 | EV/Sales 206.47, EV/EBITDA -34.54 |
...
- **Volatility risk:** Beta 1.24, ATR 6.2% of price, short float 14.60%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.41 | EV/Sales | 206.47 |
| Market cap | $4.66B | EV/EBITDA | -34.54 |
| Beta | 1.24 | Gross margin | 0.00% |
| RSI(14) | 34.2 | Operating margin | -629.66% |
| ATR(14) | 0.59 | Profit margin | 0.00% |
| SMA20 dist | -12.69% | ROA | -6.25% |
| SMA50 dist | -12.97% | ROE | -8.96% |
| SMA200 dist | -28.32% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 89.45% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -104.56 | Short float | 14.60% |
| PEG (trailing) | — | Avg volume | 8,364,192 |
| P/S | 230.53 | Employees | 171 |
| P/B | 3.27 | Analyst rec (1=buy..5=sell) | — |

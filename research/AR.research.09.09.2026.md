...
Signed file: `AR.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $39.12 (2026-09-09, ~15-min delayed) |
| Market cap | $12.03B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +21.83%; price +7.72% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 9.05, EV/Sales —. |
| Risk level | Moderate | Beta 0.35, ATR 2.6% of price, short float 4.44%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $39.12; 52w high $45.15 (-13.36%); 52w low $30.03 (+30.27%) |
| Trend | +7.72% vs SMA200, +8.14% vs SMA50, +2.37% vs SMA20 |
| Momentum | RSI(14) 62.2 (neutral) |
| Volatility | ATR(14) 1.02 (~2.6% of price); beta 0.35 |
...
| Valuation | P/E 11.21, forward P/E 9.05, P/S 2.08, P/B 1.45 | EV/Sales —, EV/EBITDA — |
| Growth expectations | Earnings growth 79.90%, EPS q/q 78.00% | Analyst mean target $49.95 (20 analysts) |
...
|---|---|---|---|
| Price | $39.12 | EV/Sales | — |
| Market cap | $12.03B | EV/EBITDA | — |
| Beta | 0.35 | Gross margin | 67.15% |
| RSI(14) | 62.2 | Operating margin | 26.02% |
| ATR(14) | 1.02 | Profit margin | 18.75% |
| SMA20 dist | +2.37% | ROA | 6.61% |
| SMA50 dist | +8.14% | ROE | 14.22% |
| SMA200 dist | +7.72% | Revenue (ttm) | $5.78B |
| 52W high | $45.15 | Revenue growth y/y | 12.60% |
| 52W low | $30.03 | Inst. ownership | 91.55% |
| P/E (ttm) | 11.21 | Insider ownership | 4.41% |
| Forward P/E | 9.05 | Short float | 4.44% |
| PEG (trailing) | 0.45 | Avg volume | 4,392,093 |
| P/S | 2.08 | Employees | 632 |
| P/B | 1.45 | Analyst rec (1=buy..5=sell) | 1.7 |

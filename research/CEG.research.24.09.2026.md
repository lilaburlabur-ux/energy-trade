...
Signed file: `CEG.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $261.62 (2026-09-24, ~15-min delayed) |
| Market cap | $92.69B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-9.95%) with negative half-year (-11.00%). |
...
| Value attractiveness | Reasonable | Forward P/E 19.64, EV/Sales 3.77. |
| Risk level | Elevated | Beta 1.12, ATR 3.7% of price, short float 3.65%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $261.62; 52w high $401.70 (-34.87%); 52w low $236.14 (+10.79%) |
| Trend | -9.95% vs SMA200, -3.60% vs SMA50, -5.22% vs SMA20 |
| Momentum | RSI(14) 42.4 (neutral) |
| Volatility | ATR(14) 9.65 (~3.7% of price); beta 1.12 |
...
| Valuation | P/E 25.55, forward P/E 19.64, P/S 2.96, P/B 2.91 | EV/Sales 3.77, EV/EBITDA 14.82 |
...
- **Volatility risk:** Beta 1.12, ATR 3.7% of price, short float 3.65%. Size positions accordingly.
...
|---|---|---|---|
| Price | $261.62 | EV/Sales | 3.77 |
| Market cap | $92.69B | EV/EBITDA | 14.82 |
| Beta | 1.12 | Gross margin | 22.11% |
| RSI(14) | 42.4 | Operating margin | 8.66% |
| ATR(14) | 9.65 | Profit margin | 11.08% |
| SMA20 dist | -5.22% | ROA | 3.89% |
| SMA50 dist | -3.60% | ROE | 15.06% |
| SMA200 dist | -9.95% | Revenue (ttm) | $31.27B |
| 52W high | $401.70 | Revenue growth y/y | 23.00% |
| 52W low | $236.14 | Inst. ownership | 82.97% |
| P/E (ttm) | 25.55 | Insider ownership | 0.34% |
| Forward P/E | 19.64 | Short float | 3.65% |
| PEG (trailing) | — | Avg volume | 2,981,520 |
| P/S | 2.96 | Employees | 15,291 |

...
Signed file: `OKLO.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $44.27 (2026-08-25, ~15-min delayed) |
| Market cap | $8.24B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-34.35%) with negative half-year (-31.96%). |
| Fresh setup quality | Poor / broken | -74.58% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -44.09, EV/Sales 4,067.64. |
| Risk level | High | Beta 1.20, ATR 7.4% of price, short float 18.60%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $44.27; 52w high $174.14 (-74.58%); 52w low $36.84 (+20.17%) |
| Trend | -34.35% vs SMA200, -5.34% vs SMA50, +3.16% vs SMA20 |
| Momentum | RSI(14) 50.3 (neutral) |
| Volatility | ATR(14) 3.29 (~7.4% of price); beta 1.20 |
| Setup perspective | -74.58% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -44.09, P/S 6,805.79, P/B 2.50 | EV/Sales 4,067.64, EV/EBITDA -22.70 |
...
- **Volatility risk:** Beta 1.20, ATR 7.4% of price, short float 18.60%. Size positions accordingly.
...
|---|---|---|---|
| Price | $44.27 | EV/Sales | 4,067.64 |
| Market cap | $8.24B | EV/EBITDA | -22.70 |
| Beta | 1.20 | Gross margin | 40.41% |
| RSI(14) | 50.3 | Operating margin | -6048.76% |
| ATR(14) | 3.29 | Profit margin | 0.00% |
| SMA20 dist | +3.16% | ROA | -6.65% |
| SMA50 dist | -5.34% | ROE | -7.70% |
| SMA200 dist | -34.35% | Revenue (ttm) | $1.21M |
| 52W high | $174.14 | Revenue growth y/y | — |
| 52W low | $36.84 | Inst. ownership | 47.42% |
| P/E (ttm) | — | Insider ownership | 15.43% |
| Forward P/E | -44.09 | Short float | 18.60% |
| PEG (trailing) | — | Avg volume | 10,734,500 |
| P/S | 6,805.79 | Employees | 215 |
| P/B | 2.50 | Analyst rec (1=buy..5=sell) | 2.0 |

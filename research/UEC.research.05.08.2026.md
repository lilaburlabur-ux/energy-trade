...
Signed file: `UEC.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $10.72 (2026-08-05, ~15-min delayed) |
| Market cap | — |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-20.27%) with negative half-year (-39.81%). |
| Fresh setup quality | Poor / broken | -46.77% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -107.20, EV/Sales 220.19. |
| Risk level | High | Beta 1.21, ATR 6.0% of price, short float 14.14%. |
...
|---|---|---|
| Nuclear Energy Stocks Rise on Surging Demand for Reliable Clean Power | Zacks | 2026-08-05 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.72; 52w high $20.14 (-46.77%); 52w low $9.04 (+18.58%) |
| Trend | -20.27% vs SMA200, -2.64% vs SMA50, +8.94% vs SMA20 |
| Momentum | RSI(14) 55.4 (neutral) |
| Volatility | ATR(14) 0.65 (~6.0% of price); beta 1.21 |
| Setup perspective | -46.77% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -107.20, P/S —, P/B — | EV/Sales 220.19, EV/EBITDA -36.83 |
...
- **Volatility risk:** Beta 1.21, ATR 6.0% of price, short float 14.14%. Size positions accordingly.
...
|---|---|---|---|
| Price | $10.72 | EV/Sales | 220.19 |
| Market cap | — | EV/EBITDA | -36.83 |
| Beta | 1.21 | Gross margin | 0.00% |
| RSI(14) | 55.4 | Operating margin | -629.66% |
| ATR(14) | 0.65 | Profit margin | 0.00% |
| SMA20 dist | +8.94% | ROA | -6.25% |
| SMA50 dist | -2.64% | ROE | -8.96% |
| SMA200 dist | -20.27% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 85.16% |
| P/E (ttm) | — | Insider ownership | 1.85% |
| Forward P/E | -107.20 | Short float | 14.14% |
| PEG (trailing) | — | Avg volume | 10,051,190 |
| P/S | — | Employees | 171 |

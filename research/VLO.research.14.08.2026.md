...
Signed file: `VLO.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $341.67 (2026-08-14, ~15-min delayed) |
| Market cap | $98.38B |
...
|---|---|---|
| Technical momentum | High | 1Y +156.27%; price +52.31% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.36% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 5.45%, revenue growth 51.70%. |
| Value attractiveness | Reasonable | Forward P/E 12.09, EV/Sales 0.80. |
| Risk level | Elevated | Beta 0.55, ATR 3.4% of price, short float 3.67%. |
...
| JPMorgan Chase: How To Limit Risk On A Stock That's Doing Well | Investor's Business Daily | 2026-08-14 |
| Marathon Surges 51% After Q2 Results: Is the Stock Still a Buy? | Zacks | 2026-08-14 |
| PSX, KMI & DINO Advance $5B Western Gateway Pipeline Project | Zacks | 2026-08-14 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $341.67; 52w high $342.92 (-0.36%); 52w low $133.00 (+156.89%) |
| Trend | +52.31% vs SMA200, +20.61% vs SMA50, +9.52% vs SMA20 |
| Momentum | RSI(14) 73.1 (overbought) |
| Volatility | ATR(14) 11.56 (~3.4% of price); beta 0.55 |
| Setup perspective | -0.36% from 52w high; no clean fresh pivot by default. |
...
- **Volatility risk:** Beta 0.55, ATR 3.4% of price, short float 3.67%. Size positions accordingly.
...
|---|---|---|---|
| Price | $341.67 | EV/Sales | 0.80 |
| Market cap | $98.38B | EV/EBITDA | 7.88 |
| Beta | 0.55 | Gross margin | 16.12% |
| RSI(14) | 73.1 | Operating margin | 12.27% |
| ATR(14) | 11.56 | Profit margin | 5.45% |
| SMA20 dist | +9.52% | ROA | 10.56% |
| SMA50 dist | +20.61% | ROE | 27.64% |
| SMA200 dist | +52.31% | Revenue (ttm) | $132.43B |
| 52W high | $342.92 | Revenue growth y/y | 51.70% |
| 52W low | $133.00 | Inst. ownership | 88.78% |
| P/E (ttm) | 14.25 | Insider ownership | 0.42% |
| Forward P/E | 12.09 | Short float | 3.67% |
| PEG (trailing) | 4.08 | Avg volume | 3,001,277 |

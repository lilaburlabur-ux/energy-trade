...
Signed file: `MPC.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $297.75 (2026-08-05, ~15-min delayed) |
| Market cap | $86.92B |
...
|---|---|---|
| MPC Q2 Earnings Call Highlights Refining Capture and Cash Returns | Zacks | 2026-08-05 |
| Oil Refiners Are Quietly Printing Money. This Company’s Earnings Jumped 975% | 24/7 Wall St. | 2026-08-05 |
| Marathon Petroleum (MPC) Q2 Earnings: How Key Metrics Compare to Wall Street Estimates | Zacks | 2026-08-05 |
| Marathon Petroleum (MPC) Stock May Be 20% Undervalued On Cash Flow | Simply Wall St. | 2026-08-05 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $297.75; 52w high $319.76 (-6.88%); 52w low $155.55 (+91.42%) |
| Trend | +33.77% vs SMA200, +7.43% vs SMA50, -2.89% vs SMA20 |
| Momentum | RSI(14) 50.6 (neutral) |
| Volatility | ATR(14) 10.04 (~3.4% of price); beta 0.51 |
| Setup perspective | -6.88% from 52w high; no clean fresh pivot by default. |
...
|---|---|---|---|
| Price | $297.75 | EV/Sales | 0.94 |
| Market cap | $86.92B | EV/EBITDA | 12.53 |
| Beta | 0.51 | Gross margin | 10.74% |
| RSI(14) | 50.6 | Operating margin | 3.56% |
| ATR(14) | 10.04 | Profit margin | 3.41% |
| SMA20 dist | -2.89% | ROA | 5.15% |
| SMA50 dist | +7.43% | ROE | 27.46% |
| SMA200 dist | +33.77% | Revenue (ttm) | $135.95B |

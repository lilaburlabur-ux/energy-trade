...
Signed file: `PR.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $23.18 (2026-08-28, ~15-min delayed) |
| Market cap | $19.41B |
...
|---|---|---|
| Technical momentum | High | 1Y +73.77%; price +27.89% vs SMA200. |
| Fresh setup quality | Moderate / wait | -2.89% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 21.52%, revenue growth 55.10%. |
| Value attractiveness | Reasonable | Forward P/E 10.56, EV/Sales 3.91. |
| Risk level | Moderate | Beta 0.48, ATR 2.9% of price, short float 2.27%. |
...
| Northern Oil and Gas Q2 Earnings Beat Estimates, Decline Y/Y | Zacks | 2026-08-17 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $23.18; 52w high $23.87 (-2.89%); 52w low $11.76 (+97.10%) |
| Trend | +27.89% vs SMA200, +13.30% vs SMA50, +5.90% vs SMA20 |
| Momentum | RSI(14) 62.9 (neutral) |
| Volatility | ATR(14) 0.67 (~2.9% of price); beta 0.48 |
| Setup perspective | -2.89% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 14.95, forward P/E 10.56, P/S 3.38, P/B 1.62 | EV/Sales 3.91, EV/EBITDA 5.27 |
| Growth expectations | Earnings growth 232.90%, EPS q/q 282.60% | Analyst mean target $25.79 (19 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 92.75% |
...
|---|---|---|---|
| Price | $23.18 | EV/Sales | 3.91 |
| Market cap | $19.41B | EV/EBITDA | 5.27 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 62.9 | Operating margin | 57.44% |
| ATR(14) | 0.67 | Profit margin | 21.52% |
| SMA20 dist | +5.90% | ROA | 7.54% |
| SMA50 dist | +13.30% | ROE | 11.40% |
| SMA200 dist | +27.89% | Revenue (ttm) | $5.74B |
| 52W high | $23.87 | Revenue growth y/y | 55.10% |
| 52W low | $11.76 | Inst. ownership | 92.75% |
| P/E (ttm) | 14.95 | Insider ownership | 4.61% |
| Forward P/E | 10.56 | Short float | 2.27% |
| PEG (trailing) | 1.30 | Avg volume | 9,972,409 |
| P/S | 3.38 | Employees | 515 |
| P/B | 1.62 | Analyst rec (1=buy..5=sell) | 1.3 |

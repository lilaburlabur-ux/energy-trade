...
Signed file: `PR.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $22.18 (2026-08-17, ~15-min delayed) |
| Market cap | $18.58B |
...
|---|---|---|
| Technical momentum | High | 1Y +71.34%; price +25.75% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.67% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 21.52%, revenue growth 55.10%. |
| Value attractiveness | Reasonable | Forward P/E 10.25, EV/Sales 3.67. |
...
| Helmerich & Payne Q3 Earnings Miss Estimates, Revenues Beat | Zacks | 2026-08-17 |
| U.S. Shale E&P Stocks Q2 Results: Benchmarking Permian Resources (NYSE:PR) | StockStory | 2026-08-17 |
| Permian Resources (PR) On Q2 Earnings And Higher Guidance Looks Cheap But Is It Priced In | Simply Wall St. | 2026-08-16 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $22.18; 52w high $22.33 (-0.67%); 52w low $11.76 (+88.60%) |
| Trend | +25.75% vs SMA200, +12.20% vs SMA50, +6.25% vs SMA20 |
| Momentum | RSI(14) 64.2 (neutral) |
| Volatility | ATR(14) 0.68 (~3.1% of price); beta 0.48 |
| Setup perspective | -0.67% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 14.31, forward P/E 10.25, P/S 3.24, P/B 1.55 | EV/Sales 3.67, EV/EBITDA 4.94 |
| Growth expectations | Earnings growth 232.90%, EPS q/q 282.60% | Analyst mean target $25.63 (19 analysts) |
...
|---|---|---|---|
| Price | $22.18 | EV/Sales | 3.67 |
| Market cap | $18.58B | EV/EBITDA | 4.94 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 64.2 | Operating margin | 57.44% |
| ATR(14) | 0.68 | Profit margin | 21.52% |
| SMA20 dist | +6.25% | ROA | 7.54% |
| SMA50 dist | +12.20% | ROE | 11.40% |
| SMA200 dist | +25.75% | Revenue (ttm) | $5.74B |
| 52W high | $22.33 | Revenue growth y/y | 55.10% |
| 52W low | $11.76 | Inst. ownership | 92.78% |
| P/E (ttm) | 14.31 | Insider ownership | 4.61% |
| Forward P/E | 10.25 | Short float | 2.76% |
| PEG (trailing) | 1.27 | Avg volume | 9,727,282 |

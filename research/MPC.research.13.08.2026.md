...
Signed file: `MPC.research.13.08.2026`

| Field | Value |
|---|---|
| Current price | $356.37 (2026-08-13, ~15-min delayed) |
| Market cap | $104.04B |
...
|---|---|---|
| Technical momentum | High | 1Y +128.36%; price +57.14% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 11.67, EV/Sales 0.85. |
| Risk level | Elevated | Beta 0.51, ATR 3.3% of price, short float 2.81%. |
...
| Marathon Petroleum (MPC) Could Be 19% Overvalued As Earnings Beat Expectations | Simply Wall St. | 2026-08-12 |
| Is DINO a Buy Now as Strong Earnings Meet a Richer Stock Valuation? | Zacks | 2026-08-12 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $356.37; 52w high $356.37 (+0.00%); 52w low $158.63 (+124.66%) |
| Trend | +57.14% vs SMA200, +24.60% vs SMA50, +12.80% vs SMA20 |
| Momentum | RSI(14) 75.1 (overbought) |
| Volatility | ATR(14) 11.93 (~3.3% of price); beta 0.51 |
...
| Valuation | P/E 12.36, forward P/E 11.67, P/S 0.67, P/B 6.23 | EV/Sales 0.85, EV/EBITDA 8.51 |
| Growth expectations | Earnings growth 348.00%, EPS q/q 322.50% | Analyst mean target $322.11 (18 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 81.22% |
...
- **Volatility risk:** Beta 0.51, ATR 3.3% of price, short float 2.81%. Size positions accordingly.
...
|---|---|---|---|
| Price | $356.37 | EV/Sales | 0.85 |
| Market cap | $104.04B | EV/EBITDA | 8.51 |
| Beta | 0.51 | Gross margin | 12.82% |
| RSI(14) | 75.1 | Operating margin | 13.56% |
| ATR(14) | 11.93 | Profit margin | 5.55% |
| SMA20 dist | +12.80% | ROA | 8.74% |
| SMA50 dist | +24.60% | ROE | 42.10% |
| SMA200 dist | +57.14% | Revenue (ttm) | $154.15B |
| 52W high | $356.37 | Revenue growth y/y | 53.70% |
| 52W low | $158.63 | Inst. ownership | 81.22% |
| P/E (ttm) | 12.36 | Insider ownership | 0.33% |
| Forward P/E | 11.67 | Short float | 2.81% |
| PEG (trailing) | 1.59 | Avg volume | 2,329,153 |
...
| 2026-08-05 | main | Evercore ISI Group | In-Line → In-Line |

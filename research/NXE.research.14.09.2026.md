...
Signed file: `NXE.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $9.47 (2026-09-14, ~15-min delayed) |
| Market cap | $6.27B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-12.92%) with negative half-year (-21.74%). |
| Fresh setup quality | Poor / broken | -31.97% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -58.60, EV/Sales —. |
| Risk level | Elevated | Beta 1.67, ATR 5.0% of price, short float —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.47; 52w high $13.92 (-31.97%); 52w low $7.56 (+25.26%) |
| Trend | -12.92% vs SMA200, -4.67% vs SMA50, -9.95% vs SMA20 |
| Momentum | RSI(14) 38.5 (neutral) |
| Volatility | ATR(14) 0.47 (~5.0% of price); beta 1.67 |
| Setup perspective | -31.97% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -58.60, P/S —, P/B 4.74 | EV/Sales —, EV/EBITDA -57.64 |
...
- **Volatility risk:** Beta 1.67, ATR 5.0% of price, short float —. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.47 | EV/Sales | — |
| Market cap | $6.27B | EV/EBITDA | -57.64 |
| Beta | 1.67 | Gross margin | 0.00% |
| RSI(14) | 38.5 | Operating margin | 0.00% |
| ATR(14) | 0.47 | Profit margin | 0.00% |
| SMA20 dist | -9.95% | ROA | -3.39% |
| SMA50 dist | -4.67% | ROE | -17.67% |
| SMA200 dist | -12.92% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.56 | Inst. ownership | 55.24% |
| P/E (ttm) | — | Insider ownership | 6.40% |
| Forward P/E | -58.60 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,039,124 |
| P/S | — | Employees | 142 |
| P/B | 4.74 | Analyst rec (1=buy..5=sell) | 1.5 |

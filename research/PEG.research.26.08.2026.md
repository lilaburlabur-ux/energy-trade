...
Signed file: `PEG.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $74.03 (2026-08-26, ~15-min delayed) |
| Market cap | $36.89B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-6.81%) with negative half-year (-12.44%). |
...
| Value attractiveness | Reasonable | Forward P/E 15.84, EV/Sales 4.89. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $74.03; 52w high $85.51 (-13.43%); 52w low $72.61 (+1.96%) |
| Trend | -6.81% vs SMA200, -5.47% vs SMA50, -1.66% vs SMA20 |
| Momentum | RSI(14) 38.4 (neutral) |
| Volatility | ATR(14) 1.28 (~1.7% of price); beta 0.53 |
...
| Valuation | P/E 18.42, forward P/E 15.84, P/S 2.94, P/B 2.13 | EV/Sales 4.89, EV/EBITDA 13.75 |
...
|---|---|---|---|
| Price | $74.03 | EV/Sales | 4.89 |
| Market cap | $36.89B | EV/EBITDA | 13.75 |
| Beta | 0.53 | Gross margin | 33.33% |
| RSI(14) | 38.4 | Operating margin | 18.87% |
| ATR(14) | 1.28 | Profit margin | 16.04% |
| SMA20 dist | -1.66% | ROA | 3.24% |
| SMA50 dist | -5.47% | ROE | 11.83% |
...
| Forward P/E | 15.84 | Short float | 2.22% |
| PEG (trailing) | 3.64 | Avg volume | 2,864,487 |
| P/S | 2.94 | Employees | 13,189 |
| P/B | 2.13 | Analyst rec (1=buy..5=sell) | 2.3 |

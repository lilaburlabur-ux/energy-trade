...
Signed file: `AR.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $35.59 (2026-09-17, ~15-min delayed) |
| Market cap | $10.94B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-2.26%) with negative half-year (-14.24%). |
| Fresh setup quality | Moderate / wait | -21.17% from 52w high; no clean fresh pivot by default. |
...
| Risk level | Elevated | Beta 0.35, ATR 3.3% of price, short float 4.81%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $35.59; 52w high $45.15 (-21.17%); 52w low $30.03 (+18.51%) |
| Trend | -2.26% vs SMA200, -2.47% vs SMA50, -7.31% vs SMA20 |
| Momentum | RSI(14) 36.2 (neutral) |
| Volatility | ATR(14) 1.17 (~3.3% of price); beta 0.35 |
| Setup perspective | -21.17% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 10.20, forward P/E 8.40, P/S 1.89, P/B 1.32 | EV/Sales —, EV/EBITDA — |
...
- **Volatility risk:** Beta 0.35, ATR 3.3% of price, short float 4.81%. Size positions accordingly.
...
|---|---|---|---|
| Price | $35.59 | EV/Sales | — |
| Market cap | $10.94B | EV/EBITDA | — |
| Beta | 0.35 | Gross margin | 67.15% |
| RSI(14) | 36.2 | Operating margin | 26.02% |
| ATR(14) | 1.17 | Profit margin | 18.75% |
| SMA20 dist | -7.31% | ROA | 6.61% |
| SMA50 dist | -2.47% | ROE | 14.22% |
| SMA200 dist | -2.26% | Revenue (ttm) | $5.78B |
| 52W high | $45.15 | Revenue growth y/y | 12.60% |
| 52W low | $30.03 | Inst. ownership | 91.47% |
| P/E (ttm) | 10.20 | Insider ownership | 4.41% |
| Forward P/E | 8.40 | Short float | 4.81% |
| PEG (trailing) | 0.45 | Avg volume | 4,245,343 |

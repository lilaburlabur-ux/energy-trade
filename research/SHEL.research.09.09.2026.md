...
Signed file: `SHEL.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $95.60 (2026-09-09, ~15-min delayed) |
| Market cap | $273.52B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +38.27%; price +16.57% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 9.51, EV/Sales 1.04. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $95.60; 52w high $95.60 (+0.00%); 52w low $68.25 (+40.07%) |
| Trend | +16.57% vs SMA200, +8.80% vs SMA50, +3.68% vs SMA20 |
| Momentum | RSI(14) 68.6 (neutral) |
| Volatility | ATR(14) 1.49 (~1.6% of price); beta -0.22 |
...
| Valuation | P/E 10.58, forward P/E 9.51, P/S 0.92, P/B 1.47 | EV/Sales 1.04, EV/EBITDA 5.35 |
...
| Market cap | $273.52B | EV/EBITDA | 5.35 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 68.6 | Operating margin | 16.69% |
| ATR(14) | 1.49 | Profit margin | 8.76% |
| SMA20 dist | +3.68% | ROA | 6.40% |
| SMA50 dist | +8.80% | ROE | 14.34% |
| SMA200 dist | +16.57% | Revenue (ttm) | $296.60B |
| 52W high | $95.60 | Revenue growth y/y | 44.70% |
| 52W low | $68.25 | Inst. ownership | 13.33% |
| P/E (ttm) | 10.58 | Insider ownership | 0.01% |
| Forward P/E | 9.51 | Short float | 1.57% |
| PEG (trailing) | 1.61 | Avg volume | 6,440,831 |

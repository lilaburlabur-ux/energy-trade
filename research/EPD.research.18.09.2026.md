...
Signed file: `EPD.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $38.89 (2026-09-18, ~15-min delayed) |
| Market cap | $83.98B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +29.12%; price +8.61% vs SMA200. |
| Fresh setup quality | Watch | -1.19% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.28, EV/Sales 2.02. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.89; 52w high $39.36 (-1.19%); 52w low $28.35 (+37.16%) |
| Trend | +8.61% vs SMA200, +1.56% vs SMA50, +0.14% vs SMA20 |
| Momentum | RSI(14) 53.2 (neutral) |
| Volatility | ATR(14) 0.59 (~1.5% of price); beta 0.48 |
| Setup perspective | -1.19% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.46, forward P/E 12.28, P/S 1.44, P/B 2.78 | EV/Sales 2.02, EV/EBITDA 11.44 |
...
|---|---|---|---|
| Price | $38.89 | EV/Sales | 2.02 |
| Market cap | $83.98B | EV/EBITDA | 11.44 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 53.2 | Operating margin | 11.76% |
| ATR(14) | 0.59 | Profit margin | 10.79% |
| SMA20 dist | +0.14% | ROA | 5.92% |
| SMA50 dist | +1.56% | ROE | 20.85% |
| SMA200 dist | +8.61% | Revenue (ttm) | $58.47B |
| 52W high | $39.36 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.64% |
| P/E (ttm) | 13.46 | Insider ownership | 33.04% |
| Forward P/E | 12.28 | Short float | 3.09% |
| PEG (trailing) | 1.37 | Avg volume | 2,875,591 |

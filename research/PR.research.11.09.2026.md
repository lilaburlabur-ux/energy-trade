...
Signed file: `PR.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $23.78 (2026-09-11, ~15-min delayed) |
| Market cap | $19.92B |
...
|---|---|---|
| Technical momentum | High | 1Y +73.88%; price +27.58% vs SMA200. |
| Fresh setup quality | Watch | -0.38% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Strong | Profit margin 21.52%, revenue growth 55.10%. |
| Value attractiveness | Reasonable | Forward P/E 10.78, EV/Sales 3.99. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $23.78; 52w high $23.87 (-0.38%); 52w low $11.76 (+102.20%) |
| Trend | +27.58% vs SMA200, +10.90% vs SMA50, +2.27% vs SMA20 |
| Momentum | RSI(14) 62.9 (neutral) |
| Volatility | ATR(14) 0.63 (~2.7% of price); beta 0.48 |
| Setup perspective | -0.38% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 15.34, forward P/E 10.78, P/S 3.47, P/B 1.66 | EV/Sales 3.99, EV/EBITDA 5.38 |
| Growth expectations | Earnings growth 232.90%, EPS q/q 282.60% | Analyst mean target $26.52 (21 analysts) |
...
|---|---|---|---|
| Price | $23.78 | EV/Sales | 3.99 |
| Market cap | $19.92B | EV/EBITDA | 5.38 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 62.9 | Operating margin | 57.44% |
| ATR(14) | 0.63 | Profit margin | 21.52% |
| SMA20 dist | +2.27% | ROA | 7.54% |
| SMA50 dist | +10.90% | ROE | 11.40% |
| SMA200 dist | +27.58% | Revenue (ttm) | $5.74B |
| 52W high | $23.87 | Revenue growth y/y | 55.10% |
| 52W low | $11.76 | Inst. ownership | 92.73% |
| P/E (ttm) | 15.34 | Insider ownership | 4.61% |
| Forward P/E | 10.78 | Short float | 2.47% |
| PEG (trailing) | 1.27 | Avg volume | 10,001,219 |

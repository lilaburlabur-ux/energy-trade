...
Signed file: `SMR.research.03.08.2026`

| Field | Value |
|---|---|
| Current price | $9.01 (2026-08-03, ~15-min delayed) |
| Market cap | $3.12B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-44.56%) with negative half-year (-48.46%). |
| Fresh setup quality | Poor / broken | -83.14% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -95.80%. |
| Value attractiveness | Reasonable | Forward P/E -12.57, EV/Sales 105.67. |
| Risk level | High | Beta 2.31, ATR 8.4% of price, short float 23.15%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.01; 52w high $53.43 (-83.14%); 52w low $7.59 (+18.71%) |
| Trend | -44.56% vs SMA200, -9.35% vs SMA50, +6.57% vs SMA20 |
| Momentum | RSI(14) 50.7 (neutral) |
| Volatility | ATR(14) 0.76 (~8.4% of price); beta 2.31 |
| Setup perspective | -83.14% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -12.57, P/S 167.04, P/B 2.46 | EV/Sales 105.67, EV/EBITDA -9.71 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $14.57 (15 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 52.30% |
...
- **Volatility risk:** Beta 2.31, ATR 8.4% of price, short float 23.15%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.01 | EV/Sales | 105.67 |
| Market cap | $3.12B | EV/EBITDA | -9.71 |
| Beta | 2.31 | Gross margin | 23.84% |
| RSI(14) | 50.7 | Operating margin | -10181.24% |
| ATR(14) | 0.76 | Profit margin | 0.00% |
| SMA20 dist | +6.57% | ROA | -14.46% |
| SMA50 dist | -9.35% | ROE | -83.05% |
| SMA200 dist | -44.56% | Revenue (ttm) | $18.67M |
| 52W high | $53.43 | Revenue growth y/y | -95.80% |
| 52W low | $7.59 | Inst. ownership | 52.30% |
| P/E (ttm) | — | Insider ownership | 1.99% |
| Forward P/E | -12.57 | Short float | 23.15% |
| PEG (trailing) | — | Avg volume | 33,113,627 |
| P/S | 167.04 | Employees | 428 |
| P/B | 2.46 | Analyst rec (1=buy..5=sell) | 2.6 |

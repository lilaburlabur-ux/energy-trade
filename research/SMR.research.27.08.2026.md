...
Signed file: `SMR.research.27.08.2026`

| Field | Value |
|---|---|
| Current price | $9.27 (2026-08-27, ~15-min delayed) |
| Market cap | $3.80B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-31.69%) with negative half-year (-29.67%). |
...
| Risk level | High | Beta 2.31, ATR 7.9% of price, short float 18.40%. |
...
| Trend | -31.69% vs SMA200, +0.08% vs SMA50, -0.22% vs SMA20 |
| Momentum | RSI(14) 50.3 (neutral) |
| Volatility | ATR(14) 0.73 (~7.9% of price); beta 2.31 |
...
- **Volatility risk:** Beta 2.31, ATR 7.9% of price, short float 18.40%. Size positions accordingly.
...
| RSI(14) | 50.3 | Operating margin | -85337.33% |
| ATR(14) | 0.73 | Profit margin | 0.00% |
| SMA20 dist | -0.22% | ROA | -10.60% |
| SMA50 dist | +0.08% | ROE | -55.18% |
| SMA200 dist | -31.69% | Revenue (ttm) | $10.69M |
...
| PEG (trailing) | — | Avg volume | 33,162,347 |

...
Signed file: `BEP.research.28.08.2026`
...
|---|---|---|
| Technical momentum | Moderate | 1Y +30.55%; price +3.40% vs SMA200. |
...
| Trend | +3.40% vs SMA200, -2.55% vs SMA50, -2.44% vs SMA20 |
...
| SMA20 dist | -2.44% | ROA | 0.42% |
| SMA50 dist | -2.55% | ROE | 0.40% |
| SMA200 dist | +3.40% | Revenue (ttm) | $6.36B |

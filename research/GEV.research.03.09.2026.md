...
Signed file: `GEV.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $941.84 (2026-09-03, ~15-min delayed) |
| Market cap | $250.84B |
...
|---|---|---|
| Technical momentum | High | 1Y +63.59%; price +6.57% vs SMA200. |
| Fresh setup quality | Moderate / wait | -19.83% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 23.04%, revenue growth 21.90%. |
| Value attractiveness | Low (expensive) | Forward P/E 37.56, EV/Sales 5.75. |
| Risk level | Elevated | Beta 1.03, ATR 4.7% of price, short float 2.98%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $941.84; 52w high $1,174.86 (-19.83%); 52w low $546.95 (+72.20%) |
| Trend | +6.57% vs SMA200, -7.51% vs SMA50, -3.34% vs SMA20 |
| Momentum | RSI(14) 44.6 (neutral) |
| Volatility | ATR(14) 43.89 (~4.7% of price); beta 1.03 |
| Setup perspective | -19.83% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 27.03, forward P/E 37.56, P/S 6.06, P/B 20.98 | EV/Sales 5.75, EV/EBITDA 60.53 |
...
- **Valuation risk:** Forward P/E 37.56, EV/Sales 5.75. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.03, ATR 4.7% of price, short float 2.98%. Size positions accordingly.
...
|---|---|---|---|
| Price | $941.84 | EV/Sales | 5.75 |
| Market cap | $250.84B | EV/EBITDA | 60.53 |
| Beta | 1.03 | Gross margin | 20.57% |
| RSI(14) | 44.6 | Operating margin | 7.47% |
| ATR(14) | 43.89 | Profit margin | 23.04% |
| SMA20 dist | -3.34% | ROA | 2.54% |
| SMA50 dist | -7.51% | ROE | 82.58% |
| SMA200 dist | +6.57% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.64% |
| P/E (ttm) | 27.03 | Insider ownership | 0.13% |
| Forward P/E | 37.56 | Short float | 2.98% |
| PEG (trailing) | 1.75 | Avg volume | 2,763,690 |

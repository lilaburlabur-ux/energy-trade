...
Signed file: `MPLX.research.22.09.2026`

| Field | Value |
|---|---|
| Current price | $59.16 (2026-09-22, ~15-min delayed) |
| Market cap | $59.98B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +27.06%; price +7.38% vs SMA200. |
| Fresh setup quality | Watch | -1.78% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Strong | Profit margin 39.28%, revenue growth 10.60%. |
| Value attractiveness | Reasonable | Forward P/E 12.26, EV/Sales 7.08. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $59.16; 52w high $60.23 (-1.78%); 52w low $44.22 (+33.79%) |
| Trend | +7.38% vs SMA200, +1.41% vs SMA50, -0.05% vs SMA20 |
| Momentum | RSI(14) 52.2 (neutral) |
| Volatility | ATR(14) 0.99 (~1.7% of price); beta 0.46 |
| Setup perspective | -1.78% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 12.72, forward P/E 12.26, P/S 4.99, P/B 4.28 | EV/Sales 7.08, EV/EBITDA 13.94 |
...
|---|---|---|---|
| Price | $59.16 | EV/Sales | 7.08 |
| Market cap | $59.98B | EV/EBITDA | 13.94 |
| Beta | 0.46 | Gross margin | 55.71% |
| RSI(14) | 52.2 | Operating margin | 38.25% |
| ATR(14) | 0.99 | Profit margin | 39.28% |
| SMA20 dist | -0.05% | ROA | 7.25% |
| SMA50 dist | +1.41% | ROE | 33.69% |
| SMA200 dist | +7.38% | Revenue (ttm) | $12.03B |
| 52W high | $60.23 | Revenue growth y/y | 10.60% |
| 52W low | $44.22 | Inst. ownership | 19.71% |
| P/E (ttm) | 12.72 | Insider ownership | 64.03% |
| Forward P/E | 12.26 | Short float | 2.01% |
| PEG (trailing) | 3.10 | Avg volume | 1,360,758 |
| P/S | 4.99 | Employees | 0 |
| P/B | 4.28 | Analyst rec (1=buy..5=sell) | 2.4 |

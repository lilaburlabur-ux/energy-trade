...
Signed file: `TLN.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $305.54 (2026-08-24, ~15-min delayed) |
| Market cap | $14.64B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $305.54; 52w high $445.84 (-31.47%); 52w low $302.97 (+0.85%) |
| Trend | -15.46% vs SMA200, -16.62% vs SMA50, -9.21% vs SMA20 |
| Momentum | RSI(14) 34.9 (neutral) |
| Volatility | ATR(14) 18.50 (~6.1% of price); beta 1.67 |
...
- **Volatility risk:** Beta 1.67, ATR 6.1% of price, short float 5.32%. Size positions accordingly.
...
|---|---|---|---|
| Price | $305.54 | EV/Sales | 6.53 |
| Market cap | $14.64B | EV/EBITDA | 41.98 |
| Beta | 1.67 | Gross margin | 42.10% |
| RSI(14) | 34.9 | Operating margin | -4.80% |
| ATR(14) | 18.50 | Profit margin | -4.95% |
| SMA20 dist | -9.21% | ROA | 0.92% |
| SMA50 dist | -16.62% | ROE | -12.83% |
| SMA200 dist | -15.46% | Revenue (ttm) | $3.74B |

...
Signed file: `LEU.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $142.12 (2026-09-15, ~15-min delayed) |
| Market cap | $2.91B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-31.68%) with negative half-year (-33.23%). |
| Fresh setup quality | Poor / broken | -67.40% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.23%, revenue growth 14.00%. |
| Value attractiveness | Low (expensive) | Forward P/E 37.80, EV/Sales 4.70. |
| Risk level | High | Beta 1.33, ATR 8.2% of price, short float 28.54%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $142.12; 52w high $436.00 (-67.40%); 52w low $142.12 (+0.00%) |
| Trend | -31.68% vs SMA200, -18.21% vs SMA50, -18.31% vs SMA20 |
| Momentum | RSI(14) 34.7 (neutral) |
| Volatility | ATR(14) 11.60 (~8.2% of price); beta 1.33 |
| Setup perspective | -67.40% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 75.20, forward P/E 37.80, P/S 6.13, P/B 3.35 | EV/Sales 4.70, EV/EBITDA 220.50 |
...
- **Valuation risk:** Forward P/E 37.80, EV/Sales 4.70. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.33, ATR 8.2% of price, short float 28.54%. Size positions accordingly.
...
|---|---|---|---|
| Price | $142.12 | EV/Sales | 4.70 |
| Market cap | $2.91B | EV/EBITDA | 220.50 |
| Beta | 1.33 | Gross margin | 23.66% |
| RSI(14) | 34.7 | Operating margin | 5.34% |
| ATR(14) | 11.60 | Profit margin | 10.23% |
| SMA20 dist | -18.31% | ROA | 0.02% |
| SMA50 dist | -18.21% | ROE | 8.05% |
| SMA200 dist | -31.68% | Revenue (ttm) | $473.90M |
| 52W high | $436.00 | Revenue growth y/y | 14.00% |
| 52W low | $142.12 | Inst. ownership | 88.70% |
| P/E (ttm) | 75.20 | Insider ownership | 4.20% |
| Forward P/E | 37.80 | Short float | 28.54% |
| PEG (trailing) | — | Avg volume | 757,291 |
| P/S | 6.13 | Employees | 467 |
| P/B | 3.35 | Analyst rec (1=buy..5=sell) | 1.8 |

...
Signed file: `FTI.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $77.45 (2026-08-21, ~15-min delayed) |
| Market cap | $30.37B |
...
|---|---|---|
| Technical momentum | High | 1Y +123.54%; price +23.75% vs SMA200. |
| Fresh setup quality | Moderate / wait | -2.90% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 11.28%, revenue growth 9.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 21.52, EV/Sales 2.95. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $77.45; 52w high $79.76 (-2.90%); 52w low $35.19 (+120.06%) |
| Trend | +23.75% vs SMA200, +8.66% vs SMA50, +4.88% vs SMA20 |
| Momentum | RSI(14) 60.1 (neutral) |
| Volatility | ATR(14) 2.45 (~3.2% of price); beta 0.74 |
| Setup perspective | -2.90% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 27.08, forward P/E 21.52, P/S 2.91, P/B 9.30 | EV/Sales 2.95, EV/EBITDA 15.47 |
| Growth expectations | Earnings growth 40.60%, EPS q/q 34.60% | Analyst mean target $75.81 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 100.90% |
...
- **Valuation risk:** Forward P/E 21.52, EV/Sales 2.95. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $77.45 | EV/Sales | 2.95 |
| Market cap | $30.37B | EV/EBITDA | 15.47 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 60.1 | Operating margin | 17.69% |
| ATR(14) | 2.45 | Profit margin | 11.28% |
| SMA20 dist | +4.88% | ROA | 9.53% |
| SMA50 dist | +8.66% | ROE | 35.81% |
| SMA200 dist | +23.75% | Revenue (ttm) | $10.42B |
| 52W high | $79.76 | Revenue growth y/y | 9.00% |
| 52W low | $35.19 | Inst. ownership | 100.90% |
| P/E (ttm) | 27.08 | Insider ownership | 1.71% |
| Forward P/E | 21.52 | Short float | 3.44% |
| PEG (trailing) | — | Avg volume | 4,687,001 |
| P/S | 2.91 | Employees | 22,000 |
| P/B | 9.30 | Analyst rec (1=buy..5=sell) | 2.0 |

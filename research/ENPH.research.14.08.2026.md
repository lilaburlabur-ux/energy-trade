...
Signed file: `ENPH.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $40.48 (2026-08-14, ~15-min delayed) |
| Market cap | $5.35B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +18.29%; price +0.62% vs SMA200. |
| Fresh setup quality | Poor / broken | -44.03% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 17.49, EV/Sales 3.81. |
| Risk level | High | Beta 1.65, ATR 6.3% of price, short float 20.98%. |
...
|---|---|---|
| Redwire, Enphase, Core & Main, Republic Services, and Owens Corning Stocks Trade Up, What You Need To Know | StockStory | 2026-08-11 |
| Enphase Energy (ENPH) Stock Looks Fully Priced With Cash Flow And Earnings In Sync | Simply Wall St. | 2026-08-08 |
| Enphase Energy (ENPH) Is Up 6.1% After Expanding U.S. AI-Focused Power Electronics Manufacturing - What's Changed | Simply Wall St. | 2026-08-07 |
| Solar stocks pop on Trump tariffs: AlphaSpace heat map breakdown | Yahoo Finance Video | 2026-08-07 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $40.48; 52w high $72.33 (-44.03%); 52w low $26.12 (+54.98%) |
| Trend | +0.62% vs SMA200, -9.97% vs SMA50, +3.04% vs SMA20 |
| Momentum | RSI(14) 47.6 (neutral) |
| Volatility | ATR(14) 2.57 (~6.3% of price); beta 1.65 |
| Setup perspective | -44.03% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 40.08, forward P/E 17.49, P/S 4.03, P/B 4.53 | EV/Sales 3.81, EV/EBITDA 26.41 |
| Growth expectations | Earnings growth -3.50%, EPS q/q -2.60% | Analyst mean target $47.01 (27 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 103.59% |
...
| Vanguard Portfolio Management LLC | 9,658,892 | 7.31% | 2026-03-31 |
| Alyeska Investment Group, L.p. | 5,845,629 | 4.42% | 2026-03-31 |
| Vanguard Capital Management LLC | 5,667,108 | 4.29% | 2026-03-31 |
| Two Sigma Investments, LP | 5,476,240 | 4.14% | 2026-03-31 |
| State Street Corporation | 4,746,613 | 3.59% | 2026-06-30 |
| Invesco Ltd. | 3,682,383 | 2.79% | 2026-03-31 |
| Holocene Advisors, LP | 3,361,368 | 2.54% | 2026-03-31 |
| Morgan Stanley | 2,928,679 | 2.22% | 2026-03-31 |
| JPMORGAN CHASE & CO | 2,416,246 | 1.83% | 2026-06-30 |

## 6. Risk Review and Setup Plan
- **Volatility risk:** Beta 1.65, ATR 6.3% of price, short float 20.98%. Size positions accordingly.
- **Short interest risk:** short float 20.98% can fuel squeezes both ways around news.
...
|---|---|---|---|
| Price | $40.48 | EV/Sales | 3.81 |
| Market cap | $5.35B | EV/EBITDA | 26.41 |
| Beta | 1.65 | Gross margin | 30.04% |
| RSI(14) | 47.6 | Operating margin | 17.98% |
| ATR(14) | 2.57 | Profit margin | 10.09% |
| SMA20 dist | +3.04% | ROA | 2.38% |
| SMA50 dist | -9.97% | ROE | 13.00% |
| SMA200 dist | +0.62% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 103.59% |
| P/E (ttm) | 40.08 | Insider ownership | 3.03% |
| Forward P/E | 17.49 | Short float | 20.98% |
| PEG (trailing) | 1.18 | Avg volume | 6,858,490 |
| P/S | 4.03 | Employees | 2,872 |
| P/B | 4.53 | Analyst rec (1=buy..5=sell) | 2.5 |
...
| Source | URL | Used for |
|---|---|---|
| Yahoo Finance quote/profile/statistics for ENPH | https://finance.yahoo.com/quote/ENPH | Snapshot metrics, ownership, analyst data |
| Yahoo Finance price history (via yfinance) | https://finance.yahoo.com/quote/ENPH/history | SMA/RSI/ATR/performance calculations |
| Yahoo Finance news feed | https://finance.yahoo.com/quote/ENPH/news | Catalyst headlines |

...
Signed file: `MPC.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $354.88 (2026-08-25, ~15-min delayed) |
| Market cap | $99.66B |
...
|---|---|---|
| Technical momentum | High | 1Y +111.15%; price +52.34% vs SMA200. |
| Fresh setup quality | Moderate / wait | -2.83% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 5.55%, revenue growth 53.70%. |
| Value attractiveness | Reasonable | Forward P/E 11.02, EV/Sales 0.88. |
| Risk level | Moderate | Beta 0.51, ATR 2.9% of price, short float 2.81%. |
...
| Are Investors Undervaluing Marathon Petroleum (MPC) Right Now? | Zacks | 2026-08-25 |
| Democrats: Trump oil and gas stocks gained $15.5M amid Iran war | Quartz | 2026-08-25 |
| PSX Gains 17.5% in a Month: Can Refining Strength Keep the Run Going? | Zacks | 2026-08-24 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $354.88; 52w high $365.21 (-2.83%); 52w low $160.76 (+120.75%) |
| Trend | +52.34% vs SMA200, +18.04% vs SMA50, +6.27% vs SMA20 |
| Momentum | RSI(14) 66.0 (neutral) |
| Volatility | ATR(14) 10.42 (~2.9% of price); beta 0.51 |
| Setup perspective | -2.83% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 12.30, forward P/E 11.02, P/S 0.65, P/B 5.26 | EV/Sales 0.88, EV/EBITDA 8.77 |
...
|---|---|---|---|
| Price | $354.88 | EV/Sales | 0.88 |
| Market cap | $99.66B | EV/EBITDA | 8.77 |
| Beta | 0.51 | Gross margin | 12.82% |
| RSI(14) | 66.0 | Operating margin | 13.56% |
| ATR(14) | 10.42 | Profit margin | 5.55% |
| SMA20 dist | +6.27% | ROA | 8.74% |
| SMA50 dist | +18.04% | ROE | 42.10% |
| SMA200 dist | +52.34% | Revenue (ttm) | $154.15B |
| 52W high | $365.21 | Revenue growth y/y | 53.70% |
| 52W low | $160.76 | Inst. ownership | 79.58% |
| P/E (ttm) | 12.30 | Insider ownership | 0.33% |
| Forward P/E | 11.02 | Short float | 2.81% |
| PEG (trailing) | 1.80 | Avg volume | 2,370,136 |
| P/S | 0.65 | Employees | 18,500 |
| P/B | 5.26 | Analyst rec (1=buy..5=sell) | 2.3 |

...
Signed file: `SEDG.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $33.51 (2026-08-28, ~15-min delayed) |
| Market cap | $2.06B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-20.69%) with negative half-year (-17.05%). |
| Fresh setup quality | Poor / broken | -57.32% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-20.29%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 34.55, EV/Sales 1.44. |
| Risk level | High | Beta 1.47, ATR 8.9% of price, short float 23.21%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $33.51; 52w high $78.51 (-57.32%); 52w low $28.47 (+17.70%) |
| Trend | -20.69% vs SMA200, -24.32% vs SMA50, -1.01% vs SMA20 |
| Momentum | RSI(14) 43.4 (neutral) |
| Volatility | ATR(14) 2.97 (~8.9% of price); beta 1.47 |
| Setup perspective | -57.32% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 34.55, P/S 1.55, P/B 5.00 | EV/Sales 1.44, EV/EBITDA -15.87 |
...
- **Valuation risk:** Forward P/E 34.55, EV/Sales 1.44. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.47, ATR 8.9% of price, short float 23.21%. Size positions accordingly.
...
|---|---|---|---|
| Price | $33.51 | EV/Sales | 1.44 |
| Market cap | $2.06B | EV/EBITDA | -15.87 |
| Beta | 1.47 | Gross margin | 21.25% |
| RSI(14) | 43.4 | Operating margin | -6.51% |
| ATR(14) | 2.97 | Profit margin | -20.29% |
| SMA20 dist | -1.01% | ROA | -3.84% |
| SMA50 dist | -24.32% | ROE | -58.42% |
| SMA200 dist | -20.69% | Revenue (ttm) | $1.33B |
| 52W high | $78.51 | Revenue growth y/y | 19.60% |
| 52W low | $28.47 | Inst. ownership | 102.17% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 34.55 | Short float | 23.21% |
| PEG (trailing) | — | Avg volume | 3,008,163 |
| P/S | 1.55 | Employees | 3,576 |
| P/B | 5.00 | Analyst rec (1=buy..5=sell) | 3.1 |

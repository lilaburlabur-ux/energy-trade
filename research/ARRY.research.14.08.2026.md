...
Signed file: `ARRY.research.14.08.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-37.80%) with negative half-year (-52.76%). |
| Fresh setup quality | Poor / broken | -57.78% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.63, EV/Sales 1.47. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $5.05; 52w high $11.96 (-57.78%); 52w low $4.81 (+4.99%) |
| Trend | -37.80% vs SMA200, -22.65% vs SMA50, -7.07% vs SMA20 |
| Momentum | RSI(14) 38.0 (neutral) |
| Volatility | ATR(14) 0.41 (~8.2% of price); beta 1.79 |
| Setup perspective | -57.78% from 52w high — base needs to rebuild. |
...
| Metric | Value |
|---|---|
| Institutional ownership | 146.50% |
...
| SMA20 dist | -7.07% | ROA | 3.33% |
| SMA50 dist | -22.65% | ROE | -25.98% |
| SMA200 dist | -37.80% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.81 | Inst. ownership | 146.50% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.63 | Short float | 26.42% |
| PEG (trailing) | 0.63 | Avg volume | 6,572,248 |
| P/S | 0.66 | Employees | 1,200 |
| P/B | -3.85 | Analyst rec (1=buy..5=sell) | 2.0 |

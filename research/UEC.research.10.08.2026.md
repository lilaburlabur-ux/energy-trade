...
Signed file: `UEC.research.10.08.2026`

| Field | Value |
|---|---|
| Current price | $11.38 (2026-08-10, ~15-min delayed) |
| Market cap | — |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-15.04%) with negative half-year (-29.40%). |
...
| Value attractiveness | Reasonable | Forward P/E -113.80, EV/Sales 251.79. |
| Risk level | High | Beta 1.21, ATR 5.4% of price, short float 14.14%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.38; 52w high $20.14 (-43.50%); 52w low $9.04 (+25.88%) |
| Trend | -15.04% vs SMA200, +4.71% vs SMA50, +14.11% vs SMA20 |
| Momentum | RSI(14) 61.3 (neutral) |
| Volatility | ATR(14) 0.62 (~5.4% of price); beta 1.21 |
...
| Valuation | P/E —, forward P/E -113.80, P/S —, P/B — | EV/Sales 251.79, EV/EBITDA -42.12 |
...
- **Volatility risk:** Beta 1.21, ATR 5.4% of price, short float 14.14%. Size positions accordingly.
...
|---|---|---|---|
| Price | $11.38 | EV/Sales | 251.79 |
| Market cap | — | EV/EBITDA | -42.12 |
| Beta | 1.21 | Gross margin | 0.00% |
| RSI(14) | 61.3 | Operating margin | -629.66% |
| ATR(14) | 0.62 | Profit margin | 0.00% |
| SMA20 dist | +14.11% | ROA | -6.25% |
| SMA50 dist | +4.71% | ROE | -8.96% |
| SMA200 dist | -15.04% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 87.04% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -113.80 | Short float | 14.14% |
| PEG (trailing) | — | Avg volume | 9,976,295 |
| P/S | — | Employees | 171 |

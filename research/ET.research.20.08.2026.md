...
Signed file: `ET.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $21.21 (2026-08-20, ~15-min delayed) |
| Market cap | $73.03B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +31.40%; price +17.46% vs SMA200. |
| Fresh setup quality | Watch | -0.98% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 4.92%, revenue growth 78.40%. |
| Value attractiveness | Reasonable | Forward P/E 12.12, EV/Sales 1.50. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $21.21; 52w high $21.42 (-0.98%); 52w low $15.15 (+39.95%) |
| Trend | +17.46% vs SMA200, +7.83% vs SMA50, +3.83% vs SMA20 |
| Momentum | RSI(14) 67.1 (neutral) |
| Volatility | ATR(14) 0.35 (~1.7% of price); beta 0.56 |
| Setup perspective | -0.98% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 14.53, forward P/E 12.12, P/S 0.68, P/B 2.28 | EV/Sales 1.50, EV/EBITDA 9.38 |
...
|---|---|---|---|
| Price | $21.21 | EV/Sales | 1.50 |
| Market cap | $73.03B | EV/EBITDA | 9.38 |
| Beta | 0.56 | Gross margin | 17.51% |
| RSI(14) | 67.1 | Operating margin | 10.41% |
| ATR(14) | 0.35 | Profit margin | 4.92% |
| SMA20 dist | +3.83% | ROA | 5.06% |
| SMA50 dist | +7.83% | ROE | 14.56% |
| SMA200 dist | +17.46% | Revenue (ttm) | $107.38B |
| 52W high | $21.42 | Revenue growth y/y | 78.40% |
| 52W low | $15.15 | Inst. ownership | 32.50% |
| P/E (ttm) | 14.53 | Insider ownership | 10.29% |
| Forward P/E | 12.12 | Short float | 0.84% |
| PEG (trailing) | 0.67 | Avg volume | 9,033,201 |

...
Signed file: `OKE.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $92.70 (2026-09-16, ~15-min delayed) |
| Market cap | $58.44B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $92.70; 52w high $97.51 (-4.93%); 52w low $61.95 (+49.63%) |
| Trend | +10.00% vs SMA200, +0.36% vs SMA50, -2.52% vs SMA20 |
| Momentum | RSI(14) 44.7 (neutral) |
| Volatility | ATR(14) 2.55 (~2.8% of price); beta 0.72 |
| Setup perspective | -4.93% from 52w high and near SMA20 — check for a tight base. |

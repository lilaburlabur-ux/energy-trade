...
Signed file: `UEC.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $12.51 (2026-08-24, ~15-min delayed) |
| Market cap | $6.13B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-5.65%) with negative half-year (-21.67%). |
| Fresh setup quality | Poor / broken | -37.88% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -139.00, EV/Sales 288.54. |
| Risk level | High | Beta 1.21, ATR 5.2% of price, short float 14.38%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $12.51; 52w high $20.14 (-37.88%); 52w low $9.04 (+38.38%) |
| Trend | -5.65% vs SMA200, +17.61% vs SMA50, +14.87% vs SMA20 |
| Momentum | RSI(14) 64.9 (neutral) |
| Volatility | ATR(14) 0.65 (~5.2% of price); beta 1.21 |
| Setup perspective | -37.88% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -139.00, P/S 303.60, P/B 4.34 | EV/Sales 288.54, EV/EBITDA -48.26 |
...
- **Volatility risk:** Beta 1.21, ATR 5.2% of price, short float 14.38%. Size positions accordingly.
...
|---|---|---|---|
| Price | $12.51 | EV/Sales | 288.54 |
| Market cap | $6.13B | EV/EBITDA | -48.26 |
| Beta | 1.21 | Gross margin | 0.00% |
| RSI(14) | 64.9 | Operating margin | -629.66% |
| ATR(14) | 0.65 | Profit margin | 0.00% |
| SMA20 dist | +14.87% | ROA | -6.25% |
| SMA50 dist | +17.61% | ROE | -8.96% |
| SMA200 dist | -5.65% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 88.44% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -139.00 | Short float | 14.38% |
| PEG (trailing) | — | Avg volume | 9,549,782 |
| P/S | 303.60 | Employees | 171 |
| P/B | 4.34 | Analyst rec (1=buy..5=sell) | 1.4 |

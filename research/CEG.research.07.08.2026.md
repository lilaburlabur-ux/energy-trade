...
Signed file: `CEG.research.07.08.2026`

| Field | Value |
|---|---|
| Current price | $261.10 (2026-08-07, ~15-min delayed) |
| Market cap | $93.24B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y -23.60%; price -14.35% vs SMA200. |
| Fresh setup quality | Poor / broken | -35.10% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 12.69%, revenue growth 63.80%. |
| Value attractiveness | Reasonable | Forward P/E 19.62, EV/Sales 3.94. |
| Risk level | Elevated | Beta 1.12, ATR 4.1% of price, short float 3.33%. |
...
| Constellation Energy beats on earnings, raises guidance: AlphaSpace check | Yahoo Finance Video | 2026-08-06 |
| Constellation Energy Stock Gains as Earnings Outlook Reaches $12.50 | GuruFocus.com | 2026-08-06 |
| CEG Q2 Earnings Top Estimates on Calpine Contribution, View Raised | Zacks | 2026-08-06 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $261.10; 52w high $402.32 (-35.10%); 52w low $236.50 (+10.40%) |
| Trend | -14.35% vs SMA200, -0.07% vs SMA50, -0.52% vs SMA20 |
| Momentum | RSI(14) 48.7 (neutral) |
| Volatility | ATR(14) 10.75 (~4.1% of price); beta 1.12 |
| Setup perspective | -35.10% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 22.68, forward P/E 19.62, P/S 3.12, P/B 2.83 | EV/Sales 3.94, EV/EBITDA 14.79 |
| Growth expectations | Earnings growth 1091.00%, EPS q/q 1247.50% | Analyst mean target $351.24 (21 analysts) |
...
|---|---|---|---|
| Blackrock Inc. | 23,509,199 | 6.55% | 2026-03-31 |
| ECP ControlCo, LLC | 22,043,724 | 6.14% | 2026-03-31 |
| Vanguard Capital Management LLC | 20,138,742 | 5.61% | 2026-03-31 |
| State Street Corporation | 18,796,388 | 5.23% | 2026-03-31 |
| Vanguard Portfolio Management LLC | 15,013,945 | 4.18% | 2026-03-31 |
| Capital International Investors | 11,608,787 | 3.23% | 2026-03-31 |
| Invesco Ltd. | 11,217,094 | 3.12% | 2026-03-31 |
| FMR, LLC | 10,181,644 | 2.84% | 2026-03-31 |
| Morgan Stanley | 8,903,186 | 2.48% | 2026-03-31 |
| Canada Pension Plan Investment Board | 7,672,648 | 2.14% | 2026-03-31 |

## 6. Risk Review and Setup Plan
- **Volatility risk:** Beta 1.12, ATR 4.1% of price, short float 3.33%. Size positions accordingly.
...
|---|---|---|---|
| Price | $261.10 | EV/Sales | 3.94 |
| Market cap | $93.24B | EV/EBITDA | 14.79 |
| Beta | 1.12 | Gross margin | 23.26% |
| RSI(14) | 48.7 | Operating margin | 21.86% |
| ATR(14) | 10.75 | Profit margin | 12.69% |
| SMA20 dist | -0.52% | ROA | 4.20% |
| SMA50 dist | -0.07% | ROE | 16.10% |
| SMA200 dist | -14.35% | Revenue (ttm) | $29.87B |
| 52W high | $402.32 | Revenue growth y/y | 63.80% |
| 52W low | $236.50 | Inst. ownership | 83.19% |
| P/E (ttm) | 22.68 | Insider ownership | 0.33% |
| Forward P/E | 19.62 | Short float | 3.33% |
| PEG (trailing) | — | Avg volume | 3,701,038 |
| P/S | 3.12 | Employees | 15,291 |
| P/B | 2.83 | Analyst rec (1=buy..5=sell) | 1.5 |
...
## 9. Conclusion
CEG: Moderate momentum / mixed fundamentals / reasonable value / elevated risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

## Sources
| Source | URL | Used for |
|---|---|---|
| Yahoo Finance quote/profile/statistics for CEG | https://finance.yahoo.com/quote/CEG | Snapshot metrics, ownership, analyst data |
| Yahoo Finance price history (via yfinance) | https://finance.yahoo.com/quote/CEG/history | SMA/RSI/ATR/performance calculations |
| Yahoo Finance news feed | https://finance.yahoo.com/quote/CEG/news | Catalyst headlines |

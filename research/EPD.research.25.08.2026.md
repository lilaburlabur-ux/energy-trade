...
Signed file: `EPD.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $38.27 (2026-08-25, ~15-min delayed) |
| Market cap | $82.64B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +27.74%; price +9.06% vs SMA200. |
| Fresh setup quality | Watch | -2.41% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.12, EV/Sales 2.01. |
| Risk level | Moderate | Beta 0.48, ATR 1.6% of price, short float 2.31%. |
...
|---|---|---|
| XOM vs EPD: Which Stock Offers the Better Growth Opportunity? | Zacks | 2026-08-25 |
| ET Stock Rallies Past Industry in a Month: Should You Buy or Hold? | Zacks | 2026-08-25 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.27; 52w high $39.22 (-2.41%); 52w low $28.35 (+34.97%) |
| Trend | +9.06% vs SMA200, +2.41% vs SMA50, +0.40% vs SMA20 |
| Momentum | RSI(14) 53.3 (neutral) |
| Volatility | ATR(14) 0.63 (~1.6% of price); beta 0.48 |
| Setup perspective | -2.41% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.24, forward P/E 12.12, P/S 1.41, P/B 2.73 | EV/Sales 2.01, EV/EBITDA 11.40 |
...
|---|---|---|---|
| Price | $38.27 | EV/Sales | 2.01 |
| Market cap | $82.64B | EV/EBITDA | 11.40 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 53.3 | Operating margin | 11.76% |
| ATR(14) | 0.63 | Profit margin | 10.79% |
| SMA20 dist | +0.40% | ROA | 5.92% |
| SMA50 dist | +2.41% | ROE | 20.85% |
| SMA200 dist | +9.06% | Revenue (ttm) | $58.47B |
| 52W high | $39.22 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.62% |
| P/E (ttm) | 13.24 | Insider ownership | 33.04% |
| Forward P/E | 12.12 | Short float | 2.31% |
| PEG (trailing) | 1.49 | Avg volume | 3,068,533 |
| P/S | 1.41 | Employees | 0 |
| P/B | 2.73 | Analyst rec (1=buy..5=sell) | 2.2 |

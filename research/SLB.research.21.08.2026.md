...
Signed file: `SLB.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $53.87 (2026-08-21, ~15-min delayed) |
| Market cap | $79.95B |
...
|---|---|---|
| Technical momentum | High | 1Y +65.89%; price +12.74% vs SMA200. |
| Fresh setup quality | Moderate / wait | -7.14% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 8.53%, revenue growth 5.00%. |
| Value attractiveness | Reasonable | Forward P/E 16.67, EV/Sales 2.46. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $53.87; 52w high $58.01 (-7.14%); 52w low $31.12 (+73.08%) |
| Trend | +12.74% vs SMA200, +8.48% vs SMA50, +4.15% vs SMA20 |
| Momentum | RSI(14) 61.2 (neutral) |
| Volatility | ATR(14) 1.46 (~2.7% of price); beta 0.75 |
| Setup perspective | -7.14% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.28, forward P/E 16.67, P/S 2.20, P/B 3.07 | EV/Sales 2.46, EV/EBITDA 12.10 |
...
|---|---|---|---|
| Price | $53.87 | EV/Sales | 2.46 |
| Market cap | $79.95B | EV/EBITDA | 12.10 |
| Beta | 0.75 | Gross margin | 16.99% |
| RSI(14) | 61.2 | Operating margin | 12.71% |
| ATR(14) | 1.46 | Profit margin | 8.53% |
| SMA20 dist | +4.15% | ROA | 6.17% |
| SMA50 dist | +8.48% | ROE | 12.91% |
| SMA200 dist | +12.74% | Revenue (ttm) | $36.37B |
| 52W high | $58.01 | Revenue growth y/y | 5.00% |
| 52W low | $31.12 | Inst. ownership | 92.94% |
| P/E (ttm) | 26.28 | Insider ownership | 0.22% |
| Forward P/E | 16.67 | Short float | 4.32% |
| PEG (trailing) | 1.83 | Avg volume | 13,677,296 |

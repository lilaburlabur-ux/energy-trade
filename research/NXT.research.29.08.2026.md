...
Signed file: `NXT.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $85.44 (2026-08-29, ~15-min delayed) |
| Market cap | $13.13B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-21.44%) with negative half-year (-18.71%). |
| Fresh setup quality | Poor / broken | -45.37% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 16.36%, revenue growth 8.20%. |
| Value attractiveness | Reasonable | Forward P/E 14.79, EV/Sales 3.42. |
| Risk level | High | Beta 1.95, ATR 6.1% of price, short float 8.04%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $85.44; 52w high $156.40 (-45.37%); 52w low $64.33 (+32.82%) |
| Trend | -21.44% vs SMA200, -16.93% vs SMA50, -9.89% vs SMA20 |
| Momentum | RSI(14) 36.8 (neutral) |
| Volatility | ATR(14) 5.25 (~6.1% of price); beta 1.95 |
| Setup perspective | -45.37% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 22.08, forward P/E 14.79, P/S 3.62, P/B 5.07 | EV/Sales 3.42, EV/EBITDA 16.58 |
...
- **Volatility risk:** Beta 1.95, ATR 6.1% of price, short float 8.04%. Size positions accordingly.
...
|---|---|---|---|
| Price | $85.44 | EV/Sales | 3.42 |
| Market cap | $13.13B | EV/EBITDA | 16.58 |
| Beta | 1.95 | Gross margin | 22.98% |
| RSI(14) | 36.8 | Operating margin | 20.86% |
| ATR(14) | 5.25 | Profit margin | 16.36% |
| SMA20 dist | -9.89% | ROA | 11.68% |
| SMA50 dist | -16.93% | ROE | 27.22% |
| SMA200 dist | -21.44% | Revenue (ttm) | $3.63B |
...
| PEG (trailing) | 3.15 | Avg volume | 3,029,285 |

...
Signed file: `VLO.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $347.19 (2026-08-17, ~15-min delayed) |
| Market cap | $99.97B |
...
|---|---|---|
| Technical momentum | High | 1Y +161.04%; price +54.14% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 12.28, EV/Sales 0.79. |
| Risk level | Elevated | Beta 0.55, ATR 3.3% of price, short float 3.67%. |
...
|---|---|---|
| Earnings Estimates Moving Higher for Valero Energy (VLO): Time to Buy? | Zacks | 2026-08-17 |
| YPF, E & XRG Advance Argentina LNG Toward a Key Investment Milestone | Zacks | 2026-08-17 |
| Hawaii Renewable Fuels Ramp-Up to Drive PARR's Long-Term Growth | Zacks | 2026-08-17 |
| Best Growth Stocks to Buy for August 17th | Zacks | 2026-08-17 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $347.19; 52w high $347.19 (+0.00%); 52w low $133.96 (+159.17%) |
| Trend | +54.14% vs SMA200, +21.79% vs SMA50, +10.67% vs SMA20 |
| Momentum | RSI(14) 74.9 (overbought) |
| Volatility | ATR(14) 11.48 (~3.3% of price); beta 0.55 |
...
| Valuation | P/E 14.47, forward P/E 12.28, P/S 0.75, P/B 4.32 | EV/Sales 0.79, EV/EBITDA 7.86 |
| Growth expectations | Earnings growth 453.50%, EPS q/q 421.00% | Analyst mean target $312.42 (19 analysts) |
...
- **Volatility risk:** Beta 0.55, ATR 3.3% of price, short float 3.67%. Size positions accordingly.
...
|---|---|---|---|
| Price | $347.19 | EV/Sales | 0.79 |
| Market cap | $99.97B | EV/EBITDA | 7.86 |
| Beta | 0.55 | Gross margin | 16.12% |
| RSI(14) | 74.9 | Operating margin | 12.27% |
| ATR(14) | 11.48 | Profit margin | 5.45% |
| SMA20 dist | +10.67% | ROA | 10.56% |
| SMA50 dist | +21.79% | ROE | 27.64% |
| SMA200 dist | +54.14% | Revenue (ttm) | $132.43B |
| 52W high | $347.19 | Revenue growth y/y | 51.70% |
| 52W low | $133.96 | Inst. ownership | 87.13% |
| P/E (ttm) | 14.47 | Insider ownership | 0.42% |
| Forward P/E | 12.28 | Short float | 3.67% |
| PEG (trailing) | 4.08 | Avg volume | 2,981,809 |
| P/S | 0.75 | Employees | 9,785 |
| P/B | 4.32 | Analyst rec (1=buy..5=sell) | 2.3 |

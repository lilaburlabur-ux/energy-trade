...
Signed file: `WMB.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $73.45 (2026-08-17, ~15-min delayed) |
| Market cap | $89.84B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +32.16%; price +7.29% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.81% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 24.94%, revenue growth 7.80%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 28.02, EV/Sales 10.13. |
| Risk level | Moderate | Beta 0.61, ATR 2.5% of price, short float 2.44%. |
...
| Williams’ Momentum Deal, New JV and Higher EBITDA Target Might Change The Case For Investing In WMB | Simply Wall St. | 2026-08-13 |
| Williams (WMB) Stock Trades At A Premium Despite Strong Returns | Simply Wall St. | 2026-08-13 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $73.45; 52w high $78.82 (-6.81%); 52w low $54.78 (+34.08%) |
| Trend | +7.29% vs SMA200, +0.34% vs SMA50, +1.58% vs SMA20 |
| Momentum | RSI(14) 52.2 (neutral) |
| Volatility | ATR(14) 1.85 (~2.5% of price); beta 0.61 |
| Setup perspective | -6.81% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 29.26, forward P/E 28.02, P/S 7.29, P/B 6.83 | EV/Sales 10.13, EV/EBITDA 17.74 |
| Growth expectations | Earnings growth 51.20%, EPS q/q 51.50% | Analyst mean target $84.90 (20 analysts) |
...
- **Valuation risk:** Forward P/E 28.02, EV/Sales 10.13. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $73.45 | EV/Sales | 10.13 |
| Market cap | $89.84B | EV/EBITDA | 17.74 |
| Beta | 0.61 | Gross margin | 63.64% |
| RSI(14) | 52.2 | Operating margin | 39.54% |
| ATR(14) | 1.85 | Profit margin | 24.94% |
| SMA20 dist | +1.58% | ROA | 5.03% |
| SMA50 dist | +0.34% | ROE | 21.50% |
| SMA200 dist | +7.29% | Revenue (ttm) | $12.32B |
| 52W high | $78.82 | Revenue growth y/y | 7.80% |
| 52W low | $54.78 | Inst. ownership | 91.44% |
| P/E (ttm) | 29.26 | Insider ownership | 0.45% |
| Forward P/E | 28.02 | Short float | 2.44% |
| PEG (trailing) | 2.51 | Avg volume | 6,937,006 |
| P/S | 7.29 | Employees | 5,987 |
| P/B | 6.83 | Analyst rec (1=buy..5=sell) | 1.5 |

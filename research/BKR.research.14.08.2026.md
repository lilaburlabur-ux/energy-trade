...
Signed file: `BKR.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $64.82 (2026-08-14, ~15-min delayed) |
| Market cap | $64.35B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +53.64%; price +13.81% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.31% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 11.17%, revenue growth -2.40%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.48, EV/Sales 2.25. |
...
|---|---|---|
| US Oil Drillers Add Even More Rigs As Oil Prices Stay Higher | Oilprice.com | 2026-08-14 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $64.82; 52w high $69.18 (-6.31%); 52w low $42.14 (+53.82%) |
| Trend | +13.81% vs SMA200, +9.47% vs SMA50, +7.45% vs SMA20 |
| Momentum | RSI(14) 65.9 (neutral) |
| Volatility | ATR(14) 1.76 (~2.7% of price); beta 0.96 |
| Setup perspective | -6.31% from 52w high; no clean fresh pivot by default. |
...
- **Valuation risk:** Forward P/E 20.48, EV/Sales 2.25. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $64.82 | EV/Sales | 2.25 |
| Market cap | $64.35B | EV/EBITDA | 12.89 |
| Beta | 0.96 | Gross margin | 23.66% |
| RSI(14) | 65.9 | Operating margin | 12.83% |
| ATR(14) | 1.76 | Profit margin | 11.17% |
| SMA20 dist | +7.45% | ROA | 4.85% |
| SMA50 dist | +9.47% | ROE | 16.46% |
| SMA200 dist | +13.81% | Revenue (ttm) | $27.73B |
| 52W high | $69.18 | Revenue growth y/y | -2.40% |
| 52W low | $42.14 | Inst. ownership | 100.46% |
| P/E (ttm) | 20.84 | Insider ownership | 0.15% |
| Forward P/E | 20.48 | Short float | 2.83% |
| PEG (trailing) | 2.20 | Avg volume | 8,707,179 |
| P/S | 2.32 | Employees | 54,000 |
| P/B | 3.23 | Analyst rec (1=buy..5=sell) | 1.7 |

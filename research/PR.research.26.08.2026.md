...
Signed file: `PR.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $22.75 (2026-08-26, ~15-min delayed) |
| Market cap | $19.05B |
...
|---|---|---|
| Technical momentum | High | 1Y +67.18%; price +25.87% vs SMA200. |
| Fresh setup quality | Moderate / wait | -4.69% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 21.52%, revenue growth 55.10%. |
| Value attractiveness | Reasonable | Forward P/E 10.43, EV/Sales 3.93. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $22.75; 52w high $23.87 (-4.69%); 52w low $11.76 (+93.44%) |
| Trend | +25.87% vs SMA200, +11.69% vs SMA50, +4.46% vs SMA20 |
| Momentum | RSI(14) 59.9 (neutral) |
| Volatility | ATR(14) 0.66 (~2.9% of price); beta 0.48 |
| Setup perspective | -4.69% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 14.68, forward P/E 10.43, P/S 3.32, P/B 1.59 | EV/Sales 3.93, EV/EBITDA 5.30 |
...
|---|---|---|---|
| Price | $22.75 | EV/Sales | 3.93 |
| Market cap | $19.05B | EV/EBITDA | 5.30 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 59.9 | Operating margin | 57.44% |
| ATR(14) | 0.66 | Profit margin | 21.52% |
| SMA20 dist | +4.46% | ROA | 7.54% |
| SMA50 dist | +11.69% | ROE | 11.40% |
| SMA200 dist | +25.87% | Revenue (ttm) | $5.74B |
| 52W high | $23.87 | Revenue growth y/y | 55.10% |
| 52W low | $11.76 | Inst. ownership | 92.75% |
| P/E (ttm) | 14.68 | Insider ownership | 4.61% |
| Forward P/E | 10.43 | Short float | 2.27% |
| PEG (trailing) | 1.34 | Avg volume | 9,963,157 |
| P/S | 3.32 | Employees | 515 |

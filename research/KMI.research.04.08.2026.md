...
Signed file: `KMI.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $31.38 (2026-08-04, ~15-min delayed) |
| Market cap | $69.88B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +16.16%; price +4.87% vs SMA200. |
| Fresh setup quality | Moderate / wait | -7.68% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 19.30%, revenue growth 10.80%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.39, EV/Sales 5.76. |
...
|---|---|---|
| TechnipFMC Q2 Earnings & Revenues Beat Estimates, Rise Y/Y | Zacks | 2026-08-04 |
| ProPetro Q2 Loss Wider Than Expected, Revenues Beat Estimates | Zacks | 2026-08-04 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $31.38; 52w high $33.99 (-7.68%); 52w low $24.86 (+26.22%) |
| Trend | +4.87% vs SMA200, -1.18% vs SMA50, -1.68% vs SMA20 |
| Momentum | RSI(14) 44.6 (neutral) |
| Volatility | ATR(14) 0.73 (~2.3% of price); beta 0.55 |
| Setup perspective | -7.68% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.25, forward P/E 20.39, P/S 3.89, P/B 2.21 | EV/Sales 5.76, EV/EBITDA 13.56 |
...
- **Valuation risk:** Forward P/E 20.39, EV/Sales 5.76. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $31.38 | EV/Sales | 5.76 |
| Market cap | $69.88B | EV/EBITDA | 13.56 |
| Beta | 0.55 | Gross margin | 49.41% |
| RSI(14) | 44.6 | Operating margin | 30.06% |
| ATR(14) | 0.73 | Profit margin | 19.30% |
| SMA20 dist | -1.68% | ROA | 4.45% |
| SMA50 dist | -1.18% | ROE | 10.99% |
| SMA200 dist | +4.87% | Revenue (ttm) | $17.96B |
| 52W high | $33.99 | Revenue growth y/y | 10.80% |
| 52W low | $24.86 | Inst. ownership | 70.92% |
| P/E (ttm) | 20.25 | Insider ownership | 12.67% |
| Forward P/E | 20.39 | Short float | 2.33% |
| PEG (trailing) | 3.50 | Avg volume | 10,064,236 |

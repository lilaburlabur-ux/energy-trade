...
Signed file: `WFRD.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $93.79 (2026-08-29, ~15-min delayed) |
| Market cap | $6.72B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +49.04%; price +2.75% vs SMA200. |
| Fresh setup quality | Moderate / wait | -15.56% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 7.66%, revenue growth -8.20%. |
| Value attractiveness | Reasonable | Forward P/E 13.29, EV/Sales 1.49. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $93.79; 52w high $111.07 (-15.56%); 52w low $60.68 (+54.57%) |
| Trend | +2.75% vs SMA200, +8.27% vs SMA50, +3.24% vs SMA20 |
| Momentum | RSI(14) 58.9 (neutral) |
| Volatility | ATR(14) 3.41 (~3.6% of price); beta 0.89 |
| Setup perspective | -15.56% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.50, forward P/E 13.29, P/S 1.41, P/B 3.77 | EV/Sales 1.49, EV/EBITDA 7.66 |
...
|---|---|---|---|
| Price | $93.79 | EV/Sales | 1.49 |
| Market cap | $6.72B | EV/EBITDA | 7.66 |
| Beta | 0.89 | Gross margin | 30.51% |
| RSI(14) | 58.9 | Operating margin | 10.50% |
| ATR(14) | 3.41 | Profit margin | 7.66% |
| SMA20 dist | +3.24% | ROA | 7.90% |
| SMA50 dist | +8.27% | ROE | 22.79% |
| SMA200 dist | +2.75% | Revenue (ttm) | $4.78B |
| 52W high | $111.07 | Revenue growth y/y | -8.20% |
| 52W low | $60.68 | Inst. ownership | 108.23% |
| P/E (ttm) | 18.50 | Insider ownership | 2.15% |
| Forward P/E | 13.29 | Short float | 6.33% |
| PEG (trailing) | 1.82 | Avg volume | 1,232,800 |
| P/S | 1.41 | Employees | 16,700 |
| P/B | 3.77 | Analyst rec (1=buy..5=sell) | 1.7 |

...
Signed file: `OXY.research.07.09.2026`

| Field | Value |
|---|---|
| Current price | $60.04 (2026-09-07, ~15-min delayed) |
| Market cap | $60.02B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +31.48%; price +15.14% vs SMA200. |
| Fresh setup quality | Moderate / wait | -8.94% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 30.32%, revenue growth 53.40%. |
| Value attractiveness | Reasonable | Forward P/E 15.65, EV/Sales 3.32. |
| Risk level | Moderate | Beta 0.16, ATR 2.3% of price, short float 0.01%. |
...
| 1 Value Stock with Impressive Fundamentals and 2 We Question | StockStory | 2026-09-02 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $60.04; 52w high $65.94 (-8.94%); 52w low $38.56 (+55.71%) |
| Trend | +15.14% vs SMA200, +6.99% vs SMA50, +0.72% vs SMA20 |
| Momentum | RSI(14) 56.8 (neutral) |
| Volatility | ATR(14) 1.41 (~2.3% of price); beta 0.16 |
| Setup perspective | -8.94% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 17.71, forward P/E 15.65, P/S 2.51, P/B 1.79 | EV/Sales 3.32, EV/EBITDA 5.79 |
...
|---|---|---|---|
| Price | $60.04 | EV/Sales | 3.32 |
| Market cap | $60.02B | EV/EBITDA | 5.79 |
| Beta | 0.16 | Gross margin | 73.32% |
| RSI(14) | 56.8 | Operating margin | 45.44% |
| ATR(14) | 1.41 | Profit margin | 30.32% |
| SMA20 dist | +0.72% | ROA | 4.68% |
| SMA50 dist | +6.99% | ROE | 10.63% |
| SMA200 dist | +15.14% | Revenue (ttm) | $23.93B |
...
| PEG (trailing) | 1.23 | Avg volume | 8,750,214 |

...
Signed file: `VST.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $135.66 (2026-08-24, ~15-min delayed) |
| Market cap | $45.53B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-14.82%) with negative half-year (-18.93%). |
| Fresh setup quality | Poor / broken | -37.49% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 11.55%, revenue growth -5.50%. |
| Value attractiveness | Reasonable | Forward P/E 13.09, EV/Sales 3.55. |
...
| Vistra Is the Quietest Big Winner of the AI Power Boom. Here's Why. | Motley Fool | 2026-08-23 |
| S&P 500 Posts First Weekly Loss Since July Amid US Warning to Iran | MT Newswires | 2026-08-21 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $135.66; 52w high $217.02 (-37.49%); 52w low $134.52 (+0.85%) |
| Trend | -14.82% vs SMA200, -11.40% vs SMA50, -5.76% vs SMA20 |
| Momentum | RSI(14) 36.7 (neutral) |
| Volatility | ATR(14) 5.81 (~4.3% of price); beta 1.43 |
| Setup perspective | -37.49% from 52w high — base needs to rebuild. |
...
|---|---|---|---|
| Price | $135.66 | EV/Sales | 3.55 |
| Market cap | $45.53B | EV/EBITDA | 10.27 |
| Beta | 1.43 | Gross margin | 38.31% |
| RSI(14) | 36.7 | Operating margin | 13.77% |
| ATR(14) | 5.81 | Profit margin | 11.55% |
| SMA20 dist | -5.76% | ROA | 5.89% |
| SMA50 dist | -11.40% | ROE | 42.96% |
| SMA200 dist | -14.82% | Revenue (ttm) | $19.21B |
| 52W high | $217.02 | Revenue growth y/y | -5.50% |
| 52W low | $134.52 | Inst. ownership | 92.09% |
| P/E (ttm) | 22.88 | Insider ownership | 0.79% |
| Forward P/E | 13.09 | Short float | 2.99% |
| PEG (trailing) | 0.39 | Avg volume | 4,460,053 |
| P/S | 2.37 | Employees | 6,390 |
| P/B | 15.16 | Analyst rec (1=buy..5=sell) | 1.4 |

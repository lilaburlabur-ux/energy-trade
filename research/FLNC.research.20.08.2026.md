...
Signed file: `FLNC.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $11.39 (2026-08-20, ~15-min delayed) |
| Market cap | $2.59B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-38.54%) with negative half-year (-31.22%). |
| Fresh setup quality | Poor / broken | -64.66% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 48.84, EV/Sales 0.71. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.39; 52w high $32.23 (-64.66%); 52w low $6.75 (+68.74%) |
| Trend | -38.54% vs SMA200, -30.85% vs SMA50, -13.35% vs SMA20 |
| Momentum | RSI(14) 34.9 (neutral) |
| Volatility | ATR(14) 1.20 (~10.5% of price); beta 2.78 |
| Setup perspective | -64.66% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 48.84, P/S 0.98, P/B 4.37 | EV/Sales 0.71, EV/EBITDA -23.85 |
...
- **Valuation risk:** Forward P/E 48.84, EV/Sales 0.71. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $11.39 | EV/Sales | 0.71 |
| Market cap | $2.59B | EV/EBITDA | -23.85 |
| Beta | 2.78 | Gross margin | 9.36% |
| RSI(14) | 34.9 | Operating margin | -8.85% |
| ATR(14) | 1.20 | Profit margin | -3.07% |
| SMA20 dist | -13.35% | ROA | -2.95% |
| SMA50 dist | -30.85% | ROE | -23.54% |
| SMA200 dist | -38.54% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.75 | Inst. ownership | 85.30% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 48.84 | Short float | 29.29% |
| PEG (trailing) | — | Avg volume | 9,986,425 |
| P/S | 0.98 | Employees | 1,670 |

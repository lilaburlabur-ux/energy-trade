...
Signed file: `NXE.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $9.45 (2026-09-17, ~15-min delayed) |
| Market cap | $6.26B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-13.20%) with negative half-year (-19.64%). |
| Fresh setup quality | Poor / broken | -32.11% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -58.75, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.45; 52w high $13.92 (-32.11%); 52w low $7.56 (+25.00%) |
| Trend | -13.20% vs SMA200, -4.93% vs SMA50, -8.72% vs SMA20 |
| Momentum | RSI(14) 38.9 (neutral) |
| Volatility | ATR(14) 0.44 (~4.6% of price); beta 1.67 |
| Setup perspective | -32.11% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -58.75, P/S —, P/B 4.73 | EV/Sales —, EV/EBITDA -54.73 |
...
|---|---|---|---|
| Price | $9.45 | EV/Sales | — |
| Market cap | $6.26B | EV/EBITDA | -54.73 |
| Beta | 1.67 | Gross margin | 0.00% |
| RSI(14) | 38.9 | Operating margin | 0.00% |
| ATR(14) | 0.44 | Profit margin | 0.00% |
| SMA20 dist | -8.72% | ROA | -3.39% |
| SMA50 dist | -4.93% | ROE | -17.67% |
| SMA200 dist | -13.20% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.56 | Inst. ownership | 55.22% |
| P/E (ttm) | — | Insider ownership | 6.40% |
| Forward P/E | -58.75 | Short float | — |
| PEG (trailing) | — | Avg volume | 4,847,801 |
| P/S | — | Employees | 142 |
| P/B | 4.73 | Analyst rec (1=buy..5=sell) | 1.5 |

...
Signed file: `BWXT.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $146.35 (2026-09-17, ~15-min delayed) |
| Market cap | $13.41B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-23.47%) with negative half-year (-29.77%). |
| Fresh setup quality | Poor / broken | -38.44% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.11%, revenue growth 18.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 27.79, EV/Sales 4.20. |
...
| BWX Technologies (BWXT) Lands Key Y 12 Nuclear Design Role | Simply Wall St. | 2026-09-16 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $146.35; 52w high $237.73 (-38.44%); 52w low $145.66 (+0.47%) |
| Trend | -23.47% vs SMA200, -11.03% vs SMA50, -4.62% vs SMA20 |
| Momentum | RSI(14) 36.3 (neutral) |
| Volatility | ATR(14) 5.43 (~3.7% of price); beta 0.74 |
| Setup perspective | -38.44% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 37.91, forward P/E 27.79, P/S 3.82, P/B 10.05 | EV/Sales 4.20, EV/EBITDA 30.97 |
...
- **Valuation risk:** Forward P/E 27.79, EV/Sales 4.20. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $146.35 | EV/Sales | 4.20 |
| Market cap | $13.41B | EV/EBITDA | 30.97 |
| Beta | 0.74 | Gross margin | 22.08% |
| RSI(14) | 36.3 | Operating margin | 10.39% |
| ATR(14) | 5.43 | Profit margin | 10.11% |
| SMA20 dist | -4.62% | ROA | 5.53% |
| SMA50 dist | -11.03% | ROE | 28.29% |
| SMA200 dist | -23.47% | Revenue (ttm) | $3.51B |
| 52W high | $237.73 | Revenue growth y/y | 18.00% |
| 52W low | $145.66 | Inst. ownership | 94.33% |
| P/E (ttm) | 37.91 | Insider ownership | 0.35% |
| Forward P/E | 27.79 | Short float | 4.10% |
| PEG (trailing) | — | Avg volume | 1,018,235 |
| P/S | 3.82 | Employees | 11,000 |
| P/B | 10.05 | Analyst rec (1=buy..5=sell) | 1.6 |

...
Signed file: `BWXT.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $172.56 (2026-08-12, ~15-min delayed) |
| Market cap | $15.81B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-11.88%) with negative half-year (-13.41%). |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 32.86, EV/Sales 4.83. |
| Risk level | Elevated | Beta 0.76, ATR 4.0% of price, short float 3.99%. |
...
|---|---|---|
| BWX’s Q2 Earnings Call: Our Top 5 Analyst Questions | StockStory | 2026-08-12 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $172.56; 52w high $238.10 (-27.53%); 52w low $157.44 (+9.60%) |
| Trend | -11.88% vs SMA200, -5.99% vs SMA50, +1.09% vs SMA20 |
| Momentum | RSI(14) 47.2 (neutral) |
| Volatility | ATR(14) 6.85 (~4.0% of price); beta 0.76 |
...
| Valuation | P/E 44.82, forward P/E 32.86, P/S 4.50, P/B 16.68 | EV/Sales 4.83, EV/EBITDA 35.59 |
...
- **Valuation risk:** Forward P/E 32.86, EV/Sales 4.83. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.76, ATR 4.0% of price, short float 3.99%. Size positions accordingly.
...
|---|---|---|---|
| Price | $172.56 | EV/Sales | 4.83 |
| Market cap | $15.81B | EV/EBITDA | 35.59 |
| Beta | 0.76 | Gross margin | 22.08% |
| RSI(14) | 47.2 | Operating margin | 10.39% |
| ATR(14) | 6.85 | Profit margin | 10.11% |
| SMA20 dist | +1.09% | ROA | 5.53% |
| SMA50 dist | -5.99% | ROE | 28.29% |
| SMA200 dist | -11.88% | Revenue (ttm) | $3.51B |
| 52W high | $238.10 | Revenue growth y/y | 18.00% |
| 52W low | $157.44 | Inst. ownership | 94.57% |
| P/E (ttm) | 44.82 | Insider ownership | 0.36% |
| Forward P/E | 32.86 | Short float | 3.99% |
| PEG (trailing) | — | Avg volume | 963,353 |
| P/S | 4.50 | Employees | 11,000 |
| P/B | 16.68 | Analyst rec (1=buy..5=sell) | 1.8 |

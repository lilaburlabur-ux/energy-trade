...
Signed file: `ARRY.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $4.80 (2026-08-18, ~15-min delayed) |
| Market cap | $739.24M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-40.59%) with negative half-year (-57.48%). |
| Fresh setup quality | Poor / broken | -59.87% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.36, EV/Sales 1.44. |
| Risk level | High | Beta 1.79, ATR 8.1% of price, short float 26.42%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.80; 52w high $11.96 (-59.87%); 52w low $4.80 (+0.00%) |
| Trend | -40.59% vs SMA200, -24.77% vs SMA50, -9.83% vs SMA20 |
| Momentum | RSI(14) 34.8 (neutral) |
| Volatility | ATR(14) 0.39 (~8.1% of price); beta 1.79 |
| Setup perspective | -59.87% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 5.36, P/S 0.62, P/B -3.66 | EV/Sales 1.44, EV/EBITDA 14.33 |
| Growth expectations | Earnings growth -73.20%, EPS q/q -43.70% | Analyst mean target $9.25 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 148.08% |
...
- **Volatility risk:** Beta 1.79, ATR 8.1% of price, short float 26.42%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.80 | EV/Sales | 1.44 |
| Market cap | $739.24M | EV/EBITDA | 14.33 |
| Beta | 1.79 | Gross margin | 26.76% |
| RSI(14) | 34.8 | Operating margin | 10.88% |
| ATR(14) | 0.39 | Profit margin | -7.25% |
| SMA20 dist | -9.83% | ROA | 3.33% |
| SMA50 dist | -24.77% | ROE | -25.98% |
| SMA200 dist | -40.59% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.80 | Inst. ownership | 148.08% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.36 | Short float | 26.42% |
| PEG (trailing) | 0.60 | Avg volume | 6,623,161 |
| P/S | 0.62 | Employees | 1,200 |
| P/B | -3.66 | Analyst rec (1=buy..5=sell) | 2.0 |

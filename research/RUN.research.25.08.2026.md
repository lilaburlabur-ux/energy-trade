...
Signed file: `RUN.research.25.08.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-38.32%) with negative half-year (-54.28%). |
| Fresh setup quality | Poor / broken | -57.08% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 11.59%, revenue growth 52.80%. |
| Value attractiveness | Reasonable | Forward P/E 8.28, EV/Sales 5.29. |
| Risk level | High | Beta 2.39, ATR 6.8% of price, short float 32.19%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.19; 52w high $21.41 (-57.08%); 52w low $8.92 (+3.03%) |
| Trend | -38.32% vs SMA200, -18.70% vs SMA50, -6.05% vs SMA20 |
| Momentum | RSI(14) 39.9 (neutral) |
| Volatility | ATR(14) 0.63 (~6.8% of price); beta 2.39 |
| Setup perspective | -57.08% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 2.39, ATR 6.8% of price, short float 32.19%. Size positions accordingly.
...
| SMA20 dist | -6.05% | ROA | 0.26% |
| SMA50 dist | -18.70% | ROE | -19.86% |
| SMA200 dist | -38.32% | Revenue (ttm) | $3.48B |

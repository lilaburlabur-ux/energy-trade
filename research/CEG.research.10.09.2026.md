...
Signed file: `CEG.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $285.97 (2026-09-10, ~15-min delayed) |
| Market cap | $101.32B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $285.97; 52w high $401.70 (-28.81%); 52w low $236.14 (+21.10%) |
| Trend | -2.96% vs SMA200, +6.59% vs SMA50, +1.71% vs SMA20 |
| Momentum | RSI(14) 54.8 (neutral) |
| Volatility | ATR(14) 9.74 (~3.4% of price); beta 1.12 |
| Setup perspective | -28.81% from 52w high — base needs to rebuild. |
...
| SMA20 dist | +1.71% | ROA | 3.89% |
| SMA50 dist | +6.59% | ROE | 15.06% |
| SMA200 dist | -2.96% | Revenue (ttm) | $31.27B |
| 52W high | $401.70 | Revenue growth y/y | 23.00% |
| 52W low | $236.14 | Inst. ownership | 83.04% |
| P/E (ttm) | 27.95 | Insider ownership | 0.34% |
| Forward P/E | 21.43 | Short float | 2.97% |
| PEG (trailing) | — | Avg volume | 3,078,062 |
| P/S | 3.24 | Employees | 15,291 |
| P/B | 3.18 | Analyst rec (1=buy..5=sell) | 1.5 |

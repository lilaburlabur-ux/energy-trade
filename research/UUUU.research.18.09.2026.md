...
Signed file: `UUUU.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $11.70 (2026-09-18, ~15-min delayed) |
| Market cap | $3.10B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-32.45%) with negative half-year (-34.71%). |
| Fresh setup quality | Poor / broken | -57.79% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-77.30%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 24.12, EV/Sales 25.91. |
| Risk level | High | Beta 1.63, ATR 6.8% of price, short float 20.62%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.70; 52w high $27.72 (-57.79%); 52w low $10.74 (+8.94%) |
| Trend | -32.45% vs SMA200, -12.32% vs SMA50, -16.29% vs SMA20 |
| Momentum | RSI(14) 33.6 (neutral) |
| Volatility | ATR(14) 0.80 (~6.8% of price); beta 1.63 |
| Setup perspective | -57.79% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 24.12, P/S 29.29, P/B 3.69 | EV/Sales 25.91, EV/EBITDA -38.24 |
...
- **Valuation risk:** Forward P/E 24.12, EV/Sales 25.91. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.63, ATR 6.8% of price, short float 20.62%. Size positions accordingly.
...
|---|---|---|---|
| Price | $11.70 | EV/Sales | 25.91 |
| Market cap | $3.10B | EV/EBITDA | -38.24 |
| Beta | 1.63 | Gross margin | 40.85% |
| RSI(14) | 33.6 | Operating margin | -79.03% |
| ATR(14) | 0.80 | Profit margin | -77.30% |
| SMA20 dist | -16.29% | ROA | -4.65% |
| SMA50 dist | -12.32% | ROE | -11.45% |
| SMA200 dist | -32.45% | Revenue (ttm) | $105.76M |
| 52W high | $27.72 | Revenue growth y/y | 496.10% |
| 52W low | $10.74 | Inst. ownership | 74.54% |
| P/E (ttm) | — | Insider ownership | 1.16% |
| Forward P/E | 24.12 | Short float | 20.62% |
| PEG (trailing) | — | Avg volume | 7,319,917 |
| P/S | 29.29 | Employees | 1,069 |
| P/B | 3.69 | Analyst rec (1=buy..5=sell) | 1.1 |

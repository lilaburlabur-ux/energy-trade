...
Signed file: `KMI.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $31.54 (2026-08-28, ~15-min delayed) |
| Market cap | $70.23B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +23.25%; price +3.61% vs SMA200. |
| Fresh setup quality | Moderate / wait | -7.21% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 19.30%, revenue growth 10.80%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.51, EV/Sales 5.78. |
| Risk level | Moderate | Beta 0.55, ATR 2.6% of price, short float 2.37%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $31.54; 52w high $33.99 (-7.21%); 52w low $24.86 (+26.87%) |
| Trend | +3.61% vs SMA200, -0.90% vs SMA50, -0.31% vs SMA20 |
| Momentum | RSI(14) 48.5 (neutral) |
| Volatility | ATR(14) 0.81 (~2.6% of price); beta 0.55 |
| Setup perspective | -7.21% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.35, forward P/E 20.51, P/S 3.91, P/B 2.22 | EV/Sales 5.78, EV/EBITDA 13.60 |
...
- **Valuation risk:** Forward P/E 20.51, EV/Sales 5.78. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $31.54 | EV/Sales | 5.78 |
| Market cap | $70.23B | EV/EBITDA | 13.60 |
| Beta | 0.55 | Gross margin | 49.41% |
| RSI(14) | 48.5 | Operating margin | 30.06% |
| ATR(14) | 0.81 | Profit margin | 19.30% |
| SMA20 dist | -0.31% | ROA | 4.45% |
| SMA50 dist | -0.90% | ROE | 10.99% |
| SMA200 dist | +3.61% | Revenue (ttm) | $17.96B |
| 52W high | $33.99 | Revenue growth y/y | 10.80% |
| 52W low | $24.86 | Inst. ownership | 70.92% |
| P/E (ttm) | 20.35 | Insider ownership | 12.70% |
| Forward P/E | 20.51 | Short float | 2.37% |
| PEG (trailing) | 3.48 | Avg volume | 10,262,168 |

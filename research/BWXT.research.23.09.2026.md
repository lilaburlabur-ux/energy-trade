...
Signed file: `BWXT.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $141.81 (2026-09-23, ~15-min delayed) |
| Market cap | $12.99B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $141.81; 52w high $237.73 (-40.35%); 52w low $141.81 (+0.00%) |
| Trend | -25.68% vs SMA200, -12.59% vs SMA50, -6.79% vs SMA20 |
| Momentum | RSI(14) 32.7 (neutral) |
| Volatility | ATR(14) 5.19 (~3.7% of price); beta 0.74 |
...
| SMA20 dist | -6.79% | ROA | 5.53% |
| SMA50 dist | -12.59% | ROE | 28.29% |
| SMA200 dist | -25.68% | Revenue (ttm) | $3.51B |
| 52W high | $237.73 | Revenue growth y/y | 18.00% |
| 52W low | $141.81 | Inst. ownership | 94.33% |
| P/E (ttm) | 36.74 | Insider ownership | 0.35% |
| Forward P/E | 26.92 | Short float | 4.10% |
| PEG (trailing) | — | Avg volume | 1,023,301 |
| P/S | 3.70 | Employees | 11,000 |
| P/B | 9.74 | Analyst rec (1=buy..5=sell) | 1.6 |

# FLNC Research Report
**Fluence Energy, Inc.** — Technical + Fundamental Analysis, Data Snapshot, Institutional Investors
Signed file: `FLNC.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $11.24 (2026-08-25, ~15-min delayed) |
| Market cap | $2.09B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-38.90%) with negative half-year (-31.84%). |
| Fresh setup quality | Poor / broken | -65.13% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 66.46, EV/Sales 0.64. |
| Risk level | High | Beta 2.78, ATR 9.8% of price, short float 29.29%. |
...
|---|---|---|
| Why Fluence Energy (FLNC) Stock Is Up Today | StockStory | 2026-08-25 |
| Fluence Energy Shares Surge After UBS Upgrades Stock to Neutral | InvestorsHub | 2026-08-25 |
| 1 High-Flying Stock to Own for Decades and 2 Facing Challenges | StockStory | 2026-08-25 |
| Fluence Energy, Plug Power, Shoals, EVgo, and SolarEdge Stocks Trade Down, What You Need To Know | StockStory | 2026-08-21 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.24; 52w high $32.23 (-65.13%); 52w low $6.75 (+66.52%) |
| Trend | -38.90% vs SMA200, -28.62% vs SMA50, -12.45% vs SMA20 |
| Momentum | RSI(14) 35.8 (neutral) |
| Volatility | ATR(14) 1.10 (~9.8% of price); beta 2.78 |
| Setup perspective | -65.13% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 66.46, P/S 0.79, P/B 4.31 | EV/Sales 0.64, EV/EBITDA -21.63 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $16.17 (18 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 85.32% |
...
- **Valuation risk:** Forward P/E 66.46, EV/Sales 0.64. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.78, ATR 9.8% of price, short float 29.29%. Size positions accordingly.
- **Short interest risk:** short float 29.29% can fuel squeezes both ways around news.
...
|---|---|---|---|
| Price | $11.24 | EV/Sales | 0.64 |
| Market cap | $2.09B | EV/EBITDA | -21.63 |
| Beta | 2.78 | Gross margin | 9.36% |
| RSI(14) | 35.8 | Operating margin | -8.85% |
| ATR(14) | 1.10 | Profit margin | -3.07% |
| SMA20 dist | -12.45% | ROA | -2.95% |
| SMA50 dist | -28.62% | ROE | -23.54% |
| SMA200 dist | -38.90% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.75 | Inst. ownership | 85.32% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 66.46 | Short float | 29.29% |
| PEG (trailing) | — | Avg volume | 9,868,598 |
| P/S | 0.79 | Employees | 1,670 |
| P/B | 4.31 | Analyst rec (1=buy..5=sell) | 2.7 |

## 8. Analyst Actions
| Date | Action | Firm | Rating change |
|---|---|---|---|
| 2026-08-25 | up | UBS | Sell → Neutral |
| 2026-08-20 | down | GLJ Research | Buy → Hold |
...
| 2026-05-13 | main | Citigroup | Neutral → Neutral |
...
| Source | URL | Used for |
|---|---|---|
| Yahoo Finance quote/profile/statistics for FLNC | https://finance.yahoo.com/quote/FLNC | Snapshot metrics, ownership, analyst data |
| Yahoo Finance price history (via yfinance) | https://finance.yahoo.com/quote/FLNC/history | SMA/RSI/ATR/performance calculations |
| Yahoo Finance news feed | https://finance.yahoo.com/quote/FLNC/news | Catalyst headlines |

...
Signed file: `BEP.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $34.41 (2026-08-12, ~15-min delayed) |
| Market cap | $16.77B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +42.34%; price +10.15% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E -22.46, EV/Sales 13.37. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $34.41; 52w high $37.09 (-7.23%); 52w low $23.77 (+44.74%) |
| Trend | +10.15% vs SMA200, +1.57% vs SMA50, +5.21% vs SMA20 |
| Momentum | RSI(14) 59.8 (neutral) |
| Volatility | ATR(14) 1.07 (~3.1% of price); beta 0.99 |
...
| Valuation | P/E —, forward P/E -22.46, P/S 2.64, P/B 2.76 | EV/Sales 13.37, EV/EBITDA 28.35 |
...
|---|---|---|---|
| Price | $34.41 | EV/Sales | 13.37 |
| Market cap | $16.77B | EV/EBITDA | 28.35 |
| Beta | 0.99 | Gross margin | 51.39% |
| RSI(14) | 59.8 | Operating margin | 17.08% |
| ATR(14) | 1.07 | Profit margin | -1.26% |
| SMA20 dist | +5.21% | ROA | 0.42% |
| SMA50 dist | +1.57% | ROE | 0.40% |
| SMA200 dist | +10.15% | Revenue (ttm) | $6.36B |
| 52W high | $37.09 | Revenue growth y/y | 1.10% |
| 52W low | $23.77 | Inst. ownership | 65.09% |
| P/E (ttm) | — | Insider ownership | 0.02% |
| Forward P/E | -22.46 | Short float | 0.51% |
| PEG (trailing) | — | Avg volume | 914,311 |

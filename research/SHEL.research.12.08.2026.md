...
Signed file: `SHEL.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $90.07 (2026-08-12, ~15-min delayed) |
| Market cap | $248.78B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +30.98%; price +11.41% vs SMA200. |
| Fresh setup quality | Watch | -3.47% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 8.76%, revenue growth 44.70%. |
| Value attractiveness | Reasonable | Forward P/E 10.21, EV/Sales 0.99. |
...
| Shell (LSE:SHEL) Cuts Ormen Lange Output 40% After Failure Extends Outage To 2027 | Simply Wall St. | 2026-08-12 |
| Vinson & Elkins Makes Major London Push With Energy M&A Heavyweight Michael Burns | CorpGov.com | 2026-08-11 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $90.07; 52w high $93.30 (-3.47%); 52w low $68.85 (+30.82%) |
| Trend | +11.41% vs SMA200, +6.50% vs SMA50, +1.74% vs SMA20 |
| Momentum | RSI(14) 59.1 (neutral) |
| Volatility | ATR(14) 1.63 (~1.8% of price); beta -0.22 |
| Setup perspective | -3.47% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 9.96, forward P/E 10.21, P/S 0.84, P/B 1.46 | EV/Sales 0.99, EV/EBITDA 5.12 |
...
|---|---|---|---|
| Price | $90.07 | EV/Sales | 0.99 |
| Market cap | $248.78B | EV/EBITDA | 5.12 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 59.1 | Operating margin | 16.69% |
| ATR(14) | 1.63 | Profit margin | 8.76% |
| SMA20 dist | +1.74% | ROA | 6.40% |
| SMA50 dist | +6.50% | ROE | 14.34% |
| SMA200 dist | +11.41% | Revenue (ttm) | $296.60B |
| 52W high | $93.30 | Revenue growth y/y | 44.70% |
| 52W low | $68.85 | Inst. ownership | 13.83% |
| P/E (ttm) | 9.96 | Insider ownership | 0.01% |
| Forward P/E | 10.21 | Short float | 1.77% |
| PEG (trailing) | 1.34 | Avg volume | 6,731,949 |

...
Signed file: `TTE.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $87.95 (2026-08-11, ~15-min delayed) |
| Market cap | $195.15B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +49.58%; price +13.42% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 9.12, EV/Sales 1.17. |
| Risk level | Moderate | Beta 0.06, ATR 2.0% of price, short float 0.26%. |
...
| Energy Sector Rotation and Falling Oil Prices Pressure TotalEnergies SE (TTE) | Insider Monkey | 2026-08-10 |
| What Is TotalEnergies (ENXTPA:TTE) Signaling With Its Cyprus LNG Commitment? | Simply Wall St. | 2026-08-10 |
| Eni Stock Jumps 12.7% in a Month: Will the Rally Continue? | Zacks | 2026-08-06 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $87.95; 52w high $93.60 (-6.04%); 52w low $55.92 (+57.27%) |
| Trend | +13.42% vs SMA200, +5.45% vs SMA50, +3.60% vs SMA20 |
| Momentum | RSI(14) 61.1 (neutral) |
| Volatility | ATR(14) 1.74 (~2.0% of price); beta 0.06 |
...
| Valuation | P/E 11.01, forward P/E 9.12, P/S 0.99, P/B 1.52 | EV/Sales 1.17, EV/EBITDA 5.79 |
| Growth expectations | Earnings growth 106.00%, EPS q/q 102.40% | Analyst mean target $95.00 (10 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 57.08% |
...
|---|---|---|---|
| Price | $87.95 | EV/Sales | 1.17 |
| Market cap | $195.15B | EV/EBITDA | 5.79 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 61.1 | Operating margin | 12.79% |
| ATR(14) | 1.74 | Profit margin | 9.08% |
| SMA20 dist | +3.60% | ROA | 5.51% |
| SMA50 dist | +5.45% | ROE | 14.48% |
| SMA200 dist | +13.42% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 57.08% |
| P/E (ttm) | 11.01 | Insider ownership | 8.86% |
| Forward P/E | 9.12 | Short float | 0.26% |
| PEG (trailing) | 0.72 | Avg volume | 1,537,241 |
| P/S | 0.99 | Employees | 94,847 |
| P/B | 1.52 | Analyst rec (1=buy..5=sell) | — |

...
Signed file: `HAL.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $33.80 (2026-08-25, ~15-min delayed) |
| Market cap | $28.16B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-1.34%) with negative half-year (-4.70%). |
...
| Value attractiveness | Reasonable | Forward P/E 11.62, EV/Sales 1.57. |
| Risk level | Moderate | Beta 0.75, ATR 2.9% of price, short float 5.76%. |
...
|---|---|---|
| Why Is Baker Hughes (BKR) Up 2.3% Since Last Earnings Report? | Zacks | 2026-08-25 |
| Halliburton Secures bp Contract for Deepwater Appraisal Campaign in Brazil | InvestorsHub | 2026-08-25 |
| Sector Update: Energy Stocks Fall Premarket Tuesday | MT Newswires | 2026-08-25 |
| Halliburton Expands Presence in Brazil With New Petrobras CCS Deal | Zacks | 2026-08-24 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $33.80; 52w high $42.80 (-21.02%); 52w low $21.26 (+58.99%) |
| Trend | -1.34% vs SMA200, -0.48% vs SMA50, +1.29% vs SMA20 |
| Momentum | RSI(14) 48.7 (neutral) |
| Volatility | ATR(14) 0.97 (~2.9% of price); beta 0.75 |
...
| Valuation | P/E 17.70, forward P/E 11.62, P/S 1.26, P/B 2.56 | EV/Sales 1.57, EV/EBITDA 8.47 |
...
|---|---|---|---|
| Price | $33.80 | EV/Sales | 1.57 |
| Market cap | $28.16B | EV/EBITDA | 8.47 |
| Beta | 0.75 | Gross margin | 15.08% |
| RSI(14) | 48.7 | Operating margin | 12.79% |
| ATR(14) | 0.97 | Profit margin | 7.16% |
| SMA20 dist | +1.29% | ROA | 7.26% |
| SMA50 dist | -0.48% | ROE | 14.92% |
| SMA200 dist | -1.34% | Revenue (ttm) | $22.37B |
| 52W high | $42.80 | Revenue growth y/y | 3.70% |
| 52W low | $21.26 | Inst. ownership | 90.42% |
| P/E (ttm) | 17.70 | Insider ownership | 0.40% |
| Forward P/E | 11.62 | Short float | 5.76% |
| PEG (trailing) | 0.85 | Avg volume | 11,953,560 |

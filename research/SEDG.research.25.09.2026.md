...
Signed file: `SEDG.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $32.68 (2026-09-25, ~15-min delayed) |
| Market cap | $2.01B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-22.48%) with negative half-year (-34.99%). |
| Fresh setup quality | Poor / broken | -58.37% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-20.29%). |
| Value attractiveness | Low (expensive) | Forward P/E 37.99, EV/Sales 1.37. |
| Risk level | High | Beta 1.44, ATR 7.9% of price, short float 21.99%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $32.68; 52w high $78.51 (-58.37%); 52w low $28.47 (+14.79%) |
| Trend | -22.48% vs SMA200, -10.01% vs SMA50, -4.82% vs SMA20 |
| Momentum | RSI(14) 43.5 (neutral) |
| Volatility | ATR(14) 2.60 (~7.9% of price); beta 1.44 |
| Setup perspective | -58.37% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 37.99, P/S 1.51, P/B 4.88 | EV/Sales 1.37, EV/EBITDA -15.06 |
...
- **Valuation risk:** Forward P/E 37.99, EV/Sales 1.37. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.44, ATR 7.9% of price, short float 21.99%. Size positions accordingly.
...
|---|---|---|---|
| Price | $32.68 | EV/Sales | 1.37 |
| Market cap | $2.01B | EV/EBITDA | -15.06 |
| Beta | 1.44 | Gross margin | 21.25% |
| RSI(14) | 43.5 | Operating margin | -6.51% |
| ATR(14) | 2.60 | Profit margin | -20.29% |
| SMA20 dist | -4.82% | ROA | -3.84% |
| SMA50 dist | -10.01% | ROE | -58.42% |
| SMA200 dist | -22.48% | Revenue (ttm) | $1.33B |
| 52W high | $78.51 | Revenue growth y/y | 19.60% |
| 52W low | $28.47 | Inst. ownership | 101.70% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 37.99 | Short float | 21.99% |
| PEG (trailing) | — | Avg volume | 3,114,809 |
| P/S | 1.51 | Employees | 3,576 |
| P/B | 4.88 | Analyst rec (1=buy..5=sell) | 3.0 |

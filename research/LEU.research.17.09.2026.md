...
Signed file: `LEU.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $149.85 (2026-09-17, ~15-min delayed) |
| Market cap | $3.06B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-27.57%) with negative half-year (-28.12%). |
| Fresh setup quality | Poor / broken | -65.63% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.23%, revenue growth 14.00%. |
| Value attractiveness | Low (expensive) | Forward P/E 39.86, EV/Sales 4.39. |
| Risk level | High | Beta 1.33, ATR 7.7% of price, short float 28.54%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $149.85; 52w high $436.00 (-65.63%); 52w low $139.01 (+7.80%) |
| Trend | -27.57% vs SMA200, -13.33% vs SMA50, -12.09% vs SMA20 |
| Momentum | RSI(14) 40.5 (neutral) |
| Volatility | ATR(14) 11.51 (~7.7% of price); beta 1.33 |
| Setup perspective | -65.63% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 79.29, forward P/E 39.86, P/S 6.47, P/B 3.54 | EV/Sales 4.39, EV/EBITDA 206.20 |
...
- **Valuation risk:** Forward P/E 39.86, EV/Sales 4.39. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.33, ATR 7.7% of price, short float 28.54%. Size positions accordingly.
...
|---|---|---|---|
| Price | $149.85 | EV/Sales | 4.39 |
| Market cap | $3.06B | EV/EBITDA | 206.20 |
| Beta | 1.33 | Gross margin | 23.66% |
| RSI(14) | 40.5 | Operating margin | 5.34% |
| ATR(14) | 11.51 | Profit margin | 10.23% |
| SMA20 dist | -12.09% | ROA | 0.02% |
| SMA50 dist | -13.33% | ROE | 8.05% |
| SMA200 dist | -27.57% | Revenue (ttm) | $473.90M |
| 52W high | $436.00 | Revenue growth y/y | 14.00% |
| 52W low | $139.01 | Inst. ownership | 88.70% |
| P/E (ttm) | 79.29 | Insider ownership | 4.20% |
| Forward P/E | 39.86 | Short float | 28.54% |
| PEG (trailing) | — | Avg volume | 761,751 |
| P/S | 6.47 | Employees | 467 |
| P/B | 3.54 | Analyst rec (1=buy..5=sell) | 1.8 |

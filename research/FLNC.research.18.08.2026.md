...
Signed file: `FLNC.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $11.75 (2026-08-18, ~15-min delayed) |
| Market cap | $2.67B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-36.91%) with negative half-year (-33.91%). |
| Fresh setup quality | Poor / broken | -63.54% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 50.38, EV/Sales 0.74. |
| Risk level | High | Beta 2.78, ATR 10.8% of price, short float 29.29%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.75; 52w high $32.23 (-63.54%); 52w low $6.75 (+74.07%) |
| Trend | -36.91% vs SMA200, -30.69% vs SMA50, -12.48% vs SMA20 |
| Momentum | RSI(14) 35.4 (neutral) |
| Volatility | ATR(14) 1.27 (~10.8% of price); beta 2.78 |
| Setup perspective | -63.54% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 50.38, P/S 1.01, P/B 4.51 | EV/Sales 0.74, EV/EBITDA -24.88 |
...
- **Valuation risk:** Forward P/E 50.38, EV/Sales 0.74. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.78, ATR 10.8% of price, short float 29.29%. Size positions accordingly.
...
|---|---|---|---|
| Price | $11.75 | EV/Sales | 0.74 |
| Market cap | $2.67B | EV/EBITDA | -24.88 |
| Beta | 2.78 | Gross margin | 9.36% |
| RSI(14) | 35.4 | Operating margin | -8.85% |
| ATR(14) | 1.27 | Profit margin | -3.07% |
| SMA20 dist | -12.48% | ROA | -2.95% |
| SMA50 dist | -30.69% | ROE | -23.54% |
| SMA200 dist | -36.91% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.75 | Inst. ownership | 85.24% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 50.38 | Short float | 29.29% |
| PEG (trailing) | — | Avg volume | 10,062,456 |
| P/S | 1.01 | Employees | 1,670 |
| P/B | 4.51 | Analyst rec (1=buy..5=sell) | 2.7 |

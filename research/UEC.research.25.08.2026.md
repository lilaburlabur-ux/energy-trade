...
Signed file: `UEC.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $13.27 (2026-08-25, ~15-min delayed) |
| Market cap | $6.51B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +26.02%; price +0.08% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E -147.44, EV/Sales 282.41. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $13.27; 52w high $20.14 (-34.11%); 52w low $9.04 (+46.79%) |
| Trend | +0.08% vs SMA200, +24.23% vs SMA50, +19.74% vs SMA20 |
| Momentum | RSI(14) 69.6 (neutral) |
| Volatility | ATR(14) 0.68 (~5.1% of price); beta 1.21 |
...
| Valuation | P/E —, forward P/E -147.44, P/S 322.04, P/B 4.61 | EV/Sales 282.41, EV/EBITDA -47.24 |
...
|---|---|---|---|
| Price | $13.27 | EV/Sales | 282.41 |
| Market cap | $6.51B | EV/EBITDA | -47.24 |
| Beta | 1.21 | Gross margin | 0.00% |
| RSI(14) | 69.6 | Operating margin | -629.66% |
| ATR(14) | 0.68 | Profit margin | 0.00% |
| SMA20 dist | +19.74% | ROA | -6.25% |
| SMA50 dist | +24.23% | ROE | -8.96% |
| SMA200 dist | +0.08% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 88.44% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -147.44 | Short float | 14.38% |
| PEG (trailing) | — | Avg volume | 9,555,985 |
| P/S | 322.04 | Employees | 171 |
| P/B | 4.61 | Analyst rec (1=buy..5=sell) | — |

...
Signed file: `BWXT.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $168.28 (2026-08-05, ~15-min delayed) |
| Market cap | $15.42B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-14.40%) with negative half-year (-19.98%). |
| Fresh setup quality | Poor / broken | -29.32% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.11%, revenue growth 18.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 32.08, EV/Sales 6.78. |
| Risk level | Elevated | Beta —, ATR 4.5% of price, short float 4.13%. |
...
| BWX Technologies (BWXT) Sells Medical Business And Signs New Thorium Fuel Deal | Simply Wall St. | 2026-08-04 |
| BWX Technologies, Inc. Q2 2026 Earnings Call Summary | Moby | 2026-08-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $168.28; 52w high $238.10 (-29.32%); 52w low $157.44 (+6.89%) |
| Trend | -14.40% vs SMA200, -9.69% vs SMA50, -3.10% vs SMA20 |
| Momentum | RSI(14) 41.5 (neutral) |
| Volatility | ATR(14) 7.55 (~4.5% of price); beta — |
| Setup perspective | -29.32% from 52w high — base needs to rebuild. |
...
| Profitability | Gross 22.08%, operating 9.95%, net 10.11% | ROA 5.47%, ROE 28.29% |
| Balance sheet | Cash $608.20M, debt $2.02B | Current ratio 2.40, debt/equity 151.40 |
| Valuation | P/E 44.87, forward P/E 32.08, P/S 4.39, P/B 16.27 | EV/Sales 6.78, EV/EBITDA 50.47 |
| Growth expectations | Earnings growth 14.10%, EPS q/q 13.60% | Analyst mean target $238.16 (14 analysts) |
...
|---|---|---|---|
| Blackrock Inc. | 12,487,506 | 13.63% | 2026-03-31 |
| Vanguard Portfolio Management LLC | 4,891,237 | 5.34% | 2026-03-31 |
| Vanguard Capital Management LLC | 4,094,093 | 4.47% | 2026-03-31 |
| State Street Corporation | 3,748,950 | 4.09% | 2026-03-31 |
| JPMORGAN CHASE & CO | 2,572,811 | 2.81% | 2026-03-31 |
| Invesco Ltd. | 2,522,532 | 2.75% | 2026-03-31 |
| Franklin Resources, Inc. | 1,901,316 | 2.08% | 2026-03-31 |
| Geode Capital Management, LLC | 1,793,566 | 1.96% | 2026-03-31 |
| Alkeon Capital Management LLC | 1,739,348 | 1.90% | 2026-03-31 |
| Van Eck Associates Corporation | 1,584,460 | 1.73% | 2026-03-31 |

## 6. Risk Review and Setup Plan
- **Valuation risk:** Forward P/E 32.08, EV/Sales 6.78. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta —, ATR 4.5% of price, short float 4.13%. Size positions accordingly.
...
|---|---|---|---|
| Price | $168.28 | EV/Sales | 6.78 |
| Market cap | $15.42B | EV/EBITDA | 50.47 |
| Beta | — | Gross margin | 22.08% |
| RSI(14) | 41.5 | Operating margin | 9.95% |
| ATR(14) | 7.55 | Profit margin | 10.11% |
| SMA20 dist | -3.10% | ROA | 5.47% |
| SMA50 dist | -9.69% | ROE | 28.29% |
| SMA200 dist | -14.40% | Revenue (ttm) | $3.51B |
| 52W high | $238.10 | Revenue growth y/y | 18.00% |
| 52W low | $157.44 | Inst. ownership | 95.22% |
| P/E (ttm) | 44.87 | Insider ownership | 0.36% |
| Forward P/E | 32.08 | Short float | 4.13% |
| PEG (trailing) | — | Avg volume | 988,678 |
| P/S | 4.39 | Employees | 10,400 |
| P/B | 16.27 | Analyst rec (1=buy..5=sell) | 1.8 |
...
| 2026-04-01 | init | Wells Fargo | — → Underweight |
| 2026-03-25 | main | B of A Securities | Buy → Buy |
| 2026-03-12 | init | TD Securities | — → Buy |
...
| Source | URL | Used for |
|---|---|---|
| Yahoo Finance quote/profile/statistics for BWXT | https://finance.yahoo.com/quote/BWXT | Snapshot metrics, ownership, analyst data |
| Yahoo Finance price history (via yfinance) | https://finance.yahoo.com/quote/BWXT/history | SMA/RSI/ATR/performance calculations |
| Yahoo Finance news feed | https://finance.yahoo.com/quote/BWXT/news | Catalyst headlines |

...
Signed file: `OKE.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $96.97 (2026-09-14, ~15-min delayed) |
| Market cap | $61.13B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +39.47%; price +15.41% vs SMA200. |
| Fresh setup quality | Watch | -0.55% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 9.29%, revenue growth 52.80%. |
| Value attractiveness | Reasonable | Forward P/E 15.60, EV/Sales 2.39. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $96.97; 52w high $97.51 (-0.55%); 52w low $61.95 (+56.53%) |
| Trend | +15.41% vs SMA200, +5.24% vs SMA50, +1.70% vs SMA20 |
| Momentum | RSI(14) 60.6 (neutral) |
| Volatility | ATR(14) 2.47 (~2.5% of price); beta 0.72 |
| Setup perspective | -0.55% from 52w high and near SMA20 — check for a tight base. |
...
| Market cap | $61.13B | EV/EBITDA | 12.24 |
| Beta | 0.72 | Gross margin | 27.21% |
| RSI(14) | 60.6 | Operating margin | 13.25% |
| ATR(14) | 2.47 | Profit margin | 9.29% |
| SMA20 dist | +1.70% | ROA | 5.77% |
| SMA50 dist | +5.24% | ROE | 16.28% |
| SMA200 dist | +15.41% | Revenue (ttm) | $39.37B |
| 52W high | $97.51 | Revenue growth y/y | 52.80% |
| 52W low | $61.95 | Inst. ownership | — |
| P/E (ttm) | 16.75 | Insider ownership | — |
| Forward P/E | 15.60 | Short float | 4.65% |
| PEG (trailing) | 1.80 | Avg volume | 3,704,322 |

...
Signed file: `NXE.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $10.86 (2026-08-21, ~15-min delayed) |
| Market cap | $7.28B |
...
|---|---|---|
| Technical momentum | High | 1Y +68.11%; price +1.44% vs SMA200. |
| Fresh setup quality | Moderate / wait | -21.98% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -61.46, EV/Sales —. |
| Risk level | Elevated | Beta 1.65, ATR 4.7% of price, short float —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.86; 52w high $13.92 (-21.98%); 52w low $6.59 (+64.80%) |
| Trend | +1.44% vs SMA200, +10.96% vs SMA50, +8.18% vs SMA20 |
| Momentum | RSI(14) 60.9 (neutral) |
| Volatility | ATR(14) 0.51 (~4.7% of price); beta 1.65 |
| Setup perspective | -21.98% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E -61.46, P/S —, P/B 5.95 | EV/Sales —, EV/EBITDA -59.92 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $19.53 (1 analysts) |
...
- **Volatility risk:** Beta 1.65, ATR 4.7% of price, short float —. Size positions accordingly.
...
|---|---|---|---|
| Price | $10.86 | EV/Sales | — |
| Market cap | $7.28B | EV/EBITDA | -59.92 |
| Beta | 1.65 | Gross margin | 0.00% |
| RSI(14) | 60.9 | Operating margin | 0.00% |
| ATR(14) | 0.51 | Profit margin | 0.00% |
| SMA20 dist | +8.18% | ROA | -3.39% |
| SMA50 dist | +10.96% | ROE | -17.67% |
| SMA200 dist | +1.44% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $6.59 | Inst. ownership | 55.21% |
| P/E (ttm) | — | Insider ownership | 6.39% |
| Forward P/E | -61.46 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,600,311 |
| P/S | — | Employees | 142 |
| P/B | 5.95 | Analyst rec (1=buy..5=sell) | 1.5 |

## 8. Analyst Actions
_No recent analyst actions available from Yahoo._

## 9. Conclusion
NXE: High momentum / mixed fundamentals / reasonable value / elevated risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

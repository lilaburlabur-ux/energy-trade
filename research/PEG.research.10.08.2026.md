...
Signed file: `PEG.research.10.08.2026`

| Field | Value |
|---|---|
| Current price | $74.56 (2026-08-10, ~15-min delayed) |
| Market cap | $37.16B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-6.49%) with negative half-year (-6.00%). |
| Fresh setup quality | Moderate / wait | -12.81% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 16.04%, revenue growth -8.90%. |
| Value attractiveness | Reasonable | Forward P/E 15.95, EV/Sales 4.96. |
...
| Public Service Enterprise Group Q2 Earnings Call Highlights | MarketBeat | 2026-08-05 |
| PSEG offers large load supply proposals in PJM’s bilateral contracting process | Utility Dive | 2026-08-05 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $74.56; 52w high $85.51 (-12.81%); 52w low $74.56 (+0.00%) |
| Trend | -6.49% vs SMA200, -5.76% vs SMA50, -4.21% vs SMA20 |
| Momentum | RSI(14) 30.6 (neutral) |
| Volatility | ATR(14) 1.58 (~2.1% of price); beta 0.53 |
| Setup perspective | -12.81% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.55, forward P/E 15.95, P/S 2.96, P/B 2.14 | EV/Sales 4.96, EV/EBITDA 13.94 |
...
|---|---|---|---|
| Price | $74.56 | EV/Sales | 4.96 |
| Market cap | $37.16B | EV/EBITDA | 13.94 |
| Beta | 0.53 | Gross margin | 33.33% |
| RSI(14) | 30.6 | Operating margin | 18.87% |
| ATR(14) | 1.58 | Profit margin | 16.04% |
| SMA20 dist | -4.21% | ROA | 3.24% |
| SMA50 dist | -5.76% | ROE | 11.83% |
| SMA200 dist | -6.49% | Revenue (ttm) | $12.54B |
| 52W high | $85.51 | Revenue growth y/y | -8.90% |
| 52W low | $74.56 | Inst. ownership | 78.81% |
| P/E (ttm) | 18.55 | Insider ownership | 0.13% |
| Forward P/E | 15.95 | Short float | 2.56% |
| PEG (trailing) | 3.76 | Avg volume | 3,084,766 |

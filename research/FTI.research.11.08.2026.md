...
Signed file: `FTI.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $75.32 (2026-08-11, ~15-min delayed) |
| Market cap | $29.54B |
...
|---|---|---|
| Technical momentum | High | 1Y +116.39%; price +23.16% vs SMA200. |
| Fresh setup quality | Moderate / wait | -2.10% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 11.28%, revenue growth 9.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 21.06, EV/Sales 2.81. |
| Risk level | Elevated | Beta 0.74, ATR 3.4% of price, short float 4.36%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $75.32; 52w high $76.94 (-2.10%); 52w low $34.67 (+117.26%) |
| Trend | +23.16% vs SMA200, +7.78% vs SMA50, +4.05% vs SMA20 |
| Momentum | RSI(14) 60.3 (neutral) |
| Volatility | ATR(14) 2.56 (~3.4% of price); beta 0.74 |
| Setup perspective | -2.10% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.34, forward P/E 21.06, P/S 2.83, P/B 9.04 | EV/Sales 2.81, EV/EBITDA 14.78 |
...
| Capital World Investors | 14,345,956 | 3.66% | 2026-03-31 |

## 6. Risk Review and Setup Plan
- **Valuation risk:** Forward P/E 21.06, EV/Sales 2.81. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.74, ATR 3.4% of price, short float 4.36%. Size positions accordingly.
...
|---|---|---|---|
| Price | $75.32 | EV/Sales | 2.81 |
| Market cap | $29.54B | EV/EBITDA | 14.78 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 60.3 | Operating margin | 17.69% |
| ATR(14) | 2.56 | Profit margin | 11.28% |
| SMA20 dist | +4.05% | ROA | 9.53% |
| SMA50 dist | +7.78% | ROE | 35.81% |
| SMA200 dist | +23.16% | Revenue (ttm) | $10.42B |
| 52W high | $76.94 | Revenue growth y/y | 9.00% |
| 52W low | $34.67 | Inst. ownership | 106.67% |
| P/E (ttm) | 26.34 | Insider ownership | 1.71% |
| Forward P/E | 21.06 | Short float | 4.36% |
| PEG (trailing) | — | Avg volume | 4,751,716 |
| P/S | 2.83 | Employees | 22,000 |
| P/B | 9.04 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `DUK.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $117.76 (2026-09-16, ~15-min delayed) |
| Market cap | $91.82B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-3.73%) with negative half-year (-9.87%). |
| Fresh setup quality | Moderate / wait | -10.22% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 16.00%, revenue growth 1.10%. |
| Value attractiveness | Reasonable | Forward P/E 16.42, EV/Sales 5.68. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $117.76; 52w high $131.16 (-10.22%); 52w low $111.09 (+6.00%) |
| Trend | -3.73% vs SMA200, -4.25% vs SMA50, -2.28% vs SMA20 |
| Momentum | RSI(14) 34.8 (neutral) |
| Volatility | ATR(14) 1.79 (~1.5% of price); beta 0.36 |
| Setup perspective | -10.22% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 17.73, forward P/E 16.42, P/S 2.80, P/B 1.71 | EV/Sales 5.68, EV/EBITDA 11.22 |
...
|---|---|---|---|
| Price | $117.76 | EV/Sales | 5.68 |
| Market cap | $91.82B | EV/EBITDA | 11.22 |
| Beta | 0.36 | Gross margin | 51.97% |
| RSI(14) | 34.8 | Operating margin | 27.50% |
| ATR(14) | 1.79 | Profit margin | 16.00% |
| SMA20 dist | -2.28% | ROA | 2.84% |
| SMA50 dist | -4.25% | ROE | 9.86% |
| SMA200 dist | -3.73% | Revenue (ttm) | $32.80B |
| 52W high | $131.16 | Revenue growth y/y | 1.10% |
| 52W low | $111.09 | Inst. ownership | 71.14% |
| P/E (ttm) | 17.73 | Insider ownership | 0.13% |
| Forward P/E | 16.42 | Short float | 2.44% |
| PEG (trailing) | 2.19 | Avg volume | 4,069,983 |
| P/S | 2.80 | Employees | 26,441 |
| P/B | 1.71 | Analyst rec (1=buy..5=sell) | — |

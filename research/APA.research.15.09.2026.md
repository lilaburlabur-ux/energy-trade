...
Signed file: `APA.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $47.41 (2026-09-15, ~15-min delayed) |
| Market cap | $16.61B |
...
|---|---|---|
| Technical momentum | High | 1Y +114.81%; price +39.95% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.80, EV/Sales 2.35. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $47.41; 52w high $47.41 (+0.00%); 52w low $21.16 (+124.01%) |
| Trend | +39.95% vs SMA200, +20.71% vs SMA50, +8.59% vs SMA20 |
| Momentum | RSI(14) 71.6 (overbought) |
| Volatility | ATR(14) 1.54 (~3.3% of price); beta 0.37 |
...
| Valuation | P/E 10.00, forward P/E 10.80, P/S 1.94, P/B 2.37 | EV/Sales 2.35, EV/EBITDA 3.52 |
...
- **Volatility risk:** Beta 0.37, ATR 3.3% of price, short float 9.10%. Size positions accordingly.
...
|---|---|---|---|
| Price | $47.41 | EV/Sales | 2.35 |
| Market cap | $16.61B | EV/EBITDA | 3.52 |
| Beta | 0.37 | Gross margin | 78.25% |
| RSI(14) | 71.6 | Operating margin | 56.33% |
| ATR(14) | 1.54 | Profit margin | 19.56% |
| SMA20 dist | +8.59% | ROA | 11.60% |
| SMA50 dist | +20.71% | ROE | 26.66% |
| SMA200 dist | +39.95% | Revenue (ttm) | $8.57B |
| 52W high | $47.41 | Revenue growth y/y | 9.20% |
| 52W low | $21.16 | Inst. ownership | 110.15% |
| P/E (ttm) | 10.00 | Insider ownership | 0.44% |
| Forward P/E | 10.80 | Short float | 9.10% |
| PEG (trailing) | 1.21 | Avg volume | 5,559,930 |
| P/S | 1.94 | Employees | 1,791 |
| P/B | 2.37 | Analyst rec (1=buy..5=sell) | 2.6 |

...
Signed file: `VLO.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $393.27 (2026-09-21, ~15-min delayed) |
| Market cap | $113.23B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $393.27; 52w high $413.28 (-4.84%); 52w low $153.14 (+156.80%) |
| Trend | +57.91% vs SMA200, +15.81% vs SMA50, +4.71% vs SMA20 |
| Momentum | RSI(14) 63.4 (neutral) |
| Volatility | ATR(14) 14.01 (~3.6% of price); beta 0.57 |
| Setup perspective | -4.84% from 52w high; no clean fresh pivot by default. |
...
- **Volatility risk:** Beta 0.57, ATR 3.6% of price, short float 3.99%. Size positions accordingly.
...
| SMA20 dist | +4.71% | ROA | 10.56% |
| SMA50 dist | +15.81% | ROE | 27.64% |
| SMA200 dist | +57.91% | Revenue (ttm) | $132.43B |

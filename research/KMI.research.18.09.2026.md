...
Signed file: `KMI.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $31.84 (2026-09-18, ~15-min delayed) |
| Market cap | $70.84B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +20.13%; price +3.27% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.33% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 19.30%, revenue growth 10.80%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.59, EV/Sales 5.75. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $31.84; 52w high $33.99 (-6.33%); 52w low $24.86 (+28.07%) |
| Trend | +3.27% vs SMA200, +0.51% vs SMA50, +1.38% vs SMA20 |
| Momentum | RSI(14) 54.0 (neutral) |
| Volatility | ATR(14) 0.77 (~2.4% of price); beta 0.55 |
| Setup perspective | -6.33% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.54, forward P/E 20.59, P/S 3.94, P/B 2.24 | EV/Sales 5.75, EV/EBITDA 13.53 |
...
- **Valuation risk:** Forward P/E 20.59, EV/Sales 5.75. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $31.84 | EV/Sales | 5.75 |
| Market cap | $70.84B | EV/EBITDA | 13.53 |
| Beta | 0.55 | Gross margin | 49.41% |
| RSI(14) | 54.0 | Operating margin | 30.06% |
| ATR(14) | 0.77 | Profit margin | 19.30% |
| SMA20 dist | +1.38% | ROA | 4.45% |
| SMA50 dist | +0.51% | ROE | 10.99% |
| SMA200 dist | +3.27% | Revenue (ttm) | $17.96B |
| 52W high | $33.99 | Revenue growth y/y | 10.80% |
| 52W low | $24.86 | Inst. ownership | 70.82% |
| P/E (ttm) | 20.54 | Insider ownership | 12.70% |
| Forward P/E | 20.59 | Short float | 2.50% |
| PEG (trailing) | 3.20 | Avg volume | 10,618,911 |
| P/S | 3.94 | Employees | 11,028 |

...
Signed file: `ARRY.research.13.08.2026`

| Field | Value |
|---|---|
| Current price | $5.17 (2026-08-13, ~15-min delayed) |
| Market cap | $795.28M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-36.48%) with negative half-year (-53.42%). |
| Fresh setup quality | Poor / broken | -56.77% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.77, EV/Sales 1.47. |
| Risk level | High | Beta 1.79, ATR 8.2% of price, short float 26.42%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $5.17; 52w high $11.96 (-56.77%); 52w low $4.81 (+7.48%) |
| Trend | -36.48% vs SMA200, -21.70% vs SMA50, -5.78% vs SMA20 |
| Momentum | RSI(14) 39.5 (neutral) |
| Volatility | ATR(14) 0.43 (~8.2% of price); beta 1.79 |
| Setup perspective | -56.77% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 5.77, P/S 0.67, P/B -3.94 | EV/Sales 1.47, EV/EBITDA 14.60 |
| Growth expectations | Earnings growth -73.20%, EPS q/q -43.70% | Analyst mean target $9.36 (20 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 146.46% |
...
- **Volatility risk:** Beta 1.79, ATR 8.2% of price, short float 26.42%. Size positions accordingly.
...
|---|---|---|---|
| Price | $5.17 | EV/Sales | 1.47 |
| Market cap | $795.28M | EV/EBITDA | 14.60 |
| Beta | 1.79 | Gross margin | 26.76% |
| RSI(14) | 39.5 | Operating margin | 10.88% |
| ATR(14) | 0.43 | Profit margin | -7.25% |
| SMA20 dist | -5.78% | ROA | 3.33% |
| SMA50 dist | -21.70% | ROE | -25.98% |
| SMA200 dist | -36.48% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.81 | Inst. ownership | 146.46% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.77 | Short float | 26.42% |
| PEG (trailing) | 0.63 | Avg volume | 6,555,848 |
| P/S | 0.67 | Employees | 1,200 |
| P/B | -3.94 | Analyst rec (1=buy..5=sell) | 2.0 |

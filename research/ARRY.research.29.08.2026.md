...
Signed file: `ARRY.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $4.59 (2026-08-29, ~15-min delayed) |
| Market cap | $706.06M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-42.11%) with negative half-year (-39.45%). |
| Fresh setup quality | Poor / broken | -61.62% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.16, EV/Sales 1.40. |
| Risk level | High | Beta 1.79, ATR 6.8% of price, short float 24.55%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.59; 52w high $11.96 (-61.62%); 52w low $4.55 (+0.88%) |
| Trend | -42.11% vs SMA200, -22.35% vs SMA50, -9.46% vs SMA20 |
| Momentum | RSI(14) 35.1 (neutral) |
| Volatility | ATR(14) 0.31 (~6.8% of price); beta 1.79 |
| Setup perspective | -61.62% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 5.16, P/S 0.60, P/B -3.50 | EV/Sales 1.40, EV/EBITDA 13.93 |
...
- **Volatility risk:** Beta 1.79, ATR 6.8% of price, short float 24.55%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.59 | EV/Sales | 1.40 |
| Market cap | $706.06M | EV/EBITDA | 13.93 |
| Beta | 1.79 | Gross margin | 26.76% |
| RSI(14) | 35.1 | Operating margin | 10.88% |
| ATR(14) | 0.31 | Profit margin | -7.25% |
| SMA20 dist | -9.46% | ROA | 3.33% |
| SMA50 dist | -22.35% | ROE | -25.98% |
| SMA200 dist | -42.11% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.55 | Inst. ownership | 148.30% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.16 | Short float | 24.55% |
| PEG (trailing) | 0.56 | Avg volume | 6,700,737 |
| P/S | 0.60 | Employees | 1,200 |
| P/B | -3.50 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `WMB.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $73.73 (2026-08-29, ~15-min delayed) |
| Market cap | $90.18B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +32.32%; price +6.58% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 28.13, EV/Sales 10.03. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $73.73; 52w high $78.82 (-6.46%); 52w low $55.10 (+33.81%) |
| Trend | +6.58% vs SMA200, +0.39% vs SMA50, +1.67% vs SMA20 |
| Momentum | RSI(14) 53.1 (neutral) |
| Volatility | ATR(14) 2.14 (~2.9% of price); beta 0.61 |
...
| Valuation | P/E 29.37, forward P/E 28.13, P/S 7.32, P/B 6.85 | EV/Sales 10.03, EV/EBITDA 17.57 |
...
- **Valuation risk:** Forward P/E 28.13, EV/Sales 10.03. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $73.73 | EV/Sales | 10.03 |
| Market cap | $90.18B | EV/EBITDA | 17.57 |
| Beta | 0.61 | Gross margin | 63.64% |
| RSI(14) | 53.1 | Operating margin | 39.54% |
| ATR(14) | 2.14 | Profit margin | 24.94% |
| SMA20 dist | +1.67% | ROA | 5.03% |
| SMA50 dist | +0.39% | ROE | 21.50% |
| SMA200 dist | +6.58% | Revenue (ttm) | $12.32B |
| 52W high | $78.82 | Revenue growth y/y | 7.80% |
| 52W low | $55.10 | Inst. ownership | 91.43% |
| P/E (ttm) | 29.37 | Insider ownership | 0.45% |
| Forward P/E | 28.13 | Short float | 2.22% |
| PEG (trailing) | 2.48 | Avg volume | 6,912,369 |
| P/S | 7.32 | Employees | 5,987 |
| P/B | 6.85 | Analyst rec (1=buy..5=sell) | 1.5 |

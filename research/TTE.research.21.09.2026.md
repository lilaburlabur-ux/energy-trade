...
Signed file: `TTE.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $90.06 (2026-09-21, ~15-min delayed) |
| Market cap | $198.95B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +53.04%; price +10.60% vs SMA200. |
| Fresh setup quality | Watch | -3.78% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 9.08%, revenue growth 27.80%. |
| Value attractiveness | Reasonable | Forward P/E 8.44, EV/Sales 1.20. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $90.06; 52w high $93.60 (-3.78%); 52w low $55.92 (+61.04%) |
| Trend | +10.60% vs SMA200, +3.07% vs SMA50, +0.23% vs SMA20 |
| Momentum | RSI(14) 52.0 (neutral) |
| Volatility | ATR(14) 1.61 (~1.8% of price); beta 0.06 |
| Setup perspective | -3.78% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 11.27, forward P/E 8.44, P/S 1.01, P/B 1.56 | EV/Sales 1.20, EV/EBITDA 5.95 |
...
|---|---|---|---|
| Price | $90.06 | EV/Sales | 1.20 |
| Market cap | $198.95B | EV/EBITDA | 5.95 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 52.0 | Operating margin | 12.79% |
| ATR(14) | 1.61 | Profit margin | 9.08% |
| SMA20 dist | +0.23% | ROA | 5.51% |
| SMA50 dist | +3.07% | ROE | 14.48% |
| SMA200 dist | +10.60% | Revenue (ttm) | $196.38B |

...
Signed file: `VST.research.07.09.2026`

| Field | Value |
|---|---|
| Current price | $149.30 (2026-09-07, ~15-min delayed) |
| Market cap | $50.11B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-5.19%) with negative half-year (-5.63%). |
| Fresh setup quality | Poor / broken | -31.20% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 11.55%, revenue growth -5.50%. |
| Value attractiveness | Reasonable | Forward P/E 14.40, EV/Sales 3.78. |
| Risk level | Elevated | Beta 1.41, ATR 3.6% of price, short float 3.32%. |
...
|---|---|---|
| Nuclear Stock Face-Off: Is Constellation Energy or Vistra the Better Buy Right Now? | Motley Fool | 2026-09-07 |
| Vistra’s CEO Bought $1.17 Million of Stock After the Selloff. Is AI Power Demand Mispriced? | Insider Monkey | 2026-09-05 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $149.30; 52w high $217.02 (-31.20%); 52w low $134.52 (+10.99%) |
| Trend | -5.19% vs SMA200, -0.23% vs SMA50, +5.23% vs SMA20 |
| Momentum | RSI(14) 57.5 (neutral) |
| Volatility | ATR(14) 5.45 (~3.6% of price); beta 1.41 |
| Setup perspective | -31.20% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 25.18, forward P/E 14.40, P/S 2.61, P/B 16.69 | EV/Sales 3.78, EV/EBITDA 10.94 |
...
- **Volatility risk:** Beta 1.41, ATR 3.6% of price, short float 3.32%. Size positions accordingly.
...
|---|---|---|---|
| Price | $149.30 | EV/Sales | 3.78 |
| Market cap | $50.11B | EV/EBITDA | 10.94 |
| Beta | 1.41 | Gross margin | 38.31% |
| RSI(14) | 57.5 | Operating margin | 13.77% |
| ATR(14) | 5.45 | Profit margin | 11.55% |
| SMA20 dist | +5.23% | ROA | 5.89% |
| SMA50 dist | -0.23% | ROE | 42.96% |
| SMA200 dist | -5.19% | Revenue (ttm) | $19.21B |
| 52W high | $217.02 | Revenue growth y/y | -5.50% |
| 52W low | $134.52 | Inst. ownership | 92.08% |
| P/E (ttm) | 25.18 | Insider ownership | 0.79% |
| Forward P/E | 14.40 | Short float | 3.32% |
| PEG (trailing) | 0.36 | Avg volume | 4,399,655 |
| P/S | 2.61 | Employees | 6,390 |
| P/B | 16.69 | Analyst rec (1=buy..5=sell) | 1.4 |

...
Signed file: `TLN.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $293.31 (2026-09-17, ~15-min delayed) |
| Market cap | $14.05B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-17.36%) with negative half-year (-13.38%). |
| Fresh setup quality | Poor / broken | -34.21% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-4.95%). |
| Value attractiveness | Reasonable | Forward P/E 9.54, EV/Sales 6.26. |
| Risk level | Elevated | Beta 1.63, ATR 4.9% of price, short float 5.69%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $293.31; 52w high $445.84 (-34.21%); 52w low $282.15 (+3.96%) |
| Trend | -17.36% vs SMA200, -12.56% vs SMA50, -3.60% vs SMA20 |
| Momentum | RSI(14) 39.9 (neutral) |
| Volatility | ATR(14) 14.32 (~4.9% of price); beta 1.63 |
| Setup perspective | -34.21% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 9.54, P/S 3.76, P/B 8.69 | EV/Sales 6.26, EV/EBITDA 40.24 |
...
- **Volatility risk:** Beta 1.63, ATR 4.9% of price, short float 5.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $293.31 | EV/Sales | 6.26 |
| Market cap | $14.05B | EV/EBITDA | 40.24 |
| Beta | 1.63 | Gross margin | 42.10% |
| RSI(14) | 39.9 | Operating margin | -4.80% |
| ATR(14) | 14.32 | Profit margin | -4.95% |
| SMA20 dist | -3.60% | ROA | 0.92% |
| SMA50 dist | -12.56% | ROE | -12.83% |
| SMA200 dist | -17.36% | Revenue (ttm) | $3.74B |
| 52W high | $445.84 | Revenue growth y/y | 111.20% |
| 52W low | $282.15 | Inst. ownership | 102.11% |
| P/E (ttm) | — | Insider ownership | 1.36% |
| Forward P/E | 9.54 | Short float | 5.69% |
| PEG (trailing) | — | Avg volume | 839,435 |

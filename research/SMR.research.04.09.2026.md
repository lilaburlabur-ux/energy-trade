...
Signed file: `SMR.research.04.09.2026`

| Field | Value |
|---|---|
| Current price | $9.70 (2026-09-04, ~15-min delayed) |
| Market cap | $3.98B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-25.46%) with negative half-year (-16.88%). |
| Fresh setup quality | Poor / broken | -81.85% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -14.88, EV/Sales 270.18. |
| Risk level | High | Beta 2.31, ATR 6.5% of price, short float 18.40%. |
...
|---|---|---|
| NuScale Just Turned AI on Itself. Here's What That Means for the Stock. | Motley Fool | 2026-09-04 |
| Down 84% From Its High, Is NuScale Power a Bargain Hiding in Plain Sight? | Motley Fool | 2026-09-04 |
| Why Is NuScale Power (SMR) Up 3% Since Last Earnings Report? | Zacks | 2026-09-04 |
| 3 Reasons Wall Street Analysts Remain Bullish on NuScale Power Stock | Motley Fool | 2026-09-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.70; 52w high $53.43 (-81.85%); 52w low $7.59 (+27.80%) |
| Trend | -25.46% vs SMA200, +6.52% vs SMA50, +3.11% vs SMA20 |
| Momentum | RSI(14) 53.9 (neutral) |
| Volatility | ATR(14) 0.63 (~6.5% of price); beta 2.31 |
| Setup perspective | -81.85% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -14.88, P/S 372.38, P/B 2.64 | EV/Sales 270.18, EV/EBITDA -12.89 |
...
- **Volatility risk:** Beta 2.31, ATR 6.5% of price, short float 18.40%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.70 | EV/Sales | 270.18 |
| Market cap | $3.98B | EV/EBITDA | -12.89 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 53.9 | Operating margin | -85337.33% |
| ATR(14) | 0.63 | Profit margin | 0.00% |
| SMA20 dist | +3.11% | ROA | -10.60% |
| SMA50 dist | +6.52% | ROE | -55.18% |
| SMA200 dist | -25.46% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.38% |
| P/E (ttm) | — | Insider ownership | 1.70% |
| Forward P/E | -14.88 | Short float | 18.40% |
| PEG (trailing) | — | Avg volume | 32,235,647 |
| P/S | 372.38 | Employees | 428 |
| P/B | 2.64 | Analyst rec (1=buy..5=sell) | 2.6 |

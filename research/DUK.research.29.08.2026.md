...
Signed file: `DUK.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $120.25 (2026-08-29, ~15-min delayed) |
| Market cap | $93.76B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-1.70%) with negative half-year (-6.49%). |
...
| Value attractiveness | Reasonable | Forward P/E 16.77, EV/Sales 5.76. |
...
|---|---|---|
| WYFI Stock Jumps 12% in 6 Months: Here's What You Should Know | Zacks | 2026-08-28 |
| VST Stock Underperforms Industry in the Past 6 Months: Buy or Hold? | Zacks | 2026-08-27 |
| Duke Energy Florida asks to punt on rate for large load customers | Utility Dive | 2026-08-27 |
| CEG Stock Outperforms Industry in the Past Month: Buy, Hold or Sell | Zacks | 2026-08-26 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $120.25; 52w high $131.16 (-8.32%); 52w low $111.09 (+8.24%) |
| Trend | -1.70% vs SMA200, -3.30% vs SMA50, -1.74% vs SMA20 |
| Momentum | RSI(14) 40.2 (neutral) |
| Volatility | ATR(14) 2.05 (~1.7% of price); beta 0.37 |
...
| Valuation | P/E 18.14, forward P/E 16.77, P/S 2.86, P/B 1.74 | EV/Sales 5.76, EV/EBITDA 11.36 |
...
|---|---|---|---|
| Price | $120.25 | EV/Sales | 5.76 |
| Market cap | $93.76B | EV/EBITDA | 11.36 |
| Beta | 0.37 | Gross margin | 51.97% |
| RSI(14) | 40.2 | Operating margin | 27.50% |
| ATR(14) | 2.05 | Profit margin | 16.00% |
| SMA20 dist | -1.74% | ROA | 2.84% |
| SMA50 dist | -3.30% | ROE | 9.86% |
| SMA200 dist | -1.70% | Revenue (ttm) | $32.80B |
| 52W high | $131.16 | Revenue growth y/y | 1.10% |
| 52W low | $111.09 | Inst. ownership | 71.14% |
| P/E (ttm) | 18.14 | Insider ownership | 0.13% |
| Forward P/E | 16.77 | Short float | 2.55% |
| PEG (trailing) | 2.40 | Avg volume | 4,021,395 |

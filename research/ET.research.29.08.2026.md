...
Signed file: `ET.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $21.31 (2026-08-29, ~15-min delayed) |
| Market cap | $73.38B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +30.37%; price +16.93% vs SMA200. |
| Fresh setup quality | Watch | -0.56% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 4.92%, revenue growth 78.40%. |
| Value attractiveness | Reasonable | Forward P/E 12.18, EV/Sales 1.50. |
...
| Nat-Gas Prices Fall Ahead of Opening of Texas Pipeline | Barchart | 2026-08-28 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $21.31; 52w high $21.43 (-0.56%); 52w low $15.15 (+40.61%) |
| Trend | +16.93% vs SMA200, +6.62% vs SMA50, +2.28% vs SMA20 |
| Momentum | RSI(14) 64.5 (neutral) |
| Volatility | ATR(14) 0.34 (~1.6% of price); beta 0.56 |
| Setup perspective | -0.56% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 14.60, forward P/E 12.18, P/S 0.68, P/B 2.29 | EV/Sales 1.50, EV/EBITDA 9.43 |
...
|---|---|---|---|
| Price | $21.31 | EV/Sales | 1.50 |
| Market cap | $73.38B | EV/EBITDA | 9.43 |
| Beta | 0.56 | Gross margin | 17.51% |
| RSI(14) | 64.5 | Operating margin | 10.41% |
| ATR(14) | 0.34 | Profit margin | 4.92% |
| SMA20 dist | +2.28% | ROA | 5.06% |
| SMA50 dist | +6.62% | ROE | 14.56% |
| SMA200 dist | +16.93% | Revenue (ttm) | $107.38B |
| 52W high | $21.43 | Revenue growth y/y | 78.40% |
| 52W low | $15.15 | Inst. ownership | 32.50% |
| P/E (ttm) | 14.60 | Insider ownership | 10.29% |
| Forward P/E | 12.18 | Short float | 0.93% |
| PEG (trailing) | 0.68 | Avg volume | 8,934,496 |

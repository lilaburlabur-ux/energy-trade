...
Signed file: `FTI.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $75.58 (2026-09-10, ~15-min delayed) |
| Market cap | $29.64B |
...
|---|---|---|
| Technical momentum | High | 1Y +91.24%; price +16.59% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.62% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 11.28%, revenue growth 9.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 21.00, EV/Sales 2.95. |
| Risk level | Elevated | Beta 0.74, ATR 3.2% of price, short float 3.35%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $75.58; 52w high $80.08 (-5.62%); 52w low $35.45 (+113.18%) |
| Trend | +16.59% vs SMA200, +2.10% vs SMA50, -2.59% vs SMA20 |
| Momentum | RSI(14) 47.5 (neutral) |
| Volatility | ATR(14) 2.41 (~3.2% of price); beta 0.74 |
| Setup perspective | -5.62% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.43, forward P/E 21.00, P/S 2.84, P/B 9.07 | EV/Sales 2.95, EV/EBITDA 15.51 |
...
- **Valuation risk:** Forward P/E 21.00, EV/Sales 2.95. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.74, ATR 3.2% of price, short float 3.35%. Size positions accordingly.
...
|---|---|---|---|
| Price | $75.58 | EV/Sales | 2.95 |
| Market cap | $29.64B | EV/EBITDA | 15.51 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 47.5 | Operating margin | 17.69% |
| ATR(14) | 2.41 | Profit margin | 11.28% |
| SMA20 dist | -2.59% | ROA | 9.53% |
| SMA50 dist | +2.10% | ROE | 35.81% |
| SMA200 dist | +16.59% | Revenue (ttm) | $10.42B |
| 52W high | $80.08 | Revenue growth y/y | 9.00% |
| 52W low | $35.45 | Inst. ownership | 101.21% |
| P/E (ttm) | 26.43 | Insider ownership | 1.49% |
| Forward P/E | 21.00 | Short float | 3.35% |
| PEG (trailing) | — | Avg volume | 3,661,993 |
| P/S | 2.84 | Employees | 22,000 |
| P/B | 9.07 | Analyst rec (1=buy..5=sell) | 2.0 |

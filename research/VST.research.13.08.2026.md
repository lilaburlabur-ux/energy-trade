...
Signed file: `VST.research.13.08.2026`

| Field | Value |
|---|---|
| Current price | $146.40 (2026-08-13, ~15-min delayed) |
| Market cap | $49.14B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-9.08%) with negative half-year (-8.33%). |
| Fresh setup quality | Poor / broken | -32.54% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 11.55%, revenue growth -5.50%. |
| Value attractiveness | Reasonable | Forward P/E 14.12, EV/Sales 3.74. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $146.40; 52w high $217.02 (-32.54%); 52w low $134.52 (+8.83%) |
| Trend | -9.08% vs SMA200, -4.94% vs SMA50, -3.14% vs SMA20 |
| Momentum | RSI(14) 45.6 (neutral) |
| Volatility | ATR(14) 6.64 (~4.5% of price); beta 1.43 |
| Setup perspective | -32.54% from 52w high — base needs to rebuild. |
...
| Geode Capital Management, LLC | 9,033,671 | 2.69% | 2026-03-31 |
| Morgan Stanley | 8,256,938 | 2.46% | 2026-03-31 |
| JPMORGAN CHASE & CO | 7,489,657 | 2.23% | 2026-03-31 |
...
|---|---|---|---|
| Price | $146.40 | EV/Sales | 3.74 |
| Market cap | $49.14B | EV/EBITDA | 10.80 |
| Beta | 1.43 | Gross margin | 38.31% |
| RSI(14) | 45.6 | Operating margin | 13.77% |
| ATR(14) | 6.64 | Profit margin | 11.55% |
| SMA20 dist | -3.14% | ROA | 5.89% |
...
| P/S | 2.56 | Employees | 6,390 |
| P/B | 15.86 | Analyst rec (1=buy..5=sell) | 1.4 |

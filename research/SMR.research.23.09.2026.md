...
Signed file: `SMR.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $8.68 (2026-09-23, ~15-min delayed) |
| Market cap | $3.56B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-29.85%) with negative half-year (-24.06%). |
| Fresh setup quality | Poor / broken | -83.75% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -13.15, EV/Sales 229.10. |
| Risk level | High | Beta 2.31, ATR 8.0% of price, short float 17.60%. |
...
|---|---|---|
| Is X-Energy Building a New Model for Industrial Nuclear Power? | Zacks | 2026-09-23 |
| Oklo vs. NuScale vs. BWX Technologies: Ranking the 3 Popular Nuclear Stocks From Worst to First | Motley Fool | 2026-09-23 |
| NuScale's E2 Centers Turn SMR Learning Into Hands-On Training | Zacks | 2026-09-22 |
| NuScale Power (SMR) Draws Fresh Attention, Is The Stock Still A Bargain? | Simply Wall St. | 2026-09-22 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $8.68; 52w high $53.43 (-83.75%); 52w low $7.59 (+14.36%) |
| Trend | -29.85% vs SMA200, -4.06% vs SMA50, -6.42% vs SMA20 |
| Momentum | RSI(14) 46.0 (neutral) |
| Volatility | ATR(14) 0.70 (~8.0% of price); beta 2.31 |
| Setup perspective | -83.75% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -13.15, P/S 333.23, P/B 1.73 | EV/Sales 229.10, EV/EBITDA -10.93 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $11.97 (15 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 59.48% |
...
- **Volatility risk:** Beta 2.31, ATR 8.0% of price, short float 17.60%. Size positions accordingly.
...
|---|---|---|---|
| Price | $8.68 | EV/Sales | 229.10 |
| Market cap | $3.56B | EV/EBITDA | -10.93 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 46.0 | Operating margin | -85337.33% |
| ATR(14) | 0.70 | Profit margin | 0.00% |
| SMA20 dist | -6.42% | ROA | -10.60% |
| SMA50 dist | -4.06% | ROE | -55.18% |
| SMA200 dist | -29.85% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.48% |
| P/E (ttm) | — | Insider ownership | 1.70% |
| Forward P/E | -13.15 | Short float | 17.60% |
| PEG (trailing) | — | Avg volume | 33,013,906 |
| P/S | 333.23 | Employees | 428 |
| P/B | 1.73 | Analyst rec (1=buy..5=sell) | 2.7 |

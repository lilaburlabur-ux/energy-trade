...
Signed file: `SEDG.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $35.33 (2026-09-14, ~15-min delayed) |
| Market cap | $2.17B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $35.33; 52w high $78.51 (-55.00%); 52w low $28.47 (+24.10%) |
| Trend | -16.05% vs SMA200, -11.33% vs SMA50, +7.39% vs SMA20 |
| Momentum | RSI(14) 49.7 (neutral) |
| Volatility | ATR(14) 3.00 (~8.5% of price); beta 1.44 |
| Setup perspective | -55.00% from 52w high — base needs to rebuild. |
...
| SMA20 dist | +7.39% | ROA | -3.84% |
| SMA50 dist | -11.33% | ROE | -58.42% |
| SMA200 dist | -16.05% | Revenue (ttm) | $1.33B |
| 52W high | $78.51 | Revenue growth y/y | 19.60% |
| 52W low | $28.47 | Inst. ownership | 101.65% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 40.27 | Short float | 25.50% |
| PEG (trailing) | — | Avg volume | 3,099,017 |
| P/S | 1.63 | Employees | 3,576 |
| P/B | 5.27 | Analyst rec (1=buy..5=sell) | 3.0 |

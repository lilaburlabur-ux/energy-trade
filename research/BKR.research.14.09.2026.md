...
Signed file: `BKR.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $56.78 (2026-09-14, ~15-min delayed) |
| Market cap | $56.36B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $56.78; 52w high $69.18 (-17.93%); 52w low $43.79 (+29.68%) |
| Trend | -2.87% vs SMA200, -6.02% vs SMA50, -9.23% vs SMA20 |
| Momentum | RSI(14) 29.7 (oversold) |
| Volatility | ATR(14) 2.01 (~3.5% of price); beta 0.96 |
| Setup perspective | -17.93% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | -9.23% | ROA | 4.85% |
| SMA50 dist | -6.02% | ROE | 16.46% |
| SMA200 dist | -2.87% | Revenue (ttm) | $27.73B |
| 52W high | $69.18 | Revenue growth y/y | -2.40% |
| 52W low | $43.79 | Inst. ownership | 100.03% |
| P/E (ttm) | 18.26 | Insider ownership | 0.15% |
| Forward P/E | 18.25 | Short float | 3.08% |
| PEG (trailing) | 1.65 | Avg volume | 8,393,906 |

...
Signed file: `ENPH.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $37.58 (2026-08-18, ~15-min delayed) |
| Market cap | $4.95B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-6.69%) with negative half-year (-17.66%). |
| Fresh setup quality | Poor / broken | -48.04% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 16.28, EV/Sales 3.60. |
| Risk level | High | Beta 1.65, ATR 6.5% of price, short float 20.98%. |
...
|---|---|---|
| Enphase Energy Opens U.S. Pre-Orders for First Commercial Battery System | InvestorsHub | 2026-08-18 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $37.58; 52w high $72.33 (-48.04%); 52w low $26.12 (+43.87%) |
| Trend | -6.69% vs SMA200, -14.59% vs SMA50, -3.96% vs SMA20 |
| Momentum | RSI(14) 40.9 (neutral) |
| Volatility | ATR(14) 2.44 (~6.5% of price); beta 1.65 |
| Setup perspective | -48.04% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 37.21, forward P/E 16.28, P/S 3.73, P/B 4.20 | EV/Sales 3.60, EV/EBITDA 24.94 |
...
- **Volatility risk:** Beta 1.65, ATR 6.5% of price, short float 20.98%. Size positions accordingly.
...
|---|---|---|---|
| Price | $37.58 | EV/Sales | 3.60 |
| Market cap | $4.95B | EV/EBITDA | 24.94 |
| Beta | 1.65 | Gross margin | 30.04% |
| RSI(14) | 40.9 | Operating margin | 17.98% |
| ATR(14) | 2.44 | Profit margin | 10.09% |
| SMA20 dist | -3.96% | ROA | 2.38% |
| SMA50 dist | -14.59% | ROE | 13.00% |
| SMA200 dist | -6.69% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 96.76% |
| P/E (ttm) | 37.21 | Insider ownership | 3.03% |
| Forward P/E | 16.28 | Short float | 20.98% |
| PEG (trailing) | 1.17 | Avg volume | 6,442,143 |
| P/S | 3.73 | Employees | 2,872 |
| P/B | 4.20 | Analyst rec (1=buy..5=sell) | 2.5 |

...
Signed file: `WFRD.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $82.05 (2026-09-17, ~15-min delayed) |
| Market cap | $5.87B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-11.30%) with negative half-year (-4.58%). |
| Fresh setup quality | Poor / broken | -26.13% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 7.66%, revenue growth -8.20%. |
| Value attractiveness | Reasonable | Forward P/E 11.62, EV/Sales 1.34. |
| Risk level | Elevated | Beta 0.90, ATR 4.5% of price, short float 6.87%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $82.05; 52w high $111.07 (-26.13%); 52w low $60.73 (+35.11%) |
| Trend | -11.30% vs SMA200, -7.08% vs SMA50, -9.56% vs SMA20 |
| Momentum | RSI(14) 34.9 (neutral) |
| Volatility | ATR(14) 3.71 (~4.5% of price); beta 0.90 |
| Setup perspective | -26.13% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 16.18, forward P/E 11.62, P/S 1.23, P/B 3.29 | EV/Sales 1.34, EV/EBITDA 6.91 |
...
- **Volatility risk:** Beta 0.90, ATR 4.5% of price, short float 6.87%. Size positions accordingly.
...
|---|---|---|---|
| Price | $82.05 | EV/Sales | 1.34 |
| Market cap | $5.87B | EV/EBITDA | 6.91 |
| Beta | 0.90 | Gross margin | 30.51% |
| RSI(14) | 34.9 | Operating margin | 10.50% |
| ATR(14) | 3.71 | Profit margin | 7.66% |
| SMA20 dist | -9.56% | ROA | 7.90% |
| SMA50 dist | -7.08% | ROE | 22.79% |
| SMA200 dist | -11.30% | Revenue (ttm) | $4.78B |
| 52W high | $111.07 | Revenue growth y/y | -8.20% |
| 52W low | $60.73 | Inst. ownership | 106.62% |
| P/E (ttm) | 16.18 | Insider ownership | 2.12% |
| Forward P/E | 11.62 | Short float | 6.87% |
| PEG (trailing) | 1.26 | Avg volume | 1,244,079 |

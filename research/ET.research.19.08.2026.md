...
Signed file: `ET.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $21.18 (2026-08-19, ~15-min delayed) |
| Market cap | $72.93B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +31.29%; price +17.48% vs SMA200. |
| Fresh setup quality | Watch | -1.12% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 4.92%, revenue growth 78.40%. |
| Value attractiveness | Reasonable | Forward P/E 12.10, EV/Sales 1.51. |
| Risk level | Moderate | Beta 0.56, ATR 1.7% of price, short float 0.84%. |
...
|---|---|---|
| 3 High-Yielding Dividend Stocks That Have Doubled Their Payouts in 5 Years | Motley Fool | 2026-08-19 |
| Is Energy Transfer (ET) Undervalued After Its Recent Rally? | Simply Wall St. | 2026-08-19 |
| 3 Energy Dividend Stocks to Buy for Big Yields in August | 24/7 Wall St. | 2026-08-19 |
| Energy Transfer (ET) Stock Looks Reasonable On Earnings But Stretched On Broader Checks | Simply Wall St. | 2026-08-19 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $21.18; 52w high $21.42 (-1.12%); 52w low $15.15 (+39.76%) |
| Trend | +17.48% vs SMA200, +7.95% vs SMA50, +3.97% vs SMA20 |
| Momentum | RSI(14) 66.7 (neutral) |
| Volatility | ATR(14) 0.35 (~1.7% of price); beta 0.56 |
| Setup perspective | -1.12% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 14.51, forward P/E 12.10, P/S 0.68, P/B 2.28 | EV/Sales 1.51, EV/EBITDA 9.43 |
...
|---|---|---|---|
| Price | $21.18 | EV/Sales | 1.51 |
| Market cap | $72.93B | EV/EBITDA | 9.43 |
| Beta | 0.56 | Gross margin | 17.51% |
| RSI(14) | 66.7 | Operating margin | 10.41% |
| ATR(14) | 0.35 | Profit margin | 4.92% |
| SMA20 dist | +3.97% | ROA | 5.06% |
| SMA50 dist | +7.95% | ROE | 14.56% |
| SMA200 dist | +17.48% | Revenue (ttm) | $107.38B |
| 52W high | $21.42 | Revenue growth y/y | 78.40% |
| 52W low | $15.15 | Inst. ownership | 32.50% |
| P/E (ttm) | 14.51 | Insider ownership | 10.29% |
| Forward P/E | 12.10 | Short float | 0.84% |
| PEG (trailing) | 0.68 | Avg volume | 9,063,038 |

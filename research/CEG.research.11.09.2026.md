...
Signed file: `CEG.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $284.75 (2026-09-11, ~15-min delayed) |
| Market cap | $100.89B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-3.29%) with negative half-year (-5.28%). |
| Fresh setup quality | Poor / broken | -29.11% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 11.08%, revenue growth 23.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 21.34, EV/Sales 4.02. |
| Risk level | Elevated | Beta 1.12, ATR 3.4% of price, short float 3.65%. |
...
| CEG, SHEL Stocks Rise Overnight: Constellation Energy To Acquire Rhode Island State Energy Center From Shell For $715M | Stocktwits | 2026-09-11 |
| Sector Update: Energy Stocks Decline Late Afternoon | MT Newswires | 2026-09-10 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $284.75; 52w high $401.70 (-29.11%); 52w low $236.14 (+20.59%) |
| Trend | -3.29% vs SMA200, +5.75% vs SMA50, +1.15% vs SMA20 |
| Momentum | RSI(14) 53.8 (neutral) |
| Volatility | ATR(14) 9.56 (~3.4% of price); beta 1.12 |
| Setup perspective | -29.11% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 27.81, forward P/E 21.34, P/S 3.23, P/B 3.16 | EV/Sales 4.02, EV/EBITDA 15.80 |
...
- **Valuation risk:** Forward P/E 21.34, EV/Sales 4.02. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.12, ATR 3.4% of price, short float 3.65%. Size positions accordingly.
...
|---|---|---|---|
| Price | $284.75 | EV/Sales | 4.02 |
| Market cap | $100.89B | EV/EBITDA | 15.80 |
| Beta | 1.12 | Gross margin | 22.11% |
| RSI(14) | 53.8 | Operating margin | 8.66% |
| ATR(14) | 9.56 | Profit margin | 11.08% |
| SMA20 dist | +1.15% | ROA | 3.89% |
| SMA50 dist | +5.75% | ROE | 15.06% |
| SMA200 dist | -3.29% | Revenue (ttm) | $31.27B |
| 52W high | $401.70 | Revenue growth y/y | 23.00% |
| 52W low | $236.14 | Inst. ownership | 82.96% |
| P/E (ttm) | 27.81 | Insider ownership | 0.34% |
| Forward P/E | 21.34 | Short float | 3.65% |
| PEG (trailing) | — | Avg volume | 3,033,661 |
| P/S | 3.23 | Employees | 15,291 |
| P/B | 3.16 | Analyst rec (1=buy..5=sell) | 1.5 |

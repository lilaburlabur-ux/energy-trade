...
Signed file: `BP.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $45.93 (2026-09-14, ~15-min delayed) |
| Market cap | $118.29B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +40.11%; price +14.30% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 9.36, EV/Sales 2.45. |
| Risk level | Moderate | Beta -0.22, ATR 2.2% of price, short float 0.29%. |
...
|---|---|---|
| Energy & Utilities Roundup: Market Talk | The Wall Street Journal | 2026-09-14 |
| Chevron Sees Higher Oil Prices Ahead: Is It Set for More Upside? | Zacks | 2026-09-14 |
| Best Growth Stocks to Buy for September 14th | Zacks | 2026-09-14 |
| The Zacks Analyst Blog Highlights ExxonMobil, BP and Chevron | Zacks | 2026-09-11 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $45.93; 52w high $46.52 (-1.27%); 52w low $31.17 (+47.33%) |
| Trend | +14.30% vs SMA200, +8.11% vs SMA50, +4.29% vs SMA20 |
| Momentum | RSI(14) 64.2 (neutral) |
| Volatility | ATR(14) 1.00 (~2.2% of price); beta -0.22 |
...
| Valuation | P/E 21.98, forward P/E 9.36, P/S 0.55, P/B 8.13 | EV/Sales 2.45, EV/EBITDA 13.49 |
...
|---|---|---|---|
| Price | $45.93 | EV/Sales | 2.45 |
| Market cap | $118.29B | EV/EBITDA | 13.49 |
| Beta | -0.22 | Gross margin | 28.30% |
| RSI(14) | 64.2 | Operating margin | 13.15% |
| ATR(14) | 1.00 | Profit margin | 2.55% |
| SMA20 dist | +4.29% | ROA | 5.04% |
| SMA50 dist | +8.11% | ROE | 8.87% |
| SMA200 dist | +14.30% | Revenue (ttm) | $215.47B |
| 52W high | $46.52 | Revenue growth y/y | 48.20% |
| 52W low | $31.17 | Inst. ownership | 14.09% |
| P/E (ttm) | 21.98 | Insider ownership | 0.00% |
| Forward P/E | 9.36 | Short float | 0.29% |
| PEG (trailing) | 0.06 | Avg volume | 9,183,880 |
| P/S | 0.55 | Employees | 93,700 |
| P/B | 8.13 | Analyst rec (1=buy..5=sell) | 2.4 |

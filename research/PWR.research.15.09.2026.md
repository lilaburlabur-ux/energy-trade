...
Signed file: `PWR.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $613.35 (2026-09-15, ~15-min delayed) |
| Market cap | $92.21B |
...
|---|---|---|
| Technical momentum | High | 1Y +60.48%; price +3.36% vs SMA200. |
| Fresh setup quality | Moderate / wait | -21.88% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 4.03%, revenue growth 41.10%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 31.11, EV/Sales 3.03. |
| Risk level | Elevated | Beta 1.20, ATR 4.1% of price, short float 2.38%. |
...
|---|---|---|
| Wall Street Turns More Bullish on PWR Stock: Buy, Hold or Sell Now? | Zacks | 2026-09-15 |
| MYR Group's Backlog Hits Record in Q2: Can the Growth Trend Continue? | Zacks | 2026-09-15 |
| Can MasTec's Diversified Model Cushion a Communications Dip in 2026? | Zacks | 2026-09-15 |
| Will Comfort Systems' Data Center Growth Support Service Expansion? | Zacks | 2026-09-15 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $613.35; 52w high $785.12 (-21.88%); 52w low $375.69 (+63.26%) |
| Trend | +3.36% vs SMA200, -4.83% vs SMA50, -2.50% vs SMA20 |
| Momentum | RSI(14) 44.1 (neutral) |
| Volatility | ATR(14) 24.93 (~4.1% of price); beta 1.20 |
| Setup perspective | -21.88% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 69.94, forward P/E 31.11, P/S 2.80, P/B 9.56 | EV/Sales 3.03, EV/EBITDA 32.75 |
...
- **Valuation risk:** Forward P/E 31.11, EV/Sales 3.03. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.20, ATR 4.1% of price, short float 2.38%. Size positions accordingly.
...
|---|---|---|---|
| Price | $613.35 | EV/Sales | 3.03 |
| Market cap | $92.21B | EV/EBITDA | 32.75 |
| Beta | 1.20 | Gross margin | 15.46% |
| RSI(14) | 44.1 | Operating margin | 7.22% |
| ATR(14) | 24.93 | Profit margin | 4.03% |
| SMA20 dist | -2.50% | ROA | 5.23% |
| SMA50 dist | -4.83% | ROE | 15.34% |
| SMA200 dist | +3.36% | Revenue (ttm) | $32.91B |
| 52W high | $785.12 | Revenue growth y/y | 41.10% |
| 52W low | $375.69 | Inst. ownership | 94.10% |
| P/E (ttm) | 69.94 | Insider ownership | 0.67% |
| Forward P/E | 31.11 | Short float | 2.38% |
| PEG (trailing) | 1.41 | Avg volume | 1,203,146 |
| P/S | 2.80 | Employees | 69,500 |
| P/B | 9.56 | Analyst rec (1=buy..5=sell) | 1.5 |

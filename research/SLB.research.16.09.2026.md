...
Signed file: `SLB.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $52.30 (2026-09-16, ~15-min delayed) |
| Market cap | $77.62B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +54.09%; price +6.16% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 16.17, EV/Sales 2.48. |
| Risk level | Elevated | Beta 0.77, ATR 3.8% of price, short float 4.25%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $52.30; 52w high $59.79 (-12.53%); 52w low $30.96 (+68.91%) |
| Trend | +6.16% vs SMA200, +0.86% vs SMA50, -5.57% vs SMA20 |
| Momentum | RSI(14) 42.6 (neutral) |
| Volatility | ATR(14) 1.97 (~3.8% of price); beta 0.77 |
...
| Valuation | P/E 25.51, forward P/E 16.17, P/S 2.13, P/B 2.98 | EV/Sales 2.48, EV/EBITDA 12.23 |
...
- **Volatility risk:** Beta 0.77, ATR 3.8% of price, short float 4.25%. Size positions accordingly.
...
|---|---|---|---|
| Price | $52.30 | EV/Sales | 2.48 |
| Market cap | $77.62B | EV/EBITDA | 12.23 |
| Beta | 0.77 | Gross margin | 16.99% |
| RSI(14) | 42.6 | Operating margin | 12.71% |
| ATR(14) | 1.97 | Profit margin | 8.53% |
| SMA20 dist | -5.57% | ROA | 6.17% |
| SMA50 dist | +0.86% | ROE | 12.91% |
| SMA200 dist | +6.16% | Revenue (ttm) | $36.37B |
| 52W high | $59.79 | Revenue growth y/y | 5.00% |
| 52W low | $30.96 | Inst. ownership | 92.52% |
| P/E (ttm) | 25.51 | Insider ownership | 0.22% |
| Forward P/E | 16.17 | Short float | 4.25% |
| PEG (trailing) | 1.41 | Avg volume | 13,713,120 |

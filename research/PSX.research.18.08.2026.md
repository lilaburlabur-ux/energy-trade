...
Signed file: `PSX.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $243.49 (2026-08-18, ~15-min delayed) |
| Market cap | $97.16B |
...
|---|---|---|
| Technical momentum | High | 1Y +105.20%; price +48.75% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 11.58, EV/Sales 0.75. |
| Risk level | Moderate | Beta 0.69, ATR 3.0% of price, short float 2.13%. |
...
| Executive Dumps Over 52,000 Shares of Iconic Energy Stock, After It Surges 101% in One Year | Motley Fool | 2026-08-18 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $243.49; 52w high $243.49 (+0.00%); 52w low $118.77 (+105.01%) |
| Trend | +48.75% vs SMA200, +25.01% vs SMA50, +13.37% vs SMA20 |
| Momentum | RSI(14) 80.6 (overbought) |
| Volatility | ATR(14) 7.23 (~3.0% of price); beta 0.69 |
...
| Valuation | P/E 13.91, forward P/E 11.58, P/S 0.64, P/B 3.08 | EV/Sales 0.75, EV/EBITDA 11.45 |
| Growth expectations | Earnings growth 344.90%, EPS q/q 338.70% | Analyst mean target $219.84 (19 analysts) |
...
|---|---|---|---|
| Price | $243.49 | EV/Sales | 0.75 |
| Market cap | $97.16B | EV/EBITDA | 11.45 |
| Beta | 0.69 | Gross margin | 13.10% |
| RSI(14) | 80.6 | Operating margin | 8.53% |
| ATR(14) | 7.23 | Profit margin | 4.66% |
| SMA20 dist | +13.37% | ROA | 6.04% |
| SMA50 dist | +25.01% | ROE | 23.45% |
| SMA200 dist | +48.75% | Revenue (ttm) | $152.17B |

...
Signed file: `SHEL.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $95.78 (2026-09-25, ~15-min delayed) |
| Market cap | $273.23B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +37.75%; price +14.77% vs SMA200. |
| Fresh setup quality | Watch | -3.20% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 8.76%, revenue growth 44.70%. |
| Value attractiveness | Reasonable | Forward P/E 9.25, EV/Sales 1.04. |
...
|---|---|---|
| At Gastech 2026, Wison New Energies’ Floating Data Center Concept Signals Broader Offshore Engineering Leadership | Exec Edge | 2026-09-25 |
| Talos Energy (TALO) Acquires Deepwater Gulf Of Mexico Assets | Simply Wall St. | 2026-09-25 |
| Chevron's Cost Discipline: Turning Efficiency Into Lasting Value | Zacks | 2026-09-25 |
| Shell & NGC Reach Gas Deal to Advance Trinidad's Aphrodite Project | Zacks | 2026-09-25 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $95.78; 52w high $98.95 (-3.20%); 52w low $68.43 (+39.96%) |
| Trend | +14.77% vs SMA200, +4.70% vs SMA50, +1.19% vs SMA20 |
| Momentum | RSI(14) 58.1 (neutral) |
| Volatility | ATR(14) 1.57 (~1.6% of price); beta -0.22 |
| Setup perspective | -3.20% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 10.58, forward P/E 9.25, P/S 0.92, P/B 1.48 | EV/Sales 1.04, EV/EBITDA 5.37 |
| Growth expectations | Earnings growth 220.00%, EPS q/q 200.50% | Analyst mean target $101.68 (15 analysts) |
...
|---|---|---|---|
| FMR, LLC | 87,332,346 | 3.03% | 2026-06-30 |
| Fisher Asset Management, LLC | 27,633,155 | 0.96% | 2026-06-30 |
| Dimensional Fund Advisors LP | 25,363,810 | 0.88% | 2026-06-30 |
| Morgan Stanley | 10,779,129 | 0.37% | 2026-06-30 |
| Goldman Sachs Group Inc | 10,560,692 | 0.37% | 2026-06-30 |
| Price (T.Rowe) Associates Inc | 9,835,553 | 0.34% | 2026-06-30 |
| Orbis Allan Gray Ltd | 8,847,436 | 0.31% | 2026-06-30 |
| Mawer Investment Management Ltd. | 8,013,792 | 0.28% | 2026-06-30 |
| Bank of America Corporation | 7,709,715 | 0.27% | 2026-06-30 |
...
|---|---|---|---|
| Price | $95.78 | EV/Sales | 1.04 |
| Market cap | $273.23B | EV/EBITDA | 5.37 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 58.1 | Operating margin | 16.69% |
| ATR(14) | 1.57 | Profit margin | 8.76% |
| SMA20 dist | +1.19% | ROA | 6.40% |
| SMA50 dist | +4.70% | ROE | 14.34% |
| SMA200 dist | +14.77% | Revenue (ttm) | $296.60B |
| 52W high | $98.95 | Revenue growth y/y | 44.70% |
| 52W low | $68.43 | Inst. ownership | 13.39% |
| P/E (ttm) | 10.58 | Insider ownership | 0.01% |
| Forward P/E | 9.25 | Short float | 1.24% |
| PEG (trailing) | 1.59 | Avg volume | 6,242,276 |
...
| Source | URL | Used for |
|---|---|---|
| Yahoo Finance quote/profile/statistics for SHEL | https://finance.yahoo.com/quote/SHEL | Snapshot metrics, ownership, analyst data |
| Yahoo Finance price history (via yfinance) | https://finance.yahoo.com/quote/SHEL/history | SMA/RSI/ATR/performance calculations |
| Yahoo Finance news feed | https://finance.yahoo.com/quote/SHEL/news | Catalyst headlines |

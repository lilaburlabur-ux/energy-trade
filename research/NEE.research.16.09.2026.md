...
Signed file: `NEE.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $80.37 (2026-09-16, ~15-min delayed) |
| Market cap | $167.62B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-7.11%) with negative half-year (-11.85%). |
| Fresh setup quality | Moderate / wait | -16.67% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 32.40%, revenue growth 12.40%. |
| Value attractiveness | Reasonable | Forward P/E 18.29, EV/Sales 10.02. |
...
| This Quiet Utility Has a Multi-Decade Dividend Growth Streak -- Here's Why Almost Nobody Talks About It | Motley Fool | 2026-09-16 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $80.37; 52w high $96.44 (-16.67%); 52w low $67.88 (+18.40%) |
| Trend | -7.11% vs SMA200, -5.72% vs SMA50, -3.06% vs SMA20 |
| Momentum | RSI(14) 29.3 (oversold) |
| Volatility | ATR(14) 1.34 (~1.7% of price); beta 0.64 |
| Setup perspective | -16.67% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.06, forward P/E 18.29, P/S 5.84, P/B 2.93 | EV/Sales 10.02, EV/EBITDA 19.70 |
...
|---|---|---|---|
| Price | $80.37 | EV/Sales | 10.02 |
| Market cap | $167.62B | EV/EBITDA | 19.70 |
| Beta | 0.64 | Gross margin | 61.02% |
| RSI(14) | 29.3 | Operating margin | 31.52% |
| ATR(14) | 1.34 | Profit margin | 32.40% |
| SMA20 dist | -3.06% | ROA | 2.44% |
| SMA50 dist | -5.72% | ROE | 11.68% |
| SMA200 dist | -7.11% | Revenue (ttm) | $28.70B |
| 52W high | $96.44 | Revenue growth y/y | 12.40% |
| 52W low | $67.88 | Inst. ownership | 87.01% |
| P/E (ttm) | 18.06 | Insider ownership | 0.12% |
| Forward P/E | 18.29 | Short float | 0.00% |
| PEG (trailing) | 1.64 | Avg volume | 11,087,064 |
| P/S | 5.84 | Employees | 17,400 |
| P/B | 2.93 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `SHEL.research.07.09.2026`

| Field | Value |
|---|---|
| Current price | $92.95 (2026-09-07, ~15-min delayed) |
| Market cap | $265.91B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +33.33%; price +13.66% vs SMA200. |
| Fresh setup quality | Watch | -0.75% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 8.76%, revenue growth 44.70%. |
| Value attractiveness | Reasonable | Forward P/E 10.31, EV/Sales 1.02. |
...
|---|---|---|
| Shell Climbs 1.3% as $97 Oil Supercharges Its $21 Billion Cash Engine | GuruFocus.com | 2026-09-07 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $92.95; 52w high $93.65 (-0.75%); 52w low $68.25 (+36.19%) |
| Trend | +13.66% vs SMA200, +6.72% vs SMA50, +1.47% vs SMA20 |
| Momentum | RSI(14) 60.9 (neutral) |
| Volatility | ATR(14) 1.41 (~1.5% of price); beta -0.22 |
| Setup perspective | -0.75% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 10.28, forward P/E 10.31, P/S 0.90, P/B 1.43 | EV/Sales 1.02, EV/EBITDA 5.24 |
| Growth expectations | Earnings growth 220.00%, EPS q/q 200.50% | Analyst mean target $99.81 (15 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 13.32% |
...
|---|---|---|---|
| Price | $92.95 | EV/Sales | 1.02 |
| Market cap | $265.91B | EV/EBITDA | 5.24 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 60.9 | Operating margin | 16.69% |
| ATR(14) | 1.41 | Profit margin | 8.76% |
| SMA20 dist | +1.47% | ROA | 6.40% |
| SMA50 dist | +6.72% | ROE | 14.34% |
| SMA200 dist | +13.66% | Revenue (ttm) | $296.60B |
| 52W high | $93.65 | Revenue growth y/y | 44.70% |
| 52W low | $68.25 | Inst. ownership | 13.32% |
| P/E (ttm) | 10.28 | Insider ownership | 0.01% |
| Forward P/E | 10.31 | Short float | 1.57% |
| PEG (trailing) | 1.56 | Avg volume | 6,389,242 |

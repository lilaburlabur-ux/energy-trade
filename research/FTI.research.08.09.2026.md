...
Signed file: `FTI.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $78.16 (2026-09-08, ~15-min delayed) |
| Market cap | $30.65B |
...
|---|---|---|
| Technical momentum | High | 1Y +101.58%; price +21.19% vs SMA200. |
| Fresh setup quality | Watch | -2.40% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 11.28%, revenue growth 9.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 21.72, EV/Sales 3.03. |
| Risk level | Moderate | Beta 0.74, ATR 2.9% of price, short float 3.35%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $78.16; 52w high $80.08 (-2.40%); 52w low $35.45 (+120.45%) |
| Trend | +21.19% vs SMA200, +6.22% vs SMA50, +0.92% vs SMA20 |
| Momentum | RSI(14) 56.9 (neutral) |
| Volatility | ATR(14) 2.30 (~2.9% of price); beta 0.74 |
| Setup perspective | -2.40% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 27.33, forward P/E 21.72, P/S 2.94, P/B 9.38 | EV/Sales 3.03, EV/EBITDA 15.91 |
| Growth expectations | Earnings growth 40.60%, EPS q/q 34.60% | Analyst mean target $75.81 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 101.21% |
...
- **Valuation risk:** Forward P/E 21.72, EV/Sales 3.03. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $78.16 | EV/Sales | 3.03 |
| Market cap | $30.65B | EV/EBITDA | 15.91 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 56.9 | Operating margin | 17.69% |
| ATR(14) | 2.30 | Profit margin | 11.28% |
| SMA20 dist | +0.92% | ROA | 9.53% |
| SMA50 dist | +6.22% | ROE | 35.81% |
| SMA200 dist | +21.19% | Revenue (ttm) | $10.42B |
| 52W high | $80.08 | Revenue growth y/y | 9.00% |
| 52W low | $35.45 | Inst. ownership | 101.21% |
| P/E (ttm) | 27.33 | Insider ownership | 1.49% |
| Forward P/E | 21.72 | Short float | 3.35% |
| PEG (trailing) | — | Avg volume | 3,677,403 |

...
Signed file: `ENPH.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $38.36 (2026-08-20, ~15-min delayed) |
| Market cap | $5.06B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-4.95%) with negative half-year (-13.31%). |
| Fresh setup quality | Poor / broken | -46.97% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 16.61, EV/Sales 3.67. |
| Risk level | High | Beta 1.65, ATR 6.1% of price, short float 20.98%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.36; 52w high $72.33 (-46.97%); 52w low $26.12 (+46.86%) |
| Trend | -4.95% vs SMA200, -11.50% vs SMA50, -1.87% vs SMA20 |
| Momentum | RSI(14) 43.8 (neutral) |
| Volatility | ATR(14) 2.33 (~6.1% of price); beta 1.65 |
| Setup perspective | -46.97% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 37.98, forward P/E 16.61, P/S 3.81, P/B 4.29 | EV/Sales 3.67, EV/EBITDA 25.43 |
| Growth expectations | Earnings growth -3.50%, EPS q/q -2.60% | Analyst mean target $46.79 (27 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 96.78% |
...
- **Volatility risk:** Beta 1.65, ATR 6.1% of price, short float 20.98%. Size positions accordingly.
...
|---|---|---|---|
| Price | $38.36 | EV/Sales | 3.67 |
| Market cap | $5.06B | EV/EBITDA | 25.43 |
| Beta | 1.65 | Gross margin | 30.04% |
| RSI(14) | 43.8 | Operating margin | 17.98% |
| ATR(14) | 2.33 | Profit margin | 10.09% |
| SMA20 dist | -1.87% | ROA | 2.38% |
| SMA50 dist | -11.50% | ROE | 13.00% |
| SMA200 dist | -4.95% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 96.78% |
| P/E (ttm) | 37.98 | Insider ownership | 3.03% |
| Forward P/E | 16.61 | Short float | 20.98% |
| PEG (trailing) | 1.13 | Avg volume | 6,244,216 |
| P/S | 3.81 | Employees | 2,872 |
| P/B | 4.29 | Analyst rec (1=buy..5=sell) | 2.5 |

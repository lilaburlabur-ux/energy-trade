...
Signed file: `EOSE.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $3.82 (2026-08-05, ~15-min delayed) |
| Market cap | $1.38B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $3.82; 52w high $19.19 (-80.09%); 52w low $3.14 (+21.66%) |
| Trend | -60.50% vs SMA200, -32.69% vs SMA50, -2.77% vs SMA20 |
| Momentum | RSI(14) 42.8 (neutral) |
| Volatility | ATR(14) 0.51 (~13.2% of price); beta 2.80 |
...
- **Volatility risk:** Beta 2.80, ATR 13.2% of price, short float 30.15%. Size positions accordingly.
...
|---|---|---|---|
| Price | $3.82 | EV/Sales | 12.99 |
| Market cap | $1.38B | EV/EBITDA | -7.81 |
| Beta | 2.80 | Gross margin | -101.88% |
| RSI(14) | 42.8 | Operating margin | -139.11% |
| ATR(14) | 0.51 | Profit margin | -296.12% |
| SMA20 dist | -2.77% | ROA | -33.45% |
| SMA50 dist | -32.69% | ROE | — |
| SMA200 dist | -60.50% | Revenue (ttm) | $160.71M |

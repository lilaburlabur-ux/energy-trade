...
Signed file: `XOM.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $160.66 (2026-09-08, ~15-min delayed) |
| Market cap | $660.62B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +51.35%; price +12.12% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.06% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.07%, revenue growth 44.10%. |
| Value attractiveness | Reasonable | Forward P/E 14.90, EV/Sales 1.94. |
...
|---|---|---|
| Exxon Stays Flat as Kazakhstan Pauses a $5.06 Billion Threat | GuruFocus.com | 2026-09-08 |
| Oil Prices Are Once Again on the Brink of $100 | Oilprice.com | 2026-09-08 |
| Imperial Oil Stock Rises 49% YTD: Time to Hold or Lock in Profits? | Zacks | 2026-09-08 |
| ExxonMobil Has Raised Its Dividend 43 Years Running. Here's the One Year the Streak Almost Broke. | Motley Fool | 2026-09-08 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $160.66; 52w high $169.22 (-5.06%); 52w low $106.76 (+50.49%) |
| Trend | +12.12% vs SMA200, +5.15% vs SMA50, -0.37% vs SMA20 |
| Momentum | RSI(14) 53.7 (neutral) |
| Volatility | ATR(14) 3.46 (~2.2% of price); beta 0.17 |
| Setup perspective | -5.06% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.68, forward P/E 14.90, P/S 1.83, P/B 2.55 | EV/Sales 1.94, EV/EBITDA 10.29 |
...
|---|---|---|---|
| Price | $160.66 | EV/Sales | 1.94 |
| Market cap | $660.62B | EV/EBITDA | 10.29 |
| Beta | 0.17 | Gross margin | 29.77% |
| RSI(14) | 53.7 | Operating margin | 15.86% |
| ATR(14) | 3.46 | Profit margin | 9.07% |
| SMA20 dist | -0.37% | ROA | 5.52% |
| SMA50 dist | +5.15% | ROE | 12.58% |
| SMA200 dist | +12.12% | Revenue (ttm) | $361.06B |
| 52W high | $169.22 | Revenue growth y/y | 44.10% |
| 52W low | $106.76 | Inst. ownership | 67.10% |
| P/E (ttm) | 20.68 | Insider ownership | 0.08% |
| Forward P/E | 14.90 | Short float | 1.00% |
| PEG (trailing) | 1.37 | Avg volume | 15,606,782 |

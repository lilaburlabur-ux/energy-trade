...
Signed file: `XOM.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $158.19 (2026-08-26, ~15-min delayed) |
| Market cap | $650.46B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +45.67%; price +11.80% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 14.86, EV/Sales 1.94. |
| Risk level | Moderate | Beta 0.17, ATR 2.3% of price, short float 1.00%. |
...
|---|---|---|
| Exxon Slips Below $159 as Hormuz Hope Hits Crude Again | GuruFocus.com | 2026-08-26 |
| ExxonMobil Stock's Biggest Risk Is The Shortage Ending | Trefis | 2026-08-26 |
| Can ExxonMobil's Permian Growth Keep Driving Upstream Momentum? | Zacks | 2026-08-26 |
| Exxon Mobil fined £267,000 over leaks of flammable gas at Scottish plant | PA Media: Money | 2026-08-26 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $158.19; 52w high $169.22 (-6.52%); 52w low $106.15 (+49.02%) |
| Trend | +11.80% vs SMA200, +6.07% vs SMA50, -0.28% vs SMA20 |
| Momentum | RSI(14) 52.2 (neutral) |
| Volatility | ATR(14) 3.57 (~2.3% of price); beta 0.17 |
...
| Valuation | P/E 20.36, forward P/E 14.86, P/S 1.80, P/B 2.51 | EV/Sales 1.94, EV/EBITDA 10.29 |
| Growth expectations | Earnings growth 112.80%, EPS q/q 105.10% | Analyst mean target $169.68 (22 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 66.33% |
...
|---|---|---|---|
| Price | $158.19 | EV/Sales | 1.94 |
| Market cap | $650.46B | EV/EBITDA | 10.29 |
| Beta | 0.17 | Gross margin | 29.77% |
| RSI(14) | 52.2 | Operating margin | 15.86% |
| ATR(14) | 3.57 | Profit margin | 9.07% |
| SMA20 dist | -0.28% | ROA | 5.52% |
| SMA50 dist | +6.07% | ROE | 12.58% |
| SMA200 dist | +11.80% | Revenue (ttm) | $361.06B |
| 52W high | $169.22 | Revenue growth y/y | 44.10% |
| 52W low | $106.15 | Inst. ownership | 66.33% |
| P/E (ttm) | 20.36 | Insider ownership | 0.08% |
| Forward P/E | 14.86 | Short float | 1.00% |
| PEG (trailing) | 1.26 | Avg volume | 15,844,112 |

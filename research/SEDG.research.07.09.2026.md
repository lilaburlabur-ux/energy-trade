...
Signed file: `SEDG.research.07.09.2026`

| Field | Value |
|---|---|
| Current price | $34.20 (2026-09-07, ~15-min delayed) |
| Market cap | $2.10B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +0.12%; price -18.66% vs SMA200. |
| Fresh setup quality | Poor / broken | -56.44% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-20.29%). |
| Value attractiveness | Low (expensive) | Forward P/E 35.27, EV/Sales 1.48. |
| Risk level | High | Beta 1.44, ATR 7.3% of price, short float 23.21%. |
...
|---|---|---|
| Which Solar Stock Has Dominated in 2026: SolarEdge, Enphase Energy, or First Solar? | 24/7 Wall St. | 2026-09-07 |
| SolarEdge (SEDG) Stock May Be 11% Overvalued Despite UBS Upgrade | Simply Wall St. | 2026-09-06 |
| SolarEdge Technologies (SEDG) Is Up 8.9% After Profitability Rebound But Soft Outlook - What's Changed | Simply Wall St. | 2026-09-06 |
| SolarEdge (SEDG) Stock Fair Value Moves Lower As Analysts Split On Demand Outlook | Simply Wall St. | 2026-09-05 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $34.20; 52w high $78.51 (-56.44%); 52w low $28.47 (+20.13%) |
| Trend | -18.66% vs SMA200, -18.09% vs SMA50, +6.59% vs SMA20 |
| Momentum | RSI(14) 47.0 (neutral) |
| Volatility | ATR(14) 2.49 (~7.3% of price); beta 1.44 |
| Setup perspective | -56.44% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 35.27, P/S 1.58, P/B 5.11 | EV/Sales 1.48, EV/EBITDA -16.22 |
...
- **Valuation risk:** Forward P/E 35.27, EV/Sales 1.48. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.44, ATR 7.3% of price, short float 23.21%. Size positions accordingly.
...
|---|---|---|---|
| Price | $34.20 | EV/Sales | 1.48 |
| Market cap | $2.10B | EV/EBITDA | -16.22 |
| Beta | 1.44 | Gross margin | 21.25% |
| RSI(14) | 47.0 | Operating margin | -6.51% |
| ATR(14) | 2.49 | Profit margin | -20.29% |
| SMA20 dist | +6.59% | ROA | -3.84% |
| SMA50 dist | -18.09% | ROE | -58.42% |
| SMA200 dist | -18.66% | Revenue (ttm) | $1.33B |
| 52W high | $78.51 | Revenue growth y/y | 19.60% |
| 52W low | $28.47 | Inst. ownership | 101.88% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 35.27 | Short float | 23.21% |
| PEG (trailing) | — | Avg volume | 2,928,722 |
| P/S | 1.58 | Employees | 3,576 |
| P/B | 5.11 | Analyst rec (1=buy..5=sell) | 3.0 |

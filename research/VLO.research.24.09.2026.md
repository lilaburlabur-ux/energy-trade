...
Signed file: `VLO.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $382.86 (2026-09-24, ~15-min delayed) |
| Market cap | $110.24B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $382.86; 52w high $413.28 (-7.36%); 52w low $153.14 (+150.00%) |
| Trend | +52.47% vs SMA200, +11.67% vs SMA50, +0.96% vs SMA20 |
| Momentum | RSI(14) 56.2 (neutral) |
| Volatility | ATR(14) 15.38 (~4.0% of price); beta 0.57 |
...
| SMA20 dist | +0.96% | ROA | 10.56% |
| SMA50 dist | +11.67% | ROE | 27.64% |
| SMA200 dist | +52.47% | Revenue (ttm) | $132.43B |

...
Signed file: `HAL.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $35.34 (2026-08-21, ~15-min delayed) |
| Market cap | $29.44B |
...
|---|---|---|
| Technical momentum | High | 1Y +71.37%; price +3.39% vs SMA200. |
| Fresh setup quality | Moderate / wait | -17.43% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 7.16%, revenue growth 3.70%. |
| Value attractiveness | Reasonable | Forward P/E 12.15, EV/Sales 1.61. |
| Risk level | Moderate | Beta 0.75, ATR 2.7% of price, short float 5.76%. |
...
| Liberty Energy (LBRT) Down 1.9% Since Last Earnings Report: Can It Rebound? | Zacks | 2026-08-21 |
| Is RPC Stock Attractive as Margin Gains Meet Soft Industry Activity? | Zacks | 2026-08-21 |
| Halliburton (HAL) Up 6% Since Last Earnings Report: Can It Continue? | Zacks | 2026-08-20 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $35.34; 52w high $42.80 (-17.43%); 52w low $20.80 (+69.92%) |
| Trend | +3.39% vs SMA200, +3.39% vs SMA50, +6.71% vs SMA20 |
| Momentum | RSI(14) 59.2 (neutral) |
| Volatility | ATR(14) 0.97 (~2.7% of price); beta 0.75 |
| Setup perspective | -17.43% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.50, forward P/E 12.15, P/S 1.32, P/B 2.68 | EV/Sales 1.61, EV/EBITDA 8.68 |
...
|---|---|---|---|
| Price | $35.34 | EV/Sales | 1.61 |
| Market cap | $29.44B | EV/EBITDA | 8.68 |
| Beta | 0.75 | Gross margin | 15.08% |
| RSI(14) | 59.2 | Operating margin | 12.79% |
| ATR(14) | 0.97 | Profit margin | 7.16% |
| SMA20 dist | +6.71% | ROA | 7.26% |
| SMA50 dist | +3.39% | ROE | 14.92% |
| SMA200 dist | +3.39% | Revenue (ttm) | $22.37B |
| 52W high | $42.80 | Revenue growth y/y | 3.70% |
| 52W low | $20.80 | Inst. ownership | 90.46% |
| P/E (ttm) | 18.50 | Insider ownership | 0.41% |
| Forward P/E | 12.15 | Short float | 5.76% |
| PEG (trailing) | 0.87 | Avg volume | 11,868,069 |
| P/S | 1.32 | Employees | 46,000 |
| P/B | 2.68 | Analyst rec (1=buy..5=sell) | 1.8 |

...
Signed file: `UEC.research.28.08.2026`
...
|---|---|---|
| Technical momentum | Moderate | 1Y +27.29%; price +2.63% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E -151.33, EV/Sales 309.61. |
| Risk level | High | Beta 1.21, ATR 5.1% of price, short float 14.55%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $13.62; 52w high $20.14 (-32.37%); 52w low $9.04 (+50.66%) |
| Trend | +2.63% vs SMA200, +26.72% vs SMA50, +18.64% vs SMA20 |
| Momentum | RSI(14) 70.7 (overbought) |
| Volatility | ATR(14) 0.69 (~5.1% of price); beta 1.21 |
...
- **Volatility risk:** Beta 1.21, ATR 5.1% of price, short float 14.55%. Size positions accordingly.
...
| SMA20 dist | +18.64% | ROA | -6.25% |
| SMA50 dist | +26.72% | ROE | -8.96% |
| SMA200 dist | +2.63% | Revenue (ttm) | $20.20M |

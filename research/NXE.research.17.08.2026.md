...
Signed file: `NXE.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $10.75 (2026-08-17, ~15-min delayed) |
| Market cap | $7.21B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +58.55%; price +0.58% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E -65.43, EV/Sales —. |
| Risk level | Elevated | Beta 1.65, ATR 4.4% of price, short float —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.75; 52w high $13.92 (-22.77%); 52w low $6.46 (+66.41%) |
| Trend | +0.58% vs SMA200, +10.29% vs SMA50, +9.70% vs SMA20 |
| Momentum | RSI(14) 64.4 (neutral) |
| Volatility | ATR(14) 0.47 (~4.4% of price); beta 1.65 |
...
| Valuation | P/E —, forward P/E -65.43, P/S —, P/B 5.89 | EV/Sales —, EV/EBITDA -60.97 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $19.38 (1 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 54.96% |
...
- **Volatility risk:** Beta 1.65, ATR 4.4% of price, short float —. Size positions accordingly.
...
|---|---|---|---|
| Price | $10.75 | EV/Sales | — |
| Market cap | $7.21B | EV/EBITDA | -60.97 |
| Beta | 1.65 | Gross margin | 0.00% |
| RSI(14) | 64.4 | Operating margin | 0.00% |
| ATR(14) | 0.47 | Profit margin | 0.00% |
| SMA20 dist | +9.70% | ROA | -3.39% |
| SMA50 dist | +10.29% | ROE | -17.67% |
| SMA200 dist | +0.58% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $6.46 | Inst. ownership | 54.96% |
| P/E (ttm) | — | Insider ownership | 6.39% |
| Forward P/E | -65.43 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,503,727 |
| P/S | — | Employees | 142 |
| P/B | 5.89 | Analyst rec (1=buy..5=sell) | 1.5 |

...
Signed file: `XOM.research.07.09.2026`

| Field | Value |
|---|---|
| Current price | $159.47 (2026-09-07, ~15-min delayed) |
| Market cap | $655.73B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +45.99%; price +11.46% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 14.79, EV/Sales 1.92. |
| Risk level | Moderate | Beta 0.17, ATR 2.1% of price, short float 1.00%. |
...
|---|---|---|
| TotalEnergies Gains 1.5% After Cutting Papua LNG Exposure by One-Third | GuruFocus.com | 2026-09-07 |
| 2 Safe High-Yield Energy Dividend Stocks You've Probably Never Heard Of | Motley Fool | 2026-09-07 |
| TotalEnergies to transfer Papua LNG operatorship to ExxonMobil | Offshore Technology | 2026-09-07 |
| TotalEnergies Cuts Papua LNG Cost to $14 Billion, Exxon to Become Operator | Oilprice.com | 2026-09-07 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $159.47; 52w high $169.22 (-5.76%); 52w low $106.15 (+50.23%) |
| Trend | +11.46% vs SMA200, +4.72% vs SMA50, -1.05% vs SMA20 |
| Momentum | RSI(14) 51.6 (neutral) |
| Volatility | ATR(14) 3.39 (~2.1% of price); beta 0.17 |
...
| Valuation | P/E 20.52, forward P/E 14.79, P/S 1.82, P/B 2.53 | EV/Sales 1.92, EV/EBITDA 10.22 |
...
|---|---|---|---|
| Price | $159.47 | EV/Sales | 1.92 |
| Market cap | $655.73B | EV/EBITDA | 10.22 |
| Beta | 0.17 | Gross margin | 29.77% |
| RSI(14) | 51.6 | Operating margin | 15.86% |
| ATR(14) | 3.39 | Profit margin | 9.07% |
| SMA20 dist | -1.05% | ROA | 5.52% |
| SMA50 dist | +4.72% | ROE | 12.58% |
| SMA200 dist | +11.46% | Revenue (ttm) | $361.06B |
| 52W high | $169.22 | Revenue growth y/y | 44.10% |
| 52W low | $106.15 | Inst. ownership | 67.10% |
| P/E (ttm) | 20.52 | Insider ownership | 0.08% |
| Forward P/E | 14.79 | Short float | 1.00% |
| PEG (trailing) | 1.39 | Avg volume | 15,579,228 |
| P/S | 1.82 | Employees | 57,900 |
| P/B | 2.53 | Analyst rec (1=buy..5=sell) | 2.3 |

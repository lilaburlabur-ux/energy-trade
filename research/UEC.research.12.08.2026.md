...
Signed file: `UEC.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $11.36 (2026-08-12, ~15-min delayed) |
| Market cap | $5.57B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-15.05%) with negative half-year (-30.48%). |
...
| Value attractiveness | Reasonable | Forward P/E -126.22, EV/Sales 256.69. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.36; 52w high $20.14 (-43.59%); 52w low $9.04 (+25.66%) |
| Trend | -15.05% vs SMA200, +5.40% vs SMA50, +12.60% vs SMA20 |
| Momentum | RSI(14) 60.5 (neutral) |
| Volatility | ATR(14) 0.59 (~5.2% of price); beta 1.21 |
...
| Valuation | P/E —, forward P/E -126.22, P/S 275.69, P/B 3.94 | EV/Sales 256.69, EV/EBITDA -42.94 |
...
|---|---|---|---|
| Price | $11.36 | EV/Sales | 256.69 |
| Market cap | $5.57B | EV/EBITDA | -42.94 |
| Beta | 1.21 | Gross margin | 0.00% |
| RSI(14) | 60.5 | Operating margin | -629.66% |
| ATR(14) | 0.59 | Profit margin | 0.00% |
| SMA20 dist | +12.60% | ROA | -6.25% |
| SMA50 dist | +5.40% | ROE | -8.96% |
| SMA200 dist | -15.05% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 86.90% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -126.22 | Short float | 14.38% |
| PEG (trailing) | — | Avg volume | 9,853,862 |
| P/S | 275.69 | Employees | 171 |
| P/B | 3.94 | Analyst rec (1=buy..5=sell) | 1.4 |

...
Signed file: `APA.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $44.84 (2026-09-09, ~15-min delayed) |
| Market cap | $15.71B |
...
|---|---|---|
| Technical momentum | High | 1Y +108.46%; price +34.11% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.33, EV/Sales 2.29. |
| Risk level | Elevated | Beta 0.37, ATR 3.2% of price, short float 9.82%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $44.84; 52w high $44.84 (+0.00%); 52w low $20.93 (+114.24%) |
| Trend | +34.11% vs SMA200, +17.35% vs SMA50, +5.07% vs SMA20 |
| Momentum | RSI(14) 64.7 (neutral) |
| Volatility | ATR(14) 1.43 (~3.2% of price); beta 0.37 |
...
| Valuation | P/E 9.46, forward P/E 10.33, P/S 1.83, P/B 2.24 | EV/Sales 2.29, EV/EBITDA 3.43 |
...
- **Volatility risk:** Beta 0.37, ATR 3.2% of price, short float 9.82%. Size positions accordingly.
...
|---|---|---|---|
| Price | $44.84 | EV/Sales | 2.29 |
| Market cap | $15.71B | EV/EBITDA | 3.43 |
| Beta | 0.37 | Gross margin | 78.25% |
| RSI(14) | 64.7 | Operating margin | 56.33% |
| ATR(14) | 1.43 | Profit margin | 19.56% |
| SMA20 dist | +5.07% | ROA | 11.60% |
| SMA50 dist | +17.35% | ROE | 26.66% |
| SMA200 dist | +34.11% | Revenue (ttm) | $8.57B |
| 52W high | $44.84 | Revenue growth y/y | 9.20% |
| 52W low | $20.93 | Inst. ownership | 109.89% |
| P/E (ttm) | 9.46 | Insider ownership | 0.44% |
| Forward P/E | 10.33 | Short float | 9.82% |
| PEG (trailing) | 1.17 | Avg volume | 5,546,440 |

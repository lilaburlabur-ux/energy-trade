...
| Field | Value |
|---|---|
| Current price | $40.00 (2026-08-13, ~15-min delayed) |
| Market cap | $14.01B |
...
|---|---|---|
| Technical momentum | High | 1Y +102.52%; price +26.45% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 9.50, EV/Sales 2.14. |
| Risk level | High | Beta 0.35, ATR 3.6% of price, short float 11.31%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $40.00; 52w high $43.79 (-8.65%); 52w low $19.56 (+104.52%) |
| Trend | +26.45% vs SMA200, +13.07% vs SMA50, +8.55% vs SMA20 |
| Momentum | RSI(14) 63.8 (neutral) |
| Volatility | ATR(14) 1.44 (~3.6% of price); beta 0.35 |
...
- **Volatility risk:** Beta 0.35, ATR 3.6% of price, short float 11.31%. Size positions accordingly.
...
|---|---|---|---|
| Price | $40.00 | EV/Sales | 2.14 |
| Market cap | $14.01B | EV/EBITDA | 3.21 |
| Beta | 0.35 | Gross margin | 78.25% |
| RSI(14) | 63.8 | Operating margin | 56.33% |
| ATR(14) | 1.44 | Profit margin | 19.56% |
| SMA20 dist | +8.55% | ROA | 11.60% |

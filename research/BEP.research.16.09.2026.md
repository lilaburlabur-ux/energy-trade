...
Signed file: `BEP.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $29.09 (2026-09-16, ~15-min delayed) |
| Market cap | $14.18B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-6.82%) with negative half-year (-4.56%). |
| Fresh setup quality | Moderate / wait | -20.59% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-1.26%). |
| Value attractiveness | Reasonable | Forward P/E -15.56, EV/Sales 12.79. |
| Risk level | Elevated | Beta 0.98, ATR 3.0% of price, short float 0.61%. |
...
|---|---|---|
| 3 Nuclear Energy Stocks to Buy Before 2026 Ends | Motley Fool | 2026-09-16 |
| Could Buying Brookfield Renewable Today Set You Up for Life? | Motley Fool | 2026-09-10 |
| Forget AI Stocks: This Clean-Power Play Is the Real Winner | Motley Fool | 2026-09-06 |
| Brookfield Renewable Corp's Dividend Analysis | GuruFocus.com | 2026-08-31 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $29.09; 52w high $36.63 (-20.59%); 52w low $24.08 (+20.81%) |
| Trend | -6.82% vs SMA200, -9.10% vs SMA50, -7.04% vs SMA20 |
| Momentum | RSI(14) 32.4 (neutral) |
| Volatility | ATR(14) 0.88 (~3.0% of price); beta 0.98 |
| Setup perspective | -20.59% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E -15.56, P/S 2.23, P/B 2.33 | EV/Sales 12.79, EV/EBITDA 27.11 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $35.64 (14 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 65.46% |
...
|---|---|---|---|
| Brookfield Corp /ON/ | 81,306,719 | 27.09% | 2026-06-30 |
| Royal Bank of Canada | 15,093,939 | 5.03% | 2026-06-30 |
| Principal Financial Group, Inc. | 10,232,351 | 3.41% | 2026-06-30 |
| Bank of Montreal /CAN/ | 8,149,658 | 2.72% | 2026-06-30 |
| FIL LTD | 7,616,731 | 2.54% | 2026-06-30 |
| Morgan Stanley | 6,797,319 | 2.26% | 2026-06-30 |
| Connor Clark & Lunn Investment Management Ltd | 4,706,519 | 1.57% | 2026-06-30 |
| UBS Group AG | 3,834,560 | 1.28% | 2026-06-30 |
| CIBC Asset Management Inc. | 3,470,804 | 1.16% | 2026-06-30 |
| TD Asset Management, Inc | 3,041,490 | 1.01% | 2026-06-30 |

## 6. Risk Review and Setup Plan
- **Volatility risk:** Beta 0.98, ATR 3.0% of price, short float 0.61%. Size positions accordingly.
...
|---|---|---|---|
| Price | $29.09 | EV/Sales | 12.79 |
| Market cap | $14.18B | EV/EBITDA | 27.11 |
| Beta | 0.98 | Gross margin | 51.39% |
| RSI(14) | 32.4 | Operating margin | 17.08% |
| ATR(14) | 0.88 | Profit margin | -1.26% |
| SMA20 dist | -7.04% | ROA | 0.42% |
| SMA50 dist | -9.10% | ROE | 0.40% |
| SMA200 dist | -6.82% | Revenue (ttm) | $6.36B |
| 52W high | $36.63 | Revenue growth y/y | 1.10% |
| 52W low | $24.08 | Inst. ownership | 65.46% |
| P/E (ttm) | — | Insider ownership | 0.02% |
| Forward P/E | -15.56 | Short float | 0.61% |
| PEG (trailing) | — | Avg volume | 930,245 |
| P/S | 2.23 | Employees | 5,870 |
...
## 9. Conclusion
BEP: Low momentum / weak fundamentals / reasonable value / elevated risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

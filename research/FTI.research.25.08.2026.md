...
Signed file: `FTI.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $75.20 (2026-08-25, ~15-min delayed) |
| Market cap | $29.49B |
...
|---|---|---|
| Technical momentum | High | 1Y +108.88%; price +19.51% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.72% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 11.28%, revenue growth 9.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.90, EV/Sales 2.88. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $75.20; 52w high $79.76 (-5.72%); 52w low $35.45 (+112.11%) |
| Trend | +19.51% vs SMA200, +5.21% vs SMA50, +1.58% vs SMA20 |
| Momentum | RSI(14) 52.7 (neutral) |
| Volatility | ATR(14) 2.43 (~3.2% of price); beta 0.74 |
| Setup perspective | -5.72% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.29, forward P/E 20.90, P/S 2.83, P/B 9.03 | EV/Sales 2.88, EV/EBITDA 15.12 |
...
- **Valuation risk:** Forward P/E 20.90, EV/Sales 2.88. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $75.20 | EV/Sales | 2.88 |
| Market cap | $29.49B | EV/EBITDA | 15.12 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 52.7 | Operating margin | 17.69% |
| ATR(14) | 2.43 | Profit margin | 11.28% |
| SMA20 dist | +1.58% | ROA | 9.53% |
| SMA50 dist | +5.21% | ROE | 35.81% |
| SMA200 dist | +19.51% | Revenue (ttm) | $10.42B |
| 52W high | $79.76 | Revenue growth y/y | 9.00% |
| 52W low | $35.45 | Inst. ownership | 101.10% |
| P/E (ttm) | 26.29 | Insider ownership | 1.71% |
| Forward P/E | 20.90 | Short float | 3.44% |
| PEG (trailing) | — | Avg volume | 4,586,638 |
| P/S | 2.83 | Employees | 22,000 |
| P/B | 9.03 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `NEE.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $82.44 (2026-09-10, ~15-min delayed) |
| Market cap | $171.97B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-4.75%) with negative half-year (-8.72%). |
...
| Value attractiveness | Reasonable | Forward P/E 18.78, EV/Sales 10.13. |
...
|---|---|---|
| Can EXC's Rising Revenues Support Sustainable Earnings Growth? | Zacks | 2026-09-10 |
| OpenAI meets with utility leaders on grid risks from rogue AI - report | Investing.com | 2026-09-10 |
| Forget Overvalued Tech: Build an AI Fortress Portfolio With These 5 Dividend Aristocrats | 24/7 Wall St. | 2026-09-10 |
| Should You Buy Vistra Stock For Its Shrinking Share Count? | Trefis | 2026-09-10 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $82.44; 52w high $96.44 (-14.52%); 52w low $67.88 (+21.45%) |
| Trend | -4.75% vs SMA200, -3.80% vs SMA50, -1.56% vs SMA20 |
| Momentum | RSI(14) 38.7 (neutral) |
| Volatility | ATR(14) 1.32 (~1.6% of price); beta 0.64 |
...
| Valuation | P/E 18.53, forward P/E 18.78, P/S 5.99, P/B 3.01 | EV/Sales 10.13, EV/EBITDA 19.92 |
...
|---|---|---|---|
| Price | $82.44 | EV/Sales | 10.13 |
| Market cap | $171.97B | EV/EBITDA | 19.92 |
| Beta | 0.64 | Gross margin | 61.02% |
| RSI(14) | 38.7 | Operating margin | 31.52% |
| ATR(14) | 1.32 | Profit margin | 32.40% |
| SMA20 dist | -1.56% | ROA | 2.44% |
| SMA50 dist | -3.80% | ROE | 11.68% |
| SMA200 dist | -4.75% | Revenue (ttm) | $28.70B |
| 52W high | $96.44 | Revenue growth y/y | 12.40% |
| 52W low | $67.88 | Inst. ownership | 87.10% |
| P/E (ttm) | 18.53 | Insider ownership | 0.12% |
| Forward P/E | 18.78 | Short float | 0.00% |
| PEG (trailing) | 1.67 | Avg volume | 10,975,961 |
| P/S | 5.99 | Employees | 17,400 |
| P/B | 3.01 | Analyst rec (1=buy..5=sell) | — |

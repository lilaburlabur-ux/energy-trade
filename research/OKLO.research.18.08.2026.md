...
Signed file: `OKLO.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $41.36 (2026-08-18, ~15-min delayed) |
| Market cap | $7.69B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-40.52%) with negative half-year (-38.85%). |
| Fresh setup quality | Poor / broken | -76.25% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -41.19, EV/Sales 4,711.78. |
| Risk level | High | Beta 1.20, ATR 8.2% of price, short float 18.60%. |
...
|---|---|---|
| Inside the Race to Build America’s First Nuclear Reactor in a Generation | The Wall Street Journal | 2026-08-18 |
| NuScale Power Falls 6% With Q2 Revenue Drop to $75,000 and a New $750M Share Sale | 24/7 Wall St. | 2026-08-18 |
| Oklo Built a Nuclear Reactor in 229 Days. Here's Why the CEO Calls It a World Record. | Motley Fool | 2026-08-17 |
| Could Industrial Heat Unlock New Growth for NuScale Stock? | Zacks | 2026-08-17 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $41.36; 52w high $174.14 (-76.25%); 52w low $36.84 (+12.27%) |
| Trend | -40.52% vs SMA200, -14.28% vs SMA50, -3.56% vs SMA20 |
| Momentum | RSI(14) 43.4 (neutral) |
| Volatility | ATR(14) 3.39 (~8.2% of price); beta 1.20 |
| Setup perspective | -76.25% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -41.19, P/S 6,358.42, P/B 2.34 | EV/Sales 4,711.78, EV/EBITDA -26.30 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $79.88 (20 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 46.99% |
...
- **Volatility risk:** Beta 1.20, ATR 8.2% of price, short float 18.60%. Size positions accordingly.
...
|---|---|---|---|
| Price | $41.36 | EV/Sales | 4,711.78 |
| Market cap | $7.69B | EV/EBITDA | -26.30 |
| Beta | 1.20 | Gross margin | 40.41% |
| RSI(14) | 43.4 | Operating margin | -6048.76% |
| ATR(14) | 3.39 | Profit margin | 0.00% |
| SMA20 dist | -3.56% | ROA | -6.65% |
| SMA50 dist | -14.28% | ROE | -7.70% |
| SMA200 dist | -40.52% | Revenue (ttm) | $1.21M |
| 52W high | $174.14 | Revenue growth y/y | — |
| 52W low | $36.84 | Inst. ownership | 46.99% |
| P/E (ttm) | — | Insider ownership | 15.43% |
| Forward P/E | -41.19 | Short float | 18.60% |
| PEG (trailing) | — | Avg volume | 11,092,774 |
| P/S | 6,358.42 | Employees | 215 |

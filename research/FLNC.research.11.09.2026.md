...
Signed file: `FLNC.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $9.93 (2026-09-11, ~15-min delayed) |
| Market cap | $1.85B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-44.64%) with negative half-year (-39.52%). |
| Fresh setup quality | Poor / broken | -69.19% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 77.61, EV/Sales 0.58. |
| Risk level | High | Beta 2.74, ATR 8.0% of price, short float 34.01%. |
...
|---|---|---|
| Spotting Winners: Fluence Energy (NASDAQ:FLNC) And Renewable Energy Stocks In Q2 | StockStory | 2026-09-11 |
| 1 Russell 2000 Stock with Exciting Potential and 2 Facing Challenges | StockStory | 2026-09-11 |
| Why Analysts Are Bearish On This Tesla Energy Rival | Investor's Business Daily | 2026-09-10 |
| FLNC Stock Trades at a Discount: Should You Buy, Sell or Hold? | Zacks | 2026-09-09 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.93; 52w high $32.23 (-69.19%); 52w low $6.94 (+43.08%) |
| Trend | -44.64% vs SMA200, -24.24% vs SMA50, -10.11% vs SMA20 |
| Momentum | RSI(14) 35.9 (neutral) |
| Volatility | ATR(14) 0.80 (~8.0% of price); beta 2.74 |
| Setup perspective | -69.19% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 77.61, P/S 0.70, P/B 3.81 | EV/Sales 0.58, EV/EBITDA -19.48 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $15.47 (19 analysts) |
...
- **Valuation risk:** Forward P/E 77.61, EV/Sales 0.58. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.74, ATR 8.0% of price, short float 34.01%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.93 | EV/Sales | 0.58 |
| Market cap | $1.85B | EV/EBITDA | -19.48 |
| Beta | 2.74 | Gross margin | 9.36% |
| RSI(14) | 35.9 | Operating margin | -8.85% |
| ATR(14) | 0.80 | Profit margin | -3.07% |
| SMA20 dist | -10.11% | ROA | -2.95% |
| SMA50 dist | -24.24% | ROE | -23.54% |
| SMA200 dist | -44.64% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.94 | Inst. ownership | 85.01% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 77.61 | Short float | 34.01% |
| PEG (trailing) | — | Avg volume | 7,878,030 |
| P/S | 0.70 | Employees | 1,670 |
| P/B | 3.81 | Analyst rec (1=buy..5=sell) | 2.7 |

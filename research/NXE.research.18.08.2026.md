...
Signed file: `NXE.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $10.26 (2026-08-18, ~15-min delayed) |
| Market cap | $6.79B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-4.03%) with negative half-year (-11.70%). |
| Fresh setup quality | Poor / broken | -26.29% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -58.33, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.26; 52w high $13.92 (-26.29%); 52w low $6.46 (+58.82%) |
| Trend | -4.03% vs SMA200, +5.27% vs SMA50, +4.12% vs SMA20 |
| Momentum | RSI(14) 54.8 (neutral) |
| Volatility | ATR(14) 0.49 (~4.8% of price); beta 1.65 |
| Setup perspective | -26.29% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -58.33, P/S —, P/B 5.62 | EV/Sales —, EV/EBITDA -63.20 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $19.36 (1 analysts) |
...
|---|---|---|---|
| Price | $10.26 | EV/Sales | — |
| Market cap | $6.79B | EV/EBITDA | -63.20 |
| Beta | 1.65 | Gross margin | 0.00% |
| RSI(14) | 54.8 | Operating margin | 0.00% |
| ATR(14) | 0.49 | Profit margin | 0.00% |
| SMA20 dist | +4.12% | ROA | -3.39% |
| SMA50 dist | +5.27% | ROE | -17.67% |
| SMA200 dist | -4.03% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $6.46 | Inst. ownership | 54.94% |
| P/E (ttm) | — | Insider ownership | 6.39% |
| Forward P/E | -58.33 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,676,298 |
| P/S | — | Employees | 142 |
| P/B | 5.62 | Analyst rec (1=buy..5=sell) | 1.5 |

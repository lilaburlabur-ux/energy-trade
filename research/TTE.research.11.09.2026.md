...
Signed file: `TTE.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $91.89 (2026-09-11, ~15-min delayed) |
| Market cap | $203.06B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +54.09%; price +14.00% vs SMA200. |
| Fresh setup quality | Watch | -1.83% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 9.08%, revenue growth 27.80%. |
| Value attractiveness | Reasonable | Forward P/E 8.87, EV/Sales 1.21. |
...
| Jane Street’s 2 New Energy Stock Picks | Insider Monkey | 2026-09-11 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $91.89; 52w high $93.60 (-1.83%); 52w low $55.92 (+64.32%) |
| Trend | +14.00% vs SMA200, +7.15% vs SMA50, +2.86% vs SMA20 |
| Momentum | RSI(14) 63.2 (neutral) |
| Volatility | ATR(14) 1.61 (~1.8% of price); beta 0.06 |
| Setup perspective | -1.83% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 11.50, forward P/E 8.87, P/S 1.03, P/B 1.59 | EV/Sales 1.21, EV/EBITDA 5.97 |
| Growth expectations | Earnings growth 106.00%, EPS q/q 102.40% | Analyst mean target $96.40 (10 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 54.15% |
...
|---|---|---|---|
| Price | $91.89 | EV/Sales | 1.21 |
| Market cap | $203.06B | EV/EBITDA | 5.97 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 63.2 | Operating margin | 12.79% |
| ATR(14) | 1.61 | Profit margin | 9.08% |
| SMA20 dist | +2.86% | ROA | 5.51% |
| SMA50 dist | +7.15% | ROE | 14.48% |
| SMA200 dist | +14.00% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 54.15% |
| P/E (ttm) | 11.50 | Insider ownership | 8.86% |
| Forward P/E | 8.87 | Short float | 0.22% |
| PEG (trailing) | 0.83 | Avg volume | 1,670,025 |

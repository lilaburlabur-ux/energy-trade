...
Signed file: `AR.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $37.37 (2026-08-14, ~15-min delayed) |
| Market cap | $11.49B |
...
| Risk level | Elevated | Beta 0.34, ATR 3.1% of price, short float 4.48%. |
...
- **Volatility risk:** Beta 0.34, ATR 3.1% of price, short float 4.48%. Size positions accordingly.
...
| Forward P/E | 8.55 | Short float | 4.48% |
| PEG (trailing) | 0.49 | Avg volume | 4,742,851 |

...
Signed file: `UEC.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $13.13 (2026-08-26, ~15-min delayed) |
| Market cap | $6.44B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-1.01%) with negative half-year (-15.99%). |
| Fresh setup quality | Poor / broken | -34.81% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -145.89, EV/Sales 301.03. |
| Risk level | High | Beta 1.21, ATR 5.3% of price, short float 14.55%. |
...
|---|---|---|
| NuScale Power Tumbles 7% Despite Deploying AI Tools, Oklo Slides 6%, Uranium Energy Dips | 24/7 Wall St. | 2026-08-26 |
| NuScale Power Deploys AI to Accelerate Next-Generation Nuclear SMRs | Zacks | 2026-08-26 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $13.13; 52w high $20.14 (-34.81%); 52w low $9.04 (+45.24%) |
| Trend | -1.01% vs SMA200, +22.61% vs SMA50, +16.33% vs SMA20 |
| Momentum | RSI(14) 67.8 (neutral) |
| Volatility | ATR(14) 0.69 (~5.3% of price); beta 1.21 |
| Setup perspective | -34.81% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -145.89, P/S 318.64, P/B 4.56 | EV/Sales 301.03, EV/EBITDA -50.35 |
...
- **Volatility risk:** Beta 1.21, ATR 5.3% of price, short float 14.55%. Size positions accordingly.
...
|---|---|---|---|
| Price | $13.13 | EV/Sales | 301.03 |
| Market cap | $6.44B | EV/EBITDA | -50.35 |
| Beta | 1.21 | Gross margin | 0.00% |
| RSI(14) | 67.8 | Operating margin | -629.66% |
| ATR(14) | 0.69 | Profit margin | 0.00% |
| SMA20 dist | +16.33% | ROA | -6.25% |
| SMA50 dist | +22.61% | ROE | -8.96% |
| SMA200 dist | -1.01% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 88.45% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -145.89 | Short float | 14.55% |
| PEG (trailing) | — | Avg volume | 9,580,153 |
| P/S | 318.64 | Employees | 171 |
| P/B | 4.56 | Analyst rec (1=buy..5=sell) | — |

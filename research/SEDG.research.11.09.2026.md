...
Signed file: `SEDG.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $34.68 (2026-09-11, ~15-min delayed) |
| Market cap | $2.13B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-17.58%) with negative half-year (-1.45%). |
...
| Value attractiveness | Low (expensive) | Forward P/E 35.76, EV/Sales 1.59. |
| Risk level | High | Beta 1.44, ATR 8.4% of price, short float 25.50%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $34.68; 52w high $78.51 (-55.83%); 52w low $28.47 (+21.81%) |
| Trend | -17.58% vs SMA200, -13.70% vs SMA50, +5.88% vs SMA20 |
| Momentum | RSI(14) 48.1 (neutral) |
| Volatility | ATR(14) 2.93 (~8.4% of price); beta 1.44 |
| Setup perspective | -55.83% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 35.76, P/S 1.60, P/B 5.18 | EV/Sales 1.59, EV/EBITDA -17.52 |
...
- **Valuation risk:** Forward P/E 35.76, EV/Sales 1.59. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.44, ATR 8.4% of price, short float 25.50%. Size positions accordingly.
...
|---|---|---|---|
| Price | $34.68 | EV/Sales | 1.59 |
| Market cap | $2.13B | EV/EBITDA | -17.52 |
| Beta | 1.44 | Gross margin | 21.25% |
| RSI(14) | 48.1 | Operating margin | -6.51% |
| ATR(14) | 2.93 | Profit margin | -20.29% |
| SMA20 dist | +5.88% | ROA | -3.84% |
| SMA50 dist | -13.70% | ROE | -58.42% |
| SMA200 dist | -17.58% | Revenue (ttm) | $1.33B |
| 52W high | $78.51 | Revenue growth y/y | 19.60% |
| 52W low | $28.47 | Inst. ownership | 101.89% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 35.76 | Short float | 25.50% |
| PEG (trailing) | — | Avg volume | 3,054,193 |
| P/S | 1.60 | Employees | 3,576 |
| P/B | 5.18 | Analyst rec (1=buy..5=sell) | 3.0 |

...
Signed file: `PR.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $21.68 (2026-09-23, ~15-min delayed) |
| Market cap | $18.16B |
...
|---|---|---|
| Technical momentum | High | 1Y +69.31%; price +15.11% vs SMA200. |
| Fresh setup quality | Moderate / wait | -10.89% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 21.52%, revenue growth 55.10%. |
| Value attractiveness | Reasonable | Forward P/E 9.75, EV/Sales 3.63. |
| Risk level | Elevated | Beta 0.48, ATR 3.3% of price, short float 2.47%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $21.68; 52w high $24.33 (-10.89%); 52w low $11.68 (+85.56%) |
| Trend | +15.11% vs SMA200, -0.89% vs SMA50, -6.39% vs SMA20 |
| Momentum | RSI(14) 40.6 (neutral) |
| Volatility | ATR(14) 0.71 (~3.3% of price); beta 0.48 |
| Setup perspective | -10.89% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 14.45, forward P/E 9.75, P/S 3.16, P/B 1.51 | EV/Sales 3.63, EV/EBITDA 4.90 |
...
- **Volatility risk:** Beta 0.48, ATR 3.3% of price, short float 2.47%. Size positions accordingly.
...
|---|---|---|---|
| Price | $21.68 | EV/Sales | 3.63 |
| Market cap | $18.16B | EV/EBITDA | 4.90 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 40.6 | Operating margin | 57.44% |
| ATR(14) | 0.71 | Profit margin | 21.52% |
| SMA20 dist | -6.39% | ROA | 7.54% |
| SMA50 dist | -0.89% | ROE | 11.40% |
| SMA200 dist | +15.11% | Revenue (ttm) | $5.74B |
| 52W high | $24.33 | Revenue growth y/y | 55.10% |
| 52W low | $11.68 | Inst. ownership | 92.73% |
| P/E (ttm) | 14.45 | Insider ownership | 4.61% |
| Forward P/E | 9.75 | Short float | 2.47% |
| PEG (trailing) | 1.23 | Avg volume | 9,826,025 |
| P/S | 3.16 | Employees | 515 |

...
Signed file: `HAL.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $35.02 (2026-08-19, ~15-min delayed) |
| Market cap | $29.18B |
...
|---|---|---|
| Technical momentum | High | 1Y +67.99%; price +2.72% vs SMA200. |
| Fresh setup quality | Moderate / wait | -18.17% from 52w high; no clean fresh pivot by default. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $35.02; 52w high $42.80 (-18.17%); 52w low $20.62 (+69.82%) |
| Trend | +2.72% vs SMA200, +1.95% vs SMA50, +6.54% vs SMA20 |
| Momentum | RSI(14) 58.6 (neutral) |
| Volatility | ATR(14) 0.97 (~2.8% of price); beta 0.75 |
| Setup perspective | -18.17% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.34, forward P/E 12.04, P/S 1.30, P/B 2.65 | EV/Sales 1.57, EV/EBITDA 8.47 |
...
|---|---|---|---|
| Price | $35.02 | EV/Sales | 1.57 |
| Market cap | $29.18B | EV/EBITDA | 8.47 |
| Beta | 0.75 | Gross margin | 15.08% |
| RSI(14) | 58.6 | Operating margin | 12.79% |
| ATR(14) | 0.97 | Profit margin | 7.16% |
| SMA20 dist | +6.54% | ROA | 7.26% |
| SMA50 dist | +1.95% | ROE | 14.92% |
| SMA200 dist | +2.72% | Revenue (ttm) | $22.37B |
| 52W high | $42.80 | Revenue growth y/y | 3.70% |
| 52W low | $20.62 | Inst. ownership | 90.98% |
| P/E (ttm) | 18.34 | Insider ownership | 0.43% |
| Forward P/E | 12.04 | Short float | 5.76% |
| PEG (trailing) | 0.85 | Avg volume | 11,891,920 |

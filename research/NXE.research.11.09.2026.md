...
Signed file: `NXE.research.11.09.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-9.37%) with negative half-year (-20.95%). |
...
| Value attractiveness | Reasonable | Forward P/E -50.99, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.85; 52w high $13.92 (-29.24%); 52w low $7.56 (+30.29%) |
| Trend | -9.37% vs SMA200, -0.87% vs SMA50, -6.75% vs SMA20 |
| Momentum | RSI(14) 42.7 (neutral) |
| Volatility | ATR(14) 0.46 (~4.7% of price); beta 1.67 |
...
| Valuation | P/E —, forward P/E -50.99, P/S —, P/B 4.93 | EV/Sales —, EV/EBITDA -57.64 |
...
|---|---|---|---|
| Price | $9.85 | EV/Sales | — |
| Market cap | $6.60B | EV/EBITDA | -57.64 |
| Beta | 1.67 | Gross margin | 0.00% |
| RSI(14) | 42.7 | Operating margin | 0.00% |
| ATR(14) | 0.46 | Profit margin | 0.00% |
| SMA20 dist | -6.75% | ROA | -3.39% |
| SMA50 dist | -0.87% | ROE | -17.67% |
| SMA200 dist | -9.37% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.56 | Inst. ownership | 55.24% |
| P/E (ttm) | — | Insider ownership | 6.40% |
| Forward P/E | -50.99 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,021,538 |
| P/S | — | Employees | 142 |
| P/B | 4.93 | Analyst rec (1=buy..5=sell) | 1.5 |

...
Signed file: `LEU.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $151.31 (2026-09-23, ~15-min delayed) |
| Market cap | $3.09B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-26.27%) with negative half-year (-21.85%). |
| Fresh setup quality | Poor / broken | -65.30% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.23%, revenue growth 14.00%. |
| Value attractiveness | Low (expensive) | Forward P/E 40.25, EV/Sales 4.91. |
| Risk level | High | Beta 1.33, ATR 7.3% of price, short float 28.54%. |
...
| Q2 Earnings Outperformers: Centrus Energy (NYSE:LEU) And The Rest Of The Mixed or Offshore Upstream E&P Stocks | StockStory | 2026-09-23 |
| 1 Small-Cap Stock with Exciting Potential and 2 We Find Risky | StockStory | 2026-09-21 |
| A Safer Way to Bet on Nuclear | The Wall Street Journal | 2026-09-21 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $151.31; 52w high $436.00 (-65.30%); 52w low $139.01 (+8.85%) |
| Trend | -26.27% vs SMA200, -11.98% vs SMA50, -8.88% vs SMA20 |
| Momentum | RSI(14) 42.8 (neutral) |
| Volatility | ATR(14) 10.98 (~7.3% of price); beta 1.33 |
| Setup perspective | -65.30% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 80.06, forward P/E 40.25, P/S 6.53, P/B 3.57 | EV/Sales 4.91, EV/EBITDA 230.50 |
...
- **Valuation risk:** Forward P/E 40.25, EV/Sales 4.91. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.33, ATR 7.3% of price, short float 28.54%. Size positions accordingly.
...
|---|---|---|---|
| Price | $151.31 | EV/Sales | 4.91 |
| Market cap | $3.09B | EV/EBITDA | 230.50 |
| Beta | 1.33 | Gross margin | 23.66% |
| RSI(14) | 42.8 | Operating margin | 5.34% |
| ATR(14) | 10.98 | Profit margin | 10.23% |
| SMA20 dist | -8.88% | ROA | 0.02% |
| SMA50 dist | -11.98% | ROE | 8.05% |
| SMA200 dist | -26.27% | Revenue (ttm) | $473.90M |
| 52W high | $436.00 | Revenue growth y/y | 14.00% |
| 52W low | $139.01 | Inst. ownership | 88.71% |
| P/E (ttm) | 80.06 | Insider ownership | 4.20% |
| Forward P/E | 40.25 | Short float | 28.54% |
| PEG (trailing) | — | Avg volume | 747,668 |
| P/S | 6.53 | Employees | 467 |
| P/B | 3.57 | Analyst rec (1=buy..5=sell) | 1.8 |

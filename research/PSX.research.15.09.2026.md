...
Signed file: `PSX.research.15.09.2026`
...
|---|---|---|
| Technical momentum | High | 1Y +108.58%; price +51.93% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.78, EV/Sales 0.79. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $264.93; 52w high $264.93 (+0.00%); 52w low $123.11 (+115.19%) |
| Trend | +51.93% vs SMA200, +18.28% vs SMA50, +6.02% vs SMA20 |
| Momentum | RSI(14) 75.3 (overbought) |
| Volatility | ATR(14) 7.34 (~2.8% of price); beta 0.70 |

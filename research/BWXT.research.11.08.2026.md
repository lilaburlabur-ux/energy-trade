...
Signed file: `BWXT.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $169.71 (2026-08-11, ~15-min delayed) |
| Market cap | $15.55B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-13.39%) with negative half-year (-16.17%). |
| Fresh setup quality | Poor / broken | -28.72% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.11%, revenue growth 18.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 32.31, EV/Sales 4.80. |
| Risk level | Elevated | Beta 0.76, ATR 4.1% of price, short float 4.13%. |
...
|---|---|---|
| BWXT (BWXT) Q2 2026 Earnings Call Transcript | Motley Fool | 2026-08-11 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $169.71; 52w high $238.10 (-28.72%); 52w low $157.44 (+7.79%) |
| Trend | -13.39% vs SMA200, -7.70% vs SMA50, -0.71% vs SMA20 |
| Momentum | RSI(14) 43.9 (neutral) |
| Volatility | ATR(14) 6.91 (~4.1% of price); beta 0.76 |
| Setup perspective | -28.72% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 43.85, forward P/E 32.31, P/S 4.42, P/B 16.41 | EV/Sales 4.80, EV/EBITDA 35.44 |
...
- **Valuation risk:** Forward P/E 32.31, EV/Sales 4.80. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.76, ATR 4.1% of price, short float 4.13%. Size positions accordingly.
...
|---|---|---|---|
| Price | $169.71 | EV/Sales | 4.80 |
| Market cap | $15.55B | EV/EBITDA | 35.44 |
| Beta | 0.76 | Gross margin | 22.08% |
| RSI(14) | 43.9 | Operating margin | 10.39% |
| ATR(14) | 6.91 | Profit margin | 10.11% |
| SMA20 dist | -0.71% | ROA | 5.53% |
| SMA50 dist | -7.70% | ROE | 28.29% |
| SMA200 dist | -13.39% | Revenue (ttm) | $3.51B |
| 52W high | $238.10 | Revenue growth y/y | 18.00% |
| 52W low | $157.44 | Inst. ownership | 93.55% |
| P/E (ttm) | 43.85 | Insider ownership | 0.36% |
| Forward P/E | 32.31 | Short float | 4.13% |
| PEG (trailing) | — | Avg volume | 973,367 |
| P/S | 4.42 | Employees | 11,000 |
| P/B | 16.41 | Analyst rec (1=buy..5=sell) | 1.8 |

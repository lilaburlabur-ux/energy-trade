...
Signed file: `DVN.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $47.59 (2026-09-21, ~15-min delayed) |
| Market cap | $52.35B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $47.59; 52w high $51.37 (-7.36%); 52w low $30.95 (+53.76%) |
| Trend | +9.15% vs SMA200, +3.33% vs SMA50, -1.60% vs SMA20 |
| Momentum | RSI(14) 48.9 (neutral) |
| Volatility | ATR(14) 1.39 (~2.9% of price); beta 0.43 |
...
| SMA20 dist | -1.60% | ROA | 5.91% |
| SMA50 dist | +3.33% | ROE | 11.52% |
| SMA200 dist | +9.15% | Revenue (ttm) | $18.78B |

...
Signed file: `RUN.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $7.78 (2026-09-24, ~15-min delayed) |
| Market cap | $1.87B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-43.82%) with negative half-year (-40.34%). |
| Fresh setup quality | Poor / broken | -63.66% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 11.59%, revenue growth 52.80%. |
| Value attractiveness | Reasonable | Forward P/E 7.67, EV/Sales 5.25. |
| Risk level | High | Beta 2.36, ATR 6.1% of price, short float 34.08%. |
...
| Why Sunrun (RUN) Dipped More Than Broader Market Today | Zacks | 2026-09-24 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $7.78; 52w high $21.41 (-63.66%); 52w low $7.78 (+0.00%) |
| Trend | -43.82% vs SMA200, -18.15% vs SMA50, -9.92% vs SMA20 |
| Momentum | RSI(14) 34.3 (neutral) |
| Volatility | ATR(14) 0.48 (~6.1% of price); beta 2.36 |
| Setup perspective | -63.66% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 5.29, forward P/E 7.67, P/S 0.54, P/B 0.54 | EV/Sales 5.25, EV/EBITDA 21.69 |
| Growth expectations | Earnings growth -60.70%, EPS q/q -58.80% | Analyst mean target $15.87 (19 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 116.70% |
...
- **Volatility risk:** Beta 2.36, ATR 6.1% of price, short float 34.08%. Size positions accordingly.
...
|---|---|---|---|
| Price | $7.78 | EV/Sales | 5.25 |
| Market cap | $1.87B | EV/EBITDA | 21.69 |
| Beta | 2.36 | Gross margin | 35.29% |
| RSI(14) | 34.3 | Operating margin | 4.00% |
| ATR(14) | 0.48 | Profit margin | 11.59% |
| SMA20 dist | -9.92% | ROA | 0.26% |
| SMA50 dist | -18.15% | ROE | -19.86% |
| SMA200 dist | -43.82% | Revenue (ttm) | $3.48B |
| 52W high | $21.41 | Revenue growth y/y | 52.80% |
| 52W low | $7.78 | Inst. ownership | 116.70% |
| P/E (ttm) | 5.29 | Insider ownership | 2.82% |
| Forward P/E | 7.67 | Short float | 34.08% |
| PEG (trailing) | 3.07 | Avg volume | 9,064,377 |
| P/S | 0.54 | Employees | 9,059 |
| P/B | 0.54 | Analyst rec (1=buy..5=sell) | 2.0 |

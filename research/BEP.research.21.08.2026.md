...
Signed file: `BEP.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $32.77 (2026-08-21, ~15-min delayed) |
| Market cap | $15.94B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +35.56%; price +4.44% vs SMA200. |
| Fresh setup quality | Moderate / wait | -11.65% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-1.26%). |
| Value attractiveness | Reasonable | Forward P/E -21.39, EV/Sales 13.23. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $32.77; 52w high $37.09 (-11.65%); 52w low $24.11 (+35.94%) |
| Trend | +4.44% vs SMA200, -2.20% vs SMA50, -1.35% vs SMA20 |
| Momentum | RSI(14) 45.9 (neutral) |
| Volatility | ATR(14) 1.03 (~3.2% of price); beta 0.99 |
| Setup perspective | -11.65% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E -21.39, P/S 2.51, P/B 2.63 | EV/Sales 13.23, EV/EBITDA 28.05 |
...
|---|---|---|---|
| Price | $32.77 | EV/Sales | 13.23 |
| Market cap | $15.94B | EV/EBITDA | 28.05 |
| Beta | 0.99 | Gross margin | 51.39% |
| RSI(14) | 45.9 | Operating margin | 17.08% |
| ATR(14) | 1.03 | Profit margin | -1.26% |
| SMA20 dist | -1.35% | ROA | 0.42% |
| SMA50 dist | -2.20% | ROE | 0.40% |
| SMA200 dist | +4.44% | Revenue (ttm) | $6.36B |
| 52W high | $37.09 | Revenue growth y/y | 1.10% |
| 52W low | $24.11 | Inst. ownership | 65.29% |
| P/E (ttm) | — | Insider ownership | 0.02% |
| Forward P/E | -21.39 | Short float | 0.51% |
| PEG (trailing) | — | Avg volume | 916,667 |

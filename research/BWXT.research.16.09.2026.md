...
Signed file: `BWXT.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $145.66 (2026-09-16, ~15-min delayed) |
| Market cap | $13.35B |
...
| 1 Mid-Cap Stock with Exciting Potential and 2 We Question | StockStory | 2026-09-16 |
| BWXT’s Latest NNSA Win Signals Bigger Nuclear Opportunity | Insider Monkey | 2026-09-16 |
| Jim Cramer Favors BWX Technologies (BWXT) Over Cameco (CCJ) | Insider Monkey | 2026-09-15 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $145.66; 52w high $237.73 (-38.73%); 52w low $145.66 (+0.00%) |
| Trend | -23.90% vs SMA200, -11.85% vs SMA50, -5.56% vs SMA20 |
| Momentum | RSI(14) 35.2 (neutral) |
| Volatility | ATR(14) 5.59 (~3.8% of price); beta 0.74 |
| Setup perspective | -38.73% from 52w high — base needs to rebuild. |
...
|---|---|---|---|
| Price | $145.66 | EV/Sales | 4.23 |
| Market cap | $13.35B | EV/EBITDA | 31.17 |
| Beta | 0.74 | Gross margin | 22.08% |
| RSI(14) | 35.2 | Operating margin | 10.39% |
| ATR(14) | 5.59 | Profit margin | 10.11% |
| SMA20 dist | -5.56% | ROA | 5.53% |
| SMA50 dist | -11.85% | ROE | 28.29% |
| SMA200 dist | -23.90% | Revenue (ttm) | $3.51B |

...
Signed file: `SU.research.25.08.2026`
...
|---|---|---|
| Technical momentum | High | 1Y +65.80%; price +15.23% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.65% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 15.78%, revenue growth 45.90%. |
| Value attractiveness | Reasonable | Forward P/E 11.61, EV/Sales 1.56. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $65.36; 52w high $69.27 (-5.65%); 52w low $37.63 (+73.70%) |
| Trend | +15.23% vs SMA200, +6.35% vs SMA50, +0.05% vs SMA20 |
| Momentum | RSI(14) 52.3 (neutral) |
| Volatility | ATR(14) 1.68 (~2.6% of price); beta 0.57 |
| Setup perspective | -5.65% from 52w high; no clean fresh pivot by default. |
...
| SMA50 dist | +6.35% | ROE | 19.25% |
| SMA200 dist | +15.23% | Revenue (ttm) | $56.57B |

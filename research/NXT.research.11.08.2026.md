...
Signed file: `NXT.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $104.88 (2026-08-11, ~15-min delayed) |
| Market cap | $16.11B |
...
|---|---|---|
| Technical momentum | High | 1Y +86.59%; price -4.10% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 18.14, EV/Sales 3.98. |
| Risk level | High | Beta 1.95, ATR 6.5% of price, short float 6.54%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $104.88; 52w high $156.40 (-32.94%); 52w low $53.80 (+94.94%) |
| Trend | -4.10% vs SMA200, -7.08% vs SMA50, +4.29% vs SMA20 |
| Momentum | RSI(14) 51.2 (neutral) |
| Volatility | ATR(14) 6.77 (~6.5% of price); beta 1.95 |
| Setup perspective | -32.94% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 27.10, forward P/E 18.14, P/S 4.44, P/B 6.22 | EV/Sales 3.98, EV/EBITDA 19.28 |
| Growth expectations | Earnings growth 2.90%, EPS q/q 5.20% | Analyst mean target $142.58 (26 analysts) |
...
- **Volatility risk:** Beta 1.95, ATR 6.5% of price, short float 6.54%. Size positions accordingly.
...
|---|---|---|---|
| Price | $104.88 | EV/Sales | 3.98 |
| Market cap | $16.11B | EV/EBITDA | 19.28 |
| Beta | 1.95 | Gross margin | 22.98% |
| RSI(14) | 51.2 | Operating margin | 20.86% |
| ATR(14) | 6.77 | Profit margin | 16.36% |
| SMA20 dist | +4.29% | ROA | 11.68% |
| SMA50 dist | -7.08% | ROE | 27.22% |
| SMA200 dist | -4.10% | Revenue (ttm) | $3.63B |
| 52W high | $156.40 | Revenue growth y/y | 8.20% |
| 52W low | $53.80 | Inst. ownership | 108.72% |
| P/E (ttm) | 27.10 | Insider ownership | 0.68% |
| Forward P/E | 18.14 | Short float | 6.54% |
| PEG (trailing) | 3.15 | Avg volume | 3,280,593 |
| P/S | 4.44 | Employees | 1,993 |
| P/B | 6.22 | Analyst rec (1=buy..5=sell) | 1.5 |

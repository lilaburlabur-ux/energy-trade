...
Signed file: `MPC.research.14.09.2026`
...
|---|---|---|
| Technical momentum | High | 1Y +121.09%; price +61.51% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.71, EV/Sales 0.94. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $396.45; 52w high $399.44 (-0.75%); 52w low $160.76 (+146.60%) |
| Trend | +61.51% vs SMA200, +18.32% vs SMA50, +5.49% vs SMA20 |
| Momentum | RSI(14) 74.9 (overbought) |
| Volatility | ATR(14) 12.07 (~3.0% of price); beta 0.53 |
...
| SMA20 dist | +5.49% | ROA | 8.74% |
| SMA50 dist | +18.32% | ROE | 42.10% |
| SMA200 dist | +61.51% | Revenue (ttm) | $154.15B |

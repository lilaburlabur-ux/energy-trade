...
Signed file: `FLNC.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $7.58 (2026-09-23, ~15-min delayed) |
| Market cap | $1.41B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-56.67%) with negative half-year (-53.07%). |
| Fresh setup quality | Poor / broken | -76.48% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Reasonable | Forward P/E -28.46, EV/Sales 0.45. |
| Risk level | High | Beta 2.74, ATR 9.7% of price, short float 34.01%. |
...
| This High-Growth Energy Stock Continues to Plunge. Don’t Rush to Buy the Dip. | Barchart | 2026-09-22 |
| AI Pick-And-Shovel Stocks To Watch As Xi And Trump Meet | Investor's Business Daily | 2026-09-22 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $7.58; 52w high $32.23 (-76.48%); 52w low $7.27 (+4.26%) |
| Trend | -56.67% vs SMA200, -35.80% vs SMA50, -20.83% vs SMA20 |
| Momentum | RSI(14) 28.0 (oversold) |
| Volatility | ATR(14) 0.73 (~9.7% of price); beta 2.74 |
| Setup perspective | -76.48% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -28.46, P/S 0.54, P/B 2.91 | EV/Sales 0.45, EV/EBITDA -15.04 |
...
- **Volatility risk:** Beta 2.74, ATR 9.7% of price, short float 34.01%. Size positions accordingly.
...
|---|---|---|---|
| Price | $7.58 | EV/Sales | 0.45 |
| Market cap | $1.41B | EV/EBITDA | -15.04 |
| Beta | 2.74 | Gross margin | 9.36% |
| RSI(14) | 28.0 | Operating margin | -8.85% |
| ATR(14) | 0.73 | Profit margin | -3.07% |
| SMA20 dist | -20.83% | ROA | -2.95% |
| SMA50 dist | -35.80% | ROE | -23.54% |
| SMA200 dist | -56.67% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $7.27 | Inst. ownership | 84.60% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | -28.46 | Short float | 34.01% |
| PEG (trailing) | — | Avg volume | 8,094,896 |
| P/S | 0.54 | Employees | 1,670 |
| P/B | 2.91 | Analyst rec (1=buy..5=sell) | 3.0 |

## 8. Analyst Actions
| Date | Action | Firm | Rating change |
|---|---|---|---|
| 2026-09-21 | main | Mizuho | Underperform → Underperform |
| 2026-09-18 | down | Goldman Sachs | Buy → Neutral |
| 2026-09-18 | down | Jefferies | Buy → Hold |

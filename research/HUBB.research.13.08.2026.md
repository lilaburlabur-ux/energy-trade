...
Signed file: `HUBB.research.13.08.2026`
...
|---|---|---|
| Technical momentum | Moderate | 1Y +18.76%; price +5.08% vs SMA200. |
| Fresh setup quality | Moderate / wait | -8.82% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 14.49%, revenue growth 15.30%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 22.17, EV/Sales 5.18. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $507.10; 52w high $556.18 (-8.82%); 52w low $403.70 (+25.61%) |
| Trend | +5.08% vs SMA200, +2.66% vs SMA50, +2.95% vs SMA20 |
| Momentum | RSI(14) 54.4 (neutral) |
| Volatility | ATR(14) 16.70 (~3.3% of price); beta 0.90 |
| Setup perspective | -8.82% from 52w high; no clean fresh pivot by default. |
...
- **Valuation risk:** Forward P/E 22.17, EV/Sales 5.18. Multiple compression is the main downside if growth disappoints.
...
| SMA20 dist | +2.95% | ROA | 8.43% |
| SMA50 dist | +2.66% | ROE | 24.44% |
| SMA200 dist | +5.08% | Revenue (ttm) | $6.22B |
| 52W high | $556.18 | Revenue growth y/y | 15.30% |
| 52W low | $403.70 | Inst. ownership | 100.99% |

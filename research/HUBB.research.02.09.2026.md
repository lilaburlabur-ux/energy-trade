...
Signed file: `HUBB.research.02.09.2026`

| Field | Value |
|---|---|
| Current price | $450.08 (2026-09-02, ~15-min delayed) |
| Market cap | $23.78B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-6.67%) with negative half-year (-7.73%). |
| Fresh setup quality | Moderate / wait | -18.83% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 14.49%, revenue growth 15.30%. |
| Value attractiveness | Reasonable | Forward P/E 19.64, EV/Sales 4.59. |
| Risk level | Moderate | Beta 0.90, ATR 3.0% of price, short float 5.83%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $450.08; 52w high $554.46 (-18.83%); 52w low $402.45 (+11.84%) |
| Trend | -6.67% vs SMA200, -7.45% vs SMA50, -6.58% vs SMA20 |
| Momentum | RSI(14) 37.0 (neutral) |
| Volatility | ATR(14) 13.42 (~3.0% of price); beta 0.90 |
| Setup perspective | -18.83% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.65, forward P/E 19.64, P/S 3.82, P/B 6.08 | EV/Sales 4.59, EV/EBITDA 18.87 |
...
|---|---|---|---|
| Price | $450.08 | EV/Sales | 4.59 |
| Market cap | $23.78B | EV/EBITDA | 18.87 |
| Beta | 0.90 | Gross margin | 35.34% |
| RSI(14) | 37.0 | Operating margin | 21.67% |
| ATR(14) | 13.42 | Profit margin | 14.49% |
| SMA20 dist | -6.58% | ROA | 8.43% |
| SMA50 dist | -7.45% | ROE | 24.44% |
| SMA200 dist | -6.67% | Revenue (ttm) | $6.22B |
| 52W high | $554.46 | Revenue growth y/y | 15.30% |
| 52W low | $402.45 | Inst. ownership | 99.05% |
| P/E (ttm) | 26.65 | Insider ownership | 0.34% |
| Forward P/E | 19.64 | Short float | 5.83% |
| PEG (trailing) | 1.86 | Avg volume | 577,169 |
| P/S | 3.82 | Employees | 19,400 |
| P/B | 6.08 | Analyst rec (1=buy..5=sell) | 1.9 |

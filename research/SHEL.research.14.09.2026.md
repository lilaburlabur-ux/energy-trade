...
Signed file: `SHEL.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $96.45 (2026-09-14, ~15-min delayed) |
| Market cap | $275.79B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +38.90%; price +17.07% vs SMA200. |
| Fresh setup quality | Watch | -0.33% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 8.76%, revenue growth 44.70%. |
| Value attractiveness | Reasonable | Forward P/E 9.33, EV/Sales 1.05. |
| Risk level | Moderate | Beta -0.22, ATR 1.5% of price, short float 1.54%. |
...
| Shell's Troubled Project Faces Another Major Blow | GuruFocus.com | 2026-09-11 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $96.45; 52w high $96.77 (-0.33%); 52w low $68.25 (+41.32%) |
| Trend | +17.07% vs SMA200, +8.31% vs SMA50, +3.46% vs SMA20 |
| Momentum | RSI(14) 69.6 (neutral) |
| Volatility | ATR(14) 1.46 (~1.5% of price); beta -0.22 |
| Setup perspective | -0.33% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 10.67, forward P/E 9.33, P/S 0.93, P/B 1.49 | EV/Sales 1.05, EV/EBITDA 5.41 |
| Growth expectations | Earnings growth 220.00%, EPS q/q 200.50% | Analyst mean target $100.35 (15 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 13.34% |
...
|---|---|---|---|
| Price | $96.45 | EV/Sales | 1.05 |
| Market cap | $275.79B | EV/EBITDA | 5.41 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 69.6 | Operating margin | 16.69% |
| ATR(14) | 1.46 | Profit margin | 8.76% |
| SMA20 dist | +3.46% | ROA | 6.40% |
| SMA50 dist | +8.31% | ROE | 14.34% |
| SMA200 dist | +17.07% | Revenue (ttm) | $296.60B |
| 52W high | $96.77 | Revenue growth y/y | 44.70% |
| 52W low | $68.25 | Inst. ownership | 13.34% |
| P/E (ttm) | 10.67 | Insider ownership | 0.01% |
| Forward P/E | 9.33 | Short float | 1.54% |
| PEG (trailing) | 1.64 | Avg volume | 6,450,256 |

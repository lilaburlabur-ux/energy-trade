...
Signed file: `RUN.research.02.09.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-38.60%) with negative half-year (-26.38%). |
...
| Value attractiveness | Reasonable | Forward P/E 8.83, EV/Sales 5.25. |
| Risk level | High | Beta 2.39, ATR 6.2% of price, short float 32.34%. |
...
|---|---|---|
| Most Active Options Report: DELL, CRDO, GTLB, RUN, ALLY | Schaeffer's Investment Research | 2026-09-02 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $8.96; 52w high $21.41 (-58.15%); 52w low $8.37 (+7.05%) |
| Trend | -38.60% vs SMA200, -17.12% vs SMA50, -4.56% vs SMA20 |
| Momentum | RSI(14) 41.7 (neutral) |
| Volatility | ATR(14) 0.56 (~6.2% of price); beta 2.39 |
| Setup perspective | -58.15% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 2.39, ATR 6.2% of price, short float 32.34%. Size positions accordingly.
...
| SMA20 dist | -4.56% | ROA | 0.26% |
| SMA50 dist | -17.12% | ROE | -19.86% |
| SMA200 dist | -38.60% | Revenue (ttm) | $3.48B |

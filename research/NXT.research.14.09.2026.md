...
Signed file: `NXT.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $82.62 (2026-09-14, ~15-min delayed) |
| Market cap | $12.69B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $82.62; 52w high $156.40 (-47.17%); 52w low $66.70 (+23.87%) |
| Trend | -23.75% vs SMA200, -13.97% vs SMA50, -3.85% vs SMA20 |
| Momentum | RSI(14) 38.3 (neutral) |
| Volatility | ATR(14) 4.49 (~5.4% of price); beta 1.92 |
| Setup perspective | -47.17% from 52w high — base needs to rebuild. |
...
| P/S | 3.50 | Employees | 1,993 |
| P/B | 4.90 | Analyst rec (1=buy..5=sell) | 1.4 |

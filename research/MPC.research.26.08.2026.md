...
Signed file: `MPC.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $362.27 (2026-08-26, ~15-min delayed) |
| Market cap | $105.76B |
...
|---|---|---|
| Technical momentum | High | 1Y +113.92%; price +54.93% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.81% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 5.55%, revenue growth 53.70%. |
| Value attractiveness | Reasonable | Forward P/E 11.25, EV/Sales 0.86. |
| Risk level | Elevated | Beta 0.51, ATR 3.0% of price, short float 2.70%. |
...
| Wall Street Analysts See Marathon Petroleum (MPC) as a Buy: Should You Invest? | Zacks | 2026-08-26 |
| Will Valero's Excess Cash Translate Into Higher Shareholder Returns? | Zacks | 2026-08-26 |
| Marathon Petroleum (MPC) and Valero Energy (VLO) Have Exploded in 2026. But Barron’s Sees More Upside | Insider Monkey | 2026-08-26 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $362.27; 52w high $365.21 (-0.81%); 52w low $160.76 (+125.34%) |
| Trend | +54.93% vs SMA200, +19.60% vs SMA50, +7.60% vs SMA20 |
| Momentum | RSI(14) 69.0 (neutral) |
| Volatility | ATR(14) 10.93 (~3.0% of price); beta 0.51 |
| Setup perspective | -0.81% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 12.56, forward P/E 11.25, P/S 0.69, P/B 5.37 | EV/Sales 0.86, EV/EBITDA 8.63 |
...
- **Volatility risk:** Beta 0.51, ATR 3.0% of price, short float 2.70%. Size positions accordingly.
...
|---|---|---|---|
| Price | $362.27 | EV/Sales | 0.86 |
| Market cap | $105.76B | EV/EBITDA | 8.63 |
| Beta | 0.51 | Gross margin | 12.82% |
| RSI(14) | 69.0 | Operating margin | 13.56% |
| ATR(14) | 10.93 | Profit margin | 5.55% |
| SMA20 dist | +7.60% | ROA | 8.74% |
| SMA50 dist | +19.60% | ROE | 42.10% |
| SMA200 dist | +54.93% | Revenue (ttm) | $154.15B |
| 52W high | $365.21 | Revenue growth y/y | 53.70% |
| 52W low | $160.76 | Inst. ownership | 79.60% |
| P/E (ttm) | 12.56 | Insider ownership | 0.33% |
| Forward P/E | 11.25 | Short float | 2.70% |
| PEG (trailing) | 1.76 | Avg volume | 2,366,985 |

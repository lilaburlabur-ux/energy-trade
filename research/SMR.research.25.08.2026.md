...
Signed file: `SMR.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $9.81 (2026-08-25, ~15-min delayed) |
| Market cap | $4.03B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-28.33%) with negative half-year (-26.95%). |
| Fresh setup quality | Poor / broken | -81.64% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -15.05, EV/Sales 243.30. |
| Risk level | High | Beta 2.31, ATR 7.1% of price, short float 19.43%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.81; 52w high $53.43 (-81.64%); 52w low $7.59 (+29.25%) |
| Trend | -28.33% vs SMA200, +5.60% vs SMA50, +6.56% vs SMA20 |
| Momentum | RSI(14) 55.1 (neutral) |
| Volatility | ATR(14) 0.70 (~7.1% of price); beta 2.31 |
| Setup perspective | -81.64% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -15.05, P/S 376.61, P/B 2.67 | EV/Sales 243.30, EV/EBITDA -11.61 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $12.63 (15 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 59.36% |
...
- **Volatility risk:** Beta 2.31, ATR 7.1% of price, short float 19.43%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.81 | EV/Sales | 243.30 |
| Market cap | $4.03B | EV/EBITDA | -11.61 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 55.1 | Operating margin | -85337.33% |
| ATR(14) | 0.70 | Profit margin | 0.00% |
| SMA20 dist | +6.56% | ROA | -10.60% |
| SMA50 dist | +5.60% | ROE | -55.18% |
| SMA200 dist | -28.33% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.36% |
| P/E (ttm) | — | Insider ownership | 1.69% |
| Forward P/E | -15.05 | Short float | 19.43% |
| PEG (trailing) | — | Avg volume | 32,992,752 |
| P/S | 376.61 | Employees | 428 |
| P/B | 2.67 | Analyst rec (1=buy..5=sell) | 2.6 |

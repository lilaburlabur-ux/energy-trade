...
Signed file: `CEG.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $259.53 (2026-09-16, ~15-min delayed) |
| Market cap | $91.95B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-11.44%) with negative half-year (-15.39%). |
| Fresh setup quality | Poor / broken | -35.39% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 11.08%, revenue growth 23.00%. |
| Value attractiveness | Reasonable | Forward P/E 19.56, EV/Sales 3.72. |
...
| GE Vernova Gave Back Its Gains Since July: One Wall Street Pro Says 65% Gains Will Materialize Soon | 24/7 Wall St. | 2026-09-16 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $259.53; 52w high $401.70 (-35.39%); 52w low $236.14 (+9.91%) |
| Trend | -11.44% vs SMA200, -4.05% vs SMA50, -7.10% vs SMA20 |
| Momentum | RSI(14) 38.0 (neutral) |
| Volatility | ATR(14) 10.01 (~3.9% of price); beta 1.12 |
| Setup perspective | -35.39% from 52w high — base needs to rebuild. |
...
| SMA20 dist | -7.10% | ROA | 3.89% |
| SMA50 dist | -4.05% | ROE | 15.06% |
| SMA200 dist | -11.44% | Revenue (ttm) | $31.27B |
| 52W high | $401.70 | Revenue growth y/y | 23.00% |
| 52W low | $236.14 | Inst. ownership | 82.96% |
| P/E (ttm) | 25.34 | Insider ownership | 0.34% |
| Forward P/E | 19.56 | Short float | 3.65% |
| PEG (trailing) | — | Avg volume | 2,990,800 |
| P/S | 2.94 | Employees | 15,291 |
| P/B | 2.88 | Analyst rec (1=buy..5=sell) | — |

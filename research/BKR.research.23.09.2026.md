...
Signed file: `BKR.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $58.03 (2026-09-23, ~15-min delayed) |
| Market cap | $57.60B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-1.13%) with negative half-year (-6.54%). |
| Fresh setup quality | Moderate / wait | -16.12% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 11.17%, revenue growth -2.40%. |
| Value attractiveness | Reasonable | Forward P/E 18.65, EV/Sales 2.03. |
| Risk level | Elevated | Beta 0.96, ATR 3.1% of price, short float 3.08%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $58.03; 52w high $69.18 (-16.12%); 52w low $43.79 (+32.53%) |
| Trend | -1.13% vs SMA200, -4.15% vs SMA50, -4.31% vs SMA20 |
| Momentum | RSI(14) 39.1 (neutral) |
| Volatility | ATR(14) 1.80 (~3.1% of price); beta 0.96 |
| Setup perspective | -16.12% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.66, forward P/E 18.65, P/S 2.08, P/B 2.89 | EV/Sales 2.03, EV/EBITDA 11.62 |
| Growth expectations | Earnings growth -4.20%, EPS q/q -2.90% | Analyst mean target $72.30 (23 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 99.98% |
...
- **Volatility risk:** Beta 0.96, ATR 3.1% of price, short float 3.08%. Size positions accordingly.
...
|---|---|---|---|
| Price | $58.03 | EV/Sales | 2.03 |
| Market cap | $57.60B | EV/EBITDA | 11.62 |
| Beta | 0.96 | Gross margin | 23.66% |
| RSI(14) | 39.1 | Operating margin | 12.83% |
| ATR(14) | 1.80 | Profit margin | 11.17% |
| SMA20 dist | -4.31% | ROA | 4.85% |
| SMA50 dist | -4.15% | ROE | 16.46% |
| SMA200 dist | -1.13% | Revenue (ttm) | $27.73B |
| 52W high | $69.18 | Revenue growth y/y | -2.40% |
| 52W low | $43.79 | Inst. ownership | 99.98% |
| P/E (ttm) | 18.66 | Insider ownership | 0.15% |
| Forward P/E | 18.65 | Short float | 3.08% |
| PEG (trailing) | 1.60 | Avg volume | 8,623,355 |
| P/S | 2.08 | Employees | 54,000 |

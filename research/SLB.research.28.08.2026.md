...
Signed file: `SLB.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $55.01 (2026-08-28, ~15-min delayed) |
| Market cap | $81.64B |
...
|---|---|---|
| Technical momentum | High | 1Y +60.00%; price +14.26% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 17.02, EV/Sales 2.52. |
| Risk level | Moderate | Beta 0.75, ATR 2.9% of price, short float 4.28%. |
...
| SLB (SLB) Stock Falls Amid Market Uptick: What Investors Need to Know | Zacks | 2026-08-25 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $55.01; 52w high $58.01 (-5.17%); 52w low $31.12 (+76.75%) |
| Trend | +14.26% vs SMA200, +10.91% vs SMA50, +4.69% vs SMA20 |
| Momentum | RSI(14) 64.2 (neutral) |
| Volatility | ATR(14) 1.62 (~2.9% of price); beta 0.75 |
...
| Valuation | P/E 26.83, forward P/E 17.02, P/S 2.25, P/B 3.13 | EV/Sales 2.52, EV/EBITDA 12.39 |
...
|---|---|---|---|
| Price | $55.01 | EV/Sales | 2.52 |
| Market cap | $81.64B | EV/EBITDA | 12.39 |
| Beta | 0.75 | Gross margin | 16.99% |
| RSI(14) | 64.2 | Operating margin | 12.71% |
| ATR(14) | 1.62 | Profit margin | 8.53% |
| SMA20 dist | +4.69% | ROA | 6.17% |
| SMA50 dist | +10.91% | ROE | 12.91% |
| SMA200 dist | +14.26% | Revenue (ttm) | $36.37B |
| 52W high | $58.01 | Revenue growth y/y | 5.00% |
| 52W low | $31.12 | Inst. ownership | 92.84% |
| P/E (ttm) | 26.83 | Insider ownership | 0.22% |
| Forward P/E | 17.02 | Short float | 4.28% |
| PEG (trailing) | 1.83 | Avg volume | 13,482,639 |
| P/S | 2.25 | Employees | 109,000 |

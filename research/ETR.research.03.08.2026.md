...
Signed file: `ETR.research.03.08.2026`

| Field | Value |
|---|---|
| Current price | $108.06 (2026-08-03, ~15-min delayed) |
| Market cap | $50.42B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +22.55%; price +4.38% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 21.21, EV/Sales 6.03. |
| Risk level | Moderate | Beta 0.49, ATR 2.4% of price, short float 5.56%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $108.06; 52w high $117.36 (-7.92%); 52w low $85.23 (+26.79%) |
| Trend | +4.38% vs SMA200, -3.64% vs SMA50, -4.35% vs SMA20 |
| Momentum | RSI(14) 36.7 (neutral) |
| Volatility | ATR(14) 2.55 (~2.4% of price); beta 0.49 |
...
| Valuation | P/E 27.64, forward P/E 21.21, P/S 3.74, P/B 2.89 | EV/Sales 6.03, EV/EBITDA 14.68 |
...
- **Valuation risk:** Forward P/E 21.21, EV/Sales 6.03. Multiple compression is the main downside if growth disappoints.
- **Short interest risk:** short float 5.56% can fuel squeezes both ways around news.
...
|---|---|---|---|
| Price | $108.06 | EV/Sales | 6.03 |
| Market cap | $50.42B | EV/EBITDA | 14.68 |
| Beta | 0.49 | Gross margin | 47.00% |
| RSI(14) | 36.7 | Operating margin | 24.46% |
| ATR(14) | 2.55 | Profit margin | 13.33% |
| SMA20 dist | -4.35% | ROA | 2.68% |
| SMA50 dist | -3.64% | ROE | 10.25% |
| SMA200 dist | +4.38% | Revenue (ttm) | $13.48B |
| 52W high | $117.36 | Revenue growth y/y | 5.90% |
| 52W low | $85.23 | Inst. ownership | 96.19% |
| P/E (ttm) | 27.64 | Insider ownership | 0.22% |
| Forward P/E | 21.21 | Short float | 5.56% |
| PEG (trailing) | 2.00 | Avg volume | 3,564,461 |
| P/S | 3.74 | Employees | 12,000 |
| P/B | 2.89 | Analyst rec (1=buy..5=sell) | 1.7 |

...
Signed file: `SEDG.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $36.00 (2026-09-17, ~15-min delayed) |
| Market cap | $2.21B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-14.45%) with negative half-year (-19.79%). |
| Fresh setup quality | Poor / broken | -54.15% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-20.29%). |
| Value attractiveness | Low (expensive) | Forward P/E 41.03, EV/Sales 1.50. |
| Risk level | High | Beta 1.44, ATR 7.7% of price, short float 25.50%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.00; 52w high $78.51 (-54.15%); 52w low $28.47 (+26.45%) |
| Trend | -14.45% vs SMA200, -7.02% vs SMA50, +7.35% vs SMA20 |
| Momentum | RSI(14) 51.7 (neutral) |
| Volatility | ATR(14) 2.77 (~7.7% of price); beta 1.44 |
| Setup perspective | -54.15% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 41.03, P/S 1.66, P/B 5.37 | EV/Sales 1.50, EV/EBITDA -16.47 |
...
- **Valuation risk:** Forward P/E 41.03, EV/Sales 1.50. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.44, ATR 7.7% of price, short float 25.50%. Size positions accordingly.
...
|---|---|---|---|
| Price | $36.00 | EV/Sales | 1.50 |
| Market cap | $2.21B | EV/EBITDA | -16.47 |
| Beta | 1.44 | Gross margin | 21.25% |
| RSI(14) | 51.7 | Operating margin | -6.51% |
| ATR(14) | 2.77 | Profit margin | -20.29% |
| SMA20 dist | +7.35% | ROA | -3.84% |
| SMA50 dist | -7.02% | ROE | -58.42% |
| SMA200 dist | -14.45% | Revenue (ttm) | $1.33B |
| 52W high | $78.51 | Revenue growth y/y | 19.60% |
| 52W low | $28.47 | Inst. ownership | 101.66% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 41.03 | Short float | 25.50% |
| PEG (trailing) | — | Avg volume | 3,152,169 |
| P/S | 1.66 | Employees | 3,576 |
| P/B | 5.37 | Analyst rec (1=buy..5=sell) | 3.0 |

...
Signed file: `NXE.research.11.08.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-0.88%) with negative half-year (-9.59%). |
| Fresh setup quality | Moderate / wait | -24.14% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -63.68, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.56; 52w high $13.92 (-24.14%); 52w low $6.46 (+63.47%) |
| Trend | -0.88% vs SMA200, +7.35% vs SMA50, +11.42% vs SMA20 |
| Momentum | RSI(14) 63.0 (neutral) |
| Volatility | ATR(14) 0.46 (~4.3% of price); beta 1.65 |
| Setup perspective | -24.14% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E -63.68, P/S —, P/B 5.79 | EV/Sales —, EV/EBITDA -60.42 |
...
| SMA20 dist | +11.42% | ROA | -3.39% |
| SMA50 dist | +7.35% | ROE | -17.67% |
| SMA200 dist | -0.88% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $6.46 | Inst. ownership | 54.55% |
| P/E (ttm) | — | Insider ownership | 6.39% |
| Forward P/E | -63.68 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,577,014 |
| P/S | — | Employees | 142 |
| P/B | 5.79 | Analyst rec (1=buy..5=sell) | 1.5 |

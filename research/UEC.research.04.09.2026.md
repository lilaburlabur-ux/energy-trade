...
Signed file: `UEC.research.04.09.2026`

| Field | Value |
|---|---|
| Current price | $11.54 (2026-09-04, ~15-min delayed) |
| Market cap | $5.71B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-13.01%) with negative half-year (-10.75%). |
| Fresh setup quality | Poor / broken | -42.70% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -128.22, EV/Sales 257.91. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.54; 52w high $20.14 (-42.70%); 52w low $9.04 (+27.65%) |
| Trend | -13.01% vs SMA200, +6.74% vs SMA50, -2.90% vs SMA20 |
| Momentum | RSI(14) 49.4 (neutral) |
| Volatility | ATR(14) 0.66 (~5.7% of price); beta 1.21 |
| Setup perspective | -42.70% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -128.22, P/S 282.71, P/B 4.01 | EV/Sales 257.91, EV/EBITDA -43.14 |
...
|---|---|---|---|
| Price | $11.54 | EV/Sales | 257.91 |
| Market cap | $5.71B | EV/EBITDA | -43.14 |
| Beta | 1.21 | Gross margin | 0.00% |
| RSI(14) | 49.4 | Operating margin | -629.66% |
| ATR(14) | 0.66 | Profit margin | 0.00% |
| SMA20 dist | -2.90% | ROA | -6.25% |
| SMA50 dist | +6.74% | ROE | -8.96% |
| SMA200 dist | -13.01% | Revenue (ttm) | $20.20M |
...
| PEG (trailing) | — | Avg volume | 9,627,517 |

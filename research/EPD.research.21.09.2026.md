...
Signed file: `EPD.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $38.47 (2026-09-21, ~15-min delayed) |
| Market cap | $83.08B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +28.73%; price +7.32% vs SMA200. |
| Fresh setup quality | Watch | -2.26% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.14, EV/Sales 2.03. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.47; 52w high $39.36 (-2.26%); 52w low $28.35 (+35.68%) |
| Trend | +7.32% vs SMA200, +0.37% vs SMA50, -1.00% vs SMA20 |
| Momentum | RSI(14) 48.2 (neutral) |
| Volatility | ATR(14) 0.59 (~1.5% of price); beta 0.48 |
| Setup perspective | -2.26% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.31, forward P/E 12.14, P/S 1.42, P/B 2.75 | EV/Sales 2.03, EV/EBITDA 11.53 |
...
|---|---|---|---|
| Price | $38.47 | EV/Sales | 2.03 |
| Market cap | $83.08B | EV/EBITDA | 11.53 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 48.2 | Operating margin | 11.76% |
| ATR(14) | 0.59 | Profit margin | 10.79% |
| SMA20 dist | -1.00% | ROA | 5.92% |
| SMA50 dist | +0.37% | ROE | 20.85% |
| SMA200 dist | +7.32% | Revenue (ttm) | $58.47B |

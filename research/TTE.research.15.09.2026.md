...
Signed file: `TTE.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $93.12 (2026-09-15, ~15-min delayed) |
| Market cap | $205.78B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +58.86%; price +15.12% vs SMA200. |
| Fresh setup quality | Watch | -0.51% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 9.08%, revenue growth 27.80%. |
| Value attractiveness | Reasonable | Forward P/E 8.99, EV/Sales 1.20. |
...
|---|---|---|
| TotalEnergies SE Sponsored ADR (TTE) Is Up 3.73% in One Week: What You Should Know | Zacks | 2026-09-15 |
| TotalEnergies Bets Over $115 Million on AI to Hunt for Oil With Mistral | Benzinga | 2026-09-15 |
| Should Value Investors Buy OMV (OMVKY) Stock? | Zacks | 2026-09-15 |
| Sector Update: Energy Stocks Advance Pre-Bell Tuesday | MT Newswires | 2026-09-15 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $93.12; 52w high $93.60 (-0.51%); 52w low $55.92 (+66.52%) |
| Trend | +15.12% vs SMA200, +7.80% vs SMA50, +3.82% vs SMA20 |
| Momentum | RSI(14) 65.2 (neutral) |
| Volatility | ATR(14) 1.64 (~1.8% of price); beta 0.06 |
| Setup perspective | -0.51% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 11.65, forward P/E 8.99, P/S 1.05, P/B 1.61 | EV/Sales 1.20, EV/EBITDA 5.96 |
| Growth expectations | Earnings growth 106.00%, EPS q/q 102.40% | Analyst mean target $96.40 (10 analysts) |
...
|---|---|---|---|
| Price | $93.12 | EV/Sales | 1.20 |
| Market cap | $205.78B | EV/EBITDA | 5.96 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 65.2 | Operating margin | 12.79% |
| ATR(14) | 1.64 | Profit margin | 9.08% |
| SMA20 dist | +3.82% | ROA | 5.51% |
| SMA50 dist | +7.80% | ROE | 14.48% |
| SMA200 dist | +15.12% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 54.19% |
| P/E (ttm) | 11.65 | Insider ownership | 8.86% |
| Forward P/E | 8.99 | Short float | 0.22% |
| PEG (trailing) | 0.83 | Avg volume | 1,662,129 |
| P/S | 1.05 | Employees | 94,847 |
| P/B | 1.61 | Analyst rec (1=buy..5=sell) | 2.0 |

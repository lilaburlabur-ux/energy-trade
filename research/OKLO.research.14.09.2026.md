...
Signed file: `OKLO.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $36.21 (2026-09-14, ~15-min delayed) |
| Market cap | $6.74B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-42.99%) with negative half-year (-37.96%). |
...
| Value attractiveness | Reasonable | Forward P/E -35.81, EV/Sales 3,534.34. |
| Risk level | High | Beta 1.20, ATR 8.0% of price, short float 19.64%. |
...
| Why Did OPEN, OKLO, MCD Stocks Plunge To 52-Week Lows? | Stocktwits | 2026-09-14 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.21; 52w high $174.14 (-79.21%); 52w low $36.21 (+0.00%) |
| Trend | -42.99% vs SMA200, -15.47% vs SMA50, -11.48% vs SMA20 |
| Momentum | RSI(14) 38.6 (neutral) |
| Volatility | ATR(14) 2.88 (~8.0% of price); beta 1.20 |
...
| Valuation | P/E —, forward P/E -35.81, P/S 5,566.69, P/B 2.05 | EV/Sales 3,534.34, EV/EBITDA -19.73 |
...
- **Volatility risk:** Beta 1.20, ATR 8.0% of price, short float 19.64%. Size positions accordingly.
...
|---|---|---|---|
| Price | $36.21 | EV/Sales | 3,534.34 |
| Market cap | $6.74B | EV/EBITDA | -19.73 |
| Beta | 1.20 | Gross margin | 40.41% |
| RSI(14) | 38.6 | Operating margin | -6048.76% |
| ATR(14) | 2.88 | Profit margin | 0.00% |
| SMA20 dist | -11.48% | ROA | -6.65% |
| SMA50 dist | -15.47% | ROE | -7.70% |
| SMA200 dist | -42.99% | Revenue (ttm) | $1.21M |
| 52W high | $174.14 | Revenue growth y/y | — |
| 52W low | $36.21 | Inst. ownership | 47.54% |
| P/E (ttm) | — | Insider ownership | 15.38% |
| Forward P/E | -35.81 | Short float | 19.64% |
| PEG (trailing) | — | Avg volume | 9,788,248 |
| P/S | 5,566.69 | Employees | 215 |
| P/B | 2.05 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `FANG.research.10.08.2026`

| Field | Value |
|---|---|
| Current price | $198.97 (2026-08-10, ~15-min delayed) |
| Market cap | $55.72B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +44.63%; price +14.30% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.38% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.03%, revenue growth 52.50%. |
| Value attractiveness | Reasonable | Forward P/E 11.09, EV/Sales 4.36. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $198.97; 52w high $212.52 (-6.38%); 52w low $132.09 (+50.63%) |
| Trend | +14.30% vs SMA200, +4.12% vs SMA50, +1.62% vs SMA20 |
| Momentum | RSI(14) 55.2 (neutral) |
| Volatility | ATR(14) 6.67 (~3.4% of price); beta 0.42 |
| Setup perspective | -6.38% from 52w high; no clean fresh pivot by default. |
...
- **Volatility risk:** Beta 0.42, ATR 3.4% of price, short float 4.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $198.97 | EV/Sales | 4.36 |
| Market cap | $55.72B | EV/EBITDA | 6.02 |
| Beta | 0.42 | Gross margin | 72.35% |
| RSI(14) | 55.2 | Operating margin | 48.47% |
| ATR(14) | 6.67 | Profit margin | 9.03% |
| SMA20 dist | +1.62% | ROA | 1.31% |
| SMA50 dist | +4.12% | ROE | 3.49% |
| SMA200 dist | +14.30% | Revenue (ttm) | $16.25B |

...
Signed file: `UEC.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $10.08 (2026-09-21, ~15-min delayed) |
| Market cap | $4.99B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-23.66%) with negative half-year (-16.63%). |
| Fresh setup quality | Poor / broken | -49.95% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -112.00, EV/Sales 216.26. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.08; 52w high $20.14 (-49.95%); 52w low $9.04 (+11.50%) |
| Trend | -23.66% vs SMA200, -6.90% vs SMA50, -11.93% vs SMA20 |
| Momentum | RSI(14) 38.9 (neutral) |
| Volatility | ATR(14) 0.63 (~6.2% of price); beta 1.24 |
| Setup perspective | -49.95% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -112.00, P/S 246.95, P/B 3.50 | EV/Sales 216.26, EV/EBITDA -36.17 |
...
|---|---|---|---|
| Price | $10.08 | EV/Sales | 216.26 |
| Market cap | $4.99B | EV/EBITDA | -36.17 |
| Beta | 1.24 | Gross margin | 0.00% |
| RSI(14) | 38.9 | Operating margin | -629.66% |
| ATR(14) | 0.63 | Profit margin | 0.00% |
| SMA20 dist | -11.93% | ROA | -6.25% |
| SMA50 dist | -6.90% | ROE | -8.96% |
| SMA200 dist | -23.66% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 89.43% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -112.00 | Short float | 14.73% |
| PEG (trailing) | — | Avg volume | 8,369,952 |
| P/S | 246.95 | Employees | 171 |
| P/B | 3.50 | Analyst rec (1=buy..5=sell) | — |

...
Signed file: `ARRY.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $4.54 (2026-09-03, ~15-min delayed) |
| Market cap | $699.19M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-42.17%) with negative half-year (-36.41%). |
| Fresh setup quality | Poor / broken | -62.04% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.06, EV/Sales 1.39. |
| Risk level | High | Beta 1.79, ATR 6.2% of price, short float 24.55%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.54; 52w high $11.96 (-62.04%); 52w low $4.36 (+4.13%) |
| Trend | -42.17% vs SMA200, -19.30% vs SMA50, -6.11% vs SMA20 |
| Momentum | RSI(14) 37.6 (neutral) |
| Volatility | ATR(14) 0.28 (~6.2% of price); beta 1.79 |
| Setup perspective | -62.04% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 5.06, P/S 0.59, P/B -3.46 | EV/Sales 1.39, EV/EBITDA 13.80 |
| Growth expectations | Earnings growth -73.20%, EPS q/q -43.70% | Analyst mean target $9.11 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 147.92% |
...
- **Volatility risk:** Beta 1.79, ATR 6.2% of price, short float 24.55%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.54 | EV/Sales | 1.39 |
| Market cap | $699.19M | EV/EBITDA | 13.80 |
| Beta | 1.79 | Gross margin | 26.76% |
| RSI(14) | 37.6 | Operating margin | 10.88% |
| ATR(14) | 0.28 | Profit margin | -7.25% |
| SMA20 dist | -6.11% | ROA | 3.33% |
| SMA50 dist | -19.30% | ROE | -25.98% |
| SMA200 dist | -42.17% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.36 | Inst. ownership | 147.92% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.06 | Short float | 24.55% |
| PEG (trailing) | 0.48 | Avg volume | 6,816,530 |
| P/S | 0.59 | Employees | 1,200 |
| P/B | -3.46 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `LEU.research.27.08.2026`

| Field | Value |
|---|---|
| Current price | $187.63 (2026-08-27, ~15-min delayed) |
| Market cap | $3.74B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-12.28%) with negative half-year (-10.92%). |
| Fresh setup quality | Poor / broken | -56.97% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.23%, revenue growth 14.00%. |
| Value attractiveness | Low (expensive) | Forward P/E 49.08, EV/Sales 6.44. |
| Risk level | High | Beta 1.35, ATR 6.9% of price, short float 29.16%. |
...
| Centrus Energy (LEU) May Have Found its Next Major Growth Opportunity | Insider Monkey | 2026-08-25 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $187.63; 52w high $436.00 (-56.97%); 52w low $146.61 (+27.98%) |
| Trend | -12.28% vs SMA200, +7.66% vs SMA50, +1.58% vs SMA20 |
| Momentum | RSI(14) 53.5 (neutral) |
| Volatility | ATR(14) 12.95 (~6.9% of price); beta 1.35 |
| Setup perspective | -56.97% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 98.75, forward P/E 49.08, P/S 7.90, P/B 4.43 | EV/Sales 6.44, EV/EBITDA 302.25 |
...
- **Valuation risk:** Forward P/E 49.08, EV/Sales 6.44. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.35, ATR 6.9% of price, short float 29.16%. Size positions accordingly.
...
|---|---|---|---|
| Price | $187.63 | EV/Sales | 6.44 |
| Market cap | $3.74B | EV/EBITDA | 302.25 |
| Beta | 1.35 | Gross margin | 23.66% |
| RSI(14) | 53.5 | Operating margin | 5.34% |
| ATR(14) | 12.95 | Profit margin | 10.23% |
| SMA20 dist | +1.58% | ROA | 0.02% |
| SMA50 dist | +7.66% | ROE | 8.05% |
| SMA200 dist | -12.28% | Revenue (ttm) | $473.90M |
| 52W high | $436.00 | Revenue growth y/y | 14.00% |
| 52W low | $146.61 | Inst. ownership | 89.25% |
| P/E (ttm) | 98.75 | Insider ownership | 4.31% |
| Forward P/E | 49.08 | Short float | 29.16% |
| PEG (trailing) | — | Avg volume | 792,187 |
| P/S | 7.90 | Employees | 467 |
| P/B | 4.43 | Analyst rec (1=buy..5=sell) | 1.8 |

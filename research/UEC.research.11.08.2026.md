...
Signed file: `UEC.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $11.46 (2026-08-11, ~15-min delayed) |
| Market cap | $5.62B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-14.37%) with negative half-year (-32.98%). |
| Fresh setup quality | Poor / broken | -43.10% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -127.33, EV/Sales 254.73. |
| Risk level | High | Beta 1.21, ATR 5.2% of price, short float 14.14%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.46; 52w high $20.14 (-43.10%); 52w low $9.04 (+26.77%) |
| Trend | -14.37% vs SMA200, +5.89% vs SMA50, +14.30% vs SMA20 |
| Momentum | RSI(14) 62.0 (neutral) |
| Volatility | ATR(14) 0.60 (~5.2% of price); beta 1.21 |
| Setup perspective | -43.10% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -127.33, P/S 278.12, P/B 3.98 | EV/Sales 254.73, EV/EBITDA -42.61 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $18.03 (9 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 86.98% |
...
- **Volatility risk:** Beta 1.21, ATR 5.2% of price, short float 14.14%. Size positions accordingly.
...
|---|---|---|---|
| Price | $11.46 | EV/Sales | 254.73 |
| Market cap | $5.62B | EV/EBITDA | -42.61 |
| Beta | 1.21 | Gross margin | 0.00% |
| RSI(14) | 62.0 | Operating margin | -629.66% |
| ATR(14) | 0.60 | Profit margin | 0.00% |
| SMA20 dist | +14.30% | ROA | -6.25% |
| SMA50 dist | +5.89% | ROE | -8.96% |
| SMA200 dist | -14.37% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 86.98% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -127.33 | Short float | 14.14% |
| PEG (trailing) | — | Avg volume | 9,922,758 |
| P/S | 278.12 | Employees | 171 |
| P/B | 3.98 | Analyst rec (1=buy..5=sell) | 1.4 |

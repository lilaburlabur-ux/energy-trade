...
Signed file: `BP.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $44.49 (2026-09-23, ~15-min delayed) |
| Market cap | $114.58B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +36.11%; price +9.80% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.26% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 2.55%, revenue growth 48.20%. |
| Value attractiveness | Reasonable | Forward P/E 9.11, EV/Sales 2.32. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $44.49; 52w high $46.96 (-5.26%); 52w low $31.17 (+42.71%) |
| Trend | +9.80% vs SMA200, +2.73% vs SMA50, +0.27% vs SMA20 |
| Momentum | RSI(14) 52.0 (neutral) |
| Volatility | ATR(14) 1.10 (~2.5% of price); beta -0.22 |
| Setup perspective | -5.26% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.29, forward P/E 9.11, P/S 0.53, P/B 7.88 | EV/Sales 2.32, EV/EBITDA 12.74 |

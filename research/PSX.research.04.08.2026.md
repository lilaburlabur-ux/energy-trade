...
Signed file: `PSX.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $205.89 (2026-08-04, ~15-min delayed) |
| Market cap | $82.55B |
...
|---|---|---|
| Technical momentum | High | 1Y +78.05%; price +29.11% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.85, EV/Sales 0.79. |
| Risk level | Moderate | Beta 0.69, ATR 3.0% of price, short float 2.27%. |
...
|---|---|---|
| How Valero's Q2 Refining & Renewable Diesel Surge Reshapes its 2026 | Zacks | 2026-08-04 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $205.89; 52w high $212.27 (-3.01%); 52w low $114.45 (+79.90%) |
| Trend | +29.11% vs SMA200, +10.15% vs SMA50, +1.15% vs SMA20 |
| Momentum | RSI(14) 60.2 (neutral) |
| Volatility | ATR(14) 6.09 (~3.0% of price); beta 0.69 |
...
| Valuation | P/E 20.34, forward P/E 10.85, P/S 0.61, P/B 2.89 | EV/Sales 0.79, EV/EBITDA 15.03 |
...
|---|---|---|---|
| Price | $205.89 | EV/Sales | 0.79 |
| Market cap | $82.55B | EV/EBITDA | 15.03 |
| Beta | 0.69 | Gross margin | 12.52% |
| RSI(14) | 60.2 | Operating margin | 0.64% |
| ATR(14) | 6.09 | Profit margin | 3.07% |
| SMA20 dist | +1.15% | ROA | 3.80% |
| SMA50 dist | +10.15% | ROE | 14.55% |
| SMA200 dist | +29.11% | Revenue (ttm) | $134.49B |
| 52W high | $212.27 | Revenue growth y/y | 6.90% |
| 52W low | $114.45 | Inst. ownership | 80.89% |
| P/E (ttm) | 20.34 | Insider ownership | 0.22% |
| Forward P/E | 10.85 | Short float | 2.27% |
| PEG (trailing) | 1.23 | Avg volume | 2,548,488 |
| P/S | 0.61 | Employees | 12,600 |
| P/B | 2.89 | Analyst rec (1=buy..5=sell) | 2.1 |

...
Signed file: `BEP.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $28.27 (2026-09-24, ~15-min delayed) |
| Market cap | $13.78B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-9.60%) with negative half-year (-7.58%). |
| Fresh setup quality | Moderate / wait | -22.83% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-1.26%). |
| Value attractiveness | Reasonable | Forward P/E -15.12, EV/Sales 12.73. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $28.27; 52w high $36.63 (-22.83%); 52w low $24.35 (+16.11%) |
| Trend | -9.60% vs SMA200, -10.88% vs SMA50, -7.32% vs SMA20 |
| Momentum | RSI(14) 30.8 (neutral) |
| Volatility | ATR(14) 0.88 (~3.1% of price); beta 0.98 |
| Setup perspective | -22.83% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E -15.12, P/S 2.17, P/B 2.27 | EV/Sales 12.73, EV/EBITDA 26.99 |
...
|---|---|---|---|
| Price | $28.27 | EV/Sales | 12.73 |
| Market cap | $13.78B | EV/EBITDA | 26.99 |
| Beta | 0.98 | Gross margin | 51.39% |
| RSI(14) | 30.8 | Operating margin | 17.08% |
| ATR(14) | 0.88 | Profit margin | -1.26% |
| SMA20 dist | -7.32% | ROA | 0.42% |
| SMA50 dist | -10.88% | ROE | 0.40% |
| SMA200 dist | -9.60% | Revenue (ttm) | $6.36B |
| 52W high | $36.63 | Revenue growth y/y | 1.10% |
| 52W low | $24.35 | Inst. ownership | 65.49% |
| P/E (ttm) | — | Insider ownership | 0.02% |
| Forward P/E | -15.12 | Short float | 0.61% |
| PEG (trailing) | — | Avg volume | 948,749 |
| P/S | 2.17 | Employees | 5,870 |

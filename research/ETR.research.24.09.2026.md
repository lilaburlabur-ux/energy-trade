...
Signed file: `ETR.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $98.16 (2026-09-24, ~15-min delayed) |
| Market cap | $46.90B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $98.16; 52w high $116.66 (-15.86%); 52w low $88.13 (+11.37%) |
| Trend | -6.58% vs SMA200, -8.50% vs SMA50, -6.27% vs SMA20 |
| Momentum | RSI(14) 25.7 (oversold) |
| Volatility | ATR(14) 2.01 (~2.1% of price); beta 0.48 |
| Setup perspective | -15.86% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | -6.27% | ROA | 2.68% |
| SMA50 dist | -8.50% | ROE | 10.25% |
| SMA200 dist | -6.58% | Revenue (ttm) | $13.48B |

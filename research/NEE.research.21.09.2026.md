...
Signed file: `NEE.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $79.63 (2026-09-21, ~15-min delayed) |
| Market cap | $166.11B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-7.92%) with negative half-year (-9.70%). |
...
| Value attractiveness | Reasonable | Forward P/E 18.11, EV/Sales 9.97. |
...
| NextEra’s Nuclear Bet Just Got a $1.9 Billion Boost | Insider Monkey | 2026-09-20 |
| Brookfield Asset Management Targets Doubling Fee-Bearing Capital by 2031 | MarketBeat | 2026-09-20 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $79.63; 52w high $96.44 (-17.43%); 52w low $69.09 (+15.25%) |
| Trend | -7.92% vs SMA200, -6.17% vs SMA50, -3.30% vs SMA20 |
| Momentum | RSI(14) 30.3 (neutral) |
| Volatility | ATR(14) 1.26 (~1.6% of price); beta 0.64 |
...
| Valuation | P/E 17.89, forward P/E 18.11, P/S 5.79, P/B 2.91 | EV/Sales 9.97, EV/EBITDA 19.61 |
...
|---|---|---|---|
| Price | $79.63 | EV/Sales | 9.97 |
| Market cap | $166.11B | EV/EBITDA | 19.61 |
| Beta | 0.64 | Gross margin | 61.02% |
| RSI(14) | 30.3 | Operating margin | 31.52% |
| ATR(14) | 1.26 | Profit margin | 32.40% |
| SMA20 dist | -3.30% | ROA | 2.44% |
| SMA50 dist | -6.17% | ROE | 11.68% |
| SMA200 dist | -7.92% | Revenue (ttm) | $28.70B |
| 52W high | $96.44 | Revenue growth y/y | 12.40% |
| 52W low | $69.09 | Inst. ownership | 87.02% |
| P/E (ttm) | 17.89 | Insider ownership | 0.12% |
| Forward P/E | 18.11 | Short float | 0.00% |
| PEG (trailing) | 1.62 | Avg volume | 11,092,495 |
| P/S | 5.79 | Employees | 17,400 |
| P/B | 2.91 | Analyst rec (1=buy..5=sell) | 2.0 |

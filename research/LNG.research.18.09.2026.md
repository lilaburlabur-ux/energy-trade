...
Signed file: `LNG.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $268.34 (2026-09-18, ~15-min delayed) |
| Market cap | $55.42B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +15.15%; price +10.69% vs SMA200. |
| Fresh setup quality | Moderate / wait | -9.30% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 13.94%, revenue growth 22.70%. |
| Value attractiveness | Reasonable | Forward P/E 12.92, EV/Sales 4.20. |
...
|---|---|---|
| Should You Be Optimistic on Cheniere Energy’s (LNG) Long-Term Outlook | Insider Monkey | 2026-09-18 |
| Running on Empty: 3 Energy Plays for Europe's Deep Freeze | MarketBeat | 2026-09-15 |
| BASFY's Durasorb Technology Gains Traction in Cheniere LNG Operations | Zacks | 2026-09-15 |
| QatarEnergy Eyes Cheniere Energy, Others for U.S. LNG Supplies | Zacks | 2026-09-14 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $268.34; 52w high $295.86 (-9.30%); 52w low $187.49 (+43.12%) |
| Trend | +10.69% vs SMA200, -0.68% vs SMA50, -4.30% vs SMA20 |
| Momentum | RSI(14) 43.0 (neutral) |
| Volatility | ATR(14) 7.41 (~2.8% of price); beta -0.00 |
| Setup perspective | -9.30% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.33, forward P/E 12.92, P/S 2.65, P/B 9.01 | EV/Sales 4.20, EV/EBITDA 11.23 |
| Growth expectations | Earnings growth 100.70%, EPS q/q 88.70% | Analyst mean target $309.95 (21 analysts) |
...
|---|---|---|---|
| Price | $268.34 | EV/Sales | 4.20 |
| Market cap | $55.42B | EV/EBITDA | 11.23 |
| Beta | -0.00 | Gross margin | 36.85% |
| RSI(14) | 43.0 | Operating margin | 75.00% |
| ATR(14) | 7.41 | Profit margin | 13.94% |
| SMA20 dist | -4.30% | ROA | 8.63% |
| SMA50 dist | -0.68% | ROE | 39.12% |
| SMA200 dist | +10.69% | Revenue (ttm) | $20.92B |
| 52W high | $295.86 | Revenue growth y/y | 22.70% |
| 52W low | $187.49 | Inst. ownership | 91.55% |
| P/E (ttm) | 20.33 | Insider ownership | 0.66% |
| Forward P/E | 12.92 | Short float | 2.03% |
| PEG (trailing) | — | Avg volume | 1,942,716 |
| P/S | 2.65 | Employees | 1,717 |
| P/B | 9.01 | Analyst rec (1=buy..5=sell) | 1.4 |

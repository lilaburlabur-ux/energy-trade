...
Signed file: `BP.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $46.08 (2026-09-10, ~15-min delayed) |
| Market cap | $118.67B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +42.14%; price +15.00% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.94% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 2.55%, revenue growth 48.20%. |
| Value attractiveness | Reasonable | Forward P/E 9.39, EV/Sales 2.44. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $46.08; 52w high $46.52 (-0.94%); 52w low $31.17 (+47.82%) |
| Trend | +15.00% vs SMA200, +9.46% vs SMA50, +5.49% vs SMA20 |
| Momentum | RSI(14) 65.6 (neutral) |
| Volatility | ATR(14) 1.01 (~2.2% of price); beta -0.22 |
| Setup perspective | -0.94% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 22.05, forward P/E 9.39, P/S 0.55, P/B 8.16 | EV/Sales 2.44, EV/EBITDA 13.42 |
...
|---|---|---|---|
| Price | $46.08 | EV/Sales | 2.44 |
| Market cap | $118.67B | EV/EBITDA | 13.42 |
| Beta | -0.22 | Gross margin | 28.30% |
| RSI(14) | 65.6 | Operating margin | 13.15% |
| ATR(14) | 1.01 | Profit margin | 2.55% |
| SMA20 dist | +5.49% | ROA | 5.04% |
| SMA50 dist | +9.46% | ROE | 8.87% |
| SMA200 dist | +15.00% | Revenue (ttm) | $215.47B |
| 52W high | $46.52 | Revenue growth y/y | 48.20% |
| 52W low | $31.17 | Inst. ownership | 14.09% |
| P/E (ttm) | 22.05 | Insider ownership | 0.00% |
| Forward P/E | 9.39 | Short float | 0.28% |
| PEG (trailing) | 0.06 | Avg volume | 9,207,020 |
| P/S | 0.55 | Employees | 93,700 |
| P/B | 8.16 | Analyst rec (1=buy..5=sell) | 2.4 |

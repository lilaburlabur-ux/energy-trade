...
Signed file: `BEP.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $31.73 (2026-08-29, ~15-min delayed) |
| Market cap | $15.44B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +27.59%; price +0.96% vs SMA200. |
| Fresh setup quality | Moderate / wait | -14.45% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-1.26%). |
| Value attractiveness | Reasonable | Forward P/E -16.97, EV/Sales 13.19. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $31.73; 52w high $37.09 (-14.45%); 52w low $24.11 (+31.63%) |
| Trend | +0.96% vs SMA200, -4.68% vs SMA50, -4.56% vs SMA20 |
| Momentum | RSI(14) 40.0 (neutral) |
| Volatility | ATR(14) 0.98 (~3.1% of price); beta 0.99 |
| Setup perspective | -14.45% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E -16.97, P/S 2.43, P/B 2.55 | EV/Sales 13.19, EV/EBITDA 27.95 |
...
|---|---|---|---|
| Price | $31.73 | EV/Sales | 13.19 |
| Market cap | $15.44B | EV/EBITDA | 27.95 |
| Beta | 0.99 | Gross margin | 51.39% |
| RSI(14) | 40.0 | Operating margin | 17.08% |
| ATR(14) | 0.98 | Profit margin | -1.26% |
| SMA20 dist | -4.56% | ROA | 0.42% |
| SMA50 dist | -4.68% | ROE | 0.40% |
| SMA200 dist | +0.96% | Revenue (ttm) | $6.36B |
| 52W high | $37.09 | Revenue growth y/y | 1.10% |
| 52W low | $24.11 | Inst. ownership | 65.29% |
| P/E (ttm) | — | Insider ownership | 0.02% |
| Forward P/E | -16.97 | Short float | 0.67% |
| PEG (trailing) | — | Avg volume | 876,776 |
| P/S | 2.43 | Employees | 5,870 |

...
Signed file: `MPC.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $393.52 (2026-09-25, ~15-min delayed) |
| Market cap | $110.51B |
...
|---|---|---|
| Technical momentum | High | 1Y +107.19%; price +54.25% vs SMA200. |
| Fresh setup quality | Moderate / wait | -7.38% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 5.55%, revenue growth 53.70%. |
| Value attractiveness | Reasonable | Forward P/E 8.35, EV/Sales 0.93. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $393.52; 52w high $424.89 (-7.38%); 52w low $160.76 (+144.78%) |
| Trend | +54.25% vs SMA200, +10.49% vs SMA50, -0.47% vs SMA20 |
| Momentum | RSI(14) 56.5 (neutral) |
| Volatility | ATR(14) 14.71 (~3.7% of price); beta 0.53 |
| Setup perspective | -7.38% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 13.64, forward P/E 8.35, P/S 0.72, P/B 5.84 | EV/Sales 0.93, EV/EBITDA 9.33 |
...
|---|---|---|---|
| Price | $393.52 | EV/Sales | 0.93 |
| Market cap | $110.51B | EV/EBITDA | 9.33 |
| Beta | 0.53 | Gross margin | 12.82% |
| RSI(14) | 56.5 | Operating margin | 13.56% |
| ATR(14) | 14.71 | Profit margin | 5.55% |
| SMA20 dist | -0.47% | ROA | 8.74% |
| SMA50 dist | +10.49% | ROE | 42.10% |
| SMA200 dist | +54.25% | Revenue (ttm) | $154.15B |
| 52W high | $424.89 | Revenue growth y/y | 53.70% |
| 52W low | $160.76 | Inst. ownership | 79.49% |
| P/E (ttm) | 13.64 | Insider ownership | 0.33% |
| Forward P/E | 8.35 | Short float | 3.19% |
| PEG (trailing) | 0.90 | Avg volume | 2,606,714 |
| P/S | 0.72 | Employees | 18,500 |
| P/B | 5.84 | Analyst rec (1=buy..5=sell) | 2.3 |

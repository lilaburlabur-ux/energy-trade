...
Signed file: `TLN.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $304.42 (2026-09-25, ~15-min delayed) |
| Market cap | $14.59B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-13.74%) with negative half-year (-5.79%). |
...
| Value attractiveness | Reasonable | Forward P/E 9.90, EV/Sales 6.35. |
| Risk level | Elevated | Beta 1.63, ATR 4.3% of price, short float 6.33%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $304.42; 52w high $445.84 (-31.72%); 52w low $282.15 (+7.89%) |
| Trend | -13.74% vs SMA200, -6.23% vs SMA50, +1.12% vs SMA20 |
| Momentum | RSI(14) 47.7 (neutral) |
| Volatility | ATR(14) 13.24 (~4.3% of price); beta 1.63 |
...
| Valuation | P/E —, forward P/E 9.90, P/S 3.90, P/B 9.02 | EV/Sales 6.35, EV/EBITDA 40.79 |
...
- **Volatility risk:** Beta 1.63, ATR 4.3% of price, short float 6.33%. Size positions accordingly.
...
|---|---|---|---|
| Price | $304.42 | EV/Sales | 6.35 |
| Market cap | $14.59B | EV/EBITDA | 40.79 |
| Beta | 1.63 | Gross margin | 42.10% |
| RSI(14) | 47.7 | Operating margin | -4.80% |
| ATR(14) | 13.24 | Profit margin | -4.95% |
| SMA20 dist | +1.12% | ROA | 0.92% |
| SMA50 dist | -6.23% | ROE | -12.83% |
| SMA200 dist | -13.74% | Revenue (ttm) | $3.74B |
| 52W high | $445.84 | Revenue growth y/y | 111.20% |
| 52W low | $282.15 | Inst. ownership | 102.17% |
| P/E (ttm) | — | Insider ownership | 1.36% |
| Forward P/E | 9.90 | Short float | 6.33% |
| PEG (trailing) | — | Avg volume | 797,506 |
| P/S | 3.90 | Employees | 1,880 |
| P/B | 9.02 | Analyst rec (1=buy..5=sell) | 1.6 |

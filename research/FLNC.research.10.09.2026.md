...
Signed file: `FLNC.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $9.69 (2026-09-10, ~15-min delayed) |
| Market cap | $1.80B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-46.06%) with negative half-year (-43.37%). |
| Fresh setup quality | Poor / broken | -69.93% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 75.73, EV/Sales 0.60. |
| Risk level | High | Beta 2.74, ATR 8.5% of price, short float 33.35%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.69; 52w high $32.23 (-69.93%); 52w low $6.76 (+43.34%) |
| Trend | -46.06% vs SMA200, -27.01% vs SMA50, -13.57% vs SMA20 |
| Momentum | RSI(14) 33.5 (neutral) |
| Volatility | ATR(14) 0.82 (~8.5% of price); beta 2.74 |
| Setup perspective | -69.93% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 75.73, P/S 0.68, P/B 3.72 | EV/Sales 0.60, EV/EBITDA -20.27 |
...
- **Valuation risk:** Forward P/E 75.73, EV/Sales 0.60. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.74, ATR 8.5% of price, short float 33.35%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.69 | EV/Sales | 0.60 |
| Market cap | $1.80B | EV/EBITDA | -20.27 |
| Beta | 2.74 | Gross margin | 9.36% |
| RSI(14) | 33.5 | Operating margin | -8.85% |
| ATR(14) | 0.82 | Profit margin | -3.07% |
| SMA20 dist | -13.57% | ROA | -2.95% |
| SMA50 dist | -27.01% | ROE | -23.54% |
| SMA200 dist | -46.06% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.76 | Inst. ownership | 85.06% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 75.73 | Short float | 33.35% |
| PEG (trailing) | — | Avg volume | 8,013,122 |
| P/S | 0.68 | Employees | 1,670 |
| P/B | 3.72 | Analyst rec (1=buy..5=sell) | 2.7 |

...
Signed file: `HUBB.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $446.92 (2026-09-18, ~15-min delayed) |
| Market cap | $23.62B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-7.67%) with negative half-year (-8.73%). |
| Fresh setup quality | Moderate / wait | -19.40% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 14.49%, revenue growth 15.30%. |
| Value attractiveness | Reasonable | Forward P/E 19.50, EV/Sales 4.59. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $446.92; 52w high $554.46 (-19.40%); 52w low $402.45 (+11.05%) |
| Trend | -7.67% vs SMA200, -5.99% vs SMA50, -1.83% vs SMA20 |
| Momentum | RSI(14) 41.7 (neutral) |
| Volatility | ATR(14) 12.73 (~2.8% of price); beta 0.89 |
| Setup perspective | -19.40% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.46, forward P/E 19.50, P/S 3.79, P/B 6.04 | EV/Sales 4.59, EV/EBITDA 18.86 |
...
|---|---|---|---|
| Price | $446.92 | EV/Sales | 4.59 |
| Market cap | $23.62B | EV/EBITDA | 18.86 |
| Beta | 0.89 | Gross margin | 35.34% |
| RSI(14) | 41.7 | Operating margin | 21.67% |
| ATR(14) | 12.73 | Profit margin | 14.49% |
| SMA20 dist | -1.83% | ROA | 8.43% |
| SMA50 dist | -5.99% | ROE | 24.44% |
| SMA200 dist | -7.67% | Revenue (ttm) | $6.22B |
| 52W high | $554.46 | Revenue growth y/y | 15.30% |
| 52W low | $402.45 | Inst. ownership | 99.11% |
| P/E (ttm) | 26.46 | Insider ownership | 0.34% |
| Forward P/E | 19.50 | Short float | 6.63% |
| PEG (trailing) | 1.86 | Avg volume | 536,719 |
| P/S | 3.79 | Employees | 19,400 |
| P/B | 6.04 | Analyst rec (1=buy..5=sell) | 1.9 |

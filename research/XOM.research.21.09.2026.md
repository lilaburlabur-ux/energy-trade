...
Signed file: `XOM.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $158.30 (2026-09-21, ~15-min delayed) |
| Market cap | $650.92B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $158.30; 52w high $169.32 (-6.51%); 52w low $107.52 (+47.22%) |
| Trend | +8.75% vs SMA200, +0.39% vs SMA50, -2.47% vs SMA20 |
...
| SMA20 dist | -2.47% | ROA | 5.52% |
| SMA50 dist | +0.39% | ROE | 12.58% |
| SMA200 dist | +8.75% | Revenue (ttm) | $361.06B |

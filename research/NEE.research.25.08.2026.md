...
Signed file: `NEE.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $84.22 (2026-08-25, ~15-min delayed) |
| Market cap | $175.68B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-3.37%) with negative half-year (-10.73%). |
| Fresh setup quality | Moderate / wait | -13.33% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 32.40%, revenue growth 12.40%. |
| Value attractiveness | Reasonable | Forward P/E 19.19, EV/Sales 10.24. |
...
|---|---|---|
| 2 Dividend Stocks Compounding Quietly While Oil Headlines Distract Everyone | Motley Fool | 2026-08-25 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $84.22; 52w high $97.17 (-13.33%); 52w low $68.33 (+23.25%) |
| Trend | -3.37% vs SMA200, -3.31% vs SMA50, -1.84% vs SMA20 |
| Momentum | RSI(14) 36.6 (neutral) |
| Volatility | ATR(14) 1.45 (~1.7% of price); beta 0.65 |
| Setup perspective | -13.33% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.93, forward P/E 19.19, P/S 6.12, P/B 3.08 | EV/Sales 10.24, EV/EBITDA 20.13 |
...
|---|---|---|---|
| Price | $84.22 | EV/Sales | 10.24 |
| Market cap | $175.68B | EV/EBITDA | 20.13 |
| Beta | 0.65 | Gross margin | 61.02% |
| RSI(14) | 36.6 | Operating margin | 31.52% |
| ATR(14) | 1.45 | Profit margin | 32.40% |
| SMA20 dist | -1.84% | ROA | 2.44% |
| SMA50 dist | -3.31% | ROE | 11.68% |
| SMA200 dist | -3.37% | Revenue (ttm) | $28.70B |
| 52W high | $97.17 | Revenue growth y/y | 12.40% |
| 52W low | $68.33 | Inst. ownership | 87.14% |
| P/E (ttm) | 18.93 | Insider ownership | 0.12% |
| Forward P/E | 19.19 | Short float | 0.00% |
| PEG (trailing) | 1.84 | Avg volume | 11,408,092 |
| P/S | 6.12 | Employees | 17,400 |
| P/B | 3.08 | Analyst rec (1=buy..5=sell) | 2.0 |

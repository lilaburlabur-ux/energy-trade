...
Signed file: `UEC.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $11.60 (2026-09-09, ~15-min delayed) |
| Market cap | $5.74B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-12.56%) with negative half-year (-19.89%). |
| Fresh setup quality | Poor / broken | -42.40% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -128.89, EV/Sales 267.22. |
| Risk level | High | Beta 1.24, ATR 5.6% of price, short float 14.55%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.60; 52w high $20.14 (-42.40%); 52w low $9.04 (+28.32%) |
| Trend | -12.56% vs SMA200, +6.93% vs SMA50, -2.66% vs SMA20 |
| Momentum | RSI(14) 49.8 (neutral) |
| Volatility | ATR(14) 0.65 (~5.6% of price); beta 1.24 |
| Setup perspective | -42.40% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -128.89, P/S 284.18, P/B 4.03 | EV/Sales 267.22, EV/EBITDA -44.70 |
...
- **Volatility risk:** Beta 1.24, ATR 5.6% of price, short float 14.55%. Size positions accordingly.
...
|---|---|---|---|
| Price | $11.60 | EV/Sales | 267.22 |
| Market cap | $5.74B | EV/EBITDA | -44.70 |
| Beta | 1.24 | Gross margin | 0.00% |
| RSI(14) | 49.8 | Operating margin | -629.66% |
| ATR(14) | 0.65 | Profit margin | 0.00% |
| SMA20 dist | -2.66% | ROA | -6.25% |
| SMA50 dist | +6.93% | ROE | -8.96% |
| SMA200 dist | -12.56% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 88.55% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -128.89 | Short float | 14.55% |
| PEG (trailing) | — | Avg volume | 9,134,325 |
| P/S | 284.18 | Employees | 171 |
| P/B | 4.03 | Analyst rec (1=buy..5=sell) | 1.6 |

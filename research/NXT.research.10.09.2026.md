...
Signed file: `NXT.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $81.35 (2026-09-10, ~15-min delayed) |
| Market cap | $12.50B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-24.95%) with negative half-year (-30.29%). |
| Fresh setup quality | Poor / broken | -47.99% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 16.36%, revenue growth 8.20%. |
| Value attractiveness | Reasonable | Forward P/E 14.09, EV/Sales 3.12. |
| Risk level | High | Beta 1.92, ATR 5.5% of price, short float 8.04%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $81.35; 52w high $156.40 (-47.99%); 52w low $66.70 (+21.96%) |
| Trend | -24.95% vs SMA200, -16.40% vs SMA50, -7.51% vs SMA20 |
| Momentum | RSI(14) 35.5 (neutral) |
| Volatility | ATR(14) 4.50 (~5.5% of price); beta 1.92 |
| Setup perspective | -47.99% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 21.02, forward P/E 14.09, P/S 3.44, P/B 4.82 | EV/Sales 3.12, EV/EBITDA 15.12 |
| Growth expectations | Earnings growth 2.90%, EPS q/q 5.20% | Analyst mean target $140.61 (28 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 109.68% |
...
- **Volatility risk:** Beta 1.92, ATR 5.5% of price, short float 8.04%. Size positions accordingly.
...
|---|---|---|---|
| Price | $81.35 | EV/Sales | 3.12 |
| Market cap | $12.50B | EV/EBITDA | 15.12 |
| Beta | 1.92 | Gross margin | 22.98% |
| RSI(14) | 35.5 | Operating margin | 20.86% |
| ATR(14) | 4.50 | Profit margin | 16.36% |
| SMA20 dist | -7.51% | ROA | 11.68% |
| SMA50 dist | -16.40% | ROE | 27.22% |
| SMA200 dist | -24.95% | Revenue (ttm) | $3.63B |
| 52W high | $156.40 | Revenue growth y/y | 8.20% |
| 52W low | $66.70 | Inst. ownership | 109.68% |
| P/E (ttm) | 21.02 | Insider ownership | 0.64% |
| Forward P/E | 14.09 | Short float | 8.04% |
| PEG (trailing) | 3.15 | Avg volume | 2,966,122 |
| P/S | 3.44 | Employees | 1,993 |
| P/B | 4.82 | Analyst rec (1=buy..5=sell) | 1.4 |

...
Signed file: `EPD.research.10.08.2026`

| Field | Value |
|---|---|
| Current price | $37.99 (2026-08-10, ~15-min delayed) |
| Market cap | $82.19B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +29.69%; price +9.82% vs SMA200. |
| Fresh setup quality | Watch | -3.12% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.05, EV/Sales 2.00. |
| Risk level | Moderate | Beta 0.48, ATR 1.8% of price, short float 2.34%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $37.99; 52w high $39.22 (-3.12%); 52w low $28.35 (+33.98%) |
| Trend | +9.82% vs SMA200, +2.45% vs SMA50, +0.37% vs SMA20 |
| Momentum | RSI(14) 54.1 (neutral) |
| Volatility | ATR(14) 0.69 (~1.8% of price); beta 0.48 |
| Setup perspective | -3.12% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.15, forward P/E 12.05, P/S 1.41, P/B 2.78 | EV/Sales 2.00, EV/EBITDA 11.35 |
| Growth expectations | Earnings growth 29.60%, EPS q/q 28.40% | Analyst mean target $41.20 (20 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 25.03% |
...
| Kayne Anderson Capital Advisors, L.P. | 13,031,597 | 0.60% | 2026-03-31 |
...
|---|---|---|---|
| Price | $37.99 | EV/Sales | 2.00 |
| Market cap | $82.19B | EV/EBITDA | 11.35 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 54.1 | Operating margin | 11.76% |
| ATR(14) | 0.69 | Profit margin | 10.79% |
| SMA20 dist | +0.37% | ROA | — |
| SMA50 dist | +2.45% | ROE | — |
| SMA200 dist | +9.82% | Revenue (ttm) | $58.47B |
| 52W high | $39.22 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.03% |
| P/E (ttm) | 13.15 | Insider ownership | 32.98% |
| Forward P/E | 12.05 | Short float | 2.34% |
| PEG (trailing) | 1.47 | Avg volume | 3,275,358 |

...
Signed file: `HUBB.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $443.23 (2026-09-17, ~15-min delayed) |
| Market cap | $23.42B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-8.41%) with negative half-year (-6.60%). |
| Fresh setup quality | Moderate / wait | -20.06% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 14.49%, revenue growth 15.30%. |
| Value attractiveness | Reasonable | Forward P/E 19.34, EV/Sales 4.56. |
| Risk level | Moderate | Beta 0.89, ATR 3.0% of price, short float 6.63%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $443.23; 52w high $554.46 (-20.06%); 52w low $402.45 (+10.13%) |
| Trend | -8.41% vs SMA200, -6.91% vs SMA50, -2.86% vs SMA20 |
| Momentum | RSI(14) 39.2 (neutral) |
| Volatility | ATR(14) 13.27 (~3.0% of price); beta 0.89 |
| Setup perspective | -20.06% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.23, forward P/E 19.34, P/S 3.76, P/B 5.99 | EV/Sales 4.56, EV/EBITDA 18.72 |
...
|---|---|---|---|
| Price | $443.23 | EV/Sales | 4.56 |
| Market cap | $23.42B | EV/EBITDA | 18.72 |
| Beta | 0.89 | Gross margin | 35.34% |
| RSI(14) | 39.2 | Operating margin | 21.67% |
| ATR(14) | 13.27 | Profit margin | 14.49% |
| SMA20 dist | -2.86% | ROA | 8.43% |
| SMA50 dist | -6.91% | ROE | 24.44% |
| SMA200 dist | -8.41% | Revenue (ttm) | $6.22B |
| 52W high | $554.46 | Revenue growth y/y | 15.30% |
| 52W low | $402.45 | Inst. ownership | 99.11% |
| P/E (ttm) | 26.23 | Insider ownership | 0.34% |
| Forward P/E | 19.34 | Short float | 6.63% |
| PEG (trailing) | 1.84 | Avg volume | 540,462 |

...
Signed file: `UEC.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $10.50 (2026-08-04, ~15-min delayed) |
| Market cap | — |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-22.06%) with negative half-year (-35.66%). |
| Fresh setup quality | Poor / broken | -47.86% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -105.00, EV/Sales 220.19. |
| Risk level | High | Beta 1.21, ATR 6.3% of price, short float 14.14%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.50; 52w high $20.14 (-47.86%); 52w low $9.04 (+16.15%) |
| Trend | -22.06% vs SMA200, -5.03% vs SMA50, +7.13% vs SMA20 |
| Momentum | RSI(14) 53.3 (neutral) |
| Volatility | ATR(14) 0.67 (~6.3% of price); beta 1.21 |
| Setup perspective | -47.86% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -105.00, P/S —, P/B — | EV/Sales 220.19, EV/EBITDA -36.83 |
...
- **Volatility risk:** Beta 1.21, ATR 6.3% of price, short float 14.14%. Size positions accordingly.
...
|---|---|---|---|
| Price | $10.50 | EV/Sales | 220.19 |
| Market cap | — | EV/EBITDA | -36.83 |
| Beta | 1.21 | Gross margin | 0.00% |
| RSI(14) | 53.3 | Operating margin | -629.66% |
| ATR(14) | 0.67 | Profit margin | 0.00% |
| SMA20 dist | +7.13% | ROA | -6.25% |
| SMA50 dist | -5.03% | ROE | -8.96% |
| SMA200 dist | -22.06% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 85.16% |
| P/E (ttm) | — | Insider ownership | 1.85% |
| Forward P/E | -105.00 | Short float | 14.14% |
| PEG (trailing) | — | Avg volume | 10,025,121 |
| P/S | — | Employees | 171 |

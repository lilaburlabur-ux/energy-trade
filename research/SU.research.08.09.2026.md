...
| Volatility | ATR(14) 1.67 (~2.5% of price); beta — |
...
|---|---|---|---|
| Price | $67.89 | EV/Sales | — |
| Market cap | — | EV/EBITDA | — |
| Beta | — | Gross margin | — |
| RSI(14) | 59.3 | Operating margin | — |
| ATR(14) | 1.67 | Profit margin | — |
| SMA20 dist | +2.33% | ROA | — |
| SMA50 dist | +7.64% | ROE | — |
| SMA200 dist | +18.18% | Revenue (ttm) | — |
| 52W high | $68.83 | Revenue growth y/y | — |
| 52W low | $37.39 | Inst. ownership | — |
...
## 9. Conclusion
SU: High momentum / mixed fundamentals / low (expensive) value / moderate risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

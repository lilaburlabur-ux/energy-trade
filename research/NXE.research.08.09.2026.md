# NXE Research Report
**NexGen Energy** — Technical + Fundamental Analysis, Data Snapshot, Institutional Investors
...
| Risk level | Elevated | Beta —, ATR 4.5% of price, short float —. |
...
| Volatility | ATR(14) 0.48 (~4.5% of price); beta — |
...
- **Volatility risk:** Beta —, ATR 4.5% of price, short float —. Size positions accordingly.
...
| Beta | — | Gross margin | — |
| RSI(14) | 54.3 | Operating margin | — |
| ATR(14) | 0.48 | Profit margin | — |
| SMA20 dist | +0.83% | ROA | — |
| SMA50 dist | +8.05% | ROE | — |
| SMA200 dist | -1.31% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.56 | Inst. ownership | — |
...
## 9. Conclusion
NXE: Low momentum / mixed fundamentals / low (expensive) value / elevated risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

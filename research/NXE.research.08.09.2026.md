...
Signed file: `NXE.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $10.69 (2026-09-08, ~15-min delayed) |
| Market cap | $7.17B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-1.31%) with negative half-year (-15.56%). |
| Fresh setup quality | Moderate / wait | -23.20% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -57.20, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.69; 52w high $13.92 (-23.20%); 52w low $7.56 (+41.40%) |
| Trend | -1.31% vs SMA200, +8.05% vs SMA50, +0.83% vs SMA20 |
| Momentum | RSI(14) 54.3 (neutral) |
| Volatility | ATR(14) 0.48 (~4.5% of price); beta 1.67 |
| Setup perspective | -23.20% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E -57.20, P/S —, P/B 5.35 | EV/Sales —, EV/EBITDA -63.08 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $19.51 (1 analysts) |
...
|---|---|---|---|
| Price | $10.69 | EV/Sales | — |
| Market cap | $7.17B | EV/EBITDA | -63.08 |
| Beta | 1.67 | Gross margin | 0.00% |
| RSI(14) | 54.3 | Operating margin | 0.00% |
| ATR(14) | 0.48 | Profit margin | 0.00% |
| SMA20 dist | +0.83% | ROA | -3.39% |
| SMA50 dist | +8.05% | ROE | -17.67% |
| SMA200 dist | -1.31% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.56 | Inst. ownership | 55.22% |
| P/E (ttm) | — | Insider ownership | 6.39% |
| Forward P/E | -57.20 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,238,475 |
| P/S | — | Employees | 142 |
| P/B | 5.35 | Analyst rec (1=buy..5=sell) | 1.5 |

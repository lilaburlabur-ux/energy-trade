...
Signed file: `TTE.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $89.29 (2026-08-18, ~15-min delayed) |
| Market cap | $197.97B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +49.64%; price +14.13% vs SMA200. |
| Fresh setup quality | Watch | -4.60% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 9.08%, revenue growth 27.80%. |
| Value attractiveness | Reasonable | Forward P/E 9.26, EV/Sales 1.18. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $89.29; 52w high $93.60 (-4.60%); 52w low $55.92 (+59.67%) |
| Trend | +14.13% vs SMA200, +7.20% vs SMA50, +2.98% vs SMA20 |
| Momentum | RSI(14) 63.7 (neutral) |
| Volatility | ATR(14) 1.64 (~1.8% of price); beta 0.06 |
| Setup perspective | -4.60% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 11.18, forward P/E 9.26, P/S 1.01, P/B 1.55 | EV/Sales 1.18, EV/EBITDA 5.82 |
...
|---|---|---|---|
| Price | $89.29 | EV/Sales | 1.18 |
| Market cap | $197.97B | EV/EBITDA | 5.82 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 63.7 | Operating margin | 12.79% |
| ATR(14) | 1.64 | Profit margin | 9.08% |
| SMA20 dist | +2.98% | ROA | 5.51% |
| SMA50 dist | +7.20% | ROE | 14.48% |
| SMA200 dist | +14.13% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 54.81% |
| P/E (ttm) | 11.18 | Insider ownership | 8.86% |
| Forward P/E | 9.26 | Short float | 0.20% |
| PEG (trailing) | 0.72 | Avg volume | 1,560,717 |
| P/S | 1.01 | Employees | 94,847 |
| P/B | 1.55 | Analyst rec (1=buy..5=sell) | — |

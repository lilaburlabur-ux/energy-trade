...
Signed file: `RUN.research.13.08.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-35.65%) with negative half-year (-48.54%). |
| Fresh setup quality | Poor / broken | -53.95% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 11.59%, revenue growth 52.80%. |
| Value attractiveness | Reasonable | Forward P/E 10.00, EV/Sales 5.35. |
| Risk level | High | Beta 2.39, ATR 7.5% of price, short float 32.19%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.86; 52w high $21.41 (-53.95%); 52w low $9.38 (+5.12%) |
| Trend | -35.65% vs SMA200, -17.27% vs SMA50, -4.06% vs SMA20 |
| Momentum | RSI(14) 40.7 (neutral) |
| Volatility | ATR(14) 0.74 (~7.5% of price); beta 2.39 |
| Setup perspective | -53.95% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 2.39, ATR 7.5% of price, short float 32.19%. Size positions accordingly.
...
| P/B | 0.70 | Analyst rec (1=buy..5=sell) | 2.0 |

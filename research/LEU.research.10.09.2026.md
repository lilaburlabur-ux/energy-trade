...
Signed file: `LEU.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $165.87 (2026-09-10, ~15-min delayed) |
| Market cap | $3.31B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-20.83%) with negative half-year (-17.21%). |
...
| Value attractiveness | Low (expensive) | Forward P/E 44.12, EV/Sales 6.18. |
| Risk level | High | Beta 1.33, ATR 7.3% of price, short float 29.16%. |
...
| Centrus Energy, SM Energy, BKV, Select Water Solutions, and ProFrac Stocks Trade Up, What You Need To Know | StockStory | 2026-09-09 |
| Centrus Energy (LEU) Down 4.3% Since Last Earnings Report: Can It Rebound? | Zacks | 2026-09-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $165.87; 52w high $436.00 (-61.96%); 52w low $146.61 (+13.14%) |
| Trend | -20.83% vs SMA200, -5.21% vs SMA50, -7.98% vs SMA20 |
| Momentum | RSI(14) 43.7 (neutral) |
| Volatility | ATR(14) 12.14 (~7.3% of price); beta 1.33 |
...
| Valuation | P/E 87.76, forward P/E 44.12, P/S 6.98, P/B 3.91 | EV/Sales 6.18, EV/EBITDA 290.12 |
...
- **Valuation risk:** Forward P/E 44.12, EV/Sales 6.18. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.33, ATR 7.3% of price, short float 29.16%. Size positions accordingly.
...
|---|---|---|---|
| Price | $165.87 | EV/Sales | 6.18 |
| Market cap | $3.31B | EV/EBITDA | 290.12 |
| Beta | 1.33 | Gross margin | 23.66% |
| RSI(14) | 43.7 | Operating margin | 5.34% |
| ATR(14) | 12.14 | Profit margin | 10.23% |
| SMA20 dist | -7.98% | ROA | 0.02% |
| SMA50 dist | -5.21% | ROE | 8.05% |
| SMA200 dist | -20.83% | Revenue (ttm) | $473.90M |
| 52W high | $436.00 | Revenue growth y/y | 14.00% |
| 52W low | $146.61 | Inst. ownership | 90.90% |
| P/E (ttm) | 87.76 | Insider ownership | 4.31% |
| Forward P/E | 44.12 | Short float | 29.16% |
| PEG (trailing) | — | Avg volume | 744,541 |
| P/S | 6.98 | Employees | 467 |
| P/B | 3.91 | Analyst rec (1=buy..5=sell) | 1.8 |

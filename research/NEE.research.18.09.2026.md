...
Signed file: `NEE.research.18.09.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-6.97%) with negative half-year (-11.62%). |
| Fresh setup quality | Moderate / wait | -16.56% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 32.40%, revenue growth 12.40%. |
| Value attractiveness | Reasonable | Forward P/E 18.30, EV/Sales 10.03. |
...
|---|---|---|
| JPMorgan Sees Investment Banking and Trading Powering Q3 Growth | Insider Monkey | 2026-09-18 |
| GE Vernova vs. NextEra Energy: Which Industrials Stock Is a Better Buy in 2026? | Motley Fool | 2026-09-18 |
| Jim Cramer says 'take the money and run' on energy titan, up 18% | TheStreet | 2026-09-18 |
| NextEra Energy (NEE) Gains But Lags Market: What You Should Know | Zacks | 2026-09-17 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $80.47; 52w high $96.44 (-16.56%); 52w low $68.81 (+16.94%) |
| Trend | -6.97% vs SMA200, -5.35% vs SMA50, -2.48% vs SMA20 |
| Momentum | RSI(14) 33.6 (neutral) |
| Volatility | ATR(14) 1.28 (~1.6% of price); beta 0.64 |
| Setup perspective | -16.56% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.08, forward P/E 18.30, P/S 5.85, P/B 2.94 | EV/Sales 10.03, EV/EBITDA 19.73 |
...
|---|---|---|---|
| Price | $80.47 | EV/Sales | 10.03 |
| Market cap | $167.83B | EV/EBITDA | 19.73 |
| Beta | 0.64 | Gross margin | 61.02% |
| RSI(14) | 33.6 | Operating margin | 31.52% |
| ATR(14) | 1.28 | Profit margin | 32.40% |
| SMA20 dist | -2.48% | ROA | 2.44% |
| SMA50 dist | -5.35% | ROE | 11.68% |
| SMA200 dist | -6.97% | Revenue (ttm) | $28.70B |
| 52W high | $96.44 | Revenue growth y/y | 12.40% |
| 52W low | $68.81 | Inst. ownership | 87.01% |
| P/E (ttm) | 18.08 | Insider ownership | 0.12% |
| Forward P/E | 18.30 | Short float | 0.00% |
| PEG (trailing) | 1.66 | Avg volume | 10,923,703 |
| P/S | 5.85 | Employees | 17,400 |
| P/B | 2.94 | Analyst rec (1=buy..5=sell) | 2.0 |

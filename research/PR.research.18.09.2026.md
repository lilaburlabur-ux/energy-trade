...
Signed file: `PR.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $22.76 (2026-09-18, ~15-min delayed) |
| Market cap | $19.06B |
...
|---|---|---|
| Technical momentum | High | 1Y +73.68%; price +21.35% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.45% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 21.52%, revenue growth 55.10%. |
| Value attractiveness | Reasonable | Forward P/E 10.24, EV/Sales 3.91. |
| Risk level | Elevated | Beta 0.48, ATR 3.1% of price, short float 2.47%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $22.76; 52w high $24.33 (-6.45%); 52w low $11.68 (+94.80%) |
| Trend | +21.35% vs SMA200, +4.53% vs SMA50, -2.46% vs SMA20 |
| Momentum | RSI(14) 49.4 (neutral) |
| Volatility | ATR(14) 0.71 (~3.1% of price); beta 0.48 |
| Setup perspective | -6.45% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 14.68, forward P/E 10.24, P/S 3.32, P/B 1.59 | EV/Sales 3.91, EV/EBITDA 5.28 |
...
- **Volatility risk:** Beta 0.48, ATR 3.1% of price, short float 2.47%. Size positions accordingly.
...
|---|---|---|---|
| Price | $22.76 | EV/Sales | 3.91 |
| Market cap | $19.06B | EV/EBITDA | 5.28 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 49.4 | Operating margin | 57.44% |
| ATR(14) | 0.71 | Profit margin | 21.52% |
| SMA20 dist | -2.46% | ROA | 7.54% |
| SMA50 dist | +4.53% | ROE | 11.40% |
| SMA200 dist | +21.35% | Revenue (ttm) | $5.74B |
| 52W high | $24.33 | Revenue growth y/y | 55.10% |
| 52W low | $11.68 | Inst. ownership | 92.72% |
| P/E (ttm) | 14.68 | Insider ownership | 4.61% |
| Forward P/E | 10.24 | Short float | 2.47% |
| PEG (trailing) | 1.34 | Avg volume | 9,632,122 |

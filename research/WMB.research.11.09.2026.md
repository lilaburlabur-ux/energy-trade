...
Signed file: `WMB.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $72.85 (2026-09-11, ~15-min delayed) |
| Market cap | $89.11B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +27.91%; price +4.22% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 27.98, EV/Sales 9.89. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $72.85; 52w high $78.82 (-7.57%); 52w low $55.24 (+31.88%) |
| Trend | +4.22% vs SMA200, -0.62% vs SMA50, -1.14% vs SMA20 |
| Momentum | RSI(14) 47.2 (neutral) |
| Volatility | ATR(14) 2.04 (~2.8% of price); beta 0.62 |
...
- **Valuation risk:** Forward P/E 27.98, EV/Sales 9.89. Multiple compression is the main downside if growth disappoints.

...
Signed file: `LEU.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $154.85 (2026-09-21, ~15-min delayed) |
| Market cap | $3.17B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-24.76%) with negative half-year (-17.09%). |
| Fresh setup quality | Poor / broken | -64.48% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.23%, revenue growth 14.00%. |
| Value attractiveness | Low (expensive) | Forward P/E 41.19, EV/Sales 4.66. |
| Risk level | High | Beta 1.33, ATR 7.4% of price, short float 28.54%. |
...
| Centrus Energy (LEU) Lands New HALEU Deal with Antares | Insider Monkey | 2026-09-20 |
| Centrus Energy (LEU) Signs Two HALEU Supply Agreements Backing Reactor And Security Demand | Simply Wall St. | 2026-09-19 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $154.85; 52w high $436.00 (-64.48%); 52w low $139.01 (+11.39%) |
| Trend | -24.76% vs SMA200, -9.97% vs SMA50, -7.46% vs SMA20 |
| Momentum | RSI(14) 44.4 (neutral) |
| Volatility | ATR(14) 11.39 (~7.4% of price); beta 1.33 |
| Setup perspective | -64.48% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 81.93, forward P/E 41.19, P/S 6.68, P/B 3.65 | EV/Sales 4.66, EV/EBITDA 218.49 |
...
- **Valuation risk:** Forward P/E 41.19, EV/Sales 4.66. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.33, ATR 7.4% of price, short float 28.54%. Size positions accordingly.
...
|---|---|---|---|
| Price | $154.85 | EV/Sales | 4.66 |
| Market cap | $3.17B | EV/EBITDA | 218.49 |
| Beta | 1.33 | Gross margin | 23.66% |
| RSI(14) | 44.4 | Operating margin | 5.34% |
| ATR(14) | 11.39 | Profit margin | 10.23% |
| SMA20 dist | -7.46% | ROA | 0.02% |
| SMA50 dist | -9.97% | ROE | 8.05% |
| SMA200 dist | -24.76% | Revenue (ttm) | $473.90M |

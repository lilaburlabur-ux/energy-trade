...
Signed file: `TLN.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $317.66 (2026-08-18, ~15-min delayed) |
| Market cap | $15.22B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-12.56%) with negative half-year (-15.67%). |
...
| Value attractiveness | Reasonable | Forward P/E 10.90, EV/Sales 7.08. |
| Risk level | High | Beta 1.67, ATR 6.7% of price, short float 5.32%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $317.66; 52w high $445.84 (-28.75%); 52w low $302.97 (+4.85%) |
| Trend | -12.56% vs SMA200, -14.03% vs SMA50, -8.49% vs SMA20 |
| Momentum | RSI(14) 38.1 (neutral) |
| Volatility | ATR(14) 21.16 (~6.7% of price); beta 1.67 |
...
| Valuation | P/E —, forward P/E 10.90, P/S 4.07, P/B 9.42 | EV/Sales 7.08, EV/EBITDA 45.48 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $467.69 (16 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 102.18% |
...
- **Volatility risk:** Beta 1.67, ATR 6.7% of price, short float 5.32%. Size positions accordingly.
...
|---|---|---|---|
| Price | $317.66 | EV/Sales | 7.08 |
| Market cap | $15.22B | EV/EBITDA | 45.48 |
| Beta | 1.67 | Gross margin | 42.10% |
| RSI(14) | 38.1 | Operating margin | -4.80% |
| ATR(14) | 21.16 | Profit margin | -4.95% |
| SMA20 dist | -8.49% | ROA | 0.92% |
| SMA50 dist | -14.03% | ROE | -12.83% |
| SMA200 dist | -12.56% | Revenue (ttm) | $3.74B |
| 52W high | $445.84 | Revenue growth y/y | 111.20% |
| 52W low | $302.97 | Inst. ownership | 102.18% |
| P/E (ttm) | — | Insider ownership | 1.36% |
| Forward P/E | 10.90 | Short float | 5.32% |
| PEG (trailing) | — | Avg volume | 824,101 |
| P/S | 4.07 | Employees | 1,880 |
| P/B | 9.42 | Analyst rec (1=buy..5=sell) | 1.6 |

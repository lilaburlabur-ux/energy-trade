...
Signed file: `SLB.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $54.20 (2026-09-15, ~15-min delayed) |
| Market cap | $80.44B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +56.10%; price +10.21% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 16.76, EV/Sales 2.45. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $54.20; 52w high $59.79 (-9.35%); 52w low $30.96 (+75.05%) |
| Trend | +10.21% vs SMA200, +4.77% vs SMA50, -2.20% vs SMA20 |
| Momentum | RSI(14) 48.8 (neutral) |
| Volatility | ATR(14) 1.91 (~3.5% of price); beta 0.77 |
...
| Valuation | P/E 26.44, forward P/E 16.76, P/S 2.21, P/B 3.09 | EV/Sales 2.45, EV/EBITDA 12.05 |
...
- **Volatility risk:** Beta 0.77, ATR 3.5% of price, short float 4.25%. Size positions accordingly.
...
|---|---|---|---|
| Price | $54.20 | EV/Sales | 2.45 |
| Market cap | $80.44B | EV/EBITDA | 12.05 |
| Beta | 0.77 | Gross margin | 16.99% |
| RSI(14) | 48.8 | Operating margin | 12.71% |
| ATR(14) | 1.91 | Profit margin | 8.53% |
| SMA20 dist | -2.20% | ROA | 6.17% |
| SMA50 dist | +4.77% | ROE | 12.91% |
| SMA200 dist | +10.21% | Revenue (ttm) | $36.37B |
| 52W high | $59.79 | Revenue growth y/y | 5.00% |
| 52W low | $30.96 | Inst. ownership | 92.52% |
| P/E (ttm) | 26.44 | Insider ownership | 0.22% |
| Forward P/E | 16.76 | Short float | 4.25% |
| PEG (trailing) | 1.41 | Avg volume | 13,752,233 |
| P/S | 2.21 | Employees | 109,000 |
| P/B | 3.09 | Analyst rec (1=buy..5=sell) | 1.6 |

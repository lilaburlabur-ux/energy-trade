...
Signed file: `BP.research.27.08.2026`

| Field | Value |
|---|---|
| Current price | $42.50 (2026-08-27, ~15-min delayed) |
| Market cap | $109.45B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +27.79%; price +7.26% vs SMA200. |
| Fresh setup quality | Moderate / wait | -8.64% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 2.55%, revenue growth 48.20%. |
| Value attractiveness | Reasonable | Forward P/E 9.58, EV/Sales 2.29. |
...
|---|---|---|
| Meta joins a list of corporations that have settled cases for billions of dollars | Associated Press | 2026-08-26 |
| Eni Announces $8.5B Investment Plan to Boost E&P Activities in Egypt | Zacks | 2026-08-26 |
| Halliburton Wins BP Contract for Bumerangue Field Appraisal | Zacks | 2026-08-26 |
| Exchange-Traded Funds Lower, Equity Futures Mixed Pre-Bell Wednesday Amid Inflation Data Release | MT Newswires | 2026-08-26 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $42.50; 52w high $46.52 (-8.64%); 52w low $31.17 (+36.33%) |
| Trend | +7.26% vs SMA200, +3.82% vs SMA50, -1.02% vs SMA20 |
| Momentum | RSI(14) 49.5 (neutral) |
| Volatility | ATR(14) 0.99 (~2.3% of price); beta -0.21 |
| Setup perspective | -8.64% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.53, forward P/E 9.58, P/S 0.51, P/B 7.53 | EV/Sales 2.29, EV/EBITDA 12.58 |
...
|---|---|---|---|
| Price | $42.50 | EV/Sales | 2.29 |
| Market cap | $109.45B | EV/EBITDA | 12.58 |
| Beta | -0.21 | Gross margin | 28.30% |
| RSI(14) | 49.5 | Operating margin | 13.15% |
| ATR(14) | 0.99 | Profit margin | 2.55% |
| SMA20 dist | -1.02% | ROA | 5.04% |
| SMA50 dist | +3.82% | ROE | 8.87% |
| SMA200 dist | +7.26% | Revenue (ttm) | $215.47B |
| 52W high | $46.52 | Revenue growth y/y | 48.20% |
| 52W low | $31.17 | Inst. ownership | 14.09% |
| P/E (ttm) | 20.53 | Insider ownership | 0.00% |
| Forward P/E | 9.58 | Short float | 0.28% |
| PEG (trailing) | 0.04 | Avg volume | 8,931,238 |
| P/S | 0.51 | Employees | 93,700 |
| P/B | 7.53 | Analyst rec (1=buy..5=sell) | 2.4 |

...
Signed file: `NEE.research.09.09.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-4.51%) with negative half-year (-8.37%). |
| Fresh setup quality | Moderate / wait | -14.30% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 32.40%, revenue growth 12.40%. |
| Value attractiveness | Reasonable | Forward P/E 18.83, EV/Sales 10.22. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $82.65; 52w high $96.44 (-14.30%); 52w low $67.88 (+21.76%) |
| Trend | -4.51% vs SMA200, -3.66% vs SMA50, -1.47% vs SMA20 |
| Momentum | RSI(14) 39.8 (neutral) |
| Volatility | ATR(14) 1.34 (~1.6% of price); beta 0.64 |
| Setup perspective | -14.30% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.57, forward P/E 18.83, P/S 6.01, P/B 3.02 | EV/Sales 10.22, EV/EBITDA 20.09 |
...
| SMA20 dist | -1.47% | ROA | 2.44% |
| SMA50 dist | -3.66% | ROE | 11.68% |
| SMA200 dist | -4.51% | Revenue (ttm) | $28.70B |
| 52W high | $96.44 | Revenue growth y/y | 12.40% |
| 52W low | $67.88 | Inst. ownership | 87.10% |
| P/E (ttm) | 18.57 | Insider ownership | 0.12% |
| Forward P/E | 18.83 | Short float | 0.00% |
| PEG (trailing) | 1.69 | Avg volume | 10,978,972 |
| P/S | 6.01 | Employees | 17,400 |
| P/B | 3.02 | Analyst rec (1=buy..5=sell) | — |

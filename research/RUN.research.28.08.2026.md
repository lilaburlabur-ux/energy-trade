...
Signed file: `RUN.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $9.06 (2026-08-28, ~15-min delayed) |
| Market cap | $2.16B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-38.79%) with negative half-year (-55.63%). |
...
| Value attractiveness | Reasonable | Forward P/E 8.93, EV/Sales 5.30. |
| Risk level | High | Beta 2.39, ATR 6.5% of price, short float 32.34%. |
...
|---|---|---|
| The Demand Signal Underneath Tesla Stock's Cash-Burn Debate | Trefis | 2026-08-27 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.06; 52w high $21.41 (-57.68%); 52w low $8.92 (+1.57%) |
| Trend | -38.79% vs SMA200, -18.86% vs SMA50, -7.00% vs SMA20 |
| Momentum | RSI(14) 38.8 (neutral) |
| Volatility | ATR(14) 0.59 (~6.5% of price); beta 2.39 |
...
| Valuation | P/E 6.16, forward P/E 8.93, P/S 0.62, P/B 0.62 | EV/Sales 5.30, EV/EBITDA 21.90 |
...
- **Volatility risk:** Beta 2.39, ATR 6.5% of price, short float 32.34%. Size positions accordingly.
- **Short interest risk:** short float 32.34% can fuel squeezes both ways around news.
...
|---|---|---|---|
| Price | $9.06 | EV/Sales | 5.30 |
| Market cap | $2.16B | EV/EBITDA | 21.90 |
| Beta | 2.39 | Gross margin | 35.29% |
| RSI(14) | 38.8 | Operating margin | 4.00% |
| ATR(14) | 0.59 | Profit margin | 11.59% |
| SMA20 dist | -7.00% | ROA | 0.26% |
| SMA50 dist | -18.86% | ROE | -19.86% |
| SMA200 dist | -38.79% | Revenue (ttm) | $3.48B |
| 52W high | $21.41 | Revenue growth y/y | 52.80% |
| 52W low | $8.92 | Inst. ownership | 116.93% |
| P/E (ttm) | 6.16 | Insider ownership | 2.82% |
| Forward P/E | 8.93 | Short float | 32.34% |
| PEG (trailing) | 3.07 | Avg volume | 10,064,555 |

...
Signed file: `VLO.research.27.08.2026`

| Field | Value |
|---|---|
| Current price | $348.03 (2026-08-27, ~15-min delayed) |
| Market cap | $100.21B |
...
|---|---|---|
| Technical momentum | High | 1Y +141.59%; price +50.35% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.58% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 5.45%, revenue growth 51.70%. |
| Value attractiveness | Reasonable | Forward P/E 11.36, EV/Sales 0.81. |
| Risk level | Elevated | Beta 0.55, ATR 3.1% of price, short float 3.89%. |
...
|---|---|---|
| 3 Growth Stocks to Buy as Treasury Yields Fall: MU, STX & VLO | Zacks | 2026-08-26 |
...
| Bet on These 5 Low-Leverage Stocks as Bond Yields Dip | Zacks | 2026-08-26 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $348.03; 52w high $350.05 (-0.58%); 52w low $143.90 (+141.86%) |
| Trend | +50.35% vs SMA200, +16.83% vs SMA50, +6.02% vs SMA20 |
| Momentum | RSI(14) 66.6 (neutral) |
| Volatility | ATR(14) 10.72 (~3.1% of price); beta 0.55 |
| Setup perspective | -0.58% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 14.53, forward P/E 11.36, P/S 0.76, P/B 4.01 | EV/Sales 0.81, EV/EBITDA 7.99 |
...
- **Volatility risk:** Beta 0.55, ATR 3.1% of price, short float 3.89%. Size positions accordingly.
...
|---|---|---|---|
| Price | $348.03 | EV/Sales | 0.81 |
| Market cap | $100.21B | EV/EBITDA | 7.99 |
| Beta | 0.55 | Gross margin | 16.12% |
| RSI(14) | 66.6 | Operating margin | 12.27% |
| ATR(14) | 10.72 | Profit margin | 5.45% |
| SMA20 dist | +6.02% | ROA | 10.56% |
| SMA50 dist | +16.83% | ROE | 27.64% |
| SMA200 dist | +50.35% | Revenue (ttm) | $132.43B |
| 52W high | $350.05 | Revenue growth y/y | 51.70% |
| 52W low | $143.90 | Inst. ownership | 87.08% |
| P/E (ttm) | 14.53 | Insider ownership | 0.42% |
| Forward P/E | 11.36 | Short float | 3.89% |
| PEG (trailing) | 4.08 | Avg volume | 2,858,444 |
| P/S | 0.76 | Employees | 9,785 |
| P/B | 4.01 | Analyst rec (1=buy..5=sell) | 2.4 |

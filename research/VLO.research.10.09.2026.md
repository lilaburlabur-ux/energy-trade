...
Signed file: `VLO.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $385.43 (2026-09-10, ~15-min delayed) |
| Market cap | $110.98B |
...
|---|---|---|
| Technical momentum | High | 1Y +143.22%; price +59.83% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.91% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 5.45%, revenue growth 51.70%. |
| Value attractiveness | Reasonable | Forward P/E 11.82, EV/Sales 0.90. |
...
|---|---|---|
| What Does the Future Hold for Par Pacific's Refining Business? | Zacks | 2026-09-10 |
| Can Par Pacific's Diversified Downstream Platform Drive Growth? | Zacks | 2026-09-10 |
| Delek's Margin Capture Improves Sharply: Is This More Than a Cycle? | Zacks | 2026-09-10 |
| Investors Heavily Search Valero Energy Corporation (VLO): Here is What You Need to Know | Zacks | 2026-09-10 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $385.43; 52w high $388.95 (-0.91%); 52w low $153.14 (+151.68%) |
| Trend | +59.83% vs SMA200, +19.72% vs SMA50, +8.00% vs SMA20 |
| Momentum | RSI(14) 77.1 (overbought) |
| Volatility | ATR(14) 10.81 (~2.8% of price); beta 0.57 |
| Setup perspective | -0.91% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 16.06, forward P/E 11.82, P/S 0.84, P/B 4.44 | EV/Sales 0.90, EV/EBITDA 8.87 |
| Growth expectations | Earnings growth 453.50%, EPS q/q 421.00% | Analyst mean target $330.21 (19 analysts) |
...
|---|---|---|---|
| Price | $385.43 | EV/Sales | 0.90 |
| Market cap | $110.98B | EV/EBITDA | 8.87 |
| Beta | 0.57 | Gross margin | 16.12% |
| RSI(14) | 77.1 | Operating margin | 12.27% |
| ATR(14) | 10.81 | Profit margin | 5.45% |
| SMA20 dist | +8.00% | ROA | 10.56% |
| SMA50 dist | +19.72% | ROE | 27.64% |
| SMA200 dist | +59.83% | Revenue (ttm) | $132.43B |
| 52W high | $388.95 | Revenue growth y/y | 51.70% |
| 52W low | $153.14 | Inst. ownership | 87.12% |
| P/E (ttm) | 16.06 | Insider ownership | 0.42% |
| Forward P/E | 11.82 | Short float | 3.89% |
| PEG (trailing) | 4.08 | Avg volume | 2,857,253 |
| P/S | 0.84 | Employees | 9,785 |
| P/B | 4.44 | Analyst rec (1=buy..5=sell) | 2.4 |

...
Signed file: `KMI.research.15.09.2026`
...
|---|---|---|
| Technical momentum | Moderate | 1Y +16.05%; price +0.04% vs SMA200. |
| Fresh setup quality | Moderate / wait | -9.48% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 19.30%, revenue growth 10.80%. |
| Value attractiveness | Reasonable | Forward P/E 19.93, EV/Sales 5.71. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $30.77; 52w high $33.99 (-9.48%); 52w low $24.86 (+23.77%) |
| Trend | +0.04% vs SMA200, -3.02% vs SMA50, -2.45% vs SMA20 |
| Momentum | RSI(14) 41.7 (neutral) |
| Volatility | ATR(14) 0.75 (~2.4% of price); beta 0.55 |
| Setup perspective | -9.48% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | -2.45% | ROA | 4.45% |
| SMA50 dist | -3.02% | ROE | 10.99% |
| SMA200 dist | +0.04% | Revenue (ttm) | $17.96B |

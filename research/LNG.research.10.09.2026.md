...
Signed file: `LNG.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $277.84 (2026-09-10, ~15-min delayed) |
| Market cap | $57.38B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +19.69%; price +15.55% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.09% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 13.94%, revenue growth 22.70%. |
| Value attractiveness | Reasonable | Forward P/E 13.38, EV/Sales 4.26. |
| Risk level | Moderate | Beta -0.00, ATR 2.9% of price, short float 2.15%. |
...
|---|---|---|
| European Natural Gas Surges to 4-Year High, Lifting These Energy Stocks | Barrons.com | 2026-09-10 |
| Why Is California Resources (CRC) Up 2.7% Since Last Earnings Report? | Zacks | 2026-09-09 |
| Bechtel reaches substantial completion on Texas LNG project | Construction Dive | 2026-09-08 |
| KGEI vs. LNG: Which Stock Is the Better Value Option? | Zacks | 2026-09-07 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $277.84; 52w high $295.86 (-6.09%); 52w low $187.49 (+48.19%) |
| Trend | +15.55% vs SMA200, +3.75% vs SMA50, -0.96% vs SMA20 |
| Momentum | RSI(14) 50.9 (neutral) |
| Volatility | ATR(14) 7.92 (~2.9% of price); beta -0.00 |
| Setup perspective | -6.09% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.06, forward P/E 13.38, P/S 2.74, P/B 9.33 | EV/Sales 4.26, EV/EBITDA 11.39 |
...
|---|---|---|---|
| Price | $277.84 | EV/Sales | 4.26 |
| Market cap | $57.38B | EV/EBITDA | 11.39 |
| Beta | -0.00 | Gross margin | 36.85% |
| RSI(14) | 50.9 | Operating margin | 75.00% |
| ATR(14) | 7.92 | Profit margin | 13.94% |
| SMA20 dist | -0.96% | ROA | 8.63% |
| SMA50 dist | +3.75% | ROE | 39.12% |
| SMA200 dist | +15.55% | Revenue (ttm) | $20.92B |
| 52W high | $295.86 | Revenue growth y/y | 22.70% |
| 52W low | $187.49 | Inst. ownership | 91.72% |
| P/E (ttm) | 21.06 | Insider ownership | 0.66% |
| Forward P/E | 13.38 | Short float | 2.15% |
| PEG (trailing) | — | Avg volume | 2,007,669 |

...
Signed file: `NXE.research.10.09.2026`
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.21; 52w high $13.92 (-26.65%); 52w low $7.56 (+35.05%) |
| Trend | -5.96% vs SMA200, +2.83% vs SMA50, -3.58% vs SMA20 |
| Momentum | RSI(14) 47.2 (neutral) |
| Volatility | ATR(14) 0.46 (~4.5% of price); beta 1.67 |
| Setup perspective | -26.65% from 52w high — base needs to rebuild. |
...
| SMA20 dist | -3.58% | ROA | -3.39% |
| SMA50 dist | +2.83% | ROE | -17.67% |
| SMA200 dist | -5.96% | Revenue (ttm) | — |

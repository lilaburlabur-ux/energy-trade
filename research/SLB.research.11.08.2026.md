...
Signed file: `SLB.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $53.68 (2026-08-11, ~15-min delayed) |
| Market cap | $79.67B |
...
|---|---|---|
| Technical momentum | High | 1Y +67.77%; price +14.04% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 16.53, EV/Sales 2.44. |
| Risk level | Elevated | Beta 0.75, ATR 3.2% of price, short float 4.88%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $53.68; 52w high $58.01 (-7.46%); 52w low $31.12 (+72.47%) |
| Trend | +14.04% vs SMA200, +7.15% vs SMA50, +8.46% vs SMA20 |
| Momentum | RSI(14) 63.8 (neutral) |
| Volatility | ATR(14) 1.71 (~3.2% of price); beta 0.75 |
...
| Valuation | P/E 26.19, forward P/E 16.53, P/S 2.19, P/B 3.06 | EV/Sales 2.44, EV/EBITDA 12.03 |
...
| Vanguard Capital Management LLC | 97,191,687 | 6.55% | 2026-03-31 |
| State Street Corporation | 91,222,641 | 6.15% | 2026-06-30 |
| Vanguard Portfolio Management LLC | 74,609,987 | 5.03% | 2026-03-31 |
| Price (T.Rowe) Associates Inc | 54,028,434 | 3.64% | 2026-03-31 |
| Capital World Investors | 47,738,940 | 3.22% | 2026-03-31 |
| Charles Schwab Investment Management, Inc. | 43,775,161 | 2.95% | 2026-03-31 |
| Morgan Stanley | 40,159,562 | 2.71% | 2026-03-31 |
| Geode Capital Management, LLC | 34,948,492 | 2.35% | 2026-03-31 |
| UBS Group AG | 33,184,227 | 2.24% | 2026-03-31 |

## 6. Risk Review and Setup Plan
- **Volatility risk:** Beta 0.75, ATR 3.2% of price, short float 4.88%. Size positions accordingly.
...
|---|---|---|---|
| Price | $53.68 | EV/Sales | 2.44 |
| Market cap | $79.67B | EV/EBITDA | 12.03 |
| Beta | 0.75 | Gross margin | 16.99% |
| RSI(14) | 63.8 | Operating margin | 12.71% |
| ATR(14) | 1.71 | Profit margin | 8.53% |
| SMA20 dist | +8.46% | ROA | 6.17% |
| SMA50 dist | +7.15% | ROE | 12.91% |
| SMA200 dist | +14.04% | Revenue (ttm) | $36.37B |
| 52W high | $58.01 | Revenue growth y/y | 5.00% |
| 52W low | $31.12 | Inst. ownership | 93.07% |
| P/E (ttm) | 26.19 | Insider ownership | 0.22% |
| Forward P/E | 16.53 | Short float | 4.88% |
| PEG (trailing) | 1.79 | Avg volume | 14,154,750 |
| P/S | 2.19 | Employees | 109,000 |
| P/B | 3.06 | Analyst rec (1=buy..5=sell) | 1.6 |

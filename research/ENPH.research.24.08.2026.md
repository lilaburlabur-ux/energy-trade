...
Signed file: `ENPH.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $37.18 (2026-08-24, ~15-min delayed) |
| Market cap | $4.90B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-8.07%) with negative half-year (-21.56%). |
| Fresh setup quality | Poor / broken | -48.60% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 16.10, EV/Sales 3.60. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $37.18; 52w high $72.33 (-48.60%); 52w low $26.12 (+42.34%) |
| Trend | -8.07% vs SMA200, -13.03% vs SMA50, -5.02% vs SMA20 |
| Momentum | RSI(14) 41.2 (neutral) |
| Volatility | ATR(14) 2.27 (~6.1% of price); beta 1.65 |
| Setup perspective | -48.60% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 36.81, forward P/E 16.10, P/S 3.69, P/B 4.16 | EV/Sales 3.60, EV/EBITDA 24.91 |
...
|---|---|---|---|
| Price | $37.18 | EV/Sales | 3.60 |
| Market cap | $4.90B | EV/EBITDA | 24.91 |
| Beta | 1.65 | Gross margin | 30.04% |
| RSI(14) | 41.2 | Operating margin | 17.98% |
| ATR(14) | 2.27 | Profit margin | 10.09% |
| SMA20 dist | -5.02% | ROA | 2.38% |
| SMA50 dist | -13.03% | ROE | 13.00% |
| SMA200 dist | -8.07% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 96.78% |
| P/E (ttm) | 36.81 | Insider ownership | 3.03% |
| Forward P/E | 16.10 | Short float | 20.98% |
| PEG (trailing) | 1.11 | Avg volume | 5,877,070 |
| P/S | 3.69 | Employees | 2,872 |
| P/B | 4.16 | Analyst rec (1=buy..5=sell) | 2.5 |

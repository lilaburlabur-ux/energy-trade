...
Signed file: `APA.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $42.54 (2026-08-29, ~15-min delayed) |
| Market cap | $14.90B |
...
|---|---|---|
| Technical momentum | High | 1Y +94.88%; price +29.96% vs SMA200. |
| Fresh setup quality | Moderate / wait | -4.17% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 19.56%, revenue growth 9.20%. |
| Value attractiveness | Reasonable | Forward P/E 10.13, EV/Sales 2.24. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $42.54; 52w high $44.39 (-4.17%); 52w low $20.93 (+103.25%) |
| Trend | +29.96% vs SMA200, +15.88% vs SMA50, +5.14% vs SMA20 |
| Momentum | RSI(14) 62.1 (neutral) |
| Volatility | ATR(14) 1.48 (~3.5% of price); beta 0.35 |
| Setup perspective | -4.17% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 8.97, forward P/E 10.13, P/S 1.74, P/B 2.12 | EV/Sales 2.24, EV/EBITDA 3.36 |
...
|---|---|---|---|
| Price | $42.54 | EV/Sales | 2.24 |
| Market cap | $14.90B | EV/EBITDA | 3.36 |
| Beta | 0.35 | Gross margin | 78.25% |
| RSI(14) | 62.1 | Operating margin | 56.33% |
| ATR(14) | 1.48 | Profit margin | 19.56% |
| SMA20 dist | +5.14% | ROA | 11.60% |
| SMA50 dist | +15.88% | ROE | 26.66% |
| SMA200 dist | +29.96% | Revenue (ttm) | $8.57B |
| 52W high | $44.39 | Revenue growth y/y | 9.20% |
| 52W low | $20.93 | Inst. ownership | 109.23% |
| P/E (ttm) | 8.97 | Insider ownership | 0.44% |
| Forward P/E | 10.13 | Short float | 9.82% |
| PEG (trailing) | 0.82 | Avg volume | 5,591,585 |
| P/S | 1.74 | Employees | 1,791 |

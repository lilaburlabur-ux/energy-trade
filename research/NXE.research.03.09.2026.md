...
Signed file: `NXE.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $10.67 (2026-09-03, ~15-min delayed) |
| Market cap | $7.06B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-1.25%) with negative half-year (-13.95%). |
...
| Value attractiveness | Reasonable | Forward P/E -57.34, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.67; 52w high $13.92 (-23.35%); 52w low $7.56 (+41.14%) |
| Trend | -1.25% vs SMA200, +8.29% vs SMA50, +0.97% vs SMA20 |
| Momentum | RSI(14) 54.2 (neutral) |
| Volatility | ATR(14) 0.49 (~4.6% of price); beta 1.65 |
...
| Valuation | P/E —, forward P/E -57.34, P/S —, P/B 5.34 | EV/Sales —, EV/EBITDA -59.92 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $19.50 (1 analysts) |
...
|---|---|---|---|
| Price | $10.67 | EV/Sales | — |
| Market cap | $7.06B | EV/EBITDA | -59.92 |
| Beta | 1.65 | Gross margin | 0.00% |
| RSI(14) | 54.2 | Operating margin | 0.00% |
| ATR(14) | 0.49 | Profit margin | 0.00% |
| SMA20 dist | +0.97% | ROA | -3.39% |
| SMA50 dist | +8.29% | ROE | -17.67% |
| SMA200 dist | -1.25% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.56 | Inst. ownership | 55.23% |
| P/E (ttm) | — | Insider ownership | 6.39% |
| Forward P/E | -57.34 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,333,979 |
| P/S | — | Employees | 142 |
| P/B | 5.34 | Analyst rec (1=buy..5=sell) | 1.5 |

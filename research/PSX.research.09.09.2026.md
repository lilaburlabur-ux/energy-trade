...
Signed file: `PSX.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $260.78 (2026-09-09, ~15-min delayed) |
| Market cap | $104.56B |
...
|---|---|---|
| Technical momentum | High | 1Y +106.21%; price +51.80% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 12.25, EV/Sales 0.80. |
...
|---|---|---|
| Are Oils-Energy Stocks Lagging  Par Pacific (PARR) This Year? | Zacks | 2026-09-09 |
| Phillips 66 (PSX) Hit a 52 Week High, Can the Run Continue? | Zacks | 2026-09-09 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $260.78; 52w high $260.78 (+0.00%); 52w low $123.11 (+111.82%) |
| Trend | +51.80% vs SMA200, +20.14% vs SMA50, +6.76% vs SMA20 |
| Momentum | RSI(14) 78.0 (overbought) |
| Volatility | ATR(14) 6.89 (~2.6% of price); beta 0.70 |
...
| Valuation | P/E 14.88, forward P/E 12.25, P/S 0.69, P/B 3.30 | EV/Sales 0.80, EV/EBITDA 12.20 |
...
|---|---|---|---|
| Price | $260.78 | EV/Sales | 0.80 |
| Market cap | $104.56B | EV/EBITDA | 12.20 |
| Beta | 0.70 | Gross margin | 13.10% |
| RSI(14) | 78.0 | Operating margin | 8.53% |
| ATR(14) | 6.89 | Profit margin | 4.66% |
| SMA20 dist | +6.76% | ROA | 6.04% |
| SMA50 dist | +20.14% | ROE | 23.45% |
| SMA200 dist | +51.80% | Revenue (ttm) | $152.17B |
| 52W high | $260.78 | Revenue growth y/y | 53.10% |
| 52W low | $123.11 | Inst. ownership | 80.59% |
| P/E (ttm) | 14.88 | Insider ownership | 0.21% |
| Forward P/E | 12.25 | Short float | 1.43% |
| PEG (trailing) | 1.24 | Avg volume | 2,774,772 |
| P/S | 0.69 | Employees | 12,600 |
| P/B | 3.30 | Analyst rec (1=buy..5=sell) | 2.1 |

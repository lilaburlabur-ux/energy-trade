...
Signed file: `DINO.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $106.91 (2026-09-14, ~15-min delayed) |
| Market cap | $19.01B |
...
|---|---|---|
| Technical momentum | High | 1Y +113.45%; price +61.31% vs SMA200. |
| Fresh setup quality | Moderate / wait | -1.29% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 6.13%, revenue growth 53.20%. |
| Value attractiveness | Reasonable | Forward P/E 9.59, EV/Sales 0.65. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $106.91; 52w high $108.31 (-1.29%); 52w low $44.83 (+138.48%) |
| Trend | +61.31% vs SMA200, +16.59% vs SMA50, +5.90% vs SMA20 |
| Momentum | RSI(14) 70.1 (overbought) |
| Volatility | ATR(14) 3.91 (~3.7% of price); beta 0.69 |
| Setup perspective | -1.29% from 52w high; no clean fresh pivot by default. |
...
| P/B | 1.85 | Analyst rec (1=buy..5=sell) | 2.6 |

...
Signed file: `MPC.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $410.84 (2026-09-15, ~15-min delayed) |
| Market cap | $119.94B |
...
|---|---|---|
| Technical momentum | High | 1Y +131.70%; price +66.62% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.35, EV/Sales 0.94. |
| Risk level | Elevated | Beta 0.53, ATR 3.0% of price, short float 3.14%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $410.84; 52w high $410.84 (+0.00%); 52w low $160.76 (+155.56%) |
| Trend | +66.62% vs SMA200, +21.58% vs SMA50, +8.55% vs SMA20 |
| Momentum | RSI(14) 79.7 (overbought) |
| Volatility | ATR(14) 12.41 (~3.0% of price); beta 0.53 |
...
| Valuation | P/E 14.26, forward P/E 10.35, P/S 0.78, P/B 6.09 | EV/Sales 0.94, EV/EBITDA 9.38 |
...
- **Volatility risk:** Beta 0.53, ATR 3.0% of price, short float 3.14%. Size positions accordingly.
...
|---|---|---|---|
| Price | $410.84 | EV/Sales | 0.94 |
| Market cap | $119.94B | EV/EBITDA | 9.38 |
| Beta | 0.53 | Gross margin | 12.82% |
| RSI(14) | 79.7 | Operating margin | 13.56% |
| ATR(14) | 12.41 | Profit margin | 5.55% |
| SMA20 dist | +8.55% | ROA | 8.74% |
| SMA50 dist | +21.58% | ROE | 42.10% |
| SMA200 dist | +66.62% | Revenue (ttm) | $154.15B |
| 52W high | $410.84 | Revenue growth y/y | 53.70% |
| 52W low | $160.76 | Inst. ownership | 79.49% |
| P/E (ttm) | 14.26 | Insider ownership | 0.33% |
| Forward P/E | 10.35 | Short float | 3.14% |
| PEG (trailing) | 1.92 | Avg volume | 2,377,524 |
| P/S | 0.78 | Employees | 18,500 |
| P/B | 6.09 | Analyst rec (1=buy..5=sell) | 2.3 |

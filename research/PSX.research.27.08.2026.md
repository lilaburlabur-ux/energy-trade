...
Signed file: `PSX.research.27.08.2026`

| Field | Value |
|---|---|
| Current price | $242.23 (2026-08-27, ~15-min delayed) |
| Market cap | $97.12B |
...
|---|---|---|
| Technical momentum | High | 1Y +92.56%; price +45.47% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.52% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 4.66%, revenue growth 53.10%. |
| Value attractiveness | Reasonable | Forward P/E 11.71, EV/Sales 0.74. |
| Risk level | Moderate | Beta 0.69, ATR 2.9% of price, short float 1.43%. |
...
|---|---|---|
| Is Phillips 66 (PSX) Still a Buy After its Massive 2026 Rally? | Insider Monkey | 2026-08-26 |
| Cenovus vs. Phillips 66: Which Energy Stock Is the Better Buy? | Zacks | 2026-08-25 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $242.23; 52w high $243.49 (-0.52%); 52w low $123.11 (+96.75%) |
| Trend | +45.47% vs SMA200, +19.84% vs SMA50, +7.82% vs SMA20 |
| Momentum | RSI(14) 71.3 (overbought) |
| Volatility | ATR(14) 6.93 (~2.9% of price); beta 0.69 |
| Setup perspective | -0.52% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 13.82, forward P/E 11.71, P/S 0.64, P/B 3.07 | EV/Sales 0.74, EV/EBITDA 11.30 |
...
|---|---|---|---|
| Price | $242.23 | EV/Sales | 0.74 |
| Market cap | $97.12B | EV/EBITDA | 11.30 |
| Beta | 0.69 | Gross margin | 13.10% |
| RSI(14) | 71.3 | Operating margin | 8.53% |
| ATR(14) | 6.93 | Profit margin | 4.66% |
| SMA20 dist | +7.82% | ROA | 6.04% |
| SMA50 dist | +19.84% | ROE | 23.45% |
| SMA200 dist | +45.47% | Revenue (ttm) | $152.17B |
| 52W high | $243.49 | Revenue growth y/y | 53.10% |
| 52W low | $123.11 | Inst. ownership | 80.58% |
| P/E (ttm) | 13.82 | Insider ownership | 0.21% |
| Forward P/E | 11.71 | Short float | 1.43% |
| PEG (trailing) | 1.13 | Avg volume | 2,664,036 |

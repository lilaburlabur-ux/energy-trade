...
Signed file: `MPC.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $387.71 (2026-09-03, ~15-min delayed) |
| Market cap | $113.19B |
...
|---|---|---|
| Technical momentum | High | 1Y +120.22%; price +62.00% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 12.20, EV/Sales 0.92. |
...
|---|---|---|
| Why Is Marathon Petroleum (MPC) Up 30% Since Last Earnings Report? | Zacks | 2026-09-03 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $387.71; 52w high $387.71 (+0.00%); 52w low $160.76 (+141.17%) |
| Trend | +62.00% vs SMA200, +21.68% vs SMA50, +8.38% vs SMA20 |
| Momentum | RSI(14) 77.9 (overbought) |
| Volatility | ATR(14) 10.91 (~2.8% of price); beta 0.51 |
...
| Valuation | P/E 13.45, forward P/E 12.20, P/S 0.71, P/B 5.75 | EV/Sales 0.92, EV/EBITDA 9.21 |
...
|---|---|---|---|
| Price | $387.71 | EV/Sales | 0.92 |
| Market cap | $113.19B | EV/EBITDA | 9.21 |
| Beta | 0.51 | Gross margin | 12.82% |
| RSI(14) | 77.9 | Operating margin | 13.56% |
| ATR(14) | 10.91 | Profit margin | 5.55% |
| SMA20 dist | +8.38% | ROA | 8.74% |
| SMA50 dist | +21.68% | ROE | 42.10% |
| SMA200 dist | +62.00% | Revenue (ttm) | $154.15B |
| 52W high | $387.71 | Revenue growth y/y | 53.70% |
| 52W low | $160.76 | Inst. ownership | 79.61% |
| P/E (ttm) | 13.45 | Insider ownership | 0.33% |
| Forward P/E | 12.20 | Short float | 2.70% |
| PEG (trailing) | 1.86 | Avg volume | 2,377,050 |
| P/S | 0.71 | Employees | 18,500 |
| P/B | 5.75 | Analyst rec (1=buy..5=sell) | 2.3 |

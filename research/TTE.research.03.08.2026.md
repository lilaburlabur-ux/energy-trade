...
Signed file: `TTE.research.03.08.2026`

| Field | Value |
|---|---|
| Current price | $87.20 (2026-08-03, ~15-min delayed) |
| Market cap | $193.61B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +52.73%; price +13.62% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.84% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.08%, revenue growth 27.80%. |
| Value attractiveness | Reasonable | Forward P/E 9.04, EV/Sales 1.17. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $87.20; 52w high $93.60 (-6.84%); 52w low $55.92 (+55.93%) |
| Trend | +13.62% vs SMA200, +4.12% vs SMA50, +5.33% vs SMA20 |
| Momentum | RSI(14) 61.5 (neutral) |
| Volatility | ATR(14) 1.77 (~2.0% of price); beta 0.06 |
| Setup perspective | -6.84% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 10.91, forward P/E 9.04, P/S 0.99, P/B 1.51 | EV/Sales 1.17, EV/EBITDA 5.78 |
| Growth expectations | Earnings growth 106.00%, EPS q/q 102.40% | Analyst mean target $95.00 (10 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 57.45% |
...
|---|---|---|---|
| Price | $87.20 | EV/Sales | 1.17 |
| Market cap | $193.61B | EV/EBITDA | 5.78 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 61.5 | Operating margin | 12.79% |
| ATR(14) | 1.77 | Profit margin | 9.08% |
| SMA20 dist | +5.33% | ROA | 5.51% |
| SMA50 dist | +4.12% | ROE | 14.48% |
| SMA200 dist | +13.62% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 57.45% |
| P/E (ttm) | 10.91 | Insider ownership | 8.86% |
| Forward P/E | 9.04 | Short float | 0.26% |
| PEG (trailing) | 0.72 | Avg volume | 1,525,475 |
| P/S | 0.99 | Employees | 94,847 |
| P/B | 1.51 | Analyst rec (1=buy..5=sell) | 2.1 |

...
Signed file: `BEP.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $30.51 (2026-09-10, ~15-min delayed) |
| Market cap | $14.87B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +25.40%; price -2.14% vs SMA200. |
| Fresh setup quality | Moderate / wait | -16.71% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-1.26%). |
| Value attractiveness | Reasonable | Forward P/E -16.32, EV/Sales 13.05. |
| Risk level | Moderate | Beta 0.98, ATR 3.0% of price, short float 0.67%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $30.51; 52w high $36.63 (-16.71%); 52w low $24.08 (+26.71%) |
| Trend | -2.14% vs SMA200, -5.59% vs SMA50, -5.20% vs SMA20 |
| Momentum | RSI(14) 38.2 (neutral) |
| Volatility | ATR(14) 0.90 (~3.0% of price); beta 0.98 |
| Setup perspective | -16.71% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E -16.32, P/S 2.34, P/B 2.45 | EV/Sales 13.05, EV/EBITDA 27.66 |
...
|---|---|---|---|
| Price | $30.51 | EV/Sales | 13.05 |
| Market cap | $14.87B | EV/EBITDA | 27.66 |
| Beta | 0.98 | Gross margin | 51.39% |
| RSI(14) | 38.2 | Operating margin | 17.08% |
| ATR(14) | 0.90 | Profit margin | -1.26% |
| SMA20 dist | -5.20% | ROA | 0.42% |
| SMA50 dist | -5.59% | ROE | 0.40% |
| SMA200 dist | -2.14% | Revenue (ttm) | $6.36B |
| 52W high | $36.63 | Revenue growth y/y | 1.10% |
| 52W low | $24.08 | Inst. ownership | 65.46% |
| P/E (ttm) | — | Insider ownership | 0.02% |
| Forward P/E | -16.32 | Short float | 0.67% |
| PEG (trailing) | — | Avg volume | 878,858 |
| P/S | 2.34 | Employees | 5,870 |

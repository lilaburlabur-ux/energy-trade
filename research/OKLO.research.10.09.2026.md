...
Signed file: `OKLO.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $39.88 (2026-09-10, ~15-min delayed) |
| Market cap | $7.42B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-37.73%) with negative half-year (-36.46%). |
| Fresh setup quality | Poor / broken | -77.10% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -39.44, EV/Sales 4,510.55. |
| Risk level | High | Beta 1.20, ATR 7.1% of price, short float 15.86%. |
...
|---|---|---|
| Nuclear Stocks Slide as Piper Sandler Splits the Sector: Oklo, NuScale Power and X-Energy All Drop 5% | 24/7 Wall St. | 2026-09-10 |
| 4 Reasons Why You Might Want to Sell OKLO Stock in September | Zacks | 2026-09-10 |
| Piper Sandler Makes Blunt Call on Two Nuclear Stocks | GuruFocus.com | 2026-09-10 |
| OKLO Stock Slips Overnight: This Analyst Sees 29% Upside, But Retail Turns Bearish | Stocktwits | 2026-09-10 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $39.88; 52w high $174.14 (-77.10%); 52w low $36.84 (+8.25%) |
| Trend | -37.73% vs SMA200, -8.29% vs SMA50, -4.65% vs SMA20 |
| Momentum | RSI(14) 44.7 (neutral) |
| Volatility | ATR(14) 2.85 (~7.1% of price); beta 1.20 |
| Setup perspective | -77.10% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -39.44, P/S 6,130.90, P/B 2.25 | EV/Sales 4,510.55, EV/EBITDA -25.17 |
...
- **Volatility risk:** Beta 1.20, ATR 7.1% of price, short float 15.86%. Size positions accordingly.
...
|---|---|---|---|
| Price | $39.88 | EV/Sales | 4,510.55 |
| Market cap | $7.42B | EV/EBITDA | -25.17 |
| Beta | 1.20 | Gross margin | 40.41% |
| RSI(14) | 44.7 | Operating margin | -6048.76% |
| ATR(14) | 2.85 | Profit margin | 0.00% |
| SMA20 dist | -4.65% | ROA | -6.65% |
| SMA50 dist | -8.29% | ROE | -7.70% |
| SMA200 dist | -37.73% | Revenue (ttm) | $1.21M |
| 52W high | $174.14 | Revenue growth y/y | — |
| 52W low | $36.84 | Inst. ownership | 47.53% |
| P/E (ttm) | — | Insider ownership | 15.38% |
| Forward P/E | -39.44 | Short float | 15.86% |
| PEG (trailing) | — | Avg volume | 9,557,030 |
| P/S | 6,130.90 | Employees | 215 |

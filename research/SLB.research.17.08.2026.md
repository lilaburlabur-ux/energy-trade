...
Signed file: `SLB.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $53.86 (2026-08-17, ~15-min delayed) |
| Market cap | $79.94B |
...
|---|---|---|
| Technical momentum | High | 1Y +66.56%; price +13.56% vs SMA200. |
| Fresh setup quality | Moderate / wait | -7.15% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 8.53%, revenue growth 5.00%. |
| Value attractiveness | Reasonable | Forward P/E 16.63, EV/Sales 2.47. |
| Risk level | Moderate | Beta 0.75, ATR 3.0% of price, short float 4.32%. |
...
|---|---|---|
| SLB (SLB) Stock May Trade At A Discount On Cash Flow But Fairly On Earnings | Simply Wall St. | 2026-08-14 |
| SLB (SLB) Is Considered a Good Investment by Brokers: Is That True? | Zacks | 2026-08-13 |
| 3 Cash-Producing Stocks with Open Questions | StockStory | 2026-08-10 |
| Is Cactus Worth Buying as Growth Accelerates but Valuation Stretches? | Zacks | 2026-08-07 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $53.86; 52w high $58.01 (-7.15%); 52w low $31.12 (+73.05%) |
| Trend | +13.56% vs SMA200, +8.08% vs SMA50, +6.22% vs SMA20 |
| Momentum | RSI(14) 62.0 (neutral) |
| Volatility | ATR(14) 1.59 (~3.0% of price); beta 0.75 |
| Setup perspective | -7.15% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.27, forward P/E 16.63, P/S 2.20, P/B 3.07 | EV/Sales 2.47, EV/EBITDA 12.14 |
| Growth expectations | Earnings growth -29.70%, EPS q/q -22.50% | Analyst mean target $61.97 (29 analysts) |
...
|---|---|---|---|
| Price | $53.86 | EV/Sales | 2.47 |
| Market cap | $79.94B | EV/EBITDA | 12.14 |
| Beta | 0.75 | Gross margin | 16.99% |
| RSI(14) | 62.0 | Operating margin | 12.71% |
| ATR(14) | 1.59 | Profit margin | 8.53% |
| SMA20 dist | +6.22% | ROA | 6.17% |
| SMA50 dist | +8.08% | ROE | 12.91% |
| SMA200 dist | +13.56% | Revenue (ttm) | $36.37B |
| 52W high | $58.01 | Revenue growth y/y | 5.00% |
| 52W low | $31.12 | Inst. ownership | 92.99% |
| P/E (ttm) | 26.27 | Insider ownership | 0.22% |
| Forward P/E | 16.63 | Short float | 4.32% |
| PEG (trailing) | 1.81 | Avg volume | 14,078,737 |
| P/S | 2.20 | Employees | 109,000 |
| P/B | 3.07 | Analyst rec (1=buy..5=sell) | 1.6 |
...
## 9. Conclusion
SLB: High momentum / mixed fundamentals / reasonable value / moderate risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

## Sources
| Source | URL | Used for |
|---|---|---|
| Yahoo Finance quote/profile/statistics for SLB | https://finance.yahoo.com/quote/SLB | Snapshot metrics, ownership, analyst data |
| Yahoo Finance price history (via yfinance) | https://finance.yahoo.com/quote/SLB/history | SMA/RSI/ATR/performance calculations |
| Yahoo Finance news feed | https://finance.yahoo.com/quote/SLB/news | Catalyst headlines |

...
Signed file: `FLNC.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $7.85 (2026-09-25, ~15-min delayed) |
| Market cap | $1.46B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $7.85; 52w high $32.23 (-75.64%); 52w low $7.27 (+7.98%) |
| Trend | -54.72% vs SMA200, -31.84% vs SMA50, -14.81% vs SMA20 |
| Momentum | RSI(14) 32.4 (neutral) |
| Volatility | ATR(14) 0.70 (~8.9% of price); beta 2.74 |
| Setup perspective | -75.64% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 2.74, ATR 8.9% of price, short float 36.54%. Size positions accordingly.
...
| SMA20 dist | -14.81% | ROA | -2.95% |
| SMA50 dist | -31.84% | ROE | -23.54% |
| SMA200 dist | -54.72% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $7.27 | Inst. ownership | 84.61% |
| P/E (ttm) | — | Insider ownership | 14.43% |
| Forward P/E | -29.47 | Short float | 36.54% |
| PEG (trailing) | — | Avg volume | 8,155,246 |
| P/S | 0.55 | Employees | 1,670 |
| P/B | 3.01 | Analyst rec (1=buy..5=sell) | 3.0 |

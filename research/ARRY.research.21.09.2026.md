...
Signed file: `ARRY.research.21.09.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-47.08%) with negative half-year (-39.25%). |
| Fresh setup quality | Poor / broken | -65.97% from 52w high — base needs to rebuild. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.07; 52w high $11.96 (-65.97%); 52w low $4.06 (+0.25%) |
| Trend | -47.08% vs SMA200, -19.63% vs SMA50, -8.84% vs SMA20 |
| Momentum | RSI(14) 32.1 (neutral) |
| Volatility | ATR(14) 0.26 (~6.4% of price); beta 1.77 |
| Setup perspective | -65.97% from 52w high — base needs to rebuild. |
...
|---|---|---|---|
| Price | $4.07 | EV/Sales | 1.32 |
| Market cap | $626.07M | EV/EBITDA | 13.15 |
| Beta | 1.77 | Gross margin | 26.76% |
| RSI(14) | 32.1 | Operating margin | 10.88% |
| ATR(14) | 0.26 | Profit margin | -7.25% |
| SMA20 dist | -8.84% | ROA | 3.33% |
| SMA50 dist | -19.63% | ROE | -25.98% |
| SMA200 dist | -47.08% | Revenue (ttm) | $1.19B |

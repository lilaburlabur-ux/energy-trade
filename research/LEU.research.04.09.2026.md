...
Signed file: `LEU.research.04.09.2026`

| Field | Value |
|---|---|
| Current price | $173.89 (2026-09-04, ~15-min delayed) |
| Market cap | $3.47B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-17.43%) with negative half-year (-7.94%). |
| Fresh setup quality | Poor / broken | -60.12% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.23%, revenue growth 14.00%. |
| Value attractiveness | Low (expensive) | Forward P/E 45.49, EV/Sales 5.72. |
| Risk level | High | Beta 1.33, ATR 6.7% of price, short float 29.16%. |
...
|---|---|---|
| Centrus Energy (LEU) Down 4.3% Since Last Earnings Report: Can It Rebound? | Zacks | 2026-09-04 |
| Energy Fuels' Q2 Revenues Surge 496% Y/Y: Is This Growth Sustainable? | Zacks | 2026-09-02 |
| Ondas, SoundHound AI Among 5 Stocks Facing Heavy Short Bets | GuruFocus.com | 2026-09-02 |
| Is XE Building the Infrastructure Needed for Advanced Nuclear Scale-Up? | Zacks | 2026-08-31 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $173.89; 52w high $436.00 (-60.12%); 52w low $146.61 (+18.61%) |
| Trend | -17.43% vs SMA200, -0.18% vs SMA50, -4.34% vs SMA20 |
| Momentum | RSI(14) 47.4 (neutral) |
| Volatility | ATR(14) 11.61 (~6.7% of price); beta 1.33 |
| Setup perspective | -60.12% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 92.01, forward P/E 45.49, P/S 7.32, P/B 4.10 | EV/Sales 5.72, EV/EBITDA 268.33 |
...
- **Valuation risk:** Forward P/E 45.49, EV/Sales 5.72. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.33, ATR 6.7% of price, short float 29.16%. Size positions accordingly.
...
|---|---|---|---|
| Price | $173.89 | EV/Sales | 5.72 |
| Market cap | $3.47B | EV/EBITDA | 268.33 |
| Beta | 1.33 | Gross margin | 23.66% |
| RSI(14) | 47.4 | Operating margin | 5.34% |
| ATR(14) | 11.61 | Profit margin | 10.23% |
| SMA20 dist | -4.34% | ROA | 0.02% |
| SMA50 dist | -0.18% | ROE | 8.05% |
| SMA200 dist | -17.43% | Revenue (ttm) | $473.90M |
| 52W high | $436.00 | Revenue growth y/y | 14.00% |
| 52W low | $146.61 | Inst. ownership | 89.23% |
| P/E (ttm) | 92.01 | Insider ownership | 4.31% |
| Forward P/E | 45.49 | Short float | 29.16% |
| PEG (trailing) | — | Avg volume | 764,506 |
| P/S | 7.32 | Employees | 467 |
| P/B | 4.10 | Analyst rec (1=buy..5=sell) | 1.8 |

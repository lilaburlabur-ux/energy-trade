...
Signed file: `APA.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $43.39 (2026-08-21, ~15-min delayed) |
| Market cap | $15.20B |
...
|---|---|---|
| Technical momentum | High | 1Y +120.76%; price +34.56% vs SMA200. |
| Fresh setup quality | Moderate / wait | -2.25% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 19.56%, revenue growth 9.20%. |
| Value attractiveness | Reasonable | Forward P/E 10.33, EV/Sales 2.32. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $43.39; 52w high $44.39 (-2.25%); 52w low $19.93 (+117.66%) |
| Trend | +34.56% vs SMA200, +20.48% vs SMA50, +11.43% vs SMA20 |
| Momentum | RSI(14) 69.0 (neutral) |
| Volatility | ATR(14) 1.48 (~3.4% of price); beta 0.35 |
| Setup perspective | -2.25% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 9.15, forward P/E 10.33, P/S 1.77, P/B 2.17 | EV/Sales 2.32, EV/EBITDA 3.48 |
...
|---|---|---|---|
| Price | $43.39 | EV/Sales | 2.32 |
| Market cap | $15.20B | EV/EBITDA | 3.48 |
| Beta | 0.35 | Gross margin | 78.25% |
| RSI(14) | 69.0 | Operating margin | 56.33% |
| ATR(14) | 1.48 | Profit margin | 19.56% |
| SMA20 dist | +11.43% | ROA | 11.60% |
| SMA50 dist | +20.48% | ROE | 26.66% |
| SMA200 dist | +34.56% | Revenue (ttm) | $8.57B |
| 52W high | $44.39 | Revenue growth y/y | 9.20% |
| 52W low | $19.93 | Inst. ownership | 109.22% |
| P/E (ttm) | 9.15 | Insider ownership | 0.44% |
| Forward P/E | 10.33 | Short float | 11.31% |
| PEG (trailing) | 0.84 | Avg volume | 5,545,620 |

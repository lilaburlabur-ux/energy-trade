...
Signed file: `SLB.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $54.00 (2026-08-24, ~15-min delayed) |
| Market cap | $80.14B |
...
|---|---|---|
| Technical momentum | High | 1Y +64.08%; price +12.80% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.91% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 8.53%, revenue growth 5.00%. |
| Value attractiveness | Reasonable | Forward P/E 16.71, EV/Sales 2.47. |
| Risk level | Moderate | Beta 0.75, ATR 2.7% of price, short float 4.32%. |
...
|---|---|---|
| Is RPC Stock Attractive as Margin Gains Meet Soft Industry Activity? | Zacks | 2026-08-21 |
| Sector Update: Energy Stocks Rise Pre-Bell Tuesday | MT Newswires | 2026-08-18 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $54.00; 52w high $58.01 (-6.91%); 52w low $31.12 (+73.50%) |
| Trend | +12.80% vs SMA200, +8.82% vs SMA50, +4.16% vs SMA20 |
| Momentum | RSI(14) 61.7 (neutral) |
| Volatility | ATR(14) 1.46 (~2.7% of price); beta 0.75 |
| Setup perspective | -6.91% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.34, forward P/E 16.71, P/S 2.20, P/B 3.07 | EV/Sales 2.47, EV/EBITDA 12.16 |
| Growth expectations | Earnings growth -29.70%, EPS q/q -22.50% | Analyst mean target $61.93 (29 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 92.94% |
...
|---|---|---|---|
| Price | $54.00 | EV/Sales | 2.47 |
| Market cap | $80.14B | EV/EBITDA | 12.16 |
| Beta | 0.75 | Gross margin | 16.99% |
| RSI(14) | 61.7 | Operating margin | 12.71% |
| ATR(14) | 1.46 | Profit margin | 8.53% |
| SMA20 dist | +4.16% | ROA | 6.17% |
| SMA50 dist | +8.82% | ROE | 12.91% |
| SMA200 dist | +12.80% | Revenue (ttm) | $36.37B |
| 52W high | $58.01 | Revenue growth y/y | 5.00% |
| 52W low | $31.12 | Inst. ownership | 92.94% |
| P/E (ttm) | 26.34 | Insider ownership | 0.22% |
| Forward P/E | 16.71 | Short float | 4.32% |
| PEG (trailing) | 1.84 | Avg volume | 13,627,146 |

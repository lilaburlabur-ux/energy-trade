...
Signed file: `PEG.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $75.87 (2026-08-12, ~15-min delayed) |
| Market cap | $37.81B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-4.78%) with negative half-year (-7.28%). |
| Fresh setup quality | Moderate / wait | -11.28% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 16.04%, revenue growth -8.90%. |
| Value attractiveness | Reasonable | Forward P/E 16.24, EV/Sales 4.94. |
| Risk level | Moderate | Beta 0.53, ATR 2.0% of price, short float 2.39%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $75.87; 52w high $85.51 (-11.28%); 52w low $74.56 (+1.76%) |
| Trend | -4.78% vs SMA200, -4.03% vs SMA50, -1.95% vs SMA20 |
| Momentum | RSI(14) 40.0 (neutral) |
| Volatility | ATR(14) 1.49 (~2.0% of price); beta 0.53 |
| Setup perspective | -11.28% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.87, forward P/E 16.24, P/S 3.01, P/B 2.18 | EV/Sales 4.94, EV/EBITDA 13.89 |
...
|---|---|---|---|
| Price | $75.87 | EV/Sales | 4.94 |
| Market cap | $37.81B | EV/EBITDA | 13.89 |
| Beta | 0.53 | Gross margin | 33.33% |
| RSI(14) | 40.0 | Operating margin | 18.87% |
| ATR(14) | 1.49 | Profit margin | 16.04% |
| SMA20 dist | -1.95% | ROA | 3.24% |
| SMA50 dist | -4.03% | ROE | 11.83% |
| SMA200 dist | -4.78% | Revenue (ttm) | $12.54B |
| 52W high | $85.51 | Revenue growth y/y | -8.90% |
| 52W low | $74.56 | Inst. ownership | 79.34% |
| P/E (ttm) | 18.87 | Insider ownership | 0.13% |
| Forward P/E | 16.24 | Short float | 2.39% |
| PEG (trailing) | 3.70 | Avg volume | 2,982,270 |

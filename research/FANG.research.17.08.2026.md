...
Signed file: `FANG.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $206.29 (2026-08-17, ~15-min delayed) |
| Market cap | $57.77B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +50.07%; price +18.12% vs SMA200. |
| Fresh setup quality | Moderate / wait | -2.40% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.03%, revenue growth 52.50%. |
| Value attractiveness | Reasonable | Forward P/E 11.56, EV/Sales 4.61. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $206.29; 52w high $211.36 (-2.40%); 52w low $131.37 (+57.03%) |
| Trend | +18.12% vs SMA200, +8.46% vs SMA50, +4.53% vs SMA20 |
| Momentum | RSI(14) 61.7 (neutral) |
| Volatility | ATR(14) 5.97 (~2.9% of price); beta 0.42 |
| Setup perspective | -2.40% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 39.37, forward P/E 11.56, P/S 3.56, P/B 1.53 | EV/Sales 4.61, EV/EBITDA 6.36 |
...
|---|---|---|---|
| Price | $206.29 | EV/Sales | 4.61 |
| Market cap | $57.77B | EV/EBITDA | 6.36 |
| Beta | 0.42 | Gross margin | 72.35% |
| RSI(14) | 61.7 | Operating margin | 48.47% |
| ATR(14) | 5.97 | Profit margin | 9.03% |
| SMA20 dist | +4.53% | ROA | 1.31% |
| SMA50 dist | +8.46% | ROE | 3.49% |
| SMA200 dist | +18.12% | Revenue (ttm) | $16.25B |
| 52W high | $211.36 | Revenue growth y/y | 52.50% |
| 52W low | $131.37 | Inst. ownership | 73.38% |
| P/E (ttm) | 39.37 | Insider ownership | 27.12% |
| Forward P/E | 11.56 | Short float | 4.26% |
| PEG (trailing) | 21.43 | Avg volume | 2,223,353 |
| P/S | 3.56 | Employees | 1,762 |

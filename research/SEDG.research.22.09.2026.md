...
| Value attractiveness | Low (expensive) | Forward P/E 41.40, EV/Sales 1.54. |
| Risk level | High | Beta 1.44, ATR nan% of price, short float 25.50%. |
...
| Volatility | ATR(14) 2.81 (~nan% of price); beta 1.44 |
...
| Valuation | P/E —, forward P/E 41.40, P/S 1.64, P/B 5.32 | EV/Sales 1.54, EV/EBITDA -16.94 |
...
- **Valuation risk:** Forward P/E 41.40, EV/Sales 1.54. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.44, ATR nan% of price, short float 25.50%. Size positions accordingly.
...
|---|---|---|---|
| Price | $nan | EV/Sales | 1.54 |
| Market cap | $2.19B | EV/EBITDA | -16.94 |
| Beta | 1.44 | Gross margin | 21.25% |
| RSI(14) | 48.0 | Operating margin | -6.51% |
| ATR(14) | 2.81 | Profit margin | -20.29% |

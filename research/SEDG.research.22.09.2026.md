...
Signed file: `SEDG.research.22.09.2026`

| Field | Value |
|---|---|
| Current price | $36.08 (2026-09-22, ~15-min delayed) |
| Market cap | $2.22B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-14.35%) with negative half-year (-22.79%). |
...
| Value attractiveness | Low (expensive) | Forward P/E 41.94, EV/Sales 1.54. |
| Risk level | High | Beta 1.44, ATR 7.5% of price, short float 25.50%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.08; 52w high $78.51 (-54.04%); 52w low $28.47 (+26.73%) |
| Trend | -14.35% vs SMA200, -4.05% vs SMA50, +5.30% vs SMA20 |
| Momentum | RSI(14) 52.0 (neutral) |
| Volatility | ATR(14) 2.71 (~7.5% of price); beta 1.44 |
...
| Valuation | P/E —, forward P/E 41.94, P/S 1.67, P/B 5.39 | EV/Sales 1.54, EV/EBITDA -16.94 |
...
- **Valuation risk:** Forward P/E 41.94, EV/Sales 1.54. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.44, ATR 7.5% of price, short float 25.50%. Size positions accordingly.
...
|---|---|---|---|
| Price | $36.08 | EV/Sales | 1.54 |
| Market cap | $2.22B | EV/EBITDA | -16.94 |
| Beta | 1.44 | Gross margin | 21.25% |
| RSI(14) | 52.0 | Operating margin | -6.51% |
| ATR(14) | 2.71 | Profit margin | -20.29% |
| SMA20 dist | +5.30% | ROA | -3.84% |
| SMA50 dist | -4.05% | ROE | -58.42% |
| SMA200 dist | -14.35% | Revenue (ttm) | $1.33B |
| 52W high | $78.51 | Revenue growth y/y | 19.60% |
| 52W low | $28.47 | Inst. ownership | 101.69% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 41.94 | Short float | 25.50% |
| PEG (trailing) | — | Avg volume | 3,114,023 |
| P/S | 1.67 | Employees | 3,576 |
| P/B | 5.39 | Analyst rec (1=buy..5=sell) | 3.0 |

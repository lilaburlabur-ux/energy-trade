...
Signed file: `SLB.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $57.33 (2026-08-29, ~15-min delayed) |
| Market cap | $85.09B |
...
|---|---|---|
| Technical momentum | High | 1Y +63.69%; price +18.82% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 17.74, EV/Sales 2.52. |
| Risk level | Moderate | Beta 0.75, ATR 3.0% of price, short float 4.28%. |
...
|---|---|---|
| SLB’s Venezuela Bet: Massive Opportunity or Risky Gamble? | Insider Monkey | 2026-08-29 |
| The World’s Largest Oil Reserves Are Opening Their Data to SLB. Should Investors Trust Venezuela to Pay? | 24/7 Wall St. | 2026-08-27 |
| Sector Update: Energy Stocks Decline Premarket Wednesday | MT Newswires | 2026-08-26 |
| An Oil Catastrophe Was Averted in 2026. What If It Comes in 2027? | Barrons.com | 2026-08-26 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $57.33; 52w high $58.01 (-1.17%); 52w low $31.12 (+84.20%) |
| Trend | +18.82% vs SMA200, +15.26% vs SMA50, +8.30% vs SMA20 |
| Momentum | RSI(14) 70.9 (overbought) |
| Volatility | ATR(14) 1.70 (~3.0% of price); beta 0.75 |
| Setup perspective | -1.17% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 27.97, forward P/E 17.74, P/S 2.34, P/B 3.26 | EV/Sales 2.52, EV/EBITDA 12.39 |
...
|---|---|---|---|
| Price | $57.33 | EV/Sales | 2.52 |
| Market cap | $85.09B | EV/EBITDA | 12.39 |
| Beta | 0.75 | Gross margin | 16.99% |
| RSI(14) | 70.9 | Operating margin | 12.71% |
| ATR(14) | 1.70 | Profit margin | 8.53% |
| SMA20 dist | +8.30% | ROA | 6.17% |
| SMA50 dist | +15.26% | ROE | 12.91% |
| SMA200 dist | +18.82% | Revenue (ttm) | $36.37B |
| 52W high | $58.01 | Revenue growth y/y | 5.00% |
| 52W low | $31.12 | Inst. ownership | 92.83% |
| P/E (ttm) | 27.97 | Insider ownership | 0.22% |
| Forward P/E | 17.74 | Short float | 4.28% |
| PEG (trailing) | 1.88 | Avg volume | 13,196,608 |
| P/S | 2.34 | Employees | 109,000 |
| P/B | 3.26 | Analyst rec (1=buy..5=sell) | 1.6 |

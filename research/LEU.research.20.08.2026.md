...
Signed file: `LEU.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $176.13 (2026-08-20, ~15-min delayed) |
| Market cap | $3.51B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-18.66%) with negative half-year (-15.68%). |
| Fresh setup quality | Poor / broken | -59.60% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.23%, revenue growth 14.00%. |
| Value attractiveness | Low (expensive) | Forward P/E 46.08, EV/Sales 6.28. |
| Risk level | High | Beta 1.35, ATR 6.5% of price, short float 26.68%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $176.13; 52w high $436.00 (-59.60%); 52w low $146.61 (+20.14%) |
| Trend | -18.66% vs SMA200, +2.23% vs SMA50, -2.67% vs SMA20 |
| Momentum | RSI(14) 48.3 (neutral) |
| Volatility | ATR(14) 11.48 (~6.5% of price); beta 1.35 |
| Setup perspective | -59.60% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 93.19, forward P/E 46.08, P/S 7.42, P/B 4.16 | EV/Sales 6.28, EV/EBITDA 294.45 |
| Growth expectations | Earnings growth -51.60%, EPS q/q -41.90% | Analyst mean target $255.12 (16 analysts) |
...
- **Valuation risk:** Forward P/E 46.08, EV/Sales 6.28. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.35, ATR 6.5% of price, short float 26.68%. Size positions accordingly.
...
|---|---|---|---|
| Price | $176.13 | EV/Sales | 6.28 |
| Market cap | $3.51B | EV/EBITDA | 294.45 |
| Beta | 1.35 | Gross margin | 23.66% |
| RSI(14) | 48.3 | Operating margin | 5.34% |
| ATR(14) | 11.48 | Profit margin | 10.23% |
| SMA20 dist | -2.67% | ROA | 0.02% |
| SMA50 dist | +2.23% | ROE | 8.05% |
| SMA200 dist | -18.66% | Revenue (ttm) | $473.90M |
| 52W high | $436.00 | Revenue growth y/y | 14.00% |
| 52W low | $146.61 | Inst. ownership | 89.22% |
| P/E (ttm) | 93.19 | Insider ownership | 4.31% |
| Forward P/E | 46.08 | Short float | 26.68% |
| PEG (trailing) | — | Avg volume | 808,274 |
| P/S | 7.42 | Employees | 467 |
| P/B | 4.16 | Analyst rec (1=buy..5=sell) | 1.8 |

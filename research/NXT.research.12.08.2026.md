...
Signed file: `NXT.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $103.67 (2026-08-12, ~15-min delayed) |
| Market cap | $15.93B |
...
|---|---|---|
| Technical momentum | High | 1Y +84.43%; price -5.21% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 17.93, EV/Sales 4.06. |
| Risk level | High | Beta 1.95, ATR 6.7% of price, short float 7.57%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $103.67; 52w high $156.40 (-33.71%); 52w low $53.80 (+92.70%) |
| Trend | -5.21% vs SMA200, -8.13% vs SMA50, +3.15% vs SMA20 |
| Momentum | RSI(14) 50.0 (neutral) |
| Volatility | ATR(14) 6.92 (~6.7% of price); beta 1.95 |
...
| Valuation | P/E 26.79, forward P/E 17.93, P/S 4.39, P/B 6.15 | EV/Sales 4.06, EV/EBITDA 19.68 |
...
- **Volatility risk:** Beta 1.95, ATR 6.7% of price, short float 7.57%. Size positions accordingly.
...
|---|---|---|---|
| Price | $103.67 | EV/Sales | 4.06 |
| Market cap | $15.93B | EV/EBITDA | 19.68 |
| Beta | 1.95 | Gross margin | 22.98% |
| RSI(14) | 50.0 | Operating margin | 20.86% |
| ATR(14) | 6.92 | Profit margin | 16.36% |
| SMA20 dist | +3.15% | ROA | 11.68% |
| SMA50 dist | -8.13% | ROE | 27.22% |
| SMA200 dist | -5.21% | Revenue (ttm) | $3.63B |
| 52W high | $156.40 | Revenue growth y/y | 8.20% |
| 52W low | $53.80 | Inst. ownership | 108.78% |
| P/E (ttm) | 26.79 | Insider ownership | 0.68% |
| Forward P/E | 17.93 | Short float | 7.57% |
| PEG (trailing) | 3.15 | Avg volume | 3,210,530 |
| P/S | 4.39 | Employees | 1,993 |
| P/B | 6.15 | Analyst rec (1=buy..5=sell) | 1.5 |

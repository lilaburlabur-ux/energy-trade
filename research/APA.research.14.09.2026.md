...
Signed file: `APA.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $45.03 (2026-09-14, ~15-min delayed) |
| Market cap | $15.78B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $45.03; 52w high $45.03 (+0.00%); 52w low $21.16 (+112.76%) |
| Trend | +33.40% vs SMA200, +15.54% vs SMA50, +3.83% vs SMA20 |
| Momentum | RSI(14) 64.7 (neutral) |
| Volatility | ATR(14) 1.47 (~3.3% of price); beta 0.37 |
...
| SMA20 dist | +3.83% | ROA | 11.60% |
| SMA50 dist | +15.54% | ROE | 26.66% |
| SMA200 dist | +33.40% | Revenue (ttm) | $8.57B |

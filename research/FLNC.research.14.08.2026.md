...
Signed file: `FLNC.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $13.14 (2026-08-14, ~15-min delayed) |
| Market cap | $2.99B |
...
|---|---|---|
| Technical momentum | High | 1Y +74.04%; price -29.71% vs SMA200. |
| Fresh setup quality | Poor / broken | -59.23% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 56.34, EV/Sales 0.77. |
| Risk level | High | Beta 2.78, ATR 10.1% of price, short float 29.29%. |
...
| Fluence Energy Inc (FLNC) (Q3 2026) Earnings Call Highlights: Record Orders and Backlog Amid ... | GuruFocus.com | 2026-08-06 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $13.14; 52w high $32.23 (-59.23%); 52w low $6.75 (+94.67%) |
| Trend | -29.71% vs SMA200, -24.77% vs SMA50, -3.98% vs SMA20 |
| Momentum | RSI(14) 41.5 (neutral) |
| Volatility | ATR(14) 1.33 (~10.1% of price); beta 2.78 |
| Setup perspective | -59.23% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 56.34, P/S 1.14, P/B 5.04 | EV/Sales 0.77, EV/EBITDA -25.96 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $16.39 (18 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 93.53% |
...
- **Valuation risk:** Forward P/E 56.34, EV/Sales 0.77. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.78, ATR 10.1% of price, short float 29.29%. Size positions accordingly.
...
|---|---|---|---|
| Price | $13.14 | EV/Sales | 0.77 |
| Market cap | $2.99B | EV/EBITDA | -25.96 |
| Beta | 2.78 | Gross margin | 9.36% |
| RSI(14) | 41.5 | Operating margin | -8.85% |
| ATR(14) | 1.33 | Profit margin | -3.07% |
| SMA20 dist | -3.98% | ROA | -2.95% |
| SMA50 dist | -24.77% | ROE | -23.54% |
| SMA200 dist | -29.71% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.75 | Inst. ownership | 93.53% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 56.34 | Short float | 29.29% |
| PEG (trailing) | — | Avg volume | 10,372,608 |
| P/S | 1.14 | Employees | 1,670 |
| P/B | 5.04 | Analyst rec (1=buy..5=sell) | 2.7 |
...
## 9. Conclusion
FLNC: High momentum / weak fundamentals / low (expensive) value / high risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

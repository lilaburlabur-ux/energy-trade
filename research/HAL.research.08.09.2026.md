...
Signed file: `HAL.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $36.80 (2026-09-08, ~15-min delayed) |
| Market cap | $30.66B |
...
|---|---|---|
| Technical momentum | High | 1Y +69.89%; price +6.55% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 12.68, EV/Sales 1.66. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.80; 52w high $42.60 (-13.62%); 52w low $21.32 (+72.62%) |
| Trend | +6.55% vs SMA200, +8.24% vs SMA50, +4.52% vs SMA20 |
| Momentum | RSI(14) 61.3 (neutral) |
| Volatility | ATR(14) 1.05 (~2.8% of price); beta 0.77 |
...
| Valuation | P/E 19.27, forward P/E 12.68, P/S 1.37, P/B 2.79 | EV/Sales 1.66, EV/EBITDA 8.96 |
...
|---|---|---|---|
| Price | $36.80 | EV/Sales | 1.66 |
| Market cap | $30.66B | EV/EBITDA | 8.96 |
| Beta | 0.77 | Gross margin | 15.08% |
| RSI(14) | 61.3 | Operating margin | 12.79% |
| ATR(14) | 1.05 | Profit margin | 7.16% |
| SMA20 dist | +4.52% | ROA | 7.26% |
| SMA50 dist | +8.24% | ROE | 14.92% |
| SMA200 dist | +6.55% | Revenue (ttm) | $22.37B |
...
| PEG (trailing) | 0.77 | Avg volume | 11,937,138 |

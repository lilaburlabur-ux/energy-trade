...
Signed file: `WFRD.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $88.73 (2026-08-24, ~15-min delayed) |
| Market cap | $6.36B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-2.40%) with negative half-year (-14.98%). |
| Fresh setup quality | Moderate / wait | -20.11% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 7.66%, revenue growth -8.20%. |
| Value attractiveness | Reasonable | Forward P/E 12.57, EV/Sales 1.47. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $88.73; 52w high $111.07 (-20.11%); 52w low $60.11 (+47.62%) |
| Trend | -2.40% vs SMA200, +1.72% vs SMA50, -0.99% vs SMA20 |
| Momentum | RSI(14) 48.2 (neutral) |
| Volatility | ATR(14) 3.31 (~3.7% of price); beta 0.89 |
| Setup perspective | -20.11% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 17.50, forward P/E 12.57, P/S 1.33, P/B 3.56 | EV/Sales 1.47, EV/EBITDA 7.55 |
...
|---|---|---|---|
| Price | $88.73 | EV/Sales | 1.47 |
| Market cap | $6.36B | EV/EBITDA | 7.55 |
| Beta | 0.89 | Gross margin | 30.51% |
| RSI(14) | 48.2 | Operating margin | 10.50% |
| ATR(14) | 3.31 | Profit margin | 7.66% |
| SMA20 dist | -0.99% | ROA | 7.90% |
| SMA50 dist | +1.72% | ROE | 22.79% |
| SMA200 dist | -2.40% | Revenue (ttm) | $4.78B |
| 52W high | $111.07 | Revenue growth y/y | -8.20% |
| 52W low | $60.11 | Inst. ownership | 108.21% |
| P/E (ttm) | 17.50 | Insider ownership | 2.15% |
| Forward P/E | 12.57 | Short float | 9.29% |
| PEG (trailing) | 1.79 | Avg volume | 1,258,938 |
| P/S | 1.33 | Employees | 16,700 |
| P/B | 3.56 | Analyst rec (1=buy..5=sell) | 1.7 |

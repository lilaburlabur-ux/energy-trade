...
Signed file: `BP.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $45.68 (2026-09-09, ~15-min delayed) |
| Market cap | $117.64B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +41.65%; price +14.17% vs SMA200. |
| Fresh setup quality | Moderate / wait | -1.80% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 2.55%, revenue growth 48.20%. |
| Value attractiveness | Reasonable | Forward P/E 9.47, EV/Sales 2.40. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $45.68; 52w high $46.52 (-1.80%); 52w low $31.17 (+46.53%) |
| Trend | +14.17% vs SMA200, +9.01% vs SMA50, +5.02% vs SMA20 |
| Momentum | RSI(14) 64.0 (neutral) |
| Volatility | ATR(14) 1.03 (~2.2% of price); beta -0.22 |
| Setup perspective | -1.80% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.86, forward P/E 9.47, P/S 0.55, P/B 8.09 | EV/Sales 2.40, EV/EBITDA 13.21 |
...
|---|---|---|---|
| Price | $45.68 | EV/Sales | 2.40 |
| Market cap | $117.64B | EV/EBITDA | 13.21 |
| Beta | -0.22 | Gross margin | 28.30% |
| RSI(14) | 64.0 | Operating margin | 13.15% |
| ATR(14) | 1.03 | Profit margin | 2.55% |
| SMA20 dist | +5.02% | ROA | 5.04% |
| SMA50 dist | +9.01% | ROE | 8.87% |
| SMA200 dist | +14.17% | Revenue (ttm) | $215.47B |
| 52W high | $46.52 | Revenue growth y/y | 48.20% |
| 52W low | $31.17 | Inst. ownership | 14.09% |
| P/E (ttm) | 21.86 | Insider ownership | 0.00% |
| Forward P/E | 9.47 | Short float | 0.28% |
| PEG (trailing) | 0.06 | Avg volume | 9,136,388 |
| P/S | 0.55 | Employees | 93,700 |
| P/B | 8.09 | Analyst rec (1=buy..5=sell) | 2.4 |

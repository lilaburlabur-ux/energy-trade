...
|---|---|---|
| Technical momentum | Moderate | 1Y +21.78%; price +4.78% vs SMA200. |
| Fresh setup quality | Moderate / wait | -7.39% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 19.30%, revenue growth 10.80%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.49, EV/Sales 5.76. |
| Risk level | Moderate | Beta 0.55, ATR 2.1% of price, short float 2.33%. |
...
|---|---|---|
| Sector Update: Energy Stocks Gain Late Afternoon | MT Newswires | 2026-08-11 |
| Sector Update: Energy Stocks Gain Tuesday Afternoon | MT Newswires | 2026-08-11 |
| An Oil Refiner That Fled California Is Back—With a Giant Pipeline From Texas | The Wall Street Journal | 2026-08-11 |
| Kinder Morgan (KMI) Stock Trades At A Discount As Its 138% Run Continues | Simply Wall St. | 2026-08-10 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $31.48; 52w high $33.99 (-7.39%); 52w low $24.86 (+26.63%) |
| Trend | +4.78% vs SMA200, -0.60% vs SMA50, -0.72% vs SMA20 |
| Momentum | RSI(14) 48.0 (neutral) |
| Volatility | ATR(14) 0.67 (~2.1% of price); beta 0.55 |
| Setup perspective | -7.39% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.31, forward P/E 20.49, P/S 3.90, P/B 2.21 | EV/Sales 5.76, EV/EBITDA 13.55 |
...
- **Valuation risk:** Forward P/E 20.49, EV/Sales 5.76. Multiple compression is the main downside if growth disappoints.
...
| SMA20 dist | -0.72% | ROA | 4.45% |
| SMA50 dist | -0.60% | ROE | 10.99% |
| SMA200 dist | +4.78% | Revenue (ttm) | $17.96B |
| 52W high | $33.99 | Revenue growth y/y | 10.80% |
| 52W low | $24.86 | Inst. ownership | 71.00% |
| P/E (ttm) | 20.31 | Insider ownership | 12.70% |
| Forward P/E | 20.49 | Short float | 2.33% |
| PEG (trailing) | 3.41 | Avg volume | 9,905,988 |
| P/S | 3.90 | Employees | 11,028 |

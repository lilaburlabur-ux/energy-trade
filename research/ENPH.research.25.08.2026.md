...
Signed file: `ENPH.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $37.35 (2026-08-25, ~15-min delayed) |
| Market cap | $4.94B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-7.71%) with negative half-year (-24.91%). |
| Fresh setup quality | Poor / broken | -48.36% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 16.18, EV/Sales 3.45. |
| Risk level | High | Beta 1.65, ATR 5.9% of price, short float 20.98%. |
...
|---|---|---|
| 1 Industrials Stock with Exciting Potential and 2 We Find Risky | StockStory | 2026-08-21 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $37.35; 52w high $72.33 (-48.36%); 52w low $26.12 (+42.99%) |
| Trend | -7.71% vs SMA200, -11.92% vs SMA50, -4.71% vs SMA20 |
| Momentum | RSI(14) 41.7 (neutral) |
| Volatility | ATR(14) 2.20 (~5.9% of price); beta 1.65 |
| Setup perspective | -48.36% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 36.98, forward P/E 16.18, P/S 3.72, P/B 4.18 | EV/Sales 3.45, EV/EBITDA 23.93 |
...
- **Volatility risk:** Beta 1.65, ATR 5.9% of price, short float 20.98%. Size positions accordingly.
...
|---|---|---|---|
| Price | $37.35 | EV/Sales | 3.45 |
| Market cap | $4.94B | EV/EBITDA | 23.93 |
| Beta | 1.65 | Gross margin | 30.04% |
| RSI(14) | 41.7 | Operating margin | 17.98% |
| ATR(14) | 2.20 | Profit margin | 10.09% |
| SMA20 dist | -4.71% | ROA | 2.38% |
| SMA50 dist | -11.92% | ROE | 13.00% |
| SMA200 dist | -7.71% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 96.77% |
| P/E (ttm) | 36.98 | Insider ownership | 3.03% |
| Forward P/E | 16.18 | Short float | 20.98% |
| PEG (trailing) | 1.11 | Avg volume | 5,849,865 |
| P/S | 3.72 | Employees | 2,872 |
| P/B | 4.18 | Analyst rec (1=buy..5=sell) | 2.5 |

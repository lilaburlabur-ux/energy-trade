...
Signed file: `NXE.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $9.46 (2026-09-15, ~15-min delayed) |
| Market cap | $6.34B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-13.06%) with negative half-year (-19.35%). |
...
| Value attractiveness | Reasonable | Forward P/E -58.57, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.46; 52w high $13.92 (-32.04%); 52w low $7.56 (+25.13%) |
| Trend | -13.06% vs SMA200, -4.73% vs SMA50, -9.49% vs SMA20 |
| Momentum | RSI(14) 38.4 (neutral) |
| Volatility | ATR(14) 0.46 (~4.8% of price); beta 1.67 |
...
| Valuation | P/E —, forward P/E -58.57, P/S —, P/B 4.74 | EV/Sales —, EV/EBITDA -55.29 |

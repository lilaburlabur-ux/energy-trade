...
Signed file: `UEC.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $11.51 (2026-09-03, ~15-min delayed) |
| Market cap | $5.70B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.51; 52w high $20.14 (-42.85%); 52w low $9.04 (+27.32%) |
| Trend | -13.22% vs SMA200, +6.65% vs SMA50, -3.04% vs SMA20 |
| Momentum | RSI(14) 49.1 (neutral) |
| Volatility | ATR(14) 0.69 (~6.0% of price); beta 1.21 |
| Setup perspective | -42.85% from 52w high — base needs to rebuild. |
...
| SMA20 dist | -3.04% | ROA | -6.25% |
| SMA50 dist | +6.65% | ROE | -8.96% |
| SMA200 dist | -13.22% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 88.54% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -127.89 | Short float | 14.55% |
| PEG (trailing) | — | Avg volume | 9,622,801 |
| P/S | 281.98 | Employees | 171 |
| P/B | 4.00 | Analyst rec (1=buy..5=sell) | 1.4 |

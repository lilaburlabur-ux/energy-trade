...
Signed file: `TLN.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $306.29 (2026-08-26, ~15-min delayed) |
| Market cap | $14.68B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-15.04%) with negative half-year (-21.75%). |
| Fresh setup quality | Poor / broken | -31.30% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-4.95%). |
| Value attractiveness | Reasonable | Forward P/E 9.95, EV/Sales 6.43. |
| Risk level | High | Beta 1.67, ATR 5.7% of price, short float 5.05%. |
...
|---|---|---|
| Talen Energy (TLN) is Down 23% This Year. But Mizuho Expects a Rebound | Insider Monkey | 2026-08-25 |
| 3 Nuclear Energy Stocks for the AI Power Era | 24/7 Wall St. | 2026-08-24 |
| These 3 AI stocks are bought by both hedge funds and mutual funds | Investing.com | 2026-08-22 |
| Pennsylvania Sets New Data-Center Rules—and Some Energy Companies Can Actually Benefit | Barrons.com | 2026-08-19 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $306.29; 52w high $445.84 (-31.30%); 52w low $302.97 (+1.10%) |
| Trend | -15.04% vs SMA200, -15.81% vs SMA50, -8.60% vs SMA20 |
| Momentum | RSI(14) 35.5 (neutral) |
| Volatility | ATR(14) 17.34 (~5.7% of price); beta 1.67 |
| Setup perspective | -31.30% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 9.95, P/S 3.92, P/B 9.08 | EV/Sales 6.43, EV/EBITDA 41.32 |
...
- **Volatility risk:** Beta 1.67, ATR 5.7% of price, short float 5.05%. Size positions accordingly.
...
|---|---|---|---|
| Price | $306.29 | EV/Sales | 6.43 |
| Market cap | $14.68B | EV/EBITDA | 41.32 |
| Beta | 1.67 | Gross margin | 42.10% |
| RSI(14) | 35.5 | Operating margin | -4.80% |
| ATR(14) | 17.34 | Profit margin | -4.95% |
| SMA20 dist | -8.60% | ROA | 0.92% |
| SMA50 dist | -15.81% | ROE | -12.83% |
| SMA200 dist | -15.04% | Revenue (ttm) | $3.74B |
| 52W high | $445.84 | Revenue growth y/y | 111.20% |
| 52W low | $302.97 | Inst. ownership | 102.20% |
| P/E (ttm) | — | Insider ownership | 1.36% |
| Forward P/E | 9.95 | Short float | 5.05% |
| PEG (trailing) | — | Avg volume | 849,277 |
| P/S | 3.92 | Employees | 1,880 |
| P/B | 9.08 | Analyst rec (1=buy..5=sell) | 1.6 |

...
Signed file: `SMR.research.02.09.2026`

| Field | Value |
|---|---|
| Current price | $9.56 (2026-09-02, ~15-min delayed) |
| Market cap | $3.92B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-27.21%) with negative half-year (-23.76%). |
| Fresh setup quality | Poor / broken | -82.11% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -14.67, EV/Sales 249.45. |
| Risk level | High | Beta 2.31, ATR 7.0% of price, short float 18.40%. |
...
| SMR Stock Declines Despite Inking Fresh Partnership For Nuclear Safety Component: Retail Turns Bearish | Stocktwits | 2026-09-02 |
| Major U.S. Oil Port Selected for Nuclear Power Project | Oilprice.com | 2026-09-01 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.56; 52w high $53.43 (-82.11%); 52w low $7.59 (+25.96%) |
| Trend | -27.21% vs SMA200, +4.79% vs SMA50, +1.71% vs SMA20 |
| Momentum | RSI(14) 52.7 (neutral) |
| Volatility | ATR(14) 0.67 (~7.0% of price); beta 2.31 |
| Setup perspective | -82.11% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -14.67, P/S 367.01, P/B 1.90 | EV/Sales 249.45, EV/EBITDA -11.90 |
...
- **Volatility risk:** Beta 2.31, ATR 7.0% of price, short float 18.40%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.56 | EV/Sales | 249.45 |
| Market cap | $3.92B | EV/EBITDA | -11.90 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 52.7 | Operating margin | -85337.33% |
| ATR(14) | 0.67 | Profit margin | 0.00% |
| SMA20 dist | +1.71% | ROA | -10.60% |
| SMA50 dist | +4.79% | ROE | -55.18% |
| SMA200 dist | -27.21% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.38% |
| P/E (ttm) | — | Insider ownership | 1.70% |
| Forward P/E | -14.67 | Short float | 18.40% |
| PEG (trailing) | — | Avg volume | 32,659,174 |
| P/S | 367.01 | Employees | 428 |
| P/B | 1.90 | Analyst rec (1=buy..5=sell) | 2.6 |

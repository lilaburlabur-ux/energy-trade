...
Signed file: `TRGP.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $293.54 (2026-09-03, ~15-min delayed) |
| Market cap | $62.94B |
...
|---|---|---|
| Technical momentum | High | 1Y +83.34%; price +24.59% vs SMA200. |
| Fresh setup quality | Watch | -2.88% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 13.54%, revenue growth 4.20%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 24.30, EV/Sales 4.93. |
| Risk level | Moderate | Beta 0.72, ATR 2.7% of price, short float 2.71%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $293.54; 52w high $302.25 (-2.88%); 52w low $143.22 (+104.96%) |
| Trend | +24.59% vs SMA200, +6.05% vs SMA50, +2.95% vs SMA20 |
| Momentum | RSI(14) 57.9 (neutral) |
| Volatility | ATR(14) 7.98 (~2.7% of price); beta 0.72 |
| Setup perspective | -2.88% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 28.09, forward P/E 24.30, P/S 3.76, P/B 20.10 | EV/Sales 4.93, EV/EBITDA 15.01 |
| Growth expectations | Earnings growth 23.30%, EPS q/q 21.50% | Analyst mean target $310.10 (21 analysts) |
...
- **Valuation risk:** Forward P/E 24.30, EV/Sales 4.93. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $293.54 | EV/Sales | 4.93 |
| Market cap | $62.94B | EV/EBITDA | 15.01 |
| Beta | 0.72 | Gross margin | 43.19% |
| RSI(14) | 57.9 | Operating margin | 27.80% |
| ATR(14) | 7.98 | Profit margin | 13.54% |
| SMA20 dist | +2.95% | ROA | 9.24% |
| SMA50 dist | +6.05% | ROE | 70.84% |
| SMA200 dist | +24.59% | Revenue (ttm) | $16.74B |
| 52W high | $302.25 | Revenue growth y/y | 4.20% |
| 52W low | $143.22 | Inst. ownership | 97.46% |
| P/E (ttm) | 28.09 | Insider ownership | 1.38% |
| Forward P/E | 24.30 | Short float | 2.71% |
| PEG (trailing) | — | Avg volume | 1,246,444 |
| P/S | 3.76 | Employees | 3,570 |
| P/B | 20.10 | Analyst rec (1=buy..5=sell) | 1.5 |

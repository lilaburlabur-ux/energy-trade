...
Signed file: `EPD.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $38.43 (2026-08-20, ~15-min delayed) |
| Market cap | $82.99B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +30.27%; price +9.95% vs SMA200. |
| Fresh setup quality | Watch | -2.00% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.18, EV/Sales 2.00. |
...
| Oil Is Up 36% and the Strait of Hormuz Is Still Closed. The QQQI Family Runs a 14.75% Energy Fund | 24/7 Wall St. | 2026-08-19 |
| 3 Reasons I'd Trust This 5.8%-Yielding Dividend Right Now | Motley Fool | 2026-08-19 |
| Here's How EPD Is Expanding Its Permian Value Chains for Future Growth | Zacks | 2026-08-19 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.43; 52w high $39.22 (-2.00%); 52w low $28.35 (+35.54%) |
| Trend | +9.95% vs SMA200, +3.06% vs SMA50, +0.93% vs SMA20 |
| Momentum | RSI(14) 55.8 (neutral) |
| Volatility | ATR(14) 0.65 (~1.7% of price); beta 0.48 |
| Setup perspective | -2.00% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.30, forward P/E 12.18, P/S 1.42, P/B 2.82 | EV/Sales 2.00, EV/EBITDA 11.35 |
...
|---|---|---|---|
| Price | $38.43 | EV/Sales | 2.00 |
| Market cap | $82.99B | EV/EBITDA | 11.35 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 55.8 | Operating margin | 11.76% |
| ATR(14) | 0.65 | Profit margin | 10.79% |
| SMA20 dist | +0.93% | ROA | 5.92% |
| SMA50 dist | +3.06% | ROE | 20.85% |
| SMA200 dist | +9.95% | Revenue (ttm) | $58.47B |
| 52W high | $39.22 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.62% |
| P/E (ttm) | 13.30 | Insider ownership | 33.04% |
| Forward P/E | 12.18 | Short float | 2.31% |
| PEG (trailing) | 1.48 | Avg volume | 3,123,087 |
| P/S | 1.42 | Employees | 0 |
| P/B | 2.82 | Analyst rec (1=buy..5=sell) | 2.2 |

...
Signed file: `SMR.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $9.75 (2026-09-03, ~15-min delayed) |
| Market cap | $4.00B |
...
| Wall Street Loves NuScale Power. Here's the Risk Analysts Are Glossing Over. | Motley Fool | 2026-09-03 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.75; 52w high $53.43 (-81.75%); 52w low $7.59 (+28.46%) |
| Trend | -25.40% vs SMA200, +6.99% vs SMA50, +3.58% vs SMA20 |
| Momentum | RSI(14) 54.4 (neutral) |
| Volatility | ATR(14) 0.65 (~6.7% of price); beta 2.31 |
| Setup perspective | -81.75% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 2.31, ATR 6.7% of price, short float 18.40%. Size positions accordingly.
...
| SMA20 dist | +3.58% | ROA | -10.60% |
| SMA50 dist | +6.99% | ROE | -55.18% |
| SMA200 dist | -25.40% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.38% |
| P/E (ttm) | — | Insider ownership | 1.70% |
| Forward P/E | -14.96 | Short float | 18.40% |
| PEG (trailing) | — | Avg volume | 32,251,187 |
| P/S | 374.30 | Employees | 428 |

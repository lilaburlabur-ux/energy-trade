...
Signed file: `SU.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $63.88 (2026-08-12, ~15-min delayed) |
| Market cap | $74.72B |
...
|---|---|---|
| Technical momentum | High | 1Y +67.06%; price +15.13% vs SMA200. |
| Fresh setup quality | Moderate / wait | -7.78% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 15.78%, revenue growth 45.90%. |
| Value attractiveness | Reasonable | Forward P/E 11.46, EV/Sales 1.47. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $63.88; 52w high $69.27 (-7.78%); 52w low $37.63 (+69.77%) |
| Trend | +15.13% vs SMA200, +5.13% vs SMA50, -0.05% vs SMA20 |
| Momentum | RSI(14) 54.1 (neutral) |
| Volatility | ATR(14) 1.85 (~2.9% of price); beta 0.57 |
| Setup perspective | -7.78% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 11.90, forward P/E 11.46, P/S 1.32, P/B 2.17 | EV/Sales 1.47, EV/EBITDA 4.27 |
| Growth expectations | Earnings growth 241.90%, EPS q/q 229.10% | Analyst mean target $70.53 (3 analysts) |
...
|---|---|---|---|
| Price | $63.88 | EV/Sales | 1.47 |
| Market cap | $74.72B | EV/EBITDA | 4.27 |
| Beta | 0.57 | Gross margin | 60.40% |
| RSI(14) | 54.1 | Operating margin | 29.94% |
| ATR(14) | 1.85 | Profit margin | 15.78% |
| SMA20 dist | -0.05% | ROA | 8.58% |
| SMA50 dist | +5.13% | ROE | 19.25% |
| SMA200 dist | +15.13% | Revenue (ttm) | $56.57B |
| 52W high | $69.27 | Revenue growth y/y | 45.90% |
| 52W low | $37.63 | Inst. ownership | 75.41% |
| P/E (ttm) | 11.90 | Insider ownership | 0.01% |
| Forward P/E | 11.46 | Short float | — |
| PEG (trailing) | — | Avg volume | 4,547,974 |
| P/S | 1.32 | Employees | 15,424 |
| P/B | 2.17 | Analyst rec (1=buy..5=sell) | 1.9 |

...
Signed file: `WMB.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $71.65 (2026-09-21, ~15-min delayed) |
| Market cap | $87.64B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +22.28%; price +2.66% vs SMA200. |
| Fresh setup quality | Moderate / wait | -8.43% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 24.94%, revenue growth 7.80%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 27.59, EV/Sales 9.81. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $71.65; 52w high $78.25 (-8.43%); 52w low $54.84 (+30.65%) |
| Trend | +2.66% vs SMA200, -1.19% vs SMA50, -1.70% vs SMA20 |
| Momentum | RSI(14) 45.9 (neutral) |
| Volatility | ATR(14) 1.92 (~2.7% of price); beta 0.62 |
| Setup perspective | -8.43% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 28.55, forward P/E 27.59, P/S 7.11, P/B 6.66 | EV/Sales 9.81, EV/EBITDA 17.20 |
...
- **Valuation risk:** Forward P/E 27.59, EV/Sales 9.81. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $71.65 | EV/Sales | 9.81 |
| Market cap | $87.64B | EV/EBITDA | 17.20 |
| Beta | 0.62 | Gross margin | 63.64% |
| RSI(14) | 45.9 | Operating margin | 39.54% |
| ATR(14) | 1.92 | Profit margin | 24.94% |
| SMA20 dist | -1.70% | ROA | 5.03% |
| SMA50 dist | -1.19% | ROE | 21.50% |
| SMA200 dist | +2.66% | Revenue (ttm) | $12.32B |

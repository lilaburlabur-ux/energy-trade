...
Signed file: `NXE.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $9.63 (2026-09-23, ~15-min delayed) |
| Market cap | $6.37B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-11.61%) with negative half-year (-15.53%). |
| Fresh setup quality | Poor / broken | -30.82% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -60.33, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.63; 52w high $13.92 (-30.82%); 52w low $7.56 (+27.38%) |
| Trend | -11.61% vs SMA200, -3.24% vs SMA50, -5.50% vs SMA20 |
| Momentum | RSI(14) 43.6 (neutral) |
| Volatility | ATR(14) 0.43 (~4.5% of price); beta 1.67 |
| Setup perspective | -30.82% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -60.33, P/S —, P/B 4.82 | EV/Sales —, EV/EBITDA -58.38 |
...
|---|---|---|---|
| Price | $9.63 | EV/Sales | — |
| Market cap | $6.37B | EV/EBITDA | -58.38 |
| Beta | 1.67 | Gross margin | 0.00% |
| RSI(14) | 43.6 | Operating margin | 0.00% |
| ATR(14) | 0.43 | Profit margin | 0.00% |
| SMA20 dist | -5.50% | ROA | -3.39% |
| SMA50 dist | -3.24% | ROE | -17.67% |
| SMA200 dist | -11.61% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.56 | Inst. ownership | 55.23% |
| P/E (ttm) | — | Insider ownership | 6.40% |
| Forward P/E | -60.33 | Short float | — |
| PEG (trailing) | — | Avg volume | 4,723,122 |
| P/S | — | Employees | 142 |
| P/B | 4.82 | Analyst rec (1=buy..5=sell) | 1.6 |

...
Signed file: `BWXT.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $165.01 (2026-08-18, ~15-min delayed) |
| Market cap | $15.12B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-15.42%) with negative half-year (-17.72%). |
| Fresh setup quality | Poor / broken | -30.70% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.11%, revenue growth 18.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 31.41, EV/Sales 4.87. |
| Risk level | Elevated | Beta 0.76, ATR 3.9% of price, short float 3.99%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $165.01; 52w high $238.10 (-30.70%); 52w low $157.44 (+4.81%) |
| Trend | -15.42% vs SMA200, -9.43% vs SMA50, -3.12% vs SMA20 |
| Momentum | RSI(14) 40.3 (neutral) |
| Volatility | ATR(14) 6.50 (~3.9% of price); beta 0.76 |
| Setup perspective | -30.70% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 42.75, forward P/E 31.41, P/S 4.30, P/B 11.33 | EV/Sales 4.87, EV/EBITDA 35.95 |
...
- **Valuation risk:** Forward P/E 31.41, EV/Sales 4.87. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.76, ATR 3.9% of price, short float 3.99%. Size positions accordingly.
...
|---|---|---|---|
| Price | $165.01 | EV/Sales | 4.87 |
| Market cap | $15.12B | EV/EBITDA | 35.95 |
| Beta | 0.76 | Gross margin | 22.08% |
| RSI(14) | 40.3 | Operating margin | 10.39% |
| ATR(14) | 6.50 | Profit margin | 10.11% |
| SMA20 dist | -3.12% | ROA | 5.53% |
| SMA50 dist | -9.43% | ROE | 28.29% |
| SMA200 dist | -15.42% | Revenue (ttm) | $3.51B |
| 52W high | $238.10 | Revenue growth y/y | 18.00% |
| 52W low | $157.44 | Inst. ownership | 94.35% |
| P/E (ttm) | 42.75 | Insider ownership | 0.35% |
| Forward P/E | 31.41 | Short float | 3.99% |
| PEG (trailing) | — | Avg volume | 960,159 |
| P/S | 4.30 | Employees | 11,000 |
| P/B | 11.33 | Analyst rec (1=buy..5=sell) | 1.8 |

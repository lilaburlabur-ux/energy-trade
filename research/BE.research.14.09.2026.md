...
Signed file: `BE.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $257.05 (2026-09-14, ~15-min delayed) |
| Market cap | $75.71B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $257.05; 52w high $345.85 (-25.68%); 52w low $67.02 (+283.54%) |
| Trend | +31.50% vs SMA200, +14.03% vs SMA50, +12.16% vs SMA20 |
| Momentum | RSI(14) 57.3 (neutral) |
| Volatility | ATR(14) 19.67 (~7.7% of price); beta 3.81 |
...
| SMA20 dist | +12.16% | ROA | 5.60% |
| SMA50 dist | +14.03% | ROE | 22.21% |
| SMA200 dist | +31.50% | Revenue (ttm) | $3.11B |
| 52W high | $345.85 | Revenue growth y/y | 165.50% |
| 52W low | $67.02 | Inst. ownership | 86.08% |
| P/E (ttm) | 333.83 | Insider ownership | 5.54% |
| Forward P/E | 52.15 | Short float | 7.43% |
| PEG (trailing) | 0.62 | Avg volume | 15,198,656 |
| P/S | 24.32 | Employees | 2,214 |
| P/B | 46.78 | Analyst rec (1=buy..5=sell) | 2.2 |

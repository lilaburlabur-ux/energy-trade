...
Signed file: `FTI.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $74.97 (2026-09-15, ~15-min delayed) |
| Market cap | $29.40B |
...
|---|---|---|
| Technical momentum | High | 1Y +88.75%; price +14.85% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 20.83, EV/Sales 2.77. |
| Risk level | Elevated | Beta 0.74, ATR 3.3% of price, short float 3.28%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $74.97; 52w high $80.08 (-6.38%); 52w low $35.45 (+111.46%) |
| Trend | +14.85% vs SMA200, +0.59% vs SMA50, -2.70% vs SMA20 |
| Momentum | RSI(14) 47.0 (neutral) |
| Volatility | ATR(14) 2.50 (~3.3% of price); beta 0.74 |
...
| Valuation | P/E 26.21, forward P/E 20.83, P/S 2.82, P/B 9.00 | EV/Sales 2.77, EV/EBITDA 14.54 |
...
- **Valuation risk:** Forward P/E 20.83, EV/Sales 2.77. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.74, ATR 3.3% of price, short float 3.28%. Size positions accordingly.
...
|---|---|---|---|
| Price | $74.97 | EV/Sales | 2.77 |
| Market cap | $29.40B | EV/EBITDA | 14.54 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 47.0 | Operating margin | 17.69% |
| ATR(14) | 2.50 | Profit margin | 11.28% |
| SMA20 dist | -2.70% | ROA | 9.53% |
| SMA50 dist | +0.59% | ROE | 35.81% |
| SMA200 dist | +14.85% | Revenue (ttm) | $10.42B |
| 52W high | $80.08 | Revenue growth y/y | 9.00% |
| 52W low | $35.45 | Inst. ownership | 101.17% |
| P/E (ttm) | 26.21 | Insider ownership | 1.49% |
| Forward P/E | 20.83 | Short float | 3.28% |
| PEG (trailing) | — | Avg volume | 3,631,532 |
| P/S | 2.82 | Employees | 22,000 |
| P/B | 9.00 | Analyst rec (1=buy..5=sell) | 2.0 |

## 8. Analyst Actions
| Date | Action | Firm | Rating change |
|---|---|---|---|
| 2026-09-15 | main | Citigroup | Buy → Buy |

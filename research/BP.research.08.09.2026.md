# BP Research Report
**BP** — Technical + Fundamental Analysis, Data Snapshot, Institutional Investors
...
| Volatility | ATR(14) 1.03 (~2.3% of price); beta — |
...
|---|---|---|---|
| Price | $44.88 | EV/Sales | — |
| Market cap | — | EV/EBITDA | — |
| Beta | — | Gross margin | — |
| RSI(14) | 60.6 | Operating margin | — |
| ATR(14) | 1.03 | Profit margin | — |
| SMA20 dist | +3.54% | ROA | — |
| SMA50 dist | +7.55% | ROE | — |
| SMA200 dist | +12.32% | Revenue (ttm) | — |
| 52W high | $46.52 | Revenue growth y/y | — |
| 52W low | $31.17 | Inst. ownership | — |
| P/E (ttm) | — | Insider ownership | — |
| Forward P/E | — | Short float | — |
| PEG (trailing) | 0.06 | Avg volume | 0 |
| P/S | — | Employees | 0 |
...
## 9. Conclusion
BP: Moderate momentum / mixed fundamentals / low (expensive) value / moderate risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

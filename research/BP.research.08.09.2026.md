...
Signed file: `BP.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $44.88 (2026-09-08, ~15-min delayed) |
| Market cap | $115.58B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +39.09%; price +12.32% vs SMA200. |
| Fresh setup quality | Watch | -3.52% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 2.55%, revenue growth 48.20%. |
| Value attractiveness | Reasonable | Forward P/E 9.42, EV/Sales 2.35. |
| Risk level | Moderate | Beta -0.22, ATR 2.3% of price, short float 0.28%. |
...
|---|---|---|
| BP (BP) Ascends While Market Falls: Some Facts to Note | Zacks | 2026-09-08 |
| European Equities Traded in the US as American Depositary Receipts Fall in Tuesday Trading | MT Newswires | 2026-09-08 |
| Shares edge down as Iran tensions push oil higher | PA Media: Money | 2026-09-07 |
| British energy giant BP names Ian Tyler as chair after boardroom turmoil | Euronews | 2026-09-07 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $44.88; 52w high $46.52 (-3.52%); 52w low $31.17 (+43.97%) |
| Trend | +12.32% vs SMA200, +7.55% vs SMA50, +3.54% vs SMA20 |
| Momentum | RSI(14) 60.6 (neutral) |
| Volatility | ATR(14) 1.03 (~2.3% of price); beta -0.22 |
| Setup perspective | -3.52% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 21.47, forward P/E 9.42, P/S 0.54, P/B 7.95 | EV/Sales 2.35, EV/EBITDA 12.93 |
| Growth expectations | Earnings growth 138.90%, EPS q/q 140.10% | Analyst mean target $48.15 (18 analysts) |
...
|---|---|---|---|
| Price | $44.88 | EV/Sales | 2.35 |
| Market cap | $115.58B | EV/EBITDA | 12.93 |
| Beta | -0.22 | Gross margin | 28.30% |
| RSI(14) | 60.6 | Operating margin | 13.15% |
| ATR(14) | 1.03 | Profit margin | 2.55% |
| SMA20 dist | +3.54% | ROA | 5.04% |
| SMA50 dist | +7.55% | ROE | 8.87% |
| SMA200 dist | +12.32% | Revenue (ttm) | $215.47B |
| 52W high | $46.52 | Revenue growth y/y | 48.20% |
| 52W low | $31.17 | Inst. ownership | 14.09% |
| P/E (ttm) | 21.47 | Insider ownership | 0.00% |
| Forward P/E | 9.42 | Short float | 0.28% |
| PEG (trailing) | 0.06 | Avg volume | 9,163,196 |
| P/S | 0.54 | Employees | 93,700 |
| P/B | 7.95 | Analyst rec (1=buy..5=sell) | 2.4 |

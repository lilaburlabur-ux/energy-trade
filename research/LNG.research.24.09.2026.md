...
Signed file: `LNG.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $276.28 (2026-09-24, ~15-min delayed) |
| Market cap | $57.06B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +20.88%; price +13.49% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.62% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 13.94%, revenue growth 22.70%. |
| Value attractiveness | Reasonable | Forward P/E 13.12, EV/Sales 4.24. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $276.28; 52w high $295.86 (-6.62%); 52w low $187.49 (+47.36%) |
| Trend | +13.49% vs SMA200, +1.96% vs SMA50, -1.26% vs SMA20 |
| Momentum | RSI(14) 51.6 (neutral) |
| Volatility | ATR(14) 7.62 (~2.8% of price); beta -0.00 |
| Setup perspective | -6.62% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.95, forward P/E 13.12, P/S 2.73, P/B 9.28 | EV/Sales 4.24, EV/EBITDA 11.33 |
...
|---|---|---|---|
| Price | $276.28 | EV/Sales | 4.24 |
| Market cap | $57.06B | EV/EBITDA | 11.33 |
| Beta | -0.00 | Gross margin | 36.85% |
| RSI(14) | 51.6 | Operating margin | 75.00% |
| ATR(14) | 7.62 | Profit margin | 13.94% |
| SMA20 dist | -1.26% | ROA | 8.63% |
| SMA50 dist | +1.96% | ROE | 39.12% |
| SMA200 dist | +13.49% | Revenue (ttm) | $20.92B |
| 52W high | $295.86 | Revenue growth y/y | 22.70% |
| 52W low | $187.49 | Inst. ownership | 91.52% |
| P/E (ttm) | 20.95 | Insider ownership | 0.66% |
| Forward P/E | 13.12 | Short float | 2.03% |
| PEG (trailing) | — | Avg volume | 1,971,044 |
| P/S | 2.73 | Employees | 1,717 |
| P/B | 9.28 | Analyst rec (1=buy..5=sell) | 1.4 |

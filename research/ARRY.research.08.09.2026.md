...
Signed file: `ARRY.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $4.70 (2026-09-08, ~15-min delayed) |
| Market cap | $722.98M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-39.92%) with negative half-year (-30.16%). |
| Fresh setup quality | Poor / broken | -60.70% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.24, EV/Sales 1.39. |
| Risk level | High | Beta 1.77, ATR 5.8% of price, short float 24.55%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.70; 52w high $11.96 (-60.70%); 52w low $4.36 (+7.80%) |
| Trend | -39.92% vs SMA200, -14.79% vs SMA50, -1.20% vs SMA20 |
| Momentum | RSI(14) 42.6 (neutral) |
| Volatility | ATR(14) 0.27 (~5.8% of price); beta 1.77 |
| Setup perspective | -60.70% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 5.24, P/S 0.61, P/B -3.58 | EV/Sales 1.39, EV/EBITDA 13.84 |
| Growth expectations | Earnings growth -73.20%, EPS q/q -43.70% | Analyst mean target $9.11 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 147.96% |
...
- **Volatility risk:** Beta 1.77, ATR 5.8% of price, short float 24.55%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.70 | EV/Sales | 1.39 |
| Market cap | $722.98M | EV/EBITDA | 13.84 |
| Beta | 1.77 | Gross margin | 26.76% |
| RSI(14) | 42.6 | Operating margin | 10.88% |
| ATR(14) | 0.27 | Profit margin | -7.25% |
| SMA20 dist | -1.20% | ROA | 3.33% |
| SMA50 dist | -14.79% | ROE | -25.98% |
| SMA200 dist | -39.92% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.36 | Inst. ownership | 147.96% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.24 | Short float | 24.55% |
| PEG (trailing) | 0.48 | Avg volume | 6,637,590 |
| P/S | 0.61 | Employees | 1,200 |
| P/B | -3.58 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `BWXT.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $171.54 (2026-08-17, ~15-min delayed) |
| Market cap | $15.72B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-12.18%) with negative half-year (-14.17%). |
| Fresh setup quality | Poor / broken | -27.96% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.11%, revenue growth 18.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 32.65, EV/Sales 4.92. |
...
|---|---|---|
| 3 Cash-Producing Stocks with Exciting Potential | StockStory | 2026-08-17 |
| Standard Nuclear Stock Hit Its High Ahead Of The Numbers | Trefis | 2026-08-17 |
| Can BWXT's Nuclear Cleanup Services Add a New Growth Avenue? | Zacks | 2026-08-17 |
| Can BWX Technologies' Nuclear Medicine Expansion Boost Growth? | Zacks | 2026-08-13 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $171.54; 52w high $238.10 (-27.96%); 52w low $157.44 (+8.96%) |
| Trend | -12.18% vs SMA200, -6.06% vs SMA50, +0.47% vs SMA20 |
| Momentum | RSI(14) 46.6 (neutral) |
| Volatility | ATR(14) 6.47 (~3.8% of price); beta 0.76 |
| Setup perspective | -27.96% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 44.44, forward P/E 32.65, P/S 4.47, P/B 11.78 | EV/Sales 4.92, EV/EBITDA 36.27 |
...
- **Valuation risk:** Forward P/E 32.65, EV/Sales 4.92. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $171.54 | EV/Sales | 4.92 |
| Market cap | $15.72B | EV/EBITDA | 36.27 |
| Beta | 0.76 | Gross margin | 22.08% |
| RSI(14) | 46.6 | Operating margin | 10.39% |
| ATR(14) | 6.47 | Profit margin | 10.11% |
| SMA20 dist | +0.47% | ROA | 5.53% |
| SMA50 dist | -6.06% | ROE | 28.29% |
| SMA200 dist | -12.18% | Revenue (ttm) | $3.51B |
| 52W high | $238.10 | Revenue growth y/y | 18.00% |
| 52W low | $157.44 | Inst. ownership | 94.36% |
| P/E (ttm) | 44.44 | Insider ownership | 0.35% |
| Forward P/E | 32.65 | Short float | 3.99% |
| PEG (trailing) | — | Avg volume | 950,596 |
| P/S | 4.47 | Employees | 11,000 |
| P/B | 11.78 | Analyst rec (1=buy..5=sell) | 1.8 |

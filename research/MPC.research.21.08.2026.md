...
Signed file: `MPC.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $360.72 (2026-08-21, ~15-min delayed) |
| Market cap | $101.30B |
...
|---|---|---|
| Technical momentum | High | 1Y +121.17%; price +56.03% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 11.20, EV/Sales 0.87. |
| Risk level | Moderate | Beta 0.51, ATR 3.0% of price, short float 2.81%. |
...
| Is Phillips 66 (PSX) Stock Rich Or Reasonable After Pipeline Approval? | Simply Wall St. | 2026-08-21 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $360.72; 52w high $365.21 (-1.23%); 52w low $160.76 (+124.38%) |
| Trend | +56.03% vs SMA200, +21.55% vs SMA50, +9.67% vs SMA20 |
| Momentum | RSI(14) 72.2 (overbought) |
| Volatility | ATR(14) 10.70 (~3.0% of price); beta 0.51 |
...
| Valuation | P/E 12.51, forward P/E 11.20, P/S 0.66, P/B 5.35 | EV/Sales 0.87, EV/EBITDA 8.69 |
...
|---|---|---|---|
| Price | $360.72 | EV/Sales | 0.87 |
| Market cap | $101.30B | EV/EBITDA | 8.69 |
| Beta | 0.51 | Gross margin | 12.82% |
| RSI(14) | 72.2 | Operating margin | 13.56% |
| ATR(14) | 10.70 | Profit margin | 5.55% |
| SMA20 dist | +9.67% | ROA | 8.74% |
| SMA50 dist | +21.55% | ROE | 42.10% |
| SMA200 dist | +56.03% | Revenue (ttm) | $154.15B |
| 52W high | $365.21 | Revenue growth y/y | 53.70% |
| 52W low | $160.76 | Inst. ownership | 79.53% |
| P/E (ttm) | 12.51 | Insider ownership | 0.33% |
| Forward P/E | 11.20 | Short float | 2.81% |
| PEG (trailing) | 1.78 | Avg volume | 2,368,430 |
| P/S | 0.66 | Employees | 18,500 |
| P/B | 5.35 | Analyst rec (1=buy..5=sell) | 2.3 |

...
Signed file: `DUK.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $119.37 (2026-09-10, ~15-min delayed) |
| Market cap | $93.07B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-2.43%) with negative half-year (-6.59%). |
| Fresh setup quality | Moderate / wait | -8.99% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 16.00%, revenue growth 1.10%. |
| Value attractiveness | Reasonable | Forward P/E 16.64, EV/Sales 5.72. |
...
|---|---|---|
| OpenAI meets with utility leaders on grid risks from rogue AI - report | Investing.com | 2026-09-10 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $119.37; 52w high $131.16 (-8.99%); 52w low $111.09 (+7.45%) |
| Trend | -2.43% vs SMA200, -3.43% vs SMA50, -1.80% vs SMA20 |
| Momentum | RSI(14) 39.9 (neutral) |
| Volatility | ATR(14) 1.88 (~1.6% of price); beta 0.36 |
| Setup perspective | -8.99% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 17.98, forward P/E 16.64, P/S 2.84, P/B 1.73 | EV/Sales 5.72, EV/EBITDA 11.29 |
...
|---|---|---|---|
| Price | $119.37 | EV/Sales | 5.72 |
| Market cap | $93.07B | EV/EBITDA | 11.29 |
| Beta | 0.36 | Gross margin | 51.97% |
| RSI(14) | 39.9 | Operating margin | 27.50% |
| ATR(14) | 1.88 | Profit margin | 16.00% |
| SMA20 dist | -1.80% | ROA | 2.84% |
| SMA50 dist | -3.43% | ROE | 9.86% |
| SMA200 dist | -2.43% | Revenue (ttm) | $32.80B |
| 52W high | $131.16 | Revenue growth y/y | 1.10% |
| 52W low | $111.09 | Inst. ownership | 71.18% |
| P/E (ttm) | 17.98 | Insider ownership | 0.13% |
| Forward P/E | 16.64 | Short float | 2.55% |
| PEG (trailing) | 2.24 | Avg volume | 4,051,219 |
| P/S | 2.84 | Employees | 26,441 |
| P/B | 1.73 | Analyst rec (1=buy..5=sell) | — |

...
Signed file: `EPD.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $39.14 (2026-08-26, ~15-min delayed) |
| Market cap | $84.52B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +31.51%; price +11.39% vs SMA200. |
| Fresh setup quality | Watch | -0.19% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.40, EV/Sales 2.04. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $39.14; 52w high $39.22 (-0.19%); 52w low $28.35 (+38.04%) |
| Trend | +11.39% vs SMA200, +4.56% vs SMA50, +2.54% vs SMA20 |
| Momentum | RSI(14) 61.5 (neutral) |
| Volatility | ATR(14) 0.65 (~1.6% of price); beta 0.48 |
| Setup perspective | -0.19% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.54, forward P/E 12.40, P/S 1.45, P/B 2.79 | EV/Sales 2.04, EV/EBITDA 11.56 |
...
|---|---|---|---|
| Price | $39.14 | EV/Sales | 2.04 |
| Market cap | $84.52B | EV/EBITDA | 11.56 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 61.5 | Operating margin | 11.76% |
| ATR(14) | 0.65 | Profit margin | 10.79% |
| SMA20 dist | +2.54% | ROA | 5.92% |
| SMA50 dist | +4.56% | ROE | 20.85% |
| SMA200 dist | +11.39% | Revenue (ttm) | $58.47B |
| 52W high | $39.22 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.62% |
| P/E (ttm) | 13.54 | Insider ownership | 33.04% |
| Forward P/E | 12.40 | Short float | 2.61% |
| PEG (trailing) | 1.49 | Avg volume | 3,038,636 |

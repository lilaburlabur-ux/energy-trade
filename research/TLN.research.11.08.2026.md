...
Signed file: `TLN.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $357.88 (2026-08-11, ~15-min delayed) |
| Market cap | $17.15B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y -4.48%; price -1.75% vs SMA200. |
| Fresh setup quality | Moderate / wait | -19.73% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-4.95%). |
| Value attractiveness | Reasonable | Forward P/E 12.28, EV/Sales 6.90. |
| Risk level | High | Beta 1.67, ATR 5.4% of price, short float 5.90%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $357.88; 52w high $445.84 (-19.73%); 52w low $302.97 (+18.12%) |
| Trend | -1.75% vs SMA200, -3.76% vs SMA50, +1.65% vs SMA20 |
| Momentum | RSI(14) 50.8 (neutral) |
| Volatility | ATR(14) 19.32 (~5.4% of price); beta 1.67 |
| Setup perspective | -19.73% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E 12.28, P/S 4.58, P/B 10.61 | EV/Sales 6.90, EV/EBITDA 44.34 |
...
- **Volatility risk:** Beta 1.67, ATR 5.4% of price, short float 5.90%. Size positions accordingly.
...
|---|---|---|---|
| Price | $357.88 | EV/Sales | 6.90 |
| Market cap | $17.15B | EV/EBITDA | 44.34 |
| Beta | 1.67 | Gross margin | 42.10% |
| RSI(14) | 50.8 | Operating margin | -4.80% |
| ATR(14) | 19.32 | Profit margin | -4.95% |
| SMA20 dist | +1.65% | ROA | 0.92% |
| SMA50 dist | -3.76% | ROE | -12.83% |
| SMA200 dist | -1.75% | Revenue (ttm) | $3.74B |
| 52W high | $445.84 | Revenue growth y/y | 111.20% |
| 52W low | $302.97 | Inst. ownership | 104.85% |
| P/E (ttm) | — | Insider ownership | 1.36% |
| Forward P/E | 12.28 | Short float | 5.90% |
| PEG (trailing) | — | Avg volume | 834,948 |
| P/S | 4.58 | Employees | 1,880 |
| P/B | 10.61 | Analyst rec (1=buy..5=sell) | 1.6 |

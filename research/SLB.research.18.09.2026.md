...
Signed file: `SLB.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $51.12 (2026-09-18, ~15-min delayed) |
| Market cap | $75.87B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +50.53%; price +3.43% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 15.80, EV/Sales 2.40. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $51.12; 52w high $59.79 (-14.50%); 52w low $30.96 (+65.10%) |
| Trend | +3.43% vs SMA200, -1.76% vs SMA50, -7.42% vs SMA20 |
| Momentum | RSI(14) 39.1 (neutral) |
| Volatility | ATR(14) 1.85 (~3.6% of price); beta 0.77 |
...
| Valuation | P/E 24.94, forward P/E 15.80, P/S 2.09, P/B 2.91 | EV/Sales 2.40, EV/EBITDA 11.81 |
...
|---|---|---|---|
| Price | $51.12 | EV/Sales | 2.40 |
| Market cap | $75.87B | EV/EBITDA | 11.81 |
| Beta | 0.77 | Gross margin | 16.99% |
| RSI(14) | 39.1 | Operating margin | 12.71% |
| ATR(14) | 1.85 | Profit margin | 8.53% |
| SMA20 dist | -7.42% | ROA | 6.17% |
| SMA50 dist | -1.76% | ROE | 12.91% |
| SMA200 dist | +3.43% | Revenue (ttm) | $36.37B |
| 52W high | $59.79 | Revenue growth y/y | 5.00% |
| 52W low | $30.96 | Inst. ownership | 92.52% |
| P/E (ttm) | 24.94 | Insider ownership | 0.22% |
| Forward P/E | 15.80 | Short float | 4.25% |
| PEG (trailing) | 1.37 | Avg volume | 13,260,438 |
| P/S | 2.09 | Employees | 109,000 |
| P/B | 2.91 | Analyst rec (1=buy..5=sell) | 1.6 |

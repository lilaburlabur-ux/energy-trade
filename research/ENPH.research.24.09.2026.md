...
Signed file: `ENPH.research.24.09.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-20.38%) with negative half-year (-22.83%). |
...
| Value attractiveness | Reasonable | Forward P/E 14.48, EV/Sales 3.02. |
...
| Trend | -20.38% vs SMA200, -13.36% vs SMA50, -8.84% vs SMA20 |
| Momentum | RSI(14) 33.4 (neutral) |
| Volatility | ATR(14) 1.89 (~5.8% of price); beta 1.64 |
...
| Valuation | P/E 32.50, forward P/E 14.48, P/S 3.26, P/B 3.67 | EV/Sales 3.02, EV/EBITDA 20.92 |
...
| SMA20 dist | -8.84% | ROA | 2.38% |
| SMA50 dist | -13.36% | ROE | 13.00% |
...
| Forward P/E | 14.48 | Short float | 21.29% |
| PEG (trailing) | 0.75 | Avg volume | 4,748,126 |

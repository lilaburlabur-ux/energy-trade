...
Signed file: `ARRY.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $4.71 (2026-08-26, ~15-min delayed) |
| Market cap | $725.38M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-40.91%) with negative half-year (-57.18%). |
| Fresh setup quality | Poor / broken | -60.62% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.29, EV/Sales 1.39. |
| Risk level | High | Beta 1.79, ATR 7.0% of price, short float 24.55%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.71; 52w high $11.96 (-60.62%); 52w low $4.55 (+3.52%) |
| Trend | -40.91% vs SMA200, -21.97% vs SMA50, -8.04% vs SMA20 |
| Momentum | RSI(14) 37.1 (neutral) |
| Volatility | ATR(14) 0.33 (~7.0% of price); beta 1.79 |
| Setup perspective | -60.62% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 5.29, P/S 0.61, P/B -3.59 | EV/Sales 1.39, EV/EBITDA 13.78 |
| Growth expectations | Earnings growth -73.20%, EPS q/q -43.70% | Analyst mean target $9.11 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 148.30% |
...
- **Volatility risk:** Beta 1.79, ATR 7.0% of price, short float 24.55%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.71 | EV/Sales | 1.39 |
| Market cap | $725.38M | EV/EBITDA | 13.78 |
| Beta | 1.79 | Gross margin | 26.76% |
| RSI(14) | 37.1 | Operating margin | 10.88% |
| ATR(14) | 0.33 | Profit margin | -7.25% |
| SMA20 dist | -8.04% | ROA | 3.33% |
| SMA50 dist | -21.97% | ROE | -25.98% |
| SMA200 dist | -40.91% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.55 | Inst. ownership | 148.30% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.29 | Short float | 24.55% |
| PEG (trailing) | 0.54 | Avg volume | 6,764,628 |
| P/S | 0.61 | Employees | 1,200 |
| P/B | -3.59 | Analyst rec (1=buy..5=sell) | 2.0 |

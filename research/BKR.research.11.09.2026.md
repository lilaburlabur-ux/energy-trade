...
Signed file: `BKR.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $59.06 (2026-09-11, ~15-min delayed) |
| Market cap | $58.63B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +27.84%; price +1.10% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 18.99, EV/Sales 2.10. |
| Risk level | Elevated | Beta 0.96, ATR 3.3% of price, short float 3.08%. |
...
|---|---|---|
| U.S. Oil Rig Count Rises as Oil Tops $100 | Oilprice.com | 2026-09-11 |
| Baker Hughes (BKR) Stock Trades Down, Here Is Why | StockStory | 2026-09-11 |
| Why Baker Hughes Stock Is Having Its Worst Day in More Than a Year | Barrons.com | 2026-09-10 |
| C3.ai vs. Atlassian: Which Technology Stock Is a Better Buy in 2026? | Motley Fool | 2026-09-10 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $59.06; 52w high $69.18 (-14.63%); 52w low $43.79 (+34.89%) |
| Trend | +1.10% vs SMA200, -2.11% vs SMA50, -6.19% vs SMA20 |
| Momentum | RSI(14) 35.9 (neutral) |
| Volatility | ATR(14) 1.95 (~3.3% of price); beta 0.96 |
...
| Valuation | P/E 18.99, forward P/E 18.99, P/S 2.11, P/B 2.94 | EV/Sales 2.10, EV/EBITDA 12.06 |
| Growth expectations | Earnings growth -4.20%, EPS q/q -2.90% | Analyst mean target $72.09 (23 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 100.02% |
...
- **Volatility risk:** Beta 0.96, ATR 3.3% of price, short float 3.08%. Size positions accordingly.
...
|---|---|---|---|
| Price | $59.06 | EV/Sales | 2.10 |
| Market cap | $58.63B | EV/EBITDA | 12.06 |
| Beta | 0.96 | Gross margin | 23.66% |
| RSI(14) | 35.9 | Operating margin | 12.83% |
| ATR(14) | 1.95 | Profit margin | 11.17% |
| SMA20 dist | -6.19% | ROA | 4.85% |
| SMA50 dist | -2.11% | ROE | 16.46% |
| SMA200 dist | +1.10% | Revenue (ttm) | $27.73B |
| 52W high | $69.18 | Revenue growth y/y | -2.40% |
| 52W low | $43.79 | Inst. ownership | 100.02% |
| P/E (ttm) | 18.99 | Insider ownership | 0.15% |
| Forward P/E | 18.99 | Short float | 3.08% |
| PEG (trailing) | 1.66 | Avg volume | 8,343,943 |
| P/S | 2.11 | Employees | 54,000 |
| P/B | 2.94 | Analyst rec (1=buy..5=sell) | 1.7 |

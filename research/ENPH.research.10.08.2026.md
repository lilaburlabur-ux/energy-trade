...
Signed file: `ENPH.research.10.08.2026`

| Field | Value |
|---|---|
| Current price | $40.92 (2026-08-10, ~15-min delayed) |
| Market cap | $5.41B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +28.72%; price +1.96% vs SMA200. |
| Fresh setup quality | Poor / broken | -43.43% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 17.77, EV/Sales 3.92. |
| Risk level | High | Beta 1.65, ATR 7.0% of price, short float 20.87%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $40.92; 52w high $72.33 (-43.43%); 52w low $26.12 (+56.66%) |
| Trend | +1.96% vs SMA200, -13.21% vs SMA50, +3.19% vs SMA20 |
| Momentum | RSI(14) 48.7 (neutral) |
| Volatility | ATR(14) 2.87 (~7.0% of price); beta 1.65 |
| Setup perspective | -43.43% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 40.51, forward P/E 17.77, P/S 4.07, P/B 4.58 | EV/Sales 3.92, EV/EBITDA 27.16 |
...
- **Volatility risk:** Beta 1.65, ATR 7.0% of price, short float 20.87%. Size positions accordingly.
...
|---|---|---|---|
| Price | $40.92 | EV/Sales | 3.92 |
| Market cap | $5.41B | EV/EBITDA | 27.16 |
| Beta | 1.65 | Gross margin | 30.04% |
| RSI(14) | 48.7 | Operating margin | 17.98% |
| ATR(14) | 2.87 | Profit margin | 10.09% |
| SMA20 dist | +3.19% | ROA | 2.38% |
| SMA50 dist | -13.21% | ROE | 13.00% |
| SMA200 dist | +1.96% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 103.29% |
| P/E (ttm) | 40.51 | Insider ownership | 3.03% |
| Forward P/E | 17.77 | Short float | 20.87% |
| PEG (trailing) | 1.21 | Avg volume | 7,313,682 |
| P/S | 4.07 | Employees | 2,872 |
| P/B | 4.58 | Analyst rec (1=buy..5=sell) | 2.5 |

...
Signed file: `SHEL.research.03.08.2026`

| Field | Value |
|---|---|
| Current price | $91.08 (2026-08-03, ~15-min delayed) |
| Market cap | $252.00B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +30.98%; price +13.56% vs SMA200. |
| Fresh setup quality | Moderate / wait | -2.38% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 8.76%, revenue growth 44.70%. |
| Value attractiveness | Reasonable | Forward P/E 10.31, EV/Sales 1.01. |
| Risk level | Moderate | Beta -0.22, ATR 1.8% of price, short float 1.82%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $91.08; 52w high $93.30 (-2.38%); 52w low $68.73 (+32.52%) |
| Trend | +13.56% vs SMA200, +8.52% vs SMA50, +5.58% vs SMA20 |
| Momentum | RSI(14) 67.9 (neutral) |
| Volatility | ATR(14) 1.63 (~1.8% of price); beta -0.22 |
| Setup perspective | -2.38% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 10.08, forward P/E 10.31, P/S 0.85, P/B 1.48 | EV/Sales 1.01, EV/EBITDA 5.19 |
| Growth expectations | Earnings growth 220.00%, EPS q/q 200.50% | Analyst mean target $97.97 (15 analysts) |
...
|---|---|---|---|
| Price | $91.08 | EV/Sales | 1.01 |
| Market cap | $252.00B | EV/EBITDA | 5.19 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 67.9 | Operating margin | 16.69% |
| ATR(14) | 1.63 | Profit margin | 8.76% |
| SMA20 dist | +5.58% | ROA | 6.40% |
| SMA50 dist | +8.52% | ROE | 14.34% |
| SMA200 dist | +13.56% | Revenue (ttm) | $296.60B |
| 52W high | $93.30 | Revenue growth y/y | 44.70% |
| 52W low | $68.73 | Inst. ownership | 13.82% |
| P/E (ttm) | 10.08 | Insider ownership | 0.00% |
| Forward P/E | 10.31 | Short float | 1.82% |
| PEG (trailing) | 1.34 | Avg volume | 7,011,095 |

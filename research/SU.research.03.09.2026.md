...
Signed file: `SU.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $68.24 (2026-09-03, ~15-min delayed) |
| Market cap | $79.82B |
...
|---|---|---|
| Technical momentum | High | 1Y +70.38%; price +18.52% vs SMA200. |
| Fresh setup quality | Watch | -1.49% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Strong | Profit margin 15.78%, revenue growth 45.90%. |
| Value attractiveness | Reasonable | Forward P/E 11.90, EV/Sales 1.58. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $68.24; 52w high $69.27 (-1.49%); 52w low $37.63 (+81.36%) |
| Trend | +18.52% vs SMA200, +8.45% vs SMA50, +3.23% vs SMA20 |
| Momentum | RSI(14) 59.6 (neutral) |
| Volatility | ATR(14) 1.66 (~2.4% of price); beta 0.57 |
| Setup perspective | -1.49% from 52w high and near SMA20 — check for a tight base. |
...
|---|---|---|---|
| Price | $68.24 | EV/Sales | 1.58 |
| Market cap | $79.82B | EV/EBITDA | 4.58 |
| Beta | 0.57 | Gross margin | 60.40% |
| RSI(14) | 59.6 | Operating margin | 29.94% |
| ATR(14) | 1.66 | Profit margin | 15.78% |
| SMA20 dist | +3.23% | ROA | 8.58% |
| SMA50 dist | +8.45% | ROE | 19.25% |
| SMA200 dist | +18.52% | Revenue (ttm) | $56.57B |

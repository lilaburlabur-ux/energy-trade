...
Signed file: `PWR.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $616.54 (2026-09-17, ~15-min delayed) |
| Market cap | $92.69B |
...
| Lennar Q3 Earnings Miss Estimates on Housing Weakness, Revenues Lag | Zacks | 2026-09-17 |
| Strong Operational Momentum Drives Quanta Services’ (PWR) Full-Year Outlook Upgrade | Insider Monkey | 2026-09-17 |
| Quanta Services Has A $53 Billion AI Power Backlog |  TheStreet | 2026-09-16 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $616.54; 52w high $785.12 (-21.47%); 52w low $375.69 (+64.11%) |
| Trend | +3.63% vs SMA200, -4.07% vs SMA50, -0.91% vs SMA20 |
| Momentum | RSI(14) 45.2 (neutral) |
| Volatility | ATR(14) 24.70 (~4.0% of price); beta 1.20 |
...
| SMA20 dist | -0.91% | ROA | 5.23% |
| SMA50 dist | -4.07% | ROE | 15.34% |
| SMA200 dist | +3.63% | Revenue (ttm) | $32.91B |
| 52W high | $785.12 | Revenue growth y/y | 41.10% |
| 52W low | $375.69 | Inst. ownership | 94.10% |
| P/E (ttm) | 70.62 | Insider ownership | 0.67% |
| Forward P/E | 31.27 | Short float | 2.38% |
| PEG (trailing) | 1.40 | Avg volume | 1,195,779 |
| P/S | 2.82 | Employees | 69,500 |
| P/B | 9.61 | Analyst rec (1=buy..5=sell) | 1.5 |

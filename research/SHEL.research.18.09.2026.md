...
Signed file: `SHEL.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $94.54 (2026-09-18, ~15-min delayed) |
| Market cap | $270.07B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +37.32%; price +14.07% vs SMA200. |
| Fresh setup quality | Watch | -4.46% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 8.76%, revenue growth 44.70%. |
| Value attractiveness | Reasonable | Forward P/E 9.13, EV/Sales 1.04. |
...
| Update: Market Chatter: Saudi Aramco May Cut Crude Oil Supply to European Refiners After Pipeline Attacks | MT Newswires | 2026-09-18 |
| Market Chatter: Saudi Aramco May Cut Crude Oil Supply to European Refiners After Pipeline Attacks | MT Newswires | 2026-09-18 |
| Shell Warns 36 Million Lost LNG Tons Are Exhausting Market Buffers | GuruFocus.com | 2026-09-17 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $94.54; 52w high $98.95 (-4.46%); 52w low $68.25 (+38.52%) |
| Trend | +14.07% vs SMA200, +4.66% vs SMA50, +0.61% vs SMA20 |
| Momentum | RSI(14) 54.6 (neutral) |
| Volatility | ATR(14) 1.63 (~1.7% of price); beta -0.22 |
| Setup perspective | -4.46% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 10.46, forward P/E 9.13, P/S 0.91, P/B 1.46 | EV/Sales 1.04, EV/EBITDA 5.38 |
...
|---|---|---|---|
| Price | $94.54 | EV/Sales | 1.04 |
| Market cap | $270.07B | EV/EBITDA | 5.38 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 54.6 | Operating margin | 16.69% |
| ATR(14) | 1.63 | Profit margin | 8.76% |
| SMA20 dist | +0.61% | ROA | 6.40% |
| SMA50 dist | +4.66% | ROE | 14.34% |
| SMA200 dist | +14.07% | Revenue (ttm) | $296.60B |
| 52W high | $98.95 | Revenue growth y/y | 44.70% |
| 52W low | $68.25 | Inst. ownership | 13.36% |
| P/E (ttm) | 10.46 | Insider ownership | 0.01% |
| Forward P/E | 9.13 | Short float | 1.54% |
| PEG (trailing) | 1.62 | Avg volume | 6,345,345 |

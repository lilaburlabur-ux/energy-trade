...
Signed file: `EOSE.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $3.99 (2026-09-10, ~15-min delayed) |
| Market cap | $1.45B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-51.55%) with negative half-year (-38.14%). |
| Fresh setup quality | Poor / broken | -79.21% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-246.76%). |
| Value attractiveness | Reasonable | Forward P/E -26.68, EV/Sales 11.95. |
| Risk level | High | Beta 2.78, ATR 8.9% of price, short float 31.27%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $3.99; 52w high $19.19 (-79.21%); 52w low $3.04 (+31.25%) |
| Trend | -51.55% vs SMA200, +0.87% vs SMA50, +8.57% vs SMA20 |
| Momentum | RSI(14) 52.6 (neutral) |
| Volatility | ATR(14) 0.36 (~8.9% of price); beta 2.78 |
| Setup perspective | -79.21% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -26.68, P/S 6.78, P/B -1.32 | EV/Sales 11.95, EV/EBITDA -9.00 |
...
- **Volatility risk:** Beta 2.78, ATR 8.9% of price, short float 31.27%. Size positions accordingly.
...
|---|---|---|---|
| Price | $3.99 | EV/Sales | 11.95 |
| Market cap | $1.45B | EV/EBITDA | -9.00 |
| Beta | 2.78 | Gross margin | -84.75% |
| RSI(14) | 52.6 | Operating margin | -121.86% |
| ATR(14) | 0.36 | Profit margin | -246.76% |
| SMA20 dist | +8.57% | ROA | -30.03% |
| SMA50 dist | +0.87% | ROE | — |
| SMA200 dist | -51.55% | Revenue (ttm) | $214.25M |
| 52W high | $19.19 | Revenue growth y/y | 351.40% |
| 52W low | $3.04 | Inst. ownership | 64.43% |
| P/E (ttm) | — | Insider ownership | 1.43% |
| Forward P/E | -26.68 | Short float | 31.27% |
| PEG (trailing) | — | Avg volume | 26,467,795 |
| P/S | 6.78 | Employees | 787 |
| P/B | -1.32 | Analyst rec (1=buy..5=sell) | 2.4 |

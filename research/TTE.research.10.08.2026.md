...
Signed file: `TTE.research.10.08.2026`

| Field | Value |
|---|---|
| Current price | $87.96 (2026-08-10, ~15-min delayed) |
| Market cap | $195.17B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +50.90%; price +13.63% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.03% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.08%, revenue growth 27.80%. |
| Value attractiveness | Reasonable | Forward P/E 9.12, EV/Sales 1.14. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $87.96; 52w high $93.60 (-6.03%); 52w low $55.92 (+57.29%) |
| Trend | +13.63% vs SMA200, +5.48% vs SMA50, +4.04% vs SMA20 |
| Momentum | RSI(14) 61.1 (neutral) |
| Volatility | ATR(14) 1.81 (~2.1% of price); beta 0.06 |
| Setup perspective | -6.03% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 11.01, forward P/E 9.12, P/S 0.99, P/B 1.52 | EV/Sales 1.14, EV/EBITDA 5.67 |
...
|---|---|---|---|
| Price | $87.96 | EV/Sales | 1.14 |
| Market cap | $195.17B | EV/EBITDA | 5.67 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 61.1 | Operating margin | 12.79% |
| ATR(14) | 1.81 | Profit margin | 9.08% |
| SMA20 dist | +4.04% | ROA | 5.51% |
| SMA50 dist | +5.48% | ROE | 14.48% |
| SMA200 dist | +13.63% | Revenue (ttm) | $196.38B |
...
| PEG (trailing) | 0.70 | Avg volume | 1,534,391 |
| P/S | 0.99 | Employees | 94,847 |
| P/B | 1.52 | Analyst rec (1=buy..5=sell) | 2.1 |

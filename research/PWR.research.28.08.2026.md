...
Signed file: `PWR.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $621.83 (2026-08-28, ~15-min delayed) |
| Market cap | $93.49B |
...
|---|---|---|
| Technical momentum | High | 1Y +62.11%; price +6.75% vs SMA200. |
| Fresh setup quality | Moderate / wait | -20.80% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 4.03%, revenue growth 41.10%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 31.66, EV/Sales 3.03. |
| Risk level | Elevated | Beta 1.22, ATR 4.6% of price, short float 2.10%. |
...
|---|---|---|
| Is Quanta Becoming the Biggest Winner From America's AI Buildout? | Zacks | 2026-08-27 |
| Can Comfort Systems' 81% Electrical Growth Keep Outpacing Mechanical? | Zacks | 2026-08-27 |
| JPMorgan Strategist: The AI Rally Is Expanding Far Beyond the Magnificent Seven | 24/7 Wall St. | 2026-08-27 |
| How MasTec Is Building an End-to-End Infrastructure Platform | Zacks | 2026-08-26 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $621.83; 52w high $785.12 (-20.80%); 52w low $372.18 (+67.08%) |
| Trend | +6.75% vs SMA200, -6.38% vs SMA50, -6.41% vs SMA20 |
| Momentum | RSI(14) 42.3 (neutral) |
| Volatility | ATR(14) 28.39 (~4.6% of price); beta 1.22 |
| Setup perspective | -20.80% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 70.99, forward P/E 31.66, P/S 2.84, P/B 9.70 | EV/Sales 3.03, EV/EBITDA 32.74 |
...
- **Valuation risk:** Forward P/E 31.66, EV/Sales 3.03. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.22, ATR 4.6% of price, short float 2.10%. Size positions accordingly.
...
|---|---|---|---|
| Price | $621.83 | EV/Sales | 3.03 |
| Market cap | $93.49B | EV/EBITDA | 32.74 |
| Beta | 1.22 | Gross margin | 15.46% |
| RSI(14) | 42.3 | Operating margin | 7.22% |
| ATR(14) | 28.39 | Profit margin | 4.03% |
| SMA20 dist | -6.41% | ROA | 5.23% |
| SMA50 dist | -6.38% | ROE | 15.34% |
| SMA200 dist | +6.75% | Revenue (ttm) | $32.91B |
| 52W high | $785.12 | Revenue growth y/y | 41.10% |
| 52W low | $372.18 | Inst. ownership | 94.18% |
| P/E (ttm) | 70.99 | Insider ownership | 0.67% |
| Forward P/E | 31.66 | Short float | 2.10% |
| PEG (trailing) | 1.70 | Avg volume | 1,255,604 |
| P/S | 2.84 | Employees | 69,500 |
| P/B | 9.70 | Analyst rec (1=buy..5=sell) | 1.5 |

...
Signed file: `ETN.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $435.43 (2026-09-21, ~15-min delayed) |
| Market cap | $169.12B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $435.43; 52w high $459.96 (-5.33%); 52w low $313.20 (+39.03%) |
| Trend | +13.65% vs SMA200, +4.66% vs SMA50, +6.56% vs SMA20 |
| Momentum | RSI(14) 58.4 (neutral) |
| Volatility | ATR(14) 15.43 (~3.5% of price); beta 1.17 |
| Setup perspective | -5.33% from 52w high; no clean fresh pivot by default. |
...
| SMA50 dist | +4.66% | ROE | 19.68% |
| SMA200 dist | +13.65% | Revenue (ttm) | $30.03B |

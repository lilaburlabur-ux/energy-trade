...
Signed file: `KMI.research.17.09.2026`
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $31.31; 52w high $33.99 (-7.89%); 52w low $24.86 (+25.94%) |
| Trend | +1.64% vs SMA200, -1.18% vs SMA50, -0.28% vs SMA20 |
...
| SMA20 dist | -0.28% | ROA | 4.45% |
| SMA50 dist | -1.18% | ROE | 10.99% |
| SMA200 dist | +1.64% | Revenue (ttm) | $17.96B |

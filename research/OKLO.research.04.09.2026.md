...
Signed file: `OKLO.research.04.09.2026`

| Field | Value |
|---|---|
| Current price | $41.27 (2026-09-04, ~15-min delayed) |
| Market cap | $7.68B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-36.36%) with negative half-year (-29.15%). |
| Fresh setup quality | Poor / broken | -76.30% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -41.10, EV/Sales 4,090.85. |
| Risk level | High | Beta 1.20, ATR 7.0% of price, short float 15.86%. |
...
|---|---|---|
| Nuclear Stock Face-Off: Is NuScale Power or Oklo the Better Buy Right Now? | Motley Fool | 2026-09-04 |
| Our Pick Of The Best Nuclear Stocks In September 2026 | Simply Wall St. | 2026-09-04 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $41.27; 52w high $174.14 (-76.30%); 52w low $36.84 (+12.02%) |
| Trend | -36.36% vs SMA200, -6.36% vs SMA50, -2.59% vs SMA20 |
| Momentum | RSI(14) 47.4 (neutral) |
| Volatility | ATR(14) 2.89 (~7.0% of price); beta 1.20 |
| Setup perspective | -76.30% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -41.10, P/S 6,344.59, P/B 2.33 | EV/Sales 4,090.85, EV/EBITDA -22.83 |
...
- **Volatility risk:** Beta 1.20, ATR 7.0% of price, short float 15.86%. Size positions accordingly.
...
|---|---|---|---|
| Price | $41.27 | EV/Sales | 4,090.85 |
| Market cap | $7.68B | EV/EBITDA | -22.83 |
| Beta | 1.20 | Gross margin | 40.41% |
| RSI(14) | 47.4 | Operating margin | -6048.76% |
| ATR(14) | 2.89 | Profit margin | 0.00% |
| SMA20 dist | -2.59% | ROA | -6.65% |
| SMA50 dist | -6.36% | ROE | -7.70% |
| SMA200 dist | -36.36% | Revenue (ttm) | $1.21M |
| 52W high | $174.14 | Revenue growth y/y | — |
| 52W low | $36.84 | Inst. ownership | 47.49% |
| P/E (ttm) | — | Insider ownership | 15.38% |
| Forward P/E | -41.10 | Short float | 15.86% |
| PEG (trailing) | — | Avg volume | 9,700,595 |
| P/S | 6,344.59 | Employees | 215 |
| P/B | 2.33 | Analyst rec (1=buy..5=sell) | — |

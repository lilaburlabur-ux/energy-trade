...
Signed file: `EPD.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $38.90 (2026-09-11, ~15-min delayed) |
| Market cap | $84.00B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +30.87%; price +9.21% vs SMA200. |
| Fresh setup quality | Watch | -1.17% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.29, EV/Sales 2.05. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.90; 52w high $39.36 (-1.17%); 52w low $28.35 (+37.19%) |
| Trend | +9.21% vs SMA200, +2.10% vs SMA50, +0.19% vs SMA20 |
| Momentum | RSI(14) 53.5 (neutral) |
| Volatility | ATR(14) 0.55 (~1.4% of price); beta 0.48 |
| Setup perspective | -1.17% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.46, forward P/E 12.29, P/S 1.44, P/B 2.78 | EV/Sales 2.05, EV/EBITDA 11.62 |
...
|---|---|---|---|
| Price | $38.90 | EV/Sales | 2.05 |
| Market cap | $84.00B | EV/EBITDA | 11.62 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 53.5 | Operating margin | 11.76% |
| ATR(14) | 0.55 | Profit margin | 10.79% |
| SMA20 dist | +0.19% | ROA | 5.92% |
| SMA50 dist | +2.10% | ROE | 20.85% |
| SMA200 dist | +9.21% | Revenue (ttm) | $58.47B |
| 52W high | $39.36 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.64% |
| P/E (ttm) | 13.46 | Insider ownership | 33.04% |
| Forward P/E | 12.29 | Short float | 3.09% |
| PEG (trailing) | 1.39 | Avg volume | 2,960,424 |
| P/S | 1.44 | Employees | 0 |
| P/B | 2.78 | Analyst rec (1=buy..5=sell) | 2.3 |

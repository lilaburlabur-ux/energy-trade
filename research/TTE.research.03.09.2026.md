...
Signed file: `TTE.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $89.25 (2026-09-03, ~15-min delayed) |
| Market cap | $197.48B |
...
|---|---|---|
| Sintana Energy welcomes TotalEnergies' completed entry into PEL 83 | Proactive | 2026-09-03 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $89.25; 52w high $93.60 (-4.65%); 52w low $55.92 (+59.60%) |
| Trend | +11.70% vs SMA200, +5.75% vs SMA50, +0.87% vs SMA20 |
| Momentum | RSI(14) 56.5 (neutral) |
| Volatility | ATR(14) 1.67 (~1.9% of price); beta 0.06 |
...
|---|---|---|---|
| Price | $89.25 | EV/Sales | 1.19 |
| Market cap | $197.48B | EV/EBITDA | 5.91 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 56.5 | Operating margin | 12.79% |
| ATR(14) | 1.67 | Profit margin | 9.08% |
| SMA20 dist | +0.87% | ROA | 5.51% |
| SMA50 dist | +5.75% | ROE | 14.48% |
| SMA200 dist | +11.70% | Revenue (ttm) | $196.38B |

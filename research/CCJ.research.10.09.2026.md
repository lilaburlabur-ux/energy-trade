...
Signed file: `CCJ.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $97.42 (2026-09-10, ~15-min delayed) |
| Market cap | $42.43B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $97.42; 52w high $134.09 (-27.35%); 52w low $77.96 (+24.96%) |
| Trend | -7.75% vs SMA200, +2.34% vs SMA50, -2.66% vs SMA20 |
| Momentum | RSI(14) 47.5 (neutral) |
| Volatility | ATR(14) 3.82 (~3.9% of price); beta 1.01 |
...
| Growth expectations | Earnings growth -92.10%, EPS q/q -92.10% | Analyst mean target $130.99 (12 analysts) |
...
|---|---|---|---|
| Price | $97.42 | EV/Sales | 12.62 |
| Market cap | $42.43B | EV/EBITDA | 54.91 |
| Beta | 1.01 | Gross margin | 35.11% |
| RSI(14) | 47.5 | Operating margin | 9.11% |
| ATR(14) | 3.82 | Profit margin | 10.21% |
| SMA20 dist | -2.66% | ROA | 2.98% |
| SMA50 dist | +2.34% | ROE | 5.11% |
| SMA200 dist | -7.75% | Revenue (ttm) | $3.47B |

...
Signed file: `ENPH.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $40.77 (2026-08-12, ~15-min delayed) |
| Market cap | $5.37B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +25.18%; price +1.44% vs SMA200. |
| Fresh setup quality | Poor / broken | -43.63% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 17.71, EV/Sales 3.96. |
| Risk level | High | Beta 1.65, ATR 6.8% of price, short float 20.98%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $40.77; 52w high $72.33 (-43.63%); 52w low $26.12 (+56.09%) |
| Trend | +1.44% vs SMA200, -11.69% vs SMA50, +3.59% vs SMA20 |
| Momentum | RSI(14) 48.3 (neutral) |
| Volatility | ATR(14) 2.76 (~6.8% of price); beta 1.65 |
| Setup perspective | -43.63% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 40.37, forward P/E 17.71, P/S 4.04, P/B 4.56 | EV/Sales 3.96, EV/EBITDA 27.45 |
...
- **Volatility risk:** Beta 1.65, ATR 6.8% of price, short float 20.98%. Size positions accordingly.
...
|---|---|---|---|
| Price | $40.77 | EV/Sales | 3.96 |
| Market cap | $5.37B | EV/EBITDA | 27.45 |
| Beta | 1.65 | Gross margin | 30.04% |
| RSI(14) | 48.3 | Operating margin | 17.98% |
| ATR(14) | 2.76 | Profit margin | 10.09% |
| SMA20 dist | +3.59% | ROA | 2.38% |
| SMA50 dist | -11.69% | ROE | 13.00% |
| SMA200 dist | +1.44% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 104.70% |
| P/E (ttm) | 40.37 | Insider ownership | 3.03% |
| Forward P/E | 17.71 | Short float | 20.98% |
| PEG (trailing) | 1.18 | Avg volume | 7,215,900 |
| P/S | 4.04 | Employees | 2,872 |

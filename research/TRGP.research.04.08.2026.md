...
Signed file: `TRGP.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $262.98 (2026-08-04, ~15-min delayed) |
| Market cap | $56.45B |
...
|---|---|---|
| Technical momentum | High | 1Y +64.89%; price +18.66% vs SMA200. |
| Fresh setup quality | Moderate / wait | -7.48% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 12.87%, revenue growth -10.20%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 22.03, EV/Sales 4.59. |
...
|---|---|---|
| ONEOK Q2 Earnings & Sales Surpass Estimates on Record NGL Volumes | Zacks | 2026-08-04 |
| Gear Up for Targa Resources (TRGP) Q2 Earnings: Wall Street Estimates for Key Metrics | Zacks | 2026-08-04 |
| Targa Resources Corp's Dividend Analysis | GuruFocus.com | 2026-07-31 |
| APA Corp Gears Up to Report Q2 Earnings: Here's How It Will Fare | Zacks | 2026-07-30 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $262.98; 52w high $284.25 (-7.48%); 52w low $143.22 (+83.62%) |
| Trend | +18.66% vs SMA200, -1.94% vs SMA50, -4.00% vs SMA20 |
| Momentum | RSI(14) 43.2 (neutral) |
| Volatility | ATR(14) 7.51 (~2.9% of price); beta 0.72 |
| Setup perspective | -7.48% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.86, forward P/E 22.03, P/S 3.41, P/B 18.00 | EV/Sales 4.59, EV/EBITDA 14.56 |
| Growth expectations | Earnings growth 142.90%, EPS q/q 77.30% | Analyst mean target $297.29 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 97.41% |
...
- **Valuation risk:** Forward P/E 22.03, EV/Sales 4.59. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $262.98 | EV/Sales | 4.59 |
| Market cap | $56.45B | EV/EBITDA | 14.56 |
| Beta | 0.72 | Gross margin | 41.77% |
| RSI(14) | 43.2 | Operating margin | 20.90% |
| ATR(14) | 7.51 | Profit margin | 12.87% |
| SMA20 dist | -4.00% | ROA | 9.13% |
| SMA50 dist | -1.94% | ROE | 74.10% |
| SMA200 dist | +18.66% | Revenue (ttm) | $16.56B |
| 52W high | $284.25 | Revenue growth y/y | -10.20% |
| 52W low | $143.22 | Inst. ownership | 97.41% |
| P/E (ttm) | 26.86 | Insider ownership | 1.38% |
| Forward P/E | 22.03 | Short float | 2.27% |
| PEG (trailing) | — | Avg volume | 1,227,854 |
| P/S | 3.41 | Employees | 3,570 |
| P/B | 18.00 | Analyst rec (1=buy..5=sell) | 1.5 |

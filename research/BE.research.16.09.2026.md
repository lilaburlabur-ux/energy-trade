...
Signed file: `BE.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $270.02 (2026-09-16, ~15-min delayed) |
| Market cap | $79.53B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $270.02; 52w high $345.85 (-21.93%); 52w low $68.69 (+293.10%) |
| Trend | +36.96% vs SMA200, +20.15% vs SMA50, +15.60% vs SMA20 |
| Momentum | RSI(14) 61.0 (neutral) |
| Volatility | ATR(14) 18.94 (~7.0% of price); beta 3.81 |
| Setup perspective | -21.93% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | +15.60% | ROA | 5.60% |
| SMA50 dist | +20.15% | ROE | 22.21% |
| SMA200 dist | +36.96% | Revenue (ttm) | $3.11B |
| 52W high | $345.85 | Revenue growth y/y | 165.50% |
| 52W low | $68.69 | Inst. ownership | 86.07% |
| P/E (ttm) | 346.18 | Insider ownership | 5.54% |
| Forward P/E | 54.79 | Short float | 7.43% |
| PEG (trailing) | 0.59 | Avg volume | 15,281,803 |
| P/S | 25.55 | Employees | 2,214 |
| P/B | 49.14 | Analyst rec (1=buy..5=sell) | 2.2 |

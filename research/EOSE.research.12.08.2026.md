...
Signed file: `EOSE.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $4.24 (2026-08-12, ~15-min delayed) |
| Market cap | $1.54B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-54.87%) with negative half-year (-65.30%). |
| Fresh setup quality | Poor / broken | -77.91% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-246.76%). |
| Value attractiveness | Reasonable | Forward P/E -28.35, EV/Sales 12.10. |
| Risk level | High | Beta 2.80, ATR 10.7% of price, short float 32.31%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.24; 52w high $19.19 (-77.91%); 52w low $3.14 (+35.03%) |
| Trend | -54.87% vs SMA200, -18.67% vs SMA50, +9.83% vs SMA20 |
| Momentum | RSI(14) 48.9 (neutral) |
| Volatility | ATR(14) 0.45 (~10.7% of price); beta 2.80 |
| Setup perspective | -77.91% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -28.35, P/S 7.21, P/B -1.66 | EV/Sales 12.10, EV/EBITDA -9.11 |
...
- **Volatility risk:** Beta 2.80, ATR 10.7% of price, short float 32.31%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.24 | EV/Sales | 12.10 |
| Market cap | $1.54B | EV/EBITDA | -9.11 |
| Beta | 2.80 | Gross margin | -84.75% |
| RSI(14) | 48.9 | Operating margin | -121.86% |
| ATR(14) | 0.45 | Profit margin | -246.76% |
| SMA20 dist | +9.83% | ROA | -30.03% |
| SMA50 dist | -18.67% | ROE | — |
| SMA200 dist | -54.87% | Revenue (ttm) | $214.25M |
| 52W high | $19.19 | Revenue growth y/y | 351.40% |
| 52W low | $3.14 | Inst. ownership | 59.92% |
| P/E (ttm) | — | Insider ownership | 1.43% |
| Forward P/E | -28.35 | Short float | 32.31% |
| PEG (trailing) | — | Avg volume | 27,899,401 |
| P/S | 7.21 | Employees | 787 |
| P/B | -1.66 | Analyst rec (1=buy..5=sell) | 2.4 |

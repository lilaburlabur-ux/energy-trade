...
Signed file: `MPLX.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $58.62 (2026-09-17, ~15-min delayed) |
| Market cap | $59.48B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +24.10%; price +6.62% vs SMA200. |
| Fresh setup quality | Watch | -2.67% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Strong | Profit margin 39.28%, revenue growth 10.60%. |
| Value attractiveness | Reasonable | Forward P/E 12.15, EV/Sales 7.04. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $58.62; 52w high $60.23 (-2.67%); 52w low $44.22 (+32.57%) |
| Trend | +6.62% vs SMA200, +0.81% vs SMA50, -0.78% vs SMA20 |
| Momentum | RSI(14) 48.2 (neutral) |
| Volatility | ATR(14) 0.98 (~1.7% of price); beta 0.46 |
| Setup perspective | -2.67% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 12.61, forward P/E 12.15, P/S 4.94, P/B 4.24 | EV/Sales 7.04, EV/EBITDA 13.87 |
...
|---|---|---|---|
| Price | $58.62 | EV/Sales | 7.04 |
| Market cap | $59.48B | EV/EBITDA | 13.87 |
| Beta | 0.46 | Gross margin | 55.71% |
| RSI(14) | 48.2 | Operating margin | 38.25% |
| ATR(14) | 0.98 | Profit margin | 39.28% |
| SMA20 dist | -0.78% | ROA | 7.25% |
| SMA50 dist | +0.81% | ROE | 33.69% |
| SMA200 dist | +6.62% | Revenue (ttm) | $12.03B |
| 52W high | $60.23 | Revenue growth y/y | 10.60% |
| 52W low | $44.22 | Inst. ownership | 19.71% |
| P/E (ttm) | 12.61 | Insider ownership | 64.03% |
| Forward P/E | 12.15 | Short float | 2.01% |
| PEG (trailing) | 3.04 | Avg volume | 1,386,846 |
| P/S | 4.94 | Employees | 0 |
| P/B | 4.24 | Analyst rec (1=buy..5=sell) | 2.4 |

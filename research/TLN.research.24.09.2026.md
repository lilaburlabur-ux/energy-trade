...
Signed file: `TLN.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $300.01 (2026-09-24, ~15-min delayed) |
| Market cap | $14.37B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-15.12%) with negative half-year (-4.99%). |
| Fresh setup quality | Poor / broken | -32.71% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-4.95%). |
| Value attractiveness | Reasonable | Forward P/E 9.75, EV/Sales 6.35. |
| Risk level | Elevated | Beta 1.63, ATR 4.6% of price, short float 5.69%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $300.01; 52w high $445.84 (-32.71%); 52w low $282.15 (+6.33%) |
| Trend | -15.12% vs SMA200, -8.54% vs SMA50, -0.54% vs SMA20 |
| Momentum | RSI(14) 44.2 (neutral) |
| Volatility | ATR(14) 13.91 (~4.6% of price); beta 1.63 |
| Setup perspective | -32.71% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 1.63, ATR 4.6% of price, short float 5.69%. Size positions accordingly.
...
| SMA20 dist | -0.54% | ROA | 0.92% |
| SMA50 dist | -8.54% | ROE | -12.83% |
| SMA200 dist | -15.12% | Revenue (ttm) | $3.74B |
...
| PEG (trailing) | — | Avg volume | 805,219 |

...
Signed file: `BP.research.07.08.2026`

| Field | Value |
|---|---|
| Current price | $42.23 (2026-08-07, ~15-min delayed) |
| Market cap | $108.76B |
...
| Sector Update: Energy Stocks Gain Thursday Afternoon | MT Newswires | 2026-08-06 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $42.23; 52w high $47.09 (-10.32%); 52w low $31.56 (+33.82%) |
| Trend | +7.18% vs SMA200, +2.46% vs SMA50, -0.45% vs SMA20 |
| Momentum | RSI(14) 50.9 (neutral) |
| Volatility | ATR(14) 1.18 (~2.8% of price); beta -0.21 |
...
| SMA20 dist | -0.45% | ROA | 5.04% |
| SMA50 dist | +2.46% | ROE | 8.87% |
| SMA200 dist | +7.18% | Revenue (ttm) | $215.47B |
| 52W high | $47.09 | Revenue growth y/y | 48.20% |
| 52W low | $31.56 | Inst. ownership | 13.83% |
| P/E (ttm) | 20.21 | Insider ownership | 0.00% |

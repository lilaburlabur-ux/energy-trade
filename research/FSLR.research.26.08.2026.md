...
Signed file: `FSLR.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $205.93 (2026-08-26, ~15-min delayed) |
| Market cap | $22.13B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-11.47%) with negative half-year (-1.99%). |
| Fresh setup quality | Poor / broken | -35.29% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 32.46%, revenue growth -3.70%. |
| Value attractiveness | Reasonable | Forward P/E 8.91, EV/Sales 3.85. |
| Risk level | High | Beta 1.75, ATR 5.3% of price, short float 11.86%. |
...
| 2 Industrials Stocks on Our Buy List and 1 We Ignore | StockStory | 2026-08-26 |
| Sustainable Development ETF (SDG) Touches New 52-Week High | Zacks | 2026-08-21 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $205.93; 52w high $318.25 (-35.29%); 52w low $184.70 (+11.49%) |
| Trend | -11.47% vs SMA200, -8.95% vs SMA50, -8.28% vs SMA20 |
| Momentum | RSI(14) 38.3 (neutral) |
| Volatility | ATR(14) 10.82 (~5.3% of price); beta 1.75 |
| Setup perspective | -35.29% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 12.70, forward P/E 8.91, P/S 4.12, P/B 2.14 | EV/Sales 3.85, EV/EBITDA 8.67 |
...
- **Volatility risk:** Beta 1.75, ATR 5.3% of price, short float 11.86%. Size positions accordingly.
...
|---|---|---|---|
| Price | $205.93 | EV/Sales | 3.85 |
| Market cap | $22.13B | EV/EBITDA | 8.67 |
| Beta | 1.75 | Gross margin | 44.02% |
| RSI(14) | 38.3 | Operating margin | 42.64% |
| ATR(14) | 10.82 | Profit margin | 32.46% |
| SMA20 dist | -8.28% | ROA | 8.62% |
| SMA50 dist | -8.95% | ROE | 18.51% |
| SMA200 dist | -11.47% | Revenue (ttm) | $5.38B |
| 52W high | $318.25 | Revenue growth y/y | -3.70% |
| 52W low | $184.70 | Inst. ownership | 96.88% |
| P/E (ttm) | 12.70 | Insider ownership | 5.36% |
| Forward P/E | 8.91 | Short float | 11.86% |
| PEG (trailing) | 0.56 | Avg volume | 2,370,820 |
| P/S | 4.12 | Employees | 7,900 |
| P/B | 2.14 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `DVN.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $44.05 (2026-08-04, ~15-min delayed) |
| Market cap | — |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +40.62%; price +6.00% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 8.41, EV/Sales 2.16. |
| Risk level | Moderate | Beta 0.42, ATR 3.0% of price, short float 2.86%. |
...
|---|---|---|
| Devon Energy (NYSE:DVN) Reports Strong Q2 CY2026 | StockStory | 2026-08-04 |
...
| CNX Resources Q2 Earnings Surpass Estimates, Production Falls Y/Y | Zacks | 2026-07-31 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $44.05; 52w high $51.70 (-14.80%); 52w low $31.13 (+41.50%) |
| Trend | +6.00% vs SMA200, +0.90% vs SMA50, +0.60% vs SMA20 |
| Momentum | RSI(14) 51.2 (neutral) |
| Volatility | ATR(14) 1.32 (~3.0% of price); beta 0.42 |
...
| Valuation | P/E 12.27, forward P/E 8.41, P/S —, P/B 1.77 | EV/Sales 2.16, EV/EBITDA 5.15 |
...
|---|---|---|---|
| Price | $44.05 | EV/Sales | 2.16 |
| Market cap | — | EV/EBITDA | 5.15 |
| Beta | 0.42 | Gross margin | 46.93% |
| RSI(14) | 51.2 | Operating margin | 6.86% |
| ATR(14) | 1.32 | Profit margin | 14.17% |
| SMA20 dist | +0.60% | ROA | 6.07% |
| SMA50 dist | +0.90% | ROE | 15.18% |
| SMA200 dist | +6.00% | Revenue (ttm) | $16.00B |
| 52W high | $51.70 | Revenue growth y/y | -0.80% |
| 52W low | $31.13 | Inst. ownership | 51.52% |
| P/E (ttm) | 12.27 | Insider ownership | 0.67% |
| Forward P/E | 8.41 | Short float | 2.86% |
| PEG (trailing) | 2.92 | Avg volume | 14,201,721 |
| P/S | — | Employees | 2,200 |
| P/B | 1.77 | Analyst rec (1=buy..5=sell) | 1.3 |
...
| 2026-06-10 | main | UBS | Buy → Buy |

## 9. Conclusion
DVN: Moderate momentum / mixed fundamentals / reasonable value / moderate risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

...
Signed file: `WMB.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $74.05 (2026-09-03, ~15-min delayed) |
| Market cap | $90.58B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +32.34%; price +6.56% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 28.47, EV/Sales 10.12. |
| Risk level | Moderate | Beta 0.61, ATR 2.7% of price, short float 2.22%. |
...
| OKE Plans to Expand Permian Presence With Brazos Midland Acquisition | Zacks | 2026-08-31 |
| Rising Permian Volumes and Expansions Support EPD's Growth Outlook | Zacks | 2026-08-31 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $74.05; 52w high $78.82 (-6.05%); 52w low $55.10 (+34.39%) |
| Trend | +6.56% vs SMA200, +0.83% vs SMA50, +1.14% vs SMA20 |
| Momentum | RSI(14) 52.7 (neutral) |
| Volatility | ATR(14) 2.03 (~2.7% of price); beta 0.61 |
...
| Valuation | P/E 29.50, forward P/E 28.47, P/S 7.35, P/B 6.88 | EV/Sales 10.12, EV/EBITDA 17.74 |
| Growth expectations | Earnings growth 51.20%, EPS q/q 51.50% | Analyst mean target $85.37 (19 analysts) |
...
- **Valuation risk:** Forward P/E 28.47, EV/Sales 10.12. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $74.05 | EV/Sales | 10.12 |
| Market cap | $90.58B | EV/EBITDA | 17.74 |
| Beta | 0.61 | Gross margin | 63.64% |
| RSI(14) | 52.7 | Operating margin | 39.54% |
| ATR(14) | 2.03 | Profit margin | 24.94% |
| SMA20 dist | +1.14% | ROA | 5.03% |
| SMA50 dist | +0.83% | ROE | 21.50% |
| SMA200 dist | +6.56% | Revenue (ttm) | $12.32B |
| 52W high | $78.82 | Revenue growth y/y | 7.80% |
| 52W low | $55.10 | Inst. ownership | 91.43% |
| P/E (ttm) | 29.50 | Insider ownership | 0.45% |
| Forward P/E | 28.47 | Short float | 2.22% |
| PEG (trailing) | 2.17 | Avg volume | 7,128,833 |
| P/S | 7.35 | Employees | 5,987 |
| P/B | 6.88 | Analyst rec (1=buy..5=sell) | 1.5 |

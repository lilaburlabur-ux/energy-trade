...
Signed file: `DUK.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $117.53 (2026-09-18, ~15-min delayed) |
| Market cap | $91.64B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-3.91%) with negative half-year (-7.82%). |
| Fresh setup quality | Moderate / wait | -10.39% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 16.00%, revenue growth 1.10%. |
| Value attractiveness | Reasonable | Forward P/E 16.39, EV/Sales 5.70. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $117.53; 52w high $131.16 (-10.39%); 52w low $111.09 (+5.80%) |
| Trend | -3.91% vs SMA200, -4.23% vs SMA50, -2.06% vs SMA20 |
| Momentum | RSI(14) 35.8 (neutral) |
| Volatility | ATR(14) 1.72 (~1.5% of price); beta 0.36 |
| Setup perspective | -10.39% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 17.70, forward P/E 16.39, P/S 2.79, P/B 1.70 | EV/Sales 5.70, EV/EBITDA 11.26 |
...
|---|---|---|---|
| Price | $117.53 | EV/Sales | 5.70 |
| Market cap | $91.64B | EV/EBITDA | 11.26 |
| Beta | 0.36 | Gross margin | 51.97% |
| RSI(14) | 35.8 | Operating margin | 27.50% |
| ATR(14) | 1.72 | Profit margin | 16.00% |
| SMA20 dist | -2.06% | ROA | 2.84% |
| SMA50 dist | -4.23% | ROE | 9.86% |
| SMA200 dist | -3.91% | Revenue (ttm) | $32.80B |
| 52W high | $131.16 | Revenue growth y/y | 1.10% |
| 52W low | $111.09 | Inst. ownership | 71.14% |
| P/E (ttm) | 17.70 | Insider ownership | 0.13% |
| Forward P/E | 16.39 | Short float | 2.44% |
| PEG (trailing) | 2.22 | Avg volume | 4,002,754 |
| P/S | 2.79 | Employees | 26,441 |
| P/B | 1.70 | Analyst rec (1=buy..5=sell) | — |

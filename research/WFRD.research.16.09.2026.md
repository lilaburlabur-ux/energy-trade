...
Signed file: `WFRD.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $82.30 (2026-09-16, ~15-min delayed) |
| Market cap | $5.89B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $82.30; 52w high $111.07 (-25.90%); 52w low $60.73 (+35.53%) |
| Trend | -10.99% vs SMA200, -6.83% vs SMA50, -9.79% vs SMA20 |
| Momentum | RSI(14) 35.2 (neutral) |
| Volatility | ATR(14) 3.86 (~4.7% of price); beta 0.90 |
| Setup perspective | -25.90% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 0.90, ATR 4.7% of price, short float 6.87%. Size positions accordingly.
...
| SMA20 dist | -9.79% | ROA | 7.90% |
| SMA50 dist | -6.83% | ROE | 22.79% |
| SMA200 dist | -10.99% | Revenue (ttm) | $4.78B |
| 52W high | $111.07 | Revenue growth y/y | -8.20% |
| 52W low | $60.73 | Inst. ownership | 106.62% |
| P/E (ttm) | 16.23 | Insider ownership | 2.12% |
| Forward P/E | 11.66 | Short float | 6.87% |
| PEG (trailing) | 1.30 | Avg volume | 1,256,856 |

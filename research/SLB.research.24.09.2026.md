...
Signed file: `SLB.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $51.43 (2026-09-24, ~15-min delayed) |
| Market cap | $76.33B |
...
| SLB Wins Oman Contract, Strengthening Its Middle East Growth Story | Zacks | 2026-09-24 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $51.43; 52w high $59.79 (-13.98%); 52w low $30.96 (+66.10%) |
| Trend | +3.58% vs SMA200, -1.66% vs SMA50, -6.41% vs SMA20 |
| Momentum | RSI(14) 40.9 (neutral) |
| Volatility | ATR(14) 1.79 (~3.5% of price); beta 0.77 |
...
| SMA20 dist | -6.41% | ROA | 6.17% |
| SMA50 dist | -1.66% | ROE | 12.91% |
| SMA200 dist | +3.58% | Revenue (ttm) | $36.37B |
| 52W high | $59.79 | Revenue growth y/y | 5.00% |
| 52W low | $30.96 | Inst. ownership | 92.53% |
| P/E (ttm) | 25.09 | Insider ownership | 0.22% |
| Forward P/E | 15.90 | Short float | 4.25% |
| PEG (trailing) | 1.37 | Avg volume | 12,725,514 |

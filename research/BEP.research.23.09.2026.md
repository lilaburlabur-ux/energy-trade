...
Signed file: `BEP.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $29.08 (2026-09-23, ~15-min delayed) |
| Market cap | $14.15B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-7.00%) with negative half-year (-2.85%). |
| Fresh setup quality | Moderate / wait | -20.62% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Weak | Negative profit margin (-1.26%). |
| Value attractiveness | Reasonable | Forward P/E -15.56, EV/Sales 12.82. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $29.08; 52w high $36.63 (-20.62%); 52w low $24.35 (+19.43%) |
| Trend | -7.00% vs SMA200, -8.53% vs SMA50, -5.31% vs SMA20 |
| Momentum | RSI(14) 35.0 (neutral) |
| Volatility | ATR(14) 0.85 (~2.9% of price); beta 0.98 |
| Setup perspective | -20.62% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E -15.56, P/S 2.22, P/B 2.33 | EV/Sales 12.82, EV/EBITDA 27.17 |
...
|---|---|---|---|
| Price | $29.08 | EV/Sales | 12.82 |
| Market cap | $14.15B | EV/EBITDA | 27.17 |
| Beta | 0.98 | Gross margin | 51.39% |
| RSI(14) | 35.0 | Operating margin | 17.08% |
| ATR(14) | 0.85 | Profit margin | -1.26% |
| SMA20 dist | -5.31% | ROA | 0.42% |
| SMA50 dist | -8.53% | ROE | 0.40% |
| SMA200 dist | -7.00% | Revenue (ttm) | $6.36B |
...
| PEG (trailing) | — | Avg volume | 949,203 |
| P/S | 2.22 | Employees | 5,870 |

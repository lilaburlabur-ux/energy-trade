...
Signed file: `APA.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $42.74 (2026-09-25, ~15-min delayed) |
| Market cap | $14.97B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $42.74; 52w high $47.41 (-9.85%); 52w low $21.16 (+101.94%) |
| Trend | +23.46% vs SMA200, +4.57% vs SMA50, -3.20% vs SMA20 |
| Momentum | RSI(14) 48.5 (neutral) |
| Volatility | ATR(14) 1.54 (~3.6% of price); beta 0.37 |
...
- **Volatility risk:** Beta 0.37, ATR 3.6% of price, short float 9.21%. Size positions accordingly.
...
| SMA20 dist | -3.20% | ROA | 11.60% |
| SMA50 dist | +4.57% | ROE | 26.66% |
| SMA200 dist | +23.46% | Revenue (ttm) | $8.57B |
...
| PEG (trailing) | 1.18 | Avg volume | 5,611,239 |
| P/S | 1.75 | Employees | 1,791 |
| P/B | 2.13 | Analyst rec (1=buy..5=sell) | 2.6 |

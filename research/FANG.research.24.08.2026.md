...
Signed file: `FANG.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $205.60 (2026-08-24, ~15-min delayed) |
| Market cap | $57.84B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +52.57%; price +16.55% vs SMA200. |
| Fresh setup quality | Watch | -2.72% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 9.03%, revenue growth 52.50%. |
| Value attractiveness | Reasonable | Forward P/E 11.37, EV/Sales 4.75. |
...
| Diamondback Hits a Milestone at Just the Right Time | MarketBeat | 2026-08-20 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $205.60; 52w high $211.36 (-2.72%); 52w low $131.37 (+56.51%) |
| Trend | +16.55% vs SMA200, +7.22% vs SMA50, +3.07% vs SMA20 |
| Momentum | RSI(14) 57.1 (neutral) |
| Volatility | ATR(14) 6.03 (~2.9% of price); beta 0.42 |
| Setup perspective | -2.72% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 39.16, forward P/E 11.37, P/S 3.56, P/B 1.52 | EV/Sales 4.75, EV/EBITDA 6.56 |
...
|---|---|---|---|
| Price | $205.60 | EV/Sales | 4.75 |
| Market cap | $57.84B | EV/EBITDA | 6.56 |
| Beta | 0.42 | Gross margin | 72.35% |
| RSI(14) | 57.1 | Operating margin | 48.47% |
| ATR(14) | 6.03 | Profit margin | 9.03% |
| SMA20 dist | +3.07% | ROA | 1.31% |
| SMA50 dist | +7.22% | ROE | 3.49% |
| SMA200 dist | +16.55% | Revenue (ttm) | $16.25B |
| 52W high | $211.36 | Revenue growth y/y | 52.50% |
| 52W low | $131.37 | Inst. ownership | 73.36% |
| P/E (ttm) | 39.16 | Insider ownership | 27.12% |
| Forward P/E | 11.37 | Short float | 4.26% |
| PEG (trailing) | 22.30 | Avg volume | 2,234,522 |

...
Signed file: `TRGP.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $299.10 (2026-08-21, ~15-min delayed) |
| Market cap | $64.14B |
...
|---|---|---|
| Technical momentum | High | 1Y +87.59%; price +30.08% vs SMA200. |
| Fresh setup quality | Moderate / wait | -1.04% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 13.54%, revenue growth 4.20%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 24.76, EV/Sales 5.04. |
| Risk level | Elevated | Beta 0.72, ATR 3.0% of price, short float 2.51%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $299.10; 52w high $302.25 (-1.04%); 52w low $143.22 (+108.84%) |
| Trend | +30.08% vs SMA200, +10.10% vs SMA50, +9.61% vs SMA20 |
| Momentum | RSI(14) 66.6 (neutral) |
| Volatility | ATR(14) 9.02 (~3.0% of price); beta 0.72 |
| Setup perspective | -1.04% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 28.59, forward P/E 24.76, P/S 3.83, P/B 20.48 | EV/Sales 5.04, EV/EBITDA 15.35 |
| Growth expectations | Earnings growth 23.30%, EPS q/q 21.50% | Analyst mean target $305.24 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 97.42% |
...
- **Valuation risk:** Forward P/E 24.76, EV/Sales 5.04. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.72, ATR 3.0% of price, short float 2.51%. Size positions accordingly.
...
|---|---|---|---|
| Price | $299.10 | EV/Sales | 5.04 |
| Market cap | $64.14B | EV/EBITDA | 15.35 |
| Beta | 0.72 | Gross margin | 43.19% |
| RSI(14) | 66.6 | Operating margin | 27.80% |
| ATR(14) | 9.02 | Profit margin | 13.54% |
| SMA20 dist | +9.61% | ROA | 9.24% |
| SMA50 dist | +10.10% | ROE | 70.84% |
| SMA200 dist | +30.08% | Revenue (ttm) | $16.74B |
| 52W high | $302.25 | Revenue growth y/y | 4.20% |
| 52W low | $143.22 | Inst. ownership | 97.42% |
| P/E (ttm) | 28.59 | Insider ownership | 1.38% |
| Forward P/E | 24.76 | Short float | 2.51% |
| PEG (trailing) | — | Avg volume | 1,240,517 |
| P/S | 3.83 | Employees | 3,570 |
| P/B | 20.48 | Analyst rec (1=buy..5=sell) | 1.5 |

...
Signed file: `FLNC.research.07.09.2026`

| Field | Value |
|---|---|
| Current price | $10.35 (2026-09-07, ~15-min delayed) |
| Market cap | $1.92B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-42.68%) with negative half-year (-29.97%). |
| Fresh setup quality | Poor / broken | -67.89% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 75.21, EV/Sales 0.61. |
| Risk level | High | Beta 2.74, ATR 8.0% of price, short float 33.35%. |
...
|---|---|---|
| Fluence Has a $6.4 Billion Backlog but Pushed $400 Million of Deliveries Out. Is the AI-Power Story Breaking? | Insider Monkey | 2026-09-05 |
| Fluence Energy (FLNC) Stock Trades Down, Here Is Why | StockStory | 2026-09-03 |
| Fluence Energy (FLNC) Refreshes Its Board, Is The Stock Still Cheap? | Simply Wall St. | 2026-09-03 |
| Has Fluence Energy (FLNC) Fallen Far Enough To Look Undervalued? | Simply Wall St. | 2026-09-03 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.35; 52w high $32.23 (-67.89%); 52w low $6.76 (+53.11%) |
| Trend | -42.68% vs SMA200, -25.14% vs SMA50, -10.90% vs SMA20 |
| Momentum | RSI(14) 34.1 (neutral) |
| Volatility | ATR(14) 0.83 (~8.0% of price); beta 2.74 |
| Setup perspective | -67.89% from 52w high — base needs to rebuild. |
...
|---|---|---|
| Next earnings | 2026-11-23 | Next scheduled report (Yahoo estimate) |
...
| Valuation | P/E —, forward P/E 75.21, P/S 0.73, P/B 3.97 | EV/Sales 0.61, EV/EBITDA -20.70 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $16.00 (18 analysts) |
...
- **Valuation risk:** Forward P/E 75.21, EV/Sales 0.61. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.74, ATR 8.0% of price, short float 33.35%. Size positions accordingly.
...
|---|---|---|---|
| Price | $10.35 | EV/Sales | 0.61 |
| Market cap | $1.92B | EV/EBITDA | -20.70 |
| Beta | 2.74 | Gross margin | 9.36% |
| RSI(14) | 34.1 | Operating margin | -8.85% |
| ATR(14) | 0.83 | Profit margin | -3.07% |
| SMA20 dist | -10.90% | ROA | -2.95% |
| SMA50 dist | -25.14% | ROE | -23.54% |
| SMA200 dist | -42.68% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.76 | Inst. ownership | 84.98% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 75.21 | Short float | 33.35% |
| PEG (trailing) | — | Avg volume | 8,405,996 |
| P/S | 0.73 | Employees | 1,670 |
| P/B | 3.97 | Analyst rec (1=buy..5=sell) | 2.6 |

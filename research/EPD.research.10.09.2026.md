...
Signed file: `EPD.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $39.33 (2026-09-10, ~15-min delayed) |
| Market cap | $84.93B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +32.73%; price +10.54% vs SMA200. |
| Fresh setup quality | Watch | -0.08% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.42, EV/Sales 2.05. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $39.33; 52w high $39.36 (-0.08%); 52w low $28.35 (+38.71%) |
| Trend | +10.54% vs SMA200, +3.39% vs SMA50, +1.42% vs SMA20 |
| Momentum | RSI(14) 60.0 (neutral) |
| Volatility | ATR(14) 0.55 (~1.4% of price); beta 0.48 |
| Setup perspective | -0.08% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.61, forward P/E 12.42, P/S 1.45, P/B 2.81 | EV/Sales 2.05, EV/EBITDA 11.62 |
| Growth expectations | Earnings growth 28.50%, EPS q/q 28.20% | Analyst mean target $41.44 (18 analysts) |
...
|---|---|---|---|
| Price | $39.33 | EV/Sales | 2.05 |
| Market cap | $84.93B | EV/EBITDA | 11.62 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 60.0 | Operating margin | 11.76% |
| ATR(14) | 0.55 | Profit margin | 10.79% |
| SMA20 dist | +1.42% | ROA | 5.92% |
| SMA50 dist | +3.39% | ROE | 20.85% |
| SMA200 dist | +10.54% | Revenue (ttm) | $58.47B |
| 52W high | $39.36 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.64% |
| P/E (ttm) | 13.61 | Insider ownership | 33.04% |
| Forward P/E | 12.42 | Short float | 2.61% |
| PEG (trailing) | 1.39 | Avg volume | 2,960,708 |
| P/S | 1.45 | Employees | 0 |
| P/B | 2.81 | Analyst rec (1=buy..5=sell) | 2.2 |

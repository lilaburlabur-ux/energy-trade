...
Signed file: `SHEL.research.27.08.2026`

| Field | Value |
|---|---|
| Current price | $91.11 (2026-08-27, ~15-min delayed) |
| Market cap | $250.85B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +28.01%; price +12.30% vs SMA200. |
| Fresh setup quality | Watch | -2.71% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 8.76%, revenue growth 44.70%. |
| Value attractiveness | Reasonable | Forward P/E 10.33, EV/Sales 1.00. |
...
| Shell (LSE:SHEL) Could Be 5% Undervalued As Chemicals Sale Interest Builds | Simply Wall St. | 2026-08-26 |
| Equinor starts production at Troll phase three, stage two in North Sea | Offshore Technology | 2026-08-26 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $91.11; 52w high $93.65 (-2.71%); 52w low $68.25 (+33.49%) |
| Trend | +12.30% vs SMA200, +6.92% vs SMA50, +0.60% vs SMA20 |
| Momentum | RSI(14) 56.9 (neutral) |
| Volatility | ATR(14) 1.43 (~1.6% of price); beta -0.22 |
| Setup perspective | -2.71% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 10.08, forward P/E 10.33, P/S 0.85, P/B 1.40 | EV/Sales 1.00, EV/EBITDA 5.15 |
...
|---|---|---|---|
| Price | $91.11 | EV/Sales | 1.00 |
| Market cap | $250.85B | EV/EBITDA | 5.15 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 56.9 | Operating margin | 16.69% |
| ATR(14) | 1.43 | Profit margin | 8.76% |
| SMA20 dist | +0.60% | ROA | 6.40% |
| SMA50 dist | +6.92% | ROE | 14.34% |
| SMA200 dist | +12.30% | Revenue (ttm) | $296.60B |
| 52W high | $93.65 | Revenue growth y/y | 44.70% |
| 52W low | $68.25 | Inst. ownership | 13.95% |
| P/E (ttm) | 10.08 | Insider ownership | 0.01% |
| Forward P/E | 10.33 | Short float | 1.57% |
| PEG (trailing) | 1.38 | Avg volume | 6,387,464 |
| P/S | 0.85 | Employees | 84,000 |

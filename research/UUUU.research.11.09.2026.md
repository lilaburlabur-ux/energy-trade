...
Signed file: `UUUU.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $12.95 (2026-09-11, ~15-min delayed) |
| Market cap | $3.43B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-25.49%) with negative half-year (-34.66%). |
| Fresh setup quality | Poor / broken | -53.28% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-77.30%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 26.70, EV/Sales 29.81. |
| Risk level | High | Beta 1.63, ATR 6.6% of price, short float 20.62%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $12.95; 52w high $27.72 (-53.28%); 52w low $10.74 (+20.58%) |
| Trend | -25.49% vs SMA200, -4.03% vs SMA50, -11.50% vs SMA20 |
| Momentum | RSI(14) 39.4 (neutral) |
| Volatility | ATR(14) 0.85 (~6.6% of price); beta 1.63 |
| Setup perspective | -53.28% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 26.70, P/S 32.42, P/B 4.38 | EV/Sales 29.81, EV/EBITDA -43.99 |
...
- **Valuation risk:** Forward P/E 26.70, EV/Sales 29.81. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.63, ATR 6.6% of price, short float 20.62%. Size positions accordingly.
...
|---|---|---|---|
| Price | $12.95 | EV/Sales | 29.81 |
| Market cap | $3.43B | EV/EBITDA | -43.99 |
| Beta | 1.63 | Gross margin | 40.85% |
| RSI(14) | 39.4 | Operating margin | -79.03% |
| ATR(14) | 0.85 | Profit margin | -77.30% |
| SMA20 dist | -11.50% | ROA | -4.65% |
| SMA50 dist | -4.03% | ROE | -11.45% |
| SMA200 dist | -25.49% | Revenue (ttm) | $105.76M |
| 52W high | $27.72 | Revenue growth y/y | 496.10% |
| 52W low | $10.74 | Inst. ownership | 74.55% |
| P/E (ttm) | — | Insider ownership | 1.16% |
| Forward P/E | 26.70 | Short float | 20.62% |
| PEG (trailing) | — | Avg volume | 7,591,454 |
| P/S | 32.42 | Employees | 1,069 |
| P/B | 4.38 | Analyst rec (1=buy..5=sell) | 1.1 |

...
Signed file: `GEV.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $924.93 (2026-09-17, ~15-min delayed) |
| Market cap | $246.34B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +50.03%; price +2.81% vs SMA200. |
| Fresh setup quality | Moderate / wait | -21.27% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 23.04%, revenue growth 21.90%. |
| Value attractiveness | Low (expensive) | Forward P/E 36.54, EV/Sales 5.77. |
| Risk level | Elevated | Beta 0.97, ATR 4.7% of price, short float 3.29%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $924.93; 52w high $1,174.86 (-21.27%); 52w low $546.95 (+69.11%) |
| Trend | +2.81% vs SMA200, -6.21% vs SMA50, -0.68% vs SMA20 |
| Momentum | RSI(14) 46.2 (neutral) |
| Volatility | ATR(14) 43.24 (~4.7% of price); beta 0.97 |
| Setup perspective | -21.27% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.52, forward P/E 36.54, P/S 5.95, P/B 20.60 | EV/Sales 5.77, EV/EBITDA 60.74 |
...
- **Valuation risk:** Forward P/E 36.54, EV/Sales 5.77. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.97, ATR 4.7% of price, short float 3.29%. Size positions accordingly.
...
|---|---|---|---|
| Price | $924.93 | EV/Sales | 5.77 |
| Market cap | $246.34B | EV/EBITDA | 60.74 |
| Beta | 0.97 | Gross margin | 20.57% |
| RSI(14) | 46.2 | Operating margin | 7.47% |
| ATR(14) | 43.24 | Profit margin | 23.04% |
| SMA20 dist | -0.68% | ROA | 2.54% |
| SMA50 dist | -6.21% | ROE | 82.58% |
| SMA200 dist | +2.81% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.65% |
| P/E (ttm) | 26.52 | Insider ownership | 0.13% |
| Forward P/E | 36.54 | Short float | 3.29% |
| PEG (trailing) | 1.80 | Avg volume | 2,554,291 |
| P/S | 5.95 | Employees | 78,000 |
| P/B | 20.60 | Analyst rec (1=buy..5=sell) | 1.5 |

...
Signed file: `BP.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $42.85 (2026-08-17, ~15-min delayed) |
| Market cap | $110.35B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +31.97%; price +9.13% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 9.69, EV/Sales 2.29. |
...
| Buyers line up for £2.5bn BP North Sea takeover | The Telegraph | 2026-08-16 |
| BP (LSE:BP.) Returns To Venezuela To Run Loran Phase 2 Gas Project | Simply Wall St. | 2026-08-15 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $42.85; 52w high $46.52 (-7.89%); 52w low $31.17 (+37.45%) |
| Trend | +9.13% vs SMA200, +5.21% vs SMA50, +0.81% vs SMA20 |
| Momentum | RSI(14) 55.6 (neutral) |
| Volatility | ATR(14) 0.99 (~2.3% of price); beta -0.21 |
| Setup perspective | -7.89% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.50, forward P/E 9.69, P/S 0.51, P/B 7.59 | EV/Sales 2.29, EV/EBITDA 12.59 |
...
|---|---|---|---|
| Price | $42.85 | EV/Sales | 2.29 |
| Market cap | $110.35B | EV/EBITDA | 12.59 |
| Beta | -0.21 | Gross margin | 28.30% |
| RSI(14) | 55.6 | Operating margin | 13.15% |
| ATR(14) | 0.99 | Profit margin | 2.55% |
| SMA20 dist | +0.81% | ROA | 5.04% |
| SMA50 dist | +5.21% | ROE | 8.87% |
| SMA200 dist | +9.13% | Revenue (ttm) | $215.47B |
| 52W high | $46.52 | Revenue growth y/y | 48.20% |
| 52W low | $31.17 | Inst. ownership | 14.09% |
| P/E (ttm) | 20.50 | Insider ownership | 0.00% |
| Forward P/E | 9.69 | Short float | 0.41% |
| PEG (trailing) | 0.04 | Avg volume | 9,017,082 |

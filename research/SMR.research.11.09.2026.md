...
Signed file: `SMR.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $8.61 (2026-09-11, ~15-min delayed) |
| Market cap | $3.53B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-32.83%) with negative half-year (-26.79%). |
| Fresh setup quality | Poor / broken | -83.89% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -13.09, EV/Sales 287.84. |
...
|---|---|---|
| NuScale Stock Falls 14% as UBS Sees a $95 Million EBITDA Gap | GuruFocus.com | 2026-09-11 |
| Why NuScale Power Stock Just Crashed | Motley Fool | 2026-09-11 |
| Forget NuScale: This Nuclear Energy Stock Is the Smarter Bet Right Now | Motley Fool | 2026-09-11 |
| SMR Stock Slides After UBS Downgrade — Analyst Flags Concerns Around Build Timeline, Lack Of Firm Customer Commitments | Stocktwits | 2026-09-11 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $8.61; 52w high $53.43 (-83.89%); 52w low $7.59 (+13.44%) |
| Trend | -32.83% vs SMA200, -5.50% vs SMA50, -9.58% vs SMA20 |
| Momentum | RSI(14) 43.0 (neutral) |
| Volatility | ATR(14) 0.76 (~8.8% of price); beta 2.31 |
| Setup perspective | -83.89% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -13.09, P/S 330.54, P/B 1.71 | EV/Sales 287.84, EV/EBITDA -13.73 |
...
|---|---|---|---|
| Price | $8.61 | EV/Sales | 287.84 |
| Market cap | $3.53B | EV/EBITDA | -13.73 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 43.0 | Operating margin | -85337.33% |
| ATR(14) | 0.76 | Profit margin | 0.00% |
| SMA20 dist | -9.58% | ROA | -10.60% |
| SMA50 dist | -5.50% | ROE | -55.18% |
| SMA200 dist | -32.83% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.42% |
| P/E (ttm) | — | Insider ownership | 1.70% |
| Forward P/E | -13.09 | Short float | 17.60% |
| PEG (trailing) | — | Avg volume | 31,814,435 |
| P/S | 330.54 | Employees | 428 |
| P/B | 1.71 | Analyst rec (1=buy..5=sell) | 2.6 |

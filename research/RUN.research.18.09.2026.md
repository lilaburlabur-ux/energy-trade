...
Signed file: `RUN.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $8.53 (2026-09-18, ~15-min delayed) |
| Market cap | $2.05B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-39.25%) with negative half-year (-34.79%). |
| Fresh setup quality | Poor / broken | -60.16% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 11.59%, revenue growth 52.80%. |
| Value attractiveness | Reasonable | Forward P/E 8.41, EV/Sales 5.27. |
| Risk level | High | Beta 2.36, ATR 5.7% of price, short float 34.08%. |
...
| Should Sunrun’s (RUN) New Capital Raise and Outage Messaging Reframe Its Resilience-Focused Investment Story? | Simply Wall St. | 2026-09-18 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $8.53; 52w high $21.41 (-60.16%); 52w low $8.27 (+3.14%) |
| Trend | -39.25% vs SMA200, -13.31% vs SMA50, -2.75% vs SMA20 |
| Momentum | RSI(14) 41.7 (neutral) |
| Volatility | ATR(14) 0.48 (~5.7% of price); beta 2.36 |
| Setup perspective | -60.16% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 5.80, forward P/E 8.41, P/S 0.59, P/B 0.59 | EV/Sales 5.27, EV/EBITDA 21.80 |
...
- **Volatility risk:** Beta 2.36, ATR 5.7% of price, short float 34.08%. Size positions accordingly.
...
|---|---|---|---|
| Price | $8.53 | EV/Sales | 5.27 |
| Market cap | $2.05B | EV/EBITDA | 21.80 |
| Beta | 2.36 | Gross margin | 35.29% |
| RSI(14) | 41.7 | Operating margin | 4.00% |
| ATR(14) | 0.48 | Profit margin | 11.59% |
| SMA20 dist | -2.75% | ROA | 0.26% |
| SMA50 dist | -13.31% | ROE | -19.86% |
| SMA200 dist | -39.25% | Revenue (ttm) | $3.48B |
| 52W high | $21.41 | Revenue growth y/y | 52.80% |
| 52W low | $8.27 | Inst. ownership | 116.82% |
| P/E (ttm) | 5.80 | Insider ownership | 2.82% |
| Forward P/E | 8.41 | Short float | 34.08% |
| PEG (trailing) | 3.07 | Avg volume | 9,745,677 |
| P/S | 0.59 | Employees | 9,059 |
| P/B | 0.59 | Analyst rec (1=buy..5=sell) | — |

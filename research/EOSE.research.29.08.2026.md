...
Signed file: `EOSE.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $3.26 (2026-08-29, ~15-min delayed) |
| Market cap | $1.18B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-62.40%) with negative half-year (-42.76%). |
...
| Value attractiveness | Reasonable | Forward P/E -21.80, EV/Sales 10.71. |
| Risk level | High | Beta 2.80, ATR 10.7% of price, short float 31.27%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $3.26; 52w high $19.19 (-83.01%); 52w low $3.14 (+3.82%) |
| Trend | -62.40% vs SMA200, -25.78% vs SMA50, -14.60% vs SMA20 |
| Momentum | RSI(14) 38.4 (neutral) |
| Volatility | ATR(14) 0.35 (~10.7% of price); beta 2.80 |
...
| Valuation | P/E —, forward P/E -21.80, P/S 5.50, P/B -1.08 | EV/Sales 10.71, EV/EBITDA -8.06 |
...
- **Volatility risk:** Beta 2.80, ATR 10.7% of price, short float 31.27%. Size positions accordingly.
...
|---|---|---|---|
| Price | $3.26 | EV/Sales | 10.71 |
| Market cap | $1.18B | EV/EBITDA | -8.06 |
| Beta | 2.80 | Gross margin | -84.75% |
| RSI(14) | 38.4 | Operating margin | -121.86% |
| ATR(14) | 0.35 | Profit margin | -246.76% |
| SMA20 dist | -14.60% | ROA | -30.03% |
| SMA50 dist | -25.78% | ROE | — |
| SMA200 dist | -62.40% | Revenue (ttm) | $214.25M |
| 52W high | $19.19 | Revenue growth y/y | 351.40% |
| 52W low | $3.14 | Inst. ownership | 64.43% |
| P/E (ttm) | — | Insider ownership | 1.43% |
| Forward P/E | -21.80 | Short float | 31.27% |
| PEG (trailing) | — | Avg volume | 25,499,387 |

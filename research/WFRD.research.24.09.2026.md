...
Signed file: `WFRD.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $84.13 (2026-09-24, ~15-min delayed) |
| Market cap | $6.02B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-9.20%) with negative half-year (-9.24%). |
| Fresh setup quality | Moderate / wait | -24.25% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 7.66%, revenue growth -8.20%. |
| Value attractiveness | Reasonable | Forward P/E 11.92, EV/Sales 1.38. |
| Risk level | Elevated | Beta 0.90, ATR 4.1% of price, short float 6.87%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $84.13; 52w high $111.07 (-24.25%); 52w low $60.73 (+38.54%) |
| Trend | -9.20% vs SMA200, -4.80% vs SMA50, -5.94% vs SMA20 |
| Momentum | RSI(14) 41.0 (neutral) |
| Volatility | ATR(14) 3.45 (~4.1% of price); beta 0.90 |
| Setup perspective | -24.25% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 16.59, forward P/E 11.92, P/S 1.26, P/B 3.38 | EV/Sales 1.38, EV/EBITDA 7.10 |
...
- **Volatility risk:** Beta 0.90, ATR 4.1% of price, short float 6.87%. Size positions accordingly.
...
|---|---|---|---|
| Price | $84.13 | EV/Sales | 1.38 |
| Market cap | $6.02B | EV/EBITDA | 7.10 |
| Beta | 0.90 | Gross margin | 30.51% |
| RSI(14) | 41.0 | Operating margin | 10.50% |
| ATR(14) | 3.45 | Profit margin | 7.66% |
| SMA20 dist | -5.94% | ROA | 7.90% |
| SMA50 dist | -4.80% | ROE | 22.79% |
| SMA200 dist | -9.20% | Revenue (ttm) | $4.78B |
| 52W high | $111.07 | Revenue growth y/y | -8.20% |
| 52W low | $60.73 | Inst. ownership | 106.72% |
| P/E (ttm) | 16.59 | Insider ownership | 2.12% |
| Forward P/E | 11.92 | Short float | 6.87% |
| PEG (trailing) | 1.29 | Avg volume | 1,189,047 |
| P/S | 1.26 | Employees | 16,700 |
| P/B | 3.38 | Analyst rec (1=buy..5=sell) | 1.7 |

...
Signed file: `DINO.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $95.18 (2026-08-24, ~15-min delayed) |
| Market cap | $16.92B |
...
|---|---|---|
| Technical momentum | High | 1Y +113.43%; price +51.75% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.15, EV/Sales 0.59. |
| Risk level | Elevated | Beta 0.69, ATR 3.8% of price, short float 5.59%. |
...
|---|---|---|
| Petrobras Eyes Four Offshore Blocks in Ghana's Keta Basin | Zacks | 2026-08-24 |
| Three-Year ORLEN Deal Enhances EQNR's Crude Sales & European Reach | Zacks | 2026-08-24 |
| Here's How Much You'd Have If You Invested $1000 in HF Sinclair a Decade Ago | Zacks | 2026-08-24 |
| Halliburton Expands Portfolio With Three Energy Innovators | Zacks | 2026-08-21 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $95.18; 52w high $97.32 (-2.20%); 52w low $44.83 (+112.31%) |
| Trend | +51.75% vs SMA200, +16.50% vs SMA50, +5.94% vs SMA20 |
| Momentum | RSI(14) 62.7 (neutral) |
| Volatility | ATR(14) 3.58 (~3.8% of price); beta 0.69 |
...
| Valuation | P/E 9.07, forward P/E 10.15, P/S 0.54, P/B 1.65 | EV/Sales 0.59, EV/EBITDA 5.75 |
...
- **Volatility risk:** Beta 0.69, ATR 3.8% of price, short float 5.59%. Size positions accordingly.
...
|---|---|---|---|
| Price | $95.18 | EV/Sales | 0.59 |
| Market cap | $16.92B | EV/EBITDA | 5.75 |
| Beta | 0.69 | Gross margin | 12.89% |
| RSI(14) | 62.7 | Operating margin | 11.69% |
| ATR(14) | 3.58 | Profit margin | 6.13% |
| SMA20 dist | +5.94% | ROA | 9.16% |
| SMA50 dist | +16.50% | ROE | 19.50% |
| SMA200 dist | +51.75% | Revenue (ttm) | $31.23B |
| 52W high | $97.32 | Revenue growth y/y | 53.20% |
| 52W low | $44.83 | Inst. ownership | 89.83% |
| P/E (ttm) | 9.07 | Insider ownership | 5.49% |
| Forward P/E | 10.15 | Short float | 5.59% |
| PEG (trailing) | 1.21 | Avg volume | 2,625,674 |
| P/S | 0.54 | Employees | 5,165 |
| P/B | 1.65 | Analyst rec (1=buy..5=sell) | 2.6 |

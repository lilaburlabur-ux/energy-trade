...
Signed file: `KMI.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $31.25 (2026-09-24, ~15-min delayed) |
| Market cap | $69.53B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +19.60%; price +1.12% vs SMA200. |
| Fresh setup quality | Moderate / wait | -8.07% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 19.30%, revenue growth 10.80%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.23, EV/Sales 5.75. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $31.25; 52w high $33.99 (-8.07%); 52w low $24.86 (+25.70%) |
| Trend | +1.12% vs SMA200, -1.25% vs SMA50, -0.73% vs SMA20 |
| Momentum | RSI(14) 47.4 (neutral) |
| Volatility | ATR(14) 0.71 (~2.3% of price); beta 0.55 |
| Setup perspective | -8.07% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.16, forward P/E 20.23, P/S 3.87, P/B 2.20 | EV/Sales 5.75, EV/EBITDA 13.51 |
...
- **Valuation risk:** Forward P/E 20.23, EV/Sales 5.75. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $31.25 | EV/Sales | 5.75 |
| Market cap | $69.53B | EV/EBITDA | 13.51 |
| Beta | 0.55 | Gross margin | 49.41% |
| RSI(14) | 47.4 | Operating margin | 30.06% |
| ATR(14) | 0.71 | Profit margin | 19.30% |
| SMA20 dist | -0.73% | ROA | 4.45% |
| SMA50 dist | -1.25% | ROE | 10.99% |
| SMA200 dist | +1.12% | Revenue (ttm) | $17.96B |
| 52W high | $33.99 | Revenue growth y/y | 10.80% |
| 52W low | $24.86 | Inst. ownership | 70.85% |
| P/E (ttm) | 20.16 | Insider ownership | 12.70% |
| Forward P/E | 20.23 | Short float | 2.50% |
| PEG (trailing) | 3.19 | Avg volume | 11,138,660 |
| P/S | 3.87 | Employees | 11,028 |

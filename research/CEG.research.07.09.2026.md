...
Signed file: `CEG.research.07.09.2026`

| Field | Value |
|---|---|
| Current price | $298.96 (2026-09-07, ~15-min delayed) |
| Market cap | $105.92B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y -2.73%; price +1.18% vs SMA200. |
| Fresh setup quality | Poor / broken | -25.58% from 52w high — base needs to rebuild. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $298.96; 52w high $401.70 (-25.58%); 52w low $236.14 (+26.60%) |
| Trend | +1.18% vs SMA200, +12.34% vs SMA50, +7.33% vs SMA20 |
| Momentum | RSI(14) 66.9 (neutral) |
| Volatility | ATR(14) 10.14 (~3.4% of price); beta 1.12 |
| Setup perspective | -25.58% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 29.25, forward P/E 22.41, P/S 3.39, P/B 3.32 | EV/Sales 4.17, EV/EBITDA 16.38 |
...
|---|---|---|---|
| Price | $298.96 | EV/Sales | 4.17 |
| Market cap | $105.92B | EV/EBITDA | 16.38 |
| Beta | 1.12 | Gross margin | 22.11% |
| RSI(14) | 66.9 | Operating margin | 8.66% |
| ATR(14) | 10.14 | Profit margin | 11.08% |
| SMA20 dist | +7.33% | ROA | 3.89% |
| SMA50 dist | +12.34% | ROE | 15.06% |
| SMA200 dist | +1.18% | Revenue (ttm) | $31.27B |
| 52W high | $401.70 | Revenue growth y/y | 23.00% |
| 52W low | $236.14 | Inst. ownership | 83.03% |
| P/E (ttm) | 29.25 | Insider ownership | 0.34% |
| Forward P/E | 22.41 | Short float | 2.97% |
| PEG (trailing) | — | Avg volume | 3,111,301 |

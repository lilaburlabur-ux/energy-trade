...
Signed file: `DUK.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $121.24 (2026-09-08, ~15-min delayed) |
| Market cap | $94.53B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-0.90%) with negative half-year (-5.89%). |
...
| Value attractiveness | Reasonable | Forward P/E 16.90, EV/Sales 5.74. |
| Risk level | Moderate | Beta 0.36, ATR 1.5% of price, short float 2.55%. |
...
|---|---|---|
| New Study Reveals Strongest State Economies, Only 1 State Was Better Than Texas | 24/7 Wall St. | 2026-09-08 |
| BWX Technologies Already Builds Reactors for the Navy. Why Is It Still the Cheapest Nuclear Stock? | Motley Fool | 2026-09-06 |
| Dividends vs. Annuity: Which Turns $930,000 Into More Monthly Income for Life? | 24/7 Wall St. | 2026-09-05 |
| The Lowe’s Foundation wants to train 1 million craft workers | Construction Dive | 2026-09-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $121.24; 52w high $131.16 (-7.57%); 52w low $111.09 (+9.13%) |
| Trend | -0.90% vs SMA200, -2.13% vs SMA50, -0.45% vs SMA20 |
| Momentum | RSI(14) 46.4 (neutral) |
| Volatility | ATR(14) 1.87 (~1.5% of price); beta 0.36 |
...
| Valuation | P/E 18.26, forward P/E 16.90, P/S 2.88, P/B 1.76 | EV/Sales 5.74, EV/EBITDA 11.34 |
...
|---|---|---|---|
| Price | $121.24 | EV/Sales | 5.74 |
| Market cap | $94.53B | EV/EBITDA | 11.34 |
| Beta | 0.36 | Gross margin | 51.97% |
| RSI(14) | 46.4 | Operating margin | 27.50% |
| ATR(14) | 1.87 | Profit margin | 16.00% |
| SMA20 dist | -0.45% | ROA | 2.84% |
| SMA50 dist | -2.13% | ROE | 9.86% |
| SMA200 dist | -0.90% | Revenue (ttm) | $32.80B |
| 52W high | $131.16 | Revenue growth y/y | 1.10% |
| 52W low | $111.09 | Inst. ownership | 71.18% |
| P/E (ttm) | 18.26 | Insider ownership | 0.13% |
| Forward P/E | 16.90 | Short float | 2.55% |
| PEG (trailing) | — | Avg volume | 4,024,614 |
| P/S | 2.88 | Employees | 26,441 |
| P/B | 1.76 | Analyst rec (1=buy..5=sell) | — |

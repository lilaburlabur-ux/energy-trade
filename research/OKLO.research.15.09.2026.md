...
Signed file: `OKLO.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $35.98 (2026-09-15, ~15-min delayed) |
| Market cap | $6.69B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-43.13%) with negative half-year (-39.72%). |
...
| Value attractiveness | Reasonable | Forward P/E -35.58, EV/Sales 3,532.80. |
| Risk level | High | Beta 1.20, ATR 7.7% of price, short float 19.64%. |
...
| SMR Loss to Improve 70.5%: Is This Sub-$10 Stock a Bargain? | Zacks | 2026-09-15 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $35.98; 52w high $174.14 (-79.34%); 52w low $35.98 (+0.00%) |
| Trend | -43.13% vs SMA200, -15.38% vs SMA50, -11.18% vs SMA20 |
| Momentum | RSI(14) 38.3 (neutral) |
| Volatility | ATR(14) 2.76 (~7.7% of price); beta 1.20 |
...
| Valuation | P/E —, forward P/E -35.58, P/S 5,531.33, P/B 2.03 | EV/Sales 3,532.80, EV/EBITDA -19.72 |
...
- **Volatility risk:** Beta 1.20, ATR 7.7% of price, short float 19.64%. Size positions accordingly.
...
|---|---|---|---|
| Price | $35.98 | EV/Sales | 3,532.80 |
| Market cap | $6.69B | EV/EBITDA | -19.72 |
| Beta | 1.20 | Gross margin | 40.41% |
| RSI(14) | 38.3 | Operating margin | -6048.76% |
| ATR(14) | 2.76 | Profit margin | 0.00% |
| SMA20 dist | -11.18% | ROA | -6.65% |
| SMA50 dist | -15.38% | ROE | -7.70% |
| SMA200 dist | -43.13% | Revenue (ttm) | $1.21M |
| 52W high | $174.14 | Revenue growth y/y | — |
| 52W low | $35.98 | Inst. ownership | 47.55% |
| P/E (ttm) | — | Insider ownership | 15.38% |
| Forward P/E | -35.58 | Short float | 19.64% |
| PEG (trailing) | — | Avg volume | 9,821,495 |
| P/S | 5,531.33 | Employees | 215 |
| P/B | 2.03 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `SMR.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $9.89 (2026-08-11, ~15-min delayed) |
| Market cap | $4.06B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-35.04%) with negative half-year (-44.06%). |
| Fresh setup quality | Poor / broken | -81.49% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -15.90, EV/Sales 248.29. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.89; 52w high $53.43 (-81.49%); 52w low $7.59 (+30.30%) |
| Trend | -35.04% vs SMA200, +2.52% vs SMA50, +13.95% vs SMA20 |
| Momentum | RSI(14) 56.6 (neutral) |
| Volatility | ATR(14) 0.73 (~7.4% of price); beta 2.31 |
| Setup perspective | -81.49% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -15.90, P/S 379.68, P/B 2.69 | EV/Sales 248.29, EV/EBITDA -11.85 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $12.90 (15 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 48.90% |
...
|---|---|---|---|
| Price | $9.89 | EV/Sales | 248.29 |
| Market cap | $4.06B | EV/EBITDA | -11.85 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 56.6 | Operating margin | -85337.33% |
| ATR(14) | 0.73 | Profit margin | 0.00% |
| SMA20 dist | +13.95% | ROA | -10.60% |
| SMA50 dist | +2.52% | ROE | -55.18% |
| SMA200 dist | -35.04% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 48.90% |
| P/E (ttm) | — | Insider ownership | 1.68% |
| Forward P/E | -15.90 | Short float | 23.15% |
| PEG (trailing) | — | Avg volume | 32,485,046 |
| P/S | 379.68 | Employees | 428 |
| P/B | 2.69 | Analyst rec (1=buy..5=sell) | 2.6 |

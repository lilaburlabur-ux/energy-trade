...
Signed file: `OKLO.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $42.09 (2026-08-21, ~15-min delayed) |
| Market cap | $7.83B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-38.27%) with negative half-year (-34.06%). |
| Fresh setup quality | Poor / broken | -75.83% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -41.91, EV/Sales 4,370.49. |
| Risk level | High | Beta 1.20, ATR 7.6% of price, short float 18.60%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $42.09; 52w high $174.14 (-75.83%); 52w low $36.84 (+14.25%) |
| Trend | -38.27% vs SMA200, -11.20% vs SMA50, -1.62% vs SMA20 |
| Momentum | RSI(14) 45.3 (neutral) |
| Volatility | ATR(14) 3.19 (~7.6% of price); beta 1.20 |
| Setup perspective | -75.83% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -41.91, P/S 6,470.65, P/B 2.38 | EV/Sales 4,370.49, EV/EBITDA -24.39 |
...
- **Volatility risk:** Beta 1.20, ATR 7.6% of price, short float 18.60%. Size positions accordingly.
...
|---|---|---|---|
| Price | $42.09 | EV/Sales | 4,370.49 |
| Market cap | $7.83B | EV/EBITDA | -24.39 |
| Beta | 1.20 | Gross margin | 40.41% |
| RSI(14) | 45.3 | Operating margin | -6048.76% |
| ATR(14) | 3.19 | Profit margin | 0.00% |
| SMA20 dist | -1.62% | ROA | -6.65% |
| SMA50 dist | -11.20% | ROE | -7.70% |
| SMA200 dist | -38.27% | Revenue (ttm) | $1.21M |
| 52W high | $174.14 | Revenue growth y/y | — |
| 52W low | $36.84 | Inst. ownership | 47.40% |
| P/E (ttm) | — | Insider ownership | 15.43% |
| Forward P/E | -41.91 | Short float | 18.60% |
| PEG (trailing) | — | Avg volume | 10,863,298 |
| P/S | 6,470.65 | Employees | 215 |
| P/B | 2.38 | Analyst rec (1=buy..5=sell) | 2.0 |

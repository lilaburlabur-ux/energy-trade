...
Signed file: `GEV.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $1,063.25 (2026-08-14, ~15-min delayed) |
| Market cap | $283.18B |
...
|---|---|---|
| Technical momentum | High | 1Y +68.00%; price +24.08% vs SMA200. |
| Fresh setup quality | Moderate / wait | -9.50% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 23.04%, revenue growth 21.90%. |
| Value attractiveness | Low (expensive) | Forward P/E 42.39, EV/Sales 6.57. |
| Risk level | Elevated | Beta 1.03, ATR 4.8% of price, short float 3.20%. |
...
| Should Investors Take Profits in GE Vernova After Its Big Run? | Motley Fool | 2026-08-14 |
| Why GE Vernova (GEV) Is Emerging as an AI Power Winner | Insider Monkey | 2026-08-14 |
| AirJoule Technologies Corporation Q2 2026 Earnings Call Summary | Moby | 2026-08-14 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $1,063.25; 52w high $1,174.86 (-9.50%); 52w low $546.95 (+94.40%) |
| Trend | +24.08% vs SMA200, +3.48% vs SMA50, +5.32% vs SMA20 |
| Momentum | RSI(14) 56.6 (neutral) |
| Volatility | ATR(14) 51.31 (~4.8% of price); beta 1.03 |
| Setup perspective | -9.50% from 52w high; no clean fresh pivot by default. |
...
- **Valuation risk:** Forward P/E 42.39, EV/Sales 6.57. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.03, ATR 4.8% of price, short float 3.20%. Size positions accordingly.
...
|---|---|---|---|
| Price | $1,063.25 | EV/Sales | 6.57 |
| Market cap | $283.18B | EV/EBITDA | 69.18 |
| Beta | 1.03 | Gross margin | 20.57% |
| RSI(14) | 56.6 | Operating margin | 7.47% |
| ATR(14) | 51.31 | Profit margin | 23.04% |
| SMA20 dist | +5.32% | ROA | 2.54% |
| SMA50 dist | +3.48% | ROE | 82.58% |
...
| P/B | 23.68 | Analyst rec (1=buy..5=sell) | 1.6 |

...
Signed file: `ENPH.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $36.86 (2026-09-10, ~15-min delayed) |
| Market cap | $4.86B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-9.88%) with negative half-year (-14.95%). |
| Fresh setup quality | Poor / broken | -49.04% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 16.21, EV/Sales 3.41. |
| Risk level | High | Beta 1.64, ATR 5.9% of price, short float 19.63%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.86; 52w high $72.33 (-49.04%); 52w low $26.12 (+41.12%) |
| Trend | -9.88% vs SMA200, -7.17% vs SMA50, -2.47% vs SMA20 |
| Momentum | RSI(14) 45.0 (neutral) |
| Volatility | ATR(14) 2.18 (~5.9% of price); beta 1.64 |
| Setup perspective | -49.04% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 36.50, forward P/E 16.21, P/S 3.66, P/B 4.12 | EV/Sales 3.41, EV/EBITDA 23.61 |
...
- **Volatility risk:** Beta 1.64, ATR 5.9% of price, short float 19.63%. Size positions accordingly.
...
|---|---|---|---|
| Price | $36.86 | EV/Sales | 3.41 |
| Market cap | $4.86B | EV/EBITDA | 23.61 |
| Beta | 1.64 | Gross margin | 30.04% |
| RSI(14) | 45.0 | Operating margin | 17.98% |
| ATR(14) | 2.18 | Profit margin | 10.09% |
| SMA20 dist | -2.47% | ROA | 2.38% |
| SMA50 dist | -7.17% | ROE | 13.00% |
| SMA200 dist | -9.88% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 96.91% |
| P/E (ttm) | 36.50 | Insider ownership | 3.03% |
| Forward P/E | 16.21 | Short float | 19.63% |
| PEG (trailing) | 0.79 | Avg volume | 5,108,377 |
| P/S | 3.66 | Employees | 2,872 |

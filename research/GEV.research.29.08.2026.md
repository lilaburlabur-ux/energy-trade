...
Signed file: `GEV.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $911.93 (2026-08-29, ~15-min delayed) |
| Market cap | $242.88B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +46.85%; price +4.00% vs SMA200. |
| Fresh setup quality | Moderate / wait | -22.38% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 23.04%, revenue growth 21.90%. |
| Value attractiveness | Low (expensive) | Forward P/E 36.28, EV/Sales 5.95. |
...
|---|---|---|
| GE Vernova’s New JV Could Unlock its Next Big Growth Engine | Insider Monkey | 2026-08-29 |
| GE Vernova's Electrification Revenue Jumped 68% on Data Center Deals in a Single Quarter. So Why Did the Stock Sell Off? | Motley Fool | 2026-08-29 |
| Rivian Shares Tumble After CFO Departure | GuruFocus.com | 2026-08-28 |
| Rivian Falls 6% as CFO Departs for GE Vernova; Lucid Slips, Tesla Holds Steady | 24/7 Wall St. | 2026-08-28 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $911.93; 52w high $1,174.86 (-22.38%); 52w low $546.95 (+66.73%) |
| Trend | +4.00% vs SMA200, -11.60% vs SMA50, -8.21% vs SMA20 |
| Momentum | RSI(14) 37.0 (neutral) |
| Volatility | ATR(14) 46.79 (~5.1% of price); beta 1.03 |
| Setup perspective | -22.38% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.12, forward P/E 36.28, P/S 5.87, P/B 20.31 | EV/Sales 5.95, EV/EBITDA 62.69 |
...
- **Valuation risk:** Forward P/E 36.28, EV/Sales 5.95. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $911.93 | EV/Sales | 5.95 |
| Market cap | $242.88B | EV/EBITDA | 62.69 |
| Beta | 1.03 | Gross margin | 20.57% |
| RSI(14) | 37.0 | Operating margin | 7.47% |
| ATR(14) | 46.79 | Profit margin | 23.04% |
| SMA20 dist | -8.21% | ROA | 2.54% |
| SMA50 dist | -11.60% | ROE | 82.58% |
| SMA200 dist | +4.00% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.66% |
| P/E (ttm) | 26.12 | Insider ownership | 0.13% |
| Forward P/E | 36.28 | Short float | 2.98% |
| PEG (trailing) | 1.62 | Avg volume | 2,792,892 |
| P/S | 5.87 | Employees | 78,000 |
| P/B | 20.31 | Analyst rec (1=buy..5=sell) | 1.5 |

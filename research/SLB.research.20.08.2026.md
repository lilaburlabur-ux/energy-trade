...
Signed file: `SLB.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $53.55 (2026-08-20, ~15-min delayed) |
| Market cap | $79.48B |
...
|---|---|---|
| Technical momentum | High | 1Y +65.01%; price +12.28% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 16.57, EV/Sales 2.46. |
| Risk level | Moderate | Beta 0.75, ATR 2.8% of price, short float 4.32%. |
...
| Trend | +12.28% vs SMA200, +7.76% vs SMA50, +3.68% vs SMA20 |
| Momentum | RSI(14) 60.1 (neutral) |
| Volatility | ATR(14) 1.49 (~2.8% of price); beta 0.75 |
...
| Valuation | P/E 26.12, forward P/E 16.57, P/S 2.19, P/B 3.05 | EV/Sales 2.46, EV/EBITDA 12.10 |
...
|---|---|---|---|
| Price | $53.55 | EV/Sales | 2.46 |
| Market cap | $79.48B | EV/EBITDA | 12.10 |
| Beta | 0.75 | Gross margin | 16.99% |
| RSI(14) | 60.1 | Operating margin | 12.71% |
| ATR(14) | 1.49 | Profit margin | 8.53% |
| SMA20 dist | +3.68% | ROA | 6.17% |
| SMA50 dist | +7.76% | ROE | 12.91% |
| SMA200 dist | +12.28% | Revenue (ttm) | $36.37B |

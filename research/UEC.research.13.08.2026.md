...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-16.25%) with negative half-year (-29.62%). |
| Fresh setup quality | Poor / broken | -44.44% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -124.33, EV/Sales 254.24. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.19; 52w high $20.14 (-44.44%); 52w low $9.04 (+23.78%) |
| Trend | -16.25% vs SMA200, +4.65% vs SMA50, +9.91% vs SMA20 |
| Momentum | RSI(14) 58.0 (neutral) |
| Volatility | ATR(14) 0.58 (~5.2% of price); beta 1.21 |
| Setup perspective | -44.44% from 52w high — base needs to rebuild. |
...
| SMA20 dist | +9.91% | ROA | -6.25% |
| SMA50 dist | +4.65% | ROE | -8.96% |
| SMA200 dist | -16.25% | Revenue (ttm) | $20.20M |

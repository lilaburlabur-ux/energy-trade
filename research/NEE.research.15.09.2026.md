...
Signed file: `NEE.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $81.07 (2026-09-15, ~15-min delayed) |
| Market cap | $169.08B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-6.32%) with negative half-year (-11.36%). |
| Fresh setup quality | Moderate / wait | -15.94% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 32.40%, revenue growth 12.40%. |
| Value attractiveness | Reasonable | Forward P/E 18.45, EV/Sales 10.06. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $81.07; 52w high $96.44 (-15.94%); 52w low $67.88 (+19.43%) |
| Trend | -6.32% vs SMA200, -5.07% vs SMA50, -2.52% vs SMA20 |
| Momentum | RSI(14) 32.1 (neutral) |
| Volatility | ATR(14) 1.29 (~1.6% of price); beta 0.64 |
| Setup perspective | -15.94% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.22, forward P/E 18.45, P/S 5.89, P/B 2.96 | EV/Sales 10.06, EV/EBITDA 19.78 |
...
|---|---|---|---|
| Price | $81.07 | EV/Sales | 10.06 |
| Market cap | $169.08B | EV/EBITDA | 19.78 |
| Beta | 0.64 | Gross margin | 61.02% |
| RSI(14) | 32.1 | Operating margin | 31.52% |
| ATR(14) | 1.29 | Profit margin | 32.40% |
| SMA20 dist | -2.52% | ROA | 2.44% |
| SMA50 dist | -5.07% | ROE | 11.68% |
| SMA200 dist | -6.32% | Revenue (ttm) | $28.70B |
| 52W high | $96.44 | Revenue growth y/y | 12.40% |
| 52W low | $67.88 | Inst. ownership | 87.01% |
| P/E (ttm) | 18.22 | Insider ownership | 0.12% |
| Forward P/E | 18.45 | Short float | 0.00% |
| PEG (trailing) | 1.65 | Avg volume | 11,068,288 |
| P/S | 5.89 | Employees | 17,400 |
| P/B | 2.96 | Analyst rec (1=buy..5=sell) | 2.0 |

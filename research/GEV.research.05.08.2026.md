...
Signed file: `GEV.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $1,017.96 (2026-08-05, ~15-min delayed) |
| Market cap | $271.12B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +53.94%; price +20.94% vs SMA200. |
| Fresh setup quality | Moderate / wait | -13.35% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 23.04%, revenue growth 21.90%. |
| Value attractiveness | Low (expensive) | Forward P/E 40.91, EV/Sales 6.29. |
...
|---|---|---|
| This GE Vernova Supplier Spikes Past A Buy Point | Investor's Business Daily | 2026-08-05 |
| GE Vernova to supply 43 wind turbines for Enfinity Global’s Fatehgarh site | Power Technology | 2026-08-05 |
| AI Infrastructure Backlog: How Dell, HPE, SMCI, and GE Vernova Are Positioned | Insider Monkey | 2026-08-05 |
| GE Vernova Set to Be Biggest Winner From AI Data Center’s Massive Power Shortfall | 24/7 Wall St. | 2026-08-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $1,017.96; 52w high $1,174.86 (-13.35%); 52w low $546.95 (+86.12%) |
| Trend | +20.94% vs SMA200, -0.53% vs SMA50, -0.54% vs SMA20 |
| Momentum | RSI(14) 49.5 (neutral) |
| Volatility | ATR(14) 60.13 (~5.9% of price); beta 1.03 |
| Setup perspective | -13.35% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 29.23, forward P/E 40.91, P/S 6.55, P/B 22.67 | EV/Sales 6.29, EV/EBITDA 66.28 |
...
- **Valuation risk:** Forward P/E 40.91, EV/Sales 6.29. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $1,017.96 | EV/Sales | 6.29 |
| Market cap | $271.12B | EV/EBITDA | 66.28 |
| Beta | 1.03 | Gross margin | 20.57% |
| RSI(14) | 49.5 | Operating margin | 7.47% |
| ATR(14) | 60.13 | Profit margin | 23.04% |
| SMA20 dist | -0.54% | ROA | 2.54% |
| SMA50 dist | -0.53% | ROE | 82.58% |
| SMA200 dist | +20.94% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 80.32% |
| P/E (ttm) | 29.23 | Insider ownership | 0.12% |
| Forward P/E | 40.91 | Short float | 3.80% |
| PEG (trailing) | 1.68 | Avg volume | 2,885,454 |
| P/S | 6.55 | Employees | 78,000 |
| P/B | 22.67 | Analyst rec (1=buy..5=sell) | 1.6 |

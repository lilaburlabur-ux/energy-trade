...
Signed file: `ENPH.research.13.08.2026`
...
|---|---|---|
| Technical momentum | Moderate | 1Y +21.51%; price +1.41% vs SMA200. |
| Fresh setup quality | Poor / broken | -43.62% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 17.71, EV/Sales 3.81. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $40.78; 52w high $72.33 (-43.62%); 52w low $26.12 (+56.13%) |
| Trend | +1.41% vs SMA200, -10.44% vs SMA50, +3.66% vs SMA20 |
| Momentum | RSI(14) 48.3 (neutral) |
| Volatility | ATR(14) 2.65 (~6.5% of price); beta 1.65 |
| Setup perspective | -43.62% from 52w high — base needs to rebuild. |

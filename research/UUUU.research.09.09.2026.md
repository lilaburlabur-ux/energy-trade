...
Signed file: `UUUU.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $14.55 (2026-09-09, ~15-min delayed) |
| Market cap | $3.85B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-16.26%) with negative half-year (-28.36%). |
| Fresh setup quality | Poor / broken | -47.51% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-77.30%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 30.00, EV/Sales 32.15. |
| Risk level | High | Beta 1.63, ATR 5.8% of price, short float 21.42%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $14.55; 52w high $27.72 (-47.51%); 52w low $10.74 (+35.47%) |
| Trend | -16.26% vs SMA200, +7.49% vs SMA50, -1.40% vs SMA20 |
| Momentum | RSI(14) 51.8 (neutral) |
| Volatility | ATR(14) 0.84 (~5.8% of price); beta 1.63 |
| Setup perspective | -47.51% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 30.00, P/S 36.43, P/B 4.59 | EV/Sales 32.15, EV/EBITDA -47.45 |
...
- **Valuation risk:** Forward P/E 30.00, EV/Sales 32.15. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.63, ATR 5.8% of price, short float 21.42%. Size positions accordingly.
...
|---|---|---|---|
| Price | $14.55 | EV/Sales | 32.15 |
| Market cap | $3.85B | EV/EBITDA | -47.45 |
| Beta | 1.63 | Gross margin | 40.85% |
| RSI(14) | 51.8 | Operating margin | -79.03% |
| ATR(14) | 0.84 | Profit margin | -77.30% |
| SMA20 dist | -1.40% | ROA | -4.65% |
| SMA50 dist | +7.49% | ROE | -11.45% |
| SMA200 dist | -16.26% | Revenue (ttm) | $105.76M |
| 52W high | $27.72 | Revenue growth y/y | 496.10% |
| 52W low | $10.74 | Inst. ownership | 74.65% |
| P/E (ttm) | — | Insider ownership | 1.16% |
| Forward P/E | 30.00 | Short float | 21.42% |
| PEG (trailing) | — | Avg volume | 7,715,353 |
| P/S | 36.43 | Employees | 1,069 |
| P/B | 4.59 | Analyst rec (1=buy..5=sell) | 1.1 |

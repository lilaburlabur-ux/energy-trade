...
Signed file: `SMR.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $9.39 (2026-08-14, ~15-min delayed) |
| Market cap | $3.85B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-36.55%) with negative half-year (-32.88%). |
| Fresh setup quality | Poor / broken | -82.43% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -14.49, EV/Sales 274.02. |
| Risk level | High | Beta 2.31, ATR 7.7% of price, short float 19.43%. |
...
| Can OKLO's Groves Milestone Validate Its Nuclear Strategy? | Zacks | 2026-08-14 |
| The Last U.S. Nuclear Boom Applied to Build 26 Reactors and Finished 2. NuScale Carries a $4 Billion Market Value on $10.7 Million of Sales. | Motley Fool | 2026-08-14 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.39; 52w high $53.43 (-82.43%); 52w low $7.59 (+23.72%) |
| Trend | -36.55% vs SMA200, -0.54% vs SMA50, +5.10% vs SMA20 |
| Momentum | RSI(14) 51.4 (neutral) |
| Volatility | ATR(14) 0.72 (~7.7% of price); beta 2.31 |
| Setup perspective | -82.43% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -14.49, P/S 360.48, P/B 2.56 | EV/Sales 274.02, EV/EBITDA -13.07 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $12.90 (15 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 51.69% |
...
- **Volatility risk:** Beta 2.31, ATR 7.7% of price, short float 19.43%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.39 | EV/Sales | 274.02 |
| Market cap | $3.85B | EV/EBITDA | -13.07 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 51.4 | Operating margin | -85337.33% |
| ATR(14) | 0.72 | Profit margin | 0.00% |
| SMA20 dist | +5.10% | ROA | -10.60% |
| SMA50 dist | -0.54% | ROE | -55.18% |
| SMA200 dist | -36.55% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 51.69% |
| P/E (ttm) | — | Insider ownership | 1.69% |
| Forward P/E | -14.49 | Short float | 19.43% |
| PEG (trailing) | — | Avg volume | 32,359,943 |
| P/S | 360.48 | Employees | 428 |

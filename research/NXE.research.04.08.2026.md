...
Signed file: `NXE.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $9.76 (2026-08-04, ~15-min delayed) |
| Market cap | $6.46B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-8.01%) with negative half-year (-19.60%). |
| Fresh setup quality | Poor / broken | -29.89% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -52.30, EV/Sales —. |
| Risk level | Elevated | Beta 1.65, ATR 4.8% of price, short float —. |
...
|---|---|---|
| NexGen Energy (TSX:NXE) Stock Looks Above Fair Value Despite 145% Returns | Simply Wall St. | 2026-07-25 |
| NexGen Energy (TSX:NXE) Has Slid In Recent Trading, Is It Still Fully Valued? | Simply Wall St. | 2026-07-25 |
| Uranium Holds at $85 as AI Data Centers Go Nuclear | 24/7 Wall St. | 2026-07-22 |
| NexGen Energy Ltd. (NXE) Fell Due to Risk-Off Sentiment in the Commodity Market | Insider Monkey | 2026-07-20 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.76; 52w high $13.92 (-29.89%); 52w low $6.46 (+51.08%) |
| Trend | -8.01% vs SMA200, -1.59% vs SMA50, +5.69% vs SMA20 |
| Momentum | RSI(14) 54.2 (neutral) |
| Volatility | ATR(14) 0.47 (~4.8% of price); beta 1.65 |
| Setup perspective | -29.89% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -52.30, P/S —, P/B 5.36 | EV/Sales —, EV/EBITDA -62.85 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $19.24 (1 analysts) |
...
|---|---|---|---|
| Mirae Asset Global ETFs Holdings Ltd. | 42,786,101 | 6.39% | 2026-03-31 |
| L1 Capital Pty Ltd | 35,220,809 | 5.26% | 2026-03-31 |
| Van Eck Associates Corporation | 31,399,867 | 4.69% | 2026-03-31 |
| Alps Advisors Inc. | 24,670,482 | 3.69% | 2026-06-30 |
| Vanguard Capital Management LLC | 17,423,992 | 2.60% | 2026-03-31 |
| Hancock Prospecting Pty Ltd | 9,078,245 | 1.36% | 2026-03-31 |
| Ameriprise Financial, Inc. | 8,156,244 | 1.22% | 2026-03-31 |
| Grantham, Mayo, Van Otterloo & Co. LLC | 7,554,115 | 1.13% | 2026-03-31 |
| Millennium Management Llc | 5,638,384 | 0.84% | 2026-03-31 |
| Vanguard Fiduciary Trust Co | 5,343,563 | 0.80% | 2026-03-31 |

## 6. Risk Review and Setup Plan
- **Volatility risk:** Beta 1.65, ATR 4.8% of price, short float —. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.76 | EV/Sales | — |
| Market cap | $6.46B | EV/EBITDA | -62.85 |
| Beta | 1.65 | Gross margin | 0.00% |
| RSI(14) | 54.2 | Operating margin | 0.00% |
| ATR(14) | 0.47 | Profit margin | 0.00% |
| SMA20 dist | +5.69% | ROA | -3.04% |
| SMA50 dist | -1.59% | ROE | -29.61% |
| SMA200 dist | -8.01% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $6.46 | Inst. ownership | 55.21% |
| P/E (ttm) | — | Insider ownership | 6.47% |
| Forward P/E | -52.30 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,857,196 |
| P/S | — | Employees | 142 |
| P/B | 5.36 | Analyst rec (1=buy..5=sell) | 1.5 |

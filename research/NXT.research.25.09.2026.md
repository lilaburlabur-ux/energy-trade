...
Signed file: `NXT.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $80.85 (2026-09-25, ~15-min delayed) |
| Market cap | $12.42B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-25.12%) with negative half-year (-32.54%). |
| Fresh setup quality | Poor / broken | -48.31% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 16.36%, revenue growth 8.20%. |
| Value attractiveness | Reasonable | Forward P/E 14.00, EV/Sales 3.02. |
| Risk level | High | Beta 1.92, ATR 5.1% of price, short float 7.96%. |
...
|---|---|---|
| 3 Growth Stocks Set to Flourish | StockStory | 2026-09-25 |
| Sterling, Axon, Herc, Nextpower, and FTAI Aviation Shares Plummet, What You Need To Know | StockStory | 2026-09-25 |
| Nextpower Inc. (NXT) Is a Trending Stock: Facts to Know Before Betting on It | Zacks | 2026-09-24 |
| AI Pick-And-Shovel Stocks To Watch As Xi And Trump Meet | Investor's Business Daily | 2026-09-22 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $80.85; 52w high $156.40 (-48.31%); 52w low $73.07 (+10.65%) |
| Trend | -25.12% vs SMA200, -11.22% vs SMA50, -1.75% vs SMA20 |
| Momentum | RSI(14) 41.9 (neutral) |
| Volatility | ATR(14) 4.14 (~5.1% of price); beta 1.92 |
| Setup perspective | -48.31% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 20.89, forward P/E 14.00, P/S 3.42, P/B 4.80 | EV/Sales 3.02, EV/EBITDA 14.63 |
| Growth expectations | Earnings growth 2.90%, EPS q/q 5.20% | Analyst mean target $139.18 (28 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 109.65% |
...
- **Volatility risk:** Beta 1.92, ATR 5.1% of price, short float 7.96%. Size positions accordingly.
- **Short interest risk:** short float 7.96% can fuel squeezes both ways around news.
...
|---|---|---|---|
| Price | $80.85 | EV/Sales | 3.02 |
| Market cap | $12.42B | EV/EBITDA | 14.63 |
| Beta | 1.92 | Gross margin | 22.98% |
| RSI(14) | 41.9 | Operating margin | 20.86% |
| ATR(14) | 4.14 | Profit margin | 16.36% |
| SMA20 dist | -1.75% | ROA | 11.68% |
| SMA50 dist | -11.22% | ROE | 27.22% |
| SMA200 dist | -25.12% | Revenue (ttm) | $3.63B |
| 52W high | $156.40 | Revenue growth y/y | 8.20% |
| 52W low | $73.07 | Inst. ownership | 109.65% |
| P/E (ttm) | 20.89 | Insider ownership | 0.64% |
| Forward P/E | 14.00 | Short float | 7.96% |
| PEG (trailing) | 3.15 | Avg volume | 2,961,665 |
| P/S | 3.42 | Employees | 1,993 |
| P/B | 4.80 | Analyst rec (1=buy..5=sell) | 1.4 |

...
Signed file: `ARRY.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $5.19 (2026-08-12, ~15-min delayed) |
| Market cap | $799.30M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-36.38%) with negative half-year (-55.30%). |
...
| Value attractiveness | Reasonable | Forward P/E 5.79, EV/Sales 1.49. |
| Risk level | High | Beta 1.79, ATR 8.5% of price, short float 26.42%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $5.19; 52w high $11.96 (-56.61%); 52w low $4.81 (+7.90%) |
| Trend | -36.38% vs SMA200, -22.35% vs SMA50, -6.34% vs SMA20 |
| Momentum | RSI(14) 39.7 (neutral) |
| Volatility | ATR(14) 0.44 (~8.5% of price); beta 1.79 |
...
| Valuation | P/E —, forward P/E 5.79, P/S 0.67, P/B -3.96 | EV/Sales 1.49, EV/EBITDA 14.81 |
| Growth expectations | Earnings growth -73.20%, EPS q/q -43.70% | Analyst mean target $9.36 (20 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 152.01% |
...
- **Volatility risk:** Beta 1.79, ATR 8.5% of price, short float 26.42%. Size positions accordingly.
...
|---|---|---|---|
| Price | $5.19 | EV/Sales | 1.49 |
| Market cap | $799.30M | EV/EBITDA | 14.81 |
| Beta | 1.79 | Gross margin | 26.76% |
| RSI(14) | 39.7 | Operating margin | 10.88% |
| ATR(14) | 0.44 | Profit margin | -7.25% |
| SMA20 dist | -6.34% | ROA | 3.33% |
| SMA50 dist | -22.35% | ROE | -25.98% |
| SMA200 dist | -36.38% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.81 | Inst. ownership | 152.01% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.79 | Short float | 26.42% |
| PEG (trailing) | 0.63 | Avg volume | 6,571,630 |
| P/S | 0.67 | Employees | 1,200 |
| P/B | -3.96 | Analyst rec (1=buy..5=sell) | 2.0 |

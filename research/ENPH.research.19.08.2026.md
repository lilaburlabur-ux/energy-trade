...
Signed file: `ENPH.research.19.08.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-2.35%) with negative half-year (-14.49%). |
| Fresh setup quality | Poor / broken | -45.57% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 17.05, EV/Sales 3.49. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $39.37; 52w high $72.33 (-45.57%); 52w low $26.12 (+50.73%) |
| Trend | -2.35% vs SMA200, -9.80% vs SMA50, +0.64% vs SMA20 |
| Momentum | RSI(14) 46.2 (neutral) |
| Volatility | ATR(14) 2.40 (~6.1% of price); beta 1.65 |
| Setup perspective | -45.57% from 52w high — base needs to rebuild. |
...
| SMA20 dist | +0.64% | ROA | 2.38% |
| SMA50 dist | -9.80% | ROE | 13.00% |
| SMA200 dist | -2.35% | Revenue (ttm) | $1.33B |

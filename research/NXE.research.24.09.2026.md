...
Signed file: `NXE.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $9.27 (2026-09-24, ~15-min delayed) |
| Market cap | $6.14B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-14.89%) with negative half-year (-20.29%). |
| Fresh setup quality | Poor / broken | -33.41% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -58.22, EV/Sales —. |
| Risk level | Elevated | Beta 1.67, ATR 4.7% of price, short float —. |
...
| Every New Reactor Needs Fuel: 3 Uranium Stocks Positioned for the Nuclear Buildout | 24/7 Wall St. | 2026-09-19 |
| Powering the AI Boom: Uranium’s $95 Spark | MarketBeat | 2026-09-07 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.27; 52w high $13.92 (-33.41%); 52w low $7.56 (+22.62%) |
| Trend | -14.89% vs SMA200, -6.84% vs SMA50, -8.16% vs SMA20 |
| Momentum | RSI(14) 39.0 (neutral) |
| Volatility | ATR(14) 0.43 (~4.7% of price); beta 1.67 |
| Setup perspective | -33.41% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -58.22, P/S —, P/B 4.64 | EV/Sales —, EV/EBITDA -56.28 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $16.44 (2 analysts) |
...
- **Volatility risk:** Beta 1.67, ATR 4.7% of price, short float —. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.27 | EV/Sales | — |
| Market cap | $6.14B | EV/EBITDA | -56.28 |
| Beta | 1.67 | Gross margin | 0.00% |
| RSI(14) | 39.0 | Operating margin | 0.00% |
| ATR(14) | 0.43 | Profit margin | 0.00% |
| SMA20 dist | -8.16% | ROA | -3.39% |
| SMA50 dist | -6.84% | ROE | -17.67% |
| SMA200 dist | -14.89% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.56 | Inst. ownership | 55.23% |
| P/E (ttm) | — | Insider ownership | 6.40% |
| Forward P/E | -58.22 | Short float | — |
| PEG (trailing) | — | Avg volume | 4,712,612 |
| P/S | — | Employees | 142 |
| P/B | 4.64 | Analyst rec (1=buy..5=sell) | 1.6 |

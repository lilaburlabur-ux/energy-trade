...
Signed file: `MPC.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $413.92 (2026-09-16, ~15-min delayed) |
| Market cap | $120.84B |
...
|---|---|---|
| Technical momentum | High | 1Y +133.87%; price +67.11% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 9.70, EV/Sales 0.96. |
| Risk level | Elevated | Beta 0.53, ATR 3.1% of price, short float 3.14%. |
...
|---|---|---|
| This ETF Should Rise as Interest Rates Go Up. Is It Too Late to Get In on the Fun Now? | Barrons.com | 2026-09-16 |
| Stocks to Watch Recap: UBS, Vera Bradley, Dave & Buster’s, Coinbase | The Wall Street Journal | 2026-09-15 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $413.92; 52w high $413.92 (+0.00%); 52w low $160.76 (+157.47%) |
| Trend | +67.11% vs SMA200, +21.42% vs SMA50, +8.66% vs SMA20 |
| Momentum | RSI(14) 80.5 (overbought) |
| Volatility | ATR(14) 12.72 (~3.1% of price); beta 0.53 |
...
| Valuation | P/E 14.35, forward P/E 9.70, P/S 0.78, P/B 6.14 | EV/Sales 0.96, EV/EBITDA 9.65 |
| Growth expectations | Earnings growth 348.00%, EPS q/q 322.50% | Analyst mean target $370.17 (18 analysts) |
...
- **Volatility risk:** Beta 0.53, ATR 3.1% of price, short float 3.14%. Size positions accordingly.
...
|---|---|---|---|
| Price | $413.92 | EV/Sales | 0.96 |
| Market cap | $120.84B | EV/EBITDA | 9.65 |
| Beta | 0.53 | Gross margin | 12.82% |
| RSI(14) | 80.5 | Operating margin | 13.56% |
| ATR(14) | 12.72 | Profit margin | 5.55% |
| SMA20 dist | +8.66% | ROA | 8.74% |
| SMA50 dist | +21.42% | ROE | 42.10% |
| SMA200 dist | +67.11% | Revenue (ttm) | $154.15B |
| 52W high | $413.92 | Revenue growth y/y | 53.70% |
| 52W low | $160.76 | Inst. ownership | 79.48% |
| P/E (ttm) | 14.35 | Insider ownership | 0.33% |
| Forward P/E | 9.70 | Short float | 3.14% |
| PEG (trailing) | 1.99 | Avg volume | 2,380,553 |
| P/S | 0.78 | Employees | 18,500 |
| P/B | 6.14 | Analyst rec (1=buy..5=sell) | 2.3 |

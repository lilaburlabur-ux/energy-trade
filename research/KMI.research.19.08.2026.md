...
|---|---|---|
| Technical momentum | Moderate | 1Y +27.22%; price +6.01% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 20.87, EV/Sales 5.95. |
| Risk level | Moderate | Beta 0.55, ATR 2.2% of price, short float 2.34%. |
...
| Trend | +6.01% vs SMA200, +0.83% vs SMA50, +0.97% vs SMA20 |
| Momentum | RSI(14) 51.9 (neutral) |
| Volatility | ATR(14) 0.72 (~2.2% of price); beta 0.55 |
...
- **Valuation risk:** Forward P/E 20.87, EV/Sales 5.95. Multiple compression is the main downside if growth disappoints.
...
| SMA20 dist | +0.97% | ROA | 4.45% |
| SMA50 dist | +0.83% | ROE | 10.99% |
| SMA200 dist | +6.01% | Revenue (ttm) | $17.96B |

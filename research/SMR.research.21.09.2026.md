...
Signed file: `SMR.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $8.79 (2026-09-21, ~15-min delayed) |
| Market cap | $3.61B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-29.68%) with negative half-year (-23.16%). |
| Fresh setup quality | Poor / broken | -83.55% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -13.32, EV/Sales 213.36. |
| Risk level | High | Beta 2.31, ATR 8.5% of price, short float 17.60%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $8.79; 52w high $53.43 (-83.55%); 52w low $7.59 (+15.81%) |
| Trend | -29.68% vs SMA200, -2.71% vs SMA50, -5.89% vs SMA20 |
| Momentum | RSI(14) 46.8 (neutral) |
| Volatility | ATR(14) 0.74 (~8.5% of price); beta 2.31 |
| Setup perspective | -83.55% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -13.32, P/S 337.45, P/B 1.75 | EV/Sales 213.36, EV/EBITDA -10.18 |
...
- **Volatility risk:** Beta 2.31, ATR 8.5% of price, short float 17.60%. Size positions accordingly.
...
|---|---|---|---|
| Price | $8.79 | EV/Sales | 213.36 |
| Market cap | $3.61B | EV/EBITDA | -10.18 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 46.8 | Operating margin | -85337.33% |
| ATR(14) | 0.74 | Profit margin | 0.00% |
| SMA20 dist | -5.89% | ROA | -10.60% |
| SMA50 dist | -2.71% | ROE | -55.18% |
| SMA200 dist | -29.68% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.47% |
| P/E (ttm) | — | Insider ownership | 1.70% |
| Forward P/E | -13.32 | Short float | 17.60% |
| PEG (trailing) | — | Avg volume | 32,964,792 |
| P/S | 337.45 | Employees | 428 |
| P/B | 1.75 | Analyst rec (1=buy..5=sell) | 2.7 |

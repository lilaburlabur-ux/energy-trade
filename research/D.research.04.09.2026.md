...
Signed file: `D.research.04.09.2026`

| Field | Value |
|---|---|
| Current price | $65.84 (2026-09-04, ~15-min delayed) |
| Market cap | $57.91B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +16.94%; price +3.75% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 17.26, EV/Sales 6.52. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $65.84; 52w high $71.69 (-8.16%); 52w low $55.92 (+17.74%) |
| Trend | +3.75% vs SMA200, -4.22% vs SMA50, -2.02% vs SMA20 |
| Momentum | RSI(14) 38.5 (neutral) |
| Volatility | ATR(14) 1.13 (~1.7% of price); beta 0.62 |
...
| Valuation | P/E 22.78, forward P/E 17.26, P/S 3.20, P/B 2.07 | EV/Sales 6.52, EV/EBITDA 14.15 |
...
|---|---|---|---|
| Price | $65.84 | EV/Sales | 6.52 |
| Market cap | $57.91B | EV/EBITDA | 14.15 |
| Beta | 0.62 | Gross margin | 46.22% |
| RSI(14) | 38.5 | Operating margin | 29.22% |
| ATR(14) | 1.13 | Profit margin | 13.98% |
| SMA20 dist | -2.02% | ROA | 3.04% |
| SMA50 dist | -4.22% | ROE | 8.28% |
| SMA200 dist | +3.75% | Revenue (ttm) | $18.12B |

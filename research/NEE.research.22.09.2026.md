...
Signed file: `NEE.research.22.09.2026`

| Field | Value |
|---|---|
| Current price | $79.26 (2026-09-22, ~15-min delayed) |
| Market cap | $165.33B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-8.33%) with negative half-year (-10.85%). |
...
| Value attractiveness | Reasonable | Forward P/E 18.03, EV/Sales 9.91. |
| Risk level | Moderate | Beta 0.64, ATR 1.5% of price, short float 0.00%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $79.26; 52w high $96.44 (-17.82%); 52w low $70.30 (+12.75%) |
| Trend | -8.33% vs SMA200, -6.42% vs SMA50, -3.50% vs SMA20 |
| Momentum | RSI(14) 29.0 (oversold) |
| Volatility | ATR(14) 1.22 (~1.5% of price); beta 0.64 |
...
| Valuation | P/E 17.81, forward P/E 18.03, P/S 5.76, P/B 2.89 | EV/Sales 9.91, EV/EBITDA 19.49 |
...
|---|---|---|---|
| Price | $79.26 | EV/Sales | 9.91 |
| Market cap | $165.33B | EV/EBITDA | 19.49 |
| Beta | 0.64 | Gross margin | 61.02% |
| RSI(14) | 29.0 | Operating margin | 31.52% |
| ATR(14) | 1.22 | Profit margin | 32.40% |
| SMA20 dist | -3.50% | ROA | 2.44% |
| SMA50 dist | -6.42% | ROE | 11.68% |
| SMA200 dist | -8.33% | Revenue (ttm) | $28.70B |
| 52W high | $96.44 | Revenue growth y/y | 12.40% |
| 52W low | $70.30 | Inst. ownership | 87.02% |
| P/E (ttm) | 17.81 | Insider ownership | 0.12% |
| Forward P/E | 18.03 | Short float | 0.00% |
| PEG (trailing) | 1.61 | Avg volume | 11,057,222 |
| P/S | 5.76 | Employees | 17,400 |
| P/B | 2.89 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `BWXT.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $147.47 (2026-09-21, ~15-min delayed) |
| Market cap | $13.51B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-22.78%) with negative half-year (-25.96%). |
| Fresh setup quality | Poor / broken | -37.97% from 52w high — base needs to rebuild. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $147.47; 52w high $237.73 (-37.97%); 52w low $145.66 (+1.24%) |
| Trend | -22.78% vs SMA200, -9.49% vs SMA50, -3.31% vs SMA20 |
| Momentum | RSI(14) 38.1 (neutral) |
| Volatility | ATR(14) 5.13 (~3.5% of price); beta 0.74 |
| Setup perspective | -37.97% from 52w high — base needs to rebuild. |
...
|---|---|---|---|
| Price | $147.47 | EV/Sales | 4.25 |
| Market cap | $13.51B | EV/EBITDA | 31.32 |
| Beta | 0.74 | Gross margin | 22.08% |
| RSI(14) | 38.1 | Operating margin | 10.39% |
| ATR(14) | 5.13 | Profit margin | 10.11% |
| SMA20 dist | -3.31% | ROA | 5.53% |
| SMA50 dist | -9.49% | ROE | 28.29% |
| SMA200 dist | -22.78% | Revenue (ttm) | $3.51B |

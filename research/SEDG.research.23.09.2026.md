...
Signed file: `SEDG.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $33.35 (2026-09-23, ~15-min delayed) |
| Market cap | $2.05B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-20.80%) with negative half-year (-28.63%). |
| Fresh setup quality | Poor / broken | -57.52% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-20.29%). |
| Value attractiveness | Low (expensive) | Forward P/E 38.77, EV/Sales 1.44. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $33.35; 52w high $78.51 (-57.52%); 52w low $28.47 (+17.14%) |
| Trend | -20.80% vs SMA200, -11.18% vs SMA50, -2.28% vs SMA20 |
| Momentum | RSI(14) 44.6 (neutral) |
| Volatility | ATR(14) 2.83 (~8.5% of price); beta 1.44 |
| Setup perspective | -57.52% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 38.77, P/S 1.54, P/B 4.98 | EV/Sales 1.44, EV/EBITDA -15.79 |
...
- **Valuation risk:** Forward P/E 38.77, EV/Sales 1.44. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $33.35 | EV/Sales | 1.44 |
| Market cap | $2.05B | EV/EBITDA | -15.79 |
| Beta | 1.44 | Gross margin | 21.25% |
| RSI(14) | 44.6 | Operating margin | -6.51% |
| ATR(14) | 2.83 | Profit margin | -20.29% |
| SMA20 dist | -2.28% | ROA | -3.84% |
| SMA50 dist | -11.18% | ROE | -58.42% |
| SMA200 dist | -20.80% | Revenue (ttm) | $1.33B |
| 52W high | $78.51 | Revenue growth y/y | 19.60% |
| 52W low | $28.47 | Inst. ownership | 101.70% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 38.77 | Short float | 25.50% |
| PEG (trailing) | — | Avg volume | 3,095,520 |
| P/S | 1.54 | Employees | 3,576 |
| P/B | 4.98 | Analyst rec (1=buy..5=sell) | 3.0 |

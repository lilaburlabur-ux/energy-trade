...
Signed file: `BKR.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $61.73 (2026-08-04, ~15-min delayed) |
| Market cap | $61.28B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +44.32%; price +9.33% vs SMA200. |
| Fresh setup quality | Moderate / wait | -11.10% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 11.17%, revenue growth -2.40%. |
| Value attractiveness | Reasonable | Forward P/E 19.51, EV/Sales 2.16. |
| Risk level | Elevated | Beta 0.96, ATR 3.2% of price, short float 3.06%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $61.73; 52w high $69.44 (-11.10%); 52w low $42.01 (+46.94%) |
| Trend | +9.33% vs SMA200, +3.61% vs SMA50, +6.46% vs SMA20 |
| Momentum | RSI(14) 62.3 (neutral) |
| Volatility | ATR(14) 1.96 (~3.2% of price); beta 0.96 |
| Setup perspective | -11.10% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 19.85, forward P/E 19.51, P/S 2.21, P/B 3.05 | EV/Sales 2.16, EV/EBITDA 12.35 |
...
- **Volatility risk:** Beta 0.96, ATR 3.2% of price, short float 3.06%. Size positions accordingly.
...
|---|---|---|---|
| Price | $61.73 | EV/Sales | 2.16 |
| Market cap | $61.28B | EV/EBITDA | 12.35 |
| Beta | 0.96 | Gross margin | 23.66% |
| RSI(14) | 62.3 | Operating margin | 12.83% |
| ATR(14) | 1.96 | Profit margin | 11.17% |
| SMA20 dist | +6.46% | ROA | 4.85% |
| SMA50 dist | +3.61% | ROE | 16.46% |
| SMA200 dist | +9.33% | Revenue (ttm) | $27.73B |
| 52W high | $69.44 | Revenue growth y/y | -2.40% |
| 52W low | $42.01 | Inst. ownership | 100.16% |
| P/E (ttm) | 19.85 | Insider ownership | 0.15% |
| Forward P/E | 19.51 | Short float | 3.06% |
| PEG (trailing) | 2.08 | Avg volume | 8,887,500 |
| P/S | 2.21 | Employees | 54,000 |
| P/B | 3.05 | Analyst rec (1=buy..5=sell) | 1.7 |

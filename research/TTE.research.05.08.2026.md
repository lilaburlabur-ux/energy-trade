...
Signed file: `TTE.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $84.74 (2026-08-05, ~15-min delayed) |
| Market cap | $188.02B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +48.58%; price +10.05% vs SMA200. |
| Fresh setup quality | Moderate / wait | -9.47% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.08%, revenue growth 27.80%. |
| Value attractiveness | Reasonable | Forward P/E 8.79, EV/Sales 1.16. |
| Risk level | Moderate | Beta 0.06, ATR 2.2% of price, short float 0.26%. |
...
TotalEnergies SE, an integrated energy company, produces and markets oil and biofuels, natural gas, biogas and low-carbon hydrogen, renewables, and electricity in France, the United States, Europe, Brazil, India, and internationally. Its Exploration & Production segment engages in the activities of exploration and production of oil and natural gas, as well as carbon storage. The company's Integrated LNG segment is involved in the upstream and midstream LNG activities, as well as biogas and synthetic methane activities, as well as gas trading.

**Recent headlines (potential catalysts):**

| Headline | Source | Date |
|---|---|---|
| Devon Q2 Earnings Surpass Estimates on Strong Oil Output and Pricing | Zacks | 2026-08-05 |
| Middle East War Triggers New Global Refining Boom | Oilprice.com | 2026-08-05 |
| BP profit more than doubles as Middle East conflict boosts oil prices | Euronews | 2026-08-04 |
| Energy Transfer Q2 Earnings Beat Estimates on NGL Growth, View Up | Zacks | 2026-08-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $84.74; 52w high $93.60 (-9.47%); 52w low $55.92 (+51.53%) |
| Trend | +10.05% vs SMA200, +1.52% vs SMA50, +1.56% vs SMA20 |
| Momentum | RSI(14) 52.9 (neutral) |
| Volatility | ATR(14) 1.84 (~2.2% of price); beta 0.06 |
| Setup perspective | -9.47% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 10.61, forward P/E 8.79, P/S 0.96, P/B 1.47 | EV/Sales 1.16, EV/EBITDA 5.74 |
...
|---|---|---|---|
| Amundi | 207,395,270 | 8.30% | 2026-03-31 |
| Vanguard Capital Management LLC | 56,109,159 | 2.25% | 2026-03-31 |
| Capital International Investors | 52,493,616 | 2.10% | 2026-03-31 |
| Capital World Investors | 48,349,190 | 1.94% | 2026-03-31 |
| Deutsche Bank AG | 42,925,687 | 1.72% | 2026-03-31 |
| JPMORGAN CHASE & CO | 33,012,133 | 1.32% | 2026-03-31 |
| Caisse Des Depots Et Consignations | 30,368,297 | 1.22% | 2026-06-30 |
| Goldman Sachs Group Inc | 27,239,924 | 1.09% | 2026-03-31 |
| Wellington Management Group, LLP | 22,291,231 | 0.89% | 2026-03-31 |
...
|---|---|---|---|
| Price | $84.74 | EV/Sales | 1.16 |
| Market cap | $188.02B | EV/EBITDA | 5.74 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 52.9 | Operating margin | 12.79% |
| ATR(14) | 1.84 | Profit margin | 9.08% |
| SMA20 dist | +1.56% | ROA | 5.51% |
| SMA50 dist | +1.52% | ROE | 14.48% |
| SMA200 dist | +10.05% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 57.53% |
| P/E (ttm) | 10.61 | Insider ownership | 8.86% |
| Forward P/E | 8.79 | Short float | 0.26% |
| PEG (trailing) | 0.72 | Avg volume | 1,519,401 |
| P/S | 0.96 | Employees | 94,847 |
| P/B | 1.47 | Analyst rec (1=buy..5=sell) | 2.1 |
...
| 2026-01-08 | main | Piper Sandler | Neutral → Neutral |
...
| Source | URL | Used for |
|---|---|---|
| Yahoo Finance quote/profile/statistics for TTE | https://finance.yahoo.com/quote/TTE | Snapshot metrics, ownership, analyst data |
| Yahoo Finance price history (via yfinance) | https://finance.yahoo.com/quote/TTE/history | SMA/RSI/ATR/performance calculations |
| Yahoo Finance news feed | https://finance.yahoo.com/quote/TTE/news | Catalyst headlines |

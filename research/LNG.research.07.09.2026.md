...
Signed file: `LNG.research.07.09.2026`

| Field | Value |
|---|---|
| Current price | $292.00 (2026-09-07, ~15-min delayed) |
| Market cap | $60.31B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +24.44%; price +21.96% vs SMA200. |
| Fresh setup quality | Moderate / wait | -1.30% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 13.94%, revenue growth 22.70%. |
| Value attractiveness | Reasonable | Forward P/E 14.06, EV/Sales 4.42. |
| Risk level | Moderate | Beta -0.00, ATR 2.6% of price, short float 2.15%. |
...
| BE, P, ILMN Join S&P 500; LNG Misses Out — Bloom Energy Stock Gains While Cheniere Energy Slips | Stocktwits | 2026-09-04 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $292.00; 52w high $295.86 (-1.30%); 52w low $187.49 (+55.74%) |
| Trend | +21.96% vs SMA200, +9.92% vs SMA50, +4.65% vs SMA20 |
| Momentum | RSI(14) 65.2 (neutral) |
| Volatility | ATR(14) 7.60 (~2.6% of price); beta -0.00 |
| Setup perspective | -1.30% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 22.12, forward P/E 14.06, P/S 2.88, P/B 9.81 | EV/Sales 4.42, EV/EBITDA 11.81 |
...
|---|---|---|---|
| Price | $292.00 | EV/Sales | 4.42 |
| Market cap | $60.31B | EV/EBITDA | 11.81 |
| Beta | -0.00 | Gross margin | 36.85% |
| RSI(14) | 65.2 | Operating margin | 75.00% |
| ATR(14) | 7.60 | Profit margin | 13.94% |
| SMA20 dist | +4.65% | ROA | 8.63% |
| SMA50 dist | +9.92% | ROE | 39.12% |
| SMA200 dist | +21.96% | Revenue (ttm) | $20.92B |
| 52W high | $295.86 | Revenue growth y/y | 22.70% |
| 52W low | $187.49 | Inst. ownership | 91.75% |
| P/E (ttm) | 22.12 | Insider ownership | 0.66% |
| Forward P/E | 14.06 | Short float | 2.15% |
| PEG (trailing) | — | Avg volume | 1,933,247 |
| P/S | 2.88 | Employees | 1,717 |
| P/B | 9.81 | Analyst rec (1=buy..5=sell) | 1.4 |

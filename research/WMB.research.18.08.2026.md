...
Signed file: `WMB.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $75.13 (2026-08-18, ~15-min delayed) |
| Market cap | $91.90B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +34.90%; price +9.59% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 28.11, EV/Sales 9.95. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $75.13; 52w high $78.82 (-4.68%); 52w low $54.78 (+37.14%) |
| Trend | +9.59% vs SMA200, +2.53% vs SMA50, +3.78% vs SMA20 |
| Momentum | RSI(14) 57.4 (neutral) |
| Volatility | ATR(14) 1.90 (~2.5% of price); beta 0.61 |
...
| Valuation | P/E 29.93, forward P/E 28.11, P/S 7.46, P/B 6.98 | EV/Sales 9.95, EV/EBITDA 17.44 |
...
- **Valuation risk:** Forward P/E 28.11, EV/Sales 9.95. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $75.13 | EV/Sales | 9.95 |
| Market cap | $91.90B | EV/EBITDA | 17.44 |
| Beta | 0.61 | Gross margin | 63.64% |
| RSI(14) | 57.4 | Operating margin | 39.54% |
| ATR(14) | 1.90 | Profit margin | 24.94% |
| SMA20 dist | +3.78% | ROA | 5.03% |
| SMA50 dist | +2.53% | ROE | 21.50% |
| SMA200 dist | +9.59% | Revenue (ttm) | $12.32B |
| 52W high | $78.82 | Revenue growth y/y | 7.80% |
| 52W low | $54.78 | Inst. ownership | 91.48% |
| P/E (ttm) | 29.93 | Insider ownership | 0.45% |
| Forward P/E | 28.11 | Short float | 2.44% |
| PEG (trailing) | 2.45 | Avg volume | 6,956,188 |

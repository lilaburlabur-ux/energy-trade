...
Signed file: `SMR.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $9.05 (2026-08-24, ~15-min delayed) |
| Market cap | $3.71B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-34.55%) with negative half-year (-28.17%). |
| Fresh setup quality | Poor / broken | -83.06% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -13.88, EV/Sales 256.74. |
...
|---|---|---|
| I Love NuScale Stock for 1 Reason, and It's Not What You Think | Motley Fool | 2026-08-23 |
| NuScale Power (SMR) Shares Moved, So What Is Behind the Attention? | Simply Wall St. | 2026-08-22 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.05; 52w high $53.43 (-83.06%); 52w low $7.59 (+19.24%) |
| Trend | -34.55% vs SMA200, -2.60% vs SMA50, -0.84% vs SMA20 |
| Momentum | RSI(14) 48.6 (neutral) |
| Volatility | ATR(14) 0.68 (~7.5% of price); beta 2.31 |
| Setup perspective | -83.06% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -13.88, P/S 347.43, P/B 2.47 | EV/Sales 256.74, EV/EBITDA -12.25 |
...
|---|---|---|---|
| Price | $9.05 | EV/Sales | 256.74 |
| Market cap | $3.71B | EV/EBITDA | -12.25 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 48.6 | Operating margin | -85337.33% |
| ATR(14) | 0.68 | Profit margin | 0.00% |
| SMA20 dist | -0.84% | ROA | -10.60% |
| SMA50 dist | -2.60% | ROE | -55.18% |
| SMA200 dist | -34.55% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.33% |
| P/E (ttm) | — | Insider ownership | 1.69% |
| Forward P/E | -13.88 | Short float | 19.43% |
| PEG (trailing) | — | Avg volume | 32,780,372 |
| P/S | 347.43 | Employees | 428 |
| P/B | 2.47 | Analyst rec (1=buy..5=sell) | 2.6 |

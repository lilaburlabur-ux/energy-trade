...
Signed file: `NXE.research.24.08.2026`
...
|---|---|---|
| Technical momentum | High | 1Y +65.86%; price +1.99% vs SMA200. |
| Fresh setup quality | Moderate / wait | -21.48% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -61.70, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.93; 52w high $13.92 (-21.48%); 52w low $7.10 (+53.94%) |
| Trend | +1.99% vs SMA200, +11.41% vs SMA50, +8.01% vs SMA20 |
| Momentum | RSI(14) 61.6 (neutral) |
| Volatility | ATR(14) 0.51 (~4.6% of price); beta 1.65 |
| Setup perspective | -21.48% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | +8.01% | ROA | -3.39% |
| SMA50 dist | +11.41% | ROE | -17.67% |
| SMA200 dist | +1.99% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.10 | Inst. ownership | 55.23% |
| P/E (ttm) | — | Insider ownership | 6.39% |
| Forward P/E | -61.70 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,611,537 |
| P/S | — | Employees | 142 |
| P/B | 5.47 | Analyst rec (1=buy..5=sell) | 1.5 |

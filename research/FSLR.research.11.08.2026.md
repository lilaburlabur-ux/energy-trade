...
Signed file: `FSLR.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $240.91 (2026-08-11, ~15-min delayed) |
| Market cap | $25.89B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +30.47%; price +2.70% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.36, EV/Sales 4.50. |
| Risk level | High | Beta 1.75, ATR 5.9% of price, short float 12.03%. |
...
| Why Is FSLR Stock Rising Premarket Today? | Stocktwits | 2026-08-11 |
| First Solar Stock: Analyst Estimates & Ratings | Barchart | 2026-08-10 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $240.91; 52w high $318.25 (-24.30%); 52w low $180.05 (+33.80%) |
| Trend | +2.70% vs SMA200, -0.02% vs SMA50, +9.78% vs SMA20 |
| Momentum | RSI(14) 57.5 (neutral) |
| Volatility | ATR(14) 14.32 (~5.9% of price); beta 1.75 |
...
| Valuation | P/E 24.61, forward P/E 10.36, P/S 4.81, P/B 2.51 | EV/Sales 4.50, EV/EBITDA 10.14 |
...
- **Volatility risk:** Beta 1.75, ATR 5.9% of price, short float 12.03%. Size positions accordingly.
...
|---|---|---|---|
| Price | $240.91 | EV/Sales | 4.50 |
| Market cap | $25.89B | EV/EBITDA | 10.14 |
| Beta | 1.75 | Gross margin | 44.02% |
| RSI(14) | 57.5 | Operating margin | 42.64% |
| ATR(14) | 14.32 | Profit margin | 32.46% |
| SMA20 dist | +9.78% | ROA | 8.62% |
| SMA50 dist | -0.02% | ROE | 18.51% |
| SMA200 dist | +2.70% | Revenue (ttm) | $5.38B |
| 52W high | $318.25 | Revenue growth y/y | -3.70% |
| 52W low | $180.05 | Inst. ownership | 98.35% |
| P/E (ttm) | 24.61 | Insider ownership | 5.36% |
| Forward P/E | 10.36 | Short float | 12.03% |
| PEG (trailing) | 0.65 | Avg volume | 2,501,495 |
| P/S | 4.81 | Employees | 7,900 |
| P/B | 2.51 | Analyst rec (1=buy..5=sell) | 2.1 |

...
Signed file: `FANG.research.17.09.2026`
...
|---|---|---|
| Technical momentum | Moderate | 1Y +45.70%; price +8.60% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.63, EV/Sales 4.47. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $196.94; 52w high $211.53 (-6.90%); 52w low $134.06 (+46.90%) |
| Trend | +8.60% vs SMA200, -0.85% vs SMA50, -2.89% vs SMA20 |
| Momentum | RSI(14) 45.4 (neutral) |
| Volatility | ATR(14) 6.78 (~3.4% of price); beta 0.41 |
...
| SMA20 dist | -2.89% | ROA | 1.31% |
| SMA50 dist | -0.85% | ROE | 3.49% |
| SMA200 dist | +8.60% | Revenue (ttm) | $16.25B |

...
Signed file: `NXE.research.27.08.2026`

| Field | Value |
|---|---|
| Current price | $11.07 (2026-08-27, ~15-min delayed) |
| Market cap | $7.42B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +55.70%; price +3.03% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E -63.11, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.07; 52w high $13.92 (-20.47%); 52w low $7.24 (+52.90%) |
| Trend | +3.03% vs SMA200, +12.40% vs SMA50, +7.19% vs SMA20 |
| Momentum | RSI(14) 62.0 (neutral) |
| Volatility | ATR(14) 0.49 (~4.5% of price); beta 1.65 |
...
| Valuation | P/E —, forward P/E -63.11, P/S —, P/B 5.54 | EV/Sales —, EV/EBITDA -66.04 |
...
|---|---|---|---|
| Price | $11.07 | EV/Sales | — |
| Market cap | $7.42B | EV/EBITDA | -66.04 |
| Beta | 1.65 | Gross margin | 0.00% |
| RSI(14) | 62.0 | Operating margin | 0.00% |
| ATR(14) | 0.49 | Profit margin | 0.00% |
| SMA20 dist | +7.19% | ROA | -3.39% |
| SMA50 dist | +12.40% | ROE | -17.67% |
| SMA200 dist | +3.03% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.24 | Inst. ownership | 55.23% |
| P/E (ttm) | — | Insider ownership | 6.39% |
| Forward P/E | -63.11 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,564,968 |
| P/S | — | Employees | 142 |
| P/B | 5.54 | Analyst rec (1=buy..5=sell) | 1.5 |

...
Signed file: `ENPH.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $38.61 (2026-08-21, ~15-min delayed) |
| Market cap | $5.10B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-4.44%) with negative half-year (-17.07%). |
| Fresh setup quality | Poor / broken | -46.62% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 16.72, EV/Sales 3.57. |
| Risk level | High | Beta 1.65, ATR 6.0% of price, short float 20.98%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.61; 52w high $72.33 (-46.62%); 52w low $26.12 (+47.82%) |
| Trend | -4.44% vs SMA200, -10.43% vs SMA50, -1.47% vs SMA20 |
| Momentum | RSI(14) 44.6 (neutral) |
| Volatility | ATR(14) 2.32 (~6.0% of price); beta 1.65 |
| Setup perspective | -46.62% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 38.23, forward P/E 16.72, P/S 3.84, P/B 4.32 | EV/Sales 3.57, EV/EBITDA 24.74 |
...
- **Volatility risk:** Beta 1.65, ATR 6.0% of price, short float 20.98%. Size positions accordingly.
...
|---|---|---|---|
| Price | $38.61 | EV/Sales | 3.57 |
| Market cap | $5.10B | EV/EBITDA | 24.74 |
| Beta | 1.65 | Gross margin | 30.04% |
| RSI(14) | 44.6 | Operating margin | 17.98% |
| ATR(14) | 2.32 | Profit margin | 10.09% |
| SMA20 dist | -1.47% | ROA | 2.38% |
| SMA50 dist | -10.43% | ROE | 13.00% |
| SMA200 dist | -4.44% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 96.78% |
| P/E (ttm) | 38.23 | Insider ownership | 3.03% |
| Forward P/E | 16.72 | Short float | 20.98% |
| PEG (trailing) | 1.10 | Avg volume | 5,991,616 |
| P/S | 3.84 | Employees | 2,872 |
| P/B | 4.32 | Analyst rec (1=buy..5=sell) | 2.5 |

...
Signed file: `PR.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $21.85 (2026-09-24, ~15-min delayed) |
| Market cap | $18.30B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $21.85; 52w high $24.33 (-10.19%); 52w low $11.68 (+87.01%) |
| Trend | +15.78% vs SMA200, -0.34% vs SMA50, -5.39% vs SMA20 |
| Momentum | RSI(14) 42.4 (neutral) |
| Volatility | ATR(14) 0.70 (~3.2% of price); beta 0.48 |
...
- **Volatility risk:** Beta 0.48, ATR 3.2% of price, short float 2.47%. Size positions accordingly.
...
| SMA20 dist | -5.39% | ROA | 7.54% |
| SMA50 dist | -0.34% | ROE | 11.40% |
...
| P/B | 1.52 | Analyst rec (1=buy..5=sell) | 1.3 |

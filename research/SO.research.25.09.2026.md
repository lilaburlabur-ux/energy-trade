...
Signed file: `SO.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $82.88 (2026-09-25, ~15-min delayed) |
| Market cap | $95.34B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-8.92%) with negative half-year (-11.70%). |
| Fresh setup quality | Moderate / wait | -14.99% from 52w high; no clean fresh pivot by default. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $82.88; 52w high $97.49 (-14.99%); 52w low $82.06 (+1.00%) |
| Trend | -8.92% vs SMA200, -8.12% vs SMA50, -4.36% vs SMA20 |
| Momentum | RSI(14) 21.9 (oversold) |
| Volatility | ATR(14) 1.29 (~1.6% of price); beta 0.32 |
| Setup perspective | -14.99% from 52w high; no clean fresh pivot by default. |
...
|---|---|---|---|
| Price | $82.88 | EV/Sales | 5.71 |
| Market cap | $95.34B | EV/EBITDA | 12.08 |
| Beta | 0.32 | Gross margin | 48.29% |
| RSI(14) | 21.9 | Operating margin | 29.61% |
| ATR(14) | 1.29 | Profit margin | 15.43% |
| SMA20 dist | -4.36% | ROA | 3.27% |
| SMA50 dist | -8.12% | ROE | 11.48% |
...
|---|---|---|---|
| 2026-09-25 | main | Citigroup | Buy → Buy |

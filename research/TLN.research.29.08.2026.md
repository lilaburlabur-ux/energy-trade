...
Signed file: `TLN.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $296.11 (2026-08-29, ~15-min delayed) |
| Market cap | $14.19B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-17.66%) with negative half-year (-20.18%). |
| Fresh setup quality | Poor / broken | -33.58% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-4.95%). |
| Value attractiveness | Reasonable | Forward P/E 9.62, EV/Sales 6.40. |
...
|---|---|---|
| How Talen Energy Corporation (TLN) Transformed Bankruptcy into a High-Yield Masterclass | Insider Monkey | 2026-08-27 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $296.11; 52w high $445.84 (-33.58%); 52w low $296.11 (+0.00%) |
| Trend | -17.66% vs SMA200, -17.63% vs SMA50, -10.76% vs SMA20 |
| Momentum | RSI(14) 32.4 (neutral) |
| Volatility | ATR(14) 16.68 (~5.6% of price); beta 1.67 |
| Setup perspective | -33.58% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 9.62, P/S 3.79, P/B 8.78 | EV/Sales 6.40, EV/EBITDA 41.17 |
...
|---|---|---|---|
| Price | $296.11 | EV/Sales | 6.40 |
| Market cap | $14.19B | EV/EBITDA | 41.17 |
| Beta | 1.67 | Gross margin | 42.10% |
| RSI(14) | 32.4 | Operating margin | -4.80% |
| ATR(14) | 16.68 | Profit margin | -4.95% |
| SMA20 dist | -10.76% | ROA | 0.92% |
| SMA50 dist | -17.63% | ROE | -12.83% |
| SMA200 dist | -17.66% | Revenue (ttm) | $3.74B |
| 52W high | $445.84 | Revenue growth y/y | 111.20% |
| 52W low | $296.11 | Inst. ownership | 102.20% |
| P/E (ttm) | — | Insider ownership | 1.36% |
| Forward P/E | 9.62 | Short float | 5.05% |
| PEG (trailing) | — | Avg volume | 851,832 |
| P/S | 3.79 | Employees | 1,880 |
| P/B | 8.78 | Analyst rec (1=buy..5=sell) | 1.6 |

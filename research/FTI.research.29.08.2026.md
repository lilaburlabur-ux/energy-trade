...
Signed file: `FTI.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $75.84 (2026-08-29, ~15-min delayed) |
| Market cap | $29.74B |
...
|---|---|---|
| Technical momentum | High | 1Y +108.12%; price +19.59% vs SMA200. |
| Fresh setup quality | Watch | -4.91% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 11.28%, revenue growth 9.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 21.07, EV/Sales 2.90. |
...
| 1 Energy Stock to Research Further and 2 We Turn Down | StockStory | 2026-08-16 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $75.84; 52w high $79.76 (-4.91%); 52w low $35.45 (+113.91%) |
| Trend | +19.59% vs SMA200, +5.36% vs SMA50, +1.37% vs SMA20 |
| Momentum | RSI(14) 54.1 (neutral) |
| Volatility | ATR(14) 2.40 (~3.2% of price); beta 0.74 |
| Setup perspective | -4.91% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 26.52, forward P/E 21.07, P/S 2.85, P/B 9.11 | EV/Sales 2.90, EV/EBITDA 15.22 |
| Growth expectations | Earnings growth 40.60%, EPS q/q 34.60% | Analyst mean target $75.81 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 101.10% |
...
- **Valuation risk:** Forward P/E 21.07, EV/Sales 2.90. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $75.84 | EV/Sales | 2.90 |
| Market cap | $29.74B | EV/EBITDA | 15.22 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 54.1 | Operating margin | 17.69% |
| ATR(14) | 2.40 | Profit margin | 11.28% |
| SMA20 dist | +1.37% | ROA | 9.53% |
| SMA50 dist | +5.36% | ROE | 35.81% |
| SMA200 dist | +19.59% | Revenue (ttm) | $10.42B |
| 52W high | $79.76 | Revenue growth y/y | 9.00% |
| 52W low | $35.45 | Inst. ownership | 101.10% |
| P/E (ttm) | 26.52 | Insider ownership | 1.49% |
| Forward P/E | 21.07 | Short float | 3.35% |
| PEG (trailing) | — | Avg volume | 3,811,714 |
| P/S | 2.85 | Employees | 22,000 |
| P/B | 9.11 | Analyst rec (1=buy..5=sell) | 2.0 |

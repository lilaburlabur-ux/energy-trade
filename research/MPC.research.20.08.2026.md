...
Signed file: `MPC.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $358.23 (2026-08-20, ~15-min delayed) |
| Market cap | $100.60B |
...
|---|---|---|
| Technical momentum | High | 1Y +122.80%; price +55.52% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 11.12, EV/Sales 0.87. |
| Risk level | Elevated | Beta 0.51, ATR 3.1% of price, short float 2.81%. |
...
|---|---|---|
| Marathon Petroleum (MPC) is Up 121% in 2026. Is There Still More Upside? | Insider Monkey | 2026-08-20 |
| Marathon Petroleum (MPC) Stock Looks Fairly Valued On Its 7x Five Year Run | Simply Wall St. | 2026-08-19 |
| ExxonMobil's Return Comes From Somewhere The Index Does Not Go | Trefis | 2026-08-19 |
| Bull of the Day: Valero Energy (VLO) | Zacks | 2026-08-19 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $358.23; 52w high $365.21 (-1.91%); 52w low $160.76 (+122.83%) |
| Trend | +55.52% vs SMA200, +21.51% vs SMA50, +9.79% vs SMA20 |
| Momentum | RSI(14) 71.4 (overbought) |
| Volatility | ATR(14) 10.95 (~3.1% of price); beta 0.51 |
| Setup perspective | -1.91% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 12.43, forward P/E 11.12, P/S 0.65, P/B 5.31 | EV/Sales 0.87, EV/EBITDA 8.73 |
...
- **Volatility risk:** Beta 0.51, ATR 3.1% of price, short float 2.81%. Size positions accordingly.
...
|---|---|---|---|
| Price | $358.23 | EV/Sales | 0.87 |
| Market cap | $100.60B | EV/EBITDA | 8.73 |
| Beta | 0.51 | Gross margin | 12.82% |
| RSI(14) | 71.4 | Operating margin | 13.56% |
| ATR(14) | 10.95 | Profit margin | 5.55% |
| SMA20 dist | +9.79% | ROA | 8.74% |
| SMA50 dist | +21.51% | ROE | 42.10% |
| SMA200 dist | +55.52% | Revenue (ttm) | $154.15B |
| 52W high | $365.21 | Revenue growth y/y | 53.70% |
| 52W low | $160.76 | Inst. ownership | 79.53% |
| P/E (ttm) | 12.43 | Insider ownership | 0.33% |
| Forward P/E | 11.12 | Short float | 2.81% |
| PEG (trailing) | 1.79 | Avg volume | 2,364,038 |
| P/S | 0.65 | Employees | 18,500 |
| P/B | 5.31 | Analyst rec (1=buy..5=sell) | 2.3 |

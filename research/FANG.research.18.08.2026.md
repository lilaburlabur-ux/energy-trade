...
Signed file: `FANG.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $210.02 (2026-08-18, ~15-min delayed) |
| Market cap | $59.08B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +53.39%; price +20.02% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.63% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.03%, revenue growth 52.50%. |
| Value attractiveness | Reasonable | Forward P/E 11.76, EV/Sales 4.68. |
| Risk level | Moderate | Beta 0.42, ATR 2.8% of price, short float 4.26%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $210.02; 52w high $211.36 (-0.63%); 52w low $131.37 (+59.87%) |
| Trend | +20.02% vs SMA200, +10.21% vs SMA50, +6.12% vs SMA20 |
| Momentum | RSI(14) 64.5 (neutral) |
| Volatility | ATR(14) 5.84 (~2.8% of price); beta 0.42 |
| Setup perspective | -0.63% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 40.08, forward P/E 11.76, P/S 3.64, P/B 1.55 | EV/Sales 4.68, EV/EBITDA 6.45 |
...
|---|---|---|---|
| Price | $210.02 | EV/Sales | 4.68 |
| Market cap | $59.08B | EV/EBITDA | 6.45 |
| Beta | 0.42 | Gross margin | 72.35% |
| RSI(14) | 64.5 | Operating margin | 48.47% |
| ATR(14) | 5.84 | Profit margin | 9.03% |
| SMA20 dist | +6.12% | ROA | 1.31% |
| SMA50 dist | +10.21% | ROE | 3.49% |
| SMA200 dist | +20.02% | Revenue (ttm) | $16.25B |
| 52W high | $211.36 | Revenue growth y/y | 52.50% |
| 52W low | $131.37 | Inst. ownership | 73.36% |
| P/E (ttm) | 40.08 | Insider ownership | 27.12% |
| Forward P/E | 11.76 | Short float | 4.26% |
| PEG (trailing) | 21.43 | Avg volume | 2,217,550 |
| P/S | 3.64 | Employees | 1,762 |
| P/B | 1.55 | Analyst rec (1=buy..5=sell) | 1.4 |

...
Signed file: `GEV.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $953.09 (2026-08-26, ~15-min delayed) |
| Market cap | $253.84B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +58.60%; price +9.14% vs SMA200. |
| Fresh setup quality | Moderate / wait | -18.88% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 23.04%, revenue growth 21.90%. |
| Value attractiveness | Low (expensive) | Forward P/E 37.91, EV/Sales 5.78. |
| Risk level | High | Beta 1.03, ATR 5.0% of price, short float 2.98%. |
...
|---|---|---|
| Jim Cramer Says GE Vernova (GEV) Order Book Might Have Gotten Soft | Insider Monkey | 2026-08-26 |
| Is GE Vernova Emerging as a Key Beneficiary of the AI Power Boom? | Zacks | 2026-08-26 |
| Is SEI Worth Buying as Growth Accelerates but Valuation Stays High? | Zacks | 2026-08-26 |
| GE Vernova Offers Quick Solution To AI's Power Turbine Quandary | Investor's Business Daily | 2026-08-25 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $953.09; 52w high $1,174.86 (-18.88%); 52w low $546.95 (+74.26%) |
| Trend | +9.14% vs SMA200, -7.91% vs SMA50, -4.58% vs SMA20 |
| Momentum | RSI(14) 42.4 (neutral) |
| Volatility | ATR(14) 47.84 (~5.0% of price); beta 1.03 |
| Setup perspective | -18.88% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 27.35, forward P/E 37.91, P/S 6.14, P/B 21.23 | EV/Sales 5.78, EV/EBITDA 60.85 |
...
- **Valuation risk:** Forward P/E 37.91, EV/Sales 5.78. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.03, ATR 5.0% of price, short float 2.98%. Size positions accordingly.
...
|---|---|---|---|
| Price | $953.09 | EV/Sales | 5.78 |
| Market cap | $253.84B | EV/EBITDA | 60.85 |
| Beta | 1.03 | Gross margin | 20.57% |
| RSI(14) | 42.4 | Operating margin | 7.47% |
| ATR(14) | 47.84 | Profit margin | 23.04% |
| SMA20 dist | -4.58% | ROA | 2.54% |
| SMA50 dist | -7.91% | ROE | 82.58% |
| SMA200 dist | +9.14% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.65% |
| P/E (ttm) | 27.35 | Insider ownership | 0.13% |
| Forward P/E | 37.91 | Short float | 2.98% |
| PEG (trailing) | 1.57 | Avg volume | 2,815,463 |
| P/S | 6.14 | Employees | 78,000 |
| P/B | 21.23 | Analyst rec (1=buy..5=sell) | 1.5 |

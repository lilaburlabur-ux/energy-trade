...
Signed file: `EOSE.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $3.46 (2026-08-20, ~15-min delayed) |
| Market cap | $1.25B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-61.78%) with negative half-year (-69.78%). |
| Fresh setup quality | Poor / broken | -81.97% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-246.76%). |
| Value attractiveness | Reasonable | Forward P/E -23.14, EV/Sales 11.25. |
| Risk level | High | Beta 2.80, ATR 11.4% of price, short float 32.31%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $3.46; 52w high $19.19 (-81.97%); 52w low $3.14 (+10.19%) |
| Trend | -61.78% vs SMA200, -27.28% vs SMA50, -9.07% vs SMA20 |
| Momentum | RSI(14) 38.1 (neutral) |
| Volatility | ATR(14) 0.40 (~11.4% of price); beta 2.80 |
| Setup perspective | -81.97% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -23.14, P/S 5.84, P/B -1.35 | EV/Sales 11.25, EV/EBITDA -8.47 |
...
- **Volatility risk:** Beta 2.80, ATR 11.4% of price, short float 32.31%. Size positions accordingly.
...
|---|---|---|---|
| Price | $3.46 | EV/Sales | 11.25 |
| Market cap | $1.25B | EV/EBITDA | -8.47 |
| Beta | 2.80 | Gross margin | -84.75% |
| RSI(14) | 38.1 | Operating margin | -121.86% |
| ATR(14) | 0.40 | Profit margin | -246.76% |
| SMA20 dist | -9.07% | ROA | -30.03% |
| SMA50 dist | -27.28% | ROE | — |
| SMA200 dist | -61.78% | Revenue (ttm) | $214.25M |
| 52W high | $19.19 | Revenue growth y/y | 351.40% |
| 52W low | $3.14 | Inst. ownership | 64.43% |
| P/E (ttm) | — | Insider ownership | 1.43% |
| Forward P/E | -23.14 | Short float | 32.31% |
| PEG (trailing) | — | Avg volume | 25,520,056 |
| P/S | 5.84 | Employees | 787 |

...
Signed file: `WMB.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $70.97 (2026-08-24, ~15-min delayed) |
| Market cap | $86.81B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +26.68%; price +3.06% vs SMA200. |
| Fresh setup quality | Moderate / wait | -9.96% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 24.94%, revenue growth 7.80%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 27.08, EV/Sales 9.66. |
| Risk level | Moderate | Beta 0.61, ATR 3.0% of price, short float 2.44%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $70.97; 52w high $78.82 (-9.96%); 52w low $55.08 (+28.84%) |
| Trend | +3.06% vs SMA200, -3.18% vs SMA50, -1.41% vs SMA20 |
| Momentum | RSI(14) 44.4 (neutral) |
| Volatility | ATR(14) 2.10 (~3.0% of price); beta 0.61 |
| Setup perspective | -9.96% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 28.27, forward P/E 27.08, P/S 7.04, P/B 6.60 | EV/Sales 9.66, EV/EBITDA 16.92 |
...
- **Valuation risk:** Forward P/E 27.08, EV/Sales 9.66. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $70.97 | EV/Sales | 9.66 |
| Market cap | $86.81B | EV/EBITDA | 16.92 |
| Beta | 0.61 | Gross margin | 63.64% |
| RSI(14) | 44.4 | Operating margin | 39.54% |
| ATR(14) | 2.10 | Profit margin | 24.94% |
| SMA20 dist | -1.41% | ROA | 5.03% |
| SMA50 dist | -3.18% | ROE | 21.50% |
| SMA200 dist | +3.06% | Revenue (ttm) | $12.32B |
| 52W high | $78.82 | Revenue growth y/y | 7.80% |
| 52W low | $55.08 | Inst. ownership | 91.42% |
| P/E (ttm) | 28.27 | Insider ownership | 0.45% |
| Forward P/E | 27.08 | Short float | 2.44% |
| PEG (trailing) | 2.35 | Avg volume | 6,942,814 |
| P/S | 7.04 | Employees | 5,987 |
| P/B | 6.60 | Analyst rec (1=buy..5=sell) | 1.5 |

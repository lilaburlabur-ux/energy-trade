...
Signed file: `SLB.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $53.32 (2026-09-14, ~15-min delayed) |
| Market cap | $79.13B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +51.61%; price +8.63% vs SMA200. |
| Fresh setup quality | Moderate / wait | -10.82% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 8.53%, revenue growth 5.00%. |
| Value attractiveness | Reasonable | Forward P/E 16.48, EV/Sales 2.56. |
| Risk level | Elevated | Beta 0.77, ATR 3.7% of price, short float 4.25%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $53.32; 52w high $59.79 (-10.82%); 52w low $30.96 (+72.21%) |
| Trend | +8.63% vs SMA200, +3.42% vs SMA50, -3.73% vs SMA20 |
| Momentum | RSI(14) 45.4 (neutral) |
| Volatility | ATR(14) 1.95 (~3.7% of price); beta 0.77 |
| Setup perspective | -10.82% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.01, forward P/E 16.48, P/S 2.18, P/B 3.04 | EV/Sales 2.56, EV/EBITDA 12.61 |
...
- **Volatility risk:** Beta 0.77, ATR 3.7% of price, short float 4.25%. Size positions accordingly.
...
|---|---|---|---|
| Price | $53.32 | EV/Sales | 2.56 |
| Market cap | $79.13B | EV/EBITDA | 12.61 |
| Beta | 0.77 | Gross margin | 16.99% |
| RSI(14) | 45.4 | Operating margin | 12.71% |
| ATR(14) | 1.95 | Profit margin | 8.53% |
| SMA20 dist | -3.73% | ROA | 6.17% |
| SMA50 dist | +3.42% | ROE | 12.91% |
| SMA200 dist | +8.63% | Revenue (ttm) | $36.37B |
| 52W high | $59.79 | Revenue growth y/y | 5.00% |
| 52W low | $30.96 | Inst. ownership | 92.52% |
| P/E (ttm) | 26.01 | Insider ownership | 0.22% |
| Forward P/E | 16.48 | Short float | 4.25% |
| PEG (trailing) | 1.48 | Avg volume | 13,837,603 |
| P/S | 2.18 | Employees | 109,000 |
| P/B | 3.04 | Analyst rec (1=buy..5=sell) | 1.6 |

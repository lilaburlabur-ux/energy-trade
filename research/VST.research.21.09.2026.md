...
Signed file: `VST.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $140.78 (2026-09-21, ~15-min delayed) |
| Market cap | $47.25B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-9.77%) with negative half-year (-3.45%). |
| Fresh setup quality | Poor / broken | -35.13% from 52w high — base needs to rebuild. |
...
| Risk level | Elevated | Beta 1.41, ATR 3.5% of price, short float 3.72%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $140.78; 52w high $217.02 (-35.13%); 52w low $134.52 (+4.65%) |
| Trend | -9.77% vs SMA200, -4.29% vs SMA50, -1.21% vs SMA20 |
| Momentum | RSI(14) 45.2 (neutral) |
| Volatility | ATR(14) 4.93 (~3.5% of price); beta 1.41 |
| Setup perspective | -35.13% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 1.41, ATR 3.5% of price, short float 3.72%. Size positions accordingly.
...
|---|---|---|---|
| Price | $140.78 | EV/Sales | 3.63 |
| Market cap | $47.25B | EV/EBITDA | 10.50 |
| Beta | 1.41 | Gross margin | 38.31% |
| RSI(14) | 45.2 | Operating margin | 13.77% |
| ATR(14) | 4.93 | Profit margin | 11.55% |
| SMA20 dist | -1.21% | ROA | 5.89% |
| SMA50 dist | -4.29% | ROE | 42.96% |

...
Signed file: `DUK.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $121.97 (2026-08-24, ~15-min delayed) |
| Market cap | $95.10B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-0.26%) with negative half-year (-2.88%). |
| Fresh setup quality | Moderate / wait | -7.01% from 52w high; no clean fresh pivot by default. |
...
|---|---|---|
| PG&E Stock Runs On A Legislative Calendar, Not The Market's | Trefis | 2026-08-21 |
| Duke’s Carolinas resource plan targets 18.5 GW new solar by 2041 | Utility Dive | 2026-08-20 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $121.97; 52w high $131.16 (-7.01%); 52w low $111.09 (+9.79%) |
| Trend | -0.26% vs SMA200, -2.09% vs SMA50, -1.18% vs SMA20 |
| Momentum | RSI(14) 45.0 (neutral) |
| Volatility | ATR(14) 2.26 (~1.9% of price); beta 0.37 |
| Setup perspective | -7.01% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.37, forward P/E 17.01, P/S 2.90, P/B 1.77 | EV/Sales 5.73, EV/EBITDA 11.32 |
...
|---|---|---|---|
| Price | $121.97 | EV/Sales | 5.73 |
| Market cap | $95.10B | EV/EBITDA | 11.32 |
| Beta | 0.37 | Gross margin | 51.97% |
| RSI(14) | 45.0 | Operating margin | 27.50% |
| ATR(14) | 2.26 | Profit margin | 16.00% |
| SMA20 dist | -1.18% | ROA | 2.84% |
| SMA50 dist | -2.09% | ROE | 9.86% |
| SMA200 dist | -0.26% | Revenue (ttm) | $32.80B |
| 52W high | $131.16 | Revenue growth y/y | 1.10% |
| 52W low | $111.09 | Inst. ownership | 71.11% |
| P/E (ttm) | 18.37 | Insider ownership | 0.13% |
| Forward P/E | 17.01 | Short float | 2.34% |
| PEG (trailing) | 2.39 | Avg volume | 4,037,514 |
| P/S | 2.90 | Employees | 26,441 |
| P/B | 1.77 | Analyst rec (1=buy..5=sell) | 2.1 |

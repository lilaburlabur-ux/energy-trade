...
Signed file: `XOM.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $165.56 (2026-08-18, ~15-min delayed) |
| Market cap | $680.77B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +59.98%; price +18.32% vs SMA200. |
| Fresh setup quality | Moderate / wait | -2.16% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.07%, revenue growth 44.10%. |
| Value attractiveness | Reasonable | Forward P/E 15.56, EV/Sales 1.95. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $165.56; 52w high $169.22 (-2.16%); 52w low $103.71 (+59.63%) |
| Trend | +18.32% vs SMA200, +12.50% vs SMA50, +6.10% vs SMA20 |
| Momentum | RSI(14) 72.4 (overbought) |
| Volatility | ATR(14) 3.65 (~2.2% of price); beta 0.17 |
| Setup perspective | -2.16% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.31, forward P/E 15.56, P/S 1.89, P/B 2.62 | EV/Sales 1.95, EV/EBITDA 10.34 |
...
|---|---|---|---|
| Price | $165.56 | EV/Sales | 1.95 |
| Market cap | $680.77B | EV/EBITDA | 10.34 |
| Beta | 0.17 | Gross margin | 29.77% |
| RSI(14) | 72.4 | Operating margin | 15.86% |
| ATR(14) | 3.65 | Profit margin | 9.07% |
| SMA20 dist | +6.10% | ROA | 5.52% |
| SMA50 dist | +12.50% | ROE | 12.58% |
| SMA200 dist | +18.32% | Revenue (ttm) | $361.06B |
| 52W high | $169.22 | Revenue growth y/y | 44.10% |
| 52W low | $103.71 | Inst. ownership | 66.16% |
| P/E (ttm) | 21.31 | Insider ownership | 0.08% |
| Forward P/E | 15.56 | Short float | 1.15% |
| PEG (trailing) | 1.26 | Avg volume | 15,990,300 |
| P/S | 1.89 | Employees | 57,900 |
| P/B | 2.62 | Analyst rec (1=buy..5=sell) | 2.4 |

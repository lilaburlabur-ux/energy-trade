...
Signed file: `RUN.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $8.92 (2026-08-24, ~15-min delayed) |
| Market cap | $2.13B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-40.36%) with negative half-year (-55.38%). |
| Fresh setup quality | Poor / broken | -58.34% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 11.59%, revenue growth 52.80%. |
| Value attractiveness | Reasonable | Forward P/E 8.03, EV/Sales 5.30. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $8.92; 52w high $21.41 (-58.34%); 52w low $8.92 (+0.00%) |
| Trend | -40.36% vs SMA200, -21.60% vs SMA50, -9.02% vs SMA20 |
| Momentum | RSI(14) 36.6 (neutral) |
| Volatility | ATR(14) 0.64 (~7.2% of price); beta 2.39 |
| Setup perspective | -58.34% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 6.07, forward P/E 8.03, P/S 0.61, P/B 0.61 | EV/Sales 5.30, EV/EBITDA 21.93 |
...
|---|---|---|---|
| Price | $8.92 | EV/Sales | 5.30 |
| Market cap | $2.13B | EV/EBITDA | 21.93 |
| Beta | 2.39 | Gross margin | 35.29% |
| RSI(14) | 36.6 | Operating margin | 4.00% |
| ATR(14) | 0.64 | Profit margin | 11.59% |
| SMA20 dist | -9.02% | ROA | 0.26% |
| SMA50 dist | -21.60% | ROE | -19.86% |
| SMA200 dist | -40.36% | Revenue (ttm) | $3.48B |
| 52W high | $21.41 | Revenue growth y/y | 52.80% |
| 52W low | $8.92 | Inst. ownership | 116.89% |
| P/E (ttm) | 6.07 | Insider ownership | 2.82% |
| Forward P/E | 8.03 | Short float | 32.19% |
| PEG (trailing) | 3.07 | Avg volume | 10,226,354 |
| P/S | 0.61 | Employees | 9,059 |
| P/B | 0.61 | Analyst rec (1=buy..5=sell) | 2.0 |

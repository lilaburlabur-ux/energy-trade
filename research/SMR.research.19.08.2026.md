...
Signed file: `SMR.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $9.29 (2026-08-19, ~15-min delayed) |
| Market cap | $3.81B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-35.02%) with negative half-year (-34.58%). |
| Fresh setup quality | Poor / broken | -82.61% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -14.34, EV/Sales 227.56. |
| Risk level | High | Beta 2.31, ATR 7.6% of price, short float 19.43%. |
...
| Billionaire Stanley Druckenmiller Just Bought A Top Nuclear Stock Play. George Soros Just Sold Out of It. | 24/7 Wall St. | 2026-08-18 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.29; 52w high $53.43 (-82.61%); 52w low $7.59 (+22.40%) |
| Trend | -35.02% vs SMA200, -0.30% vs SMA50, +2.96% vs SMA20 |
| Momentum | RSI(14) 50.8 (neutral) |
| Volatility | ATR(14) 0.70 (~7.6% of price); beta 2.31 |
| Setup perspective | -82.61% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -14.34, P/S 356.64, P/B 2.53 | EV/Sales 227.56, EV/EBITDA -10.86 |
...
- **Volatility risk:** Beta 2.31, ATR 7.6% of price, short float 19.43%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.29 | EV/Sales | 227.56 |
| Market cap | $3.81B | EV/EBITDA | -10.86 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 50.8 | Operating margin | -85337.33% |
| ATR(14) | 0.70 | Profit margin | 0.00% |
| SMA20 dist | +2.96% | ROA | -10.60% |
| SMA50 dist | -0.30% | ROE | -55.18% |
| SMA200 dist | -35.02% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.33% |
| P/E (ttm) | — | Insider ownership | 1.69% |
| Forward P/E | -14.34 | Short float | 19.43% |
| PEG (trailing) | — | Avg volume | 32,419,166 |
| P/S | 356.64 | Employees | 428 |

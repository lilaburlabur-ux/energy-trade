...
Signed file: `FSLR.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $220.01 (2026-08-18, ~15-min delayed) |
| Market cap | $23.64B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-6.04%) with negative half-year (-2.67%). |
| Fresh setup quality | Poor / broken | -30.87% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 32.46%, revenue growth -3.70%. |
| Value attractiveness | Reasonable | Forward P/E 9.53, EV/Sales 4.07. |
| Risk level | High | Beta 1.75, ATR 5.8% of price, short float 12.45%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $220.01; 52w high $318.25 (-30.87%); 52w low $184.70 (+19.12%) |
| Trend | -6.04% vs SMA200, -5.46% vs SMA50, -0.98% vs SMA20 |
| Momentum | RSI(14) 45.8 (neutral) |
| Volatility | ATR(14) 12.68 (~5.8% of price); beta 1.75 |
| Setup perspective | -30.87% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 22.45, forward P/E 9.53, P/S 4.40, P/B 2.29 | EV/Sales 4.07, EV/EBITDA 9.17 |
...
- **Volatility risk:** Beta 1.75, ATR 5.8% of price, short float 12.45%. Size positions accordingly.
...
|---|---|---|---|
| Price | $220.01 | EV/Sales | 4.07 |
| Market cap | $23.64B | EV/EBITDA | 9.17 |
| Beta | 1.75 | Gross margin | 44.02% |
| RSI(14) | 45.8 | Operating margin | 42.64% |
| ATR(14) | 12.68 | Profit margin | 32.46% |
| SMA20 dist | -0.98% | ROA | 8.62% |
| SMA50 dist | -5.46% | ROE | 18.51% |
| SMA200 dist | -6.04% | Revenue (ttm) | $5.38B |
| 52W high | $318.25 | Revenue growth y/y | -3.70% |
| 52W low | $184.70 | Inst. ownership | 96.86% |
| P/E (ttm) | 22.45 | Insider ownership | 5.36% |
| Forward P/E | 9.53 | Short float | 12.45% |
| PEG (trailing) | 0.61 | Avg volume | 2,491,293 |
| P/S | 4.40 | Employees | 7,900 |

...
Signed file: `BWXT.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $147.52 (2026-09-18, ~15-min delayed) |
| Market cap | $13.52B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-22.81%) with negative half-year (-29.59%). |
| Fresh setup quality | Poor / broken | -37.95% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.11%, revenue growth 18.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 28.01, EV/Sales 4.22. |
| Risk level | Elevated | Beta 0.74, ATR 3.6% of price, short float 4.10%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $147.52; 52w high $237.73 (-37.95%); 52w low $145.66 (+1.28%) |
| Trend | -22.81% vs SMA200, -9.89% vs SMA50, -3.57% vs SMA20 |
| Momentum | RSI(14) 38.1 (neutral) |
| Volatility | ATR(14) 5.24 (~3.6% of price); beta 0.74 |
| Setup perspective | -37.95% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 38.22, forward P/E 28.01, P/S 3.85, P/B 10.13 | EV/Sales 4.22, EV/EBITDA 31.10 |
...
- **Valuation risk:** Forward P/E 28.01, EV/Sales 4.22. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.74, ATR 3.6% of price, short float 4.10%. Size positions accordingly.
...
|---|---|---|---|
| Price | $147.52 | EV/Sales | 4.22 |
| Market cap | $13.52B | EV/EBITDA | 31.10 |
| Beta | 0.74 | Gross margin | 22.08% |
| RSI(14) | 38.1 | Operating margin | 10.39% |
| ATR(14) | 5.24 | Profit margin | 10.11% |
| SMA20 dist | -3.57% | ROA | 5.53% |
| SMA50 dist | -9.89% | ROE | 28.29% |
| SMA200 dist | -22.81% | Revenue (ttm) | $3.51B |
| 52W high | $237.73 | Revenue growth y/y | 18.00% |
| 52W low | $145.66 | Inst. ownership | 94.33% |
| P/E (ttm) | 38.22 | Insider ownership | 0.35% |
| Forward P/E | 28.01 | Short float | 4.10% |
| PEG (trailing) | — | Avg volume | 995,014 |
| P/S | 3.85 | Employees | 11,000 |
| P/B | 10.13 | Analyst rec (1=buy..5=sell) | 1.6 |

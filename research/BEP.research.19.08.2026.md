...
|---|---|---|
| Technical momentum | Moderate | 1Y +37.88%; price +6.91% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E -21.88, EV/Sales 13.22. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $33.52; 52w high $37.09 (-9.63%); 52w low $24.11 (+39.05%) |
| Trend | +6.91% vs SMA200, -0.32% vs SMA50, +0.83% vs SMA20 |
| Momentum | RSI(14) 50.5 (neutral) |
| Volatility | ATR(14) 1.06 (~3.2% of price); beta 0.99 |
...
| SMA20 dist | +0.83% | ROA | 0.42% |
| SMA50 dist | -0.32% | ROE | 0.40% |
| SMA200 dist | +6.91% | Revenue (ttm) | $6.36B |

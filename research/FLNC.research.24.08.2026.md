...
Signed file: `FLNC.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $10.86 (2026-08-24, ~15-min delayed) |
| Market cap | $2.02B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-41.12%) with negative half-year (-32.42%). |
...
| Value attractiveness | Low (expensive) | Forward P/E 71.18, EV/Sales 0.67. |
| Risk level | High | Beta 2.78, ATR 10.2% of price, short float 29.29%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.86; 52w high $32.23 (-66.30%); 52w low $6.75 (+60.89%) |
| Trend | -41.12% vs SMA200, -32.11% vs SMA50, -15.86% vs SMA20 |
| Momentum | RSI(14) 32.6 (neutral) |
| Volatility | ATR(14) 1.11 (~10.2% of price); beta 2.78 |
...
| Valuation | P/E —, forward P/E 71.18, P/S 0.77, P/B 4.17 | EV/Sales 0.67, EV/EBITDA -22.51 |
...
- **Valuation risk:** Forward P/E 71.18, EV/Sales 0.67. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.78, ATR 10.2% of price, short float 29.29%. Size positions accordingly.
...
|---|---|---|---|
| Price | $10.86 | EV/Sales | 0.67 |
| Market cap | $2.02B | EV/EBITDA | -22.51 |
| Beta | 2.78 | Gross margin | 9.36% |
| RSI(14) | 32.6 | Operating margin | -8.85% |
| ATR(14) | 1.11 | Profit margin | -3.07% |
| SMA20 dist | -15.86% | ROA | -2.95% |
| SMA50 dist | -32.11% | ROE | -23.54% |
| SMA200 dist | -41.12% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.75 | Inst. ownership | 85.30% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 71.18 | Short float | 29.29% |
| PEG (trailing) | — | Avg volume | 9,915,995 |
| P/S | 0.77 | Employees | 1,670 |
| P/B | 4.17 | Analyst rec (1=buy..5=sell) | 2.7 |

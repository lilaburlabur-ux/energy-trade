...
Signed file: `FLNC.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $9.05 (2026-09-16, ~15-min delayed) |
| Market cap | $1.68B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-49.21%) with negative half-year (-45.15%). |
| Fresh setup quality | Poor / broken | -71.92% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 70.73, EV/Sales 0.56. |
| Risk level | High | Beta 2.74, ATR 8.3% of price, short float 34.01%. |
...
|---|---|---|
| FLNC Stock Tumbles After-Hours As Houston Plant Delays Force Another Guidance Cut | Stocktwits | 2026-09-16 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.05; 52w high $32.23 (-71.92%); 52w low $7.44 (+21.64%) |
| Trend | -49.21% vs SMA200, -28.41% vs SMA50, -14.29% vs SMA20 |
| Momentum | RSI(14) 31.1 (neutral) |
| Volatility | ATR(14) 0.75 (~8.3% of price); beta 2.74 |
| Setup perspective | -71.92% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 70.73, P/S 0.64, P/B 3.47 | EV/Sales 0.56, EV/EBITDA -18.77 |
...
- **Valuation risk:** Forward P/E 70.73, EV/Sales 0.56. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.74, ATR 8.3% of price, short float 34.01%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.05 | EV/Sales | 0.56 |
| Market cap | $1.68B | EV/EBITDA | -18.77 |
| Beta | 2.74 | Gross margin | 9.36% |
| RSI(14) | 31.1 | Operating margin | -8.85% |
| ATR(14) | 0.75 | Profit margin | -3.07% |
| SMA20 dist | -14.29% | ROA | -2.95% |
| SMA50 dist | -28.41% | ROE | -23.54% |
| SMA200 dist | -49.21% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $7.44 | Inst. ownership | 84.59% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 70.73 | Short float | 34.01% |
| PEG (trailing) | — | Avg volume | 7,643,506 |
| P/S | 0.64 | Employees | 1,670 |

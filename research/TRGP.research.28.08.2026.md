...
Signed file: `TRGP.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $288.95 (2026-08-28, ~15-min delayed) |
| Market cap | $61.96B |
...
|---|---|---|
| Technical momentum | High | 1Y +80.99%; price +24.28% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 23.92, EV/Sales 4.87. |
| Risk level | Elevated | Beta 0.72, ATR 3.1% of price, short float 2.71%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $288.95; 52w high $302.25 (-4.40%); 52w low $143.22 (+101.75%) |
| Trend | +24.28% vs SMA200, +5.55% vs SMA50, +3.86% vs SMA20 |
| Momentum | RSI(14) 56.0 (neutral) |
| Volatility | ATR(14) 9.07 (~3.1% of price); beta 0.72 |
...
| Valuation | P/E 27.60, forward P/E 23.92, P/S 3.70, P/B 19.78 | EV/Sales 4.87, EV/EBITDA 14.83 |
| Growth expectations | Earnings growth 23.30%, EPS q/q 21.50% | Analyst mean target $308.10 (21 analysts) |
...
- **Valuation risk:** Forward P/E 23.92, EV/Sales 4.87. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.72, ATR 3.1% of price, short float 2.71%. Size positions accordingly.
...
|---|---|---|---|
| Price | $288.95 | EV/Sales | 4.87 |
| Market cap | $61.96B | EV/EBITDA | 14.83 |
| Beta | 0.72 | Gross margin | 43.19% |
| RSI(14) | 56.0 | Operating margin | 27.80% |
| ATR(14) | 9.07 | Profit margin | 13.54% |
| SMA20 dist | +3.86% | ROA | 9.24% |
| SMA50 dist | +5.55% | ROE | 70.84% |
| SMA200 dist | +24.28% | Revenue (ttm) | $16.74B |
| 52W high | $302.25 | Revenue growth y/y | 4.20% |
| 52W low | $143.22 | Inst. ownership | 97.48% |
| P/E (ttm) | 27.60 | Insider ownership | 1.38% |
| Forward P/E | 23.92 | Short float | 2.71% |
| PEG (trailing) | — | Avg volume | 1,257,268 |
| P/S | 3.70 | Employees | 3,570 |
| P/B | 19.78 | Analyst rec (1=buy..5=sell) | 1.5 |

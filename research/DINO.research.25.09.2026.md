...
Signed file: `DINO.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $106.82 (2026-09-25, ~15-min delayed) |
| Market cap | $18.99B |
...
|---|---|---|
| Oil Prices Remain High, But These 2 Refiners Keep Outperforming | Zacks | 2026-09-25 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $106.82; 52w high $116.62 (-8.40%); 52w low $44.83 (+138.28%) |
| Trend | +54.87% vs SMA200, +9.79% vs SMA50, -0.88% vs SMA20 |
| Momentum | RSI(14) 55.4 (neutral) |
| Volatility | ATR(14) 4.76 (~4.5% of price); beta 0.69 |
...
- **Volatility risk:** Beta 0.69, ATR 4.5% of price, short float 6.20%. Size positions accordingly.
...
| SMA20 dist | -0.88% | ROA | 9.16% |
| SMA50 dist | +9.79% | ROE | 19.50% |
| SMA200 dist | +54.87% | Revenue (ttm) | $31.23B |
| 52W high | $116.62 | Revenue growth y/y | 53.20% |
| 52W low | $44.83 | Inst. ownership | 89.61% |
| P/E (ttm) | 10.18 | Insider ownership | 5.49% |
| Forward P/E | 9.03 | Short float | 6.20% |
| PEG (trailing) | 1.13 | Avg volume | 2,795,869 |

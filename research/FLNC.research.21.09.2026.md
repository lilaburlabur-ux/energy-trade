...
Signed file: `FLNC.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $7.39 (2026-09-21, ~15-min delayed) |
| Market cap | $1.37B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-58.09%) with negative half-year (-51.16%). |
| Fresh setup quality | Poor / broken | -77.07% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Reasonable | Forward P/E -27.75, EV/Sales 0.45. |
| Risk level | High | Beta 2.74, ATR 10.6% of price, short float 34.01%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $7.39; 52w high $32.23 (-77.07%); 52w low $7.32 (+0.96%) |
| Trend | -58.09% vs SMA200, -39.05% vs SMA50, -25.63% vs SMA20 |
| Momentum | RSI(14) 24.5 (oversold) |
| Volatility | ATR(14) 0.79 (~10.6% of price); beta 2.74 |
| Setup perspective | -77.07% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 2.74, ATR 10.6% of price, short float 34.01%. Size positions accordingly.
...
| SMA20 dist | -25.63% | ROA | -2.95% |
| SMA50 dist | -39.05% | ROE | -23.54% |
| SMA200 dist | -58.09% | Revenue (ttm) | $2.63B |

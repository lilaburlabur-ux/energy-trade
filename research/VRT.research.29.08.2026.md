...
Signed file: `VRT.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $257.08 (2026-08-29, ~15-min delayed) |
| Market cap | $98.97B |
...
|---|---|---|
| Technical momentum | High | 1Y +99.03%; price +0.81% vs SMA200. |
| Fresh setup quality | Poor / broken | -31.66% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 15.09%, revenue growth 24.10%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 28.25, EV/Sales 9.05. |
| Risk level | High | Beta 2.08, ATR 6.0% of price, short float 3.40%. |
...
|---|---|---|
| Vertiv (VRT) Is Down From Its Peak. Is the Selloff Overdone | Insider Monkey | 2026-08-28 |
| SentinelOne Q2 Earnings Beat as Platform Growth Drives Outlook Raise | Zacks | 2026-08-28 |
| Why Is Vertiv (VRT) Up 18.4% Since Last Earnings Report? | Zacks | 2026-08-28 |
| The Vertiv Stock Signal Was Never In The Demand Headline | Trefis | 2026-08-27 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $257.08; 52w high $376.15 (-31.66%); 52w low $121.69 (+111.27%) |
| Trend | +0.81% vs SMA200, -11.14% vs SMA50, -5.37% vs SMA20 |
| Momentum | RSI(14) 42.2 (neutral) |
| Volatility | ATR(14) 15.40 (~6.0% of price); beta 2.08 |
| Setup perspective | -31.66% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 58.16, forward P/E 28.25, P/S 8.62, P/B 20.80 | EV/Sales 9.05, EV/EBITDA 38.78 |
...
- **Valuation risk:** Forward P/E 28.25, EV/Sales 9.05. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.08, ATR 6.0% of price, short float 3.40%. Size positions accordingly.
...
|---|---|---|---|
| Price | $257.08 | EV/Sales | 9.05 |
| Market cap | $98.97B | EV/EBITDA | 38.78 |
| Beta | 2.08 | Gross margin | 38.04% |
| RSI(14) | 42.2 | Operating margin | 20.36% |
| ATR(14) | 15.40 | Profit margin | 15.09% |
| SMA20 dist | -5.37% | ROA | 10.89% |
| SMA50 dist | -11.14% | ROE | 43.94% |
| SMA200 dist | +0.81% | Revenue (ttm) | $11.48B |
| 52W high | $376.15 | Revenue growth y/y | 24.10% |
| 52W low | $121.69 | Inst. ownership | 84.45% |
| P/E (ttm) | 58.16 | Insider ownership | 0.27% |
| Forward P/E | 28.25 | Short float | 3.40% |
| PEG (trailing) | 1.27 | Avg volume | 6,025,012 |
| P/S | 8.62 | Employees | 34,000 |
| P/B | 20.80 | Analyst rec (1=buy..5=sell) | 1.4 |

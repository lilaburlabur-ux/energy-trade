...
Signed file: `LNG.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $266.93 (2026-08-17, ~15-min delayed) |
| Market cap | $55.13B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +15.87%; price +13.98% vs SMA200. |
| Fresh setup quality | Moderate / wait | -9.69% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 13.94%, revenue growth 22.70%. |
| Value attractiveness | Reasonable | Forward P/E 14.34, EV/Sales 4.22. |
| Risk level | Moderate | Beta -0.01, ATR 2.9% of price, short float 1.84%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $266.93; 52w high $295.58 (-9.69%); 52w low $187.49 (+42.37%) |
| Trend | +13.98% vs SMA200, +5.98% vs SMA50, +1.72% vs SMA20 |
| Momentum | RSI(14) 55.6 (neutral) |
| Volatility | ATR(14) 7.83 (~2.9% of price); beta -0.01 |
| Setup perspective | -9.69% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.22, forward P/E 14.34, P/S 2.64, P/B 8.96 | EV/Sales 4.22, EV/EBITDA 11.27 |
...
|---|---|---|---|
| Price | $266.93 | EV/Sales | 4.22 |
| Market cap | $55.13B | EV/EBITDA | 11.27 |
| Beta | -0.01 | Gross margin | 36.85% |
| RSI(14) | 55.6 | Operating margin | 75.00% |
| ATR(14) | 7.83 | Profit margin | 13.94% |
| SMA20 dist | +1.72% | ROA | 8.63% |
| SMA50 dist | +5.98% | ROE | 39.12% |
| SMA200 dist | +13.98% | Revenue (ttm) | $20.92B |
| 52W high | $295.58 | Revenue growth y/y | 22.70% |
| 52W low | $187.49 | Inst. ownership | 91.82% |
| P/E (ttm) | 20.22 | Insider ownership | 0.66% |
| Forward P/E | 14.34 | Short float | 1.84% |
| PEG (trailing) | 9.46 | Avg volume | 2,020,790 |
| P/S | 2.64 | Employees | 1,717 |
| P/B | 8.96 | Analyst rec (1=buy..5=sell) | 1.4 |

...
Signed file: `SU.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $67.68 (2026-08-18, ~15-min delayed) |
| Market cap | $79.16B |
...
|---|---|---|
| Technical momentum | High | 1Y +76.59%; price +20.80% vs SMA200. |
| Fresh setup quality | Moderate / wait | -2.30% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 15.78%, revenue growth 45.90%. |
| Value attractiveness | Reasonable | Forward P/E 11.99, EV/Sales 1.54. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $67.68; 52w high $69.27 (-2.30%); 52w low $37.63 (+79.87%) |
| Trend | +20.80% vs SMA200, +11.09% vs SMA50, +4.54% vs SMA20 |
| Momentum | RSI(14) 64.3 (neutral) |
| Volatility | ATR(14) 1.74 (~2.6% of price); beta 0.57 |
| Setup perspective | -2.30% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 12.53, forward P/E 11.99, P/S 1.41, P/B 2.30 | EV/Sales 1.54, EV/EBITDA 4.47 |
...
|---|---|---|---|
| Price | $67.68 | EV/Sales | 1.54 |
| Market cap | $79.16B | EV/EBITDA | 4.47 |
| Beta | 0.57 | Gross margin | 60.40% |
| RSI(14) | 64.3 | Operating margin | 29.94% |
| ATR(14) | 1.74 | Profit margin | 15.78% |
| SMA20 dist | +4.54% | ROA | 8.58% |
| SMA50 dist | +11.09% | ROE | 19.25% |
| SMA200 dist | +20.80% | Revenue (ttm) | $56.57B |
| 52W high | $69.27 | Revenue growth y/y | 45.90% |
| 52W low | $37.63 | Inst. ownership | 73.02% |
| P/E (ttm) | 12.53 | Insider ownership | 0.01% |
| Forward P/E | 11.99 | Short float | — |
| PEG (trailing) | — | Avg volume | 4,611,914 |
| P/S | 1.41 | Employees | 15,424 |
| P/B | 2.30 | Analyst rec (1=buy..5=sell) | 1.9 |

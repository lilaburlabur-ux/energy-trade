...
Signed file: `HAL.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $34.63 (2026-08-24, ~15-min delayed) |
| Market cap | $28.93B |
...
|---|---|---|
| Technical momentum | High | 1Y +66.51%; price +1.19% vs SMA200. |
| Fresh setup quality | Moderate / wait | -19.08% from 52w high; no clean fresh pivot by default. |
...
| Risk level | Moderate | Beta 0.75, ATR 2.8% of price, short float 5.76%. |
...
| How Strong Quarterly Results And New Tech Partnerships At Halliburton (HAL) Have Changed Its Investment Story | Simply Wall St. | 2026-08-23 |
| Halliburton (HAL) Brings Three Startups Into Its Labs Push Beyond Oilfield Services | Simply Wall St. | 2026-08-22 |
| Halliburton (HAL) Beat Estimates, Is It Still Below Fair Value? | Simply Wall St. | 2026-08-22 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $34.63; 52w high $42.80 (-19.08%); 52w low $21.26 (+62.89%) |
| Trend | +1.19% vs SMA200, +1.61% vs SMA50, +4.18% vs SMA20 |
| Momentum | RSI(14) 54.1 (neutral) |
| Volatility | ATR(14) 0.98 (~2.8% of price); beta 0.75 |
| Setup perspective | -19.08% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.13, forward P/E 11.91, P/S 1.29, P/B 2.62 | EV/Sales 1.59, EV/EBITDA 8.61 |
...
|---|---|---|---|
| Price | $34.63 | EV/Sales | 1.59 |
| Market cap | $28.93B | EV/EBITDA | 8.61 |
| Beta | 0.75 | Gross margin | 15.08% |
| RSI(14) | 54.1 | Operating margin | 12.79% |
| ATR(14) | 0.98 | Profit margin | 7.16% |
| SMA20 dist | +4.18% | ROA | 7.26% |
| SMA50 dist | +1.61% | ROE | 14.92% |
| SMA200 dist | +1.19% | Revenue (ttm) | $22.37B |
| 52W high | $42.80 | Revenue growth y/y | 3.70% |
| 52W low | $21.26 | Inst. ownership | 90.46% |
| P/E (ttm) | 18.13 | Insider ownership | 0.40% |
| Forward P/E | 11.91 | Short float | 5.76% |
| PEG (trailing) | 0.86 | Avg volume | 11,859,224 |
| P/S | 1.29 | Employees | 46,000 |
| P/B | 2.62 | Analyst rec (1=buy..5=sell) | 1.8 |

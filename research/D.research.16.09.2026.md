...
Signed file: `D.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $63.51 (2026-09-16, ~15-min delayed) |
| Market cap | $55.86B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $63.51; 52w high $70.97 (-10.52%); 52w low $55.36 (+14.72%) |
| Trend | +0.76% vs SMA200, -5.98% vs SMA50, -3.08% vs SMA20 |
...
| SMA20 dist | -3.08% | ROA | 3.04% |
| SMA50 dist | -5.98% | ROE | 8.28% |
| SMA200 dist | +0.76% | Revenue (ttm) | $18.12B |
| 52W high | $70.97 | Revenue growth y/y | 17.60% |
| 52W low | $55.36 | Inst. ownership | 83.03% |
| P/E (ttm) | 21.98 | Insider ownership | 0.13% |
| Forward P/E | 16.65 | Short float | 3.09% |
| PEG (trailing) | 2.54 | Avg volume | 4,650,924 |
| P/S | 3.08 | Employees | 15,200 |
| P/B | 2.00 | Analyst rec (1=buy..5=sell) | — |

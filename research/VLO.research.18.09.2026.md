...
Signed file: `VLO.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $413.28 (2026-09-18, ~15-min delayed) |
| Market cap | $118.99B |
...
|---|---|---|
| Technical momentum | High | 1Y +157.86%; price +66.67% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 11.07, EV/Sales 0.95. |
...
|---|---|---|
| Refining Tailwinds and Diversified Operations to Support Par Pacific | Zacks | 2026-09-18 |
| Eni to Study Oil and Gas Potential of Five Senegal Offshore Blocks | Zacks | 2026-09-18 |
| The Zacks Analyst Blog Highlights Applied Materials, Philip Morris, Valero Energy, Crimson Wine and Global Self Storage | Zacks | 2026-09-18 |
| Top Analyst Reports for Applied Materials, Philip Morris & Valero Energy | Zacks | 2026-09-17 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $413.28; 52w high $413.28 (+0.00%); 52w low $153.14 (+169.87%) |
| Trend | +66.67% vs SMA200, +22.52% vs SMA50, +10.69% vs SMA20 |
| Momentum | RSI(14) 80.1 (overbought) |
| Volatility | ATR(14) 12.93 (~3.1% of price); beta 0.57 |
...
| Valuation | P/E 17.24, forward P/E 11.07, P/S 0.90, P/B 4.76 | EV/Sales 0.95, EV/EBITDA 9.38 |
...
- **Volatility risk:** Beta 0.57, ATR 3.1% of price, short float 3.99%. Size positions accordingly.
...
|---|---|---|---|
| Price | $413.28 | EV/Sales | 0.95 |
| Market cap | $118.99B | EV/EBITDA | 9.38 |
| Beta | 0.57 | Gross margin | 16.12% |
| RSI(14) | 80.1 | Operating margin | 12.27% |
| ATR(14) | 12.93 | Profit margin | 5.45% |
| SMA20 dist | +10.69% | ROA | 10.56% |
| SMA50 dist | +22.52% | ROE | 27.64% |
| SMA200 dist | +66.67% | Revenue (ttm) | $132.43B |
| 52W high | $413.28 | Revenue growth y/y | 51.70% |
| 52W low | $153.14 | Inst. ownership | 87.03% |
| P/E (ttm) | 17.24 | Insider ownership | 0.42% |
| Forward P/E | 11.07 | Short float | 3.99% |
| PEG (trailing) | 4.08 | Avg volume | 2,851,785 |
| P/S | 0.90 | Employees | 9,785 |
| P/B | 4.76 | Analyst rec (1=buy..5=sell) | 2.3 |

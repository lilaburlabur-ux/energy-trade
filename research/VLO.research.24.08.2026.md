...
Signed file: `VLO.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $346.00 (2026-08-24, ~15-min delayed) |
| Market cap | $99.62B |
...
|---|---|---|
| Technical momentum | High | 1Y +151.86%; price +50.61% vs SMA200. |
| Fresh setup quality | Moderate / wait | -1.16% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 5.45%, revenue growth 51.70%. |
| Value attractiveness | Reasonable | Forward P/E 11.34, EV/Sales 0.81. |
...
|---|---|---|
| PSX Gains 17.5% in a Month: Can Refining Strength Keep the Run Going? | Zacks | 2026-08-24 |
| Will Tight Product Inventories Boost PARR's Refining Outlook? | Zacks | 2026-08-24 |
| Is DK a Buy Now as Cash Flow Improves Despite Refining Cycle Risks? | Zacks | 2026-08-24 |
| Three-Year ORLEN Deal Enhances EQNR's Crude Sales & European Reach | Zacks | 2026-08-24 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $346.00; 52w high $350.05 (-1.16%); 52w low $142.35 (+143.06%) |
| Trend | +50.61% vs SMA200, +17.61% vs SMA50, +6.88% vs SMA20 |
| Momentum | RSI(14) 68.0 (neutral) |
| Volatility | ATR(14) 10.68 (~3.1% of price); beta 0.55 |
| Setup perspective | -1.16% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 14.43, forward P/E 11.34, P/S 0.75, P/B 3.98 | EV/Sales 0.81, EV/EBITDA 8.01 |
...
|---|---|---|---|
| Price | $346.00 | EV/Sales | 0.81 |
| Market cap | $99.62B | EV/EBITDA | 8.01 |
| Beta | 0.55 | Gross margin | 16.12% |
| RSI(14) | 68.0 | Operating margin | 12.27% |
| ATR(14) | 10.68 | Profit margin | 5.45% |
| SMA20 dist | +6.88% | ROA | 10.56% |
| SMA50 dist | +17.61% | ROE | 27.64% |
| SMA200 dist | +50.61% | Revenue (ttm) | $132.43B |
| 52W high | $350.05 | Revenue growth y/y | 51.70% |
| 52W low | $142.35 | Inst. ownership | 87.01% |
| P/E (ttm) | 14.43 | Insider ownership | 0.42% |
| Forward P/E | 11.34 | Short float | 3.67% |
| PEG (trailing) | 4.08 | Avg volume | 2,888,309 |
| P/S | 0.75 | Employees | 9,785 |
| P/B | 3.98 | Analyst rec (1=buy..5=sell) | 2.4 |

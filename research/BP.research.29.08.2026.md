...
Signed file: `BP.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $42.15 (2026-08-29, ~15-min delayed) |
| Market cap | $108.55B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +27.03%; price +6.19% vs SMA200. |
| Fresh setup quality | Moderate / wait | -9.39% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 2.55%, revenue growth 48.20%. |
| Value attractiveness | Reasonable | Forward P/E 9.51, EV/Sales 2.28. |
...
|---|---|---|
| Sector Update: Energy Stocks Mostly Lower Pre-Bell Friday | MT Newswires | 2026-08-28 |
| Energean plans to buy bp’s Egyptian oil and gas assets for $1bn | Offshore Technology | 2026-08-28 |
| Emerson Electric (EMR) Wins Energy Contracts, Is The Stock Still Undervalued? | Simply Wall St. | 2026-08-27 |
| Sector Update: Energy Stocks Mixed Late Afternoon | MT Newswires | 2026-08-27 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $42.15; 52w high $46.52 (-9.39%); 52w low $31.17 (+35.21%) |
| Trend | +6.19% vs SMA200, +2.75% vs SMA50, -1.39% vs SMA20 |
| Momentum | RSI(14) 47.5 (neutral) |
| Volatility | ATR(14) 0.95 (~2.3% of price); beta -0.21 |
| Setup perspective | -9.39% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.17, forward P/E 9.51, P/S 0.50, P/B 7.47 | EV/Sales 2.28, EV/EBITDA 12.54 |
...
|---|---|---|---|
| Price | $42.15 | EV/Sales | 2.28 |
| Market cap | $108.55B | EV/EBITDA | 12.54 |
| Beta | -0.21 | Gross margin | 28.30% |
| RSI(14) | 47.5 | Operating margin | 13.15% |
| ATR(14) | 0.95 | Profit margin | 2.55% |
| SMA20 dist | -1.39% | ROA | 5.04% |
| SMA50 dist | +2.75% | ROE | 8.87% |
| SMA200 dist | +6.19% | Revenue (ttm) | $215.47B |
| 52W high | $46.52 | Revenue growth y/y | 48.20% |
| 52W low | $31.17 | Inst. ownership | 14.09% |
| P/E (ttm) | 20.17 | Insider ownership | 0.00% |
| Forward P/E | 9.51 | Short float | 0.28% |
| PEG (trailing) | 0.04 | Avg volume | 8,793,579 |
| P/S | 0.50 | Employees | 93,700 |
| P/B | 7.47 | Analyst rec (1=buy..5=sell) | 2.4 |

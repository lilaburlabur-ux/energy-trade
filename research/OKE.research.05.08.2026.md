...
Signed file: `OKE.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $87.24 (2026-08-05, ~15-min delayed) |
| Market cap | $54.96B |
...
| OKE Q2 Earnings Call Highlights Higher Guidance and Project Growth | Zacks | 2026-08-05 |
| Oneok (OKE) Reports Q2 Earnings: What Key Metrics Have to Say | Zacks | 2026-08-05 |
| ONEOK Q2 Earnings Call Highlights | MarketBeat | 2026-08-05 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $87.24; 52w high $94.12 (-7.31%); 52w low $61.95 (+40.82%) |
| Trend | +8.84% vs SMA200, -0.89% vs SMA50, -2.94% vs SMA20 |
| Momentum | RSI(14) 44.3 (neutral) |
| Volatility | ATR(14) 2.48 (~2.8% of price); beta 0.71 |
| Setup perspective | -7.31% from 52w high; no clean fresh pivot by default. |

...
Signed file: `FLNC.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $7.32 (2026-09-18, ~15-min delayed) |
| Market cap | $1.36B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-58.64%) with negative half-year (-54.34%). |
| Fresh setup quality | Poor / broken | -77.29% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 41.21, EV/Sales 0.47. |
| Risk level | High | Beta 2.74, ATR 11.3% of price, short float 34.01%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $7.32; 52w high $32.23 (-77.29%); 52w low $7.32 (+0.00%) |
| Trend | -58.64% vs SMA200, -40.49% vs SMA50, -27.77% vs SMA20 |
| Momentum | RSI(14) 23.7 (oversold) |
| Volatility | ATR(14) 0.82 (~11.3% of price); beta 2.74 |
| Setup perspective | -77.29% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 41.21, P/S 0.52, P/B 2.81 | EV/Sales 0.47, EV/EBITDA -15.76 |
...
- **Valuation risk:** Forward P/E 41.21, EV/Sales 0.47. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.74, ATR 11.3% of price, short float 34.01%. Size positions accordingly.
...
|---|---|---|---|
| Price | $7.32 | EV/Sales | 0.47 |
| Market cap | $1.36B | EV/EBITDA | -15.76 |
| Beta | 2.74 | Gross margin | 9.36% |
| RSI(14) | 23.7 | Operating margin | -8.85% |
| ATR(14) | 0.82 | Profit margin | -3.07% |
| SMA20 dist | -27.77% | ROA | -2.95% |
| SMA50 dist | -40.49% | ROE | -23.54% |
| SMA200 dist | -58.64% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $7.32 | Inst. ownership | 84.59% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 41.21 | Short float | 34.01% |
| PEG (trailing) | — | Avg volume | 8,029,587 |
| P/S | 0.52 | Employees | 1,670 |
| P/B | 2.81 | Analyst rec (1=buy..5=sell) | 2.7 |

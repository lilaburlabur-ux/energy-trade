...
Signed file: `MPLX.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $58.89 (2026-09-14, ~15-min delayed) |
| Market cap | $59.71B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $58.89; 52w high $60.23 (-2.22%); 52w low $44.22 (+33.18%) |
| Trend | +7.33% vs SMA200, +1.48% vs SMA50, -0.50% vs SMA20 |
| Momentum | RSI(14) 49.4 (neutral) |
| Volatility | ATR(14) 0.94 (~1.6% of price); beta 0.46 |
| Setup perspective | -2.22% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 12.66, forward P/E 12.20, P/S 4.96, P/B 4.26 | EV/Sales 7.15, EV/EBITDA 14.07 |

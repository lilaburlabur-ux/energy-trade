...
Signed file: `OKE.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $95.72 (2026-09-10, ~15-min delayed) |
| Market cap | $60.34B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +40.47%; price +14.32% vs SMA200. |
| Fresh setup quality | Watch | -1.84% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 9.29%, revenue growth 52.80%. |
| Value attractiveness | Reasonable | Forward P/E 15.40, EV/Sales 2.37. |
| Risk level | Moderate | Beta 0.72, ATR 2.6% of price, short float 4.48%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $95.72; 52w high $97.51 (-1.84%); 52w low $61.95 (+54.51%) |
| Trend | +14.32% vs SMA200, +4.39% vs SMA50, +0.70% vs SMA20 |
| Momentum | RSI(14) 56.8 (neutral) |
| Volatility | ATR(14) 2.48 (~2.6% of price); beta 0.72 |
| Setup perspective | -1.84% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 16.53, forward P/E 15.40, P/S 1.53, P/B 2.63 | EV/Sales 2.37, EV/EBITDA 12.18 |
...
|---|---|---|---|
| Price | $95.72 | EV/Sales | 2.37 |
| Market cap | $60.34B | EV/EBITDA | 12.18 |
| Beta | 0.72 | Gross margin | 27.21% |
| RSI(14) | 56.8 | Operating margin | 13.25% |
| ATR(14) | 2.48 | Profit margin | 9.29% |
| SMA20 dist | +0.70% | ROA | 5.77% |
| SMA50 dist | +4.39% | ROE | 16.28% |
| SMA200 dist | +14.32% | Revenue (ttm) | $39.37B |
| 52W high | $97.51 | Revenue growth y/y | 52.80% |
| 52W low | $61.95 | Inst. ownership | 84.92% |
| P/E (ttm) | 16.53 | Insider ownership | 0.15% |
| Forward P/E | 15.40 | Short float | 4.48% |
| PEG (trailing) | 1.79 | Avg volume | 3,728,893 |

...
Signed file: `ARRY.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $4.67 (2026-08-28, ~15-min delayed) |
| Market cap | $718.37M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-41.27%) with negative half-year (-35.85%). |
| Fresh setup quality | Poor / broken | -60.95% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.25, EV/Sales 1.40. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.67; 52w high $11.96 (-60.95%); 52w low $4.55 (+2.64%) |
| Trend | -41.27% vs SMA200, -21.81% vs SMA50, -8.45% vs SMA20 |
| Momentum | RSI(14) 36.5 (neutral) |
| Volatility | ATR(14) 0.32 (~6.9% of price); beta 1.79 |
| Setup perspective | -60.95% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 5.25, P/S 0.61, P/B -3.56 | EV/Sales 1.40, EV/EBITDA 13.93 |
...
|---|---|---|---|
| Price | $4.67 | EV/Sales | 1.40 |
| Market cap | $718.37M | EV/EBITDA | 13.93 |
| Beta | 1.79 | Gross margin | 26.76% |
| RSI(14) | 36.5 | Operating margin | 10.88% |
| ATR(14) | 0.32 | Profit margin | -7.25% |
| SMA20 dist | -8.45% | ROA | 3.33% |
| SMA50 dist | -21.81% | ROE | -25.98% |
| SMA200 dist | -41.27% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.55 | Inst. ownership | 148.30% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.25 | Short float | 24.55% |
| PEG (trailing) | 0.56 | Avg volume | 6,665,196 |
| P/S | 0.61 | Employees | 1,200 |
| P/B | -3.56 | Analyst rec (1=buy..5=sell) | 2.0 |

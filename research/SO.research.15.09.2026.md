...
Signed file: `SO.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $85.95 (2026-09-15, ~15-min delayed) |
| Market cap | $98.87B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-5.60%) with negative half-year (-11.84%). |
...
| Value attractiveness | Reasonable | Forward P/E 17.45, EV/Sales 5.82. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $85.95; 52w high $97.49 (-11.84%); 52w low $82.06 (+4.74%) |
| Trend | -5.60% vs SMA200, -6.44% vs SMA50, -3.33% vs SMA20 |
| Momentum | RSI(14) 28.2 (oversold) |
...
| Valuation | P/E 20.71, forward P/E 17.45, P/S 3.28, P/B 2.50 | EV/Sales 5.82, EV/EBITDA 12.33 |
...
|---|---|---|---|
| Price | $85.95 | EV/Sales | 5.82 |
| Market cap | $98.87B | EV/EBITDA | 12.33 |
| Beta | 0.32 | Gross margin | 48.29% |
| RSI(14) | 28.2 | Operating margin | 29.61% |
| ATR(14) | 1.41 | Profit margin | 15.43% |
| SMA20 dist | -3.33% | ROA | 3.27% |
| SMA50 dist | -6.44% | ROE | 11.48% |
| SMA200 dist | -5.60% | Revenue (ttm) | $30.18B |
| 52W high | $97.49 | Revenue growth y/y | 0.10% |
| 52W low | $82.06 | Inst. ownership | 74.23% |
| P/E (ttm) | 20.71 | Insider ownership | 0.10% |
| Forward P/E | 17.45 | Short float | 3.06% |
| PEG (trailing) | 2.06 | Avg volume | 5,768,543 |
| P/S | 3.28 | Employees | 29,502 |
| P/B | 2.50 | Analyst rec (1=buy..5=sell) | 2.7 |

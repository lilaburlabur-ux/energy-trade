...
Signed file: `EOSE.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $3.96 (2026-09-18, ~15-min delayed) |
| Market cap | $1.44B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-50.15%) with negative half-year (-28.26%). |
| Fresh setup quality | Poor / broken | -79.36% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-246.76%). |
| Value attractiveness | Reasonable | Forward P/E -22.82, EV/Sales 11.66. |
| Risk level | High | Beta 2.78, ATR 8.4% of price, short float 30.87%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $3.96; 52w high $19.19 (-79.36%); 52w low $3.04 (+30.26%) |
| Trend | -50.15% vs SMA200, +3.21% vs SMA50, +6.69% vs SMA20 |
| Momentum | RSI(14) 51.7 (neutral) |
| Volatility | ATR(14) 0.33 (~8.4% of price); beta 2.78 |
| Setup perspective | -79.36% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -22.82, P/S 6.73, P/B -1.31 | EV/Sales 11.66, EV/EBITDA -8.78 |
...
- **Volatility risk:** Beta 2.78, ATR 8.4% of price, short float 30.87%. Size positions accordingly.
...
|---|---|---|---|
| Price | $3.96 | EV/Sales | 11.66 |
| Market cap | $1.44B | EV/EBITDA | -8.78 |
| Beta | 2.78 | Gross margin | -84.75% |
| RSI(14) | 51.7 | Operating margin | -121.86% |
| ATR(14) | 0.33 | Profit margin | -246.76% |
| SMA20 dist | +6.69% | ROA | -30.03% |
| SMA50 dist | +3.21% | ROE | — |
| SMA200 dist | -50.15% | Revenue (ttm) | $214.25M |
| 52W high | $19.19 | Revenue growth y/y | 351.40% |
| 52W low | $3.04 | Inst. ownership | 64.48% |
| P/E (ttm) | — | Insider ownership | 1.44% |
| Forward P/E | -22.82 | Short float | 30.87% |
| PEG (trailing) | — | Avg volume | 25,937,117 |
| P/S | 6.73 | Employees | 787 |

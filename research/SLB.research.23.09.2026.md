...
Signed file: `SLB.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $51.87 (2026-09-23, ~15-min delayed) |
| Market cap | $76.98B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +54.34%; price +4.61% vs SMA200. |
| Fresh setup quality | Moderate / wait | -13.25% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 8.53%, revenue growth 5.00%. |
| Value attractiveness | Reasonable | Forward P/E 16.04, EV/Sales 2.39. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $51.87; 52w high $59.79 (-13.25%); 52w low $30.96 (+67.52%) |
| Trend | +4.61% vs SMA200, -0.66% vs SMA50, -5.75% vs SMA20 |
| Momentum | RSI(14) 42.4 (neutral) |
| Volatility | ATR(14) 1.84 (~3.5% of price); beta 0.77 |
| Setup perspective | -13.25% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 25.30, forward P/E 16.04, P/S 2.12, P/B 2.95 | EV/Sales 2.39, EV/EBITDA 11.76 |
...
|---|---|---|---|
| Price | $51.87 | EV/Sales | 2.39 |
| Market cap | $76.98B | EV/EBITDA | 11.76 |
| Beta | 0.77 | Gross margin | 16.99% |
| RSI(14) | 42.4 | Operating margin | 12.71% |
| ATR(14) | 1.84 | Profit margin | 8.53% |
| SMA20 dist | -5.75% | ROA | 6.17% |
| SMA50 dist | -0.66% | ROE | 12.91% |
| SMA200 dist | +4.61% | Revenue (ttm) | $36.37B |
| 52W high | $59.79 | Revenue growth y/y | 5.00% |
| 52W low | $30.96 | Inst. ownership | 92.52% |
| P/E (ttm) | 25.30 | Insider ownership | 0.22% |
| Forward P/E | 16.04 | Short float | 4.25% |
| PEG (trailing) | 1.37 | Avg volume | 13,050,168 |
| P/S | 2.12 | Employees | 109,000 |

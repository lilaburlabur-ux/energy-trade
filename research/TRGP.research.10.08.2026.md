...
Signed file: `TRGP.research.10.08.2026`

| Field | Value |
|---|---|
| Current price | $266.21 (2026-08-10, ~15-min delayed) |
| Market cap | $57.08B |
...
|---|---|---|
| Technical momentum | High | 1Y +62.94%; price +18.86% vs SMA200. |
| Fresh setup quality | Moderate / wait | -6.35% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 13.54%, revenue growth 4.20%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 22.14, EV/Sales 4.46. |
| Risk level | Elevated | Beta 0.72, ATR 3.1% of price, short float 2.27%. |
...
|---|---|---|
| Targa Resources Q2 Earnings Call Highlights | MarketBeat | 2026-08-09 |
| Targa Resources Corp. Q2 2026 Earnings Call Summary | Moby | 2026-08-06 |
| Targa Resources (TRGP) Q2 Earnings: Taking a Look at Key Metrics Versus Estimates | Zacks | 2026-08-06 |
| Targa Resources, Inc. (TRGP) Q2 Earnings Top Estimates | Zacks | 2026-08-06 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $266.21; 52w high $284.25 (-6.35%); 52w low $143.22 (+85.87%) |
| Trend | +18.86% vs SMA200, -0.62% vs SMA50, -1.98% vs SMA20 |
| Momentum | RSI(14) 48.5 (neutral) |
| Volatility | ATR(14) 8.16 (~3.1% of price); beta 0.72 |
| Setup perspective | -6.35% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 25.47, forward P/E 22.14, P/S 3.41, P/B 18.22 | EV/Sales 4.46, EV/EBITDA 13.58 |
| Growth expectations | Earnings growth 23.30%, EPS q/q 21.50% | Analyst mean target $298.90 (21 analysts) |
...
|---|---|---|---|
| Blackrock Inc. | 20,832,687 | 9.71% | 2026-06-30 |
| Wellington Management Group, LLP | 15,043,461 | 7.01% | 2026-03-31 |
| State Street Corporation | 14,226,166 | 6.63% | 2026-06-30 |
| Vanguard Capital Management LLC | 13,950,353 | 6.50% | 2026-03-31 |
| Vanguard Portfolio Management LLC | 11,851,389 | 5.52% | 2026-03-31 |
| Harris Associates L.P. | 8,723,203 | 4.06% | 2026-03-31 |
| Geode Capital Management, LLC | 6,008,324 | 2.80% | 2026-03-31 |
| Tortoise Capital Advisors, LLC | 3,546,761 | 1.65% | 2026-03-31 |
| Blackstone Inc | 3,342,348 | 1.56% | 2026-03-31 |
| Morgan Stanley | 3,218,149 | 1.50% | 2026-03-31 |

## 6. Risk Review and Setup Plan
- **Valuation risk:** Forward P/E 22.14, EV/Sales 4.46. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.72, ATR 3.1% of price, short float 2.27%. Size positions accordingly.
...
|---|---|---|---|
| Price | $266.21 | EV/Sales | 4.46 |
| Market cap | $57.08B | EV/EBITDA | 13.58 |
| Beta | 0.72 | Gross margin | 43.19% |
| RSI(14) | 48.5 | Operating margin | 27.80% |
| ATR(14) | 8.16 | Profit margin | 13.54% |
| SMA20 dist | -1.98% | ROA | 9.24% |
| SMA50 dist | -0.62% | ROE | 70.84% |
| SMA200 dist | +18.86% | Revenue (ttm) | $16.74B |
| 52W high | $284.25 | Revenue growth y/y | 4.20% |
| 52W low | $143.22 | Inst. ownership | 98.21% |
| P/E (ttm) | 25.47 | Insider ownership | 1.37% |
| Forward P/E | 22.14 | Short float | 2.27% |
| PEG (trailing) | — | Avg volume | 1,236,250 |
| P/S | 3.41 | Employees | 3,570 |
| P/B | 18.22 | Analyst rec (1=buy..5=sell) | 1.5 |
...
| Source | URL | Used for |
|---|---|---|
| Yahoo Finance quote/profile/statistics for TRGP | https://finance.yahoo.com/quote/TRGP | Snapshot metrics, ownership, analyst data |
| Yahoo Finance price history (via yfinance) | https://finance.yahoo.com/quote/TRGP/history | SMA/RSI/ATR/performance calculations |
| Yahoo Finance news feed | https://finance.yahoo.com/quote/TRGP/news | Catalyst headlines |

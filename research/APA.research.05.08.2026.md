...
|---|---|---|
| Technical momentum | High | 1Y +96.33%; price +11.34% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 8.40, EV/Sales 2.18. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $34.66; 52w high $43.79 (-20.84%); 52w low $17.45 (+98.61%) |
| Trend | +11.34% vs SMA200, -1.20% vs SMA50, -1.57% vs SMA20 |
| Momentum | RSI(14) 46.8 (neutral) |
| Volatility | ATR(14) 1.30 (~3.8% of price); beta 0.35 |
...
| SMA20 dist | -1.57% | ROA | 9.61% |
| SMA50 dist | -1.20% | ROE | 26.22% |
| SMA200 dist | +11.34% | Revenue (ttm) | $8.37B |

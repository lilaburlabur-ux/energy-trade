...
Signed file: `BKR.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $61.67 (2026-08-05, ~15-min delayed) |
| Market cap | $61.22B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $61.67; 52w high $69.44 (-11.19%); 52w low $42.01 (+46.80%) |
| Trend | +9.05% vs SMA200, +3.66% vs SMA50, +5.98% vs SMA20 |
| Momentum | RSI(14) 62.0 (neutral) |
| Volatility | ATR(14) 1.92 (~3.1% of price); beta 0.96 |
| Setup perspective | -11.19% from 52w high; no clean fresh pivot by default. |
...
- **Volatility risk:** Beta 0.96, ATR 3.1% of price, short float 3.06%. Size positions accordingly.
...
|---|---|---|---|
| Price | $61.67 | EV/Sales | 2.16 |
| Market cap | $61.22B | EV/EBITDA | 12.35 |
| Beta | 0.96 | Gross margin | 23.66% |
| RSI(14) | 62.0 | Operating margin | 12.83% |
| ATR(14) | 1.92 | Profit margin | 11.17% |
| SMA20 dist | +5.98% | ROA | 4.85% |
| SMA50 dist | +3.66% | ROE | 16.46% |
| SMA200 dist | +9.05% | Revenue (ttm) | $27.73B |

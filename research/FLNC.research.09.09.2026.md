...
Signed file: `FLNC.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $10.12 (2026-09-09, ~15-min delayed) |
| Market cap | $1.88B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-43.76%) with negative half-year (-40.05%). |
| Fresh setup quality | Poor / broken | -68.60% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 79.09, EV/Sales 0.65. |
| Risk level | High | Beta 2.74, ATR 8.4% of price, short float 33.35%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.12; 52w high $32.23 (-68.60%); 52w low $6.76 (+49.70%) |
| Trend | -43.76% vs SMA200, -24.92% vs SMA50, -11.12% vs SMA20 |
| Momentum | RSI(14) 35.7 (neutral) |
| Volatility | ATR(14) 0.85 (~8.4% of price); beta 2.74 |
| Setup perspective | -68.60% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 79.09, P/S 0.71, P/B 3.88 | EV/Sales 0.65, EV/EBITDA -21.96 |
...
|---|---|---|---|
| Price | $10.12 | EV/Sales | 0.65 |
| Market cap | $1.88B | EV/EBITDA | -21.96 |
| Beta | 2.74 | Gross margin | 9.36% |
| RSI(14) | 35.7 | Operating margin | -8.85% |
| ATR(14) | 0.85 | Profit margin | -3.07% |
| SMA20 dist | -11.12% | ROA | -2.95% |
| SMA50 dist | -24.92% | ROE | -23.54% |
| SMA200 dist | -43.76% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.76 | Inst. ownership | 85.06% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 79.09 | Short float | 33.35% |
| PEG (trailing) | — | Avg volume | 8,207,370 |
| P/S | 0.71 | Employees | 1,670 |
| P/B | 3.88 | Analyst rec (1=buy..5=sell) | 2.7 |

...
Signed file: `TLN.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $282.15 (2026-09-15, ~15-min delayed) |
| Market cap | $13.52B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-20.73%) with negative half-year (-11.16%). |
| Fresh setup quality | Poor / broken | -36.71% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-4.95%). |
| Value attractiveness | Reasonable | Forward P/E 9.17, EV/Sales 6.12. |
| Risk level | High | Beta 1.63, ATR 5.1% of price, short float 5.69%. |
...
| Bloom Energy Outpaces Its Industry in a Month: Time to Buy the Stock? | Zacks | 2026-09-08 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $282.15; 52w high $445.84 (-36.71%); 52w low $282.15 (+0.00%) |
| Trend | -20.73% vs SMA200, -16.65% vs SMA50, -8.16% vs SMA20 |
| Momentum | RSI(14) 33.3 (neutral) |
| Volatility | ATR(14) 14.52 (~5.1% of price); beta 1.63 |
| Setup perspective | -36.71% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 9.17, P/S 3.61, P/B 8.36 | EV/Sales 6.12, EV/EBITDA 39.32 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $459.94 (17 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 102.11% |
...
- **Volatility risk:** Beta 1.63, ATR 5.1% of price, short float 5.69%. Size positions accordingly.
- **Short interest risk:** short float 5.69% can fuel squeezes both ways around news.
...
|---|---|---|---|
| Price | $282.15 | EV/Sales | 6.12 |
| Market cap | $13.52B | EV/EBITDA | 39.32 |
| Beta | 1.63 | Gross margin | 42.10% |
| RSI(14) | 33.3 | Operating margin | -4.80% |
| ATR(14) | 14.52 | Profit margin | -4.95% |
| SMA20 dist | -8.16% | ROA | 0.92% |
| SMA50 dist | -16.65% | ROE | -12.83% |
| SMA200 dist | -20.73% | Revenue (ttm) | $3.74B |
| 52W high | $445.84 | Revenue growth y/y | 111.20% |
| 52W low | $282.15 | Inst. ownership | 102.11% |
| P/E (ttm) | — | Insider ownership | 1.36% |
| Forward P/E | 9.17 | Short float | 5.69% |
| PEG (trailing) | — | Avg volume | 854,188 |
| P/S | 3.61 | Employees | 1,880 |

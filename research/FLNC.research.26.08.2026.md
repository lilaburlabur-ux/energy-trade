...
Signed file: `FLNC.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $11.08 (2026-08-26, ~15-min delayed) |
| Market cap | $2.06B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-39.63%) with negative half-year (-32.15%). |
| Fresh setup quality | Poor / broken | -65.62% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 65.51, EV/Sales 0.65. |
| Risk level | High | Beta 2.78, ATR 9.5% of price, short float 33.35%. |
...
|---|---|---|
| Stocks making big moves yesterday: Fluence Energy, Paymentus, RLI, Dick's, and Robinhood | StockStory | 2026-08-26 |
| 3 Unprofitable Stocks We Find Risky | StockStory | 2026-08-26 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.08; 52w high $32.23 (-65.62%); 52w low $6.75 (+64.15%) |
| Trend | -39.63% vs SMA200, -28.45% vs SMA50, -13.42% vs SMA20 |
| Momentum | RSI(14) 35.1 (neutral) |
| Volatility | ATR(14) 1.05 (~9.5% of price); beta 2.78 |
| Setup perspective | -65.62% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 65.51, P/S 0.78, P/B 4.25 | EV/Sales 0.65, EV/EBITDA -22.02 |
...
- **Valuation risk:** Forward P/E 65.51, EV/Sales 0.65. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.78, ATR 9.5% of price, short float 33.35%. Size positions accordingly.
...
|---|---|---|---|
| Price | $11.08 | EV/Sales | 0.65 |
| Market cap | $2.06B | EV/EBITDA | -22.02 |
| Beta | 2.78 | Gross margin | 9.36% |
| RSI(14) | 35.1 | Operating margin | -8.85% |
| ATR(14) | 1.05 | Profit margin | -3.07% |
| SMA20 dist | -13.42% | ROA | -2.95% |
| SMA50 dist | -28.45% | ROE | -23.54% |
| SMA200 dist | -39.63% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.75 | Inst. ownership | 85.33% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 65.51 | Short float | 33.35% |
| PEG (trailing) | — | Avg volume | 9,864,330 |
| P/S | 0.78 | Employees | 1,670 |
| P/B | 4.25 | Analyst rec (1=buy..5=sell) | 2.7 |

...
Signed file: `TTE.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $86.33 (2026-08-28, ~15-min delayed) |
| Market cap | $191.02B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +45.42%; price +8.94% vs SMA200. |
| Fresh setup quality | Moderate / wait | -7.77% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.08%, revenue growth 27.80%. |
| Value attractiveness | Reasonable | Forward P/E 8.92, EV/Sales 1.15. |
...
|---|---|---|
| Top Research Reports for Goldman Sachs, TotalEnergies & Prologis | Zacks | 2026-08-27 |
| TotalEnergies exits Arctic LNG 2 with 10% stake sale to NordLine | Offshore Technology | 2026-08-27 |
| TotalEnergies Exits Russia’s Sanctioned Arctic LNG 2 Project | Oilprice.com | 2026-08-27 |
| Equinor starts production at Troll phase three, stage two in North Sea | Offshore Technology | 2026-08-26 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $86.33; 52w high $93.60 (-7.77%); 52w low $55.92 (+54.37%) |
| Trend | +8.94% vs SMA200, +3.33% vs SMA50, -1.70% vs SMA20 |
| Momentum | RSI(14) 47.4 (neutral) |
| Volatility | ATR(14) 1.62 (~1.9% of price); beta 0.06 |
| Setup perspective | -7.77% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 10.80, forward P/E 8.92, P/S 0.97, P/B 1.50 | EV/Sales 1.15, EV/EBITDA 5.69 |
...
|---|---|---|---|
| Price | $86.33 | EV/Sales | 1.15 |
| Market cap | $191.02B | EV/EBITDA | 5.69 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 47.4 | Operating margin | 12.79% |
| ATR(14) | 1.62 | Profit margin | 9.08% |
| SMA20 dist | -1.70% | ROA | 5.51% |
| SMA50 dist | +3.33% | ROE | 14.48% |
| SMA200 dist | +8.94% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 54.32% |
| P/E (ttm) | 10.80 | Insider ownership | 8.86% |
| Forward P/E | 8.92 | Short float | 0.19% |
| PEG (trailing) | 0.70 | Avg volume | 1,601,274 |
| P/S | 0.97 | Employees | 94,847 |
| P/B | 1.50 | Analyst rec (1=buy..5=sell) | 1.0 |

...
Signed file: `SMR.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $9.40 (2026-08-21, ~15-min delayed) |
| Market cap | $3.86B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-32.67%) with negative half-year (-30.06%). |
| Fresh setup quality | Poor / broken | -82.41% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -14.42, EV/Sales 244.07. |
| Risk level | High | Beta 2.31, ATR 7.3% of price, short float 19.43%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.40; 52w high $53.43 (-82.41%); 52w low $7.59 (+23.85%) |
| Trend | -32.67% vs SMA200, +1.05% vs SMA50, +3.28% vs SMA20 |
| Momentum | RSI(14) 51.8 (neutral) |
| Volatility | ATR(14) 0.68 (~7.3% of price); beta 2.31 |
| Setup perspective | -82.41% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -14.42, P/S 360.87, P/B 2.56 | EV/Sales 244.07, EV/EBITDA -11.64 |
...
- **Volatility risk:** Beta 2.31, ATR 7.3% of price, short float 19.43%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.40 | EV/Sales | 244.07 |
| Market cap | $3.86B | EV/EBITDA | -11.64 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 51.8 | Operating margin | -85337.33% |
| ATR(14) | 0.68 | Profit margin | 0.00% |
| SMA20 dist | +3.28% | ROA | -10.60% |
| SMA50 dist | +1.05% | ROE | -55.18% |
| SMA200 dist | -32.67% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.33% |
| P/E (ttm) | — | Insider ownership | 1.69% |
| Forward P/E | -14.42 | Short float | 19.43% |
| PEG (trailing) | — | Avg volume | 32,669,975 |
| P/S | 360.87 | Employees | 428 |

...
Signed file: `ARRY.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $4.48 (2026-09-09, ~15-min delayed) |
| Market cap | $689.95M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-42.63%) with negative half-year (-36.63%). |
| Fresh setup quality | Poor / broken | -62.54% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.00, EV/Sales 1.41. |
| Risk level | High | Beta 1.77, ATR 6.2% of price, short float 24.55%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.48; 52w high $11.96 (-62.54%); 52w low $4.36 (+2.75%) |
| Trend | -42.63% vs SMA200, -17.96% vs SMA50, -4.95% vs SMA20 |
| Momentum | RSI(14) 38.0 (neutral) |
| Volatility | ATR(14) 0.28 (~6.2% of price); beta 1.77 |
| Setup perspective | -62.54% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 5.00, P/S 0.58, P/B -3.41 | EV/Sales 1.41, EV/EBITDA 13.97 |
...
- **Volatility risk:** Beta 1.77, ATR 6.2% of price, short float 24.55%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.48 | EV/Sales | 1.41 |
| Market cap | $689.95M | EV/EBITDA | 13.97 |
| Beta | 1.77 | Gross margin | 26.76% |
| RSI(14) | 38.0 | Operating margin | 10.88% |
| ATR(14) | 0.28 | Profit margin | -7.25% |
| SMA20 dist | -4.95% | ROA | 3.33% |
| SMA50 dist | -17.96% | ROE | -25.98% |
| SMA200 dist | -42.63% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.36 | Inst. ownership | 147.96% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.00 | Short float | 24.55% |
| PEG (trailing) | 0.49 | Avg volume | 6,647,411 |
| P/S | 0.58 | Employees | 1,200 |
| P/B | -3.41 | Analyst rec (1=buy..5=sell) | 2.1 |

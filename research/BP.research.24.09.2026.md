...
Signed file: `BP.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $44.41 (2026-09-24, ~15-min delayed) |
| Market cap | $114.37B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +34.42%; price +9.47% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.43% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 2.55%, revenue growth 48.20%. |
| Value attractiveness | Reasonable | Forward P/E 9.03, EV/Sales 2.38. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $44.41; 52w high $46.96 (-5.43%); 52w low $31.17 (+42.46%) |
| Trend | +9.47% vs SMA200, +2.37% vs SMA50, -0.13% vs SMA20 |
| Momentum | RSI(14) 51.6 (neutral) |
| Volatility | ATR(14) 1.12 (~2.5% of price); beta -0.22 |
| Setup perspective | -5.43% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.15, forward P/E 9.03, P/S 0.53, P/B 7.87 | EV/Sales 2.38, EV/EBITDA 13.11 |
...
|---|---|---|---|
| Price | $44.41 | EV/Sales | 2.38 |
| Market cap | $114.37B | EV/EBITDA | 13.11 |
| Beta | -0.22 | Gross margin | 28.30% |
| RSI(14) | 51.6 | Operating margin | 13.15% |
| ATR(14) | 1.12 | Profit margin | 2.55% |
| SMA20 dist | -0.13% | ROA | 5.04% |
| SMA50 dist | +2.37% | ROE | 8.87% |
| SMA200 dist | +9.47% | Revenue (ttm) | $215.47B |
| 52W high | $46.96 | Revenue growth y/y | 48.20% |
| 52W low | $31.17 | Inst. ownership | 14.09% |
| P/E (ttm) | 21.15 | Insider ownership | 0.00% |
| Forward P/E | 9.03 | Short float | 0.29% |
| PEG (trailing) | 0.06 | Avg volume | 9,281,304 |
| P/S | 0.53 | Employees | 93,700 |
| P/B | 7.87 | Analyst rec (1=buy..5=sell) | 2.4 |

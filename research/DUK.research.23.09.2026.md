...
Signed file: `DUK.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $114.17 (2026-09-23, ~15-min delayed) |
| Market cap | $89.02B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $114.17; 52w high $131.16 (-12.96%); 52w low $111.09 (+2.77%) |
| Trend | -6.66% vs SMA200, -6.67% vs SMA50, -4.42% vs SMA20 |
| Momentum | RSI(14) 26.8 (oversold) |
| Volatility | ATR(14) 1.77 (~1.5% of price); beta 0.36 |
| Setup perspective | -12.96% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | -4.42% | ROA | 2.84% |
| SMA50 dist | -6.67% | ROE | 9.86% |
...
| P/B | 1.66 | Analyst rec (1=buy..5=sell) | 2.1 |

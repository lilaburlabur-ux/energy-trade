...
Signed file: `CEG.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $263.88 (2026-09-23, ~15-min delayed) |
| Market cap | $93.49B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $263.88; 52w high $401.70 (-34.31%); 52w low $236.14 (+11.75%) |
| Trend | -9.34% vs SMA200, -2.73% vs SMA50, -4.69% vs SMA20 |
| Momentum | RSI(14) 43.8 (neutral) |
| Volatility | ATR(14) 9.98 (~3.8% of price); beta 1.12 |
| Setup perspective | -34.31% from 52w high — base needs to rebuild. |
...
| SMA20 dist | -4.69% | ROA | 3.89% |
| SMA50 dist | -2.73% | ROE | 15.06% |
| SMA200 dist | -9.34% | Revenue (ttm) | $31.27B |
| 52W high | $401.70 | Revenue growth y/y | 23.00% |
| 52W low | $236.14 | Inst. ownership | 82.97% |
| P/E (ttm) | 25.82 | Insider ownership | 0.34% |
| Forward P/E | 19.91 | Short float | 3.65% |
| PEG (trailing) | — | Avg volume | 2,976,663 |

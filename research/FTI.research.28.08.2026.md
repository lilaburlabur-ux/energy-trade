...
Signed file: `FTI.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $76.32 (2026-08-28, ~15-min delayed) |
| Market cap | $29.93B |
...
|---|---|---|
| Technical momentum | High | 1Y +111.23%; price +20.65% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 21.21, EV/Sales 2.90. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $76.32; 52w high $79.76 (-4.31%); 52w low $35.45 (+115.26%) |
| Trend | +20.65% vs SMA200, +6.28% vs SMA50, +2.30% vs SMA20 |
| Momentum | RSI(14) 55.9 (neutral) |
| Volatility | ATR(14) 2.47 (~3.2% of price); beta 0.74 |
...
- **Valuation risk:** Forward P/E 21.21, EV/Sales 2.90. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $76.32 | EV/Sales | 2.90 |
| Market cap | $29.93B | EV/EBITDA | 15.22 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 55.9 | Operating margin | 17.69% |
| ATR(14) | 2.47 | Profit margin | 11.28% |
| SMA20 dist | +2.30% | ROA | 9.53% |
| SMA50 dist | +6.28% | ROE | 35.81% |
...
| P/B | 9.16 | Analyst rec (1=buy..5=sell) | 2.0 |

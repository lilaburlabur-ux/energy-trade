...
Signed file: `FLNC.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $10.88 (2026-08-29, ~15-min delayed) |
| Market cap | $2.02B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-40.39%) with negative half-year (-29.99%). |
| Fresh setup quality | Poor / broken | -66.24% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 45.05, EV/Sales 0.67. |
| Risk level | High | Beta 2.78, ATR 9.1% of price, short float 33.35%. |
...
|---|---|---|
| 3 Small-Cap Stocks We Keep Off Our Radar | StockStory | 2026-08-28 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.88; 52w high $32.23 (-66.24%); 52w low $6.75 (+61.19%) |
| Trend | -40.39% vs SMA200, -27.39% vs SMA50, -13.26% vs SMA20 |
| Momentum | RSI(14) 35.3 (neutral) |
| Volatility | ATR(14) 0.99 (~9.1% of price); beta 2.78 |
| Setup perspective | -66.24% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 45.05, P/S 0.77, P/B 4.17 | EV/Sales 0.67, EV/EBITDA -22.68 |
...
- **Valuation risk:** Forward P/E 45.05, EV/Sales 0.67. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.78, ATR 9.1% of price, short float 33.35%. Size positions accordingly.
...
|---|---|---|---|
| Price | $10.88 | EV/Sales | 0.67 |
| Market cap | $2.02B | EV/EBITDA | -22.68 |
| Beta | 2.78 | Gross margin | 9.36% |
| RSI(14) | 35.3 | Operating margin | -8.85% |
| ATR(14) | 0.99 | Profit margin | -3.07% |
| SMA20 dist | -13.26% | ROA | -2.95% |
| SMA50 dist | -27.39% | ROE | -23.54% |
| SMA200 dist | -40.39% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.75 | Inst. ownership | 85.33% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 45.05 | Short float | 33.35% |
| PEG (trailing) | — | Avg volume | 9,792,345 |
| P/S | 0.77 | Employees | 1,670 |
| P/B | 4.17 | Analyst rec (1=buy..5=sell) | 2.6 |

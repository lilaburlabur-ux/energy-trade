...
Signed file: `NXT.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $82.37 (2026-09-09, ~15-min delayed) |
| Market cap | $12.66B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-24.02%) with negative half-year (-27.57%). |
| Fresh setup quality | Poor / broken | -47.33% from 52w high — base needs to rebuild. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $82.37; 52w high $156.40 (-47.33%); 52w low $64.33 (+28.04%) |
| Trend | -24.02% vs SMA200, -16.00% vs SMA50, -7.52% vs SMA20 |
| Momentum | RSI(14) 36.7 (neutral) |
| Volatility | ATR(14) 4.56 (~5.5% of price); beta 1.92 |
| Setup perspective | -47.33% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 21.28, forward P/E 14.27, P/S 3.49, P/B 4.89 | EV/Sales 3.25, EV/EBITDA 15.74 |
...
|---|---|---|---|
| Price | $82.37 | EV/Sales | 3.25 |
| Market cap | $12.66B | EV/EBITDA | 15.74 |
| Beta | 1.92 | Gross margin | 22.98% |
| RSI(14) | 36.7 | Operating margin | 20.86% |
| ATR(14) | 4.56 | Profit margin | 16.36% |
| SMA20 dist | -7.52% | ROA | 11.68% |
| SMA50 dist | -16.00% | ROE | 27.22% |
| SMA200 dist | -24.02% | Revenue (ttm) | $3.63B |
| 52W high | $156.40 | Revenue growth y/y | 8.20% |
| 52W low | $64.33 | Inst. ownership | 109.68% |
| P/E (ttm) | 21.28 | Insider ownership | 0.64% |
| Forward P/E | 14.27 | Short float | 8.04% |
| PEG (trailing) | 3.15 | Avg volume | 2,996,638 |

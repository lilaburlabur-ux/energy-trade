...
Signed file: `EPD.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $38.12 (2026-08-04, ~15-min delayed) |
| Market cap | $82.47B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +32.04%; price +10.79% vs SMA200. |
| Fresh setup quality | Watch | -2.79% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.09, EV/Sales 2.00. |
| Risk level | Moderate | Beta 0.48, ATR 2.0% of price, short float 2.34%. |
...
| EPD Q2 Earnings Beat Estimates on Record Volumes & Export Demand | Zacks | 2026-08-03 |
| 4 Dividend Energy Stocks to Buy This Month, Starting With ExxonMobil | Motley Fool | 2026-08-02 |
| 3 High-Yield Energy Stocks to Buy With $1,000 Right Now and Hold Through 2030 | Motley Fool | 2026-08-01 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.12; 52w high $39.22 (-2.79%); 52w low $28.35 (+34.44%) |
| Trend | +10.79% vs SMA200, +2.81% vs SMA50, +1.12% vs SMA20 |
| Momentum | RSI(14) 56.4 (neutral) |
| Volatility | ATR(14) 0.75 (~2.0% of price); beta 0.48 |
| Setup perspective | -2.79% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.19, forward P/E 12.09, P/S 1.41, P/B 2.79 | EV/Sales 2.00, EV/EBITDA 11.37 |
...
| Energy Income Partners, LLC | 13,731,348 | 0.64% | 2026-03-31 |
...
|---|---|---|---|
| Price | $38.12 | EV/Sales | 2.00 |
| Market cap | $82.47B | EV/EBITDA | 11.37 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 56.4 | Operating margin | 11.76% |
| ATR(14) | 0.75 | Profit margin | 10.79% |
| SMA20 dist | +1.12% | ROA | — |
| SMA50 dist | +2.81% | ROE | — |
| SMA200 dist | +10.79% | Revenue (ttm) | $58.47B |
| 52W high | $39.22 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.04% |
| P/E (ttm) | 13.19 | Insider ownership | 32.98% |
| Forward P/E | 12.09 | Short float | 2.34% |
| PEG (trailing) | 1.55 | Avg volume | 3,366,254 |

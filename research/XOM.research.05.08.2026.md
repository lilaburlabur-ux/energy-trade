...
Signed file: `XOM.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $151.63 (2026-08-05, ~15-min delayed) |
| Market cap | $628.50B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +45.72%; price +9.32% vs SMA200. |
| Fresh setup quality | Moderate / wait | -10.97% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.07%, revenue growth 44.10%. |
| Value attractiveness | Reasonable | Forward P/E 14.36, EV/Sales 1.87. |
...
|---|---|---|
| Shell Q2 Earnings Beat Estimates as Higher Oil Prices Boost Results | Zacks | 2026-08-05 |
| EOG Q2 Earnings Beat Estimates on Higher Volumes & Prices | Zacks | 2026-08-05 |
| Oil Refiners Are Quietly Printing Money. This Company’s Earnings Jumped 975% | 24/7 Wall St. | 2026-08-05 |
| Trump rips Exxon, Chevron for ‘making too much money’ as US gas prices soar above $4 — but is Big Oil the bad guy? | Moneywise | 2026-08-05 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $151.63; 52w high $170.31 (-10.97%); 52w low $102.56 (+47.84%) |
| Trend | +9.32% vs SMA200, +3.66% vs SMA50, +0.76% vs SMA20 |
| Momentum | RSI(14) 53.6 (neutral) |
| Volatility | ATR(14) 3.86 (~2.5% of price); beta 0.17 |
| Setup perspective | -10.97% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 25.53, forward P/E 14.36, P/S 1.74, P/B 2.40 | EV/Sales 1.87, EV/EBITDA 9.95 |
| Growth expectations | Earnings growth 112.80%, EPS q/q 105.10% | Analyst mean target $167.00 (22 analysts) |
...
|---|---|---|---|
| Blackrock Inc. | 322,741,137 | 7.79% | 2026-03-31 |
| Vanguard Capital Management LLC | 271,198,613 | 6.54% | 2026-03-31 |
| State Street Corporation | 213,904,380 | 5.16% | 2026-03-31 |
| FMR, LLC | 140,010,460 | 3.38% | 2026-03-31 |
| Vanguard Portfolio Management LLC | 115,629,047 | 2.79% | 2026-03-31 |
| Geode Capital Management, LLC | 95,478,649 | 2.30% | 2026-03-31 |
...
|---|---|---|---|
| Price | $151.63 | EV/Sales | 1.87 |
| Market cap | $628.50B | EV/EBITDA | 9.95 |
| Beta | 0.17 | Gross margin | 29.77% |
| RSI(14) | 53.6 | Operating margin | 15.86% |
| ATR(14) | 3.86 | Profit margin | 9.07% |
| SMA20 dist | +0.76% | ROA | 5.52% |
| SMA50 dist | +3.66% | ROE | 12.58% |
| SMA200 dist | +9.32% | Revenue (ttm) | $361.06B |
| 52W high | $170.31 | Revenue growth y/y | 44.10% |
| 52W low | $102.56 | Inst. ownership | 68.58% |
| P/E (ttm) | 25.53 | Insider ownership | 0.08% |
| Forward P/E | 14.36 | Short float | 1.15% |
| PEG (trailing) | 1.21 | Avg volume | 16,771,491 |
| P/S | 1.74 | Employees | 57,900 |
| P/B | 2.40 | Analyst rec (1=buy..5=sell) | 2.4 |

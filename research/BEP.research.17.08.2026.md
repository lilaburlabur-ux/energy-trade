...
Signed file: `BEP.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $34.44 (2026-08-17, ~15-min delayed) |
| Market cap | $16.75B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +44.87%; price +9.97% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E -22.48, EV/Sales 13.43. |
| Risk level | Moderate | Beta 0.99, ATR 3.0% of price, short float 0.51%. |
...
|---|---|---|
| Brookfield, La Caisse close $6.5bn Boralex acquisition | Power Technology | 2026-08-17 |
| The AI-adjacent portfolio: Six Canadian stocks that could benefit from the AI buildout | Financial Post | 2026-08-07 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $34.44; 52w high $37.09 (-7.14%); 52w low $24.04 (+43.28%) |
| Trend | +9.97% vs SMA200, +2.00% vs SMA50, +3.90% vs SMA20 |
| Momentum | RSI(14) 57.4 (neutral) |
| Volatility | ATR(14) 1.03 (~3.0% of price); beta 0.99 |
...
| Valuation | P/E —, forward P/E -22.48, P/S 2.63, P/B 2.76 | EV/Sales 13.43, EV/EBITDA 28.47 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $35.62 (13 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 65.34% |
...
|---|---|---|---|
| Price | $34.44 | EV/Sales | 13.43 |
| Market cap | $16.75B | EV/EBITDA | 28.47 |
| Beta | 0.99 | Gross margin | 51.39% |
| RSI(14) | 57.4 | Operating margin | 17.08% |
| ATR(14) | 1.03 | Profit margin | -1.26% |
| SMA20 dist | +3.90% | ROA | 0.42% |
| SMA50 dist | +2.00% | ROE | 0.40% |
| SMA200 dist | +9.97% | Revenue (ttm) | $6.36B |
| 52W high | $37.09 | Revenue growth y/y | 1.10% |
| 52W low | $24.04 | Inst. ownership | 65.34% |
| P/E (ttm) | — | Insider ownership | 0.02% |
| Forward P/E | -22.48 | Short float | 0.51% |
| PEG (trailing) | — | Avg volume | 928,051 |
| P/S | 2.63 | Employees | 5,870 |
| P/B | 2.76 | Analyst rec (1=buy..5=sell) | 2.4 |

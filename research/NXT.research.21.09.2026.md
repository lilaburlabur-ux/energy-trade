...
Signed file: `NXT.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $83.15 (2026-09-21, ~15-min delayed) |
| Market cap | $12.78B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $83.15; 52w high $156.40 (-46.84%); 52w low $70.56 (+17.84%) |
| Trend | -23.11% vs SMA200, -10.57% vs SMA50, -0.23% vs SMA20 |
| Momentum | RSI(14) 44.6 (neutral) |
| Volatility | ATR(14) 4.58 (~5.5% of price); beta 1.92 |
| Setup perspective | -46.84% from 52w high — base needs to rebuild. |
...
| SMA20 dist | -0.23% | ROA | 11.68% |
| SMA50 dist | -10.57% | ROE | 27.22% |
| SMA200 dist | -23.11% | Revenue (ttm) | $3.63B |

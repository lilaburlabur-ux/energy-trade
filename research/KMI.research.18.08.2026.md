...
Signed file: `KMI.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $32.87 (2026-08-18, ~15-min delayed) |
| Market cap | $73.13B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +28.20%; price +8.75% vs SMA200. |
| Fresh setup quality | Watch | -3.30% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Strong | Profit margin 19.30%, revenue growth 10.80%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 21.38, EV/Sales 5.88. |
...
|---|---|---|
| It’s August and 5 High-Yield S&P 500 Dividend Stocks Are Back-to-School Bargains | 24/7 Wall St. | 2026-08-18 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $32.87; 52w high $33.99 (-3.30%); 52w low $24.86 (+32.22%) |
| Trend | +8.75% vs SMA200, +3.38% vs SMA50, +3.44% vs SMA20 |
| Momentum | RSI(14) 60.6 (neutral) |
| Volatility | ATR(14) 0.67 (~2.1% of price); beta 0.55 |
| Setup perspective | -3.30% from 52w high and near SMA20 — check for a tight base. |
...
- **Valuation risk:** Forward P/E 21.38, EV/Sales 5.88. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $32.87 | EV/Sales | 5.88 |
| Market cap | $73.13B | EV/EBITDA | 13.83 |
| Beta | 0.55 | Gross margin | 49.41% |
| RSI(14) | 60.6 | Operating margin | 30.06% |
| ATR(14) | 0.67 | Profit margin | 19.30% |
| SMA20 dist | +3.44% | ROA | 4.45% |
| SMA50 dist | +3.38% | ROE | 10.99% |
| SMA200 dist | +8.75% | Revenue (ttm) | $17.96B |

...
Signed file: `ARRY.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $4.69 (2026-08-21, ~15-min delayed) |
| Market cap | $721.45M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-41.55%) with negative half-year (-58.24%). |
| Fresh setup quality | Poor / broken | -60.79% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.23, EV/Sales 1.41. |
| Risk level | High | Beta 1.79, ATR 7.6% of price, short float 26.42%. |
...
| Array Technologies (ARRY) Q2 2026 Earnings Call Transcript | Motley Fool | 2026-08-12 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.69; 52w high $11.96 (-60.79%); 52w low $4.69 (+0.00%) |
| Trend | -41.55% vs SMA200, -24.66% vs SMA50, -9.83% vs SMA20 |
| Momentum | RSI(14) 34.5 (neutral) |
| Volatility | ATR(14) 0.36 (~7.6% of price); beta 1.79 |
| Setup perspective | -60.79% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 5.23, P/S 0.61, P/B -3.57 | EV/Sales 1.41, EV/EBITDA 13.98 |
| Growth expectations | Earnings growth -73.20%, EPS q/q -43.70% | Analyst mean target $9.20 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 148.14% |
...
- **Volatility risk:** Beta 1.79, ATR 7.6% of price, short float 26.42%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.69 | EV/Sales | 1.41 |
| Market cap | $721.45M | EV/EBITDA | 13.98 |
| Beta | 1.79 | Gross margin | 26.76% |
| RSI(14) | 34.5 | Operating margin | 10.88% |
| ATR(14) | 0.36 | Profit margin | -7.25% |
| SMA20 dist | -9.83% | ROA | 3.33% |
| SMA50 dist | -24.66% | ROE | -25.98% |
| SMA200 dist | -41.55% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.69 | Inst. ownership | 148.14% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.23 | Short float | 26.42% |
| PEG (trailing) | 0.56 | Avg volume | 6,680,561 |
| P/S | 0.61 | Employees | 1,200 |
| P/B | -3.57 | Analyst rec (1=buy..5=sell) | 2.0 |

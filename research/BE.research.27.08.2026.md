...
Signed file: `BE.research.27.08.2026`

| Field | Value |
|---|---|
| Current price | $218.21 (2026-08-27, ~15-min delayed) |
| Market cap | $64.27B |
...
|---|---|---|
| Technical momentum | High | 1Y +342.17%; price +16.23% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 44.28, EV/Sales 20.68. |
| Risk level | High | Beta 3.83, ATR 9.9% of price, short float 7.06%. |
...
|---|---|---|
| I'd Rather Own Bloom Energy Than Nvidia Right Now. Here's My Case. | Motley Fool | 2026-08-26 |
| Will Bloom Energy Be the Next SpaceX? What the Numbers Actually Say. | Motley Fool | 2026-08-26 |
| Plug Power Sinks 5%, Bloom and FuelCell Slip: Is the Hydrogen Trade Narrowing to One Name? | 24/7 Wall St. | 2026-08-26 |
| Zacks Investment Ideas feature highlights: Bloom Energy, Micron, Nvidia, UBS and Moderna | Zacks | 2026-08-26 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $218.21; 52w high $345.85 (-36.91%); 52w low $49.94 (+336.94%) |
| Trend | +16.23% vs SMA200, -8.83% vs SMA50, +0.13% vs SMA20 |
| Momentum | RSI(14) 49.4 (neutral) |
| Volatility | ATR(14) 21.59 (~9.9% of price); beta 3.83 |
...
| Valuation | P/E 287.12, forward P/E 44.28, P/S 20.64, P/B 39.71 | EV/Sales 20.68, EV/EBITDA 153.88 |
...
- **Valuation risk:** Forward P/E 44.28, EV/Sales 20.68. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 3.83, ATR 9.9% of price, short float 7.06%. Size positions accordingly.
...
|---|---|---|---|
| Price | $218.21 | EV/Sales | 20.68 |
| Market cap | $64.27B | EV/EBITDA | 153.88 |
| Beta | 3.83 | Gross margin | 31.65% |
| RSI(14) | 49.4 | Operating margin | 17.11% |
| ATR(14) | 21.59 | Profit margin | 7.87% |
| SMA20 dist | +0.13% | ROA | 5.60% |
| SMA50 dist | -8.83% | ROE | 22.21% |
| SMA200 dist | +16.23% | Revenue (ttm) | $3.11B |
| 52W high | $345.85 | Revenue growth y/y | 165.50% |
| 52W low | $49.94 | Inst. ownership | 86.00% |
| P/E (ttm) | 287.12 | Insider ownership | 5.64% |
| Forward P/E | 44.28 | Short float | 7.06% |
| PEG (trailing) | 0.91 | Avg volume | 14,586,563 |
| P/S | 20.64 | Employees | 2,214 |
| P/B | 39.71 | Analyst rec (1=buy..5=sell) | 2.2 |

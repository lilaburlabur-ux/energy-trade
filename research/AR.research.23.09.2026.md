...
Signed file: `AR.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $35.65 (2026-09-23, ~15-min delayed) |
| Market cap | $10.96B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-2.06%) with negative half-year (-16.24%). |
| Fresh setup quality | Moderate / wait | -21.04% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 18.75%, revenue growth 12.60%. |
| Value attractiveness | Reasonable | Forward P/E 8.21, EV/Sales —. |
| Risk level | Elevated | Beta 0.35, ATR 3.5% of price, short float 4.81%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $35.65; 52w high $45.15 (-21.04%); 52w low $30.03 (+18.71%) |
| Trend | -2.06% vs SMA200, -2.44% vs SMA50, -6.05% vs SMA20 |
| Momentum | RSI(14) 41.8 (neutral) |
| Volatility | ATR(14) 1.24 (~3.5% of price); beta 0.35 |
| Setup perspective | -21.04% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 10.21, forward P/E 8.21, P/S 1.90, P/B 1.32 | EV/Sales —, EV/EBITDA — |
...
- **Volatility risk:** Beta 0.35, ATR 3.5% of price, short float 4.81%. Size positions accordingly.
...
|---|---|---|---|
| Price | $35.65 | EV/Sales | — |
| Market cap | $10.96B | EV/EBITDA | — |
| Beta | 0.35 | Gross margin | 67.15% |
| RSI(14) | 41.8 | Operating margin | 26.02% |
| ATR(14) | 1.24 | Profit margin | 18.75% |
| SMA20 dist | -6.05% | ROA | 6.61% |
| SMA50 dist | -2.44% | ROE | 14.22% |
| SMA200 dist | -2.06% | Revenue (ttm) | $5.78B |
| 52W high | $45.15 | Revenue growth y/y | 12.60% |
| 52W low | $30.03 | Inst. ownership | 91.58% |
| P/E (ttm) | 10.21 | Insider ownership | 4.41% |
| Forward P/E | 8.21 | Short float | 4.81% |
| PEG (trailing) | 0.43 | Avg volume | 4,227,012 |

...
Signed file: `TRGP.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $286.91 (2026-08-25, ~15-min delayed) |
| Market cap | $61.52B |
...
|---|---|---|
| Technical momentum | High | 1Y +79.52%; price +24.06% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 23.75, EV/Sales 4.94. |
| Risk level | Elevated | Beta 0.72, ATR 3.1% of price, short float 2.51%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $286.91; 52w high $302.25 (-5.08%); 52w low $143.22 (+100.33%) |
| Trend | +24.06% vs SMA200, +5.29% vs SMA50, +4.10% vs SMA20 |
| Momentum | RSI(14) 55.9 (neutral) |
| Volatility | ATR(14) 8.85 (~3.1% of price); beta 0.72 |
...
| Valuation | P/E 27.46, forward P/E 23.75, P/S 3.67, P/B 19.64 | EV/Sales 4.94, EV/EBITDA 15.04 |
...
- **Valuation risk:** Forward P/E 23.75, EV/Sales 4.94. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.72, ATR 3.1% of price, short float 2.51%. Size positions accordingly.
...
|---|---|---|---|
| Price | $286.91 | EV/Sales | 4.94 |
| Market cap | $61.52B | EV/EBITDA | 15.04 |
| Beta | 0.72 | Gross margin | 43.19% |
| RSI(14) | 55.9 | Operating margin | 27.80% |
| ATR(14) | 8.85 | Profit margin | 13.54% |
| SMA20 dist | +4.10% | ROA | 9.24% |
| SMA50 dist | +5.29% | ROE | 70.84% |
| SMA200 dist | +24.06% | Revenue (ttm) | $16.74B |
| 52W high | $302.25 | Revenue growth y/y | 4.20% |
| 52W low | $143.22 | Inst. ownership | 97.46% |
| P/E (ttm) | 27.46 | Insider ownership | 1.38% |
| Forward P/E | 23.75 | Short float | 2.51% |
| PEG (trailing) | — | Avg volume | 1,258,403 |
| P/S | 3.67 | Employees | 3,570 |
| P/B | 19.64 | Analyst rec (1=buy..5=sell) | 1.5 |

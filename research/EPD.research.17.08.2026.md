...
Signed file: `EPD.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $38.61 (2026-08-17, ~15-min delayed) |
| Market cap | $83.38B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +28.79%; price +10.89% vs SMA200. |
| Fresh setup quality | Watch | -1.54% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.23, EV/Sales 2.03. |
...
| 5 Safe High-Yield Stocks Boomers Should Own in August | 24/7 Wall St. | 2026-08-15 |
| Could Enterprise Products Partners’ Fee-Based Model And Payout Streak Reframe Its Stability Narrative (EPD)? | Simply Wall St. | 2026-08-15 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.61; 52w high $39.22 (-1.54%); 52w low $28.35 (+36.17%) |
| Trend | +10.89% vs SMA200, +3.77% vs SMA50, +1.49% vs SMA20 |
| Momentum | RSI(14) 59.0 (neutral) |
| Volatility | ATR(14) 0.66 (~1.7% of price); beta 0.48 |
| Setup perspective | -1.54% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.36, forward P/E 12.23, P/S 1.43, P/B 2.83 | EV/Sales 2.03, EV/EBITDA 11.51 |
...
|---|---|---|---|
| Price | $38.61 | EV/Sales | 2.03 |
| Market cap | $83.38B | EV/EBITDA | 11.51 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 59.0 | Operating margin | 11.76% |
| ATR(14) | 0.66 | Profit margin | 10.79% |
| SMA20 dist | +1.49% | ROA | 5.92% |
| SMA50 dist | +3.77% | ROE | 20.85% |
| SMA200 dist | +10.89% | Revenue (ttm) | $58.47B |
| 52W high | $39.22 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.63% |
| P/E (ttm) | 13.36 | Insider ownership | 33.04% |
| Forward P/E | 12.23 | Short float | 2.31% |
| PEG (trailing) | 1.51 | Avg volume | 3,209,680 |
| P/S | 1.43 | Employees | 0 |
| P/B | 2.83 | Analyst rec (1=buy..5=sell) | 2.2 |

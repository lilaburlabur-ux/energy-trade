...
Signed file: `ARRY.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $4.06 (2026-09-18, ~15-min delayed) |
| Market cap | $625.27M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-47.33%) with negative half-year (-41.75%). |
...
| Value attractiveness | Reasonable | Forward P/E 4.54, EV/Sales 1.35. |
| Risk level | High | Beta 1.77, ATR 6.5% of price, short float 29.27%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.06; 52w high $11.96 (-66.05%); 52w low $4.06 (+0.00%) |
| Trend | -47.33% vs SMA200, -20.55% vs SMA50, -9.69% vs SMA20 |
| Momentum | RSI(14) 31.7 (neutral) |
| Volatility | ATR(14) 0.26 (~6.5% of price); beta 1.77 |
...
| Valuation | P/E —, forward P/E 4.54, P/S 0.53, P/B -3.09 | EV/Sales 1.35, EV/EBITDA 13.38 |
...
- **Volatility risk:** Beta 1.77, ATR 6.5% of price, short float 29.27%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.06 | EV/Sales | 1.35 |
| Market cap | $625.27M | EV/EBITDA | 13.38 |
| Beta | 1.77 | Gross margin | 26.76% |
| RSI(14) | 31.7 | Operating margin | 10.88% |
| ATR(14) | 0.26 | Profit margin | -7.25% |
| SMA20 dist | -9.69% | ROA | 3.33% |
| SMA50 dist | -20.55% | ROE | -25.98% |
| SMA200 dist | -47.33% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.06 | Inst. ownership | 147.85% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 4.54 | Short float | 29.27% |
| PEG (trailing) | 0.44 | Avg volume | 6,458,253 |
| P/S | 0.53 | Employees | 1,200 |
| P/B | -3.09 | Analyst rec (1=buy..5=sell) | 2.1 |

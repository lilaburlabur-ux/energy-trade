...
Signed file: `VRT.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $269.28 (2026-08-28, ~15-min delayed) |
| Market cap | $103.67B |
...
|---|---|---|
| Technical momentum | High | 1Y +110.72%; price +5.74% vs SMA200. |
| Fresh setup quality | Poor / broken | -28.41% from 52w high — base needs to rebuild. |
| Fundamental quality | Strong | Profit margin 15.09%, revenue growth 24.10%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 29.60, EV/Sales 9.05. |
...
| Vertiv (VRT) is an Incredible Growth Stock: 3 Reasons Why | Zacks | 2026-08-27 |
| Can Maverick Power Acquisition Boost NVT's Data Center Growth? | Zacks | 2026-08-27 |
| Wall Street Analysts Believe Vertiv (VRT) Could Rally 28.42%: Here's is How to Trade | Zacks | 2026-08-27 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $269.28; 52w high $376.15 (-28.41%); 52w low $121.69 (+121.29%) |
| Trend | +5.74% vs SMA200, -7.31% vs SMA50, -0.59% vs SMA20 |
| Momentum | RSI(14) 47.2 (neutral) |
| Volatility | ATR(14) 15.47 (~5.7% of price); beta 2.08 |
| Setup perspective | -28.41% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 60.79, forward P/E 29.60, P/S 9.03, P/B 21.79 | EV/Sales 9.05, EV/EBITDA 38.78 |
...
- **Valuation risk:** Forward P/E 29.60, EV/Sales 9.05. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $269.28 | EV/Sales | 9.05 |
| Market cap | $103.67B | EV/EBITDA | 38.78 |
| Beta | 2.08 | Gross margin | 38.04% |
| RSI(14) | 47.2 | Operating margin | 20.36% |
| ATR(14) | 15.47 | Profit margin | 15.09% |
| SMA20 dist | -0.59% | ROA | 10.89% |
| SMA50 dist | -7.31% | ROE | 43.94% |
| SMA200 dist | +5.74% | Revenue (ttm) | $11.48B |

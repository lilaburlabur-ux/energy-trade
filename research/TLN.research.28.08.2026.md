...
Signed file: `TLN.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $304.58 (2026-08-28, ~15-min delayed) |
| Market cap | $14.59B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $304.58; 52w high $445.84 (-31.68%); 52w low $302.97 (+0.53%) |
| Trend | -15.42% vs SMA200, -15.80% vs SMA50, -8.73% vs SMA20 |
| Momentum | RSI(14) 35.0 (neutral) |
| Volatility | ATR(14) 16.96 (~5.6% of price); beta 1.67 |
...
| SMA20 dist | -8.73% | ROA | 0.92% |
| SMA50 dist | -15.80% | ROE | -12.83% |
| SMA200 dist | -15.42% | Revenue (ttm) | $3.74B |
| 52W high | $445.84 | Revenue growth y/y | 111.20% |
| 52W low | $302.97 | Inst. ownership | 102.20% |
| P/E (ttm) | — | Insider ownership | 1.36% |
| Forward P/E | 9.90 | Short float | 5.05% |
| PEG (trailing) | — | Avg volume | 849,011 |
| P/S | 3.90 | Employees | 1,880 |
| P/B | 9.03 | Analyst rec (1=buy..5=sell) | 1.6 |

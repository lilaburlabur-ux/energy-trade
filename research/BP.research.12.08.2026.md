...
Signed file: `BP.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $42.93 (2026-08-12, ~15-min delayed) |
| Market cap | $110.56B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +33.27%; price +8.41% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 9.71, EV/Sales 2.32. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $42.93; 52w high $47.09 (-8.84%); 52w low $31.56 (+36.04%) |
| Trend | +8.41% vs SMA200, +4.03% vs SMA50, +0.27% vs SMA20 |
| Momentum | RSI(14) 53.5 (neutral) |
| Volatility | ATR(14) 1.09 (~2.5% of price); beta -0.21 |
...
| Valuation | P/E 20.54, forward P/E 9.71, P/S 0.51, P/B 7.60 | EV/Sales 2.32, EV/EBITDA 12.76 |
...
|---|---|---|---|
| Price | $42.93 | EV/Sales | 2.32 |
| Market cap | $110.56B | EV/EBITDA | 12.76 |
| Beta | -0.21 | Gross margin | 28.30% |
| RSI(14) | 53.5 | Operating margin | 13.15% |
| ATR(14) | 1.09 | Profit margin | 2.55% |
| SMA20 dist | +0.27% | ROA | 5.04% |
| SMA50 dist | +4.03% | ROE | 8.87% |
| SMA200 dist | +8.41% | Revenue (ttm) | $215.47B |
| 52W high | $47.09 | Revenue growth y/y | 48.20% |
| 52W low | $31.56 | Inst. ownership | 13.71% |
| P/E (ttm) | 20.54 | Insider ownership | 0.00% |
| Forward P/E | 9.71 | Short float | 0.41% |
| PEG (trailing) | 0.04 | Avg volume | 8,956,832 |
| P/S | 0.51 | Employees | 93,700 |
| P/B | 7.60 | Analyst rec (1=buy..5=sell) | 2.4 |

...
Signed file: `EOSE.research.13.08.2026`
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-55.44%) with negative half-year (-64.08%). |
| Fresh setup quality | Poor / broken | -78.32% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-246.76%). |
| Value attractiveness | Reasonable | Forward P/E -27.82, EV/Sales 12.10. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.16; 52w high $19.19 (-78.32%); 52w low $3.14 (+32.48%) |
| Trend | -55.44% vs SMA200, -18.56% vs SMA50, +7.48% vs SMA20 |
| Momentum | RSI(14) 47.7 (neutral) |
| Volatility | ATR(14) 0.44 (~10.6% of price); beta 2.80 |
| Setup perspective | -78.32% from 52w high — base needs to rebuild. |

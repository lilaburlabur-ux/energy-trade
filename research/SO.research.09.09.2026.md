...
Signed file: `SO.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $88.34 (2026-09-09, ~15-min delayed) |
| Market cap | $101.62B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-2.98%) with negative half-year (-6.71%). |
...
| Value attractiveness | Reasonable | Forward P/E 17.94, EV/Sales 5.94. |
| Risk level | Moderate | Beta 0.32, ATR 1.6% of price, short float 2.84%. |
...
|---|---|---|
| KEEL Stock On Track To Break 4-Day Rally: PowerSecure AI Data Center Deal Fails To Prevent Pull Back | Stocktwits | 2026-09-09 |
| Here's Why a Hold Strategy Is Apt for Southern Company Stock Now | Zacks | 2026-09-08 |
| XLU’s AI Power Story Crumbles as Texas Freezes Data-Center Demand | 24/7 Wall St. | 2026-09-07 |
| Southern Co (SO) Cleared PSC Review for 3.2GW of OpenAI Demand. Can Data Centers Lower Customer Bills Without Raising Grid Risk? | Insider Monkey | 2026-09-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $88.34; 52w high $97.49 (-9.39%); 52w low $82.06 (+7.65%) |
| Trend | -2.98% vs SMA200, -4.54% vs SMA50, -1.76% vs SMA20 |
| Momentum | RSI(14) 37.8 (neutral) |
| Volatility | ATR(14) 1.41 (~1.6% of price); beta 0.32 |
...
| Valuation | P/E 21.29, forward P/E 17.94, P/S 3.37, P/B 2.57 | EV/Sales 5.94, EV/EBITDA 12.57 |
| Growth expectations | Earnings growth 30.40%, EPS q/q 33.40% | Analyst mean target $99.97 (19 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 74.27% |
...
|---|---|---|---|
| Price | $88.34 | EV/Sales | 5.94 |
| Market cap | $101.62B | EV/EBITDA | 12.57 |
| Beta | 0.32 | Gross margin | 48.29% |
| RSI(14) | 37.8 | Operating margin | 29.61% |
| ATR(14) | 1.41 | Profit margin | 15.43% |
| SMA20 dist | -1.76% | ROA | 3.27% |
| SMA50 dist | -4.54% | ROE | 11.48% |
| SMA200 dist | -2.98% | Revenue (ttm) | $30.18B |
| 52W high | $97.49 | Revenue growth y/y | 0.10% |
| 52W low | $82.06 | Inst. ownership | 74.27% |
| P/E (ttm) | 21.29 | Insider ownership | 0.10% |
| Forward P/E | 17.94 | Short float | 2.84% |
| PEG (trailing) | 2.10 | Avg volume | 5,873,764 |
| P/S | 3.37 | Employees | 29,502 |
| P/B | 2.57 | Analyst rec (1=buy..5=sell) | 2.7 |

...
Signed file: `WMB.research.05.08.2026`
...
|---|---|---|
| Technical momentum | Moderate | 1Y +22.95%; price +5.75% vs SMA200. |
| Fresh setup quality | Moderate / wait | -8.89% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 25.43%, revenue growth 11.20%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 27.87, EV/Sales 9.84. |
| Risk level | Moderate | Beta —, ATR 2.8% of price, short float 1.89%. |
...
| The Williams Companies, Inc. Q2 2026 Earnings Call Summary | Moby | 2026-08-04 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $71.81; 52w high $78.82 (-8.89%); 52w low $54.78 (+31.08%) |
| Trend | +5.75% vs SMA200, -1.76% vs SMA50, -1.76% vs SMA20 |
| Momentum | RSI(14) 46.0 (neutral) |
| Volatility | ATR(14) 2.00 (~2.8% of price); beta — |
| Setup perspective | -8.89% from 52w high; no clean fresh pivot by default. |
...
| Revenue (ttm) | $12.08B | Revenue growth 11.20% y/y |
| Profitability | Gross 62.92%, operating 38.32%, net 25.43% | ROA 5.03%, ROE 21.50% |
| Balance sheet | Cash $203.00M, debt $30.79B | Current ratio 0.48, debt/equity 200.37 |
| Valuation | P/E 28.61, forward P/E 27.87, P/S 7.27, P/B 6.87 | EV/Sales 9.84, EV/EBITDA 16.91 |
| Growth expectations | Earnings growth 51.20%, EPS q/q 51.50% | Analyst mean target $83.55 (20 analysts) |
...
- **Valuation risk:** Forward P/E 27.87, EV/Sales 9.84. Multiple compression is the main downside if growth disappoints.
...
| SMA20 dist | -1.76% | ROA | 5.03% |
| SMA50 dist | -1.76% | ROE | 21.50% |
| SMA200 dist | +5.75% | Revenue (ttm) | $12.08B |
| 52W high | $78.82 | Revenue growth y/y | 11.20% |
| 52W low | $54.78 | Inst. ownership | 89.62% |
| P/E (ttm) | 28.61 | Insider ownership | 0.45% |
| Forward P/E | 27.87 | Short float | 1.89% |
| PEG (trailing) | 2.25 | Avg volume | 7,033,993 |
| P/S | 7.27 | Employees | 5,987 |
| P/B | 6.87 | Analyst rec (1=buy..5=sell) | 1.6 |
...
## 9. Conclusion
WMB: Moderate momentum / strong fundamentals / fair-to-demanding value / moderate risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

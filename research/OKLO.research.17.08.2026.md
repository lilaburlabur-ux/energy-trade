...
Signed file: `OKLO.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $43.88 (2026-08-17, ~15-min delayed) |
| Market cap | $8.16B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-37.35%) with negative half-year (-33.20%). |
| Fresh setup quality | Poor / broken | -74.80% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -43.70, EV/Sales 4,788.65. |
| Risk level | High | Beta 1.20, ATR 7.8% of price, short float 18.60%. |
...
| $10,000 in Oklo Stock at Its High Is Worth About $2,300 Today | Motley Fool | 2026-08-17 |
| Oklo (OKLO) Stock Trades At A Premium On Book Value Despite 351% Returns | Simply Wall St. | 2026-08-17 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $43.88; 52w high $174.14 (-74.80%); 52w low $36.84 (+19.11%) |
| Trend | -37.35% vs SMA200, -9.69% vs SMA50, +1.98% vs SMA20 |
| Momentum | RSI(14) 47.4 (neutral) |
| Volatility | ATR(14) 3.44 (~7.8% of price); beta 1.20 |
| Setup perspective | -74.80% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -43.70, P/S 6,745.83, P/B 2.48 | EV/Sales 4,788.65, EV/EBITDA -26.73 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $79.88 (20 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 46.96% |
...
- **Volatility risk:** Beta 1.20, ATR 7.8% of price, short float 18.60%. Size positions accordingly.
...
|---|---|---|---|
| Price | $43.88 | EV/Sales | 4,788.65 |
| Market cap | $8.16B | EV/EBITDA | -26.73 |
| Beta | 1.20 | Gross margin | 40.41% |
| RSI(14) | 47.4 | Operating margin | -6048.76% |
| ATR(14) | 3.44 | Profit margin | 0.00% |
| SMA20 dist | +1.98% | ROA | -6.65% |
| SMA50 dist | -9.69% | ROE | -7.70% |
| SMA200 dist | -37.35% | Revenue (ttm) | $1.21M |
| 52W high | $174.14 | Revenue growth y/y | — |
| 52W low | $36.84 | Inst. ownership | 46.96% |
| P/E (ttm) | — | Insider ownership | 15.42% |
| Forward P/E | -43.70 | Short float | 18.60% |
| PEG (trailing) | — | Avg volume | 11,227,354 |
| P/S | 6,745.83 | Employees | 215 |
| P/B | 2.48 | Analyst rec (1=buy..5=sell) | 2.0 |

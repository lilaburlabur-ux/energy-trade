...
Signed file: `MPC.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $424.89 (2026-09-18, ~15-min delayed) |
| Market cap | $124.04B |
...
|---|---|---|
| Technical momentum | High | 1Y +133.91%; price +69.95% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 9.96, EV/Sales 0.98. |
| Risk level | Moderate | Beta 0.53, ATR 3.0% of price, short float 3.14%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $424.89; 52w high $424.89 (+0.00%); 52w low $160.76 (+164.29%) |
| Trend | +69.95% vs SMA200, +22.60% vs SMA50, +9.70% vs SMA20 |
| Momentum | RSI(14) 83.3 (overbought) |
| Volatility | ATR(14) 12.71 (~3.0% of price); beta 0.53 |
...
| Valuation | P/E 14.74, forward P/E 9.96, P/S 0.80, P/B 6.30 | EV/Sales 0.98, EV/EBITDA 9.85 |
...
|---|---|---|---|
| Price | $424.89 | EV/Sales | 0.98 |
| Market cap | $124.04B | EV/EBITDA | 9.85 |
| Beta | 0.53 | Gross margin | 12.82% |
| RSI(14) | 83.3 | Operating margin | 13.56% |
| ATR(14) | 12.71 | Profit margin | 5.55% |
| SMA20 dist | +9.70% | ROA | 8.74% |
| SMA50 dist | +22.60% | ROE | 42.10% |
| SMA200 dist | +69.95% | Revenue (ttm) | $154.15B |
| 52W high | $424.89 | Revenue growth y/y | 53.70% |
| 52W low | $160.76 | Inst. ownership | 79.48% |
| P/E (ttm) | 14.74 | Insider ownership | 0.33% |
| Forward P/E | 9.96 | Short float | 3.14% |
| PEG (trailing) | 2.05 | Avg volume | 2,351,838 |
| P/S | 0.80 | Employees | 18,500 |
| P/B | 6.30 | Analyst rec (1=buy..5=sell) | 2.2 |

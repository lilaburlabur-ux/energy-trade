...
Signed file: `FSLR.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $203.10 (2026-09-09, ~15-min delayed) |
| Market cap | $21.83B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y -0.05%; price -11.76% vs SMA200. |
| Fresh setup quality | Poor / broken | -36.18% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 32.46%, revenue growth -3.70%. |
| Value attractiveness | Reasonable | Forward P/E 8.77, EV/Sales 3.98. |
| Risk level | High | Beta 1.73, ATR 4.8% of price, short float 11.86%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $203.10; 52w high $318.25 (-36.18%); 52w low $184.70 (+9.96%) |
| Trend | -11.76% vs SMA200, -6.81% vs SMA50, -4.03% vs SMA20 |
| Momentum | RSI(14) 42.2 (neutral) |
| Volatility | ATR(14) 9.79 (~4.8% of price); beta 1.73 |
| Setup perspective | -36.18% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 12.51, forward P/E 8.77, P/S 4.06, P/B 2.11 | EV/Sales 3.98, EV/EBITDA 8.96 |
| Growth expectations | Earnings growth 23.30%, EPS q/q 23.60% | Analyst mean target $274.81 (31 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 96.59% |
...
- **Volatility risk:** Beta 1.73, ATR 4.8% of price, short float 11.86%. Size positions accordingly.
...
|---|---|---|---|
| Price | $203.10 | EV/Sales | 3.98 |
| Market cap | $21.83B | EV/EBITDA | 8.96 |
| Beta | 1.73 | Gross margin | 44.02% |
| RSI(14) | 42.2 | Operating margin | 42.64% |
| ATR(14) | 9.79 | Profit margin | 32.46% |
| SMA20 dist | -4.03% | ROA | 8.62% |
| SMA50 dist | -6.81% | ROE | 18.51% |
| SMA200 dist | -11.76% | Revenue (ttm) | $5.38B |
| 52W high | $318.25 | Revenue growth y/y | -3.70% |
| 52W low | $184.70 | Inst. ownership | 96.59% |
| P/E (ttm) | 12.51 | Insider ownership | 5.36% |
| Forward P/E | 8.77 | Short float | 11.86% |
| PEG (trailing) | 0.40 | Avg volume | 2,125,945 |
| P/S | 4.06 | Employees | 7,900 |
| P/B | 2.11 | Analyst rec (1=buy..5=sell) | 1.9 |

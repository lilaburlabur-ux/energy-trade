...
Signed file: `ENPH.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $36.35 (2026-09-11, ~15-min delayed) |
| Market cap | $4.80B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-11.23%) with negative half-year (-14.67%). |
| Fresh setup quality | Poor / broken | -49.74% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 15.98, EV/Sales 3.37. |
| Risk level | High | Beta 1.64, ATR 5.9% of price, short float 21.29%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.35; 52w high $72.33 (-49.74%); 52w low $26.12 (+39.17%) |
| Trend | -11.23% vs SMA200, -7.96% vs SMA50, -3.25% vs SMA20 |
| Momentum | RSI(14) 43.4 (neutral) |
| Volatility | ATR(14) 2.13 (~5.9% of price); beta 1.64 |
| Setup perspective | -49.74% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 35.99, forward P/E 15.98, P/S 3.62, P/B 4.06 | EV/Sales 3.37, EV/EBITDA 23.37 |
...
- **Volatility risk:** Beta 1.64, ATR 5.9% of price, short float 21.29%. Size positions accordingly.
...
|---|---|---|---|
| Price | $36.35 | EV/Sales | 3.37 |
| Market cap | $4.80B | EV/EBITDA | 23.37 |
| Beta | 1.64 | Gross margin | 30.04% |
| RSI(14) | 43.4 | Operating margin | 17.98% |
| ATR(14) | 2.13 | Profit margin | 10.09% |
| SMA20 dist | -3.25% | ROA | 2.38% |
| SMA50 dist | -7.96% | ROE | 13.00% |
| SMA200 dist | -11.23% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 96.66% |
| P/E (ttm) | 35.99 | Insider ownership | 3.03% |
| Forward P/E | 15.98 | Short float | 21.29% |
| PEG (trailing) | 0.79 | Avg volume | 5,110,801 |

...
Signed file: `MPLX.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $59.83 (2026-09-08, ~15-min delayed) |
| Market cap | $60.66B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +28.04%; price +9.40% vs SMA200. |
| Fresh setup quality | Watch | -0.18% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Strong | Profit margin 39.28%, revenue growth 10.60%. |
| Value attractiveness | Reasonable | Forward P/E 12.34, EV/Sales 7.13. |
...
| 3 Pipeline Stocks Paying Huge Dividends Without Stretching the Payout | 24/7 Wall St. | 2026-09-04 |
| Why Is MPLX LP (MPLX) Down 0.5% Since Last Earnings Report? | Zacks | 2026-09-03 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $59.83; 52w high $59.94 (-0.18%); 52w low $44.22 (+35.30%) |
| Trend | +9.40% vs SMA200, +3.71% vs SMA50, +1.18% vs SMA20 |
| Momentum | RSI(14) 61.2 (neutral) |
| Volatility | ATR(14) 0.95 (~1.6% of price); beta 0.46 |
| Setup perspective | -0.18% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 12.87, forward P/E 12.34, P/S 5.04, P/B 4.33 | EV/Sales 7.13, EV/EBITDA 14.04 |
...
|---|---|---|---|
| Price | $59.83 | EV/Sales | 7.13 |
| Market cap | $60.66B | EV/EBITDA | 14.04 |
| Beta | 0.46 | Gross margin | 55.71% |
| RSI(14) | 61.2 | Operating margin | 38.25% |
| ATR(14) | 0.95 | Profit margin | 39.28% |
| SMA20 dist | +1.18% | ROA | 7.25% |
| SMA50 dist | +3.71% | ROE | 33.69% |
| SMA200 dist | +9.40% | Revenue (ttm) | $12.03B |
| 52W high | $59.94 | Revenue growth y/y | 10.60% |
| 52W low | $44.22 | Inst. ownership | 19.71% |
| P/E (ttm) | 12.87 | Insider ownership | 64.03% |
| Forward P/E | 12.34 | Short float | 2.04% |
| PEG (trailing) | 3.06 | Avg volume | 1,411,350 |
| P/S | 5.04 | Employees | 0 |
| P/B | 4.33 | Analyst rec (1=buy..5=sell) | 2.4 |

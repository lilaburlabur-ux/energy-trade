...
Signed file: `ARRY.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $4.98 (2026-08-17, ~15-min delayed) |
| Market cap | $766.96M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-38.52%) with negative half-year (-55.38%). |
| Fresh setup quality | Poor / broken | -58.36% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.56, EV/Sales 1.45. |
| Risk level | High | Beta 1.79, ATR 8.0% of price, short float 26.42%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.98; 52w high $11.96 (-58.36%); 52w low $4.81 (+3.53%) |
| Trend | -38.52% vs SMA200, -22.75% vs SMA50, -7.53% vs SMA20 |
| Momentum | RSI(14) 37.1 (neutral) |
| Volatility | ATR(14) 0.40 (~8.0% of price); beta 1.79 |
| Setup perspective | -58.36% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 5.56, P/S 0.65, P/B -3.80 | EV/Sales 1.45, EV/EBITDA 14.42 |
| Growth expectations | Earnings growth -73.20%, EPS q/q -43.70% | Analyst mean target $9.25 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 148.00% |
...
- **Volatility risk:** Beta 1.79, ATR 8.0% of price, short float 26.42%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.98 | EV/Sales | 1.45 |
| Market cap | $766.96M | EV/EBITDA | 14.42 |
| Beta | 1.79 | Gross margin | 26.76% |
| RSI(14) | 37.1 | Operating margin | 10.88% |
| ATR(14) | 0.40 | Profit margin | -7.25% |
| SMA20 dist | -7.53% | ROA | 3.33% |
| SMA50 dist | -22.75% | ROE | -25.98% |
| SMA200 dist | -38.52% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.81 | Inst. ownership | 148.00% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.56 | Short float | 26.42% |
| PEG (trailing) | 0.60 | Avg volume | 6,589,372 |
| P/S | 0.65 | Employees | 1,200 |
| P/B | -3.80 | Analyst rec (1=buy..5=sell) | 2.0 |

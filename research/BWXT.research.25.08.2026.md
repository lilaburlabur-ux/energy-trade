...
Signed file: `BWXT.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $149.73 (2026-08-25, ~15-min delayed) |
| Market cap | $13.72B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-22.61%) with negative half-year (-26.37%). |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 28.50, EV/Sales 4.30. |
| Risk level | Elevated | Beta 0.76, ATR 4.2% of price, short float 3.99%. |
...
|---|---|---|
| Can BWXT's National Laboratory Role Expand Its Government Services? | Zacks | 2026-08-25 |
| Mercury Systems, BWX, Kratos, Parsons, and Huntington Ingalls Shares Plummet, What You Need To Know | StockStory | 2026-08-20 |
| BWX Technologies (BWXT) Stock May Be Fully Priced Despite Nuclear Growth Hopes | Simply Wall St. | 2026-08-20 |
| BWX Technologies (BWXT) Wins ANEEL Fuel Review Role, Is It Still 32% Below Fair Value? | Simply Wall St. | 2026-08-20 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $149.73; 52w high $237.73 (-37.02%); 52w low $149.52 (+0.14%) |
| Trend | -22.61% vs SMA200, -16.11% vs SMA50, -9.39% vs SMA20 |
| Momentum | RSI(14) 29.6 (oversold) |
| Volatility | ATR(14) 6.31 (~4.2% of price); beta 0.76 |
...
| Valuation | P/E 38.79, forward P/E 28.50, P/S 3.90, P/B 10.28 | EV/Sales 4.30, EV/EBITDA 31.71 |
...
- **Valuation risk:** Forward P/E 28.50, EV/Sales 4.30. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.76, ATR 4.2% of price, short float 3.99%. Size positions accordingly.
...
|---|---|---|---|
| Price | $149.73 | EV/Sales | 4.30 |
| Market cap | $13.72B | EV/EBITDA | 31.71 |
| Beta | 0.76 | Gross margin | 22.08% |
| RSI(14) | 29.6 | Operating margin | 10.39% |
| ATR(14) | 6.31 | Profit margin | 10.11% |
| SMA20 dist | -9.39% | ROA | 5.53% |
| SMA50 dist | -16.11% | ROE | 28.29% |
| SMA200 dist | -22.61% | Revenue (ttm) | $3.51B |
| 52W high | $237.73 | Revenue growth y/y | 18.00% |
| 52W low | $149.52 | Inst. ownership | 94.37% |
| P/E (ttm) | 38.79 | Insider ownership | 0.35% |
| Forward P/E | 28.50 | Short float | 3.99% |
| PEG (trailing) | — | Avg volume | 990,346 |
| P/S | 3.90 | Employees | 11,000 |
| P/B | 10.28 | Analyst rec (1=buy..5=sell) | 1.8 |

...
Signed file: `NEE.research.26.08.2026`

| Field | Value |
|---|---|
| Current price | $84.22 (2026-08-26, ~15-min delayed) |
| Market cap | $175.65B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-3.39%) with negative half-year (-10.19%). |
...
| Trend | -3.39% vs SMA200, -3.26% vs SMA50, -1.60% vs SMA20 |
| Momentum | RSI(14) 36.6 (neutral) |
| Volatility | ATR(14) 1.40 (~1.7% of price); beta 0.65 |
...
| Valuation | P/E 18.93, forward P/E 19.19, P/S 6.12, P/B 3.08 | EV/Sales 10.24, EV/EBITDA 20.15 |
...
| Market cap | $175.65B | EV/EBITDA | 20.15 |
| Beta | 0.65 | Gross margin | 61.02% |
| RSI(14) | 36.6 | Operating margin | 31.52% |
| ATR(14) | 1.40 | Profit margin | 32.40% |
| SMA20 dist | -1.60% | ROA | 2.44% |
| SMA50 dist | -3.26% | ROE | 11.68% |
| SMA200 dist | -3.39% | Revenue (ttm) | $28.70B |
...
| PEG (trailing) | 1.84 | Avg volume | 11,343,323 |

...
Signed file: `ARRY.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $3.93 (2026-09-24, ~15-min delayed) |
| Market cap | $605.25M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-48.63%) with negative half-year (-45.72%). |
| Fresh setup quality | Poor / broken | -67.14% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 4.41, EV/Sales 1.31. |
...
|---|---|---|
| Array Technologies (ARRY) Stock Sees Fair Value Cut As Analysts Turn More Neutral | Simply Wall St. | 2026-09-24 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $3.93; 52w high $11.96 (-67.14%); 52w low $3.86 (+1.81%) |
| Trend | -48.63% vs SMA200, -20.96% vs SMA50, -10.64% vs SMA20 |
| Momentum | RSI(14) 31.3 (neutral) |
| Volatility | ATR(14) 0.25 (~6.4% of price); beta 1.77 |
| Setup perspective | -67.14% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 4.41, P/S 0.51, P/B -3.00 | EV/Sales 1.31, EV/EBITDA 12.98 |
...
|---|---|---|---|
| Price | $3.93 | EV/Sales | 1.31 |
| Market cap | $605.25M | EV/EBITDA | 12.98 |
| Beta | 1.77 | Gross margin | 26.76% |
| RSI(14) | 31.3 | Operating margin | 10.88% |
| ATR(14) | 0.25 | Profit margin | -7.25% |
| SMA20 dist | -10.64% | ROA | 3.33% |
| SMA50 dist | -20.96% | ROE | -25.98% |
| SMA200 dist | -48.63% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $3.86 | Inst. ownership | 147.85% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 4.41 | Short float | 29.27% |
| PEG (trailing) | 0.40 | Avg volume | 6,681,234 |
| P/S | 0.51 | Employees | 1,200 |
| P/B | -3.00 | Analyst rec (1=buy..5=sell) | 2.2 |

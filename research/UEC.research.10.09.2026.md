...
Signed file: `UEC.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $11.02 (2026-09-10, ~15-min delayed) |
| Market cap | $5.45B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-16.93%) with negative half-year (-22.12%). |
| Fresh setup quality | Poor / broken | -45.28% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -122.44, EV/Sales 245.91. |
| Risk level | High | Beta 1.24, ATR 5.9% of price, short float 14.55%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.02; 52w high $20.14 (-45.28%); 52w low $9.04 (+21.90%) |
| Trend | -16.93% vs SMA200, +1.51% vs SMA50, -7.40% vs SMA20 |
| Momentum | RSI(14) 44.3 (neutral) |
| Volatility | ATR(14) 0.65 (~5.9% of price); beta 1.24 |
| Setup perspective | -45.28% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -122.44, P/S 269.97, P/B 3.83 | EV/Sales 245.91, EV/EBITDA -41.13 |
...
- **Volatility risk:** Beta 1.24, ATR 5.9% of price, short float 14.55%. Size positions accordingly.
...
|---|---|---|---|
| Price | $11.02 | EV/Sales | 245.91 |
| Market cap | $5.45B | EV/EBITDA | -41.13 |
| Beta | 1.24 | Gross margin | 0.00% |
| RSI(14) | 44.3 | Operating margin | -629.66% |
| ATR(14) | 0.65 | Profit margin | 0.00% |
| SMA20 dist | -7.40% | ROA | -6.25% |
| SMA50 dist | +1.51% | ROE | -8.96% |
| SMA200 dist | -16.93% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 88.55% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -122.44 | Short float | 14.55% |
| PEG (trailing) | — | Avg volume | 8,853,961 |
| P/S | 269.97 | Employees | 171 |
| P/B | 3.83 | Analyst rec (1=buy..5=sell) | 1.4 |

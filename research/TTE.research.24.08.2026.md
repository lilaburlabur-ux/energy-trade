...
Signed file: `TTE.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $89.35 (2026-08-24, ~15-min delayed) |
| Market cap | $198.10B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +46.88%; price +13.34% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 9.27, EV/Sales 1.19. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $89.35; 52w high $93.60 (-4.54%); 52w low $55.92 (+59.77%) |
| Trend | +13.34% vs SMA200, +7.09% vs SMA50, +1.99% vs SMA20 |
| Momentum | RSI(14) 60.2 (neutral) |
| Volatility | ATR(14) 1.62 (~1.8% of price); beta 0.06 |
| Setup perspective | -4.54% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 11.18, forward P/E 9.27, P/S 1.01, P/B 1.55 | EV/Sales 1.19, EV/EBITDA 5.89 |
...
|---|---|---|---|
| Price | $89.35 | EV/Sales | 1.19 |
| Market cap | $198.10B | EV/EBITDA | 5.89 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 60.2 | Operating margin | 12.79% |
| ATR(14) | 1.62 | Profit margin | 9.08% |
| SMA20 dist | +1.99% | ROA | 5.51% |
| SMA50 dist | +7.09% | ROE | 14.48% |
| SMA200 dist | +13.34% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 54.68% |
| P/E (ttm) | 11.18 | Insider ownership | 8.86% |
| Forward P/E | 9.27 | Short float | 0.20% |
| PEG (trailing) | 0.72 | Avg volume | 1,579,158 |

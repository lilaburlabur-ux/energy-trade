...
Signed file: `PSX.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $256.48 (2026-09-23, ~15-min delayed) |
| Market cap | $102.34B |
...
|---|---|---|
| Technical momentum | High | 1Y +103.57%; price +44.37% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.30, EV/Sales 0.79. |
| Risk level | Elevated | Beta 0.70, ATR 3.4% of price, short float 1.61%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $256.48; 52w high $274.21 (-6.47%); 52w low $123.11 (+108.33%) |
| Trend | +44.37% vs SMA200, +10.64% vs SMA50, +0.24% vs SMA20 |
| Momentum | RSI(14) 56.1 (neutral) |
| Volatility | ATR(14) 8.66 (~3.4% of price); beta 0.70 |
...
| Valuation | P/E 14.65, forward P/E 10.30, P/S 0.67, P/B 3.25 | EV/Sales 0.79, EV/EBITDA 12.10 |
...
- **Volatility risk:** Beta 0.70, ATR 3.4% of price, short float 1.61%. Size positions accordingly.
...
|---|---|---|---|
| Price | $256.48 | EV/Sales | 0.79 |
| Market cap | $102.34B | EV/EBITDA | 12.10 |
| Beta | 0.70 | Gross margin | 13.10% |
| RSI(14) | 56.1 | Operating margin | 8.53% |
| ATR(14) | 8.66 | Profit margin | 4.66% |
| SMA20 dist | +0.24% | ROA | 6.04% |
| SMA50 dist | +10.64% | ROE | 23.45% |
| SMA200 dist | +44.37% | Revenue (ttm) | $152.17B |
| 52W high | $274.21 | Revenue growth y/y | 53.10% |
| 52W low | $123.11 | Inst. ownership | 80.53% |
| P/E (ttm) | 14.65 | Insider ownership | 0.21% |
| Forward P/E | 10.30 | Short float | 1.61% |
| PEG (trailing) | 0.82 | Avg volume | 2,880,477 |
| P/S | 0.67 | Employees | 12,600 |
| P/B | 3.25 | Analyst rec (1=buy..5=sell) | 2.1 |

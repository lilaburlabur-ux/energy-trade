...
Signed file: `NXT.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $85.45 (2026-09-08, ~15-min delayed) |
| Market cap | $13.13B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-21.21%) with negative half-year (-20.97%). |
| Fresh setup quality | Poor / broken | -45.36% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 16.36%, revenue growth 8.20%. |
| Value attractiveness | Reasonable | Forward P/E 14.79, EV/Sales 3.21. |
| Risk level | High | Beta 1.92, ATR 5.2% of price, short float 8.04%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $85.45; 52w high $156.40 (-45.36%); 52w low $64.33 (+32.83%) |
| Trend | -21.21% vs SMA200, -13.36% vs SMA50, -5.26% vs SMA20 |
| Momentum | RSI(14) 40.4 (neutral) |
| Volatility | ATR(14) 4.46 (~5.2% of price); beta 1.92 |
| Setup perspective | -45.36% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 22.08, forward P/E 14.79, P/S 3.62, P/B 5.07 | EV/Sales 3.21, EV/EBITDA 15.55 |
| Growth expectations | Earnings growth 2.90%, EPS q/q 5.20% | Analyst mean target $141.52 (27 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 109.67% |
...
- **Volatility risk:** Beta 1.92, ATR 5.2% of price, short float 8.04%. Size positions accordingly.
...
|---|---|---|---|
| Price | $85.45 | EV/Sales | 3.21 |
| Market cap | $13.13B | EV/EBITDA | 15.55 |
| Beta | 1.92 | Gross margin | 22.98% |
| RSI(14) | 40.4 | Operating margin | 20.86% |
| ATR(14) | 4.46 | Profit margin | 16.36% |
| SMA20 dist | -5.26% | ROA | 11.68% |
| SMA50 dist | -13.36% | ROE | 27.22% |
| SMA200 dist | -21.21% | Revenue (ttm) | $3.63B |
| 52W high | $156.40 | Revenue growth y/y | 8.20% |
| 52W low | $64.33 | Inst. ownership | 109.67% |
| P/E (ttm) | 22.08 | Insider ownership | 0.63% |
| Forward P/E | 14.79 | Short float | 8.04% |
| PEG (trailing) | 3.15 | Avg volume | 3,017,906 |
| P/S | 3.62 | Employees | 1,993 |
| P/B | 5.07 | Analyst rec (1=buy..5=sell) | 1.4 |

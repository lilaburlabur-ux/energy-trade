...
Signed file: `FSLR.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $236.80 (2026-08-05, ~15-min delayed) |
| Market cap | $25.45B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +29.10%; price +1.08% vs SMA200. |
| Fresh setup quality | Poor / broken | -25.59% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 32.46%, revenue growth -3.70%. |
| Value attractiveness | Reasonable | Forward P/E 10.30, EV/Sales 4.37. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $236.80; 52w high $318.25 (-25.59%); 52w low $180.05 (+31.52%) |
| Trend | +1.08% vs SMA200, -3.17% vs SMA50, +9.82% vs SMA20 |
| Momentum | RSI(14) 58.1 (neutral) |
| Volatility | ATR(14) 12.95 (~5.5% of price); beta 1.75 |
| Setup perspective | -25.59% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 24.19, forward P/E 10.30, P/S 4.73, P/B 2.58 | EV/Sales 4.37, EV/EBITDA 9.84 |
...
|---|---|---|---|
| Price | $236.80 | EV/Sales | 4.37 |
| Market cap | $25.45B | EV/EBITDA | 9.84 |
| Beta | 1.75 | Gross margin | 44.02% |
| RSI(14) | 58.1 | Operating margin | 42.64% |
| ATR(14) | 12.95 | Profit margin | 32.46% |
| SMA20 dist | +9.82% | ROA | 8.62% |
| SMA50 dist | -3.17% | ROE | 18.51% |
| SMA200 dist | +1.08% | Revenue (ttm) | $5.38B |
| 52W high | $318.25 | Revenue growth y/y | -3.70% |
| 52W low | $180.05 | Inst. ownership | 98.06% |
| P/E (ttm) | 24.19 | Insider ownership | 5.40% |
| Forward P/E | 10.30 | Short float | 12.03% |
| PEG (trailing) | 0.55 | Avg volume | 2,414,927 |
| P/S | 4.73 | Employees | 7,900 |
| P/B | 2.58 | Analyst rec (1=buy..5=sell) | 2.1 |

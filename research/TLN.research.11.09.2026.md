...
Signed file: `TLN.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $312.74 (2026-09-11, ~15-min delayed) |
| Market cap | $14.98B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y -22.33%; price -12.37% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.16, EV/Sales 6.49. |
| Risk level | Elevated | Beta 1.63, ATR 4.4% of price, short float 5.69%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $312.74; 52w high $445.84 (-29.85%); 52w low $293.73 (+6.47%) |
| Trend | -12.37% vs SMA200, -8.56% vs SMA50, -0.64% vs SMA20 |
| Momentum | RSI(14) 44.7 (neutral) |
| Volatility | ATR(14) 13.84 (~4.4% of price); beta 1.63 |
...
| Valuation | P/E —, forward P/E 10.16, P/S 4.01, P/B 9.27 | EV/Sales 6.49, EV/EBITDA 41.74 |
...
- **Volatility risk:** Beta 1.63, ATR 4.4% of price, short float 5.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $312.74 | EV/Sales | 6.49 |
| Market cap | $14.98B | EV/EBITDA | 41.74 |
| Beta | 1.63 | Gross margin | 42.10% |
| RSI(14) | 44.7 | Operating margin | -4.80% |
| ATR(14) | 13.84 | Profit margin | -4.95% |
| SMA20 dist | -0.64% | ROA | 0.92% |
| SMA50 dist | -8.56% | ROE | -12.83% |
| SMA200 dist | -12.37% | Revenue (ttm) | $3.74B |
| 52W high | $445.84 | Revenue growth y/y | 111.20% |
| 52W low | $293.73 | Inst. ownership | 102.12% |
| P/E (ttm) | — | Insider ownership | 1.36% |
| Forward P/E | 10.16 | Short float | 5.69% |
| PEG (trailing) | — | Avg volume | 858,185 |
| P/S | 4.01 | Employees | 1,880 |

...
Signed file: `XOM.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $164.77 (2026-08-19, ~15-min delayed) |
| Market cap | $677.52B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +58.87%; price +17.53% vs SMA200. |
| Fresh setup quality | Moderate / wait | -2.63% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.07%, revenue growth 44.10%. |
| Value attractiveness | Reasonable | Forward P/E 15.43, EV/Sales 1.99. |
...
| What’s Going On With Exxon Stock on Wednesday? | Benzinga | 2026-08-19 |
| Targa Resources' Stock Near 52-Week High: Time to Lock in Gains? | Zacks | 2026-08-19 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $164.77; 52w high $169.22 (-2.63%); 52w low $104.39 (+57.83%) |
| Trend | +17.53% vs SMA200, +11.75% vs SMA50, +5.21% vs SMA20 |
| Momentum | RSI(14) 70.2 (overbought) |
| Volatility | ATR(14) 3.64 (~2.2% of price); beta 0.17 |
| Setup perspective | -2.63% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.23, forward P/E 15.43, P/S 1.88, P/B 2.61 | EV/Sales 1.99, EV/EBITDA 10.59 |
...
|---|---|---|---|
| Price | $164.77 | EV/Sales | 1.99 |
| Market cap | $677.52B | EV/EBITDA | 10.59 |
| Beta | 0.17 | Gross margin | 29.77% |
| RSI(14) | 70.2 | Operating margin | 15.86% |
| ATR(14) | 3.64 | Profit margin | 9.07% |
| SMA20 dist | +5.21% | ROA | 5.52% |
| SMA50 dist | +11.75% | ROE | 12.58% |
| SMA200 dist | +17.53% | Revenue (ttm) | $361.06B |
| 52W high | $169.22 | Revenue growth y/y | 44.10% |
| 52W low | $104.39 | Inst. ownership | 66.16% |
| P/E (ttm) | 21.23 | Insider ownership | 0.08% |
| Forward P/E | 15.43 | Short float | 1.15% |
| PEG (trailing) | 1.30 | Avg volume | 15,961,825 |

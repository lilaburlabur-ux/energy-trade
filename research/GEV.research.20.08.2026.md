...
Signed file: `GEV.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $966.01 (2026-08-20, ~15-min delayed) |
| Market cap | $257.28B |
...
|---|---|---|
| Technical momentum | High | 1Y +60.53%; price +11.60% vs SMA200. |
| Fresh setup quality | Moderate / wait | -17.78% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 23.04%, revenue growth 21.90%. |
| Value attractiveness | Low (expensive) | Forward P/E 38.47, EV/Sales 6.17. |
| Risk level | High | Beta 1.03, ATR 5.4% of price, short float 3.20%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $966.01; 52w high $1,174.86 (-17.78%); 52w low $546.95 (+76.62%) |
| Trend | +11.60% vs SMA200, -6.50% vs SMA50, -3.66% vs SMA20 |
| Momentum | RSI(14) 42.1 (neutral) |
| Volatility | ATR(14) 51.88 (~5.4% of price); beta 1.03 |
| Setup perspective | -17.78% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 27.71, forward P/E 38.47, P/S 6.22, P/B 21.52 | EV/Sales 6.17, EV/EBITDA 64.97 |
...
- **Valuation risk:** Forward P/E 38.47, EV/Sales 6.17. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.03, ATR 5.4% of price, short float 3.20%. Size positions accordingly.
...
|---|---|---|---|
| Price | $966.01 | EV/Sales | 6.17 |
| Market cap | $257.28B | EV/EBITDA | 64.97 |
| Beta | 1.03 | Gross margin | 20.57% |
| RSI(14) | 42.1 | Operating margin | 7.47% |
| ATR(14) | 51.88 | Profit margin | 23.04% |
| SMA20 dist | -3.66% | ROA | 2.54% |
| SMA50 dist | -6.50% | ROE | 82.58% |
| SMA200 dist | +11.60% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.70% |
| P/E (ttm) | 27.71 | Insider ownership | 0.13% |
| Forward P/E | 38.47 | Short float | 3.20% |
| PEG (trailing) | 1.68 | Avg volume | 2,807,514 |
| P/S | 6.22 | Employees | 78,000 |
| P/B | 21.52 | Analyst rec (1=buy..5=sell) | 1.6 |

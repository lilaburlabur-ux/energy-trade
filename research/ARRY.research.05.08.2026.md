...
Signed file: `ARRY.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $5.64 (2026-08-05, ~15-min delayed) |
| Market cap | $867.58M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-31.62%) with negative half-year (-50.22%). |
| Fresh setup quality | Poor / broken | -52.84% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-5.56%). |
| Value attractiveness | Reasonable | Forward P/E 6.20, EV/Sales 1.59. |
| Risk level | High | Beta 1.79, ATR 7.5% of price, short float 25.46%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $5.64; 52w high $11.96 (-52.84%); 52w low $4.81 (+17.26%) |
| Trend | -31.62% vs SMA200, -19.92% vs SMA50, -2.56% vs SMA20 |
| Momentum | RSI(14) 43.5 (neutral) |
| Volatility | ATR(14) 0.42 (~7.5% of price); beta 1.79 |
| Setup perspective | -52.84% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 6.20, P/S 0.72, P/B -4.05 | EV/Sales 1.59, EV/EBITDA 15.36 |
| Growth expectations | Earnings growth —, EPS q/q -88.10% | Analyst mean target $9.82 (21 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 146.96% |
...
- **Volatility risk:** Beta 1.79, ATR 7.5% of price, short float 25.46%. Size positions accordingly.
...
|---|---|---|---|
| Price | $5.64 | EV/Sales | 1.59 |
| Market cap | $867.58M | EV/EBITDA | 15.36 |
| Beta | 1.79 | Gross margin | 26.11% |
| RSI(14) | 43.5 | Operating margin | 2.02% |
| ATR(14) | 0.42 | Profit margin | -5.56% |
| SMA20 dist | -2.56% | ROA | 3.93% |
| SMA50 dist | -19.92% | ROE | -22.65% |
| SMA200 dist | -31.62% | Revenue (ttm) | $1.21B |
| 52W high | $11.96 | Revenue growth y/y | -26.10% |
| 52W low | $4.81 | Inst. ownership | 146.96% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 6.20 | Short float | 25.46% |
| PEG (trailing) | 0.82 | Avg volume | 6,195,980 |
| P/S | 0.72 | Employees | 1,200 |
| P/B | -4.05 | Analyst rec (1=buy..5=sell) | 2.1 |

...
Signed file: `FTI.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $69.27 (2026-08-05, ~15-min delayed) |
| Market cap | $27.17B |
...
|---|---|---|
| Technical momentum | High | 1Y +94.88%; price +14.60% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 19.35, EV/Sales 2.63. |
...
|---|---|---|
| TechnipFMC (FTI) Stock Could Be 37% Undervalued As Cash Flow Holds Up | Simply Wall St. | 2026-08-05 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $69.27; 52w high $76.94 (-9.97%); 52w low $34.67 (+99.81%) |
| Trend | +14.60% vs SMA200, -0.48% vs SMA50, -4.40% vs SMA20 |
| Momentum | RSI(14) 45.1 (neutral) |
| Volatility | ATR(14) 2.52 (~3.6% of price); beta 0.74 |
...
| Valuation | P/E 24.22, forward P/E 19.35, P/S 2.61, P/B 8.32 | EV/Sales 2.63, EV/EBITDA 13.81 |
...
|---|---|---|---|
| Price | $69.27 | EV/Sales | 2.63 |
| Market cap | $27.17B | EV/EBITDA | 13.81 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 45.1 | Operating margin | 17.69% |
| ATR(14) | 2.52 | Profit margin | 11.28% |
| SMA20 dist | -4.40% | ROA | 9.53% |
| SMA50 dist | -0.48% | ROE | 35.81% |
| SMA200 dist | +14.60% | Revenue (ttm) | $10.42B |
| 52W high | $76.94 | Revenue growth y/y | 9.00% |
| 52W low | $34.67 | Inst. ownership | 104.07% |
| P/E (ttm) | 24.22 | Insider ownership | 1.71% |
| Forward P/E | 19.35 | Short float | 4.36% |
| PEG (trailing) | — | Avg volume | 4,787,593 |
| P/S | 2.61 | Employees | 22,000 |
| P/B | 8.32 | Analyst rec (1=buy..5=sell) | 2.0 |

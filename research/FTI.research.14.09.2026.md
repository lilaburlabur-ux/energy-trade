...
Signed file: `FTI.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $72.87 (2026-09-14, ~15-min delayed) |
| Market cap | $28.58B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $72.87; 52w high $80.08 (-9.00%); 52w low $35.45 (+105.53%) |
| Trend | +11.89% vs SMA200, -2.02% vs SMA50, -5.72% vs SMA20 |
| Momentum | RSI(14) 40.1 (neutral) |
| Volatility | ATR(14) 2.49 (~3.4% of price); beta 0.74 |
| Setup perspective | -9.00% from 52w high; no clean fresh pivot by default. |
...
| P/B | 8.75 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `FLNC.research.08.09.2026`

| Field | Value |
|---|---|
| Current price | $11.04 (2026-09-08, ~15-min delayed) |
| Market cap | $2.05B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-38.76%) with negative half-year (-29.68%). |
| Fresh setup quality | Poor / broken | -65.75% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 80.23, EV/Sales 0.61. |
| Risk level | High | Beta 2.74, ATR 7.6% of price, short float 33.35%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.04; 52w high $32.23 (-65.75%); 52w low $6.76 (+63.31%) |
| Trend | -38.76% vs SMA200, -19.18% vs SMA50, -4.30% vs SMA20 |
| Momentum | RSI(14) 41.3 (neutral) |
| Volatility | ATR(14) 0.84 (~7.6% of price); beta 2.74 |
| Setup perspective | -65.75% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 80.23, P/S 0.78, P/B 4.23 | EV/Sales 0.61, EV/EBITDA -20.70 |
...
- **Valuation risk:** Forward P/E 80.23, EV/Sales 0.61. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.74, ATR 7.6% of price, short float 33.35%. Size positions accordingly.
...
|---|---|---|---|
| Price | $11.04 | EV/Sales | 0.61 |
| Market cap | $2.05B | EV/EBITDA | -20.70 |
| Beta | 2.74 | Gross margin | 9.36% |
| RSI(14) | 41.3 | Operating margin | -8.85% |
| ATR(14) | 0.84 | Profit margin | -3.07% |
| SMA20 dist | -4.30% | ROA | -2.95% |
| SMA50 dist | -19.18% | ROE | -23.54% |
| SMA200 dist | -38.76% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.76 | Inst. ownership | 85.06% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 80.23 | Short float | 33.35% |
| PEG (trailing) | — | Avg volume | 8,377,216 |
| P/S | 0.78 | Employees | 1,670 |
| P/B | 4.23 | Analyst rec (1=buy..5=sell) | 2.6 |

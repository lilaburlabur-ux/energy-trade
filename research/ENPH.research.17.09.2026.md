...
Signed file: `ENPH.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $36.02 (2026-09-17, ~15-min delayed) |
| Market cap | $4.75B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-12.39%) with negative half-year (-16.77%). |
| Fresh setup quality | Poor / broken | -50.20% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 15.84, EV/Sales 3.29. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.02; 52w high $72.33 (-50.20%); 52w low $26.12 (+37.90%) |
| Trend | -12.39% vs SMA200, -7.46% vs SMA50, -2.69% vs SMA20 |
| Momentum | RSI(14) 43.1 (neutral) |
| Volatility | ATR(14) 2.03 (~5.6% of price); beta 1.64 |
| Setup perspective | -50.20% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 35.66, forward P/E 15.84, P/S 3.57, P/B 4.03 | EV/Sales 3.29, EV/EBITDA 22.81 |
...
|---|---|---|---|
| Price | $36.02 | EV/Sales | 3.29 |
| Market cap | $4.75B | EV/EBITDA | 22.81 |
| Beta | 1.64 | Gross margin | 30.04% |
| RSI(14) | 43.1 | Operating margin | 17.98% |
| ATR(14) | 2.03 | Profit margin | 10.09% |
| SMA20 dist | -2.69% | ROA | 2.38% |
| SMA50 dist | -7.46% | ROE | 13.00% |
| SMA200 dist | -12.39% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 96.64% |
| P/E (ttm) | 35.66 | Insider ownership | 3.03% |
| Forward P/E | 15.84 | Short float | 21.29% |
| PEG (trailing) | 0.77 | Avg volume | 4,930,398 |
| P/S | 3.57 | Employees | 2,872 |
| P/B | 4.03 | Analyst rec (1=buy..5=sell) | 2.4 |

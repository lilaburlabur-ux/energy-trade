...
Signed file: `BEP.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $31.10 (2026-09-03, ~15-min delayed) |
| Market cap | $15.16B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +30.63%; price -0.01% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E -16.64, EV/Sales 13.03. |
| Risk level | Moderate | Beta 0.99, ATR 3.0% of price, short float 0.67%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $31.10; 52w high $36.63 (-15.10%); 52w low $24.02 (+29.47%) |
| Trend | -0.01% vs SMA200, -4.54% vs SMA50, -4.49% vs SMA20 |
| Momentum | RSI(14) 39.4 (neutral) |
| Volatility | ATR(14) 0.92 (~3.0% of price); beta 0.99 |
...
| Valuation | P/E —, forward P/E -16.64, P/S 2.38, P/B 2.50 | EV/Sales 13.03, EV/EBITDA 27.62 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $35.62 (13 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 65.39% |
...
|---|---|---|---|
| Price | $31.10 | EV/Sales | 13.03 |
| Market cap | $15.16B | EV/EBITDA | 27.62 |
| Beta | 0.99 | Gross margin | 51.39% |
| RSI(14) | 39.4 | Operating margin | 17.08% |
| ATR(14) | 0.92 | Profit margin | -1.26% |
| SMA20 dist | -4.49% | ROA | 0.42% |
| SMA50 dist | -4.54% | ROE | 0.40% |
| SMA200 dist | -0.01% | Revenue (ttm) | $6.36B |
| 52W high | $36.63 | Revenue growth y/y | 1.10% |
| 52W low | $24.02 | Inst. ownership | 65.39% |
| P/E (ttm) | — | Insider ownership | 0.02% |
| Forward P/E | -16.64 | Short float | 0.67% |
| PEG (trailing) | — | Avg volume | 878,449 |
| P/S | 2.38 | Employees | 5,870 |
| P/B | 2.50 | Analyst rec (1=buy..5=sell) | 2.3 |

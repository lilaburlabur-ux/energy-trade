...
Signed file: `ET.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $20.49 (2026-09-23, ~15-min delayed) |
| Market cap | $70.55B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $20.49; 52w high $21.73 (-5.71%); 52w low $15.15 (+35.20%) |
| Trend | +9.65% vs SMA200, -1.22% vs SMA50, -3.78% vs SMA20 |
| Momentum | RSI(14) 36.9 (neutral) |
| Volatility | ATR(14) 0.34 (~1.7% of price); beta 0.57 |
| Setup perspective | -5.71% from 52w high; no clean fresh pivot by default. |
...
| SMA50 dist | -1.22% | ROE | 14.56% |
| SMA200 dist | +9.65% | Revenue (ttm) | $107.38B |
| 52W high | $21.73 | Revenue growth y/y | 78.40% |
| 52W low | $15.15 | Inst. ownership | 32.52% |
| P/E (ttm) | 14.03 | Insider ownership | 10.29% |
| Forward P/E | 11.75 | Short float | 0.86% |
| PEG (trailing) | 0.62 | Avg volume | 8,577,598 |
| P/S | 0.66 | Employees | 22,311 |
| P/B | 2.21 | Analyst rec (1=buy..5=sell) | 1.5 |

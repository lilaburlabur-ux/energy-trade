...
Signed file: `NXE.research.25.08.2026`

| Field | Value |
|---|---|
| Current price | $11.21 (2026-08-25, ~15-min delayed) |
| Market cap | $7.42B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +57.89%; price +4.48% vs SMA200. |
| Fresh setup quality | Moderate / wait | -19.47% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -63.69, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.21; 52w high $13.92 (-19.47%); 52w low $7.11 (+57.67%) |
| Trend | +4.48% vs SMA200, +13.95% vs SMA50, +9.68% vs SMA20 |
| Momentum | RSI(14) 64.5 (neutral) |
| Volatility | ATR(14) 0.50 (~4.5% of price); beta 1.65 |
| Setup perspective | -19.47% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E —, forward P/E -63.69, P/S —, P/B 5.61 | EV/Sales —, EV/EBITDA -64.31 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $19.44 (1 analysts) |
...
|---|---|---|---|
| Price | $11.21 | EV/Sales | — |
| Market cap | $7.42B | EV/EBITDA | -64.31 |
| Beta | 1.65 | Gross margin | 0.00% |
| RSI(14) | 64.5 | Operating margin | 0.00% |
| ATR(14) | 0.50 | Profit margin | 0.00% |
| SMA20 dist | +9.68% | ROA | -3.39% |
| SMA50 dist | +13.95% | ROE | -17.67% |
| SMA200 dist | +4.48% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.11 | Inst. ownership | 55.23% |
| P/E (ttm) | — | Insider ownership | 6.39% |
| Forward P/E | -63.69 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,595,153 |
| P/S | — | Employees | 142 |

...
Signed file: `MPLX.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $59.34 (2026-09-03, ~15-min delayed) |
| Market cap | $60.21B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +26.07%; price +8.70% vs SMA200. |
| Fresh setup quality | Watch | -1.00% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Strong | Profit margin 39.28%, revenue growth 10.60%. |
| Value attractiveness | Reasonable | Forward P/E 12.24, EV/Sales 7.07. |
...
| 2 Dividend Stocks Yielding Over 6% That Should Be in Every Roth | 24/7 Wall St. | 2026-09-01 |
| This Popular Energy ETF Has a Hidden Cost—Own These 3 Dividend Stocks Instead | 24/7 Wall St. | 2026-08-31 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $59.34; 52w high $59.94 (-1.00%); 52w low $44.22 (+34.19%) |
| Trend | +8.70% vs SMA200, +3.18% vs SMA50, +0.51% vs SMA20 |
| Momentum | RSI(14) 57.5 (neutral) |
| Volatility | ATR(14) 0.94 (~1.6% of price); beta 0.46 |
| Setup perspective | -1.00% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 12.76, forward P/E 12.24, P/S 5.00, P/B 4.29 | EV/Sales 7.07, EV/EBITDA 13.93 |
...
|---|---|---|---|
| Price | $59.34 | EV/Sales | 7.07 |
| Market cap | $60.21B | EV/EBITDA | 13.93 |
| Beta | 0.46 | Gross margin | 55.71% |
| RSI(14) | 57.5 | Operating margin | 38.25% |
| ATR(14) | 0.94 | Profit margin | 39.28% |
| SMA20 dist | +0.51% | ROA | 7.25% |
| SMA50 dist | +3.18% | ROE | 33.69% |
| SMA200 dist | +8.70% | Revenue (ttm) | $12.03B |
| 52W high | $59.94 | Revenue growth y/y | 10.60% |
| 52W low | $44.22 | Inst. ownership | 19.71% |
| P/E (ttm) | 12.76 | Insider ownership | 64.03% |
| Forward P/E | 12.24 | Short float | 2.04% |
| PEG (trailing) | 3.03 | Avg volume | 1,420,033 |
| P/S | 5.00 | Employees | 0 |
| P/B | 4.29 | Analyst rec (1=buy..5=sell) | 2.4 |

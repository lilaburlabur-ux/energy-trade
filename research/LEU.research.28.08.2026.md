...
Signed file: `LEU.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $194.78 (2026-08-28, ~15-min delayed) |
| Market cap | $3.89B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-8.72%) with negative half-year (-7.67%). |
| Fresh setup quality | Poor / broken | -55.33% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.23%, revenue growth 14.00%. |
| Value attractiveness | Low (expensive) | Forward P/E 50.96, EV/Sales 6.74. |
| Risk level | High | Beta 1.35, ATR 6.6% of price, short float 29.16%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $194.78; 52w high $436.00 (-55.33%); 52w low $146.61 (+32.86%) |
| Trend | -8.72% vs SMA200, +11.39% vs SMA50, +4.94% vs SMA20 |
| Momentum | RSI(14) 56.7 (neutral) |
| Volatility | ATR(14) 12.84 (~6.6% of price); beta 1.35 |
| Setup perspective | -55.33% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 102.52, forward P/E 50.96, P/S 8.20, P/B 4.60 | EV/Sales 6.74, EV/EBITDA 316.38 |
...
- **Valuation risk:** Forward P/E 50.96, EV/Sales 6.74. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.35, ATR 6.6% of price, short float 29.16%. Size positions accordingly.
...
|---|---|---|---|
| Price | $194.78 | EV/Sales | 6.74 |
| Market cap | $3.89B | EV/EBITDA | 316.38 |
| Beta | 1.35 | Gross margin | 23.66% |
| RSI(14) | 56.7 | Operating margin | 5.34% |
| ATR(14) | 12.84 | Profit margin | 10.23% |
| SMA20 dist | +4.94% | ROA | 0.02% |
| SMA50 dist | +11.39% | ROE | 8.05% |
| SMA200 dist | -8.72% | Revenue (ttm) | $473.90M |

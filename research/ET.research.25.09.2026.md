...
Signed file: `ET.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $20.19 (2026-09-25, ~15-min delayed) |
| Market cap | $69.52B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +24.73%; price +7.80% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 11.58, EV/Sales 1.47. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $20.19; 52w high $21.73 (-7.09%); 52w low $15.15 (+33.22%) |
| Trend | +7.80% vs SMA200, -2.77% vs SMA50, -4.68% vs SMA20 |
...
| SMA20 dist | -4.68% | ROA | 5.06% |
| SMA50 dist | -2.77% | ROE | 14.56% |
| SMA200 dist | +7.80% | Revenue (ttm) | $107.38B |
| 52W high | $21.73 | Revenue growth y/y | 78.40% |
| 52W low | $15.15 | Inst. ownership | 32.52% |
| P/E (ttm) | 13.83 | Insider ownership | 10.29% |
| Forward P/E | 11.58 | Short float | 1.01% |
| PEG (trailing) | 0.62 | Avg volume | 8,596,314 |
| P/S | 0.65 | Employees | 22,311 |
| P/B | 2.17 | Analyst rec (1=buy..5=sell) | 1.5 |

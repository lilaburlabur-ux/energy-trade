...
**Energy Fuels** — Technical + Fundamental Analysis, Data Snapshot, Institutional Investors
...
| Risk level | High | Beta —, ATR 5.9% of price, short float —. |
...
| Volatility | ATR(14) 0.86 (~5.9% of price); beta — |
...
- **Volatility risk:** Beta —, ATR 5.9% of price, short float —. Size positions accordingly.
...
|---|---|---|---|
| Price | $14.62 | EV/Sales | — |
| Market cap | — | EV/EBITDA | — |
| Beta | — | Gross margin | — |
| RSI(14) | 52.5 | Operating margin | — |
| ATR(14) | 0.86 | Profit margin | — |
| SMA20 dist | -1.00% | ROA | — |
| SMA50 dist | +8.00% | ROE | — |
| SMA200 dist | -15.88% | Revenue (ttm) | — |
| 52W high | $27.72 | Revenue growth y/y | — |
| 52W low | $10.74 | Inst. ownership | — |
...
## 9. Conclusion
UUUU: Low momentum / mixed fundamentals / low (expensive) value / high risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

...
Signed file: `SMR.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $8.30 (2026-09-16, ~15-min delayed) |
| Market cap | $3.41B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-34.41%) with negative half-year (-33.28%). |
| Fresh setup quality | Poor / broken | -84.47% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -12.62, EV/Sales 214.51. |
| Risk level | High | Beta 2.31, ATR 8.6% of price, short float 17.60%. |
...
| NuScale Power Just Solved a Major Engineering Hurdle: Is the Stock a Buy? | Motley Fool | 2026-09-16 |
| Wall Street sounds alarm on nuclear stock with 40% downside | TheStreet | 2026-09-16 |
| Is NuScale Power (SMR) Facing A Bigger Threat From Costs And Customer Delays? | Simply Wall St. | 2026-09-16 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $8.30; 52w high $53.43 (-84.47%); 52w low $7.59 (+9.35%) |
| Trend | -34.41% vs SMA200, -8.28% vs SMA50, -11.92% vs SMA20 |
| Momentum | RSI(14) 41.0 (neutral) |
| Volatility | ATR(14) 0.71 (~8.6% of price); beta 2.31 |
| Setup perspective | -84.47% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -12.62, P/S 318.64, P/B 1.65 | EV/Sales 214.51, EV/EBITDA -10.23 |
...
- **Volatility risk:** Beta 2.31, ATR 8.6% of price, short float 17.60%. Size positions accordingly.
...
|---|---|---|---|
| Price | $8.30 | EV/Sales | 214.51 |
| Market cap | $3.41B | EV/EBITDA | -10.23 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 41.0 | Operating margin | -85337.33% |
| ATR(14) | 0.71 | Profit margin | 0.00% |
| SMA20 dist | -11.92% | ROA | -10.60% |
| SMA50 dist | -8.28% | ROE | -55.18% |
| SMA200 dist | -34.41% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.47% |
| P/E (ttm) | — | Insider ownership | 1.70% |
| Forward P/E | -12.62 | Short float | 17.60% |
| PEG (trailing) | — | Avg volume | 32,862,514 |
| P/S | 318.64 | Employees | 428 |
| P/B | 1.65 | Analyst rec (1=buy..5=sell) | 2.7 |

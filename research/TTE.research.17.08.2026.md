...
Signed file: `TTE.research.17.08.2026`

| Field | Value |
|---|---|
| Current price | $88.63 (2026-08-17, ~15-min delayed) |
| Market cap | $196.51B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +50.27%; price +13.50% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.31% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.08%, revenue growth 27.80%. |
| Value attractiveness | Reasonable | Forward P/E 9.19, EV/Sales 1.17. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $88.63; 52w high $93.60 (-5.31%); 52w low $55.92 (+58.49%) |
| Trend | +13.50% vs SMA200, +6.42% vs SMA50, +2.56% vs SMA20 |
| Momentum | RSI(14) 61.9 (neutral) |
| Volatility | ATR(14) 1.65 (~1.9% of price); beta 0.06 |
| Setup perspective | -5.31% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 11.09, forward P/E 9.19, P/S 1.00, P/B 1.54 | EV/Sales 1.17, EV/EBITDA 5.81 |
| Growth expectations | Earnings growth 106.00%, EPS q/q 102.40% | Analyst mean target $— (— analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 54.83% |
...
|---|---|---|---|
| Price | $88.63 | EV/Sales | 1.17 |
| Market cap | $196.51B | EV/EBITDA | 5.81 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 61.9 | Operating margin | 12.79% |
| ATR(14) | 1.65 | Profit margin | 9.08% |
| SMA20 dist | +2.56% | ROA | 5.51% |
| SMA50 dist | +6.42% | ROE | 14.48% |
| SMA200 dist | +13.50% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 54.83% |
| P/E (ttm) | 11.09 | Insider ownership | 8.87% |
| Forward P/E | 9.19 | Short float | 0.20% |
| PEG (trailing) | 0.72 | Avg volume | 1,555,245 |

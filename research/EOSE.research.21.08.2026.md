...
Signed file: `EOSE.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $3.81 (2026-08-21, ~15-min delayed) |
| Market cap | $1.38B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-57.64%) with negative half-year (-64.39%). |
...
| Value attractiveness | Reasonable | Forward P/E -25.48, EV/Sales 10.78. |
| Risk level | High | Beta 2.80, ATR 10.3% of price, short float 32.31%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $3.81; 52w high $19.19 (-80.15%); 52w low $3.14 (+21.34%) |
| Trend | -57.64% vs SMA200, -19.16% vs SMA50, -0.31% vs SMA20 |
| Momentum | RSI(14) 45.0 (neutral) |
| Volatility | ATR(14) 0.39 (~10.3% of price); beta 2.80 |
| Setup perspective | -80.15% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -25.48, P/S 6.43, P/B -1.49 | EV/Sales 10.78, EV/EBITDA -8.12 |
...
- **Volatility risk:** Beta 2.80, ATR 10.3% of price, short float 32.31%. Size positions accordingly.
...
|---|---|---|---|
| Price | $3.81 | EV/Sales | 10.78 |
| Market cap | $1.38B | EV/EBITDA | -8.12 |
| Beta | 2.80 | Gross margin | -84.75% |
| RSI(14) | 45.0 | Operating margin | -121.86% |
| ATR(14) | 0.39 | Profit margin | -246.76% |
| SMA20 dist | -0.31% | ROA | -30.03% |
| SMA50 dist | -19.16% | ROE | — |
| SMA200 dist | -57.64% | Revenue (ttm) | $214.25M |
| 52W high | $19.19 | Revenue growth y/y | 351.40% |
| 52W low | $3.14 | Inst. ownership | 64.43% |
| P/E (ttm) | — | Insider ownership | 1.43% |
| Forward P/E | -25.48 | Short float | 32.31% |
| PEG (trailing) | — | Avg volume | 25,555,453 |
| P/S | 6.43 | Employees | 787 |

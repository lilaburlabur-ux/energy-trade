...
Signed file: `SO.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $89.05 (2026-08-28, ~15-min delayed) |
| Market cap | $102.44B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-2.19%) with negative half-year (-6.04%). |
| Fresh setup quality | Moderate / wait | -8.66% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 15.43%, revenue growth 0.10%. |
| Value attractiveness | Reasonable | Forward P/E 18.08, EV/Sales 5.94. |
| Risk level | Moderate | Beta 0.33, ATR 1.8% of price, short float 2.84%. |
...
|---|---|---|
| 3 Time-Tested Dividend Stocks to Build Annual Income | 24/7 Wall St. | 2026-08-27 |
| CEG Stock Outperforms Industry in the Past Month: Buy, Hold or Sell | Zacks | 2026-08-26 |
| Utility Stocks Hit Record Lows vs. S&P 500: Why It’s Time to Buy | Barrons.com | 2026-08-26 |
| PG&E Stock Runs On A Legislative Calendar, Not The Market's | Trefis | 2026-08-21 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $89.05; 52w high $97.49 (-8.66%); 52w low $82.06 (+8.52%) |
| Trend | -2.19% vs SMA200, -4.73% vs SMA50, -2.58% vs SMA20 |
| Momentum | RSI(14) 34.4 (neutral) |
| Volatility | ATR(14) 1.56 (~1.8% of price); beta 0.33 |
| Setup perspective | -8.66% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.67, forward P/E 18.08, P/S 3.39, P/B 2.59 | EV/Sales 5.94, EV/EBITDA 12.58 |
...
|---|---|---|---|
| Price | $89.05 | EV/Sales | 5.94 |
| Market cap | $102.44B | EV/EBITDA | 12.58 |
| Beta | 0.33 | Gross margin | 48.29% |
| RSI(14) | 34.4 | Operating margin | 29.61% |
| ATR(14) | 1.56 | Profit margin | 15.43% |
| SMA20 dist | -2.58% | ROA | 3.27% |
| SMA50 dist | -4.73% | ROE | 11.48% |
| SMA200 dist | -2.19% | Revenue (ttm) | $30.18B |
| 52W high | $97.49 | Revenue growth y/y | 0.10% |
| 52W low | $82.06 | Inst. ownership | 74.21% |
| P/E (ttm) | 21.67 | Insider ownership | 0.10% |
| Forward P/E | 18.08 | Short float | 2.84% |
| PEG (trailing) | 2.28 | Avg volume | 5,930,636 |

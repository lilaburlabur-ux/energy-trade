...
Signed file: `ENPH.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $37.25 (2026-08-29, ~15-min delayed) |
| Market cap | $4.92B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-8.19%) with negative half-year (-11.88%). |
| Fresh setup quality | Poor / broken | -48.50% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 16.17, EV/Sales 3.66. |
| Risk level | High | Beta 1.65, ATR 5.9% of price, short float 19.63%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $37.25; 52w high $72.33 (-48.50%); 52w low $26.12 (+42.61%) |
| Trend | -8.19% vs SMA200, -10.66% vs SMA50, -5.56% vs SMA20 |
| Momentum | RSI(14) 42.6 (neutral) |
| Volatility | ATR(14) 2.18 (~5.9% of price); beta 1.65 |
| Setup perspective | -48.50% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 36.88, forward P/E 16.17, P/S 3.71, P/B 4.16 | EV/Sales 3.66, EV/EBITDA 25.35 |
...
- **Volatility risk:** Beta 1.65, ATR 5.9% of price, short float 19.63%. Size positions accordingly.
...
|---|---|---|---|
| Price | $37.25 | EV/Sales | 3.66 |
| Market cap | $4.92B | EV/EBITDA | 25.35 |
| Beta | 1.65 | Gross margin | 30.04% |
| RSI(14) | 42.6 | Operating margin | 17.98% |
| ATR(14) | 2.18 | Profit margin | 10.09% |
| SMA20 dist | -5.56% | ROA | 2.38% |
| SMA50 dist | -10.66% | ROE | 13.00% |
| SMA200 dist | -8.19% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 96.77% |
| P/E (ttm) | 36.88 | Insider ownership | 3.03% |
| Forward P/E | 16.17 | Short float | 19.63% |
| PEG (trailing) | 1.13 | Avg volume | 5,522,259 |

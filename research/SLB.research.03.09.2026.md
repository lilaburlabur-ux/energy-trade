...
Signed file: `SLB.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $57.41 (2026-09-03, ~15-min delayed) |
| Market cap | $85.20B |
...
|---|---|---|
| Technical momentum | High | 1Y +68.04%; price +18.50% vs SMA200. |
| Fresh setup quality | Moderate / wait | -3.98% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 8.53%, revenue growth 5.00%. |
| Value attractiveness | Reasonable | Forward P/E 17.76, EV/Sales 2.64. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $57.41; 52w high $59.79 (-3.98%); 52w low $30.96 (+85.41%) |
| Trend | +18.50% vs SMA200, +14.05% vs SMA50, +5.84% vs SMA20 |
| Momentum | RSI(14) 62.6 (neutral) |
| Volatility | ATR(14) 1.92 (~3.3% of price); beta 0.75 |
| Setup perspective | -3.98% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 28.00, forward P/E 17.76, P/S 2.34, P/B 3.27 | EV/Sales 2.64, EV/EBITDA 13.02 |
| Growth expectations | Earnings growth -29.70%, EPS q/q -22.50% | Analyst mean target $62.03 (29 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 92.64% |
...
|---|---|---|---|
| Price | $57.41 | EV/Sales | 2.64 |
| Market cap | $85.20B | EV/EBITDA | 13.02 |
| Beta | 0.75 | Gross margin | 16.99% |
| RSI(14) | 62.6 | Operating margin | 12.71% |
| ATR(14) | 1.92 | Profit margin | 8.53% |
| SMA20 dist | +5.84% | ROA | 6.17% |
| SMA50 dist | +14.05% | ROE | 12.91% |
| SMA200 dist | +18.50% | Revenue (ttm) | $36.37B |
| 52W high | $59.79 | Revenue growth y/y | 5.00% |
| 52W low | $30.96 | Inst. ownership | 92.64% |
| P/E (ttm) | 28.00 | Insider ownership | 0.22% |
| Forward P/E | 17.76 | Short float | 4.28% |
| PEG (trailing) | 1.51 | Avg volume | 13,772,133 |

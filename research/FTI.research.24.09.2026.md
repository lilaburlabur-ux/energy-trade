...
Signed file: `FTI.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $70.95 (2026-09-24, ~15-min delayed) |
| Market cap | $27.82B |
...
|---|---|---|
| Technical momentum | High | 1Y +83.55%; price +7.40% vs SMA200. |
| Fresh setup quality | Moderate / wait | -11.40% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 11.28%, revenue growth 9.00%. |
| Value attractiveness | Reasonable | Forward P/E 19.72, EV/Sales 2.69. |
| Risk level | Elevated | Beta 0.74, ATR 3.2% of price, short float 3.28%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $70.95; 52w high $80.08 (-11.40%); 52w low $35.45 (+100.12%) |
| Trend | +7.40% vs SMA200, -4.87% vs SMA50, -6.07% vs SMA20 |
| Momentum | RSI(14) 37.2 (neutral) |
| Volatility | ATR(14) 2.28 (~3.2% of price); beta 0.74 |
| Setup perspective | -11.40% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 24.81, forward P/E 19.72, P/S 2.67, P/B 8.52 | EV/Sales 2.69, EV/EBITDA 14.16 |
...
- **Volatility risk:** Beta 0.74, ATR 3.2% of price, short float 3.28%. Size positions accordingly.
...
|---|---|---|---|
| Price | $70.95 | EV/Sales | 2.69 |
| Market cap | $27.82B | EV/EBITDA | 14.16 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 37.2 | Operating margin | 17.69% |
| ATR(14) | 2.28 | Profit margin | 11.28% |
| SMA20 dist | -6.07% | ROA | 9.53% |
| SMA50 dist | -4.87% | ROE | 35.81% |
| SMA200 dist | +7.40% | Revenue (ttm) | $10.42B |
| 52W high | $80.08 | Revenue growth y/y | 9.00% |
| 52W low | $35.45 | Inst. ownership | 101.16% |
| P/E (ttm) | 24.81 | Insider ownership | 1.49% |
| Forward P/E | 19.72 | Short float | 3.28% |
| PEG (trailing) | — | Avg volume | 3,531,533 |
| P/S | 2.67 | Employees | 22,000 |
| P/B | 8.52 | Analyst rec (1=buy..5=sell) | 2.0 |

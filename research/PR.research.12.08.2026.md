...
Signed file: `PR.research.12.08.2026`

| Field | Value |
|---|---|
| Current price | $21.45 (2026-08-12, ~15-min delayed) |
| Market cap | $17.97B |
...
|---|---|---|
| Technical momentum | High | 1Y +68.20%; price +22.58% vs SMA200. |
| Fresh setup quality | Moderate / wait | -3.94% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 21.52%, revenue growth 55.10%. |
| Value attractiveness | Reasonable | Forward P/E 9.92, EV/Sales 3.66. |
...
| Permian Resources Q2 Earnings Call Highlights | MarketBeat | 2026-08-09 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $21.45; 52w high $22.33 (-3.94%); 52w low $11.76 (+82.39%) |
| Trend | +22.58% vs SMA200, +9.14% vs SMA50, +4.07% vs SMA20 |
| Momentum | RSI(14) 60.4 (neutral) |
| Volatility | ATR(14) 0.69 (~3.2% of price); beta 0.48 |
| Setup perspective | -3.94% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 13.84, forward P/E 9.92, P/S 3.13, P/B 1.59 | EV/Sales 3.66, EV/EBITDA 4.93 |
...
|---|---|---|---|
| Price | $21.45 | EV/Sales | 3.66 |
| Market cap | $17.97B | EV/EBITDA | 4.93 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 60.4 | Operating margin | 57.44% |
| ATR(14) | 0.69 | Profit margin | 21.52% |
| SMA20 dist | +4.07% | ROA | 7.54% |
| SMA50 dist | +9.14% | ROE | 11.40% |
| SMA200 dist | +22.58% | Revenue (ttm) | $5.74B |
| 52W high | $22.33 | Revenue growth y/y | 55.10% |
| 52W low | $11.76 | Inst. ownership | 89.38% |
| P/E (ttm) | 13.84 | Insider ownership | 4.61% |
| Forward P/E | 9.92 | Short float | 2.76% |
| PEG (trailing) | 1.33 | Avg volume | 10,032,377 |
| P/S | 3.13 | Employees | 515 |

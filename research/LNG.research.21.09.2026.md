...
Signed file: `LNG.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $274.98 (2026-09-21, ~15-min delayed) |
| Market cap | $56.79B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +18.50%; price +13.27% vs SMA200. |
| Fresh setup quality | Moderate / wait | -7.06% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 13.94%, revenue growth 22.70%. |
| Value attractiveness | Reasonable | Forward P/E 13.24, EV/Sales 4.19. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $274.98; 52w high $295.86 (-7.06%); 52w low $187.49 (+46.66%) |
| Trend | +13.27% vs SMA200, +1.65% vs SMA50, -1.89% vs SMA20 |
| Momentum | RSI(14) 50.2 (neutral) |
| Volatility | ATR(14) 7.71 (~2.8% of price); beta -0.00 |
| Setup perspective | -7.06% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.83, forward P/E 13.24, P/S 2.71, P/B 9.23 | EV/Sales 4.19, EV/EBITDA 11.19 |
...
|---|---|---|---|
| Price | $274.98 | EV/Sales | 4.19 |
| Market cap | $56.79B | EV/EBITDA | 11.19 |
| Beta | -0.00 | Gross margin | 36.85% |
| RSI(14) | 50.2 | Operating margin | 75.00% |
| ATR(14) | 7.71 | Profit margin | 13.94% |
| SMA20 dist | -1.89% | ROA | 8.63% |
| SMA50 dist | +1.65% | ROE | 39.12% |
| SMA200 dist | +13.27% | Revenue (ttm) | $20.92B |
| 52W high | $295.86 | Revenue growth y/y | 22.70% |
| 52W low | $187.49 | Inst. ownership | 91.55% |
| P/E (ttm) | 20.83 | Insider ownership | 0.66% |
| Forward P/E | 13.24 | Short float | 2.03% |
| PEG (trailing) | — | Avg volume | 1,959,974 |

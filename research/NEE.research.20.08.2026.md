...
Signed file: `NEE.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $85.03 (2026-08-20, ~15-min delayed) |
| Market cap | $177.37B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-2.37%) with negative half-year (-5.90%). |
...
| Value attractiveness | Reasonable | Forward P/E 19.26, EV/Sales 10.37. |
...
|---|---|---|
| Gemini AI Stock Portfolio’s New Addition: NextEra Energy (NEE) | Insider Monkey | 2026-08-20 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $85.03; 52w high $97.17 (-12.49%); 52w low $68.33 (+24.44%) |
| Trend | -2.37% vs SMA200, -2.46% vs SMA50, -1.81% vs SMA20 |
| Momentum | RSI(14) 38.2 (neutral) |
| Volatility | ATR(14) 1.49 (~1.8% of price); beta 0.65 |
...
| Valuation | P/E 19.11, forward P/E 19.26, P/S 6.18, P/B 3.10 | EV/Sales 10.37, EV/EBITDA 20.39 |
...
|---|---|---|---|
| Price | $85.03 | EV/Sales | 10.37 |
| Market cap | $177.37B | EV/EBITDA | 20.39 |
| Beta | 0.65 | Gross margin | 61.02% |
| RSI(14) | 38.2 | Operating margin | 31.52% |
| ATR(14) | 1.49 | Profit margin | 32.40% |
| SMA20 dist | -1.81% | ROA | 2.44% |
| SMA50 dist | -2.46% | ROE | 11.68% |
| SMA200 dist | -2.37% | Revenue (ttm) | $28.70B |
| 52W high | $97.17 | Revenue growth y/y | 12.40% |
| 52W low | $68.33 | Inst. ownership | 87.15% |
| P/E (ttm) | 19.11 | Insider ownership | 0.12% |
| Forward P/E | 19.26 | Short float | 0.00% |
| PEG (trailing) | 1.88 | Avg volume | 11,405,840 |
| P/S | 6.18 | Employees | 17,400 |
| P/B | 3.10 | Analyst rec (1=buy..5=sell) | 2.0 |

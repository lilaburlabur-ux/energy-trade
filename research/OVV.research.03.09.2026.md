...
Signed file: `OVV.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $65.91 (2026-09-03, ~15-min delayed) |
| Market cap | $18.23B |
...
|---|---|---|
| Technical momentum | High | 1Y +63.69%; price +26.11% vs SMA200. |
...
| Risk level | Moderate | Beta 0.54, ATR 2.6% of price, short float 4.84%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $65.91; 52w high $66.91 (-1.49%); 52w low $35.32 (+86.60%) |
| Trend | +26.11% vs SMA200, +9.28% vs SMA50, +1.99% vs SMA20 |
| Momentum | RSI(14) 59.4 (neutral) |
| Volatility | ATR(14) 1.74 (~2.6% of price); beta 0.54 |
...
|---|---|---|---|
| Price | $65.91 | EV/Sales | 2.39 |
| Market cap | $18.23B | EV/EBITDA | 4.66 |
| Beta | 0.54 | Gross margin | 53.86% |
| RSI(14) | 59.4 | Operating margin | 36.18% |
| ATR(14) | 1.74 | Profit margin | 9.66% |
| SMA20 dist | +1.99% | ROA | 8.64% |
| SMA50 dist | +9.28% | ROE | 8.41% |
| SMA200 dist | +26.11% | Revenue (ttm) | $9.52B |
| 52W high | $66.91 | Revenue growth y/y | 29.70% |
| 52W low | $35.32 | Inst. ownership | 96.95% |
| P/E (ttm) | 18.41 | Insider ownership | 0.47% |
| Forward P/E | 9.02 | Short float | 4.84% |
| PEG (trailing) | — | Avg volume | 3,273,268 |
| P/S | 1.91 | Employees | 1,465 |
| P/B | 1.59 | Analyst rec (1=buy..5=sell) | 1.6 |

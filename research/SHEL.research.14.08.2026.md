...
Signed file: `SHEL.research.14.08.2026`

| Field | Value |
|---|---|
| Current price | $90.47 (2026-08-14, ~15-min delayed) |
| Market cap | $249.88B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +30.27%; price +12.65% vs SMA200. |
| Fresh setup quality | Watch | -2.19% from 52w high and near SMA20 — check for a tight base. |
...
| Risk level | Moderate | Beta -0.22, ATR 1.8% of price, short float 1.77%. |
...
| How North Koreans Faked Their Way Into U.S. Companies | The Wall Street Journal | 2026-08-14 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $90.47; 52w high $92.49 (-2.19%); 52w low $68.25 (+32.56%) |
| Trend | +12.65% vs SMA200, +7.71% vs SMA50, +2.58% vs SMA20 |
| Momentum | RSI(14) 62.2 (neutral) |
| Volatility | ATR(14) 1.61 (~1.8% of price); beta -0.22 |
| Setup perspective | -2.19% from 52w high and near SMA20 — check for a tight base. |
...
|---|---|---|---|
| Price | $90.47 | EV/Sales | 0.99 |
| Market cap | $249.88B | EV/EBITDA | 5.09 |
| Beta | -0.22 | Gross margin | 26.09% |
| RSI(14) | 62.2 | Operating margin | 16.69% |
| ATR(14) | 1.61 | Profit margin | 8.76% |
| SMA20 dist | +2.58% | ROA | 6.40% |
| SMA50 dist | +7.71% | ROE | 14.34% |
| SMA200 dist | +12.65% | Revenue (ttm) | $296.60B |
| 52W high | $92.49 | Revenue growth y/y | 44.70% |
| 52W low | $68.25 | Inst. ownership | 13.46% |
| P/E (ttm) | 10.01 | Insider ownership | 0.01% |
| Forward P/E | 10.26 | Short float | 1.77% |
| PEG (trailing) | 1.34 | Avg volume | 6,637,079 |

...
Signed file: `PR.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $20.50 (2026-08-04, ~15-min delayed) |
| Market cap | $17.66B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +56.16%; price +18.61% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 9.86, EV/Sales 4.14. |
| Risk level | Elevated | Beta 0.48, ATR 3.2% of price, short float 3.05%. |
...
| Permian Resources (PR) Stock Looks Fully Valued After A 431% Run | Simply Wall St. | 2026-07-30 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $20.50; 52w high $22.33 (-8.19%); 52w low $11.76 (+74.31%) |
| Trend | +18.61% vs SMA200, +4.92% vs SMA50, +0.96% vs SMA20 |
| Momentum | RSI(14) 53.4 (neutral) |
| Volatility | ATR(14) 0.65 (~3.2% of price); beta 0.48 |
...
| Valuation | P/E 23.03, forward P/E 9.86, P/S 3.48, P/B 1.51 | EV/Sales 4.14, EV/EBITDA 5.90 |
...
- **Volatility risk:** Beta 0.48, ATR 3.2% of price, short float 3.05%. Size positions accordingly.
...
|---|---|---|---|
| Price | $20.50 | EV/Sales | 4.14 |
| Market cap | $17.66B | EV/EBITDA | 5.90 |
| Beta | 0.48 | Gross margin | 73.33% |
| RSI(14) | 53.4 | Operating margin | 9.17% |
| ATR(14) | 0.65 | Profit margin | 12.79% |
| SMA20 dist | +0.96% | ROA | 5.25% |
| SMA50 dist | +4.92% | ROE | 6.86% |
| SMA200 dist | +18.61% | Revenue (ttm) | $5.08B |
| 52W high | $22.33 | Revenue growth y/y | 0.90% |
| 52W low | $11.76 | Inst. ownership | 89.79% |
| P/E (ttm) | 23.03 | Insider ownership | 4.61% |
| Forward P/E | 9.86 | Short float | 3.05% |
| PEG (trailing) | 1.34 | Avg volume | 10,560,490 |
| P/S | 3.48 | Employees | 515 |
| P/B | 1.51 | Analyst rec (1=buy..5=sell) | 1.3 |

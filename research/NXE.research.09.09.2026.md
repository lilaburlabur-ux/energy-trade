...
Signed file: `NXE.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $10.64 (2026-09-09, ~15-min delayed) |
| Market cap | $7.04B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-1.88%) with negative half-year (-18.15%). |
...
| Value attractiveness | Reasonable | Forward P/E -55.09, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.64; 52w high $13.92 (-23.56%); 52w low $7.56 (+40.74%) |
| Trend | -1.88% vs SMA200, +7.34% vs SMA50, +0.32% vs SMA20 |
| Momentum | RSI(14) 53.5 (neutral) |
| Volatility | ATR(14) 0.46 (~4.4% of price); beta 1.67 |
...
| Valuation | P/E —, forward P/E -55.09, P/S —, P/B 5.33 | EV/Sales —, EV/EBITDA -62.83 |
...
|---|---|---|---|
| Price | $10.64 | EV/Sales | — |
| Market cap | $7.04B | EV/EBITDA | -62.83 |
| Beta | 1.67 | Gross margin | 0.00% |
| RSI(14) | 53.5 | Operating margin | 0.00% |
| ATR(14) | 0.46 | Profit margin | 0.00% |
| SMA20 dist | +0.32% | ROA | -3.39% |
| SMA50 dist | +7.34% | ROE | -17.67% |
| SMA200 dist | -1.88% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.56 | Inst. ownership | 55.32% |
| P/E (ttm) | — | Insider ownership | 6.40% |
| Forward P/E | -55.09 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,137,625 |
| P/S | — | Employees | 142 |
| P/B | 5.33 | Analyst rec (1=buy..5=sell) | 1.5 |

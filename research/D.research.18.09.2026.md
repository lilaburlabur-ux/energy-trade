...
Signed file: `D.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $63.58 (2026-09-18, ~15-min delayed) |
| Market cap | $55.92B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +11.24%; price +0.80% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 16.66, EV/Sales 6.39. |
...
| Microsoft ‘preserving its ability’ to challenge data center transmission costs decision | Utility Dive | 2026-09-18 |
| Dominion Energy (D) Beats Stock Market Upswing: What Investors Need to Know | Zacks | 2026-09-17 |
| NextEra Energy (NEE) Stock Looks Fairly Priced As Merger Approval Looms Large | Simply Wall St. | 2026-09-16 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $63.58; 52w high $70.97 (-10.42%); 52w low $55.36 (+14.85%) |
| Trend | +0.80% vs SMA200, -5.59% vs SMA50, -2.48% vs SMA20 |
...
| Valuation | P/E 22.00, forward P/E 16.66, P/S 3.09, P/B 2.00 | EV/Sales 6.39, EV/EBITDA 13.89 |
...
|---|---|---|---|
| Price | $63.58 | EV/Sales | 6.39 |
| Market cap | $55.92B | EV/EBITDA | 13.89 |
| Beta | 0.62 | Gross margin | 46.22% |
| RSI(14) | 34.6 | Operating margin | 29.22% |
| ATR(14) | 1.07 | Profit margin | 13.98% |
| SMA20 dist | -2.48% | ROA | 3.04% |
| SMA50 dist | -5.59% | ROE | 8.28% |
| SMA200 dist | +0.80% | Revenue (ttm) | $18.12B |
| 52W high | $70.97 | Revenue growth y/y | 17.60% |
| 52W low | $55.36 | Inst. ownership | 83.03% |
| P/E (ttm) | 22.00 | Insider ownership | 0.13% |
| Forward P/E | 16.66 | Short float | 3.09% |
| PEG (trailing) | 2.56 | Avg volume | 4,379,016 |
| P/S | 3.09 | Employees | 15,200 |

...
Signed file: `ARRY.research.16.09.2026`

| Field | Value |
|---|---|
| Current price | $4.20 (2026-09-16, ~15-min delayed) |
| Market cap | $646.83M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-45.75%) with negative half-year (-39.91%). |
| Fresh setup quality | Poor / broken | -64.88% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 4.68, EV/Sales 1.37. |
| Risk level | High | Beta 1.77, ATR 6.3% of price, short float 29.27%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.20; 52w high $11.96 (-64.88%); 52w low $4.20 (+0.00%) |
| Trend | -45.75% vs SMA200, -19.23% vs SMA50, -7.94% vs SMA20 |
| Momentum | RSI(14) 33.7 (neutral) |
| Volatility | ATR(14) 0.26 (~6.3% of price); beta 1.77 |
| Setup perspective | -64.88% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 4.68, P/S 0.55, P/B -3.20 | EV/Sales 1.37, EV/EBITDA 13.56 |
...
- **Volatility risk:** Beta 1.77, ATR 6.3% of price, short float 29.27%. Size positions accordingly.
...
|---|---|---|---|
| Price | $4.20 | EV/Sales | 1.37 |
| Market cap | $646.83M | EV/EBITDA | 13.56 |
| Beta | 1.77 | Gross margin | 26.76% |
| RSI(14) | 33.7 | Operating margin | 10.88% |
| ATR(14) | 0.26 | Profit margin | -7.25% |
| SMA20 dist | -7.94% | ROA | 3.33% |
| SMA50 dist | -19.23% | ROE | -25.98% |
| SMA200 dist | -45.75% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.20 | Inst. ownership | 147.85% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 4.68 | Short float | 29.27% |
| PEG (trailing) | 0.46 | Avg volume | 6,563,709 |
| P/S | 0.55 | Employees | 1,200 |
| P/B | -3.20 | Analyst rec (1=buy..5=sell) | 2.1 |

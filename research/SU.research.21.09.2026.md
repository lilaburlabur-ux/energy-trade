...
Signed file: `SU.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $67.24 (2026-09-21, ~15-min delayed) |
| Market cap | $79.39B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $67.24; 52w high $71.87 (-6.44%); 52w low $37.39 (+79.85%) |
| Trend | +14.75% vs SMA200, +2.66% vs SMA50, -0.86% vs SMA20 |
| Momentum | RSI(14) 49.6 (neutral) |
| Volatility | ATR(14) 1.83 (~2.7% of price); beta 0.56 |
...
| SMA50 dist | +2.66% | ROE | 19.25% |
| SMA200 dist | +14.75% | Revenue (ttm) | $56.57B |

...
Signed file: `APA.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $43.68 (2026-09-24, ~15-min delayed) |
| Market cap | $15.30B |
...
|---|---|---|
| Technical momentum | High | 1Y +91.46%; price +26.78% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 9.77, EV/Sales 2.29. |
...
| Trend | +26.78% vs SMA200, +7.77% vs SMA50, -0.91% vs SMA20 |
| Momentum | RSI(14) 52.3 (neutral) |
| Volatility | ATR(14) 1.55 (~3.5% of price); beta 0.37 |
...
|---|---|---|---|
| Price | $43.68 | EV/Sales | 2.29 |
| Market cap | $15.30B | EV/EBITDA | 3.44 |
| Beta | 0.37 | Gross margin | 78.25% |
| RSI(14) | 52.3 | Operating margin | 56.33% |
| ATR(14) | 1.55 | Profit margin | 19.56% |
| SMA20 dist | -0.91% | ROA | 11.60% |
| SMA50 dist | +7.77% | ROE | 26.66% |

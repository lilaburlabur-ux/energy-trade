...
Signed file: `VLO.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $412.53 (2026-09-17, ~15-min delayed) |
| Market cap | $118.78B |
...
|---|---|---|
| Technical momentum | High | 1Y +159.02%; price +67.16% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 11.05, EV/Sales 0.93. |
| Risk level | Elevated | Beta 0.57, ATR 3.2% of price, short float 3.99%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $412.53; 52w high $412.53 (+0.00%); 52w low $153.14 (+169.38%) |
| Trend | +67.16% vs SMA200, +23.27% vs SMA50, +11.56% vs SMA20 |
| Momentum | RSI(14) 79.9 (overbought) |
| Volatility | ATR(14) 13.35 (~3.2% of price); beta 0.57 |
...
| Valuation | P/E 17.19, forward P/E 11.05, P/S 0.90, P/B 4.75 | EV/Sales 0.93, EV/EBITDA 9.18 |
...
- **Volatility risk:** Beta 0.57, ATR 3.2% of price, short float 3.99%. Size positions accordingly.
...
|---|---|---|---|
| Price | $412.53 | EV/Sales | 0.93 |
| Market cap | $118.78B | EV/EBITDA | 9.18 |
| Beta | 0.57 | Gross margin | 16.12% |
| RSI(14) | 79.9 | Operating margin | 12.27% |
| ATR(14) | 13.35 | Profit margin | 5.45% |
| SMA20 dist | +11.56% | ROA | 10.56% |
| SMA50 dist | +23.27% | ROE | 27.64% |
| SMA200 dist | +67.16% | Revenue (ttm) | $132.43B |
| 52W high | $412.53 | Revenue growth y/y | 51.70% |
| 52W low | $153.14 | Inst. ownership | 87.03% |
| P/E (ttm) | 17.19 | Insider ownership | 0.42% |
| Forward P/E | 11.05 | Short float | 3.99% |
| PEG (trailing) | 4.08 | Avg volume | 2,898,195 |
| P/S | 0.90 | Employees | 9,785 |
| P/B | 4.75 | Analyst rec (1=buy..5=sell) | 2.3 |

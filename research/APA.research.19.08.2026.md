...
| Field | Value |
|---|---|
| Current price | $43.45 (2026-08-19, ~15-min delayed) |
| Market cap | $15.22B |
...
|---|---|---|
| Technical momentum | High | 1Y +120.31%; price +35.66% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.77% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 19.56%, revenue growth 9.20%. |
| Value attractiveness | Reasonable | Forward P/E 10.18, EV/Sales 2.24. |
| Risk level | High | Beta 0.35, ATR 3.4% of price, short float 11.31%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $43.45; 52w high $43.79 (-0.77%); 52w low $19.56 (+122.16%) |
| Trend | +35.66% vs SMA200, +21.58% vs SMA50, +13.81% vs SMA20 |
| Momentum | RSI(14) 72.9 (overbought) |
| Volatility | ATR(14) 1.47 (~3.4% of price); beta 0.35 |
| Setup perspective | -0.77% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 9.17, forward P/E 10.18, P/S 1.78, P/B 2.17 | EV/Sales 2.24, EV/EBITDA 3.36 |
| Growth expectations | Earnings growth 26.30%, EPS q/q 23.90% | Analyst mean target $43.54 (24 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 109.24% |
...
- **Volatility risk:** Beta 0.35, ATR 3.4% of price, short float 11.31%. Size positions accordingly.
...
|---|---|---|---|
| Price | $43.45 | EV/Sales | 2.24 |
| Market cap | $15.22B | EV/EBITDA | 3.36 |
| Beta | 0.35 | Gross margin | 78.25% |
| RSI(14) | 72.9 | Operating margin | 56.33% |
| ATR(14) | 1.47 | Profit margin | 19.56% |
| SMA20 dist | +13.81% | ROA | 11.60% |
| SMA50 dist | +21.58% | ROE | 26.66% |
| SMA200 dist | +35.66% | Revenue (ttm) | $8.57B |
| 52W high | $43.79 | Revenue growth y/y | 9.20% |
| 52W low | $19.56 | Inst. ownership | 109.24% |
| P/E (ttm) | 9.17 | Insider ownership | 0.44% |
| Forward P/E | 10.18 | Short float | 11.31% |
| PEG (trailing) | 0.81 | Avg volume | 5,515,754 |
| P/S | 1.78 | Employees | 1,791 |
| P/B | 2.17 | Analyst rec (1=buy..5=sell) | 2.6 |

...
Signed file: `HAL.research.02.09.2026`

| Field | Value |
|---|---|
| Current price | $37.63 (2026-09-02, ~15-min delayed) |
| Market cap | $31.44B |
...
|---|---|---|
| Technical momentum | High | 1Y +69.69%; price +8.96% vs SMA200. |
| Fresh setup quality | Moderate / wait | -12.08% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 7.16%, revenue growth 3.70%. |
| Value attractiveness | Reasonable | Forward P/E 12.97, EV/Sales 1.65. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $37.63; 52w high $42.80 (-12.08%); 52w low $21.26 (+77.00%) |
| Trend | +8.96% vs SMA200, +10.76% vs SMA50, +8.50% vs SMA20 |
| Momentum | RSI(14) 67.4 (neutral) |
| Volatility | ATR(14) 1.09 (~2.9% of price); beta 0.75 |
| Setup perspective | -12.08% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 19.70, forward P/E 12.97, P/S 1.41, P/B 2.85 | EV/Sales 1.65, EV/EBITDA 8.90 |
...
|---|---|---|---|
| Price | $37.63 | EV/Sales | 1.65 |
| Market cap | $31.44B | EV/EBITDA | 8.90 |
| Beta | 0.75 | Gross margin | 15.08% |
| RSI(14) | 67.4 | Operating margin | 12.79% |
| ATR(14) | 1.09 | Profit margin | 7.16% |
| SMA20 dist | +8.50% | ROA | 7.26% |
| SMA50 dist | +10.76% | ROE | 14.92% |
| SMA200 dist | +8.96% | Revenue (ttm) | $22.37B |
| 52W high | $42.80 | Revenue growth y/y | 3.70% |
| 52W low | $21.26 | Inst. ownership | 90.54% |
| P/E (ttm) | 19.70 | Insider ownership | 0.40% |
| Forward P/E | 12.97 | Short float | 5.04% |
| PEG (trailing) | 0.76 | Avg volume | 11,855,487 |
| P/S | 1.41 | Employees | 46,000 |
| P/B | 2.85 | Analyst rec (1=buy..5=sell) | 1.8 |

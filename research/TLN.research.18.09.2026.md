...
Signed file: `TLN.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $292.30 (2026-09-18, ~15-min delayed) |
| Market cap | $14.01B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-17.54%) with negative half-year (-14.05%). |
...
| Value attractiveness | Reasonable | Forward P/E 9.50, EV/Sales 6.26. |
| Risk level | Elevated | Beta 1.63, ATR 4.8% of price, short float 5.69%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $292.30; 52w high $445.84 (-34.44%); 52w low $282.15 (+3.60%) |
| Trend | -17.54% vs SMA200, -12.38% vs SMA50, -3.54% vs SMA20 |
| Momentum | RSI(14) 39.5 (neutral) |
| Volatility | ATR(14) 13.99 (~4.8% of price); beta 1.63 |
...
| Valuation | P/E —, forward P/E 9.50, P/S 3.74, P/B 8.66 | EV/Sales 6.26, EV/EBITDA 40.24 |
...
- **Volatility risk:** Beta 1.63, ATR 4.8% of price, short float 5.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $292.30 | EV/Sales | 6.26 |
| Market cap | $14.01B | EV/EBITDA | 40.24 |
| Beta | 1.63 | Gross margin | 42.10% |
| RSI(14) | 39.5 | Operating margin | -4.80% |
| ATR(14) | 13.99 | Profit margin | -4.95% |
| SMA20 dist | -3.54% | ROA | 0.92% |
| SMA50 dist | -12.38% | ROE | -12.83% |
| SMA200 dist | -17.54% | Revenue (ttm) | $3.74B |
| 52W high | $445.84 | Revenue growth y/y | 111.20% |
| 52W low | $282.15 | Inst. ownership | 102.11% |
| P/E (ttm) | — | Insider ownership | 1.36% |
| Forward P/E | 9.50 | Short float | 5.69% |
| PEG (trailing) | — | Avg volume | 819,287 |
| P/S | 3.74 | Employees | 1,880 |

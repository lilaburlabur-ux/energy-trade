...
Signed file: `SMR.research.24.09.2026`

| Field | Value |
|---|---|
| Current price | $8.47 (2026-09-24, ~15-min delayed) |
| Market cap | $3.48B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-31.19%) with negative half-year (-27.54%). |
| Fresh setup quality | Poor / broken | -84.15% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -12.83, EV/Sales 221.04. |
| Risk level | High | Beta 2.31, ATR 7.9% of price, short float 17.60%. |
...
|---|---|---|
| NuScale Power Trades Below $10. Bargain or Value Trap? | Motley Fool | 2026-09-24 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $8.47; 52w high $53.43 (-84.15%); 52w low $7.59 (+11.59%) |
| Trend | -31.19% vs SMA200, -6.40% vs SMA50, -8.29% vs SMA20 |
| Momentum | RSI(14) 44.3 (neutral) |
| Volatility | ATR(14) 0.67 (~7.9% of price); beta 2.31 |
| Setup perspective | -84.15% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -12.83, P/S 325.16, P/B 1.69 | EV/Sales 221.04, EV/EBITDA -10.54 |
...
- **Volatility risk:** Beta 2.31, ATR 7.9% of price, short float 17.60%. Size positions accordingly.
...
|---|---|---|---|
| Price | $8.47 | EV/Sales | 221.04 |
| Market cap | $3.48B | EV/EBITDA | -10.54 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 44.3 | Operating margin | -85337.33% |
| ATR(14) | 0.67 | Profit margin | 0.00% |
| SMA20 dist | -8.29% | ROA | -10.60% |
| SMA50 dist | -6.40% | ROE | -55.18% |
| SMA200 dist | -31.19% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.47% |
| P/E (ttm) | — | Insider ownership | 1.70% |
| Forward P/E | -12.83 | Short float | 17.60% |
| PEG (trailing) | — | Avg volume | 33,096,779 |
| P/S | 325.16 | Employees | 428 |

...
Signed file: `GEV.research.03.08.2026`

| Field | Value |
|---|---|
| Current price | $1,006.76 (2026-08-03, ~15-min delayed) |
| Market cap | $268.13B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +52.82%; price +20.19% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 40.46, EV/Sales 6.19. |
| Risk level | High | Beta 1.03, ATR 6.3% of price, short float 3.80%. |
...
| Why Did AirJoule Stock Pop Today? | Motley Fool | 2026-08-03 |
| How AI-Driven Power Demand and Wind Cost Pressures At GE Vernova (GEV) Has Changed Its Investment Story | Simply Wall St. | 2026-08-03 |
| Exploring Unmatched Scale of GE Vernova (GEV) | Insider Monkey | 2026-08-03 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $1,006.76; 52w high $1,174.86 (-14.31%); 52w low $546.95 (+84.07%) |
| Trend | +20.19% vs SMA200, -1.71% vs SMA50, -2.17% vs SMA20 |
| Momentum | RSI(14) 48.2 (neutral) |
| Volatility | ATR(14) 63.74 (~6.3% of price); beta 1.03 |
...
| Valuation | P/E 28.88, forward P/E 40.46, P/S 6.48, P/B 22.42 | EV/Sales 6.19, EV/EBITDA 65.17 |
...
|---|---|---|---|
| Blackrock Inc. | 20,726,610 | 7.78% | 2026-03-31 |
| FMR, LLC | 18,336,935 | 6.88% | 2026-03-31 |
| Vanguard Capital Management LLC | 17,516,600 | 6.58% | 2026-03-31 |
| State Street Corporation | 11,394,498 | 4.28% | 2026-03-31 |
| JPMORGAN CHASE & CO | 6,752,963 | 2.54% | 2026-03-31 |
| Geode Capital Management, LLC | 6,385,078 | 2.40% | 2026-03-31 |
...
- **Valuation risk:** Forward P/E 40.46, EV/Sales 6.19. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.03, ATR 6.3% of price, short float 3.80%. Size positions accordingly.
...
|---|---|---|---|
| Price | $1,006.76 | EV/Sales | 6.19 |
| Market cap | $268.13B | EV/EBITDA | 65.17 |
| Beta | 1.03 | Gross margin | 20.57% |
| RSI(14) | 48.2 | Operating margin | 7.47% |
| ATR(14) | 63.74 | Profit margin | 23.04% |
| SMA20 dist | -2.17% | ROA | 2.54% |
| SMA50 dist | -1.71% | ROE | 82.58% |
| SMA200 dist | +20.19% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 80.57% |
| P/E (ttm) | 28.88 | Insider ownership | 0.12% |
| Forward P/E | 40.46 | Short float | 3.80% |
| PEG (trailing) | 1.68 | Avg volume | 2,870,979 |
| P/S | 6.48 | Employees | 78,000 |
| P/B | 22.42 | Analyst rec (1=buy..5=sell) | 1.6 |

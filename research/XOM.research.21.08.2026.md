...
Signed file: `XOM.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $165.11 (2026-08-21, ~15-min delayed) |
| Market cap | $678.92B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +56.54%; price +17.32% vs SMA200. |
| Fresh setup quality | Moderate / wait | -2.43% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.07%, revenue growth 44.10%. |
| Value attractiveness | Reasonable | Forward P/E 15.46, EV/Sales 2.00. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $165.11; 52w high $169.22 (-2.43%); 52w low $106.15 (+55.54%) |
| Trend | +17.32% vs SMA200, +11.48% vs SMA50, +4.78% vs SMA20 |
| Momentum | RSI(14) 68.9 (neutral) |
| Volatility | ATR(14) 3.64 (~2.2% of price); beta 0.17 |
| Setup perspective | -2.43% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.22, forward P/E 15.46, P/S 1.88, P/B 2.62 | EV/Sales 2.00, EV/EBITDA 10.62 |
...
|---|---|---|---|
| Price | $165.11 | EV/Sales | 2.00 |
| Market cap | $678.92B | EV/EBITDA | 10.62 |
| Beta | 0.17 | Gross margin | 29.77% |
| RSI(14) | 68.9 | Operating margin | 15.86% |
| ATR(14) | 3.64 | Profit margin | 9.07% |
| SMA20 dist | +4.78% | ROA | 5.52% |
| SMA50 dist | +11.48% | ROE | 12.58% |
| SMA200 dist | +17.32% | Revenue (ttm) | $361.06B |
| 52W high | $169.22 | Revenue growth y/y | 44.10% |
| 52W low | $106.15 | Inst. ownership | 66.14% |
| P/E (ttm) | 21.22 | Insider ownership | 0.08% |
| Forward P/E | 15.46 | Short float | 1.15% |
| PEG (trailing) | 1.30 | Avg volume | 15,830,840 |

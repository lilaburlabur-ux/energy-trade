...
Signed file: `WFRD.research.03.08.2026`

| Field | Value |
|---|---|
| Current price | $88.35 (2026-08-03, ~15-min delayed) |
| Market cap | $6.33B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-1.27%) with negative half-year (-5.60%). |
...
| Value attractiveness | Reasonable | Forward P/E 12.15, EV/Sales 1.43. |
| Risk level | Elevated | Beta 0.89, ATR 4.3% of price, short float 9.36%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $88.35; 52w high $111.42 (-20.71%); 52w low $53.31 (+65.72%) |
| Trend | -1.27% vs SMA200, -3.12% vs SMA50, +5.43% vs SMA20 |
| Momentum | RSI(14) 54.1 (neutral) |
| Volatility | ATR(14) 3.78 (~4.3% of price); beta 0.89 |
...
| Valuation | P/E 17.43, forward P/E 12.15, P/S 1.33, P/B 3.55 | EV/Sales 1.43, EV/EBITDA 7.34 |
...
- **Volatility risk:** Beta 0.89, ATR 4.3% of price, short float 9.36%. Size positions accordingly.
...
|---|---|---|---|
| Price | $88.35 | EV/Sales | 1.43 |
| Market cap | $6.33B | EV/EBITDA | 7.34 |
| Beta | 0.89 | Gross margin | 30.51% |
| RSI(14) | 54.1 | Operating margin | 10.50% |
| ATR(14) | 3.78 | Profit margin | 7.66% |
| SMA20 dist | +5.43% | ROA | 7.90% |
| SMA50 dist | -3.12% | ROE | 22.79% |
| SMA200 dist | -1.27% | Revenue (ttm) | $4.78B |
| 52W high | $111.42 | Revenue growth y/y | -8.20% |
| 52W low | $53.31 | Inst. ownership | 104.96% |
| P/E (ttm) | 17.43 | Insider ownership | 2.16% |
| Forward P/E | 12.15 | Short float | 9.36% |
| PEG (trailing) | 1.73 | Avg volume | 1,311,575 |
| P/S | 1.33 | Employees | 16,700 |
| P/B | 3.55 | Analyst rec (1=buy..5=sell) | 1.7 |

...
Signed file: `CEG.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $272.92 (2026-08-20, ~15-min delayed) |
| Market cap | $96.70B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-8.84%) with negative half-year (-6.01%). |
| Fresh setup quality | Poor / broken | -32.06% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 11.08%, revenue growth 23.00%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.56, EV/Sales 3.88. |
| Risk level | Elevated | Beta 1.12, ATR 3.6% of price, short float 3.29%. |
...
|---|---|---|
| This Week In Energy Transition - AI Powers the Rise of Green Hydrogen Investments | Simply Wall St. | 2026-08-20 |
...
| KKR Makes $9 Billion Takeover Bid for Natural-Gas and Electricity Distributor | The Wall Street Journal | 2026-08-18 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $272.92; 52w high $401.70 (-32.06%); 52w low $236.14 (+15.58%) |
| Trend | -8.84% vs SMA200, +4.12% vs SMA50, +1.10% vs SMA20 |
| Momentum | RSI(14) 53.3 (neutral) |
| Volatility | ATR(14) 9.93 (~3.6% of price); beta 1.12 |
| Setup perspective | -32.06% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 26.68, forward P/E 20.56, P/S 3.09, P/B 3.03 | EV/Sales 3.88, EV/EBITDA 15.28 |
| Growth expectations | Earnings growth -46.80%, EPS q/q -38.90% | Analyst mean target $347.50 (20 analysts) |
...
- **Valuation risk:** Forward P/E 20.56, EV/Sales 3.88. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.12, ATR 3.6% of price, short float 3.29%. Size positions accordingly.
...
|---|---|---|---|
| Price | $272.92 | EV/Sales | 3.88 |
| Market cap | $96.70B | EV/EBITDA | 15.28 |
| Beta | 1.12 | Gross margin | 22.11% |
| RSI(14) | 53.3 | Operating margin | 8.66% |
| ATR(14) | 9.93 | Profit margin | 11.08% |
| SMA20 dist | +1.10% | ROA | 3.89% |
| SMA50 dist | +4.12% | ROE | 15.06% |
| SMA200 dist | -8.84% | Revenue (ttm) | $31.27B |
| 52W high | $401.70 | Revenue growth y/y | 23.00% |
| 52W low | $236.14 | Inst. ownership | 83.17% |
| P/E (ttm) | 26.68 | Insider ownership | 0.34% |
| Forward P/E | 20.56 | Short float | 3.29% |
| PEG (trailing) | — | Avg volume | 3,476,137 |
| P/S | 3.09 | Employees | 15,291 |
| P/B | 3.03 | Analyst rec (1=buy..5=sell) | 1.5 |

...
Signed file: `TTE.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $91.23 (2026-09-10, ~15-min delayed) |
| Market cap | $201.60B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +54.58%; price +13.39% vs SMA200. |
| Fresh setup quality | Watch | -2.53% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 9.08%, revenue growth 27.80%. |
| Value attractiveness | Reasonable | Forward P/E 8.81, EV/Sales 1.21. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $91.23; 52w high $93.60 (-2.53%); 52w low $55.92 (+63.14%) |
| Trend | +13.39% vs SMA200, +6.80% vs SMA50, +2.40% vs SMA20 |
| Momentum | RSI(14) 61.3 (neutral) |
| Volatility | ATR(14) 1.66 (~1.8% of price); beta 0.06 |
| Setup perspective | -2.53% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 11.42, forward P/E 8.81, P/S 1.03, P/B 1.58 | EV/Sales 1.21, EV/EBITDA 5.99 |
...
|---|---|---|---|
| Price | $91.23 | EV/Sales | 1.21 |
| Market cap | $201.60B | EV/EBITDA | 5.99 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 61.3 | Operating margin | 12.79% |
| ATR(14) | 1.66 | Profit margin | 9.08% |
| SMA20 dist | +2.40% | ROA | 5.51% |
| SMA50 dist | +6.80% | ROE | 14.48% |
| SMA200 dist | +13.39% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 54.14% |
| P/E (ttm) | 11.42 | Insider ownership | 8.86% |
| Forward P/E | 8.81 | Short float | 0.19% |
| PEG (trailing) | 0.83 | Avg volume | 1,673,372 |
| P/S | 1.03 | Employees | 94,847 |
| P/B | 1.58 | Analyst rec (1=buy..5=sell) | 2.3 |

...
Signed file: `HUBB.research.04.09.2026`

| Field | Value |
|---|---|
| Current price | $460.72 (2026-09-04, ~15-min delayed) |
| Market cap | $24.34B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-4.54%) with negative half-year (-1.70%). |
| Fresh setup quality | Moderate / wait | -16.91% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 14.49%, revenue growth 15.30%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.11, EV/Sales 4.74. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $460.72; 52w high $554.46 (-16.91%); 52w low $402.45 (+14.48%) |
| Trend | -4.54% vs SMA200, -4.75% vs SMA50, -3.39% vs SMA20 |
| Momentum | RSI(14) 43.2 (neutral) |
| Volatility | ATR(14) 13.13 (~2.8% of price); beta 0.89 |
| Setup perspective | -16.91% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 27.28, forward P/E 20.11, P/S 3.91, P/B 6.22 | EV/Sales 4.74, EV/EBITDA 19.45 |
...
- **Valuation risk:** Forward P/E 20.11, EV/Sales 4.74. Multiple compression is the main downside if growth disappoints.
...
| Market cap | $24.34B | EV/EBITDA | 19.45 |
| Beta | 0.89 | Gross margin | 35.34% |
| RSI(14) | 43.2 | Operating margin | 21.67% |
| ATR(14) | 13.13 | Profit margin | 14.49% |
| SMA20 dist | -3.39% | ROA | 8.43% |

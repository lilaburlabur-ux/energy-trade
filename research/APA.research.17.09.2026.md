...
Signed file: `APA.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $45.46 (2026-09-17, ~15-min delayed) |
| Market cap | $15.93B |
...
|---|---|---|
| Technical momentum | High | 1Y +91.94%; price +33.38% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.35, EV/Sales 2.34. |
| Risk level | Elevated | Beta 0.37, ATR 3.6% of price, short float 9.10%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $45.46; 52w high $47.41 (-4.11%); 52w low $21.16 (+114.80%) |
| Trend | +33.38% vs SMA200, +14.48% vs SMA50, +3.60% vs SMA20 |
| Momentum | RSI(14) 60.1 (neutral) |
| Volatility | ATR(14) 1.63 (~3.6% of price); beta 0.37 |
...
| Valuation | P/E 9.59, forward P/E 10.35, P/S 1.86, P/B 2.27 | EV/Sales 2.34, EV/EBITDA 3.51 |
| Growth expectations | Earnings growth 26.30%, EPS q/q 23.90% | Analyst mean target $45.88 (25 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 110.15% |
...
- **Volatility risk:** Beta 0.37, ATR 3.6% of price, short float 9.10%. Size positions accordingly.
- **Short interest risk:** short float 9.10% can fuel squeezes both ways around news.
...
|---|---|---|---|
| Price | $45.46 | EV/Sales | 2.34 |
| Market cap | $15.93B | EV/EBITDA | 3.51 |
| Beta | 0.37 | Gross margin | 78.25% |
| RSI(14) | 60.1 | Operating margin | 56.33% |
| ATR(14) | 1.63 | Profit margin | 19.56% |
| SMA20 dist | +3.60% | ROA | 11.60% |
| SMA50 dist | +14.48% | ROE | 26.66% |
| SMA200 dist | +33.38% | Revenue (ttm) | $8.57B |
| 52W high | $47.41 | Revenue growth y/y | 9.20% |
| 52W low | $21.16 | Inst. ownership | 110.15% |
| P/E (ttm) | 9.59 | Insider ownership | 0.44% |
| Forward P/E | 10.35 | Short float | 9.10% |
| PEG (trailing) | 1.21 | Avg volume | 5,608,958 |

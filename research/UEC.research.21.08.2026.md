...
Signed file: `UEC.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $12.76 (2026-08-21, ~15-min delayed) |
| Market cap | — |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-3.78%) with negative half-year (-21.48%). |
...
| Value attractiveness | Reasonable | Forward P/E -141.78, EV/Sales 249.09. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $12.76; 52w high $20.14 (-36.64%); 52w low $9.04 (+41.15%) |
| Trend | -3.78% vs SMA200, +20.39% vs SMA50, +18.58% vs SMA20 |
| Momentum | RSI(14) 68.1 (neutral) |
| Volatility | ATR(14) 0.65 (~5.1% of price); beta 1.21 |
...
| Valuation | P/E —, forward P/E -141.78, P/S —, P/B — | EV/Sales 249.09, EV/EBITDA -41.67 |
...
|---|---|---|---|
| Price | $12.76 | EV/Sales | 249.09 |
| Market cap | — | EV/EBITDA | -41.67 |
| Beta | 1.21 | Gross margin | 0.00% |
| RSI(14) | 68.1 | Operating margin | -629.66% |
| ATR(14) | 0.65 | Profit margin | 0.00% |
| SMA20 dist | +18.58% | ROA | -6.25% |
| SMA50 dist | +20.39% | ROE | -8.96% |
| SMA200 dist | -3.78% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 88.44% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -141.78 | Short float | 14.38% |
| PEG (trailing) | — | Avg volume | 9,409,548 |
| P/S | — | Employees | 171 |

...
Signed file: `EQNR.research.05.08.2026`
...
|---|---|---|
| Technical momentum | Moderate | 1Y +59.58%; price +22.52% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.74, EV/Sales 1.78. |
| Risk level | Elevated | Beta -0.73, ATR 3.5% of price, short float 2.92%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.13; 52w high $41.97 (-9.15%); 52w low $21.89 (+74.18%) |
| Trend | +22.52% vs SMA200, +5.85% vs SMA50, +0.07% vs SMA20 |
| Momentum | RSI(14) 52.0 (neutral) |
| Volatility | ATR(14) 1.32 (~3.5% of price); beta -0.73 |
...
| Valuation | P/E 10.33, forward P/E 10.74, P/S 0.80, P/B 4.31 | EV/Sales 1.78, EV/EBITDA 4.84 |
...
- **Volatility risk:** Beta -0.73, ATR 3.5% of price, short float 2.92%. Size positions accordingly.
...
| SMA20 dist | +0.07% | ROA | 14.52% |
| SMA50 dist | +5.85% | ROE | 21.27% |
| SMA200 dist | +22.52% | Revenue (ttm) | $113.65B |
| 52W high | $41.97 | Revenue growth y/y | 37.40% |
| 52W low | $21.89 | Inst. ownership | 6.88% |
| P/E (ttm) | 10.33 | Insider ownership | 0.00% |
| Forward P/E | 10.74 | Short float | 2.92% |
| PEG (trailing) | 1.03 | Avg volume | 3,950,016 |
| P/S | 0.80 | Employees | 23,545 |
| P/B | 4.31 | Analyst rec (1=buy..5=sell) | 3.3 |
...
## 9. Conclusion
EQNR: Moderate momentum / mixed fundamentals / reasonable value / elevated risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

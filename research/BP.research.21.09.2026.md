...
Signed file: `BP.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $43.16 (2026-09-21, ~15-min delayed) |
| Market cap | $111.15B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $43.16; 52w high $46.96 (-8.09%); 52w low $31.17 (+38.45%) |
| Trend | +6.73% vs SMA200, -0.05% vs SMA50, -2.62% vs SMA20 |
| Momentum | RSI(14) 44.5 (neutral) |
| Volatility | ATR(14) 1.06 (~2.5% of price); beta -0.22 |
...
| SMA20 dist | -2.62% | ROA | 5.04% |
| SMA50 dist | -0.05% | ROE | 8.87% |
| SMA200 dist | +6.73% | Revenue (ttm) | $215.47B |

...
Signed file: `EPD.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $38.45 (2026-09-17, ~15-min delayed) |
| Market cap | $83.03B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +28.86%; price +7.50% vs SMA200. |
| Fresh setup quality | Watch | -2.31% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.14, EV/Sales 2.00. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.45; 52w high $39.36 (-2.31%); 52w low $28.35 (+35.61%) |
| Trend | +7.50% vs SMA200, +0.52% vs SMA50, -0.94% vs SMA20 |
| Momentum | RSI(14) 48.0 (neutral) |
| Volatility | ATR(14) 0.58 (~1.5% of price); beta 0.48 |
| Setup perspective | -2.31% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.30, forward P/E 12.14, P/S 1.42, P/B 2.75 | EV/Sales 2.00, EV/EBITDA 11.36 |
...
|---|---|---|---|
| Price | $38.45 | EV/Sales | 2.00 |
| Market cap | $83.03B | EV/EBITDA | 11.36 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 48.0 | Operating margin | 11.76% |
| ATR(14) | 0.58 | Profit margin | 10.79% |
| SMA20 dist | -0.94% | ROA | 5.92% |
| SMA50 dist | +0.52% | ROE | 20.85% |
| SMA200 dist | +7.50% | Revenue (ttm) | $58.47B |
...
| PEG (trailing) | 1.35 | Avg volume | 2,907,990 |

...
Signed file: `LEU.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $186.26 (2026-08-21, ~15-min delayed) |
| Market cap | $3.72B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-13.67%) with negative half-year (-8.58%). |
| Fresh setup quality | Poor / broken | -57.28% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.23%, revenue growth 14.00%. |
| Value attractiveness | Low (expensive) | Forward P/E 48.73, EV/Sales 5.96. |
| Risk level | High | Beta 1.35, ATR 6.2% of price, short float 26.68%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $186.26; 52w high $436.00 (-57.28%); 52w low $146.61 (+27.04%) |
| Trend | -13.67% vs SMA200, +7.62% vs SMA50, +2.30% vs SMA20 |
| Momentum | RSI(14) 53.9 (neutral) |
| Volatility | ATR(14) 11.50 (~6.2% of price); beta 1.35 |
| Setup perspective | -57.28% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 99.07, forward P/E 48.73, P/S 7.84, P/B 4.40 | EV/Sales 5.96, EV/EBITDA 279.53 |
...
- **Valuation risk:** Forward P/E 48.73, EV/Sales 5.96. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.35, ATR 6.2% of price, short float 26.68%. Size positions accordingly.
...
|---|---|---|---|
| Price | $186.26 | EV/Sales | 5.96 |
| Market cap | $3.72B | EV/EBITDA | 279.53 |
| Beta | 1.35 | Gross margin | 23.66% |
| RSI(14) | 53.9 | Operating margin | 5.34% |
| ATR(14) | 11.50 | Profit margin | 10.23% |
| SMA20 dist | +2.30% | ROA | 0.02% |
| SMA50 dist | +7.62% | ROE | 8.05% |
| SMA200 dist | -13.67% | Revenue (ttm) | $473.90M |
| 52W high | $436.00 | Revenue growth y/y | 14.00% |
| 52W low | $146.61 | Inst. ownership | 89.22% |
| P/E (ttm) | 99.07 | Insider ownership | 4.31% |
| Forward P/E | 48.73 | Short float | 26.68% |
| PEG (trailing) | — | Avg volume | 802,133 |
| P/S | 7.84 | Employees | 467 |
| P/B | 4.40 | Analyst rec (1=buy..5=sell) | 1.8 |

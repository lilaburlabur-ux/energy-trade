...
Signed file: `ET.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $21.38 (2026-08-28, ~15-min delayed) |
| Market cap | $73.62B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +30.65%; price +17.49% vs SMA200. |
| Fresh setup quality | Watch | -0.23% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 4.92%, revenue growth 78.40%. |
| Value attractiveness | Reasonable | Forward P/E 12.22, EV/Sales 1.50. |
...
|---|---|---|
| Energy Transfer vs. Enterprise Products Partners: Which Is the Better Dividend Stock to Own? | Motley Fool | 2026-08-27 |
| Youngest Boomers Just Hit 62: Claim Social Security Now and Grab These 5 Dividend Giants Yielding 6% | 24/7 Wall St. | 2026-08-26 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $21.38; 52w high $21.43 (-0.23%); 52w low $15.15 (+41.08%) |
| Trend | +17.49% vs SMA200, +7.28% vs SMA50, +2.93% vs SMA20 |
| Momentum | RSI(14) 66.6 (neutral) |
| Volatility | ATR(14) 0.35 (~1.6% of price); beta 0.56 |
| Setup perspective | -0.23% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 14.64, forward P/E 12.22, P/S 0.69, P/B 2.30 | EV/Sales 1.50, EV/EBITDA 9.43 |
...
|---|---|---|---|
| Price | $21.38 | EV/Sales | 1.50 |
| Market cap | $73.62B | EV/EBITDA | 9.43 |
| Beta | 0.56 | Gross margin | 17.51% |
| RSI(14) | 66.6 | Operating margin | 10.41% |
| ATR(14) | 0.35 | Profit margin | 4.92% |
| SMA20 dist | +2.93% | ROA | 5.06% |
| SMA50 dist | +7.28% | ROE | 14.56% |
| SMA200 dist | +17.49% | Revenue (ttm) | $107.38B |
| 52W high | $21.43 | Revenue growth y/y | 78.40% |
| 52W low | $15.15 | Inst. ownership | 32.50% |
| P/E (ttm) | 14.64 | Insider ownership | 10.29% |
| Forward P/E | 12.22 | Short float | 0.93% |
| PEG (trailing) | 0.68 | Avg volume | 8,951,071 |
| P/S | 0.69 | Employees | 22,311 |
| P/B | 2.30 | Analyst rec (1=buy..5=sell) | 1.4 |

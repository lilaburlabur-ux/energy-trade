...
Signed file: `TRGP.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $285.07 (2026-09-17, ~15-min delayed) |
| Market cap | $61.13B |
...
|---|---|---|
| Technical momentum | High | 1Y +78.72%; price +18.27% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.68% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 13.54%, revenue growth 4.20%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 23.60, EV/Sales 4.82. |
| Risk level | Moderate | Beta 0.72, ATR 2.5% of price, short float 2.93%. |
...
| Targa Resources Extends Growth Runway With New Permian Projects, RBC Says | MT Newswires | 2026-08-27 |
| Targa grants new CFO hefty long-term incentive | CFO Dive | 2026-08-25 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $285.07; 52w high $302.25 (-5.68%); 52w low $143.22 (+99.04%) |
| Trend | +18.27% vs SMA200, +1.56% vs SMA50, -2.22% vs SMA20 |
| Momentum | RSI(14) 48.5 (neutral) |
| Volatility | ATR(14) 7.25 (~2.5% of price); beta 0.72 |
| Setup perspective | -5.68% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 27.28, forward P/E 23.60, P/S 3.65, P/B 19.52 | EV/Sales 4.82, EV/EBITDA 14.67 |
| Growth expectations | Earnings growth 23.30%, EPS q/q 21.50% | Analyst mean target $318.81 (21 analysts) |
...
- **Valuation risk:** Forward P/E 23.60, EV/Sales 4.82. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $285.07 | EV/Sales | 4.82 |
| Market cap | $61.13B | EV/EBITDA | 14.67 |
| Beta | 0.72 | Gross margin | 43.19% |
| RSI(14) | 48.5 | Operating margin | 27.80% |
| ATR(14) | 7.25 | Profit margin | 13.54% |
| SMA20 dist | -2.22% | ROA | 9.24% |
| SMA50 dist | +1.56% | ROE | 70.84% |
| SMA200 dist | +18.27% | Revenue (ttm) | $16.74B |
| 52W high | $302.25 | Revenue growth y/y | 4.20% |
| 52W low | $143.22 | Inst. ownership | 97.47% |
| P/E (ttm) | 27.28 | Insider ownership | 1.38% |
| Forward P/E | 23.60 | Short float | 2.93% |
| PEG (trailing) | — | Avg volume | 1,229,708 |
| P/S | 3.65 | Employees | 3,570 |
| P/B | 19.52 | Analyst rec (1=buy..5=sell) | 1.5 |

## 8. Analyst Actions
| Date | Action | Firm | Rating change |
|---|---|---|---|
| 2026-09-16 | main | Morgan Stanley | Overweight → Overweight |

...
Signed file: `WFRD.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $93.06 (2026-09-09, ~15-min delayed) |
| Market cap | $6.65B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +52.48%; price +1.03% vs SMA200. |
| Fresh setup quality | Moderate / wait | -16.21% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 7.66%, revenue growth -8.20%. |
| Value attractiveness | Reasonable | Forward P/E 13.18, EV/Sales 1.51. |
| Risk level | Elevated | Beta 0.90, ATR 4.0% of price, short float 6.33%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $93.06; 52w high $111.07 (-16.21%); 52w low $60.68 (+53.37%) |
| Trend | +1.03% vs SMA200, +5.84% vs SMA50, +0.15% vs SMA20 |
| Momentum | RSI(14) 52.1 (neutral) |
| Volatility | ATR(14) 3.68 (~4.0% of price); beta 0.90 |
| Setup perspective | -16.21% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 18.36, forward P/E 13.18, P/S 1.39, P/B 3.74 | EV/Sales 1.51, EV/EBITDA 7.79 |
...
- **Volatility risk:** Beta 0.90, ATR 4.0% of price, short float 6.33%. Size positions accordingly.
...
|---|---|---|---|
| Price | $93.06 | EV/Sales | 1.51 |
| Market cap | $6.65B | EV/EBITDA | 7.79 |
| Beta | 0.90 | Gross margin | 30.51% |
| RSI(14) | 52.1 | Operating margin | 10.50% |
| ATR(14) | 3.68 | Profit margin | 7.66% |
| SMA20 dist | +0.15% | ROA | 7.90% |
| SMA50 dist | +5.84% | ROE | 22.79% |
| SMA200 dist | +1.03% | Revenue (ttm) | $4.78B |

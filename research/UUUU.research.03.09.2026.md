...
Signed file: `UUUU.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $14.35 (2026-09-03, ~15-min delayed) |
| Market cap | $3.80B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $14.35; 52w high $27.72 (-48.23%); 52w low $10.74 (+33.61%) |
| Trend | -17.46% vs SMA200, +6.01% vs SMA50, -2.61% vs SMA20 |
| Momentum | RSI(14) 50.3 (neutral) |
| Volatility | ATR(14) 0.88 (~6.2% of price); beta 1.57 |
| Setup perspective | -48.23% from 52w high — base needs to rebuild. |
...
| SMA20 dist | -2.61% | ROA | -4.65% |
| SMA50 dist | +6.01% | ROE | -11.45% |
| SMA200 dist | -17.46% | Revenue (ttm) | $105.76M |
| 52W high | $27.72 | Revenue growth y/y | 496.10% |
| 52W low | $10.74 | Inst. ownership | 78.94% |
| P/E (ttm) | — | Insider ownership | 1.23% |
| Forward P/E | 29.59 | Short float | 21.42% |
| PEG (trailing) | — | Avg volume | 8,122,050 |
| P/S | 35.93 | Employees | 1,069 |
| P/B | 4.53 | Analyst rec (1=buy..5=sell) | 1.1 |

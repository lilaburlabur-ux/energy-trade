...
Signed file: `TTE.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $91.59 (2026-09-17, ~15-min delayed) |
| Market cap | $202.33B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +53.84%; price +12.85% vs SMA200. |
| Fresh setup quality | Watch | -2.15% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 9.08%, revenue growth 27.80%. |
| Value attractiveness | Reasonable | Forward P/E 8.84, EV/Sales 1.20. |
...
|---|---|---|
| France: TotalEnergies cut-price fuel spikes controversy among rivals | Euronews | 2026-09-16 |
| TotalEnergies pumps up controversy in France with cut-price gas | AFP | 2026-09-16 |
| TotalEnergies and Mistral launch oil and gas AI partnership | Offshore Technology | 2026-09-16 |
| Europe’s Fortune 500 2026: Record revenue, shrinking margins, and a new No. 1 country | Fortune | 2026-09-16 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $91.59; 52w high $93.60 (-2.15%); 52w low $55.92 (+63.78%) |
| Trend | +12.85% vs SMA200, +5.40% vs SMA50, +1.94% vs SMA20 |
| Momentum | RSI(14) 57.8 (neutral) |
| Volatility | ATR(14) 1.65 (~1.8% of price); beta 0.06 |
| Setup perspective | -2.15% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 11.46, forward P/E 8.84, P/S 1.03, P/B 1.59 | EV/Sales 1.20, EV/EBITDA 5.95 |
| Growth expectations | Earnings growth 106.00%, EPS q/q 102.40% | Analyst mean target $96.40 (10 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 54.20% |
...
|---|---|---|---|
| Price | $91.59 | EV/Sales | 1.20 |
| Market cap | $202.33B | EV/EBITDA | 5.95 |
| Beta | 0.06 | Gross margin | 37.68% |
| RSI(14) | 57.8 | Operating margin | 12.79% |
| ATR(14) | 1.65 | Profit margin | 9.08% |
| SMA20 dist | +1.94% | ROA | 5.51% |
| SMA50 dist | +5.40% | ROE | 14.48% |
| SMA200 dist | +12.85% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 54.20% |
| P/E (ttm) | 11.46 | Insider ownership | 8.86% |
| Forward P/E | 8.84 | Short float | 0.22% |
| PEG (trailing) | 0.83 | Avg volume | 1,646,466 |
| P/S | 1.03 | Employees | 94,847 |
| P/B | 1.59 | Analyst rec (1=buy..5=sell) | 2.0 |

...
Signed file: `VST.research.11.09.2026`

| Field | Value |
|---|---|
| Current price | $148.38 (2026-09-11, ~15-min delayed) |
| Market cap | $49.80B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $148.38; 52w high $217.02 (-31.63%); 52w low $134.52 (+10.30%) |
| Trend | -5.49% vs SMA200, -0.32% vs SMA50, +3.95% vs SMA20 |
| Momentum | RSI(14) 54.5 (neutral) |
| Volatility | ATR(14) 5.10 (~3.4% of price); beta 1.41 |
| Setup perspective | -31.63% from 52w high — base needs to rebuild. |
...
| SMA20 dist | +3.95% | ROA | 5.89% |
| SMA50 dist | -0.32% | ROE | 42.96% |
| SMA200 dist | -5.49% | Revenue (ttm) | $19.21B |
| 52W high | $217.02 | Revenue growth y/y | -5.50% |
| 52W low | $134.52 | Inst. ownership | 92.07% |
| P/E (ttm) | 25.02 | Insider ownership | 0.78% |
| Forward P/E | 14.31 | Short float | 3.72% |
| PEG (trailing) | 0.37 | Avg volume | 4,434,029 |
| P/S | 2.59 | Employees | 6,390 |
| P/B | 16.58 | Analyst rec (1=buy..5=sell) | 1.4 |

...
Signed file: `BEP.research.25.09.2026`
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $28.35; 52w high $36.63 (-22.61%); 52w low $24.64 (+15.07%) |
| Trend | -9.39% vs SMA200, -10.32% vs SMA50, -6.13% vs SMA20 |
| Momentum | RSI(14) 31.5 (neutral) |
| Volatility | ATR(14) 0.83 (~2.9% of price); beta 0.98 |
| Setup perspective | -22.61% from 52w high; no clean fresh pivot by default. |
...
| Market cap | $13.79B | EV/EBITDA | 26.99 |
| Beta | 0.98 | Gross margin | 51.39% |
| RSI(14) | 31.5 | Operating margin | 17.08% |
| ATR(14) | 0.83 | Profit margin | -1.26% |
| SMA20 dist | -6.13% | ROA | 0.42% |
| SMA50 dist | -10.32% | ROE | 0.40% |
| SMA200 dist | -9.39% | Revenue (ttm) | $6.36B |
| 52W high | $36.63 | Revenue growth y/y | 1.10% |
| 52W low | $24.64 | Inst. ownership | 65.49% |
| P/E (ttm) | — | Insider ownership | 0.02% |
| Forward P/E | -15.17 | Short float | 0.46% |
| PEG (trailing) | — | Avg volume | 957,096 |

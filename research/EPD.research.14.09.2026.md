...
Signed file: `EPD.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $38.70 (2026-09-14, ~15-min delayed) |
| Market cap | $83.57B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +29.05%; price +8.53% vs SMA200. |
| Fresh setup quality | Watch | -1.68% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.22, EV/Sales 2.03. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.70; 52w high $39.36 (-1.68%); 52w low $28.35 (+36.49%) |
| Trend | +8.53% vs SMA200, +1.44% vs SMA50, -0.30% vs SMA20 |
| Momentum | RSI(14) 50.7 (neutral) |
| Volatility | ATR(14) 0.57 (~1.5% of price); beta 0.48 |
| Setup perspective | -1.68% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.39, forward P/E 12.22, P/S 1.43, P/B 2.76 | EV/Sales 2.03, EV/EBITDA 11.53 |
...
|---|---|---|---|
| Price | $38.70 | EV/Sales | 2.03 |
| Market cap | $83.57B | EV/EBITDA | 11.53 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 50.7 | Operating margin | 11.76% |
| ATR(14) | 0.57 | Profit margin | 10.79% |
| SMA20 dist | -0.30% | ROA | 5.92% |
| SMA50 dist | +1.44% | ROE | 20.85% |
| SMA200 dist | +8.53% | Revenue (ttm) | $58.47B |
| 52W high | $39.36 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.64% |
| P/E (ttm) | 13.39 | Insider ownership | 33.04% |
| Forward P/E | 12.22 | Short float | 3.09% |
| PEG (trailing) | 1.38 | Avg volume | 2,945,661 |
| P/S | 1.43 | Employees | 0 |
| P/B | 2.76 | Analyst rec (1=buy..5=sell) | 2.3 |

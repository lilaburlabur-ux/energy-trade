...
Signed file: `BEP.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $29.43 (2026-09-14, ~15-min delayed) |
| Market cap | $14.35B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-5.68%) with negative half-year (-0.18%). |
...
| Value attractiveness | Reasonable | Forward P/E -15.74, EV/Sales 12.96. |
| Risk level | Elevated | Beta 0.98, ATR 3.1% of price, short float 0.61%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $29.43; 52w high $36.63 (-19.66%); 52w low $24.08 (+22.23%) |
| Trend | -5.68% vs SMA200, -8.50% vs SMA50, -7.21% vs SMA20 |
| Momentum | RSI(14) 32.4 (neutral) |
| Volatility | ATR(14) 0.90 (~3.1% of price); beta 0.98 |
...
| Valuation | P/E —, forward P/E -15.74, P/S 2.26, P/B 2.36 | EV/Sales 12.96, EV/EBITDA 27.47 |
...
- **Volatility risk:** Beta 0.98, ATR 3.1% of price, short float 0.61%. Size positions accordingly.
...
|---|---|---|---|
| Price | $29.43 | EV/Sales | 12.96 |
| Market cap | $14.35B | EV/EBITDA | 27.47 |
| Beta | 0.98 | Gross margin | 51.39% |
| RSI(14) | 32.4 | Operating margin | 17.08% |
| ATR(14) | 0.90 | Profit margin | -1.26% |
| SMA20 dist | -7.21% | ROA | 0.42% |
| SMA50 dist | -8.50% | ROE | 0.40% |
| SMA200 dist | -5.68% | Revenue (ttm) | $6.36B |
| 52W high | $36.63 | Revenue growth y/y | 1.10% |
| 52W low | $24.08 | Inst. ownership | 65.46% |
| P/E (ttm) | — | Insider ownership | 0.02% |
| Forward P/E | -15.74 | Short float | 0.61% |
| PEG (trailing) | — | Avg volume | 906,562 |

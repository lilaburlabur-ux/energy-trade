...
Signed file: `FLNC.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $11.43 (2026-08-28, ~15-min delayed) |
| Market cap | $2.12B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-37.56%) with negative half-year (-29.44%). |
| Fresh setup quality | Poor / broken | -64.54% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-3.07%). |
| Value attractiveness | Low (expensive) | Forward P/E 47.33, EV/Sales 0.67. |
| Risk level | High | Beta 2.78, ATR 8.9% of price, short float 33.35%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.43; 52w high $32.23 (-64.54%); 52w low $6.75 (+69.33%) |
| Trend | -37.56% vs SMA200, -24.98% vs SMA50, -9.97% vs SMA20 |
| Momentum | RSI(14) 38.1 (neutral) |
| Volatility | ATR(14) 1.02 (~8.9% of price); beta 2.78 |
| Setup perspective | -64.54% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 47.33, P/S 0.81, P/B 4.38 | EV/Sales 0.67, EV/EBITDA -22.68 |
...
- **Valuation risk:** Forward P/E 47.33, EV/Sales 0.67. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 2.78, ATR 8.9% of price, short float 33.35%. Size positions accordingly.
...
|---|---|---|---|
| Price | $11.43 | EV/Sales | 0.67 |
| Market cap | $2.12B | EV/EBITDA | -22.68 |
| Beta | 2.78 | Gross margin | 9.36% |
| RSI(14) | 38.1 | Operating margin | -8.85% |
| ATR(14) | 1.02 | Profit margin | -3.07% |
| SMA20 dist | -9.97% | ROA | -2.95% |
| SMA50 dist | -24.98% | ROE | -23.54% |
| SMA200 dist | -37.56% | Revenue (ttm) | $2.63B |
| 52W high | $32.23 | Revenue growth y/y | 7.90% |
| 52W low | $6.75 | Inst. ownership | 85.33% |
| P/E (ttm) | — | Insider ownership | 14.42% |
| Forward P/E | 47.33 | Short float | 33.35% |
| PEG (trailing) | — | Avg volume | 9,814,611 |
| P/S | 0.81 | Employees | 1,670 |

...
Signed file: `TTE.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $91.67 (2026-09-23, ~15-min delayed) |
| Market cap | $202.50B |
...
| TotalEnergies to Develop Offshore Gas Field to Boost Nigeria LNG Supply | Oilprice.com | 2026-09-23 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $91.67; 52w high $93.60 (-2.06%); 52w low $55.92 (+63.92%) |
| Trend | +12.22% vs SMA200, +4.45% vs SMA50, +1.83% vs SMA20 |
| Momentum | RSI(14) 57.3 (neutral) |
| Volatility | ATR(14) 1.61 (~1.8% of price); beta 0.06 |
| Setup perspective | -2.06% from 52w high and near SMA20 — check for a tight base. |
...
| SMA20 dist | +1.83% | ROA | 5.51% |
| SMA50 dist | +4.45% | ROE | 14.48% |
| SMA200 dist | +12.22% | Revenue (ttm) | $196.38B |
| 52W high | $93.60 | Revenue growth y/y | 27.80% |
| 52W low | $55.92 | Inst. ownership | 54.20% |
| P/E (ttm) | 11.47 | Insider ownership | 8.86% |
| Forward P/E | 8.60 | Short float | 0.22% |
| PEG (trailing) | 0.80 | Avg volume | 1,590,515 |

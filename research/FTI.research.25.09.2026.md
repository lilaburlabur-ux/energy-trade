...
Signed file: `FTI.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $70.99 (2026-09-25, ~15-min delayed) |
| Market cap | $27.84B |
...
|---|---|---|
| Technical momentum | High | 1Y +80.13%; price +7.05% vs SMA200. |
| Fresh setup quality | Moderate / wait | -11.35% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 11.28%, revenue growth 9.00%. |
| Value attractiveness | Reasonable | Forward P/E 19.73, EV/Sales 2.70. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $70.99; 52w high $80.08 (-11.35%); 52w low $35.45 (+100.23%) |
| Trend | +7.05% vs SMA200, -4.76% vs SMA50, -5.38% vs SMA20 |
| Momentum | RSI(14) 38.1 (neutral) |
| Volatility | ATR(14) 2.21 (~3.1% of price); beta 0.74 |
| Setup perspective | -11.35% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 24.82, forward P/E 19.73, P/S 2.67, P/B 8.52 | EV/Sales 2.70, EV/EBITDA 14.16 |
...
|---|---|---|---|
| Price | $70.99 | EV/Sales | 2.70 |
| Market cap | $27.84B | EV/EBITDA | 14.16 |
| Beta | 0.74 | Gross margin | 22.97% |
| RSI(14) | 38.1 | Operating margin | 17.69% |
| ATR(14) | 2.21 | Profit margin | 11.28% |
| SMA20 dist | -5.38% | ROA | 9.53% |
| SMA50 dist | -4.76% | ROE | 35.81% |
| SMA200 dist | +7.05% | Revenue (ttm) | $10.42B |
| 52W high | $80.08 | Revenue growth y/y | 9.00% |
| 52W low | $35.45 | Inst. ownership | 101.17% |
| P/E (ttm) | 24.82 | Insider ownership | 1.36% |
| Forward P/E | 19.73 | Short float | 3.26% |
| PEG (trailing) | — | Avg volume | 3,499,211 |

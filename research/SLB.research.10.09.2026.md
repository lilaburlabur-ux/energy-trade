...
Signed file: `SLB.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $56.01 (2026-09-10, ~15-min delayed) |
| Market cap | $83.13B |
...
|---|---|---|
| Technical momentum | High | 1Y +60.37%; price +14.57% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 17.32, EV/Sales 2.60. |
| Risk level | Elevated | Beta 0.77, ATR 3.4% of price, short float 4.28%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $56.01; 52w high $59.79 (-6.32%); 52w low $30.96 (+80.89%) |
| Trend | +14.57% vs SMA200, +9.47% vs SMA50, +1.50% vs SMA20 |
| Momentum | RSI(14) 56.0 (neutral) |
| Volatility | ATR(14) 1.90 (~3.4% of price); beta 0.77 |
...
| Valuation | P/E 27.32, forward P/E 17.32, P/S 2.29, P/B 3.19 | EV/Sales 2.60, EV/EBITDA 12.80 |
...
- **Volatility risk:** Beta 0.77, ATR 3.4% of price, short float 4.28%. Size positions accordingly.
...
|---|---|---|---|
| Price | $56.01 | EV/Sales | 2.60 |
| Market cap | $83.13B | EV/EBITDA | 12.80 |
| Beta | 0.77 | Gross margin | 16.99% |
| RSI(14) | 56.0 | Operating margin | 12.71% |
| ATR(14) | 1.90 | Profit margin | 8.53% |
| SMA20 dist | +1.50% | ROA | 6.17% |
| SMA50 dist | +9.47% | ROE | 12.91% |
| SMA200 dist | +14.57% | Revenue (ttm) | $36.37B |
| 52W high | $59.79 | Revenue growth y/y | 5.00% |
| 52W low | $30.96 | Inst. ownership | 92.71% |
| P/E (ttm) | 27.32 | Insider ownership | 0.22% |
| Forward P/E | 17.32 | Short float | 4.28% |
| PEG (trailing) | 1.50 | Avg volume | 13,831,759 |
| P/S | 2.29 | Employees | 109,000 |

...
Signed file: `VLO.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $323.92 (2026-08-11, ~15-min delayed) |
| Market cap | $93.27B |
...
|---|---|---|
| Technical momentum | High | 1Y +148.17%; price +46.04% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 11.69, EV/Sales 0.74. |
| Risk level | Elevated | Beta 0.55, ATR 3.6% of price, short float 4.42%. |
...
|---|---|---|
| Marathon Petroleum's Value Chain Edge: Can it Keep Driving Growth? | Zacks | 2026-08-11 |
| Sunoco's $600M Offen Acquisition Expands Fuel Distribution Footprint | Zacks | 2026-08-11 |
| XOM Charges A Premium Its Peers Do Not | Trefis | 2026-08-11 |
| Archrock Miss Q2 Earnings & Revenues Estimates on AMS Weakness | Zacks | 2026-08-10 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $323.92; 52w high $323.92 (+0.00%); 52w low $129.03 (+151.03%) |
| Trend | +46.04% vs SMA200, +16.36% vs SMA50, +5.79% vs SMA20 |
| Momentum | RSI(14) 67.4 (neutral) |
| Volatility | ATR(14) 11.60 (~3.6% of price); beta 0.55 |
...
| Valuation | P/E 13.51, forward P/E 11.69, P/S 0.70, P/B 4.03 | EV/Sales 0.74, EV/EBITDA 7.28 |
...
- **Volatility risk:** Beta 0.55, ATR 3.6% of price, short float 4.42%. Size positions accordingly.
...
|---|---|---|---|
| Price | $323.92 | EV/Sales | 0.74 |
| Market cap | $93.27B | EV/EBITDA | 7.28 |
| Beta | 0.55 | Gross margin | 16.12% |
| RSI(14) | 67.4 | Operating margin | 12.27% |
| ATR(14) | 11.60 | Profit margin | 5.45% |
| SMA20 dist | +5.79% | ROA | 10.56% |
| SMA50 dist | +16.36% | ROE | 27.64% |
| SMA200 dist | +46.04% | Revenue (ttm) | $132.43B |
| 52W high | $323.92 | Revenue growth y/y | 51.70% |
| 52W low | $129.03 | Inst. ownership | 89.87% |
| P/E (ttm) | 13.51 | Insider ownership | 0.42% |
| Forward P/E | 11.69 | Short float | 4.42% |
| PEG (trailing) | 4.08 | Avg volume | 3,013,298 |
| P/S | 0.70 | Employees | 9,785 |
| P/B | 4.03 | Analyst rec (1=buy..5=sell) | 2.3 |

...
Signed file: `FANG.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $202.94 (2026-09-03, ~15-min delayed) |
| Market cap | $57.09B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +46.06%; price +13.50% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 11.22, EV/Sales 4.63. |
| Risk level | Moderate | Beta 0.42, ATR 2.7% of price, short float 3.92%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $202.94; 52w high $211.36 (-3.98%); 52w low $131.37 (+54.48%) |
| Trend | +13.50% vs SMA200, +4.55% vs SMA50, +0.28% vs SMA20 |
| Momentum | RSI(14) 53.9 (neutral) |
| Volatility | ATR(14) 5.57 (~2.7% of price); beta 0.42 |
...
| Valuation | P/E 38.66, forward P/E 11.22, P/S 3.51, P/B 1.50 | EV/Sales 4.63, EV/EBITDA 6.38 |
...
|---|---|---|---|
| Price | $202.94 | EV/Sales | 4.63 |
| Market cap | $57.09B | EV/EBITDA | 6.38 |
| Beta | 0.42 | Gross margin | 72.35% |
| RSI(14) | 53.9 | Operating margin | 48.47% |
| ATR(14) | 5.57 | Profit margin | 9.03% |
| SMA20 dist | +0.28% | ROA | 1.31% |
| SMA50 dist | +4.55% | ROE | 3.49% |
| SMA200 dist | +13.50% | Revenue (ttm) | $16.25B |
| 52W high | $211.36 | Revenue growth y/y | 52.50% |
| 52W low | $131.37 | Inst. ownership | 73.39% |
| P/E (ttm) | 38.66 | Insider ownership | 27.11% |
| Forward P/E | 11.22 | Short float | 3.92% |
| PEG (trailing) | 24.39 | Avg volume | 2,203,571 |

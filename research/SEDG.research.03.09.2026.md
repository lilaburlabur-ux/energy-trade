...
Signed file: `SEDG.research.03.09.2026`

| Field | Value |
|---|---|
| Current price | $33.80 (2026-09-03, ~15-min delayed) |
| Market cap | $2.08B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-19.61%) with negative half-year (-4.09%). |
| Fresh setup quality | Poor / broken | -56.95% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-20.29%). |
| Value attractiveness | Fair-to-demanding | Forward P/E 34.85, EV/Sales 1.46. |
| Risk level | High | Beta 1.47, ATR 7.7% of price, short float 23.21%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $33.80; 52w high $78.51 (-56.95%); 52w low $28.47 (+18.72%) |
| Trend | -19.61% vs SMA200, -19.73% vs SMA50, +5.74% vs SMA20 |
| Momentum | RSI(14) 45.9 (neutral) |
| Volatility | ATR(14) 2.59 (~7.7% of price); beta 1.47 |
| Setup perspective | -56.95% from 52w high — base needs to rebuild. |
...
- **Valuation risk:** Forward P/E 34.85, EV/Sales 1.46. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.47, ATR 7.7% of price, short float 23.21%. Size positions accordingly.
...
| SMA20 dist | +5.74% | ROA | -3.84% |
| SMA50 dist | -19.73% | ROE | -58.42% |
| SMA200 dist | -19.61% | Revenue (ttm) | $1.33B |
| 52W high | $78.51 | Revenue growth y/y | 19.60% |
| 52W low | $28.47 | Inst. ownership | 102.08% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 34.85 | Short float | 23.21% |
| PEG (trailing) | — | Avg volume | 2,962,506 |
| P/S | 1.56 | Employees | 3,576 |
| P/B | 5.05 | Analyst rec (1=buy..5=sell) | 3.1 |

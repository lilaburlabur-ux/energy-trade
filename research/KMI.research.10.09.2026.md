...
Signed file: `KMI.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $30.95 (2026-09-10, ~15-min delayed) |
| Market cap | $68.92B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +20.85%; price +0.86% vs SMA200. |
...
| Value attractiveness | Fair-to-demanding | Forward P/E 20.09, EV/Sales 5.76. |
...
|---|---|---|
| This Pipeline Stock Has Raised Its Dividend for 31 Straight Years. Almost Nobody Talks About It. | Motley Fool | 2026-09-10 |
| Kinder Morgan Targets $1.4B in New Gas Projects as LNG, Power Demand Fuel Growth | MarketBeat | 2026-09-10 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $30.95; 52w high $33.99 (-8.95%); 52w low $24.86 (+24.49%) |
| Trend | +0.86% vs SMA200, -2.58% vs SMA50, -2.59% vs SMA20 |
| Momentum | RSI(14) 43.0 (neutral) |
| Volatility | ATR(14) 0.78 (~2.5% of price); beta 0.55 |
...
| Valuation | P/E 19.97, forward P/E 20.09, P/S 3.84, P/B 2.18 | EV/Sales 5.76, EV/EBITDA 13.56 |
| Growth expectations | Earnings growth 21.20%, EPS q/q 21.30% | Analyst mean target $36.05 (19 analysts) |
...
- **Valuation risk:** Forward P/E 20.09, EV/Sales 5.76. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $30.95 | EV/Sales | 5.76 |
| Market cap | $68.92B | EV/EBITDA | 13.56 |
| Beta | 0.55 | Gross margin | 49.41% |
| RSI(14) | 43.0 | Operating margin | 30.06% |
| ATR(14) | 0.78 | Profit margin | 19.30% |
| SMA20 dist | -2.59% | ROA | 4.45% |
| SMA50 dist | -2.58% | ROE | 10.99% |
| SMA200 dist | +0.86% | Revenue (ttm) | $17.96B |
| 52W high | $33.99 | Revenue growth y/y | 10.80% |
| 52W low | $24.86 | Inst. ownership | 70.88% |
| P/E (ttm) | 19.97 | Insider ownership | 12.70% |
| Forward P/E | 20.09 | Short float | 2.37% |
| PEG (trailing) | 3.30 | Avg volume | 10,455,069 |

...
Signed file: `UEC.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $11.63 (2026-08-19, ~15-min delayed) |
| Market cap | $5.70B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-12.47%) with negative half-year (-27.31%). |
| Fresh setup quality | Poor / broken | -42.25% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -129.22, EV/Sales 244.44. |
| Risk level | High | Beta 1.21, ATR 4.9% of price, short float 14.38%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $11.63; 52w high $20.14 (-42.25%); 52w low $9.04 (+28.65%) |
| Trend | -12.47% vs SMA200, +10.53% vs SMA50, +10.43% vs SMA20 |
| Momentum | RSI(14) 61.9 (neutral) |
| Volatility | ATR(14) 0.57 (~4.9% of price); beta 1.21 |
| Setup perspective | -42.25% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -129.22, P/S 282.24, P/B 4.04 | EV/Sales 244.44, EV/EBITDA -40.89 |
...
- **Volatility risk:** Beta 1.21, ATR 4.9% of price, short float 14.38%. Size positions accordingly.
...
|---|---|---|---|
| Price | $11.63 | EV/Sales | 244.44 |
| Market cap | $5.70B | EV/EBITDA | -40.89 |
| Beta | 1.21 | Gross margin | 0.00% |
| RSI(14) | 61.9 | Operating margin | -629.66% |
| ATR(14) | 0.57 | Profit margin | 0.00% |
| SMA20 dist | +10.43% | ROA | -6.25% |
| SMA50 dist | +10.53% | ROE | -8.96% |
| SMA200 dist | -12.47% | Revenue (ttm) | $20.20M |
| 52W high | $20.14 | Revenue growth y/y | — |
| 52W low | $9.04 | Inst. ownership | 88.45% |
| P/E (ttm) | — | Insider ownership | 1.86% |
| Forward P/E | -129.22 | Short float | 14.38% |
| PEG (trailing) | — | Avg volume | 9,505,898 |
| P/S | 282.24 | Employees | 171 |
| P/B | 4.04 | Analyst rec (1=buy..5=sell) | 1.4 |

...
Signed file: `SO.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $85.52 (2026-09-18, ~15-min delayed) |
| Market cap | $98.38B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-6.05%) with negative half-year (-9.65%). |
...
| Value attractiveness | Reasonable | Forward P/E 17.37, EV/Sales 5.85. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $85.52; 52w high $97.49 (-12.28%); 52w low $82.06 (+4.21%) |
| Trend | -6.05% vs SMA200, -6.34% vs SMA50, -2.88% vs SMA20 |
| Momentum | RSI(14) 30.2 (neutral) |
| Volatility | ATR(14) 1.34 (~1.6% of price); beta 0.32 |
...
| Valuation | P/E 20.61, forward P/E 17.37, P/S 3.26, P/B 2.49 | EV/Sales 5.85, EV/EBITDA 12.39 |
...
|---|---|---|---|
| Price | $85.52 | EV/Sales | 5.85 |
| Market cap | $98.38B | EV/EBITDA | 12.39 |
| Beta | 0.32 | Gross margin | 48.29% |
| RSI(14) | 30.2 | Operating margin | 29.61% |
| ATR(14) | 1.34 | Profit margin | 15.43% |
| SMA20 dist | -2.88% | ROA | 3.27% |
| SMA50 dist | -6.34% | ROE | 11.48% |
| SMA200 dist | -6.05% | Revenue (ttm) | $30.18B |
| 52W high | $97.49 | Revenue growth y/y | 0.10% |
| 52W low | $82.06 | Inst. ownership | 74.23% |
| P/E (ttm) | 20.61 | Insider ownership | 0.10% |
| Forward P/E | 17.37 | Short float | 3.06% |
| PEG (trailing) | 2.05 | Avg volume | 5,498,850 |
| P/S | 3.26 | Employees | 29,502 |
| P/B | 2.49 | Analyst rec (1=buy..5=sell) | 2.7 |

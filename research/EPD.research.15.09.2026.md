...
Signed file: `EPD.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $38.81 (2026-09-15, ~15-min delayed) |
| Market cap | $83.81B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +30.03%; price +8.72% vs SMA200. |
| Fresh setup quality | Watch | -1.40% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 10.79%, revenue growth 60.80%. |
| Value attractiveness | Reasonable | Forward P/E 12.25, EV/Sales 2.03. |
| Risk level | Moderate | Beta 0.48, ATR 1.4% of price, short float 3.09%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $38.81; 52w high $39.36 (-1.40%); 52w low $28.35 (+36.88%) |
| Trend | +8.72% vs SMA200, +1.58% vs SMA50, -0.04% vs SMA20 |
| Momentum | RSI(14) 52.2 (neutral) |
| Volatility | ATR(14) 0.55 (~1.4% of price); beta 0.48 |
| Setup perspective | -1.40% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 13.43, forward P/E 12.25, P/S 1.43, P/B 2.77 | EV/Sales 2.03, EV/EBITDA 11.51 |
...
|---|---|---|---|
| Price | $38.81 | EV/Sales | 2.03 |
| Market cap | $83.81B | EV/EBITDA | 11.51 |
| Beta | 0.48 | Gross margin | 13.33% |
| RSI(14) | 52.2 | Operating margin | 11.76% |
| ATR(14) | 0.55 | Profit margin | 10.79% |
| SMA20 dist | -0.04% | ROA | 5.92% |
| SMA50 dist | +1.58% | ROE | 20.85% |
| SMA200 dist | +8.72% | Revenue (ttm) | $58.47B |
| 52W high | $39.36 | Revenue growth y/y | 60.80% |
| 52W low | $28.35 | Inst. ownership | 25.64% |
| P/E (ttm) | 13.43 | Insider ownership | 33.04% |
| Forward P/E | 12.25 | Short float | 3.09% |
| PEG (trailing) | 1.37 | Avg volume | 2,952,208 |
| P/S | 1.43 | Employees | 0 |
| P/B | 2.77 | Analyst rec (1=buy..5=sell) | 2.3 |

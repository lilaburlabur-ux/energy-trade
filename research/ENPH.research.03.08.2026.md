...
Signed file: `ENPH.research.03.08.2026`

| Field | Value |
|---|---|
| Current price | $39.35 (2026-08-03, ~15-min delayed) |
| Market cap | $5.19B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +21.60%; price -1.74% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 17.06, EV/Sales 3.49. |
| Risk level | High | Beta 1.65, ATR 7.7% of price, short float 20.94%. |
...
|---|---|---|
| 1 Cash-Producing Stock on Our Watchlist and 2 We Find Risky | StockStory | 2026-08-03 |
...
| Enphase Energy Q2 Earnings Match Estimates, Revenues Decline Y/Y | Zacks | 2026-07-29 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $39.35; 52w high $72.33 (-45.60%); 52w low $26.12 (+50.65%) |
| Trend | -1.74% vs SMA200, -20.89% vs SMA50, -2.69% vs SMA20 |
| Momentum | RSI(14) 43.9 (neutral) |
| Volatility | ATR(14) 3.03 (~7.7% of price); beta 1.65 |
...
| Valuation | P/E 38.96, forward P/E 17.06, P/S 3.90, P/B 4.40 | EV/Sales 3.49, EV/EBITDA 24.17 |
...
|---|---|---|---|
| Blackrock Inc. | 22,202,913 | 16.80% | 2026-03-31 |
...
| State Street Corporation | 4,597,699 | 3.48% | 2026-03-31 |
...
- **Volatility risk:** Beta 1.65, ATR 7.7% of price, short float 20.94%. Size positions accordingly.
- **Short interest risk:** short float 20.94% can fuel squeezes both ways around news.
...
|---|---|---|---|
| Price | $39.35 | EV/Sales | 3.49 |
| Market cap | $5.19B | EV/EBITDA | 24.17 |
| Beta | 1.65 | Gross margin | 30.04% |
| RSI(14) | 43.9 | Operating margin | 17.98% |
| ATR(14) | 3.03 | Profit margin | 10.09% |
| SMA20 dist | -2.69% | ROA | 2.38% |
| SMA50 dist | -20.89% | ROE | 13.00% |
| SMA200 dist | -1.74% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 103.09% |
| P/E (ttm) | 38.96 | Insider ownership | 3.03% |
| Forward P/E | 17.06 | Short float | 20.94% |
| PEG (trailing) | 1.08 | Avg volume | 7,324,861 |
| P/S | 3.90 | Employees | 2,872 |

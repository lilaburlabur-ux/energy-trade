...
Signed file: `SMR.research.28.08.2026`

| Field | Value |
|---|---|
| Current price | $9.74 (2026-08-28, ~15-min delayed) |
| Market cap | $4.00B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-27.68%) with negative half-year (-26.93%). |
| Fresh setup quality | Poor / broken | -81.77% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -99.10%. |
| Value attractiveness | Reasonable | Forward P/E -14.94, EV/Sales 269.79. |
...
| NuScale Power Is Launching AI Tools for Nuclear Power. How to Play SMR Stock Here. | Barchart | 2026-08-27 |
| NuScale Power Rises 4%, Oklo Climbs 3% as Risk Appetite Returns, Uranium Energy Ticks Up | 24/7 Wall St. | 2026-08-27 |
| Can NuScale Power (SMR) Cut SMR Timelines With Nuclear Specific AI Tools? | Simply Wall St. | 2026-08-27 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.74; 52w high $53.43 (-81.77%); 52w low $7.59 (+28.33%) |
| Trend | -27.68% vs SMA200, +5.19% vs SMA50, +4.20% vs SMA20 |
| Momentum | RSI(14) 54.1 (neutral) |
| Volatility | ATR(14) 0.72 (~7.4% of price); beta 2.31 |
| Setup perspective | -81.77% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -14.94, P/S 373.92, P/B 2.65 | EV/Sales 269.79, EV/EBITDA -12.87 |
...
|---|---|---|---|
| Price | $9.74 | EV/Sales | 269.79 |
| Market cap | $4.00B | EV/EBITDA | -12.87 |
| Beta | 2.31 | Gross margin | 23.54% |
| RSI(14) | 54.1 | Operating margin | -85337.33% |
| ATR(14) | 0.72 | Profit margin | 0.00% |
| SMA20 dist | +4.20% | ROA | -10.60% |
| SMA50 dist | +5.19% | ROE | -55.18% |
| SMA200 dist | -27.68% | Revenue (ttm) | $10.69M |
| 52W high | $53.43 | Revenue growth y/y | -99.10% |
| 52W low | $7.59 | Inst. ownership | 59.38% |
| P/E (ttm) | — | Insider ownership | 1.69% |
| Forward P/E | -14.94 | Short float | 18.40% |
| PEG (trailing) | — | Avg volume | 33,797,115 |
| P/S | 373.92 | Employees | 428 |
| P/B | 2.65 | Analyst rec (1=buy..5=sell) | 2.6 |

...
Signed file: `OKLO.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $42.94 (2026-08-19, ~15-min delayed) |
| Market cap | $7.99B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-37.82%) with negative half-year (-36.28%). |
| Fresh setup quality | Poor / broken | -75.34% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -42.76, EV/Sales 4,324.37. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $42.94; 52w high $174.14 (-75.34%); 52w low $36.84 (+16.56%) |
| Trend | -37.82% vs SMA200, -10.42% vs SMA50, +0.30% vs SMA20 |
| Momentum | RSI(14) 46.5 (neutral) |
| Volatility | ATR(14) 3.34 (~7.8% of price); beta 1.20 |
| Setup perspective | -75.34% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -42.76, P/S 6,601.32, P/B 2.43 | EV/Sales 4,324.37, EV/EBITDA -24.14 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $79.88 (20 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 47.38% |
...
|---|---|---|---|
| Price | $42.94 | EV/Sales | 4,324.37 |
| Market cap | $7.99B | EV/EBITDA | -24.14 |
| Beta | 1.20 | Gross margin | 40.41% |
| RSI(14) | 46.5 | Operating margin | -6048.76% |
| ATR(14) | 3.34 | Profit margin | 0.00% |
| SMA20 dist | +0.30% | ROA | -6.65% |
| SMA50 dist | -10.42% | ROE | -7.70% |
| SMA200 dist | -37.82% | Revenue (ttm) | $1.21M |
| 52W high | $174.14 | Revenue growth y/y | — |
| 52W low | $36.84 | Inst. ownership | 47.38% |
| P/E (ttm) | — | Insider ownership | 15.43% |
| Forward P/E | -42.76 | Short float | 18.60% |
| PEG (trailing) | — | Avg volume | 11,027,462 |
| P/S | 6,601.32 | Employees | 215 |
| P/B | 2.43 | Analyst rec (1=buy..5=sell) | 2.0 |

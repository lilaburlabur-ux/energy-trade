...
Signed file: `VLO.research.20.08.2026`

| Field | Value |
|---|---|
| Current price | $341.51 (2026-08-20, ~15-min delayed) |
| Market cap | $98.33B |
...
|---|---|---|
| Technical momentum | High | 1Y +152.85%; price +49.83% vs SMA200. |
| Fresh setup quality | Moderate / wait | -2.44% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 5.45%, revenue growth 51.70%. |
| Value attractiveness | Reasonable | Forward P/E 11.19, EV/Sales 0.80. |
| Risk level | Elevated | Beta 0.55, ATR 3.2% of price, short float 3.67%. |
...
|---|---|---|
| Is DAR a Buy as Earnings Surge but Cost and Capacity Risks Build? | Zacks | 2026-08-20 |
| Can DAR's 12.8% Weekly Rally Continue as Core Earnings Strengthen? | Zacks | 2026-08-20 |
| Can Renewable Fuel Policy Keep DAR's DGD Earnings Strong Through 2027? | Zacks | 2026-08-20 |
| Will Refining Business Strength Continue to Support Par Pacific? | Zacks | 2026-08-20 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $341.51; 52w high $350.05 (-2.44%); 52w low $137.38 (+148.59%) |
| Trend | +49.83% vs SMA200, +17.54% vs SMA50, +6.97% vs SMA20 |
| Momentum | RSI(14) 67.7 (neutral) |
| Volatility | ATR(14) 10.92 (~3.2% of price); beta 0.55 |
| Setup perspective | -2.44% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 14.23, forward P/E 11.19, P/S 0.74, P/B 3.93 | EV/Sales 0.80, EV/EBITDA 7.96 |
| Growth expectations | Earnings growth 453.50%, EPS q/q 421.00% | Analyst mean target $312.53 (19 analysts) |
...
- **Volatility risk:** Beta 0.55, ATR 3.2% of price, short float 3.67%. Size positions accordingly.
...
|---|---|---|---|
| Price | $341.51 | EV/Sales | 0.80 |
| Market cap | $98.33B | EV/EBITDA | 7.96 |
| Beta | 0.55 | Gross margin | 16.12% |
| RSI(14) | 67.7 | Operating margin | 12.27% |
| ATR(14) | 10.92 | Profit margin | 5.45% |
| SMA20 dist | +6.97% | ROA | 10.56% |
| SMA50 dist | +17.54% | ROE | 27.64% |
| SMA200 dist | +49.83% | Revenue (ttm) | $132.43B |
| 52W high | $350.05 | Revenue growth y/y | 51.70% |
| 52W low | $137.38 | Inst. ownership | 87.10% |
| P/E (ttm) | 14.23 | Insider ownership | 0.42% |
| Forward P/E | 11.19 | Short float | 3.67% |
| PEG (trailing) | 4.08 | Avg volume | 2,920,109 |
| P/S | 0.74 | Employees | 9,785 |
| P/B | 3.93 | Analyst rec (1=buy..5=sell) | 2.4 |

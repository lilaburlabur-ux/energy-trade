...
Signed file: `MPLX.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $58.42 (2026-09-15, ~15-min delayed) |
| Market cap | $59.23B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +23.63%; price +6.40% vs SMA200. |
| Fresh setup quality | Watch | -3.01% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Strong | Profit margin 39.28%, revenue growth 10.60%. |
| Value attractiveness | Reasonable | Forward P/E 12.11, EV/Sales 7.03. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $58.42; 52w high $60.23 (-3.01%); 52w low $44.22 (+32.11%) |
| Trend | +6.40% vs SMA200, +0.59% vs SMA50, -1.24% vs SMA20 |
| Momentum | RSI(14) 45.5 (neutral) |
| Volatility | ATR(14) 0.94 (~1.6% of price); beta 0.46 |
| Setup perspective | -3.01% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 12.56, forward P/E 12.11, P/S 4.92, P/B 4.22 | EV/Sales 7.03, EV/EBITDA 13.83 |
...
|---|---|---|---|
| Price | $58.42 | EV/Sales | 7.03 |
| Market cap | $59.23B | EV/EBITDA | 13.83 |
| Beta | 0.46 | Gross margin | 55.71% |
| RSI(14) | 45.5 | Operating margin | 38.25% |
| ATR(14) | 0.94 | Profit margin | 39.28% |
| SMA20 dist | -1.24% | ROA | 7.25% |
| SMA50 dist | +0.59% | ROE | 33.69% |
| SMA200 dist | +6.40% | Revenue (ttm) | $12.03B |
| 52W high | $60.23 | Revenue growth y/y | 10.60% |
| 52W low | $44.22 | Inst. ownership | 19.71% |
| P/E (ttm) | 12.56 | Insider ownership | 64.03% |
| Forward P/E | 12.11 | Short float | 2.01% |
| PEG (trailing) | 3.09 | Avg volume | 1,371,143 |
| P/S | 4.92 | Employees | 0 |
| P/B | 4.22 | Analyst rec (1=buy..5=sell) | 2.4 |

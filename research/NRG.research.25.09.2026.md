...
Signed file: `NRG.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $100.37 (2026-09-25, ~15-min delayed) |
| Market cap | $21.10B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $100.37; 52w high $182.82 (-45.10%); 52w low $97.85 (+2.58%) |
| Trend | -29.23% vs SMA200, -14.91% vs SMA50, -7.47% vs SMA20 |
| Momentum | RSI(14) 35.1 (neutral) |
| Volatility | ATR(14) 4.17 (~4.2% of price); beta 1.17 |
| Setup perspective | -45.10% from 52w high — base needs to rebuild. |
...
- **Volatility risk:** Beta 1.17, ATR 4.2% of price, short float 3.71%. Size positions accordingly.
...
| SMA20 dist | -7.47% | ROA | 4.06% |
| SMA50 dist | -14.91% | ROE | 23.77% |
| SMA200 dist | -29.23% | Revenue (ttm) | $33.12B |
| 52W high | $182.82 | Revenue growth y/y | 11.00% |
| 52W low | $97.85 | Inst. ownership | 95.72% |
| P/E (ttm) | 26.14 | Insider ownership | 4.46% |
| Forward P/E | 8.97 | Short float | 3.71% |
| PEG (trailing) | 0.39 | Avg volume | 2,832,169 |
| P/S | 0.64 | Employees | 16,702 |
| P/B | 5.02 | Analyst rec (1=buy..5=sell) | 1.6 |

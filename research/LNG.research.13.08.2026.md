...
Signed file: `LNG.research.13.08.2026`

| Field | Value |
|---|---|
| Current price | $266.48 (2026-08-13, ~15-min delayed) |
| Market cap | $55.04B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +17.12%; price +14.05% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 14.32, EV/Sales 4.18. |
| Risk level | Moderate | Beta -0.01, ATR 3.0% of price, short float 1.84%. |
...
| Cheniere Energy (LNG) Q2 2026 Earnings Call Transcript | Motley Fool | 2026-08-13 |
| Cheniere Energy Q2 Earnings Call Highlights | MarketBeat | 2026-08-08 |
| LNG Q2 Earnings Call Highlights Guidance Raise and Output Gains | Zacks | 2026-08-07 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $266.48; 52w high $295.58 (-9.85%); 52w low $187.49 (+42.13%) |
| Trend | +14.05% vs SMA200, +6.34% vs SMA50, +1.78% vs SMA20 |
| Momentum | RSI(14) 56.4 (neutral) |
| Volatility | ATR(14) 7.92 (~3.0% of price); beta -0.01 |
...
| Valuation | P/E 20.20, forward P/E 14.32, P/S 2.63, P/B 8.95 | EV/Sales 4.18, EV/EBITDA 11.18 |
...
| Vanguard Portfolio Management LLC | 9,324,645 | 4.51% | 2026-03-31 |
| Vanguard Capital Management LLC | 9,150,289 | 4.43% | 2026-03-31 |
| State Street Corporation | 5,938,476 | 2.88% | 2026-06-30 |
| Morgan Stanley | 5,209,126 | 2.52% | 2026-03-31 |
| Canada Pension Plan Investment Board | 4,074,529 | 1.97% | 2026-03-31 |
| JPMORGAN CHASE & CO | 3,971,663 | 1.92% | 2026-03-31 |
| Geode Capital Management, LLC | 3,945,766 | 1.91% | 2026-03-31 |
| FMR, LLC | 3,901,585 | 1.89% | 2026-03-31 |
| Manufacturers Life Insurance Co. | 3,689,935 | 1.79% | 2026-03-31 |
...
|---|---|---|---|
| Price | $266.48 | EV/Sales | 4.18 |
| Market cap | $55.04B | EV/EBITDA | 11.18 |
| Beta | -0.01 | Gross margin | 36.85% |
| RSI(14) | 56.4 | Operating margin | 75.00% |
| ATR(14) | 7.92 | Profit margin | 13.94% |
| SMA20 dist | +1.78% | ROA | 8.63% |
| SMA50 dist | +6.34% | ROE | 39.12% |
| SMA200 dist | +14.05% | Revenue (ttm) | $20.92B |
| 52W high | $295.58 | Revenue growth y/y | 22.70% |
| 52W low | $187.49 | Inst. ownership | 91.98% |
| P/E (ttm) | 20.20 | Insider ownership | 0.66% |
| Forward P/E | 14.32 | Short float | 1.84% |
| PEG (trailing) | 9.46 | Avg volume | 2,059,687 |
| P/S | 2.63 | Employees | 1,717 |
| P/B | 8.95 | Analyst rec (1=buy..5=sell) | 1.4 |
...
## 9. Conclusion
LNG: Moderate momentum / mixed fundamentals / reasonable value / moderate risk. Per the journal method: act only on a defined setup (new tight base, controlled pullback, or confirmed reclaim of a key level) with risk sized in advance — never chase an extended move.

## Sources
| Source | URL | Used for |
|---|---|---|
| Yahoo Finance quote/profile/statistics for LNG | https://finance.yahoo.com/quote/LNG | Snapshot metrics, ownership, analyst data |
| Yahoo Finance price history (via yfinance) | https://finance.yahoo.com/quote/LNG/history | SMA/RSI/ATR/performance calculations |
| Yahoo Finance news feed | https://finance.yahoo.com/quote/LNG/news | Catalyst headlines |

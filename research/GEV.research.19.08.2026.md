...
Signed file: `GEV.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $987.46 (2026-08-19, ~15-min delayed) |
| Market cap | $262.99B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +58.35%; price +14.33% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 39.33, EV/Sales 6.28. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $987.46; 52w high $1,174.86 (-15.95%); 52w low $546.95 (+80.54%) |
| Trend | +14.33% vs SMA200, -4.34% vs SMA50, -1.84% vs SMA20 |
| Momentum | RSI(14) 44.8 (neutral) |
| Volatility | ATR(14) 52.40 (~5.3% of price); beta 1.03 |
...
| Valuation | P/E 28.33, forward P/E 39.33, P/S 6.36, P/B 21.99 | EV/Sales 6.28, EV/EBITDA 66.13 |
...
- **Valuation risk:** Forward P/E 39.33, EV/Sales 6.28. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $987.46 | EV/Sales | 6.28 |
| Market cap | $262.99B | EV/EBITDA | 66.13 |
| Beta | 1.03 | Gross margin | 20.57% |
| RSI(14) | 44.8 | Operating margin | 7.47% |
| ATR(14) | 52.40 | Profit margin | 23.04% |
| SMA20 dist | -1.84% | ROA | 2.54% |
| SMA50 dist | -4.34% | ROE | 82.58% |
| SMA200 dist | +14.33% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.70% |
| P/E (ttm) | 28.33 | Insider ownership | 0.13% |
| Forward P/E | 39.33 | Short float | 3.20% |
| PEG (trailing) | 1.71 | Avg volume | 2,815,719 |
| P/S | 6.36 | Employees | 78,000 |
| P/B | 21.99 | Analyst rec (1=buy..5=sell) | 1.6 |

...
Signed file: `NXE.research.29.08.2026`

| Field | Value |
|---|---|
| Current price | $10.40 (2026-08-29, ~15-min delayed) |
| Market cap | $6.97B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-3.40%) with negative half-year (-18.62%). |
| Fresh setup quality | Poor / broken | -25.29% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth —. |
| Value attractiveness | Reasonable | Forward P/E -59.44, EV/Sales —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.40; 52w high $13.92 (-25.29%); 52w low $7.44 (+39.78%) |
| Trend | -3.40% vs SMA200, +5.50% vs SMA50, -0.80% vs SMA20 |
| Momentum | RSI(14) 50.7 (neutral) |
| Volatility | ATR(14) 0.51 (~4.9% of price); beta 1.65 |
| Setup perspective | -25.29% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -59.44, P/S —, P/B 5.21 | EV/Sales —, EV/EBITDA -65.92 |
...
|---|---|---|---|
| Price | $10.40 | EV/Sales | — |
| Market cap | $6.97B | EV/EBITDA | -65.92 |
| Beta | 1.65 | Gross margin | 0.00% |
| RSI(14) | 50.7 | Operating margin | 0.00% |
| ATR(14) | 0.51 | Profit margin | 0.00% |
| SMA20 dist | -0.80% | ROA | -3.39% |
| SMA50 dist | +5.50% | ROE | -17.67% |
| SMA200 dist | -3.40% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $7.44 | Inst. ownership | 55.23% |
| P/E (ttm) | — | Insider ownership | 6.39% |
| Forward P/E | -59.44 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,493,227 |
| P/S | — | Employees | 142 |
| P/B | 5.21 | Analyst rec (1=buy..5=sell) | 1.5 |

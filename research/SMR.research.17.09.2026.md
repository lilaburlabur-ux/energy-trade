...
Signed file: `SMR.research.17.09.2026`

| Field | Value |
|---|---|
| Current price | $9.04 (2026-09-17, ~15-min delayed) |
| Market cap | $3.71B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.04; 52w high $53.43 (-83.08%); 52w low $7.59 (+19.10%) |
| Trend | -28.26% vs SMA200, -0.17% vs SMA50, -3.94% vs SMA20 |
| Momentum | RSI(14) 47.8 (neutral) |
| Volatility | ATR(14) 0.73 (~8.1% of price); beta 2.31 |
| Setup perspective | -83.08% from 52w high — base needs to rebuild. |
...
| SMA20 dist | -3.94% | ROA | -10.60% |
| SMA50 dist | -0.17% | ROE | -55.18% |
| SMA200 dist | -28.26% | Revenue (ttm) | $10.69M |

...
Signed file: `GEV.research.09.09.2026`

| Field | Value |
|---|---|
| Current price | $951.04 (2026-09-09, ~15-min delayed) |
| Market cap | $253.29B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +58.81%; price +6.93% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 37.63, EV/Sales 6.06. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $951.04; 52w high $1,174.86 (-19.05%); 52w low $546.95 (+73.88%) |
| Trend | +6.93% vs SMA200, -5.92% vs SMA50, -1.75% vs SMA20 |
| Momentum | RSI(14) 46.8 (neutral) |
| Volatility | ATR(14) 40.94 (~4.3% of price); beta 0.97 |
...
| Valuation | P/E 27.27, forward P/E 37.63, P/S 6.12, P/B 21.18 | EV/Sales 6.06, EV/EBITDA 63.88 |
...
- **Valuation risk:** Forward P/E 37.63, EV/Sales 6.06. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $951.04 | EV/Sales | 6.06 |
| Market cap | $253.29B | EV/EBITDA | 63.88 |
| Beta | 0.97 | Gross margin | 20.57% |
| RSI(14) | 46.8 | Operating margin | 7.47% |
| ATR(14) | 40.94 | Profit margin | 23.04% |
| SMA20 dist | -1.75% | ROA | 2.54% |
| SMA50 dist | -5.92% | ROE | 82.58% |
| SMA200 dist | +6.93% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.73% |
| P/E (ttm) | 27.27 | Insider ownership | 0.13% |
| Forward P/E | 37.63 | Short float | 2.98% |
| PEG (trailing) | 1.89 | Avg volume | 2,707,930 |
| P/S | 6.12 | Employees | 78,000 |
| P/B | 21.18 | Analyst rec (1=buy..5=sell) | 1.5 |

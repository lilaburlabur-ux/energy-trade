...
Signed file: `ENPH.research.11.08.2026`

| Field | Value |
|---|---|
| Current price | $42.30 (2026-08-11, ~15-min delayed) |
| Market cap | $5.59B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +30.39%; price +5.32% vs SMA200. |
| Fresh setup quality | Poor / broken | -41.52% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 10.09%, revenue growth -19.60%. |
| Value attractiveness | Reasonable | Forward P/E 18.37, EV/Sales 3.83. |
| Risk level | High | Beta 1.65, ATR 6.6% of price, short float 20.87%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $42.30; 52w high $72.33 (-41.52%); 52w low $26.12 (+61.94%) |
| Trend | +5.32% vs SMA200, -9.28% vs SMA50, +7.03% vs SMA20 |
| Momentum | RSI(14) 51.8 (neutral) |
| Volatility | ATR(14) 2.77 (~6.6% of price); beta 1.65 |
| Setup perspective | -41.52% from 52w high — base needs to rebuild. |
...
| Valuation | P/E 41.88, forward P/E 18.37, P/S 4.20, P/B 4.73 | EV/Sales 3.83, EV/EBITDA 26.50 |
| Growth expectations | Earnings growth -3.50%, EPS q/q -2.60% | Analyst mean target $47.01 (27 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 103.53% |
...
- **Volatility risk:** Beta 1.65, ATR 6.6% of price, short float 20.87%. Size positions accordingly.
...
|---|---|---|---|
| Price | $42.30 | EV/Sales | 3.83 |
| Market cap | $5.59B | EV/EBITDA | 26.50 |
| Beta | 1.65 | Gross margin | 30.04% |
| RSI(14) | 51.8 | Operating margin | 17.98% |
| ATR(14) | 2.77 | Profit margin | 10.09% |
| SMA20 dist | +7.03% | ROA | 2.38% |
| SMA50 dist | -9.28% | ROE | 13.00% |
| SMA200 dist | +5.32% | Revenue (ttm) | $1.33B |
| 52W high | $72.33 | Revenue growth y/y | -19.60% |
| 52W low | $26.12 | Inst. ownership | 103.53% |
| P/E (ttm) | 41.88 | Insider ownership | 3.03% |
| Forward P/E | 18.37 | Short float | 20.87% |
| PEG (trailing) | 1.18 | Avg volume | 7,253,650 |
| P/S | 4.20 | Employees | 2,872 |
| P/B | 4.73 | Analyst rec (1=buy..5=sell) | 2.5 |

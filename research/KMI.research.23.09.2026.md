...
Signed file: `KMI.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $31.37 (2026-09-23, ~15-min delayed) |
| Market cap | $69.85B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +19.00%; price +1.57% vs SMA200. |
| Fresh setup quality | Moderate / wait | -7.71% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 19.30%, revenue growth 10.80%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 20.31, EV/Sales 5.75. |
| Risk level | Moderate | Beta 0.55, ATR 2.3% of price, short float 2.50%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $31.37; 52w high $33.99 (-7.71%); 52w low $24.86 (+26.18%) |
| Trend | +1.57% vs SMA200, -0.93% vs SMA50, -0.30% vs SMA20 |
| Momentum | RSI(14) 48.7 (neutral) |
| Volatility | ATR(14) 0.73 (~2.3% of price); beta 0.55 |
| Setup perspective | -7.71% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 20.24, forward P/E 20.31, P/S 3.89, P/B 2.21 | EV/Sales 5.75, EV/EBITDA 13.52 |
...
- **Valuation risk:** Forward P/E 20.31, EV/Sales 5.75. Multiple compression is the main downside if growth disappoints.
...
|---|---|---|---|
| Price | $31.37 | EV/Sales | 5.75 |
| Market cap | $69.85B | EV/EBITDA | 13.52 |
| Beta | 0.55 | Gross margin | 49.41% |
| RSI(14) | 48.7 | Operating margin | 30.06% |
| ATR(14) | 0.73 | Profit margin | 19.30% |
| SMA20 dist | -0.30% | ROA | 4.45% |
| SMA50 dist | -0.93% | ROE | 10.99% |
| SMA200 dist | +1.57% | Revenue (ttm) | $17.96B |
| 52W high | $33.99 | Revenue growth y/y | 10.80% |
| 52W low | $24.86 | Inst. ownership | 70.83% |
| P/E (ttm) | 20.24 | Insider ownership | 12.70% |
| Forward P/E | 20.31 | Short float | 2.50% |
| PEG (trailing) | 3.19 | Avg volume | 11,089,584 |
...
|---|---|---|---|
| 2026-09-22 | main | RBC Capital | Sector Perform → Sector Perform |
| 2026-09-18 | main | Jefferies | Hold → Hold |

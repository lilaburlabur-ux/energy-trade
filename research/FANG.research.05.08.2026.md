...
Signed file: `FANG.research.05.08.2026`

| Field | Value |
|---|---|
| Current price | $186.17 (2026-08-05, ~15-min delayed) |
| Market cap | $52.37B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $186.17; 52w high $212.52 (-12.40%); 52w low $132.09 (+40.94%) |
| Trend | +7.45% vs SMA200, -2.63% vs SMA50, -4.44% vs SMA20 |
| Momentum | RSI(14) 43.1 (neutral) |
| Volatility | ATR(14) 6.62 (~3.6% of price); beta 0.42 |
...
- **Volatility risk:** Beta 0.42, ATR 3.6% of price, short float 4.69%. Size positions accordingly.
...
|---|---|---|---|
| Price | $186.17 | EV/Sales | 4.41 |
| Market cap | $52.37B | EV/EBITDA | 6.13 |
| Beta | 0.42 | Gross margin | 71.74% |
| RSI(14) | 43.1 | Operating margin | 46.35% |
| ATR(14) | 6.62 | Profit margin | 8.97% |
| SMA20 dist | -4.44% | ROA | 1.29% |
| SMA50 dist | -2.63% | ROE | 3.49% |
| SMA200 dist | +7.45% | Revenue (ttm) | $16.35B |

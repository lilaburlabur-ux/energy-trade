...
Signed file: `GEV.research.13.08.2026`

| Field | Value |
|---|---|
| Current price | $1,049.42 (2026-08-13, ~15-min delayed) |
| Market cap | $279.50B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +59.98%; price +22.81% vs SMA200. |
...
| Value attractiveness | Low (expensive) | Forward P/E 42.15, EV/Sales 6.51. |
| Risk level | High | Beta 1.03, ATR 5.0% of price, short float 3.20%. |
...
|---|---|---|
| GE Vernova (GEV) After Strong Q2 Results And Raised Guidance Looks Fully Valued | Simply Wall St. | 2026-08-13 |
...
| GE Vernova (GEV) Stock Could Be 14% Overvalued As Backlog Hits Record High | Simply Wall St. | 2026-08-13 |
| GE Vernova and Blue Energy Move Forward With 2.5 GW Texas Gas-Nuclear Power Project | InvestorsHub | 2026-08-13 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $1,049.42; 52w high $1,174.86 (-10.68%); 52w low $546.95 (+91.87%) |
| Trend | +22.81% vs SMA200, +2.35% vs SMA50, +3.98% vs SMA20 |
| Momentum | RSI(14) 54.7 (neutral) |
| Volatility | ATR(14) 52.84 (~5.0% of price); beta 1.03 |
...
| Valuation | P/E 30.12, forward P/E 42.15, P/S 6.76, P/B 23.37 | EV/Sales 6.51, EV/EBITDA 68.53 |
...
- **Valuation risk:** Forward P/E 42.15, EV/Sales 6.51. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.03, ATR 5.0% of price, short float 3.20%. Size positions accordingly.
...
|---|---|---|---|
| Price | $1,049.42 | EV/Sales | 6.51 |
| Market cap | $279.50B | EV/EBITDA | 68.53 |
| Beta | 1.03 | Gross margin | 20.57% |
| RSI(14) | 54.7 | Operating margin | 7.47% |
| ATR(14) | 52.84 | Profit margin | 23.04% |
| SMA20 dist | +3.98% | ROA | 2.54% |
...
| P/S | 6.76 | Employees | 78,000 |
| P/B | 23.37 | Analyst rec (1=buy..5=sell) | 1.6 |

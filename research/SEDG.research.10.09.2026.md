...
Signed file: `SEDG.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $36.75 (2026-09-10, ~15-min delayed) |
| Market cap | $2.26B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +22.34%; price -12.66% vs SMA200. |
| Fresh setup quality | Poor / broken | -53.19% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-20.29%). |
| Value attractiveness | Low (expensive) | Forward P/E 37.90, EV/Sales 1.52. |
| Risk level | High | Beta 1.44, ATR 8.0% of price, short float 23.21%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $36.75; 52w high $78.51 (-53.19%); 52w low $28.47 (+29.08%) |
| Trend | -12.66% vs SMA200, -9.51% vs SMA50, +12.63% vs SMA20 |
| Momentum | RSI(14) 53.2 (neutral) |
| Volatility | ATR(14) 2.92 (~8.0% of price); beta 1.44 |
| Setup perspective | -53.19% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 37.90, P/S 1.70, P/B 5.49 | EV/Sales 1.52, EV/EBITDA -16.73 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $38.45 (20 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 102.00% |
...
- **Valuation risk:** Forward P/E 37.90, EV/Sales 1.52. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 1.44, ATR 8.0% of price, short float 23.21%. Size positions accordingly.
...
|---|---|---|---|
| Price | $36.75 | EV/Sales | 1.52 |
| Market cap | $2.26B | EV/EBITDA | -16.73 |
| Beta | 1.44 | Gross margin | 21.25% |
| RSI(14) | 53.2 | Operating margin | -6.51% |
| ATR(14) | 2.92 | Profit margin | -20.29% |
| SMA20 dist | +12.63% | ROA | -3.84% |
| SMA50 dist | -9.51% | ROE | -58.42% |
| SMA200 dist | -12.66% | Revenue (ttm) | $1.33B |
| 52W high | $78.51 | Revenue growth y/y | 19.60% |
| 52W low | $28.47 | Inst. ownership | 102.00% |
| P/E (ttm) | — | Insider ownership | 1.20% |
| Forward P/E | 37.90 | Short float | 23.21% |
| PEG (trailing) | — | Avg volume | 2,934,062 |
| P/S | 1.70 | Employees | 3,576 |
| P/B | 5.49 | Analyst rec (1=buy..5=sell) | 3.0 |

...
Signed file: `FANG.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $185.65 (2026-09-23, ~15-min delayed) |
| Market cap | $51.99B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +36.12%; price +2.08% vs SMA200. |
| Fresh setup quality | Moderate / wait | -12.23% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 9.03%, revenue growth 52.50%. |
| Value attractiveness | Reasonable | Forward P/E 9.94, EV/Sales 4.32. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $185.65; 52w high $211.53 (-12.23%); 52w low $134.06 (+38.48%) |
| Trend | +2.08% vs SMA200, -6.66% vs SMA50, -7.08% vs SMA20 |
| Momentum | RSI(14) 35.9 (neutral) |
| Volatility | ATR(14) 6.47 (~3.5% of price); beta 0.41 |
| Setup perspective | -12.23% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 36.33, forward P/E 9.94, P/S 3.20, P/B 1.37 | EV/Sales 4.32, EV/EBITDA 5.96 |
...
|---|---|---|---|
| Price | $185.65 | EV/Sales | 4.32 |
| Market cap | $51.99B | EV/EBITDA | 5.96 |
| Beta | 0.41 | Gross margin | 72.35% |
| RSI(14) | 35.9 | Operating margin | 48.47% |
| ATR(14) | 6.47 | Profit margin | 9.03% |
| SMA20 dist | -7.08% | ROA | 1.31% |
| SMA50 dist | -6.66% | ROE | 3.49% |
| SMA200 dist | +2.08% | Revenue (ttm) | $16.25B |
| 52W high | $211.53 | Revenue growth y/y | 52.50% |
| 52W low | $134.06 | Inst. ownership | 73.37% |
| P/E (ttm) | 36.33 | Insider ownership | 23.88% |
| Forward P/E | 9.94 | Short float | 4.23% |
| PEG (trailing) | 22.15 | Avg volume | 2,382,568 |

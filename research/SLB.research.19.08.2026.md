...
Signed file: `SLB.research.19.08.2026`

| Field | Value |
|---|---|
| Current price | $53.55 (2026-08-19, ~15-min delayed) |
| Market cap | $79.48B |
...
|---|---|---|
| Technical momentum | High | 1Y +65.20%; price +12.50% vs SMA200. |
| Fresh setup quality | Moderate / wait | -7.69% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 8.53%, revenue growth 5.00%. |
| Value attractiveness | Reasonable | Forward P/E 16.57, EV/Sales 2.44. |
| Risk level | Moderate | Beta 0.75, ATR 2.9% of price, short float 4.32%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $53.55; 52w high $58.01 (-7.69%); 52w low $31.12 (+72.06%) |
| Trend | +12.50% vs SMA200, +7.66% vs SMA50, +4.32% vs SMA20 |
| Momentum | RSI(14) 60.1 (neutral) |
| Volatility | ATR(14) 1.55 (~2.9% of price); beta 0.75 |
| Setup perspective | -7.69% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 26.12, forward P/E 16.57, P/S 2.19, P/B 3.05 | EV/Sales 2.44, EV/EBITDA 12.03 |
...
|---|---|---|---|
| Price | $53.55 | EV/Sales | 2.44 |
| Market cap | $79.48B | EV/EBITDA | 12.03 |
| Beta | 0.75 | Gross margin | 16.99% |
| RSI(14) | 60.1 | Operating margin | 12.71% |
| ATR(14) | 1.55 | Profit margin | 8.53% |
| SMA20 dist | +4.32% | ROA | 6.17% |
| SMA50 dist | +7.66% | ROE | 12.91% |
| SMA200 dist | +12.50% | Revenue (ttm) | $36.37B |
...
| PEG (trailing) | 1.82 | Avg volume | 13,898,187 |

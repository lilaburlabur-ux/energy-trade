...
Signed file: `SO.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $90.10 (2026-08-24, ~15-min delayed) |
| Market cap | $103.65B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-1.01%) with negative half-year (-3.77%). |
| Fresh setup quality | Moderate / wait | -7.58% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 15.43%, revenue growth 0.10%. |
| Value attractiveness | Reasonable | Forward P/E 18.29, EV/Sales 5.94. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $90.10; 52w high $97.49 (-7.58%); 52w low $82.06 (+9.79%) |
| Trend | -1.01% vs SMA200, -3.83% vs SMA50, -2.29% vs SMA20 |
| Momentum | RSI(14) 38.5 (neutral) |
| Volatility | ATR(14) 1.67 (~1.9% of price); beta 0.33 |
| Setup perspective | -7.58% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 21.71, forward P/E 18.29, P/S 3.43, P/B 2.62 | EV/Sales 5.94, EV/EBITDA 12.57 |
...
|---|---|---|---|
| Price | $90.10 | EV/Sales | 5.94 |
| Market cap | $103.65B | EV/EBITDA | 12.57 |
| Beta | 0.33 | Gross margin | 48.29% |
| RSI(14) | 38.5 | Operating margin | 29.61% |
| ATR(14) | 1.67 | Profit margin | 15.43% |
| SMA20 dist | -2.29% | ROA | 3.27% |
| SMA50 dist | -3.83% | ROE | 11.48% |
| SMA200 dist | -1.01% | Revenue (ttm) | $30.18B |
| 52W high | $97.49 | Revenue growth y/y | 0.10% |
| 52W low | $82.06 | Inst. ownership | 74.17% |
| P/E (ttm) | 21.71 | Insider ownership | 0.10% |
| Forward P/E | 18.29 | Short float | 3.16% |
| PEG (trailing) | 2.26 | Avg volume | 5,806,525 |

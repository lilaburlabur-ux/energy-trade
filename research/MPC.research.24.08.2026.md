...
Signed file: `MPC.research.24.08.2026`

| Field | Value |
|---|---|
| Current price | $362.52 (2026-08-24, ~15-min delayed) |
| Market cap | $101.80B |
...
|---|---|---|
| Technical momentum | High | 1Y +123.46%; price +56.19% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.74% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 5.55%, revenue growth 53.70%. |
| Value attractiveness | Reasonable | Forward P/E 11.26, EV/Sales 0.87. |
...
| Marathon Petroleum (MPC) is a Great Momentum Stock: Should You Buy? | Zacks | 2026-08-24 |
| Is DK a Buy Now as Cash Flow Improves Despite Refining Cycle Risks? | Zacks | 2026-08-24 |
| Can Phillips 66, Marathon, or Valero Afford Delek US Holdings Now? | 24/7 Wall St. | 2026-08-24 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $362.52; 52w high $365.21 (-0.74%); 52w low $160.76 (+125.50%) |
| Trend | +56.19% vs SMA200, +21.32% vs SMA50, +9.37% vs SMA20 |
| Momentum | RSI(14) 72.9 (overbought) |
| Volatility | ATR(14) 10.61 (~2.9% of price); beta 0.51 |
...
| Valuation | P/E 12.56, forward P/E 11.26, P/S 0.66, P/B 5.38 | EV/Sales 0.87, EV/EBITDA 8.73 |
...
|---|---|---|---|
| Price | $362.52 | EV/Sales | 0.87 |
| Market cap | $101.80B | EV/EBITDA | 8.73 |
| Beta | 0.51 | Gross margin | 12.82% |
| RSI(14) | 72.9 | Operating margin | 13.56% |
| ATR(14) | 10.61 | Profit margin | 5.55% |
| SMA20 dist | +9.37% | ROA | 8.74% |
| SMA50 dist | +21.32% | ROE | 42.10% |
| SMA200 dist | +56.19% | Revenue (ttm) | $154.15B |
| 52W high | $365.21 | Revenue growth y/y | 53.70% |
| 52W low | $160.76 | Inst. ownership | 79.53% |
| P/E (ttm) | 12.56 | Insider ownership | 0.33% |
| Forward P/E | 11.26 | Short float | 2.81% |
| PEG (trailing) | 1.79 | Avg volume | 2,373,380 |
| P/S | 0.66 | Employees | 18,500 |
| P/B | 5.38 | Analyst rec (1=buy..5=sell) | 2.3 |

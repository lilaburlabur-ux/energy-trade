...
Signed file: `SU.research.25.09.2026`

| Field | Value |
|---|---|
| Current price | $68.19 (2026-09-25, ~15-min delayed) |
| Market cap | $79.76B |
...
|---|---|---|
| Technical momentum | High | 1Y +64.15%; price +15.41% vs SMA200. |
| Fresh setup quality | Moderate / wait | -5.12% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 15.78%, revenue growth 45.90%. |
| Value attractiveness | Reasonable | Forward P/E 11.94, EV/Sales 1.58. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $68.19; 52w high $71.87 (-5.12%); 52w low $37.39 (+82.39%) |
| Trend | +15.41% vs SMA200, +3.18% vs SMA50, -0.10% vs SMA20 |
| Momentum | RSI(14) 52.8 (neutral) |
| Volatility | ATR(14) 1.79 (~2.6% of price); beta 0.56 |
| Setup perspective | -5.12% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 12.79, forward P/E 11.94, P/S 1.41, P/B 2.32 | EV/Sales 1.58, EV/EBITDA 4.59 |
...
|---|---|---|---|
| Price | $68.19 | EV/Sales | 1.58 |
| Market cap | $79.76B | EV/EBITDA | 4.59 |
| Beta | 0.56 | Gross margin | 60.40% |
| RSI(14) | 52.8 | Operating margin | 29.94% |
| ATR(14) | 1.79 | Profit margin | 15.78% |
| SMA20 dist | -0.10% | ROA | 8.58% |
| SMA50 dist | +3.18% | ROE | 19.25% |
| SMA200 dist | +15.41% | Revenue (ttm) | $56.57B |
| 52W high | $71.87 | Revenue growth y/y | 45.90% |
| 52W low | $37.39 | Inst. ownership | 72.47% |
| P/E (ttm) | 12.79 | Insider ownership | 0.01% |
| Forward P/E | 11.94 | Short float | — |
| PEG (trailing) | — | Avg volume | 4,402,065 |

...
Signed file: `SMR.research.04.08.2026`

| Field | Value |
|---|---|
| Current price | $9.49 (2026-08-04, ~15-min delayed) |
| Market cap | $3.28B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-40.81%) with negative half-year (-42.42%). |
| Fresh setup quality | Poor / broken | -82.24% from 52w high — base needs to rebuild. |
| Fundamental quality | Mixed | Profit margin 0.00%, revenue growth -95.80%. |
| Value attractiveness | Reasonable | Forward P/E -13.24, EV/Sales 116.61. |
| Risk level | High | Beta 2.31, ATR 8.0% of price, short float 23.15%. |
...
|---|---|---|
| Better Small Modular Reactor Stock: NuScale Power vs. GE Vernova | Motley Fool | 2026-08-03 |
| Here's How to Play NuScale Stock Before Q2 Earnings Release | Zacks | 2026-08-03 |
| NuScale Power's Next Earnings Report on Aug. 5 Could Send the Stock Soaring. Here's Why. | Motley Fool | 2026-08-02 |
| NuScale Power (SMR) Gains Fresh SMR Backing, Is A $100 Fair Value Credible? | Simply Wall St. | 2026-08-01 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $9.49; 52w high $53.43 (-82.24%); 52w low $7.59 (+25.03%) |
| Trend | -40.81% vs SMA200, -4.17% vs SMA50, +11.90% vs SMA20 |
| Momentum | RSI(14) 54.5 (neutral) |
| Volatility | ATR(14) 0.76 (~8.0% of price); beta 2.31 |
| Setup perspective | -82.24% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E -13.24, P/S 175.94, P/B 2.59 | EV/Sales 116.61, EV/EBITDA -10.71 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $14.57 (15 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 52.55% |
...
|---|---|---|---|
| Van Eck Associates Corporation | 20,032,960 | 5.79% | 2026-03-31 |
| Blackrock Inc. | 12,849,132 | 3.71% | 2026-03-31 |
| Mirae Asset Global ETFs Holdings Ltd. | 11,452,161 | 3.31% | 2026-03-31 |
| Vanguard Portfolio Management LLC | 10,948,169 | 3.16% | 2026-03-31 |
| Vanguard Capital Management LLC | 10,732,371 | 3.10% | 2026-03-31 |
| Marex Group Plc | 9,098,178 | 2.63% | 2026-03-31 |
| Morgan Stanley | 7,052,969 | 2.04% | 2026-03-31 |
| Renaissance Technologies, LLC | 5,455,800 | 1.58% | 2026-03-31 |
| Marshall Wace LLP | 4,307,637 | 1.24% | 2026-03-31 |
| Geode Capital Management, LLC | 3,728,930 | 1.08% | 2026-03-31 |

## 6. Risk Review and Setup Plan
- **Volatility risk:** Beta 2.31, ATR 8.0% of price, short float 23.15%. Size positions accordingly.
...
|---|---|---|---|
| Price | $9.49 | EV/Sales | 116.61 |
| Market cap | $3.28B | EV/EBITDA | -10.71 |
| Beta | 2.31 | Gross margin | 23.84% |
| RSI(14) | 54.5 | Operating margin | -10181.24% |
| ATR(14) | 0.76 | Profit margin | 0.00% |
| SMA20 dist | +11.90% | ROA | -14.46% |
| SMA50 dist | -4.17% | ROE | -83.05% |
| SMA200 dist | -40.81% | Revenue (ttm) | $18.67M |
| 52W high | $53.43 | Revenue growth y/y | -95.80% |
| 52W low | $7.59 | Inst. ownership | 52.55% |
| P/E (ttm) | — | Insider ownership | 1.99% |
| Forward P/E | -13.24 | Short float | 23.15% |
| PEG (trailing) | — | Avg volume | 33,327,354 |
| P/S | 175.94 | Employees | 428 |
| P/B | 2.59 | Analyst rec (1=buy..5=sell) | 2.6 |
...
| 2026-04-23 | init | HSBC | — → Hold |
| 2026-04-21 | main | Citigroup | Sell → Sell |
| 2026-03-18 | main | UBS | Neutral → Neutral |
| 2026-03-02 | main | Citigroup | Sell → Sell |
...
| Source | URL | Used for |
|---|---|---|
| Yahoo Finance quote/profile/statistics for SMR | https://finance.yahoo.com/quote/SMR | Snapshot metrics, ownership, analyst data |
| Yahoo Finance price history (via yfinance) | https://finance.yahoo.com/quote/SMR/history | SMA/RSI/ATR/performance calculations |
| Yahoo Finance news feed | https://finance.yahoo.com/quote/SMR/news | Catalyst headlines |

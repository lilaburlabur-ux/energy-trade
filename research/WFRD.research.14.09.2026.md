...
Signed file: `WFRD.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $84.46 (2026-09-14, ~15-min delayed) |
| Market cap | $6.04B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-8.54%) with negative half-year (-1.84%). |
...
| Value attractiveness | Reasonable | Forward P/E 11.97, EV/Sales 1.38. |
| Risk level | Elevated | Beta 0.90, ATR 4.6% of price, short float 6.87%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $84.46; 52w high $111.07 (-23.96%); 52w low $60.68 (+39.20%) |
| Trend | -8.54% vs SMA200, -4.36% vs SMA50, -8.30% vs SMA20 |
| Momentum | RSI(14) 37.4 (neutral) |
| Volatility | ATR(14) 3.87 (~4.6% of price); beta 0.90 |
...
| Valuation | P/E 16.66, forward P/E 11.97, P/S 1.26, P/B 3.39 | EV/Sales 1.38, EV/EBITDA 7.08 |
...
- **Volatility risk:** Beta 0.90, ATR 4.6% of price, short float 6.87%. Size positions accordingly.
...
|---|---|---|---|
| Price | $84.46 | EV/Sales | 1.38 |
| Market cap | $6.04B | EV/EBITDA | 7.08 |
| Beta | 0.90 | Gross margin | 30.51% |
| RSI(14) | 37.4 | Operating margin | 10.50% |
| ATR(14) | 3.87 | Profit margin | 7.66% |
| SMA20 dist | -8.30% | ROA | 7.90% |
| SMA50 dist | -4.36% | ROE | 22.79% |
| SMA200 dist | -8.54% | Revenue (ttm) | $4.78B |
| 52W high | $111.07 | Revenue growth y/y | -8.20% |
| 52W low | $60.68 | Inst. ownership | 106.62% |
| P/E (ttm) | 16.66 | Insider ownership | 2.12% |
| Forward P/E | 11.97 | Short float | 6.87% |
| PEG (trailing) | 1.36 | Avg volume | 1,244,224 |
| P/S | 1.26 | Employees | 16,700 |
| P/B | 3.39 | Analyst rec (1=buy..5=sell) | 1.7 |

...
Signed file: `MPC.research.28.08.2026`
...
|---|---|---|
| Technical momentum | High | 1Y +113.02%; price +54.90% vs SMA200. |
| Fresh setup quality | Moderate / wait | -0.46% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Mixed | Profit margin 5.55%, revenue growth 53.70%. |
| Value attractiveness | Reasonable | Forward P/E 11.29, EV/Sales 0.88. |
| Risk level | Moderate | Beta 0.51, ATR 3.0% of price, short float 2.70%. |
...
|---|---|---|
| 5 Value Stocks to Buy Right Now as Inflation Remains Sticky | Zacks | 2026-08-27 |
| Has Marathon Petroleum (MPC) Outpaced Other Oils-Energy Stocks This Year? | Zacks | 2026-08-27 |
| Marathon Petroleum (MPC) Could Be 12% Overvalued As Buybacks Drive The Bull Case | Simply Wall St. | 2026-08-27 |
| ExxonMobil Stock's Biggest Risk Is The Shortage Ending | Trefis | 2026-08-26 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $363.54; 52w high $365.21 (-0.46%); 52w low $160.76 (+126.13%) |
| Trend | +54.90% vs SMA200, +19.13% vs SMA50, +7.18% vs SMA20 |
| Momentum | RSI(14) 69.5 (neutral) |
| Volatility | ATR(14) 10.89 (~3.0% of price); beta 0.51 |
| Setup perspective | -0.46% from 52w high; no clean fresh pivot by default. |
...
| SMA20 dist | +7.18% | ROA | 8.74% |
| SMA50 dist | +19.13% | ROE | 42.10% |

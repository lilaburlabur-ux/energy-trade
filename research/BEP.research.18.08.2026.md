...
Signed file: `BEP.research.18.08.2026`

| Field | Value |
|---|---|
| Current price | $32.80 (2026-08-18, ~15-min delayed) |
| Market cap | $15.99B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +36.45%; price +4.69% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E -21.41, EV/Sales 13.40. |
| Risk level | Elevated | Beta 0.99, ATR 3.3% of price, short float 0.51%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $32.80; 52w high $37.09 (-11.57%); 52w low $24.11 (+36.07%) |
| Trend | +4.69% vs SMA200, -2.64% vs SMA50, -1.14% vs SMA20 |
| Momentum | RSI(14) 45.7 (neutral) |
| Volatility | ATR(14) 1.08 (~3.3% of price); beta 0.99 |
...
| Valuation | P/E —, forward P/E -21.41, P/S 2.51, P/B 2.63 | EV/Sales 13.40, EV/EBITDA 28.40 |
...
- **Volatility risk:** Beta 0.99, ATR 3.3% of price, short float 0.51%. Size positions accordingly.
...
|---|---|---|---|
| Price | $32.80 | EV/Sales | 13.40 |
| Market cap | $15.99B | EV/EBITDA | 28.40 |
| Beta | 0.99 | Gross margin | 51.39% |
| RSI(14) | 45.7 | Operating margin | 17.08% |
| ATR(14) | 1.08 | Profit margin | -1.26% |
| SMA20 dist | -1.14% | ROA | 0.42% |
| SMA50 dist | -2.64% | ROE | 0.40% |
| SMA200 dist | +4.69% | Revenue (ttm) | $6.36B |
| 52W high | $37.09 | Revenue growth y/y | 1.10% |
| 52W low | $24.11 | Inst. ownership | 65.34% |
| P/E (ttm) | — | Insider ownership | 0.02% |
| Forward P/E | -21.41 | Short float | 0.51% |
| PEG (trailing) | — | Avg volume | 921,653 |

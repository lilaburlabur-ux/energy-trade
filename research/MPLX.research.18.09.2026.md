...
Signed file: `MPLX.research.18.09.2026`

| Field | Value |
|---|---|
| Current price | $59.44 (2026-09-18, ~15-min delayed) |
| Market cap | $60.32B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +25.96%; price +8.04% vs SMA200. |
| Fresh setup quality | Watch | -1.31% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Strong | Profit margin 39.28%, revenue growth 10.60%. |
| Value attractiveness | Reasonable | Forward P/E 12.32, EV/Sales 7.04. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $59.44; 52w high $60.23 (-1.31%); 52w low $44.22 (+34.42%) |
| Trend | +8.04% vs SMA200, +2.10% vs SMA50, +0.54% vs SMA20 |
| Momentum | RSI(14) 54.6 (neutral) |
| Volatility | ATR(14) 0.98 (~1.7% of price); beta 0.46 |
| Setup perspective | -1.31% from 52w high and near SMA20 — check for a tight base. |
...
| Valuation | P/E 12.78, forward P/E 12.32, P/S 5.01, P/B 4.30 | EV/Sales 7.04, EV/EBITDA 13.87 |
...
|---|---|---|---|
| Price | $59.44 | EV/Sales | 7.04 |
| Market cap | $60.32B | EV/EBITDA | 13.87 |
| Beta | 0.46 | Gross margin | 55.71% |
| RSI(14) | 54.6 | Operating margin | 38.25% |
| ATR(14) | 0.98 | Profit margin | 39.28% |
| SMA20 dist | +0.54% | ROA | 7.25% |
| SMA50 dist | +2.10% | ROE | 33.69% |
| SMA200 dist | +8.04% | Revenue (ttm) | $12.03B |
| 52W high | $60.23 | Revenue growth y/y | 10.60% |
| 52W low | $44.22 | Inst. ownership | 19.71% |
| P/E (ttm) | 12.78 | Insider ownership | 64.03% |
| Forward P/E | 12.32 | Short float | 2.01% |
| PEG (trailing) | 3.08 | Avg volume | 1,350,614 |
| P/S | 5.01 | Employees | 0 |
| P/B | 4.30 | Analyst rec (1=buy..5=sell) | 2.4 |

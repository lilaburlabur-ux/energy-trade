...
Signed file: `ENPH.research.21.09.2026`

| Field | Value |
|---|---|
| Current price | $34.76 (2026-09-21, ~15-min delayed) |
| Market cap | $4.59B |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $34.76; 52w high $72.33 (-51.94%); 52w low $26.12 (+33.08%) |
| Trend | -15.58% vs SMA200, -9.75% vs SMA50, -5.12% vs SMA20 |
| Momentum | RSI(14) 39.3 (neutral) |
| Volatility | ATR(14) 1.98 (~5.7% of price); beta 1.64 |
| Setup perspective | -51.94% from 52w high — base needs to rebuild. |
...
| SMA20 dist | -5.12% | ROA | 2.38% |
| SMA50 dist | -9.75% | ROE | 13.00% |
| SMA200 dist | -15.58% | Revenue (ttm) | $1.33B |

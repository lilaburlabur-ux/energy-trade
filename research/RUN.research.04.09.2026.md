...
Signed file: `RUN.research.04.09.2026`

| Field | Value |
|---|---|
| Current price | $8.89 (2026-09-04, ~15-min delayed) |
| Market cap | $2.12B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-38.68%) with negative half-year (-21.60%). |
...
| Value attractiveness | Reasonable | Forward P/E 8.76, EV/Sales 5.29. |
| Risk level | High | Beta 2.36, ATR 5.8% of price, short float 32.34%. |
...
| Tesla and Google Just Joined a New Bet on the Electric Grid | GuruFocus.com | 2026-09-03 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $8.89; 52w high $21.41 (-58.48%); 52w low $8.37 (+6.21%) |
| Trend | -38.68% vs SMA200, -16.19% vs SMA50, -4.41% vs SMA20 |
| Momentum | RSI(14) 41.0 (neutral) |
| Volatility | ATR(14) 0.52 (~5.8% of price); beta 2.36 |
...
| Valuation | P/E 6.05, forward P/E 8.76, P/S 0.61, P/B 0.61 | EV/Sales 5.29, EV/EBITDA 21.86 |
| Growth expectations | Earnings growth -60.70%, EPS q/q -58.80% | Analyst mean target $15.97 (19 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 116.85% |
...
- **Volatility risk:** Beta 2.36, ATR 5.8% of price, short float 32.34%. Size positions accordingly.
...
|---|---|---|---|
| Price | $8.89 | EV/Sales | 5.29 |
| Market cap | $2.12B | EV/EBITDA | 21.86 |
| Beta | 2.36 | Gross margin | 35.29% |
| RSI(14) | 41.0 | Operating margin | 4.00% |
| ATR(14) | 0.52 | Profit margin | 11.59% |
| SMA20 dist | -4.41% | ROA | 0.26% |
| SMA50 dist | -16.19% | ROE | -19.86% |
| SMA200 dist | -38.68% | Revenue (ttm) | $3.48B |
| 52W high | $21.41 | Revenue growth y/y | 52.80% |
| 52W low | $8.37 | Inst. ownership | 116.85% |
| P/E (ttm) | 6.05 | Insider ownership | 2.82% |
| Forward P/E | 8.76 | Short float | 32.34% |
| PEG (trailing) | 3.07 | Avg volume | 9,934,752 |

...
Signed file: `ET.research.14.09.2026`

| Field | Value |
|---|---|
| Current price | $21.49 (2026-09-14, ~15-min delayed) |
| Market cap | $74.00B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +32.07%; price +16.12% vs SMA200. |
| Fresh setup quality | Watch | -1.10% from 52w high and near SMA20 — check for a tight base. |
| Fundamental quality | Mixed | Profit margin 4.92%, revenue growth 78.40%. |
| Value attractiveness | Reasonable | Forward P/E 12.28, EV/Sales 1.51. |
...
| Want $1,000 a Year in Passive Income from Energy Transfer LP (ET) Stock? Here's How Many Shares You'd Need. | Motley Fool | 2026-09-13 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $21.49; 52w high $21.73 (-1.10%); 52w low $15.15 (+41.80%) |
| Trend | +16.12% vs SMA200, +4.61% vs SMA50, +0.53% vs SMA20 |
| Momentum | RSI(14) 60.3 (neutral) |
| Volatility | ATR(14) 0.32 (~1.5% of price); beta 0.57 |
| Setup perspective | -1.10% from 52w high and near SMA20 — check for a tight base. |
...
| SMA20 dist | +0.53% | ROA | 5.06% |
| SMA50 dist | +4.61% | ROE | 14.56% |
| SMA200 dist | +16.12% | Revenue (ttm) | $107.38B |
| 52W high | $21.73 | Revenue growth y/y | 78.40% |
| 52W low | $15.15 | Inst. ownership | 32.51% |
| P/E (ttm) | 14.72 | Insider ownership | 10.29% |
| Forward P/E | 12.28 | Short float | 0.86% |
| PEG (trailing) | 0.66 | Avg volume | 8,651,035 |

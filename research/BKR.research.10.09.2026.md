...
Signed file: `BKR.research.10.09.2026`

| Field | Value |
|---|---|
| Current price | $59.40 (2026-09-10, ~15-min delayed) |
| Market cap | $58.96B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +32.74%; price +1.77% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 19.10, EV/Sales 2.26. |
| Risk level | Elevated | Beta 0.96, ATR 3.1% of price, short float 2.74%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $59.40; 52w high $69.18 (-14.14%); 52w low $43.79 (+35.66%) |
| Trend | +1.77% vs SMA200, -1.37% vs SMA50, -5.97% vs SMA20 |
| Momentum | RSI(14) 37.0 (neutral) |
| Volatility | ATR(14) 1.87 (~3.1% of price); beta 0.96 |
...
| Valuation | P/E 19.10, forward P/E 19.10, P/S 2.13, P/B 2.96 | EV/Sales 2.26, EV/EBITDA 12.93 |
...
- **Volatility risk:** Beta 0.96, ATR 3.1% of price, short float 2.74%. Size positions accordingly.
...
|---|---|---|---|
| Price | $59.40 | EV/Sales | 2.26 |
| Market cap | $58.96B | EV/EBITDA | 12.93 |
| Beta | 0.96 | Gross margin | 23.66% |
| RSI(14) | 37.0 | Operating margin | 12.83% |
| ATR(14) | 1.87 | Profit margin | 11.17% |
| SMA20 dist | -5.97% | ROA | 4.85% |
| SMA50 dist | -1.37% | ROE | 16.46% |
| SMA200 dist | +1.77% | Revenue (ttm) | $27.73B |
| 52W high | $69.18 | Revenue growth y/y | -2.40% |
| 52W low | $43.79 | Inst. ownership | 100.16% |
| P/E (ttm) | 19.10 | Insider ownership | 0.15% |
| Forward P/E | 19.10 | Short float | 2.74% |
| PEG (trailing) | 1.77 | Avg volume | 8,269,077 |
| P/S | 2.13 | Employees | 54,000 |
| P/B | 2.96 | Analyst rec (1=buy..5=sell) | 1.7 |

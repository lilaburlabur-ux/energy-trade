...
Signed file: `NXE.research.10.08.2026`

| Field | Value |
|---|---|
| Current price | $10.30 (2026-08-10, ~15-min delayed) |
| Market cap | $6.91B |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-3.22%) with negative half-year (-6.70%). |
...
| Value attractiveness | Reasonable | Forward P/E -62.14, EV/Sales —. |
| Risk level | Elevated | Beta 1.65, ATR 4.5% of price, short float —. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $10.30; 52w high $13.92 (-26.01%); 52w low $6.46 (+59.44%) |
| Trend | -3.22% vs SMA200, +4.50% vs SMA50, +9.37% vs SMA20 |
| Momentum | RSI(14) 60.0 (neutral) |
| Volatility | ATR(14) 0.46 (~4.5% of price); beta 1.65 |
...
| Valuation | P/E —, forward P/E -62.14, P/S —, P/B 5.64 | EV/Sales —, EV/EBITDA -61.22 |
| Growth expectations | Earnings growth —, EPS q/q — | Analyst mean target $19.42 (1 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 54.53% |
...
- **Volatility risk:** Beta 1.65, ATR 4.5% of price, short float —. Size positions accordingly.
...
|---|---|---|---|
| Price | $10.30 | EV/Sales | — |
| Market cap | $6.91B | EV/EBITDA | -61.22 |
| Beta | 1.65 | Gross margin | 0.00% |
| RSI(14) | 60.0 | Operating margin | 0.00% |
| ATR(14) | 0.46 | Profit margin | 0.00% |
| SMA20 dist | +9.37% | ROA | -3.39% |
| SMA50 dist | +4.50% | ROE | -17.67% |
| SMA200 dist | -3.22% | Revenue (ttm) | — |
| 52W high | $13.92 | Revenue growth y/y | — |
| 52W low | $6.46 | Inst. ownership | 54.53% |
| P/E (ttm) | — | Insider ownership | 6.39% |
| Forward P/E | -62.14 | Short float | — |
| PEG (trailing) | — | Avg volume | 5,657,327 |
| P/S | — | Employees | 142 |
| P/B | 5.64 | Analyst rec (1=buy..5=sell) | 1.5 |

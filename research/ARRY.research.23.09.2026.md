...
Signed file: `ARRY.research.23.09.2026`

| Field | Value |
|---|---|
| Current price | $3.86 (2026-09-23, ~15-min delayed) |
| Market cap | $593.77M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-49.68%) with negative half-year (-42.81%). |
| Fresh setup quality | Poor / broken | -67.73% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 4.33, EV/Sales 1.30. |
| Risk level | High | Beta 1.77, ATR 6.7% of price, short float 29.27%. |
...
|---|---|---|
| 1 Cash-Producing Stock to Consider Right Now and 2 That Underwhelm | StockStory | 2026-09-23 |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $3.86; 52w high $11.96 (-67.73%); 52w low $3.86 (+0.00%) |
| Trend | -49.68% vs SMA200, -23.09% vs SMA50, -12.85% vs SMA20 |
| Momentum | RSI(14) 28.4 (oversold) |
| Volatility | ATR(14) 0.26 (~6.7% of price); beta 1.77 |
| Setup perspective | -67.73% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 4.33, P/S 0.50, P/B -2.94 | EV/Sales 1.30, EV/EBITDA 12.89 |
| Growth expectations | Earnings growth -73.20%, EPS q/q -43.70% | Analyst mean target $8.60 (22 analysts) |

## 5. Institutional Investors and Ownership
| Metric | Value |
|---|---|
| Institutional ownership | 147.85% |
...
- **Volatility risk:** Beta 1.77, ATR 6.7% of price, short float 29.27%. Size positions accordingly.
...
|---|---|---|---|
| Price | $3.86 | EV/Sales | 1.30 |
| Market cap | $593.77M | EV/EBITDA | 12.89 |
| Beta | 1.77 | Gross margin | 26.76% |
| RSI(14) | 28.4 | Operating margin | 10.88% |
| ATR(14) | 0.26 | Profit margin | -7.25% |
| SMA20 dist | -12.85% | ROA | 3.33% |
| SMA50 dist | -23.09% | ROE | -25.98% |
| SMA200 dist | -49.68% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $3.86 | Inst. ownership | 147.85% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 4.33 | Short float | 29.27% |
| PEG (trailing) | 0.41 | Avg volume | 6,661,266 |
| P/S | 0.50 | Employees | 1,200 |
| P/B | -2.94 | Analyst rec (1=buy..5=sell) | 2.2 |

...
Signed file: `GEV.research.15.09.2026`

| Field | Value |
|---|---|
| Current price | $882.81 (2026-09-15, ~15-min delayed) |
| Market cap | $235.12B |
...
|---|---|---|
| Technical momentum | Moderate | 1Y +41.45%; price -1.51% vs SMA200. |
| Fresh setup quality | Moderate / wait | -24.86% from 52w high; no clean fresh pivot by default. |
| Fundamental quality | Strong | Profit margin 23.04%, revenue growth 21.90%. |
| Value attractiveness | Fair-to-demanding | Forward P/E 34.88, EV/Sales 5.44. |
| Risk level | Elevated | Beta 0.97, ATR 4.8% of price, short float 3.29%. |
...
|---|---|---|
| GE Vernova Is ‘Wired to Win,’ Analyst Says. What It Means for the Stock. | Barrons.com | 2026-09-15 |
| Bloom Energy vs. GE Vernova: Which Stock Is a Better Buy in 2026? | Motley Fool | 2026-09-15 |
| GE Vernova Will Supply Turbines for Japanese Wind Farm | POWER Magazine | 2026-09-15 |
| GLJ Starts GE Vernova at Sell With EBITDA 22% Below Consensus | GuruFocus.com | 2026-09-15 |

## 3. Technical Analysis
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $882.81; 52w high $1,174.86 (-24.86%); 52w low $546.95 (+61.41%) |
| Trend | -1.51% vs SMA200, -11.02% vs SMA50, -5.92% vs SMA20 |
| Momentum | RSI(14) 39.1 (neutral) |
| Volatility | ATR(14) 42.02 (~4.8% of price); beta 0.97 |
| Setup perspective | -24.86% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 25.30, forward P/E 34.88, P/S 5.68, P/B 19.66 | EV/Sales 5.44, EV/EBITDA 57.33 |
...
- **Valuation risk:** Forward P/E 34.88, EV/Sales 5.44. Multiple compression is the main downside if growth disappoints.
- **Volatility risk:** Beta 0.97, ATR 4.8% of price, short float 3.29%. Size positions accordingly.
...
|---|---|---|---|
| Price | $882.81 | EV/Sales | 5.44 |
| Market cap | $235.12B | EV/EBITDA | 57.33 |
| Beta | 0.97 | Gross margin | 20.57% |
| RSI(14) | 39.1 | Operating margin | 7.47% |
| ATR(14) | 42.02 | Profit margin | 23.04% |
| SMA20 dist | -5.92% | ROA | 2.54% |
| SMA50 dist | -11.02% | ROE | 82.58% |
| SMA200 dist | -1.51% | Revenue (ttm) | $41.37B |
| 52W high | $1,174.86 | Revenue growth y/y | 21.90% |
| 52W low | $546.95 | Inst. ownership | 81.65% |
| P/E (ttm) | 25.30 | Insider ownership | 0.13% |
| Forward P/E | 34.88 | Short float | 3.29% |
| PEG (trailing) | 1.71 | Avg volume | 2,572,958 |
| P/S | 5.68 | Employees | 78,000 |
| P/B | 19.66 | Analyst rec (1=buy..5=sell) | 1.5 |

## 8. Analyst Actions
| Date | Action | Firm | Rating change |
|---|---|---|---|
| 2026-09-15 | reit | Bernstein | Outperform → Outperform |

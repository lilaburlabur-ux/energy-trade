...
Signed file: `PR.research.21.08.2026`

| Field | Value |
|---|---|
| Current price | $23.75 (2026-08-21, ~15-min delayed) |
| Market cap | $19.89B |
...
|---|---|---|
| Technical momentum | High | 1Y +85.54%; price +32.63% vs SMA200. |
...
| Value attractiveness | Reasonable | Forward P/E 10.89, EV/Sales 4.01. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $23.75; 52w high $23.87 (-0.50%); 52w low $11.76 (+101.95%) |
| Trend | +32.63% vs SMA200, +18.06% vs SMA50, +11.35% vs SMA20 |
| Momentum | RSI(14) 72.1 (overbought) |
| Volatility | ATR(14) 0.68 (~2.9% of price); beta 0.48 |
| Setup perspective | -0.50% from 52w high; no clean fresh pivot by default. |
...
| Valuation | P/E 15.32, forward P/E 10.89, P/S 3.47, P/B 1.66 | EV/Sales 4.01, EV/EBITDA 5.41 |
...
|---|---|---|---|
| Price | $23.75 | EV/Sales | 4.01 |
| Market cap | $19.89B | EV/EBITDA | 5.41 |
| Beta | 0.48 | Gross margin | 75.85% |
| RSI(14) | 72.1 | Operating margin | 57.44% |
| ATR(14) | 0.68 | Profit margin | 21.52% |
| SMA20 dist | +11.35% | ROA | 7.54% |
| SMA50 dist | +18.06% | ROE | 11.40% |
| SMA200 dist | +32.63% | Revenue (ttm) | $5.74B |
| 52W high | $23.87 | Revenue growth y/y | 55.10% |
| 52W low | $11.76 | Inst. ownership | 92.75% |
| P/E (ttm) | 15.32 | Insider ownership | 4.61% |
| Forward P/E | 10.89 | Short float | 2.76% |
| PEG (trailing) | 1.41 | Avg volume | 9,826,767 |

...
Signed file: `ARRY.research.04.09.2026`

| Field | Value |
|---|---|
| Current price | $4.60 (2026-09-04, ~15-min delayed) |
| Market cap | $707.60M |
...
|---|---|---|
| Technical momentum | Low | Below SMA200 (-41.30%) with negative half-year (-32.45%). |
| Fresh setup quality | Poor / broken | -61.54% from 52w high — base needs to rebuild. |
| Fundamental quality | Weak | Negative profit margin (-7.25%). |
| Value attractiveness | Reasonable | Forward P/E 5.13, EV/Sales 1.39. |
| Risk level | High | Beta 1.79, ATR 5.9% of price, short float 24.55%. |
...
| Technical item | Read |
|---|---|
| Price vs 52-week range | Close $4.60; 52w high $11.96 (-61.54%); 52w low $4.36 (+5.50%) |
| Trend | -41.30% vs SMA200, -17.33% vs SMA50, -3.93% vs SMA20 |
| Momentum | RSI(14) 39.5 (neutral) |
| Volatility | ATR(14) 0.27 (~5.9% of price); beta 1.79 |
| Setup perspective | -61.54% from 52w high — base needs to rebuild. |
...
| Valuation | P/E —, forward P/E 5.13, P/S 0.60, P/B -3.51 | EV/Sales 1.39, EV/EBITDA 13.77 |
...
- **Volatility risk:** Beta 1.79, ATR 5.9% of price, short float 24.55%. Size positions accordingly.
...
| Market cap | $707.60M | EV/EBITDA | 13.77 |
| Beta | 1.79 | Gross margin | 26.76% |
| RSI(14) | 39.5 | Operating margin | 10.88% |
| ATR(14) | 0.27 | Profit margin | -7.25% |
| SMA20 dist | -3.93% | ROA | 3.33% |
| SMA50 dist | -17.33% | ROE | -25.98% |
| SMA200 dist | -41.30% | Revenue (ttm) | $1.19B |
| 52W high | $11.96 | Revenue growth y/y | -5.60% |
| 52W low | $4.36 | Inst. ownership | 147.92% |
| P/E (ttm) | — | Insider ownership | 0.66% |
| Forward P/E | 5.13 | Short float | 24.55% |
| PEG (trailing) | 0.48 | Avg volume | 6,704,023 |
| P/S | 0.60 | Employees | 1,200 |
| P/B | -3.51 | Analyst rec (1=buy..5=sell) | 2.0 |
